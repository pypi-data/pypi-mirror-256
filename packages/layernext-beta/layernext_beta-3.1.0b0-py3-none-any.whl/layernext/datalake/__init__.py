...
class DatalakeClient:
    ...
    def upload_metadata_from_unique_name_json(self, file_path: str = None, json_data: dict = None):
        _metadata = Metadata(client=self)
        response = _metadata.upload_metadata_json(
    ...
    def upload_metadata_from_storage_path_json(self, file_path: str = None, json_data: dict = None, bucket_name: str = None):
        _metadata = Metadata(client=self)
    ...
    def upload_metadata_from_job_id(self, job_id: str, file_path: str = None, json_data: dict = None):
        _metadata = Metadata(client=self)
    ...
    def update_virtual_collection(self, virtual_collection_name: str = None,
    ...
    def find_chunk(self, search_key_list: [str],
                   unique_name_list: List[str],
                   page_index: int = 0, response_chunk_limit: int = 3, adjacent_chunk_limit: int = 1):
        payload = {
    ...
    def find_chunk_from_each_doc(self, search_key_list: [str], unique_name_list: List[str]):
        payload = {
            "searchKeys": search_key_list,
            "uniqueNames": unique_name_list
        }
    ...
    def execute_mongo_query(self, source_name, function, input_data, collection):
        ...
        res = self.datalake_interface.execute_mongo_query(payload)
        return res

    def run_sql_query(self, source_name, query):
        """ 
        ...
        res = self.datalake_interface.run_sql_query(payload)
        return res
