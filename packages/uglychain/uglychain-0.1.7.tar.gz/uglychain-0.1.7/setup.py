...
{'bm25': ['jieba-fast[bm25]>=0.53,<0.54'],
 ...
 'llama-index': ['llama-index-core[llama-index]>=0.10.1,<0.11.0'],
 'llama-index:python_version >= "3.11" and python_version < "3.12"': ['llama-index-embeddings-openai[llama-index]>=0.1.0,<0.2.0'],
