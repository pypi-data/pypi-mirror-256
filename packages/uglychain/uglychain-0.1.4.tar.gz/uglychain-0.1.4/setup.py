...
extras_require = \
{':extra == "bm25"': ['jieba-fast[bm25]>=0.53,<0.54'],
 ':extra == "chatglm"': ['zhipuai[chatglm]>=2.0.1,<3.0.0'],
 ':extra == "dashscope"': ['dashscope[dashscope]>=1.14.1,<2.0.0'],
 ':extra == "gemini"': ['google-generativeai[gemini]>=0.3.2,<0.4.0'],
 ':extra == "llamaindex"': ['llama-index[llamaindex]>=0.9.45.post1,<0.10.0'],
 ':extra == "ollama"': ['ollama[ollama]>=0.1.6,<0.2.0'],
 ':extra == "openai"': ['tiktoken[openai]>=0.5.2,<0.6.0']}
