...
class catPlotter:
    ...
    def boxplot(self):
        ...
        if self.grid_col:
            ...
            g = sns.FacetGrid(df, col=self.grid_col, col_wrap=self.grid_wrap, height=self.grid_kws.get('height', 2.5), aspect=self.grid_kws.get('aspect', 3.5), sharex=True, sharey=False, legend_out=True)
            ...
            for ax in g.axes.flat:
                ...
                for i in list(range(0, 5)):
                    ...
                    nan_percentage = combined_data['Nan_Percentage'][i]
                    ax.text(tmp[1], i, f'N={count}; %m={nan_percentage:.1f}\n♦GM={mean:.2f}', va='center', ha='left', fontsize=font_size)
