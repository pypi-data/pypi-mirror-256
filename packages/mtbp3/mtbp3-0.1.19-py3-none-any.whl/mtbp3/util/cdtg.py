...
class catPlotter:
    ...
    def boxplot(self):
        ...
        if self.grid_col:
            ...
            g = sns.FacetGrid(df, col=self.grid_col, col_wrap=self.grid_wrap, height=self.grid_kws.get('height', 2.5), aspect=self.grid_kws.get('aspect', 3.5), sharex=True, legend_out=True)
