...
from azureml.acft.image.components.finetune.common.mlflow.mlflow_save_utils import get_extra_pip_requirements
    ...
    if component_args.save_as_mlflow_model and master_process:
        ...
        if component_args.model_family == MODEL_FAMILY_CLS.HUGGING_FACE_IMAGE:
            ...
            if os.path.isfile(output_model_defaults_path):
                extra_files.append(output_model_defaults_path)
            if os.path.isfile(output_model_metafile_path):
                extra_files.append(output_model_metafile_path)
            ...
            mlflow.hftransformers.save_model(
                ...
                extra_pip_requirements=get_extra_pip_requirements(component_args.task_name),
