...
class ServerPlan:
    def __init__(self, dbhost=None,dbuser=None,dbpassword=None,dbdatabase=None,sql_query=None, url=None,myproxy=None):
        self.host = dbhost
        self.user = dbuser
    ...
    def serverplan(self):
        ...
        response = self.push_message(data,headers,self.myproxy,10)
        print(response.text)
