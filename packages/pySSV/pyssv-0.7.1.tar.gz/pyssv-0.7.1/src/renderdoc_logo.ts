...
// Renderdoc Logo SVG modified from original, Copyright Baldur Karlsson, available under the MIT license
// Original: https://github.com/baldurk/renderdoc/blob/v1.x/qrenderdoc/Resources/logo.svg
export const RENDERDOC_LOGO_SVG: string = `
