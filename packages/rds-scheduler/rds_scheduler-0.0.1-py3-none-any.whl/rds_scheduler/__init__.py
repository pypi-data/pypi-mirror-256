...
class Cron(metaclass=jsii.JSIIMeta, jsii_type="rds-scheduler.Cron"):
    def __init__(
        self,
        *,
...
@jsii.data_type(
    jsii_type="rds-scheduler.CronOptions",
    jsii_struct_bases=[],
    name_mapping={
        "day": "day",
        "hour": "hour",
...
class CronOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__60d565be0d7032e7636c99122523a7bb7cf699e917384a33bdca4a350099b65c)
...
class RdsScheduler(
    ...
    jsii_type="rds-scheduler.RdsScheduler",
):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bfcdf92373297e325ff69423329bba46ec08fafe3b4c4e59277a8d6edd6eab4b)
...
@jsii.data_type(
    jsii_type="rds-scheduler.RdsSchedulerProps",
    jsii_struct_bases=[],
    name_mapping={
        "schedule": "schedule",
        "cluster": "cluster",
...
class RdsSchedulerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a698e6ce0c0be06f3fdb32d7c17b15cca4bbdd37424202e9a20d660b68b8de61)
...
@jsii.data_type(
    jsii_type="rds-scheduler.Schedule",
    jsii_struct_bases=[],
...
class Schedule:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__07181b4454b6e351e5eab179c191fcd6f36d94849d24583e4511f14034d834af)
...
def _typecheckingstub__60d565be0d7032e7636c99122523a7bb7cf699e917384a33bdca4a350099b65c(
    *,
    day: typing.Optional[builtins.str] = None,
    hour: typing.Optional[builtins.str] = None,
    minute: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__bfcdf92373297e325ff69423329bba46ec08fafe3b4c4e59277a8d6edd6eab4b(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    schedule: typing.Sequence[typing.Union[Schedule, typing.Dict[builtins.str, typing.Any]]],
...
def _typecheckingstub__a698e6ce0c0be06f3fdb32d7c17b15cca4bbdd37424202e9a20d660b68b8de61(
    *,
    schedule: typing.Sequence[typing.Union[Schedule, typing.Dict[builtins.str, typing.Any]]],
    cluster: typing.Optional[_aws_cdk_aws_rds_ceddda9d.IDatabaseCluster] = None,
    instance: typing.Optional[_aws_cdk_aws_rds_ceddda9d.IDatabaseInstance] = None,
...
def _typecheckingstub__07181b4454b6e351e5eab179c191fcd6f36d94849d24583e4511f14034d834af(
    *,
    start: typing.Optional[Cron] = None,
    stop: typing.Optional[Cron] = None,
    timezone: typing.Optional[_aws_cdk_ceddda9d.TimeZone] = None,
