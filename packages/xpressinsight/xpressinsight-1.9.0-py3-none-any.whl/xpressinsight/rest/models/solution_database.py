...
class SolutionDatabase(object):
    ...
    def __init__(self, drivername=None, server=None, port=None, username=None, password=None, database=None, odbcparams=None, local_vars_configuration=None):  #
        """SolutionDatabase - a model defined in OpenAPI"""  #
