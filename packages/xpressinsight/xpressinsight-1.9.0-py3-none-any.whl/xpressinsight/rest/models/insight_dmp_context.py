...
class InsightDmpContext(object):
    ...
    def __init__(self, ispopulated=None, managerurl=None, environment=None, tenantid=None, solutionid=None, componentid=None, compinstid=None, soltoken=None, soltokenexpiry=None, soltokenenv=None, local_vars_configuration=None):  #
        """InsightDmpContext - a model defined in OpenAPI"""  #
