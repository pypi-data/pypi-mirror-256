...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of xpressinsight.rest.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = xpressinsight.rest.Configuration(
    ...
    Note you can use the constants defined in the xpressinsight.rest.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = xpressinsight.rest.Configuration(
        signing_info = xpressinsight.rest.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("xpressinsight.rest")
