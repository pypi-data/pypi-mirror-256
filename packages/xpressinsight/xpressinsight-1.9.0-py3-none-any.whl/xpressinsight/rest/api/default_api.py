...
class DefaultApi(object):
    ...
    def insight_context_get(self, environment, **kwargs):  #
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.insight_context_get_with_http_info(environment, **kwargs)  #

    def insight_context_get_with_http_info(self, environment, **kwargs):  #
        """Query the execution context from the Insight server.  # noqa: E501
        ...
        del local_var_params['kwargs']
        #
        if self.api_client.client_side_validation and ('environment' not in local_var_params or  #
                                                        local_var_params['environment'] is None):  #
            raise ApiValueError("Missing the required parameter `environment` when calling `insight_context_get`")  #
        ...
        query_params = []
        if 'environment' in local_var_params and local_var_params['environment'] is not None:  #
    ...
    def insight_version_get(self, **kwargs):  #
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.insight_version_get_with_http_info(**kwargs)  #

    def insight_version_get_with_http_info(self, **kwargs):  #
        """Query the version of the Insight server that's executing the scenario  # noqa: E501
    ...
    def progress_get_message(self, **kwargs):  #
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.progress_get_message_with_http_info(**kwargs)  #

    def progress_get_message_with_http_info(self, **kwargs):  #
        """Gets the next unread progress message sent to this scenario by a view  # noqa: E501
    ...
    def progress_send(self, **kwargs):  #
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.progress_send_with_http_info(**kwargs)  #

    def progress_send_with_http_info(self, **kwargs):  #
        """Sends values of the defined progress entities back to the Xpress Insight v5 scenario  # noqa: E501
    ...
    def repository_item_info_get(self, path, **kwargs):  #
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repository_item_info_get_with_http_info(path, **kwargs)  #

    def repository_item_info_get_with_http_info(self, path, **kwargs):  #
        """Get information for a repository item with the supplied path.  # noqa: E501
        ...
        del local_var_params['kwargs']
        #
        if self.api_client.client_side_validation and ('path' not in local_var_params or  #
                                                        local_var_params['path'] is None):  #
            raise ApiValueError("Missing the required parameter `path` when calling `repository_item_info_get`")  #
        ...
        query_params = []
        if 'path' in local_var_params and local_var_params['path'] is not None:  #
    ...
    def repository_item_infos_list_get(self, folder_path, **kwargs):  #
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repository_item_infos_list_get_with_http_info(folder_path, **kwargs)  #

    def repository_item_infos_list_get_with_http_info(self, folder_path, **kwargs):  #
        """Get information for items in the folder with the supplied path.  # noqa: E501
        ...
        del local_var_params['kwargs']
        #
        if self.api_client.client_side_validation and ('folder_path' not in local_var_params or  #
                                                        local_var_params['folder_path'] is None):  #
            raise ApiValueError("Missing the required parameter `folder_path` when calling `repository_item_infos_list_get`")  #
        ...
        query_params = []
        if 'folder_path' in local_var_params and local_var_params['folder_path'] is not None:  #
            query_params.append(('folder_path', local_var_params['folder_path']))  #
    ...
    def scenario_data_get(self, scenario, output_dir, tables_descr_file, **kwargs):  #
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.scenario_data_get_with_http_info(scenario, output_dir, tables_descr_file, **kwargs)  #

    def scenario_data_get_with_http_info(self, scenario, output_dir, tables_descr_file, **kwargs):  #
        """Fetches Insight scenario data as Parquet files in the given local folder.  # noqa: E501
        ...
        all_params = ['scenario', 'output_dir', 'tables_descr_file']  #
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        del local_var_params['kwargs']
        #
        if self.api_client.client_side_validation and ('scenario' not in local_var_params or  #
                                                        local_var_params['scenario'] is None):  #
            raise ApiValueError("Missing the required parameter `scenario` when calling `scenario_data_get`")  #
        #
        if self.api_client.client_side_validation and ('output_dir' not in local_var_params or  #
                                                        local_var_params['output_dir'] is None):  #
            raise ApiValueError("Missing the required parameter `output_dir` when calling `scenario_data_get`")  #
        #
        if self.api_client.client_side_validation and ('tables_descr_file' not in local_var_params or  #
                                                        local_var_params['tables_descr_file'] is None):  #
            raise ApiValueError("Missing the required parameter `tables_descr_file` when calling `scenario_data_get`")  #
        ...
        query_params = []
        if 'scenario' in local_var_params and local_var_params['scenario'] is not None:  #
            query_params.append(('scenario', local_var_params['scenario']))  #
        if 'output_dir' in local_var_params and local_var_params['output_dir'] is not None:  #
            query_params.append(('outputDir', local_var_params['output_dir']))  #
        if 'tables_descr_file' in local_var_params and local_var_params['tables_descr_file'] is not None:  #
            query_params.append(('tablesDescrFile', local_var_params['tables_descr_file']))  #
