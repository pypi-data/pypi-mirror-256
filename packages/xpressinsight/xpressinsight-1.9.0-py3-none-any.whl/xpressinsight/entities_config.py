...
from typing import Any, Dict, Optional, Mapping, ValuesView, Type

from .entities import ENTITY_CLASS_NAMES, ScalarBase, EntityBase
...
class ScenarioData(EntitiesConfig):
    ...
    ...
    ... my_data = self.insight.get_scenario_data('/MyApp/MyFolder/MyScenario', EntitiesToRead)
