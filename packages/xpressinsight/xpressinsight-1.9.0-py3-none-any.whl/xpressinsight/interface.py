...
from typing import List, Generator, Optional, Union, Type, TypeVar
...
class AppInterface(ABC):
    ...
    def attach_status(self) -> AttachStatus:
        ...
        current thread. Setting this property will only change the value returned by future reads.
    ...
    def list_attach_tags(self) -> List[AttachTag]:
        ...
        Notes
        -----
        Check the attachment status code using :fct-ref:`insight.attach_status` to determine whether the attachment
    ...
    def rename_scen_attach(self, old_name: str, new_name: str) -> None:
        ...
        Notes
        -----
        Check the attachment status code using :fct-ref:`insight.attach_status` to determine whether the new attachment
        name was accepted.
    ...
    def set_scen_attach_desc(self, filename: str, description: str) -> None:
        ...
        Notes
        -----
        Check the attachment status code using :fct-ref:`insight.attach_status` to determine whether the new
        attachment description was accepted.
    ...
    def set_scen_attach_hidden(self, filename: str, hidden: bool) -> None:
        ...
        Notes
        -----
        Check the attachment status code using :fct-ref:`insight.attach_status` to determine whether the update was
        successful.
    ...
    def list_scen_attach(self, scenario_path: str = None) -> List[Attachment]:
        ...
        Notes
        -----
        Check the attachment status code using :fct-ref:`insight.attach_status` to determine whether the attachments
    ...
    def get_attachs_by_tag(self, tag: str, *, destination_directory: str = None) -> Optional[List[Attachment]]:
        ...
        Notes
        -----
        Check the attachment status code using :fct-ref:`insight.attach_status` to determine whether the attachment(s)
