...
class StorageManager:
    ...
    def upload_state(object_name: str, dataset_state: DatasetState):
        ...
        presigned_post_data: Union[
            str, Dict[str, Union[str, Dict[str, str]]]
        ] = ServerFacade.create_presigned_url(object_name, is_post_url=True)
    ...
    def download(object_name: str, download_path: str) -> Optional[str]:
        ...
        :return: bool:
        """
        presigned_get_data: Union[
            str, Dict[str, Union[str, Dict[str, str]]]
        ] = ServerFacade.create_presigned_url(object_name)
