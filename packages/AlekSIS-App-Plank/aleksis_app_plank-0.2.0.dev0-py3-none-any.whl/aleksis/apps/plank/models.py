...
class Inventory(ExtensibleModel):
    ...
    class Meta:
        ...
        permissions = [
            ("view_category_for_inventory", _("Can view category for inventory")),
            ("change_category_for_inventory", _("Can change category for inventory")),
            ("delete_category_for_inventory", _("Can delete category for inventory")),
            ("create_category_for_inventory", _("Can create category for inventory")),
            ("view_manufacturer_for_inventory", _("Can view manufacturer for inventory")),
            ("change_manufacturer_for_inventory", _("Can change manufacturer for inventory")),
            ("delete_manufacturer_for_inventory", _("Can delete manufacturer for inventory")),
            ("create_manufacturer_for_inventory", _("Can create manufacturer for inventory")),
            ("view_location_for_inventory", _("Can view location for inventory")),
            ("change_location_for_inventory", _("Can change location for inventory")),
            ("delete_location_for_inventory", _("Can delete location for inventory")),
            ("create_location_for_inventory", _("Can create location for inventory")),
            ("view_itemtype_for_inventory", _("Can view item type for inventory")),
            ("change_itemtype_for_inventory", _("Can change item type for inventory")),
            ("delete_itemtype_for_inventory", _("Can delete item type for inventory")),
            ("create_itemtype_for_inventory", _("Can create item type for inventory")),
    ...
    def status(self) -> dict[str, int]:
        ...
        context = {}
        items = Item.objects.filter(category__in=self.categories.all())
        item_types = ItemType.objects.filter(category__in=self.categories.all())
        context["count_items"] = items.count()
        context["count_item_types"] = item_types.count()
        available = 0
        checked_out = 0
        not_in_time = 0
        for item in items:
...
class Category(ExtensibleModel):
    ...
    inventory = models.ForeignKey(to=Inventory, on_delete=models.CASCADE, related_name="categories")
...
class Location(ExtensibleModel):
    ...
    inventory = models.ForeignKey(to=Inventory, on_delete=models.CASCADE, related_name="locations")
    name = models.CharField(max_length=255, verbose_name=_("Name"))
    notes = models.TextField(verbose_name=_("Notes"), blank=True)
...
class Manufacturer(ExtensibleModel):
    ...
    inventory = models.ForeignKey(
        max_length=255, to=Inventory, on_delete=models.CASCADE, related_name="manufacturers"
    )
    name = models.CharField(max_length=255, verbose_name=_("Name"))
    notes = models.TextField(verbose_name=_("Notes"), blank=True)
...
class CheckOutCondition(ExtensibleModel):
    ...
    inventory = models.ForeignKey(
        max_length=255, to=Inventory, on_delete=models.CASCADE, related_name="check_out_conditions"
    )
...
class CheckOutProcess(ExtensibleModel):
    ...
    inventory = models.ForeignKey(
        max_length=255, to=Inventory, on_delete=models.CASCADE, related_name="check_out_processes"
    )
