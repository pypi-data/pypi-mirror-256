from typing import Union, TypedDict, Literal, Any, Tuple, Dict, List
...
_EventType = Union[Literal["error"], Literal["csp"], Literal["hpkp"], Literal["expectct"], Literal["expectstaple"], Literal["transaction"], Literal["nel"], Literal["default"], Literal["feedback"]]
"""
