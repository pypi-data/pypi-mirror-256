    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                    ["a", "b\nc\nd\ne", "c", "d", "e"],
                    ["j", "a", "b\nd\ne", "d", "e", "f"],
                    ["Destination_only", "Both", "Origin_only", "Origin_only", "Destination_only", "Both", "Both",
                     "Destination_only"]
            ),
            (
                    ["a", "b\nc\nd\ne", "c\nc\nc", "d", "e"],
                    ["j", "a", "c\na\nc", "b\nd\ne", "d", "e", "f"],
                    ["Destination_only", "Both", "Origin_only", "Origin_only", "Destination_only", "Destination_only",
            ...
            (
                    ...
                    ["j", "a", "b\nd\ne", "d", "e", "f\nh\ni\n", "p"],
                    ["Destination_only", "Both", "Origin_only", "Origin_only", "Destination_only", "Both", "Both",
                     "Origin_only", "Origin_only", "Destination_only", "Both"]),
            (
                    ["a", "b", "c\no"],
                    ["a", "b", "d", "c\ne\no"],
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                    ["a", "b\nc\nd\ne", "c\nc\nc", "d", "e"],
                    ["j", "a", "c\na\nc", "b\nd\ne", "d", "e", "f"],
                    ["Destination_only", "Both", "Destination_only", "Both", "Origin_only", "Both", "Both",
                     "Destination_only"]
            ),
            (
                    ["a", "b\nc\nd\ne", "c", "d", "e", "k", "f\nh\n", "p"],
            ...
            (
                    ["a", "b", "c\no"],
                    ["a", "b", "d", "c\ne\no"],
                    ["Both", "Both", "Destination_only", "Both"]
            )
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                    ["a", "b\nc\nd\ne", "c", "aa\ncc", "d", "e", "k", "b\nc\nd\ne", "f\nh\n", "p"],
                    ["j", "a", "b\nd\ne", "gg", "aa\nbb\ncc", "d", "e", "b\nc\nd\ne", "f\nh\ni\n", "p"],
                    ["Destination_only", "Both", "Both", "Origin_only", "Destination_only", "Both", "Both", "Both",
                     "Origin_only", "Both", "Both", "Both"]),
            (
                    ["a", "b\nc\nd\ne", "c", "aa\ncc", "d", "e", "k", "b\nc\nd\ne", "f\nh\n", "p", "b\nc\nd\ne", "c",
                     "aa\ncc"],
                    ["j", "a", "b\nd\ne", "gg", "aa\nbb\ncc", "d", "e", "b\nd\ne", "f\nh\ni\n", "p", "b\nd\ne", "gg",
                     "aa\nbb\ncc"],
                    ["Destination_only", "Both", "Both", "Origin_only", "Destination_only", "Both", "Both", "Both",
                     "Origin_only", "Both", "Both", "Both", "Both", "Origin_only", "Destination_only", "Both"]),
        ],
    )
