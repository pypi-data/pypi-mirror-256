...
#endif
static PyObject* __PYX_WARN_IF_PyInit_corecext_INIT_CALLED(PyObject* res) {
  return res;
}
#define PyInit_corecext() __PYX_WARN_IF_PyInit_corecext_INIT_CALLED(PyInit_corecext())
#endif
#endif
