...
from typing import Any, Union, List, Literal, TypedDict, overload, Optional
...
class 浮動小数クラス:
    ...
    @overload
    def __truediv__(self, formula: 整数クラス | int | 浮動小数クラス | float | 分数クラス) -> 浮動小数クラス:
        ...
...
class 範囲クラス:
    ...
    def 取得する_整数集合(self, 抽象構文木: astElement | None = None, 集合限界: int = 1000) -> set[int]:
        ...
...
##### ./wip/src/diophantine_equation_utils.py #####
...
##### ./wip/src/equations.py #####


class 方程式sクラス:
    def __init__(self, proof: 証明クラス, equations: express_list | express_tuple) -> None:
        ...
...
class 証明クラス:
    ...
    def 登録する_変数s(self, 変数s: list[str], 変数の種類s: variable_types_optional = {}) -> 証明クラス:
        ...
...
class セクションクラス:
    ...
    def 作成する_サブセクション(self, タイトル: str, ID: str, インデックス: int | None = None) -> セクションクラス:
        ...


##### ./wip/src/symbol_condition_utils.py #####
...
class テーブルクラス:
    ...
    def 追加する_列(self, 列名: str | int | float, ボディ: list[str | int | float]) -> テーブルクラス:
        ...
...
class 便利ツールクラス:
    ...
    @staticmethod
    def キャストする(証明: 証明クラス, 型: term_type, テキスト: str) -> 整数クラス | 浮動小数クラス | 分数クラス | 式クラス:
        ...
    ...
    @staticmethod
    @overload
    def ユークリッドの互除法(証明: 証明クラス, 項s: tuple[int, int], セクションタイトル: str) -> tuple[int, int]:
        ...

    @staticmethod
    @overload
    def ユークリッドの互除法(証明: 証明クラス, 項s: tuple[str, str], セクションタイトル: str) -> tuple[str, str]:
        ...
...
class ベクトル解sクラス:
    ...
    def 結合する(self, ベクトル方程式s: list[ベクトル方程式クラス] | ベクトル解sクラス) -> ベクトル解sクラス:
        ...
...
class ベン図クラス:
    ...
    def 表示する(self) -> ベン図クラス:
        ...


##### ./wip/src/ven_diagram_reservation.py #####
