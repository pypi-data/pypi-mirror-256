...
class_threshold = {
    "other": 0.9,
    "Modeling_Simulation_Training": 0.9,
    "Engineering": 0.9,
    "Revamps_Conversions": 0.97,
    "Consulting": 0.97,
    "Technologies": 0.97,
    "Cybersecurity": 0.97,
}
...
def prepare_category_tree():
    ...
    category_list, _ = query_cosmos_db(query, "taxonomy", "categories")[0]
...
def categorize_query(query, topic):
