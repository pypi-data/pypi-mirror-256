...
class MetadataFilter:
        ...
        try:
            is_match = all(
                self._safe_match(
                    ...
                    filter_type=self.type if self.filter_type_target_field() == component else FilterType.EXACT_MATCH
                )
    ...
    def filter_type_target_field(self) -> str:
        """The field that is evaluated using filter type. Other fields should be compared using exact match."""
