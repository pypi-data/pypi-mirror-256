...
from . import (
    ...
    div_alignment_vertical, div_appearance_transition, div_aspect,
    ...
    div_transform, div_transition_trigger, div_video_scale, div_video_source,
...
class DivVideo(BaseDiv):
    ...
    preload_required: typing.Optional[typing.Union[Expr, bool]] = Field(
        description="This option turns on preloading of video sources.",
    )
    ...
    scale: typing.Optional[typing.Union[Expr, div_video_scale.DivVideoScale]] = Field(
        description=(
            ...
            "element (free space isfilled with background);\'fill` "
            "scales the video to the element size and cuts offanything "
            "that\'s extra."
        ),
    )
