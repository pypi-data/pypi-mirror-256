...
MRI2PET = np.array([[0.99990508, 0.00800995, 0.01121016, -0.68164088],
                    [-0.00806219, 0.99995682, 0.00462244, -1.16235105],
                    [-0.01117265, -0.00471238, 0.99992648, -1.02167229], [0.0, 0.0, 0.0, 1.0]])
...
def assert_equal_arrays(x, y, nmse_tol=0, denan=True):
    ...
    if nmse_tol:
        ...
        return
    raise ValueError(
        dedent(f"""        Unequal arrays:x != y. min/mean/max(std):
