...
SPECIAL_KEYS = ["_id", "_key", "_rev", "_from", "_to", "__ttl", "__properties", "_created_at", "_modified_at", "__subcollections"]
...
class CollectionItem(_ItemMixin):
    ...
    def __init__(self, data: dict, db=None, collection=None, immut_keys:list=[], load_parser=None, commiter=None, custom_ops:dict={}, read_only:bool=False):
        ...
        data, _ = dict_mutator.mutate(mutations=data,  immuts=self._immut_keys, custom_ops=self._custom_ops)
        self._load(data)
...
class Collection(object):
    ...
    def _commit(self, item:CollectionItem, replace_document=False, merge_objects=True, upsert=True):
        """
