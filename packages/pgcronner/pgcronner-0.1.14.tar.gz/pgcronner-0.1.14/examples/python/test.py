...
SOURCE ="""
UPDATE posts_post AS r SET bookmark_count = ex.counter FROM ( SELECT object_id AS id, COUNT(*) AS counter FROM bookmarks_bookmark WHERE content_type_id = 198 GROUP BY object_id ) ex WHERE r.id = CAST(ex.id as uuid);
"""
