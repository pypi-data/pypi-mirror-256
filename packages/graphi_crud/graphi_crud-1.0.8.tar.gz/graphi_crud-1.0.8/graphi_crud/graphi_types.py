...
class Types:
    ...
    def get_fields(cls, model):
        ...
        if hasattr(model, "graphql_method_fields"):
            fields += list(model.graphql_method_fields.keys())
        return fields
    ...
    def find_all_models(cls, _apps: list):
        ...
        for app in all_apps:
            ...
            if hasattr(app.models_module, "DEPENDENCY_MODELS"):
                models += app.models_module.DEPENDENCY_MODELS
            for model in models:
                yield model
