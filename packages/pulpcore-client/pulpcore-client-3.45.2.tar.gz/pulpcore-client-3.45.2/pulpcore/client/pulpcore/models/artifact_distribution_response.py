...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, base_path=None, pulp_href=None, name=None, pulp_created=None, content_guard=None, base_url=None, hidden=False, local_vars_configuration=None):  # noqa: E501
