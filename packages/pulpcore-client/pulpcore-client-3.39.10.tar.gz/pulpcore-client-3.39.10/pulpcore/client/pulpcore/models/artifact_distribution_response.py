...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, name=None, base_url=None, base_path=None, content_guard=None, hidden=False, pulp_created=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
