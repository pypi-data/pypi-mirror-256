...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_created=None, base_path=None, content_guard=None, base_url=None, name=None, pulp_href=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
