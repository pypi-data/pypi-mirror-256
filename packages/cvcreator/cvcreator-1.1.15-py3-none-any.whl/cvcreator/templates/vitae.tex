...
\cfoot{\vspace{0.2cm}\includegraphics[width=5cm]{\VAR{meta.footer_image}}}
...
\BLOCK{if project}
  ...
  \begin{tabular}{@{}LR}
                      \VAR{titles.project_sub_titles.activity}    & \VAR{s.activity}    \\
\BLOCK{if s.period}   \VAR{titles.project_sub_titles.period}      & \VAR{s.period}      \\ \BLOCK{endif}
\BLOCK{if s.role}     \VAR{titles.project_sub_titles.role}        & \VAR{s.role}        \\ \BLOCK{endif}
\BLOCK{if s.staffing} \VAR{titles.project_sub_titles.staffing}    & \VAR{s.staffing}    \\ \BLOCK{endif}
\BLOCK{if s.volume}   \VAR{titles.project_sub_titles.volume}      & \VAR{s.volume}      \\ \BLOCK{endif}
                      \VAR{titles.project_sub_titles.description} & \VAR{s.description} \\
\BLOCK{if s.tools}    \VAR{titles.project_sub_titles.verktøy}     & \VAR{s.tools}       \\ \BLOCK{endif}
\BLOCK{if s.url}      \VAR{titles.project_sub_titles.url}         & \VAR{s.url}         \\ \BLOCK{endif}
  \rule{\textwidth}{0.1pt}
  \end{tabular}
  \BLOCK{endfor}
  \vspace{0.5cm}
