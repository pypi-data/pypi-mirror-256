...
class Requirements(object):
    ...
    def get():
        ...
        :return:
        """
        requirements = ["requests>=2.25.1", "confluent-kafka>=1.7.0", "redisbloom>=0.4.1", "m-singleton>=0.3"]
        return requirements
...
version_prod='1.0.1-rc1'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='1.0.1-rc1',  # Required, Phần này cũng không được format file.
    ...
    # larger catalog.
    keywords="mobio, kafka, m-kafka",  # Optional
