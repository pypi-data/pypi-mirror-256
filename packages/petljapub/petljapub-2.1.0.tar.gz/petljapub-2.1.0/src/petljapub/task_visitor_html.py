...
from .md_content_processor import MDContentProcessor, LinkProcessorRaw, OutputOrganizerSingleDir, ImageProcessorCopy
...
class TaskVisitorHTML(TaskVisitor):
    ...
    def task_start(self, task):
        ...
        self._md_processor = MDContentProcessor(LinkProcessorRaw(), ImageProcessorCopy(self._writer, OutputOrganizerSingleDir(task.build_dir())))
