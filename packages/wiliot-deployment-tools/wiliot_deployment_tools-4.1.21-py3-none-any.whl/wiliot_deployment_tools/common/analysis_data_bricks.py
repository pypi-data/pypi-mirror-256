...
import tabulate
try:
    from wiliot_deployment_tools.internal.utils.network_packet_list import NetworkPacketList, network_data_preparation
    print('NetworkPacketList imported (running internal version)')
except ImportError:
    pass
...
class WiliotDatabricksUtils:
    ...
    def get_seen_tags(self, table, start_time, end_time, tags_list=None, bridges_list=None, gateways_list=None):
        """
...
def analyze_packets_data(packets_df=None, csv_path=None, test_time_start=None, test_time_conf_received=None,
    ...
    reconstructed_packet_df = network_data_preparation(packets_df=packets_df)

    packets_list = packets_list.import_packet_df(import_all=True, packet_df=reconstructed_packet_df)
    return packets_list
...
def get_packet_table_name(owner, env, platform=False):
    """
