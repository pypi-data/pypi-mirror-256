...
BRG_PKT_TYPES_MASK =            "pkt_types_mask"
BRG_ENERGY_PATTERN =            "energy_pattern"
...
TTFP_50 =                       "ttfp50"
TTFPS =                         "ttfps"
TTFP_INTEGRAL =                 "ttfp_integral"
RECEIVED_TAGS =                 "received_tags"
TTFP_GRAPH =                    "ttfp_graph"
...
# Due to speedtest is depending on log period the test need
# greater time to wait untill speed test is starting on top of the running time
SPEEDTEST_TIME_LIMIT =          GW_LOG_PERIOD + 50
...
BRG_OTA_UPDATE_TIMEOUT =            230
GW_VER_UPDATE_TIMEOUT =             300
...
BRG_IDLE_CFG_FAILED =       "brg didn't receive cfg!"
ESP_HEAP_MEM_WARN =         "WLT_WARN: Current free heap size"
