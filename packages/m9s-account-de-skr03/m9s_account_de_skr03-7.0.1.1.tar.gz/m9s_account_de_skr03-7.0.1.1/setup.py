...
name = 'm9s_account_de_skr03'
download_url = 'https://gitlab.com/m9s/account_de_skr03.git'
requires = []
...
tests_require = [
    get_require_version('m9s-account-deposit'),
    ]
dependency_links = []
if minor_version % 2:
...
setup(name=name,
    version=version,
    description='Tryton Account De Skr03 Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/account_de_skr03.git',
        },
    keywords='',
    package_dir={'trytond.modules.account_de_skr03': '.'},
    packages=(
        ['trytond.modules.account_de_skr03']
        + ['trytond.modules.account_de_skr03.%s' % p
