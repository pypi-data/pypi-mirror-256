...
class ImageApi:
    ...
    def image_create(
        ...
        :param inspection_results:
        :type inspection_results: List[int]
        :param format:
    ...
    def _image_create_serialize(
        ...
        if inspection_results is not None:
            _form_params.append(('inspection_results', inspection_results))
    ...
    def image_quality_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ImageQualityGateResult]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def image_quality_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ImageQualityGateResult]]:
        """image_quality_list
