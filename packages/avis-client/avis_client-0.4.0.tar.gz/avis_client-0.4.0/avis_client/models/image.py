...
class Image(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "team", "inspection", "uploaded_by", "inspection_results", "created_at", "updated_at", "format", "capture_datetime", "file", "part_id", "validation_status"]
