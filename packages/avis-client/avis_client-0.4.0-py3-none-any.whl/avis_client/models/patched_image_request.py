...
class PatchedImageRequest(BaseModel):
    """
    PatchedImageRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["team", "inspection", "uploaded_by", "inspection_results", "format", "capture_datetime", "file", "part_id", "validation_status"]
