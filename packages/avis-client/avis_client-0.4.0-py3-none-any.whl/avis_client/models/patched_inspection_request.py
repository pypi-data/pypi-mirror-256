...
class PatchedInspectionRequest(BaseModel):
    """
    ...
    blueprint: Optional[StrictInt] = None
    metadata: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["team", "product", "opened_by", "closed_by", "images", "close_datetime", "blueprint", "metadata"]
