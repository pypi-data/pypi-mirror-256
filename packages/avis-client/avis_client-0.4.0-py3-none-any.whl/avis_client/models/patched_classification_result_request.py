...
class PatchedClassificationResultRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["team", "reported_by", "inferred_by", "image", "image_attributes", "status", "failure_reason", "comment"]
