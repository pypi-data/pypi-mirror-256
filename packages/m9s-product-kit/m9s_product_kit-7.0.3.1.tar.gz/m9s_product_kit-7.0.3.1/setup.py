...
name = 'm9s_product_kit'
download_url = 'https://gitlab.com/m9s/product_kit.git'
requires = []
...
tests_require = [
    ...
    #get_require_version('m9s_nereid_catalog_variants'),
    #get_require_version('m9s_product_variant'),
    ]

setup(name=name,
    version=version,
    description='Tryton Product Kit Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/product_kit.git',
        },
    keywords='',
