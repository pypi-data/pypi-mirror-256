...
class PhotonSimulator():
    ...
    def __init__(self, yaml_path):
        ...
        if Path(path).exists():
            ...
            pix_nbr = self.type_variable(telescope['detector']['pix_nbr'],'pix_nbr',[int])
            ...
            spectrum = self.type_variable(star['spectrum'],'spectrum',[str])
            ...
            try: sim_config['PSF']
                ...
                if self.type_variable(sim_config['PSF']['method'],'method',[str]) == 'turbulence':
                    ...
                    if np.shape(wind)==():
                        ...
                        file = open(self.type_variable(turb['file'],'PSF_file',[str]),'rb')
