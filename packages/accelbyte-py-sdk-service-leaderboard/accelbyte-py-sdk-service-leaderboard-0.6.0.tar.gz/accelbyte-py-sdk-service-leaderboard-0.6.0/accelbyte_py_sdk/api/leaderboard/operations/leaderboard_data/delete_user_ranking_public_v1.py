...
class DeleteUserRankingPublicV1(Operation):
    ...
    _url: str = "/leaderboard/v1/public/namespaces/{namespace}/leaderboards/{leaderboardCode}/users/{userId}"
    _method: str = "DELETE"
    ...
    def with_leaderboard_code(self, value: str) -> DeleteUserRankingPublicV1:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> DeleteUserRankingPublicV1:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> DeleteUserRankingPublicV1:
        self.user_id = value
        return self
