...
class GetAllTimeLeaderboardRankingAdminV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/alltime"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_leaderboard_code(self, value: str) -> GetAllTimeLeaderboardRankingAdminV3:
    ...
    def with_offset(self, value: int) -> GetAllTimeLeaderboardRankingAdminV3:
        self.offset = value
        return self
