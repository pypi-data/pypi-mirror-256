...
class UpdateLeaderboardConfigurationAdminV3(Operation):
    ...
    body: ModelsUpdateLeaderboardConfigReqV3  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelsUpdateLeaderboardConfigReqV3
    ...
    def with_namespace(self, value: str) -> UpdateLeaderboardConfigurationAdminV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelsUpdateLeaderboardConfigReqV3()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsUpdateLeaderboardConfigReqV3.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelsUpdateLeaderboardConfigReqV3()
