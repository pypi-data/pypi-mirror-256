...
class GetCurrentWeekLeaderboardRankingPublicV1(Operation):
    ...
    _url: str = "/leaderboard/v1/public/namespaces/{namespace}/leaderboards/{leaderboardCode}/week"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> GetCurrentWeekLeaderboardRankingPublicV1:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> GetCurrentWeekLeaderboardRankingPublicV1:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetCurrentWeekLeaderboardRankingPublicV1:
        self.offset = value
        return self
