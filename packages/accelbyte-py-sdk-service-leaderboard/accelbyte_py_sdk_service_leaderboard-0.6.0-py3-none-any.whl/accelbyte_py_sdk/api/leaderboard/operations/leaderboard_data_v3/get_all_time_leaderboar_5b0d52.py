...
class GetAllTimeLeaderboardRankingPublicV3(Operation):
    ...
    _url: str = "/leaderboard/v3/public/namespaces/{namespace}/leaderboards/{leaderboardCode}/alltime"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_leaderboard_code(self, value: str) -> GetAllTimeLeaderboardRankingPublicV3:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> GetAllTimeLeaderboardRankingPublicV3:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> GetAllTimeLeaderboardRankingPublicV3:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetAllTimeLeaderboardRankingPublicV3:
        self.offset = value
        return self
