...
class GetAllTimeLeaderboardRankingAdminV1(Operation):
    ...
    _url: str = "/leaderboard/v1/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/alltime"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_leaderboard_code(self, value: str) -> GetAllTimeLeaderboardRankingAdminV1:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> GetAllTimeLeaderboardRankingAdminV1:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> GetAllTimeLeaderboardRankingAdminV1:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetAllTimeLeaderboardRankingAdminV1:
        self.offset = value
        return self
