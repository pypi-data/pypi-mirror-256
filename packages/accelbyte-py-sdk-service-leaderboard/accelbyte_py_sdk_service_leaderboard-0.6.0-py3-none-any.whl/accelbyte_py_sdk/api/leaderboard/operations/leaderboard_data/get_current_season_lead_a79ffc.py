...
class GetCurrentSeasonLeaderboardRankingAdminV1(Operation):
    ...
    _url: str = "/leaderboard/v1/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/season"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> GetCurrentSeasonLeaderboardRankingAdminV1:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> GetCurrentSeasonLeaderboardRankingAdminV1:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetCurrentSeasonLeaderboardRankingAdminV1:
        self.offset = value
        return self
