...
class Settlement():
    ...
    def format_files_settlement(self, function):
        if function == "export":
    ...
    def invoice_notice(self,
        ...
        İlgili Sayfa
        ---------
        https://epys.epias.com.tr/reconciliation-operations/settlement-notification/settlement-notification-summary
        ...
        if function == "list":
            path = "https://epys{}.epias.com.tr/reconciliation-invoice/v1/invoice-notice/list".format(self.test_coef)
        elif function == "export":
            path = "https://epys{}.epias.com.tr/reconciliation-invoice/v1/invoice-notice/export".format(self.test_coef)
        else:
            print("Function is not defined")
            return
        
        self.request_settlement_data(path, {"period": period,
                                 "page": {'number': self.page, 'size': 10000}})

                                 
        if self.final_response != None:
            self.formatted_final_response = self.format_files_settlement(function)
            return self.formatted_final_response                    


    def invoice_notice_daily(self,
                              period:tuple = get_current_settlement_days(first_day = True, finalised = False),
        ...
        """
        #Settlement
        Günlük kırılımda Uzlaştırma Bildirimi
        ---------
        Günlük kırılımda aylık Uzlaştırma Bildirimi verilerini döner.

        İlgili Sayfa
        ---------
        https://epys.epias.com.tr/reconciliation-operations/settlement-notification/monthly-settlement-notification
        ...
        if function == "list":
            path = "https://epys{}.epias.com.tr/reconciliation-invoice/v1/reconciliation/detail/daily".format(self.test_coef)
        elif function == "export":
            path = "https://epys{}.epias.com.tr/reconciliation-invoice/v1/reconciliation/detail/daily/export".format(self.test_coef)
        else:
            print("Function is not defined")
            return
                    
        self.request_settlement_data(path, {
            "period":period,
            "version":version,
    ...
    def invoice_notice_hourly(self,
                              period:tuple = get_current_settlement_days(first_day = True, finalised = False),
                              version:tuple = get_current_settlement_days(first_day = True, finalised = False),
                              DateStart:tuple = None,
                              DateEnd:tuple = None,
        ...
        """
        #Settlement
        Saatlik kırılımda Uzlaştırma Bildirimi
        ---------
        Saatlik kırılımda aylık Uzlaştırma Bildirimi verilerini döner.

        İlgili Sayfa
        ---------
        https://epys.epias.com.tr/reconciliation-operations/settlement-notification/settlement-period-detail
        ...
        if function == "list":
            path = "https://epys{}.epias.com.tr/reconciliation-invoice/v1/reconciliation/detail/hourly".format(self.test_coef)
        elif function == "export":
            path = "https://epys{}.epias.com.tr/reconciliation-invoice/v1/reconciliation/detail/hourly/export".format(self.test_coef)
        else:
            print("Function is not defined")
            return
    ...
    #     self.request_settlement_data(path, {"effectiveDate": period,
    #                              "page": {'number': self.page, 'size': 10000}})
