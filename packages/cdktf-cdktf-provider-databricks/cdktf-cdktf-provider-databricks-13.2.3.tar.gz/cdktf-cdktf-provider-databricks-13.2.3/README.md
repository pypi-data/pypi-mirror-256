# CDKTF prebuilt bindings for databricks/databricks provider version 1.36.3

This repo builds and publishes the [Terraform databricks provider](https://registry.terraform.io/providers/databricks/databricks/1.36.3/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform databricks provider](https://registry.terraform.io/providers/databricks/databricks/1.36.3)
