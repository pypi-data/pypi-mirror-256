...
class DeleteNodeByID(Operation):
    ...
    def with_node_ip(self, value: str) -> DeleteNodeByID:
        self.node_ip = value
        return self

    def with_pod_name(self, value: str) -> DeleteNodeByID:
        self.pod_name = value
        return self
    ...
    @classmethod
    def create(cls, node_ip: str, pod_name: str, **kwargs) -> DeleteNodeByID:
        instance = cls()
