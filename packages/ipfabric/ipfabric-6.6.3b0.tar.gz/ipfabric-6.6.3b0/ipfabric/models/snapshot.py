...
class Snapshot(BaseModel):
    ...
    def add_devices(
        ...
        elif not ip and not refresh_vendor_api:
            ip = ["0.0.0.0/32"]
    ...
    def retry_timed_out_devices(
        ...
        Returns: bool
        """
        return self.add_devices("0.0.0.0", False, True, wait_for_discovery, wait_for_assurance, timeout, retry)
