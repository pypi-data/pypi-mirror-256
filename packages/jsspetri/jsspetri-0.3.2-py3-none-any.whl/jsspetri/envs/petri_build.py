...
class Petri_build:
    ...
    def create_petri(self):
        ...
        print(f"JSSP {self.instance_id}: {self.n_jobs} jobs X {self.n_machines} machines loaded  loaded , Dynamic Mode :{self.dynamic}")
        
        
    def create_petri_dynamic(self):
        
        """Create the Petri net structure, adding nodes, connections, and tokens. dynamic mean create
        ...
        print (f"JSSP {self.instance_id} : {self.n_jobs} jobs X {self.n_machines} machines  loaded , Dynamic Mode :{self.dynamic}")
