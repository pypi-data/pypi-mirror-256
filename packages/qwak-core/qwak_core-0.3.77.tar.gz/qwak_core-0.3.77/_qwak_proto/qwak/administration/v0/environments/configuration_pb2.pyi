...
class GcpCloudConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["big_lake_connection_name", b"big_lake_connection_name", "big_lake_location", b"big_lake_location", "project_id", b"project_id", "region", b"region"]) -> None: ...
