...
from qwak.clients.feature_store.offline_serving_client import FsOfflineServingClient
from qwak.exceptions import QwakException
from qwak.feature_store._common.packaging import upload_to_s3
from qwak.feature_store.offline._offline_serving_validations import (
    validate_features,
...
class OfflineClientV2:
    ...
    def get_feature_range_values(
        ...
        :param population: a pandas data-frame a column for each entity key defined at features,
                            if empty then no filter applied.
        ...
        try:
            ...
            return OfflineClientV2._results_response_to_df(response)
    ...
    @staticmethod
    def _results_response_to_df(response: ProtoGetFeatureValuesResultResponse):
        if (
            response.status
            ...
            raise QwakException("Got an unexpected Feature Values Status")
