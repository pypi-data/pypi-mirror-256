...
class ListInferenceJobFilesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bucket", b"bucket", "directory_path", b"directory_path", "role_arn", b"role_arn", "secret_secret", b"secret_secret", "secret_service_url", b"secret_service_url", "token_secret", b"token_secret"]) -> None: ...
