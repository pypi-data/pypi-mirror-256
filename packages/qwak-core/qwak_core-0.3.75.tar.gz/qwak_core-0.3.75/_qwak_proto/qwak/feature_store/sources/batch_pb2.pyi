...
class JdbcSource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["athenaSource", b"athenaSource", "clickhouseSource", b"clickhouseSource", "mysqlSource", b"mysqlSource", "postgresqlSource", b"postgresqlSource", "redshiftSource", b"redshiftSource", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["athenaSource", b"athenaSource", "clickhouseSource", b"clickhouseSource", "db_table", b"db_table", "mysqlSource", b"mysqlSource", "password_secret_name", b"password_secret_name", "postgresqlSource", b"postgresqlSource", "query", b"query", "redshiftSource", b"redshiftSource", "type", b"type", "url", b"url", "username_secret_name", b"username_secret_name"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type", b"type"]) -> typing_extensions.Literal["mysqlSource", "postgresqlSource", "redshiftSource", "athenaSource", "clickhouseSource"] | None: ...
