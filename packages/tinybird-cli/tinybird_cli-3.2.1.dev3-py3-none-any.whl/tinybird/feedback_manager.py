...
class FeedbackManager:
    ...
    error_no_correct_token_for_init = error_message(
        "No access to git releases. Use a Workspace admin token. See https://versions.tinybird.co/docs/version-control/working-with-version-control.html"
    )
...
**    $ tb datasource rm {datasource}"""
    ...
    info_generate_cicd_config = info_message(
        "** {provider} CI/CD config files generated. Read this guide to learn how to run CI/CD pipelines: https://versions.tinybird.co/docs/version-control/continuous-integration.html"
    )
...
"""
    ...
    success_init_git_release = success_message(
        "** Workspace '{workspace_name}' release initialized to commit '{release_commit}'.\n Now start working with git, pushing changes to pull requests and let the CI/CD work for you. More details in this guide: https://versions.tinybird.co/docs/version-control/working-with-version-control.html."
    )
