...
class AbacLabelParsersList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([AbacLabelParsers]): List of ABAC label parsers. Please note 'SimpleSecurityLabelParser' has been deprecated and will be removed in the future. Use 'IdentityParser' instead..  # noqa: E501

        Keyword Args:
            value ([AbacLabelParsers]): List of ABAC label parsers. Please note 'SimpleSecurityLabelParser' has been deprecated and will be removed in the future. Use 'IdentityParser' instead..  # noqa: E501
