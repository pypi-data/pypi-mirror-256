...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/4.116.0/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.delete_applications_id  # this is an instance of the class Endpoint
        api_instance.delete_applications_id()  # this invokes api_instance.delete_applications_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_applications_id.callable or self.callable in this class
