"""
    ...
    The version of the OpenAPI document: 4.116.0
...
class DatasetsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_schema_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    'dataset_id': 'datasetId',
                    'include_security_field': 'includeSecurityField',
                    'include_nested_fields': 'includeNestedFields',
                },
                'location_map': {
                    'dataset_id': 'path',
                    'include_security_field': 'query',
                    'include_nested_fields': 'query',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_schema(
        ...
        **kwargs
        ...
        Keyword Args:
            include_security_field (bool): Boolean flag to include the security field (_koverse_security_label) for each schema entry.. [optional] if omitted the server will use the default value of False
            include_nested_fields (bool): Boolean flag to include nested fields of the schema such as the child fields of an object or map. To include top level fields only, keep set to false.. [optional] if omitted the server will use the default value of False
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
