...
db_marketplace_cloud_node_params = pytest.mark.parametrize(
    "creds, node_type",
    [
        ("market_creds", "aws_cpu_node"),
...
def market_creds():
    ...
    lic = sct.ckl_lic_aws_db_market
    host = sct.ckl_db_market_host
    token = sct.ckl_db_market_place_token
    return lic, host, token
