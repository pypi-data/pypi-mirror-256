...
default_values = {
    'CODT_BuildLicence': {
        ...
        'investigationarticles': [
            ...
            {'id': "R.IV.40-1.1.1", 'title': u"R.IV.40-1.§1-1° - Hauteur des constructions",
            ...
            {'id': "R.IV.40-1.1.2", 'title': u"R.IV.40-1.§1-2°- Magasin de plus de 400m2",
            ...
            {'id': "R.IV.40-1.1.3", 'title': u"R.IV.40-1.§1.3° - Usage destiné aux bureaux de plus de 650m2",
            ...
            {'id': "R.IV.40-1.1.4", 'title': u"R.IV.40-1.§1.4° - Destination à usage de stockage supérieur à 400m2",
            ...
            {'id': "R.IV.40-1.1.7", 'title': u"R.IV.40-1.§1.7° - Ouverture ou modification de la voirie communale",
            ...
            {'id': "R.IV.40-1.1.8", 'title': u"R.IV.40-1.§1.8° - Voiries régionales",
    ...
    'CODT_Article127': {
        'folderdelays': [
            ...
            {'id': "160j", 'title': u"160 jours", 'deadLineDelay': 160, 'alertDelay': 20},
            {'id': "inconnu", 'title': u"Inconnu", 'deadLineDelay': 0, 'alertDelay': 20},
        ],
        'foldercategories': [
            'UrbanVocabularyTerm',
            {'id': "art127", 'title': u"UCP permis d'urbanisme à caractère public (article 127) SANS ENQUETE "},
            {'id': "art127-e", 'title': u"UCP permis d'urbanisme à caractère public (article 127) AVEC ENQUETE "},
            {'id': "inconnu", 'title': u"Inconnu"},
        ],
        'investigationarticles': [
            'UrbanVocabularyTerm',
    ...
    'shared_vocabularies': {
        ...
        'specificfeatures': [
            'SpecificFeatureTerm', ['UrbanCertificateOne', 'CODT_UrbanCertificateOne', 'UrbanCertificateTwo', 'NotaryLetter', 'CODT_NotaryLetter'],
            {
        ...
        'opinionstoaskifworks': [
            'UrbanVocabularyTerm', ['UrbanCertificateOne', 'CODT_UrbanCertificateOne', 'UrbanCertificateTwo', 'NotaryLetter', 'CODT_NotaryLetter'],
        ...
        'folderbuildworktypes': [
            ...
            {'id': 'GRONDPUBL', 'title': u"Transformation non-bâti - Terrain pour installations publicitaires", 'extraValue': 'GRONDPUBL'},
            {'id': 'INT', 'title': u"Intégration dans voirie publique", 'extraValue': 'INT'},
            {'id': 'LEASING', 'title': u"Leasing (pour mémoire SPF Finances),", 'extraValue': 'LEASING'},
            {'id': 'LOT', 'title': u"Lotissement - Général", 'extraValue': 'LOT'},
            {'id': 'N_APPART', 'title': u"Nouvelle construction - Immeuble appartements", 'extraValue': 'N_APPART'},
            {'id': 'N_AUT', 'title': u"Nouvelle construction - Autres", 'extraValue': 'N_AUT'},
            {'id': 'N_BIJ', 'title': u"Nouvelle construction - Annexe", 'extraValue': 'N_BIJ'},
            {'id': 'N_HANDEL', 'title': u"Nouvelle construction - Commerce, horeca, services", 'extraValue': 'N_HANDEL'},
            {'id': 'N_INDUS', 'title': u"Nouvelle construction - Industrie, artisanat", 'extraValue': 'N_INDUS'},
            {'id': 'N_INFRA', 'title': u"Nouvelle construction - Infrastructures", 'extraValue': 'N_INFRA'},
            {'id': 'N_KANTOOR', 'title': u"Nouvelle construction - Bureaux", 'extraValue': 'N_KANTOOR'},
            {'id': 'N_LANDTUIN', 'title': u"Nouvelle construction - Agriculture et horticulture", 'extraValue': 'N_LANDTUIN'},
            {'id': 'N_OPENBAAR', 'title': u"Nouvelle construction - Équipement communautaire ou d'ordre public", 'extraValue': 'N_OPENBAAR'},
            {'id': 'N_TOERISME', 'title': u"Nouvelle construction - Tourisme et récréation", 'extraValue': 'N_TOERISME'},
            {'id': 'N_UNI', 'title': u"Nouvelle construction unifamiliale", 'extraValue': 'N_UNI'},
            {'id': 'ONTBOSSEN', 'title': u"Transformation non-bâti - Déboisement", 'extraValue': 'ONTBOSSEN'},
            {'id': 'OPSLAFVAL', 'title': u"Transformation non-bâti - Terrain pour entreposage", 'extraValue': 'OPSLAFVAL'},
            {'id': 'PARKING', 'title': u"Transformation non-bâti - Terrain pour parking", 'extraValue': 'PARKING'},
            {'id': 'PUBLICIT', 'title': u"Autres - Installations ou enseignes publicitaires", 'extraValue': 'PUBLICIT'},
            {'id': 'RUINE', 'title': u"Ruine", 'extraValue': 'RUINE'},
            {'id': 'S_BIJ', 'title': u"Démolition - Annexe", 'extraValue': 'S_BIJ'},
            {'id': 'S_EEN', 'title': u"Démolition - Maison unifamiliale", 'extraValue': 'S_EEN'},
            {'id': 'S_HANDEL', 'title': u"Démolition - Commerce, horeca, services", 'extraValue': 'S_HANDEL'},
            {'id': 'S_INDUS', 'title': u"Démolition - Industrie, artisanat", 'extraValue': 'S_INDUS'},
            {'id': 'S_INFRA', 'title': u"Démolition - Infrastructures", 'extraValue': 'S_INFRA'},
            {'id': 'S_KANTOOR', 'title': u"Démolition - Bureaux", 'extraValue': 'S_KANTOOR'},
            {'id': 'S_LANDTUIN', 'title': u"Démolition - Agriculture et horticulture", 'extraValue': 'S_LANDTUIN'},
            {'id': 'S_MEER', 'title': u"Démolition - Immeuble appartements", 'extraValue': 'S_MEER'},
            {'id': 'S_OPENBAAR', 'title': u"Démolition - Équipement communautaire ou d'ordre public", 'extraValue': 'S_OPENBAAR'},
            {'id': 'S_TOERISME', 'title': u"Démolition - Tourisme et récréation", 'extraValue': 'S_TOERISME'},
            {'id': 'T_APPART', 'title': u"Transformation - immeuble appartements", 'extraValue': 'T_APPART'},
            {'id': 'T_AUT', 'title': u"Transformation - autre bâtiment", 'extraValue': 'T_AUT'},
            {'id': 'T_NBAT', 'title': u"Transformation parcelle non bâtie", 'extraValue': 'T_NBAT'},
            {'id': 'T_UNI', 'title': u"Transformation habitation unifamiliale", 'extraValue': 'T_UNI'},
            {'id': 'TAUDIS', 'title': u"Taudis", 'extraValue': 'TAUDIS'},
            {'id': 'V_BIJ', 'title': u"Transformation - annexe bâtie", 'extraValue': 'V_BIJ'},
            {'id': 'V_INDUS', 'title': u"Transformation - industrie, artisanat", 'extraValue': 'V_INDUS'},
            {'id': 'V_INFRA', 'title': u"Transformation - infrastructures", 'extraValue': 'V_INFRA'},
            {'id': 'V_KANTOOR', 'title': u"Transformation - bureaux", 'extraValue': 'V_KANTOOR'},
            {'id': 'V_LANDTUIN', 'title': u"Transformation - agriculture et horticulture", 'extraValue': 'V_LANDTUIN'},
            {'id': 'V_OPENBAAR', 'title': u"Transformation - équipement communautaire ou d'ordre public", 'extraValue': 'V_OPENBAAR'},
            {'id': 'V_TOERISME', 'title': u"Transformation - tourisme et récréation", 'extraValue': 'V_TOERISME'},
            {'id': 'VELHOOGST', 'title': u"Transformation non-bâti - Abbattre arbres de haute tige", 'extraValue': 'VELHOOGST'},
            {'id': 'VERNIETG', 'title': u"Lotissement - annulation", 'extraValue': 'VERNIETG'},
            {'id': 'WIJZAANTAL', 'title': u"Transformation - Changement du nombre d'habitations", 'extraValue': 'WIJZAANTAL'},
            {'id': 'WIJZIG', 'title': u"Lotissement - changement de lotissement", 'extraValue': 'WIJZIG'},
        ...
        'offense_articles': [
            ...
            {'id': "art1.6", 'title': u"créer un nouveau logement", 'numbering': u'... '},
            {'id': "art1.7", 'title': u"modifier la destination ", 'numbering': u'... '},
            ...
            {'id': "art1.11", 'title': u"abattre a) arbres isolés à haute tige dans espaces verts", 'numbering': u'... '},
            {'id': "art1.11", 'title': u"abattre b) haies ou allées (R.IV.4-6)", 'numbering': u'... '},
            {'id': "art1.12", 'title': u"abattre arbre/haie remarquable", 'numbering': u'... '},
            {'id': "art1.13", 'title': u"défricher", 'numbering': u'... '},
            {'id': "art1.14", 'title': u"sapins de Noël", 'numbering': u'... '},
            {'id': "art1.15", 'title': u"a) dépôt véhicules, mitrailles...", 'numbering': u'... '},
            {'id': "art1.16", 'title': u"b) installations mobiles", 'numbering': u'... '},
            {'id': "art1.17", 'title': u"itravaux de restauration CoPat / liste de sauvegarde, classé ou assimilé", 'numbering': u'... '},
            {'id': "art2", 'title': u"2° poursuite sans permis préalable ou postérieurement à l’acte ou à l’arrêt de suspension du permis"},
            {'id': "art3", 'title': u"3° maintien des travaux exécutés après le 21 avril 1962 sans le permis qui était requis"},
