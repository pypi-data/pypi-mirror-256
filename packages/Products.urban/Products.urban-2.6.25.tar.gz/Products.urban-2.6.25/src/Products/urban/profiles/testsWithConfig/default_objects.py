...
default_objects = {
    'notaries': [
        ...
        {'id': "notary2", 'name1': "André", 'name2': "Sanfrapper", 'email': 'maitre.andre@notaire.be'},
    ],
    ...
    'foldermanagers': [
        'FolderManager',
        {'id': "foldermanager1", 'name1': "Dumont", 'name2': "Jean", 'grade': 'agent-technique', 'ploneUserId': 'urbanmanager'},
    ],
