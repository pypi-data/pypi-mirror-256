...
class UrbanBase(object):
    ...
    def getFolderManagersSignaletic(self, withGrade=False, withParenthesis=True, withEmail=False, withTel=False):
        """
    ...
    def getNotariesSignaletic(self, withaddress=False, linebyline=False, remove_comma=False, inverted_address=False):
        """
        ...
        for notary in notaries:
            ...
            if signaletic:
                signaletic += ' %s ' % translate('and', 'urban', context=self.REQUEST).encode('utf8')
            signaletic += notary.getSignaletic(withaddress=withaddress, linebyline=linebyline, remove_comma=remove_comma, inverted_address=inverted_address)
        return signaletic

    security.declarePublic('getContactsSignaletic')
    def getContactsSignaletic(self, contacts, withaddress=False, remove_comma=False, inverted_address=False):
        """
        ...
        for contact in contacts:
            ...
            if signaletic:
                signaletic += ' %s ' % translate('and', 'urban', context=self.REQUEST).encode('utf8')
            signaletic += contact.getSignaletic(withaddress=withaddress, remove_comma=remove_comma, inverted_address=inverted_address)
        return signaletic
    ...
    def getArchitectsSignaletic(self, withaddress=False, remove_comma=False, inverted_address=False):
        ...
        """
        return self.getContactsSignaletic(self.getArchitects(), withaddress=withaddress, remove_comma=remove_comma, inverted_address=inverted_address)

    security.declarePublic('getGeometriciansSignaletic')
    def getGeometriciansSignaletic(self, withaddress=False, remove_comma=False, inverted_address=False):
        """
          Returns a string reprensenting the signaletic of every geometricians
        """
        return self.getContactsSignaletic(self.getGeometricians(), withaddress=withaddress, remove_comma=remove_comma, inverted_address=inverted_address)
