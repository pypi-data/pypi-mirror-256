...
class Text(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "text"
    value: str
...
class Url(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "url"
    text: str | None = None
...
class Code(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "code"
    value: str
...
class Value(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "value"
...
class Diff(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "diff"
    before: str
    after: str
...
class Markdown(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "markdown"
    value: Annotated[
        str,
        Field(
            examples=[
...
class Commit(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "commit"
...
class FileLocation(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "file-location"
...
class ModuleLocation(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "module-location"
...
class Vulnerability(BaseModel):
    ...
    details: dict[str, NamedField] | None = None
    tracking: Annotated[
        Tracking | None,
...
class ReportFormatForGitlabDependencyScanning(BaseModel):
    ...
    remediations: Annotated[
        ...
        Field(
            description=(
                "An array of objects containing information on available remediations,"
                " along with patch diffs to apply."
            )
        ),
    ] = None
...
class NamedList(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "named-list"
    items: dict[str, NamedField]


class ListModel(BaseModel):
    """A list of typed fields."""

    type: Annotated[str, Field(const=True)] = "list"
    items: list[
        NamedList
        | ListModel
        | Table
...
class Table(BaseModel):
    ...
    type: Annotated[str, Field(const=True)] = "table"
    header: list[
        NamedList
        | ListModel
        | Table
