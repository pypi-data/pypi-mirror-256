...
from ...models.body_soft_delete_entries_by_file_exact_entries_by_file_soft_delete_delete import (
...
def _get_kwargs(
    *,
    ...
    url = "{}/exact/entries/by-file/soft-delete".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Soft Delete Entries By File

     Soft-delete entries in exact collections by rehashing files
