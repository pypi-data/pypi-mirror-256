...
setup(
    name='invoicing-make',  # * Your package will have this name
    ...
    author='Rahul Deka',  # Your name
    author_email='app8flaskdjango@gmail.com',  # Your email
    url='https://github.com/rd030686',  # Homepage of your library (e.g. gitHub or your website)
