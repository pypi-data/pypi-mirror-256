...
extern PyObject *global_constants[82];
// ()
...
// 'name'
#define const_str_plain_name global_constants[44]
// 'globals'
#define const_str_plain_globals global_constants[45]
// 'locals'
#define const_str_plain_locals global_constants[46]
// 'fromlist'
#define const_str_plain_fromlist global_constants[47]
// 'level'
#define const_str_plain_level global_constants[48]
// 'read'
#define const_str_plain_read global_constants[49]
// 'rb'
#define const_str_plain_rb global_constants[50]
// '/'
#define const_str_slash global_constants[51]
// '\\'
#define const_str_backslash global_constants[52]
// 'path'
#define const_str_plain_path global_constants[53]
// 'basename'
#define const_str_plain_basename global_constants[54]
// 'dirname'
#define const_str_plain_dirname global_constants[55]
// 'abspath'
#define const_str_plain_abspath global_constants[56]
// 'isabs'
#define const_str_plain_isabs global_constants[57]
// 'exists'
#define const_str_plain_exists global_constants[58]
// 'isdir'
#define const_str_plain_isdir global_constants[59]
// 'isfile'
#define const_str_plain_isfile global_constants[60]
// 'listdir'
#define const_str_plain_listdir global_constants[61]
// 'getattr'
#define const_str_plain_getattr global_constants[62]
// '__cached__'
#define const_str_plain___cached__ global_constants[63]
// 'print'
#define const_str_plain_print global_constants[64]
// 'end'
#define const_str_plain_end global_constants[65]
// 'file'
#define const_str_plain_file global_constants[66]
// 'bytes'
#define const_str_plain_bytes global_constants[67]
// '.'
#define const_str_dot global_constants[68]
// '_'
#define const_str_underscore global_constants[69]
// '__loader__'
#define const_str_plain___loader__ global_constants[29]
// 'send'
#define const_str_plain_send global_constants[70]
// 'throw'
#define const_str_plain_throw global_constants[71]
// 'close'
#define const_str_plain_close global_constants[72]
// '__spec__'
#define const_str_plain___spec__ global_constants[73]
// '_initializing'
#define const_str_plain__initializing global_constants[74]
// 'parent'
#define const_str_plain_parent global_constants[75]
// 'types'
#define const_str_plain_types global_constants[76]
// '__class_getitem__'
#define const_str_plain___class_getitem__ global_constants[77]
// 'reconfigure'
#define const_str_plain_reconfigure global_constants[78]
// 'encoding'
#define const_str_plain_encoding global_constants[79]
// 'line_buffering'
#define const_str_plain_line_buffering global_constants[80]
// 'fileno'
#define const_str_plain_fileno global_constants[81]
#endif
