...
class OmitTypeClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, policy_code, account_number, code, type, invoice_number, net_amount, tax_amount, credit_amount, gross_amount, status, due_date, metadata, billing_interval_from, billing_interval_to, created_at, invoice_items, currency, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, policy_code, account_number, code, type, invoice_number, net_amount, tax_amount, credit_amount, gross_amount, status, due_date, metadata, billing_interval_from, billing_interval_to, created_at, invoice_items, currency, *args, **kwargs):  # noqa: E501
        """OmitTypeClass - a model defined in OpenAPI
