...
class CreateTerminationInvoiceRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, policy_code, account_number, billing_interval_from, billing_interval_to, *args, **kwargs):  # noqa: E501
        """CreateTerminationInvoiceRequestDto - a model defined in OpenAPI

        Args:
            policy_code (str):
            account_number (str):
            billing_interval_from (datetime):
            billing_interval_to (datetime):
    ...
    @convert_js_args_to_python_args
    def __init__(self, policy_code, account_number, billing_interval_from, billing_interval_to, *args, **kwargs):  # noqa: E501
        """CreateTerminationInvoiceRequestDto - a model defined in OpenAPI
