...
with eis.billing.ApiClient(configuration) as api_client:
    ...
    create_invoice_request_dto = CreateInvoiceRequestDto(
        ...
        policy_code="pol_uoBEDIg3mjxWZEUyvZMsw",
        type="initial",
        metadata={},
        billing_interval_from=dateutil_parser('2024-05-07T14:37:28.115Z'),
        billing_interval_to=dateutil_parser('2024-06-07T14:37:28.115Z'),
        due_date=dateutil_parser('2024-05-07T14:37:28.115Z'),
...
*InvoicesApi* | [**get_invoice**](docs/InvoicesApi.md#get_invoice) | **GET** /billingservice/v1/invoices/{code} | List invoices
