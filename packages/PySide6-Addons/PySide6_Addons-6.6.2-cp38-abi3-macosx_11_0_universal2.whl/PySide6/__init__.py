...
def _find_all_qt_modules():
    ...
    in_build = Path("/Users/qt/work/pyside/pyside-setup/build/qfpa-py3.9-qt6.6.2-64bit-release/build/pyside6") in location.parents
