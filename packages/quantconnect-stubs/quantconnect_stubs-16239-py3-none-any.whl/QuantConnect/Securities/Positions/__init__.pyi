...
class PositionExtensions(System.Object):
    ...
    @staticmethod
    def GetGroupQuantity(position: QuantConnect.Securities.Positions.IPosition) -> float:
        """
...
class SecurityPositionGroupModel(System.Object):
    ...
    @property
    def PositionGroupBuyingPowerModel(self) -> QuantConnect.Securities.Positions.IPositionGroupBuyingPowerModel:
        """
    ...
    def GetPositionGroupResolver(self) -> QuantConnect.Securities.Positions.IPositionGroupResolver:
        """
    ...
    def TryCreatePositionGroup(self, orders: System.Collections.Generic.List[QuantConnect.Orders.Order], group: typing.Optional[QuantConnect.Securities.Positions.IPositionGroup]) -> typing.Union[bool, QuantConnect.Securities.Positions.IPositionGroup]:
        """
...
class PortfolioState(System.Object):
    ...
    @property
    def PositionGroups(self) -> System.Collections.Generic.List[QuantConnect.Securities.Positions.PositionGroupState]:
    ...
    @staticmethod
    def Create(portfolioManager: QuantConnect.Securities.SecurityPortfolioManager, utcNow: typing.Union[datetime.datetime, datetime.date], currentPortfolioValue: float) -> QuantConnect.Securities.Positions.PortfolioState:
...
class PortfolioMarginChart(System.Object):
    ...
    @staticmethod
    def AddSample(portfolioChart: QuantConnect.Chart, portfolioState: QuantConnect.Securities.Positions.PortfolioState, mapFileProvider: QuantConnect.Interfaces.IMapFileProvider, currentTime: typing.Union[datetime.datetime, datetime.date]) -> None:
        """Helper method to add the portfolio margin series into the given chart"""
        ...

    @staticmethod
    def RemoveSinglePointSeries(portfolioChart: QuantConnect.Chart) -> None:
...
class PositionGroupBuyingPowerModel(System.Object, QuantConnect.Securities.Positions.IPositionGroupBuyingPowerModel, metaclass=abc.ABCMeta):
    ...
    def GetPositionGroupOrderQuantity(self, portfolio: QuantConnect.Securities.SecurityPortfolioManager, currentPositionGroup: QuantConnect.Securities.Positions.IPositionGroup, currentUsedMargin: float, targetFinalMargin: float, groupUnit: QuantConnect.Securities.Positions.IPositionGroup, unitMargin: float, finalMargin: typing.Optional[float]) -> typing.Union[float, float]:
        ...
    ...
    @staticmethod
    def UnableToConverge(currentMarginDifference: float, lastMarginDifference: float, groupUnit: QuantConnect.Securities.Positions.IPositionGroup, portfolio: QuantConnect.Securities.SecurityPortfolioManager, positionGroupQuantity: float, targetMargin: float, currentMargin: float, absUnitMargin: float, error: typing.Optional[System.ArgumentException]) -> typing.Union[bool, System.ArgumentException]:
        """
...
class PositionGroup(System.Object, QuantConnect.Securities.Positions.IPositionGroup, typing.Iterable[QuantConnect.Securities.Positions.IPosition]):
    ...
    @staticmethod
    def Empty(buyingPowerModel: QuantConnect.Securities.Positions.IPositionGroupBuyingPowerModel) -> QuantConnect.Securities.Positions.PositionGroup:
        """
...
class PositionGroupExtensions(System.Object):
    ...
    @staticmethod
    def Closes(finalGroup: QuantConnect.Securities.Positions.IPositionGroup, initialGroup: QuantConnect.Securities.Positions.IPositionGroup) -> bool:
        """
        Checks whether the provided groups are closing/reducing each other, that is, each of their positions are in opposite sides.
        
        :param finalGroup: The final position group that would result from a trade
        :param initialGroup: The initial position group before a trade
        :returns: Whether final resulting position group is a reduction of the initial one.
        """
        ...

    @staticmethod
    def CreateUnitGroup(template: QuantConnect.Securities.Positions.IPositionGroup, positionMananger: QuantConnect.Securities.Positions.SecurityPositionGroupModel) -> QuantConnect.Securities.Positions.IPositionGroup:
        """
    ...
    @staticmethod
    def IsEmpty(positionGroup: QuantConnect.Securities.Positions.IPositionGroup) -> bool:
        ...

    @staticmethod
    def IsInvertedOf(group: QuantConnect.Securities.Positions.IPositionGroup, other: QuantConnect.Securities.Positions.IPositionGroup) -> bool:
        """
    ...
    @staticmethod
    def WithQuantity(template: QuantConnect.Securities.Positions.IPositionGroup, groupQuantity: float, positionMananger: QuantConnect.Securities.Positions.SecurityPositionGroupModel) -> QuantConnect.Securities.Positions.IPositionGroup:
        """
        ...
        :param positionMananger: The position manager to use to resolve positions
        :returns: A position group with the same position ratios as the template but with the specified group quantity.
        """
        ...
