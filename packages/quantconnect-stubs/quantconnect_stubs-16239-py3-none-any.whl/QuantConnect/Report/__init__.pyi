...
class Rolling(System.Object):
    ...
    @staticmethod
    def Beta(performancePoints: System.Collections.Generic.SortedList[datetime.datetime, float], benchmarkPoints: System.Collections.Generic.SortedList[datetime.datetime, float], windowSize: int = 132) -> typing.Any:
        """
        Calculate the rolling beta with the given window size (in days)
        
        :param performancePoints: The performance points you want to measure beta for
        :param benchmarkPoints: The benchmark/points you want to calculate beta with
    ...
    @staticmethod
    def Sharpe(equityCurve: typing.Any, months: int, tradingDayPerYear: int) -> typing.Any:
        """
        ...
        :param tradingDayPerYear: The number of trading days per year to increase result of Annual statistics
...
class ResultsUtil(System.Object):
    ...
    @staticmethod
    def EquityPoints(result: QuantConnect.Result, seriesName: str = None) -> System.Collections.Generic.SortedList[datetime.datetime, float]:
        """
        Get the points, from the Series name given, in Strategy Equity chart
        
        :param result: Result object to extract the chart points
        :param seriesName: Series name from which the points will be extracted. By default is Equity series
        """
        ...
...
class Report(System.Object):
    ...
    @staticmethod
    def GetRegexInInput(pattern: str, input: str) -> str:
        """
