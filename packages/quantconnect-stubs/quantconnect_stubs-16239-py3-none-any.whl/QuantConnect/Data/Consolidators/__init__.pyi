...
class ClassicRenkoConsolidator(typing.Generic[QuantConnect_Data_Consolidators_ClassicRenkoConsolidator_TInput], QuantConnect_Data_Consolidators_ClassicRenkoConsolidator):
    ...
    @property
    def CurrentBar(self) -> QuantConnect.Data.Market.RenkoBar:
        """
        Bar being created
    ...
    def CreateNewBar(self, data: QuantConnect.Data.IBaseData, currentValue: float, volume: float) -> None:
        """
        ...
        :param currentValue: The new value for the bar
    ...
    def UpdateBar(self, time: typing.Union[datetime.datetime, datetime.date], currentValue: float, volume: float) -> None:
        """
        ...
        :param currentValue: Value of the given data
...
class PeriodCountConsolidatorBase(typing.Generic[QuantConnect_Data_Consolidators_PeriodCountConsolidatorBase_T, QuantConnect_Data_Consolidators_PeriodCountConsolidatorBase_TConsolidated], QuantConnect.Data.Consolidators.DataConsolidator[QuantConnect_Data_Consolidators_PeriodCountConsolidatorBase_T], metaclass=abc.ABCMeta):
    ...
    @overload
    def GetRoundedBarTime(self, inputData: QuantConnect.Data.IBaseData) -> datetime.datetime:
        """
        Gets a rounded-down bar start time. Called by AggregateBar in derived classes.
        
        This method is protected.
        
        :param inputData: The input data point
...
class BaseTimelessConsolidator(typing.Generic[QuantConnect_Data_Consolidators_BaseTimelessConsolidator_T], System.Object, QuantConnect.Data.Consolidators.IDataConsolidator, metaclass=abc.ABCMeta):
    ...
    @property
    def VolumeSelector(self) -> typing.Callable[[QuantConnect.Data.IBaseData], float]:
        """
    ...
    @property
    def DataConsolidatedHandler(self) -> typing.Callable[[System.Object, QuantConnect.Data.IBaseData], None]:
        """
    ...
    @property
    def CurrentBar(self) -> QuantConnect_Data_Consolidators_BaseTimelessConsolidator_T:
        """
        Bar being created
    ...
    @property
    def DataConsolidated(self) -> _EventContainer[typing.Callable[[System.Object, QuantConnect_Data_Consolidators_BaseTimelessConsolidator_T], None], None]:
        """Event handler that fires when a new piece of data is produced"""
        ...
    ...
    def OnDataConsolidated(self, consolidated: QuantConnect_Data_Consolidators_BaseTimelessConsolidator_T) -> None:
        """
        Event invocator for the DataConsolidated event. This should be invoked
        by derived classes when they have consolidated a new piece of data.
...
class RangeConsolidator(QuantConnect.Data.Consolidators.BaseTimelessConsolidator[QuantConnect.Data.Market.RangeBar]):
    ...
    @property
    def CurrentBar(self) -> QuantConnect.Data.Market.RangeBar:
        """
        Bar being created
...
class VolumeRenkoConsolidator(QuantConnect.Data.Consolidators.DataConsolidator[QuantConnect.Data.BaseData]):
    ...
    @property
    def DataConsolidated(self) -> _EventContainer[typing.Callable[[System.Object, QuantConnect.Data.Market.VolumeRenkoBar], None], None]:
        """Event handler that fires when a new piece of data is produced"""
        ...
    ...
    def OnDataConsolidated(self, consolidated: QuantConnect.Data.Market.VolumeRenkoBar) -> None:
        """
        Event invocator for the DataConsolidated event. This should be invoked
        by derived classes when they have consolidated a new piece of data.
