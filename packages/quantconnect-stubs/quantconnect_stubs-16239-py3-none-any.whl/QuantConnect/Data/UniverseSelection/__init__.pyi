...
class BaseDataCollection(QuantConnect.Data.BaseData, typing.Iterable[QuantConnect.Data.BaseData]):
    ...
    def UniverseSymbol(self) -> QuantConnect.Symbol:
...
class CryptoCoarseFundamentalUniverse(QuantConnect.Data.UniverseSelection.Universe):
    ...
    @overload
    def __init__(self, market: str, universeSettings: QuantConnect.Data.UniverseSelection.UniverseSettings, selector: typing.Callable[[System.Collections.Generic.IEnumerable[QuantConnect.DataSource.CryptoCoarseFundamental]], System.Collections.Generic.IEnumerable[QuantConnect.Symbol]]) -> None:
        """
        Initializes a new instance of the CryptoCoarseFundamentalUniverse class
    ...
    def CreateConfiguration(symbol: typing.Union[QuantConnect.Symbol, str]) -> QuantConnect.Data.SubscriptionDataConfig:
        """
        Creates a CryptoCoarseFundamental subscription configuration for the selected Crypto market
...
class FundamentalUniverse(QuantConnect.Data.UniverseSelection.Universe):
    ...
    @overload
    def __init__(self, universeSettings: QuantConnect.Data.UniverseSelection.UniverseSettings, selector: typing.Callable[[System.Collections.Generic.IEnumerable[QuantConnect.Data.Fundamental.Fundamental]], System.Collections.Generic.IEnumerable[QuantConnect.Symbol]]) -> None:
        """
        Initializes a new instance of the FundamentalUniverse class
...
class FundamentalFilteredUniverse(QuantConnect.Data.UniverseSelection.SelectSymbolsUniverseDecorator):
    ...
    @property
    def FundamentalUniverse(self) -> QuantConnect.Data.UniverseSelection.FundamentalUniverse:
