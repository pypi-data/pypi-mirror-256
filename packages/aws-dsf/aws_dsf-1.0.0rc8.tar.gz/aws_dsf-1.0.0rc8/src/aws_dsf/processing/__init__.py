...
from ..utils import (
    ...
    Architecture as _Architecture_b976ded7,
)


@jsii.enum(jsii_type="aws-dsf.processing.EmrContainersRuntimeVersion")
...
class KarpenterVersion(enum.Enum):
    '''The list of supported Karpenter versions as defined `here <https://github.com/aws/karpenter/releases>`_ At this time only v0.32.1 is supported.'''
...
class PySparkApplicationPackage(
    ...
    def __init__(
        ...
        *,
        ...
        :param asset_upload_role: The IAM Role used by the Lambda function. Additional permissions would be granted to this role such as S3 Bucket permissions. Default: - A new Role would be created with least privilege permissions
...
class SparkEmrContainersRuntime(
    ...
    def grant_start_job_execution(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__af6abc78ed40c5e16289df92311e2d47902a225bc6ece5f2460296d076c81c33)
    ...
    def add_interactive_endpoint(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f6f1b4433062af7a3cf7f74986e979d2b29760fd32e8cc2a77fe8e875b6025ed)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_karpenter_node_pool_and_node_class(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2936b63f0775eb1f47a6913343474a1f091fb80e43147393afc1895f5e4adf1d)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
@jsii.data_type(
    jsii_type="aws-dsf.processing.SparkEmrContainersRuntimeInteractiveSessionProps",
    jsii_struct_bases=[],
    name_mapping={
...
class SparkEmrContainersRuntimeInteractiveSessionProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e4bf32be8119f1d1794dfe87e2373736083c233aeac4cecd71aded32b64d3810)
...
class SparkEmrServerlessRuntime(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        architecture: typing.Optional[_Architecture_b976ded7] = None,
...
class SparkEmrServerlessRuntimeProps:
    ...
    @builtins.property
    def architecture(self) -> typing.Optional[_Architecture_b976ded7]:
        '''The CPU architecture type of the application.

        :default: - x86_64
        '''
        result = self._values.get("architecture")
        return typing.cast(typing.Optional[_Architecture_b976ded7], result)
...
class SparkEmrContainersJob(
    SparkJob,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-dsf.processing.SparkEmrContainersJob",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6102d5e0ed5c8d1076befe3c92bd4bd7204c8065f9b4ef95380348af047146bb)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def _grant_execution_role(self, role: _aws_cdk_aws_iam_ceddda9d.IRole) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__067a02fc64f54e94d432cd82f504bd842cff6123524cb5ecfde46834f5d8df12)
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
        return typing.cast(None, jsii.invoke(self, "grantExecutionRole", [role]))
...
@jsii.data_type(
    jsii_type="aws-dsf.processing.SparkEmrContainersJobApiProps",
...
class SparkEmrContainersJobApiProps(SparkJobProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9563cc2304b495abd4bd4849e2ec3d51fe8785108fb1bb5e06f0efd05acb262d)
            check_type(argname="argument removal_policy", value=removal_policy, expected_type=type_hints["removal_policy"])
            check_type(argname="argument schedule", value=schedule, expected_type=type_hints["schedule"])
...
@jsii.data_type(
    jsii_type="aws-dsf.processing.SparkEmrContainersJobProps",
    jsii_struct_bases=[SparkJobProps],
    name_mapping={
        "removal_policy": "removalPolicy",
        "schedule": "schedule",
...
class SparkEmrContainersJobProps(SparkJobProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e738b4324f66e4cc6bfa718b702f5db6d9e0fbb31a3db2e35c5a4aaf884a998d)
            check_type(argname="argument removal_policy", value=removal_policy, expected_type=type_hints["removal_policy"])
            check_type(argname="argument schedule", value=schedule, expected_type=type_hints["schedule"])
            check_type(argname="argument execution_role", value=execution_role, expected_type=type_hints["execution_role"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
...
def _typecheckingstub__af6abc78ed40c5e16289df92311e2d47902a225bc6ece5f2460296d076c81c33(
    start_job_role: _aws_cdk_aws_iam_ceddda9d.IRole,
    execution_role_arn: typing.Sequence[builtins.str],
    virtual_cluster_arn: builtins.str,
) -> None:
...
def _typecheckingstub__f6f1b4433062af7a3cf7f74986e979d2b29760fd32e8cc2a77fe8e875b6025ed(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    execution_role: _aws_cdk_aws_iam_ceddda9d.IRole,
...
def _typecheckingstub__2936b63f0775eb1f47a6913343474a1f091fb80e43147393afc1895f5e4adf1d(
    id: builtins.str,
    manifest: typing.Any,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__e4bf32be8119f1d1794dfe87e2373736083c233aeac4cecd71aded32b64d3810(
    *,
    execution_role: _aws_cdk_aws_iam_ceddda9d.IRole,
    managed_endpoint_name: builtins.str,
    virtual_cluster_id: builtins.str,
...
def _typecheckingstub__6102d5e0ed5c8d1076befe3c92bd4bd7204c8065f9b4ef95380348af047146bb(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    props: typing.Union[typing.Union[SparkEmrContainersJobProps, typing.Dict[builtins.str, typing.Any]], typing.Union[SparkEmrContainersJobApiProps, typing.Dict[builtins.str, typing.Any]]],
) -> None:
...
def _typecheckingstub__067a02fc64f54e94d432cd82f504bd842cff6123524cb5ecfde46834f5d8df12(
    role: _aws_cdk_aws_iam_ceddda9d.IRole,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9563cc2304b495abd4bd4849e2ec3d51fe8785108fb1bb5e06f0efd05acb262d(
    *,
    removal_policy: typing.Optional[_aws_cdk_ceddda9d.RemovalPolicy] = None,
    schedule: typing.Optional[_aws_cdk_aws_events_ceddda9d.Schedule] = None,
    job_config: typing.Mapping[builtins.str, typing.Any],
...
def _typecheckingstub__e738b4324f66e4cc6bfa718b702f5db6d9e0fbb31a3db2e35c5a4aaf884a998d(
    *,
    removal_policy: typing.Optional[_aws_cdk_ceddda9d.RemovalPolicy] = None,
    schedule: typing.Optional[_aws_cdk_aws_events_ceddda9d.Schedule] = None,
    execution_role: _aws_cdk_aws_iam_ceddda9d.IRole,
