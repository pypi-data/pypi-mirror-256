...
class DataFlowKeyClass(_Aspect):
    ...
    ASPECT_INFO = {'keyForEntity': 'dataFlow', 'entityCategory': 'core', 'entityAspects': ['domains', 'deprecation', 'versionInfo', 'dataFlowInfo', 'editableDataFlowProperties', 'ownership', 'status', 'globalTags', 'browsePaths', 'glossaryTerms', 'institutionalMemory', 'dataPlatformInstance', 'browsePathsV2', 'structuredProperties', 'forms']}
...
class QueryPropertiesClass(_Aspect):
    ...
    def __init__(self,
        ...
        name: Union[None, str]=None,
        description: Union[None, str]=None,
        dataPlatform: Union[None, str]=None,
    ):
        super().__init__()
    ...
    def _restore_defaults(self) -> None:
        ...
        self.created = AuditStampClass._construct_with_defaults()
        self.lastModified = AuditStampClass._construct_with_defaults()
        self.dataPlatform = self.RECORD_SCHEMA.fields_dict["dataPlatform"].default
    ...
    @property
    def dataPlatform(self) -> Union[None, str]:
        """The urn of the DataPlatform where the Query was executed."""
        return self._inner_dict.get('dataPlatform')  # type: ignore
    
    @dataPlatform.setter
    def dataPlatform(self, value: Union[None, str]) -> None:
        self._inner_dict['dataPlatform'] = value
