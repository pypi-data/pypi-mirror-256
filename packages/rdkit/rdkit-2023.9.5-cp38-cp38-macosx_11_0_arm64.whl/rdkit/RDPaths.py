...
RDCodeDir=os.path.join(r'/Users/runner/work/rdkit-pypi/rdkit-pypi/build/temp.macosx-11.0-arm64-cpython-38/rdkit_install/lib/python3.8/site-packages','rdkit')
