 ...
 * fully compatible with the latest version of SurrealDB (1.2.0), including [live queries](https://surrealdb.com/products/lq) and [change feeds](https://surrealdb.com/products/cf)
