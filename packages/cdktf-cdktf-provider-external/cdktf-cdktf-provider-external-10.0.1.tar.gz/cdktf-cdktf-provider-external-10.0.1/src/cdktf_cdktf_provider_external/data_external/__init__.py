...
class DataExternal(
    ...
    def __init__(
        ...
        *,
        ...
        :param program: A list of strings, whose first element is the program to run and whose subsequent elements are optional command line arguments to the program. Terraform does not execute the program through a shell, so it is not necessary to escape shell metacharacters nor add quotes around arguments containing spaces. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/external/2.3.3/docs/data-sources/external#program DataExternal#program}
        :param query: A map of string values to pass to the external program as the query arguments. If not supplied, the program will receive an empty object as its input. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/external/2.3.3/docs/data-sources/external#query DataExternal#query}
        :param working_dir: Working directory of the program. If not supplied, the program will run in the current directory. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/external/2.3.3/docs/data-sources/external#working_dir DataExternal#working_dir}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fa3093b8c30a19763467224131a7c1ebb4dfed7524165b964b44e2759e1207be)
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataExternal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/external/2.3.3/docs/data-sources/external#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the DataExternal to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7c20ee0fb14c781fd17f45e1e107e357d31c09d5d99c8dbe11e43758d1593490)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def program(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c1f4c9539ca7ec5dcb4458607628da8d2a2326b650b77a9d718aef73109e4a04)
    ...
    def query(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7665710703841329dbb36f84d7d3dec7f6777936145b67ed2ca50fcba3e55493)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def working_dir(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__73db18590de315ff8aafe67274b28ab0516a29153fbb0cd9e57f41704da1218a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "workingDir", value)


@jsii.data_type(
    jsii_type="@cdktf/provider-external.dataExternal.DataExternalConfig",
...
def _typecheckingstub__fa3093b8c30a19763467224131a7c1ebb4dfed7524165b964b44e2759e1207be(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    program: typing.Sequence[builtins.str],
...
def _typecheckingstub__7c20ee0fb14c781fd17f45e1e107e357d31c09d5d99c8dbe11e43758d1593490(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
...
def _typecheckingstub__c1f4c9539ca7ec5dcb4458607628da8d2a2326b650b77a9d718aef73109e4a04(
    value: typing.List[builtins.str],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7665710703841329dbb36f84d7d3dec7f6777936145b67ed2ca50fcba3e55493(
    value: typing.Mapping[builtins.str, builtins.str],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__73db18590de315ff8aafe67274b28ab0516a29153fbb0cd9e57f41704da1218a(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
