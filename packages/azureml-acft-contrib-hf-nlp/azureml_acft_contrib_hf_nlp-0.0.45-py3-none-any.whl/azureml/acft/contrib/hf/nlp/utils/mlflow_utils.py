...
from ..constants.constants import MLFlowHFFlavourConstants, MLFLOW_FLAVORS, SaveFileConstants
...
class SaveMLflowModelCallback(TrainerCallback):
    ...
    def save_oss_flavor_mlflow_model(self, model, tokenizer, py_code_files):
        ...
        conda_env=str(Path(self.model_name_or_path, SaveFileConstants.CONDA_FILE_SAVE_PATH)),
