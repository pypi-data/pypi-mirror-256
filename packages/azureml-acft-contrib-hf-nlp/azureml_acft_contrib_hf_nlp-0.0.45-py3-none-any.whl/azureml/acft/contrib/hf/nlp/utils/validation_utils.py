...
from ..constants.constants import AzuremlConstants, DatasetSplit, ValidationConstants
...
class AzuremlValidatorMixin(ABC):
    ...
    def apply_common_validations(self, split, batch_size: int = 1000) -> None:
        """
    ...
    def check_min_train_samples(self) -> None:
        """
