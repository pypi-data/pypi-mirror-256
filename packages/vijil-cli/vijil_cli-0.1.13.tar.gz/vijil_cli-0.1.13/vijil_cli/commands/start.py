...
from vijil_cli.evaluations.options import DTYPE_CHOICES, MODEL_HUB_CHOICES, PROBES_CHOICES, PROBES_DIMENSIONS_MAPPING
from vijil_cli.utils import generate_default_job_name
from vijil_cli.vijilapi.api_handler import get_headers, list_job_request, send_evaluation_request
...
def evaluation(model_hub, model_name, dimension, deployment_type, generations, token):
    try:
        ...
        result = send_evaluation_request(model_hub, model_name, probes, generations, job_name, deployment_type, token)
