...
import numpy
__all__ = ['edgeBitSetFromBools', 'faceBitSetFromBools', 'getNumpy3Darray', 'getNumpyBitSet', 'getNumpyCurvature', 'getNumpyCurvatureGradient', 'getNumpyFaces', 'getNumpyVerts', 'meshFromFacesVerts', 'meshFromUVPoints', 'pointCloudFromPoints', 'polyline2FromPoints', 'simpleVolumeFrom3Darray', 'undirectedEdgeBitSetFromBools', 'vertBitSetFromBools']
...
def getNumpy3Darray(simpleVolume: meshlib.mrmeshpy.SimpleVolume) -> numpy.ndarray[numpy.float64]:
    ...
    """
def getNumpyBitSet(bitset: meshlib.mrmeshpy.BoostBitSet) -> numpy.ndarray[bool]:
    """
...
def getNumpyVerts(mesh: meshlib.mrmeshpy.Mesh) -> numpy.ndarray[numpy.float64]:
    ...
    """
def meshFromFacesVerts(faces: typing_extensions.Buffer, verts: typing_extensions.Buffer) -> meshlib.mrmeshpy.Mesh:
    """
...
def polyline2FromPoints(points: typing_extensions.Buffer) -> meshlib.mrmeshpy.Polyline2:
    ...
    """
def simpleVolumeFrom3Darray(3DvoxelsArray: typing_extensions.Buffer) -> meshlib.mrmeshpy.SimpleVolume:
    """
