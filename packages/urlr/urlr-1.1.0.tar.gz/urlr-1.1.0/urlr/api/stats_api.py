...
class StatsApi:
    ...
    def stats(
        self,
        stats_request: Annotated[Optional[StatsRequest], Field(description="Infos to provide to get statistics of a link")] = None,
        ...
        :param stats_request: Infos to provide to get statistics of a link
        :type stats_request: StatsRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Stats200Response",
            '400': "Stats400Response",
        }
