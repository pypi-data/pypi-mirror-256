...
class PolicyStorage(
    ...
    def delete_after_days(self, value: jsii.Number) -> None:
        ...
        jsii.set(self, "deleteAfterDays", value)
    ...
    def delete_after_overridable(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deleteAfterOverridable", value)
    ...
    def retain_for_days(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "retainForDays", value)
    ...
    def retain_for_overridable(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "retainForOverridable", value)
