...
ALL_COMPONENTS = ["FOMM_KpDetector", "FOMM_Generator"]
...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    components_dict = {}
    if "FOMM_KpDetector" in components:
        components_dict["FOMM_KpDetector"] = model.detector_model
    if "FOMM_Generator" in components:
        components_dict["FOMM_Generator"] = model.generator_model
