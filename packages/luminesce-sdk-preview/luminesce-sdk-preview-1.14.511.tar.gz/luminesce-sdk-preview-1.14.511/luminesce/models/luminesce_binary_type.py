...
"""
    ...
    The version of the OpenAPI document: 1.14.511
...
class LuminesceBinaryType(object):
    ...
    allowable_values = [COMMANDLINETOOL, LOCALFILESYSTEM_PROVIDERS, EMAIL_PROVIDERS, PYTHON_PROVIDERS, AWSS3_PROVIDERS, SQLDB_PROVIDERS_DB2LINUX, SQLDB_PROVIDERS_MYSQL, SQLDB_PROVIDERS_ORACLE, SQLDB_PROVIDERS_ORACLE_SNOWFLAKE, SQLDB_PROVIDERS_POSTGRESQL, SQLDB_PROVIDERS_SNOWFLAKE, SQLDB_PROVIDERS_SQLSERVER, SQLDB_PROVIDERS_SYBASEASE, JDBC_DRIVER]  # noqa: E501
