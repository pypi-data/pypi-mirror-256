...
class PlanResult(BaseModel):
    """
    Planning result. It can be intermediate (during the calculation process) and complete (after the calculation is completed).   # noqa: E501
    """
    tracedata: Tracedata
    trips: Annotated[List[Trip], Field(min_length=0, max_length=15001)] = Field(description="Schedule of trips assigned to performers.")
