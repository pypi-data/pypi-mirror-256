...
class ReplanTask(BaseModel):
    ...
    __properties = ["locations", "orders", "performers", "transports", "hardlinks", "trips", "facts", "external_routing", "replan_settings", "dataset_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReplanTask:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReplanTask:
        """Create an instance of ReplanTask from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReplanTask.parse_obj(obj)

        _obj = ReplanTask.parse_obj({
