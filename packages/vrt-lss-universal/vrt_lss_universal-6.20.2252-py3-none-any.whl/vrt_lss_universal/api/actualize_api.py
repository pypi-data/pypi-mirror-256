...
class ActualizeApi:
    ...
    def run_actualize_calculation(self, actualize_task : Annotated[ActualizeTask, Field(description="New request for actualization.")], **kwargs) -> PlanResult:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the run_actualize_calculation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.run_actualize_calculation_with_http_info(actualize_task, **kwargs)  # noqa: E501

    @validate_arguments
    def run_actualize_calculation_with_http_info(self, actualize_task : Annotated[ActualizeTask, Field(description="New request for actualization.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Actualization (SYNC)  # noqa: E501
        ...
        _body_params = None
        if _params['actualize_task'] is not None:
    ...
    def run_actualize_refining(self, actualize_task : Annotated[ActualizeTask, Field(description="Data for refine.")], **kwargs) -> ActualizeTask:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the run_actualize_refining_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.run_actualize_refining_with_http_info(actualize_task, **kwargs)  # noqa: E501

    @validate_arguments
    def run_actualize_refining_with_http_info(self, actualize_task : Annotated[ActualizeTask, Field(description="Data for refine.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Data refine  # noqa: E501
    ...
    def run_actualize_validation(self, actualize_task : Annotated[ActualizeTask, Field(description="Data for validation.")], **kwargs) -> ValidateResult:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the run_actualize_validation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.run_actualize_validation_with_http_info(actualize_task, **kwargs)  # noqa: E501

    @validate_arguments
    def run_actualize_validation_with_http_info(self, actualize_task : Annotated[ActualizeTask, Field(description="Data for validation.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Data validation  # noqa: E501
