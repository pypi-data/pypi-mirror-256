...
class ReplanApi:
    ...
    def cancel_replan_calculation_async(self, id : Annotated[StrictStr, Field(description="Calculation identifier.")], **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the cancel_replan_calculation_async_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.cancel_replan_calculation_async_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def cancel_replan_calculation_async_with_http_info(self, id : Annotated[StrictStr, Field(description="Calculation identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Cancel calculation  # noqa: E501
    ...
    def delete_replan_result(self, id : Annotated[StrictStr, Field(description="Calculation identifier.")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_replan_result_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_replan_result_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_replan_result_with_http_info(self, id : Annotated[StrictStr, Field(description="Calculation identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Result removal  # noqa: E501
    ...
    def read_replan_calculation_state(self, id : Annotated[StrictStr, Field(description="Calculation identifier.")], **kwargs) -> CalculationState:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_replan_calculation_state_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_replan_calculation_state_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def read_replan_calculation_state_with_http_info(self, id : Annotated[StrictStr, Field(description="Calculation identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Calculation state  # noqa: E501
    ...
    def read_replan_result(self, id : Annotated[StrictStr, Field(description="Calculation identifier.")], **kwargs) -> PlanResult:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_replan_result_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_replan_result_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def read_replan_result_with_http_info(self, id : Annotated[StrictStr, Field(description="Calculation identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Getting the result  # noqa: E501
    ...
    def run_replan_calculation(self, replan_task : Annotated[ReplanTask, Field(description="New replanning request.")], **kwargs) -> PlanResult:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the run_replan_calculation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.run_replan_calculation_with_http_info(replan_task, **kwargs)  # noqa: E501

    @validate_arguments
    def run_replan_calculation_with_http_info(self, replan_task : Annotated[ReplanTask, Field(description="New replanning request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Replanning (SYNC)  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['replan_task'] is not None:
    ...
    def run_replan_calculation_async(self, replan_task : Annotated[ReplanTask, Field(description="Launching the asynchronous replanning.")], **kwargs) -> CalculationAsyncResult:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the run_replan_calculation_async_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.run_replan_calculation_async_with_http_info(replan_task, **kwargs)  # noqa: E501

    @validate_arguments
    def run_replan_calculation_async_with_http_info(self, replan_task : Annotated[ReplanTask, Field(description="Launching the asynchronous replanning.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Replanning (ASYNC)  # noqa: E501
    ...
    def run_replan_refining(self, replan_task : Annotated[ReplanTask, Field(description="Data for refine.")], **kwargs) -> ReplanTask:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the run_replan_refining_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.run_replan_refining_with_http_info(replan_task, **kwargs)  # noqa: E501

    @validate_arguments
    def run_replan_refining_with_http_info(self, replan_task : Annotated[ReplanTask, Field(description="Data for refine.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Data refine  # noqa: E501
    ...
    def run_replan_validation(self, replan_task : Annotated[ReplanTask, Field(description="Data for validation.")], **kwargs) -> ValidateResult:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the run_replan_validation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.run_replan_validation_with_http_info(replan_task, **kwargs)  # noqa: E501

    @validate_arguments
    def run_replan_validation_with_http_info(self, replan_task : Annotated[ReplanTask, Field(description="Data for validation.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Data validation  # noqa: E501
