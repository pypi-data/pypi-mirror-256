...
def index(dataset: str, library:str, 
          loader_name: str, loader_params: dict, load_params: Optional[dict],
          embedding_model: str,
          embedding_model_params: dict,
          kw_plan: Optional[str], kw_args: Optional[dict],
          ...
          vectorstore: Optional[str] = None,
          vectorstore_params: Optional[dict] = {}):
    return main(dataset, library, loader_name, loader_params, load_params, embedding_model, embedding_model_params, 
                kw_plan, kw_args, splitter_name, splitter_params, document_processing_prompt, 
                chunk_processing_prompt, ai_model, ai_model_params, vectorstore, vectorstore_params)

def search(chat_history=[], str_content=True, embedding_model=None, embedding_model_params=None, vectorstore=None, vectorstore_params=None, collection=None, top_k=5, weights=None):
    ...
    docs = retriever.invoke(chat_history[-1].content)
    references = set()
    docs_content = ""
...
def predict(chat_history=[], guidance_message=None, context_message=None, collection=None, top_k=5, ai_model=None, ai_model_params=None,
            embedding_model=None, embedding_model_params=None, vectorstore=None, vectorstore_params=None, weights=None, stream=False):
    ...
    """
    context, references = search(chat_history, embedding_model, embedding_model_params, vectorstore, vectorstore_params, collection, top_k, weights)
