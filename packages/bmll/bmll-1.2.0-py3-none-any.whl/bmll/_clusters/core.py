...
from bmll._clusters.enum import StrEnum
...
_AVAILABLE_ENVS = {'py38-stable', 'py38-latest', 'py311-latest'}
...
def create_cluster(
    ...
    """
    if conda_env not in _AVAILABLE_ENVS:
        raise ValueError(f"Unknown conda env given {conda_env!r}. Must be one of {_AVAILABLE_ENVS}")
