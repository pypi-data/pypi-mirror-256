...
from bmll._clusters import core, collections, validation
...
class Cluster:
    ...
    def __init__(self, name=None, log_area=None, log_path=None,
                 ...
                 cluster_bootstraps=None, tags=None, conda_env='py38-stable'):
    ...
    def distcp(self,
        ...
        Args:
            ...
            area: str, optional
                ...
                Possible values are :class:`_core.Area <bmll._clusters.core.Area>`
                The default is 'user'.
            distcp_params: list
        ...
        """
        self._assert_alive()
        validation.argument_check(area, 'area', core.Area)
    ...
    @typechecked
    def submit(self, script_path: str, name: typing.Optional[str] = None, script_area: str = core.Area.USER,
               failure_action: str = core.JobFailureAction.CONTINUE,
        ...
        """
        self._assert_alive()
        validation.argument_check(script_area, 'script_area', core.Area)
        validation.argument_check(failure_action, 'failure_action', core.JobFailureAction)
        ...
        payload = dict(
            name=name,
            script=script_path,
            area=core.Area[script_area].value,
...
class ClusterCollection(collections.BMLLCollection):
...
class JobCollection(collections.BMLLCollection):
