...
class TokenManagerBase:
    ...
    request_handler: HttpRequestExecutor
    ...
    def validate_url(self) -> bool:
        result = urlparse(self.credentials.auth_token_url)
    ...
    def request_token(
        ...
        try:
            ...
            response = self.request_handler.post(
                url=self.credentials.auth_token_url,
...
class TokenManager(TokenManagerBase):
    ...
    def __init__(self, token: Token, credentials: Credentials, requestor: HttpRequestExecutor):
        super().__init__(token, credentials)
        self.request_handler: HttpRequestExecutor = requestor
