...
from typing import Any, List, Type, TypeVar, Union, get_args, get_origin
...
def make_runloop_return_type(annotation: Type[Any]) -> RunloopType:
    ...
    if annotation is None or annotation == Signature.empty:
        return RunloopType(type_name=_null_type_literal)
...
class RunloopManifest:
    def __init__(self):
        ...
        self._functions: List[FunctionDescriptor] = []

    def register_function(self, function: FunctionDescriptor):
        self._functions.append(function)

    def functions(self) -> List[FunctionDescriptor]:
