...
# sources: Constants.proto, Core.proto, Datawatch.proto, FeatureProviders.proto, Forecast.proto, ModelService.proto, Temporal.proto, Tests.proto
...
class AutometricAcceptResponse(betterproto.Message):
    metric_ids: List[int] = betterproto.int32_field(1)
    failed_autometric_accepts: List["FailedAutometricOperation"] = (
        betterproto.message_field(2)
    )
...
class AutometricRejectResponse(betterproto.Message):
    metric_ids: List[int] = betterproto.int32_field(1)
    failed_autometric_rejects: List["FailedAutometricOperation"] = (
        betterproto.message_field(2)
    )
