...
from bigeye_sdk.model.protobuf_enum_facade import SimpleFieldType, SimpleMetricTemplateParameterType, \
 SimpleWorkflowProcessingStatus
...
class GeneratedDatawatchClient(abc.ABC):
    ...
    def get_delta_by_id(self, delta_id: int) -> Delta:
        ...
        return DeltaInfo().from_dict(response).delta
    ...
    def get_deltas(self, *, comparison_table_ids: List[int] = None,
                            exclude_comparison_metrics: bool = True) -> List[DeltaInfo]:
        """
            Args:
    ...
    def get_issues(
            ...
            *,
            ...
            sort_field: IssueSortField = IssueSortField.ISSUE_SORT_FIELD_UNSPECIFIED,
            sort_direction: SortDirection = SortDirection.SORT_DIRECTION_UNSPECIFIED) -> List[Issue]:
