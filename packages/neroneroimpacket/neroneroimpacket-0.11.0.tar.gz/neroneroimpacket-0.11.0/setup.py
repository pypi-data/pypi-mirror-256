...
setup(
    ...
    packages=['neroimpacket', 'neroimpacket.dcerpc', 'neroimpacket.examples', 'neroimpacket.dcerpc.v5', 'neroimpacket.dcerpc.v5.dcom',
              'neroimpacket.krb5', 'neroimpacket.ldap', 'neroimpacket.examples.ntlmrelayx',
              'neroimpacket.examples.ntlmrelayx.clients', 'neroimpacket.examples.ntlmrelayx.servers',
              'neroimpacket.examples.ntlmrelayx.servers.socksplugins', 'neroimpacket.examples.ntlmrelayx.utils',
              'neroimpacket.examples.ntlmrelayx.attacks', 'neroimpacket.examples.ntlmrelayx.attacks.httpattacks'],
