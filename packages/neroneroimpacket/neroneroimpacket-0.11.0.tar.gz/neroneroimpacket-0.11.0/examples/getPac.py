...
from neroimpacket.dcerpc.v5.rpcrt import TypeSerialization1
...
from neroimpacket.krb5.crypto import Key, _enctype_table, _HMACMD5, Enctype
from neroimpacket.krb5.kerberosv5 import getKerberosTGT, sendReceive
from neroimpacket.krb5.pac import PACTYPE, PAC_INFO_BUFFER, KERB_VALIDATION_INFO, PAC_CLIENT_INFO_TYPE, PAC_CLIENT_INFO, \
