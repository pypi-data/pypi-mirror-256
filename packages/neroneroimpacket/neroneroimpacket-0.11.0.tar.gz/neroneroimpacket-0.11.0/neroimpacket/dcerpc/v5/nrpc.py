...
from six import b
from neroimpacket.dcerpc.v5.ndr import NDRCALL, NDRSTRUCT, NDRENUM, NDRUNION, NDRPOINTER, NDRUniConformantArray, \
    NDRUniFixedArray, NDRUniConformantVaryingArray
from neroimpacket.dcerpc.v5.dtypes import WSTR, LPWSTR, DWORD, ULONG, USHORT, PGUID, NTSTATUS, NULL, LONG, UCHAR, PRPC_SID, \
    GUID, RPC_UNICODE_STRING, SECURITY_INFORMATION, LPULONG, ULONGLONG
from neroimpacket import system_errors, nt_errors
from neroimpacket.uuid import uuidtup_to_bin
from neroimpacket.dcerpc.v5.enum import Enum
from neroimpacket.dcerpc.v5.samr import OLD_LARGE_INTEGER
from neroimpacket.dcerpc.v5.lsad import PLSA_FOREST_TRUST_INFORMATION
from neroimpacket.dcerpc.v5.rpcrt import DCERPCException
from neroimpacket.structure import Structure
from neroimpacket import ntlm, crypto, LOG
import hmac
import hashlib
try:
...
# 2.2.1.1.2 STRING
from neroimpacket.dcerpc.v5.lsad import STRING
...
from neroimpacket.dcerpc.v5.samr import SAMPR_LOGON_HOURS
