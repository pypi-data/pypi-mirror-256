...
from neroimpacket import nmb, ntlm, uuid, crypto
from neroimpacket.smb3structs import *
from neroimpacket.nt_errors import STATUS_SUCCESS, STATUS_MORE_PROCESSING_REQUIRED, STATUS_INVALID_PARAMETER, \
    STATUS_NO_MORE_FILES, STATUS_PENDING, STATUS_NOT_IMPLEMENTED, ERROR_MESSAGES
from neroimpacket.spnego import SPNEGO_NegTokenInit, TypesMech, SPNEGO_NegTokenResp, ASN1_OID, asn1encode, ASN1_AID
from neroimpacket.krb5.gssapi import KRB5_AP_REQ
...
class SMB3:
    ...
    def kerberosLogin(self, user, password, domain = '', lmhash = '', nthash = '', aesKey='', kdcHost = '', TGT=None, TGS=None, mutualAuth=False):
        ...
        from neroimpacket.krb5.asn1 import AP_REQ, Authenticator, TGS_REP, seq_set
        from neroimpacket.krb5.kerberosv5 import getKerberosTGT, getKerberosTGS
        from neroimpacket.krb5 import constants
        from neroimpacket.krb5.types import Principal, KerberosTime, Ticket
...
#            pass
        ...
        if mutualAuth == True:
            from neroimpacket.krb5.constants import APOptions
        ...
        if ans.isValidAnswer(STATUS_SUCCESS):
            ...
            if mutualAuth == True:
                ...
                from neroimpacket.krb5.asn1 import AP_REP, EncAPRepPart
