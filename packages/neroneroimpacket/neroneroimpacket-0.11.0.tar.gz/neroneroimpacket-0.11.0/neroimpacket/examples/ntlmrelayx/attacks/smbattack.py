...
from neroimpacket.examples.ntlmrelayx.attacks import ProtocolAttack
from neroimpacket.examples.ntlmrelayx.utils.tcpshell import TcpShell
from neroimpacket import smb3, smb
from neroimpacket.examples import serviceinstall
from neroimpacket.smbconnection import SMBConnection
from neroimpacket.examples.smbclient import MiniImpacketShell
...
class SMBAttack(ProtocolAttack):
    ...
    def run(self):
        ...
        if self.config.exeFile is not None:
            ...
            from neroimpacket.examples.ntlmrelayx.utils.enum import EnumLocalAdmins
            samHashes = None
            try:
