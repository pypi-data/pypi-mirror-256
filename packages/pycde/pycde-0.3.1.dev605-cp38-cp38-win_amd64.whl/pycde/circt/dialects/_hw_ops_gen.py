...
def aggregate_constant(result, fields, *, loc=None, ip=None) -> _SubClassValueT:
...
def array_concat(result, inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def array_create(result, inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def array_get(input, index, *, loc=None, ip=None) -> _SubClassValueT:
...
def array_slice(dst, input, low_index, *, loc=None, ip=None) -> _SubClassValueT:
...
def bitcast(result, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def constant(value, *, loc=None, ip=None) -> _SubClassValueT:
...
def enum_cmp(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def enum_constant(result, field, *, loc=None, ip=None) -> _SubClassValueT:
...
class HWModuleExternOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, module_type, parameters, *, per_port_attrs=None, port_locs=None, verilogName=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_565')) else
      _ods_ir.AttrBuilder.get('anonymous_565')(module_type, context=_ods_context))
    if per_port_attrs is not None: attributes["per_port_attrs"] = (per_port_attrs if (
        issubclass(type(per_port_attrs), _ods_ir.Attribute) or
...
class HWModuleGeneratedOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, generatorKind, module_type, parameters, *, per_port_attrs=None, port_locs=None, verilogName=None, loc=None, ip=None):
    ...
    issubclass(type(generatorKind), _ods_ir.Attribute) or
...
class HWModuleOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, module_type, parameters, *, per_port_attrs=None, port_locs=None, comment=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def module(sym_name, module_type, parameters, *, per_port_attrs=None, port_locs=None, comment=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(HWModuleOp(sym_name=sym_name, module_type=module_type, parameters=parameters, per_port_attrs=per_port_attrs, port_locs=port_locs, comment=comment, loc=loc, ip=ip))
...
class InstanceChoiceOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, instanceName, moduleNames, targetNames, inputs, argNames, resultNames, parameters, *, inner_sym=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    issubclass(type(moduleNames), _ods_ir.Attribute) or
    ...
    attributes["targetNames"] = (targetNames if (
    issubclass(type(targetNames), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('StrArrayAttr')) else
      _ods_ir.AttrBuilder.get('StrArrayAttr')(targetNames, context=_ods_context))
  ...
  def targetNames(self):
    return self.operation.attributes["targetNames"]

  @targetNames.setter
  def targetNames(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["targetNames"] = value
...
def instance_choice(results_, instance_name, module_names, target_names, inputs, arg_names, result_names, parameters, *, inner_sym=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InstanceChoiceOp(results_=results_, instanceName=instance_name, moduleNames=module_names, targetNames=target_names, inputs=inputs, argNames=arg_names, resultNames=result_names, parameters=parameters, inner_sym=inner_sym, loc=loc, ip=ip))
...
def instance(results_, instance_name, module_name, inputs, arg_names, result_names, parameters, *, inner_sym=None, loc=None, ip=None) -> _SubClassValueT:
...
def param_value(value, *, loc=None, ip=None) -> _SubClassValueT:
...
def struct_create(result, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def struct_explode(result, input, *, loc=None, ip=None) -> _SubClassValueT:
...
class StructExtractOp(_ods_ir.OpView):
  ...
  def __init__(self, result, input, fieldIndex, *, loc=None, ip=None):
    ...
    issubclass(type(fieldIndex), _ods_ir.Attribute) or
...
def struct_extract(result, input, field_index, *, loc=None, ip=None) -> _SubClassValueT:
...
def struct_inject(input, field_index, new_value, *, loc=None, ip=None) -> _SubClassValueT:
...
def union_create(result, field_index, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def union_extract(input, field_index, *, loc=None, ip=None) -> _SubClassValueT:
...
def wire(input, *, name=None, inner_sym=None, loc=None, ip=None) -> _SubClassValueT:
