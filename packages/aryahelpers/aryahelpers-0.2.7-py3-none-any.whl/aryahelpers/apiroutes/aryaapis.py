...
def copy_jobs():
    ...
    URL = http://192.168.38.99:1501/copy_jobs\n
    payload = {
...
def jobs_record(source_env='qa'):
    ...
    URL = http://192.168.38.99:1501/qa/jobs_record\n
    payload = {
...
def access_aryacontds(source_env='qa'):
    ...
    URLs
        http://192.168.38.99:1501/qa/access_aryacontds?show=summary&top=20
...
def group_aryacontds():
    ...
    URL = http://192.168.38.99:1501/group_aryacontds?show=summary&top=20\n
    payload = {
        "jobs_info": [
