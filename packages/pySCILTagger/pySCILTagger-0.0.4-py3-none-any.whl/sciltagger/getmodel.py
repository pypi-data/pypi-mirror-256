import requests
import os
from tqdm import tqdm as tqdm #for fancy loop estimation
import logging
...
class Download:
    def __init__(self, model_name):
        ...
        try:
            ...
            print("ERROR: Model directory already exists")

        self.__model_zip_path = os.path.join(self.__lib_path, self.__model_name)
    ...
    def download_file(self):
        ...
        progress.close()
        print("Saved model to {}".format(self.__model_zip_path))
