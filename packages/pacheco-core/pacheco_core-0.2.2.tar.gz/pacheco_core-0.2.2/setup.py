...
config = {
    ...
    "py_modules": ["retico_core/core/abstract", "retico_core/core/audio", "retico_core/core/debug", "retico_core/core/dialogue", "retico_core/core/network", "retico_core/core/text", "retico_core/core/version", "retico_core/core/visual"],
    "name": "pacheco_core",
    "classifiers": [
        "Development Status :: 2 - Pre-Alpha",
        "Programming Language :: Python :: 3",
