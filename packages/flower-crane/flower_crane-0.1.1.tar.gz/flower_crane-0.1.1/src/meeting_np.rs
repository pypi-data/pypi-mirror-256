use pyo3::prelude::*;
const MAX_DIST_KM: f64 = 2.0;
const MAX_DIST_DEGREE: f64 = MAX_DIST_KM / 111.0;
const MAX_ALT_DIST: i32 = 500;

pub fn find_meeting_np(
    line1: &[f64],
    line2: &[f64],
    alt1: &[i64],
    alt2: &[i64],
    ...
    for j in 0..time2.len() {
        ...
        if alt_dist < MAX_ALT_DIST && dist < MAX_DIST_DEGREE.powi(2) && same_chunk {
