...
from eis.customers import rest
from eis.customers.configuration import Configuration
from eis.customers.exceptions import ApiTypeError, ApiValueError, ApiException, UnauthorizedException
from eis.customers.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.forgot_password  # this is an instance of the class Endpoint
        api_instance.forgot_password()  # this invokes api_instance.forgot_password.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.forgot_password.callable or self.callable in this class
