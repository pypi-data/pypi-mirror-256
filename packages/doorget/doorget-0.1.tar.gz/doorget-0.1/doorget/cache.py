...
def __create_storage(mode: StorageMode, func: Callable, cache_folder: str, custom_storage: Storage) -> Storage:
...
def cache(func: Callable=None, *, mode: StorageMode=StorageMode.Memory, cache_folder: str=None, readonly: bool=False, custom_storage: Storage=None):
    """Memoize a function
