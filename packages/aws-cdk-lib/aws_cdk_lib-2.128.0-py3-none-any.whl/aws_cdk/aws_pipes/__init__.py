    ...
    class FirehoseLogDestinationProperty:
        def __init__(
            ...
            *,
            ...
            :param delivery_stream_arn: The Amazon Resource Name (ARN) of the Kinesis Data Firehose delivery stream to which EventBridge delivers the pipe log records.
