    ...
    class CsvClassifierProperty:
        def __init__(
            ...
            *,
            ...
            :param custom_datatype_configured: Enables the custom datatype to be configured.
...
class CfnTable(
    ...
    def __init__(
        ...
        *,
        ...
        :param open_table_format_input: A structure representing an open format table.
        '''
        if __debug__:
