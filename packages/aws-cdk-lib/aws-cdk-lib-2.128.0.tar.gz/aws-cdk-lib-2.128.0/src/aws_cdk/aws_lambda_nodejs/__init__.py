...
class BundlingOptions(_DockerRunOptions_81583d32):
    def __init__(
        ...
        *,
        ...
        :param external_modules: A list of modules that should be considered as externals (already available in the runtime). Default: - ['aws-sdk'] if the runtime is <= Node.js 16.x, ['@aws-sdk/*'] if Node.js 18.x, [] if using a variable runtime version such as NODEJS_LATEST.
    ...
    def external_modules(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        - ['aws-sdk'] if the runtime is <= Node.js 16.x, ['@aws-sdk/*'] if Node.js 18.x,
