...
def create_chat_thread(knowledge_base_ids: list[str] = None, supp_id: str = None, model: str = None, temperature: float = None, segment_length: str = None, system_message: str = None, title: str = None, use_rse: bool = None, response_length: str = None, auto_query_guidance: str = None) -> dict:
    """
...
def update_chat_thread(thread_id: str, knowledge_base_ids: list[str] = None, supp_id: str = None, model: str = None, temperature: float = None, segment_length: str = None, system_message: str = None, title: str = None, use_rse: bool = None, response_length: str = None, auto_query_guidance: str = None) -> dict:
    """
...
def get_chat_response(thread_id: str, input: str, knowledge_base_ids: list = None, model: str = None, temperature: float = None, system_message: str = None, use_rse: bool = None, segment_length: str = None, response_length: str = None, timeout: int = 90, auto_query_guidance: str = None) -> dict:
    """
