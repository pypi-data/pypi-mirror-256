    ...
    def create_table(
        ...
        with self.db_cursor() as cursor:
            ...
            cursor.execute(
                ...
                # f"ALTER TABLE {table_name} SET (timescaledb.compress, timescaledb.compress_segmentby = 'id');\n"
                # f"SELECT add_compression_policy('example', INTERVAL '{compression_interval_days} days');"
            )
    ...
    def create_read_only_users(
        ...
        with self.db_cursor() as cursor:
            for user_name, password in user_logins.items():
                ...
                for table_type, table_name in self._table_names:
