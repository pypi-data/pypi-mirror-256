...
def channelDetail(username,proxy=None):
    ...
    new_channel = {
        ...
        "total_video_visit": int(convert_numerical_string_to_int(data["video_visit"])) if "video_visit" in data and data["follow_cnt"]!="" else 0,
        ...
        "start_date_timestamp": int(datetime.strptime(data["start_date"], "%Y-%m-%d").timestamp()),
