...
from jio_sonar.logi.logtypes import Unicode, TestId, TestList, Status, SubStatus, Dict, List, Int, Any, Tuple
from jio_sonar.logi.logtypes import log_action, convertor_registry
...
def set_default_logger(default_logger):
    ...
    Note that :py:func:`commandline.setup_logging` will
...
def log_actions():
    """Returns the set of implemented actions."""
...
class StructuredLogger(object):
    ...
    def suite_start(self, data):
        ...
        :param dict version_info: Optional target application version information
