...
import imp
import weakref
from jio_sonar.marionette_driver.errors import KaiOSMarionetteException, SessionNotCreatedException
from jio_sonar.logi import structuredlog
...
class KaiOSMarionetteTestCase(with_metaclass(KaiOSMetaParameterized, unittest.TestCase)):
    ...
    def setUp(self):
        ...
        #     print("value", self.marionette.timeout)
        #     print("next val", self.marionette.TIMEOUT_SEARCH)
        #     self.marionette.timeouts(self.marionette.TIMEOUT_SEARCH, 20000)
        ...
        self.marionette.execute_script("'%s:%s'" %
