...
LEADERBOARD_INDIVIDUAL_RANK_PARAMS = [
    ...
    dict(value_column='thumbs_up_ratio', rank_column='thumbs_up_rank', ascending=False),
...
LEADERBOARD_OVERALL_RANK_PARAMS = [
    ...
    dict(
        from_rank_columns=['elo_rank', 'thumbs_up_rank'],
        overall_score_column='overall_user_score_with_thumbs_up', overall_rank_column='overall_user_rank_with_thumbs_up'
    )
]
...
LEADERBOARD_FORMAT_CONFIGS['user_score_with_thumbs_up'] = {
    "output_columns": [
        'developer_uid',
        'model_name',
        'thumbs_up_ratio',
        'double_thumbs_up_ratio',
        'elo_rating',
        'overall_user_score_with_thumbs_up',
        'thumbs_up_rank',
    ...
    "sort_params": {
        "by": "overall_user_score_with_thumbs_up",
        "ascending": True
    }
}
