...
class _Mount(modal.object._StatefulObject):
    ...
    @staticmethod
    async def _load_mount(entries: typing.List[_MountEntry], provider: _Mount, resolver: modal._resolver.Resolver, existing_object_id: typing.Union[str, None]):
        ...

    @staticmethod
    def from_local_python_packages(*module_names: str, remote_dir: typing.Union[str, pathlib.PurePosixPath] = '/root') -> _Mount:
        ...


class Mount(modal.object.StatefulObject):
    _entries: typing.List[_MountEntry]
    _content_checksum_sha256_hex: typing.Union[str, None]
    ...
    class ___load_mount_spec(typing_extensions.Protocol):
        def __call__(self, entries: typing.List[_MountEntry], provider: Mount, resolver: modal._resolver.Resolver, existing_object_id: typing.Union[str, None]):
            ...
    ...
    @staticmethod
    def from_local_python_packages(*module_names: str, remote_dir: typing.Union[str, pathlib.PurePosixPath] = '/root') -> Mount:
        ...
...
def _create_package_mounts(module_names: typing.Sequence[str]):
    ...


def create_package_mounts(module_names: typing.Sequence[str]):
    ...
