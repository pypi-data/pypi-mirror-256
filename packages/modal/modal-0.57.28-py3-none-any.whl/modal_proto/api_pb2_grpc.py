...
class ModalClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MountDeploy = channel.unary_unary(
                '/modal.client.ModalClient/MountDeploy',
                request_serializer=modal__proto_dot_api__pb2.MountDeployRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        ...
        self.SecretGet = channel.unary_unary(
                '/modal.client.ModalClient/SecretGet',
                request_serializer=modal__proto_dot_api__pb2.SecretGetRequest.SerializeToString,
                response_deserializer=modal__proto_dot_api__pb2.SecretGetResponse.FromString,
                )
...
class ModalClientServicer(object):
    ...
    def MountDeploy(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def SecretGet(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ModalClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'MountDeploy': grpc.unary_unary_rpc_method_handler(
                    servicer.MountDeploy,
                    request_deserializer=modal__proto_dot_api__pb2.MountDeployRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            ...
            'SecretGet': grpc.unary_unary_rpc_method_handler(
                    servicer.SecretGet,
                    request_deserializer=modal__proto_dot_api__pb2.SecretGetRequest.FromString,
                    response_serializer=modal__proto_dot_api__pb2.SecretGetResponse.SerializeToString,
            ),
...
class ModalClient(object):
    ...
    def MountDeploy(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modal.client.ModalClient/MountDeploy',
            modal__proto_dot_api__pb2.MountDeployRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SecretGet(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modal.client.ModalClient/SecretGet',
            modal__proto_dot_api__pb2.SecretGetRequest.SerializeToString,
            modal__proto_dot_api__pb2.SecretGetResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
