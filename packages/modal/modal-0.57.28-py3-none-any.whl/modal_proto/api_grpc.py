...
class ModalClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def MountDeploy(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.MountDeployRequest, google.protobuf.empty_pb2.Empty]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def SecretGet(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.SecretGetRequest, modal_proto.api_pb2.SecretGetResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/modal.client.ModalClient/MountDeploy': grpclib.const.Handler(
                self.MountDeploy,
                grpclib.const.Cardinality.UNARY_UNARY,
                modal_proto.api_pb2.MountDeployRequest,
                google.protobuf.empty_pb2.Empty,
            ),
            ...
            '/modal.client.ModalClient/SecretGet': grpclib.const.Handler(
                self.SecretGet,
                grpclib.const.Cardinality.UNARY_UNARY,
                modal_proto.api_pb2.SecretGetRequest,
                modal_proto.api_pb2.SecretGetResponse,
            ),
...
class ModalClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.MountDeploy = grpclib.client.UnaryUnaryMethod(
            channel,
        ...
        self.SecretGet = grpclib.client.UnaryUnaryMethod(
            channel,
