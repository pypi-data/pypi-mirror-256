...
if __name__ == "__main__":
    ...
    with Orion.open_query_connection_and_cursor() as (connection, cursor):
        ...
        for value in mark_list:
            ...
            if not Orion.CHECK.name(lastname):
                need_to_be_modificated_list.append("lastname")
            if not Orion.CHECK.name(firstname):
                need_to_be_modificated_list.append("firstname")
            if not Orion.CHECK.name(middlename):
