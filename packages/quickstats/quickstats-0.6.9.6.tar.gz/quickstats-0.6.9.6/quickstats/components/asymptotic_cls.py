...
class AsymptoticCLs(AnalysisObject):
    ...
    def __init__(self, filename:str, poi_name:str=None, data_name:str='combData',
                 ...
                 optimize:int=2, batch_mode:bool=False, int_bin_precision:float=-1., 
    ...
    def evaluate_limits(self):
        ...
        if (self.minimizer.has_discrete_nuisance() and self.do_blind):
            self.minimizer.minimize(asimov_0_nll)
