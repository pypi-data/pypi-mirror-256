...
import yaml
from orbit.exceptions import ConfigDoesNotExistException, InvalidConfiguration


logger = logging.getLogger(__name__)

USER_CONFIG_PATH = os.path.expanduser("~/.orbitrc")
...
DEFAULT_CONFIG = {
    "orbits_dir": os.path.expanduser("~/.orbits/"),
    "replay_dir": os.path.expanduser("~/.orbit_replay/"),
...
def get_config(config_path):
    ...
    raw_cookies_dir = config_dict["orbits_dir"]
    config_dict["orbits_dir"] = _expand_path(raw_cookies_dir)
...
def get_user_config(config_file=None, default_config=False):
    ...
    Otherwise look up the config file path in the ``ORBIT_CONFIG``
    ...
    try:
        ...
        env_config_file = os.environ["ORBIT_CONFIG"]
    except KeyError:
