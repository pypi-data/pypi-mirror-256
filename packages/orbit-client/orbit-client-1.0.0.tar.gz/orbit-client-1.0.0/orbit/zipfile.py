...
import requests
from orbit.exceptions import InvalidZipRepository
from orbit.prompt import read_repo_password
from orbit.utils import make_sure_path_exists, prompt_and_delete
...
def unzip(
    ...
    This will download the zipfile to the orbit repository,
    and unpack into a temporary directory.

    :param zip_uri: The URI for the zipfile.
    :param is_url: Is the zip URI a URL or a file?
    :param clone_to_dir: The orbit repository directory
