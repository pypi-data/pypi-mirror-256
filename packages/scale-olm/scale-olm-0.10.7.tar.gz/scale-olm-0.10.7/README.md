...
[SCALE/ORIGEN](scale.ornl.gov) library to solve nuclide inventory generation problems.
See the [docs](https://scale-olm.readthedocs.io/) for details on using OLM.
