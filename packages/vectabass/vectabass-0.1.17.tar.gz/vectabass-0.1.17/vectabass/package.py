...
"""
    ...
    def create_endpoint(
        ...
        async def async_wrapper(*args, **kwargs):
            # This wrapper will handle asynchronous execution of func
            result = await func(*args, **kwargs)
            return result

        def sync_wrapper(*args, **kwargs):
            # This wrapper will handle synchronous execution of func
        ...
        if any(
            ...
            # If func expects a Pydantic model, directly use it in wrapper
            actual_wrapper = (
            ...
            RequestModel = create_model(f"{func.__name__}RequestModel", **fields)

            async def model_wrapper(model: RequestModel = Body(...)):
                kwargs = model.dict()
        ...
        for method in methods:
            ...
            route_decorator(endpoint_route, response_model=BaseModel)(actual_wrapper)

        return func  # Return the original function or modify as needed
