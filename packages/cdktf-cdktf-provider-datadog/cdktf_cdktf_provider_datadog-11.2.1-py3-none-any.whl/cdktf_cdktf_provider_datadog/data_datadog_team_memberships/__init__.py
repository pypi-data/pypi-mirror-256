...
Refer to the Terraform Registry for docs: [`data_datadog_team_memberships`](https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships).
'''
import abc
import builtins
import datetime
...
class DataDatadogTeamMemberships(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships datadog_team_memberships}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships datadog_team_memberships} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param team_id: The team's identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships#team_id DataDatadogTeamMemberships#team_id}
        :param exact_match: When true, ``filter_keyword`` string is exact matched against the user's ``email``, followed by ``name``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships#exact_match DataDatadogTeamMemberships#exact_match}
        :param filter_keyword: Search query, can be user email or name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships#filter_keyword DataDatadogTeamMemberships#filter_keyword}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataDatadogTeamMemberships that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships#import import section} in the documentation of this resource for the id to use
    ...
    def filter_keyword(self, value: builtins.str) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "filterKeyword", value)
...
class DataDatadogTeamMembershipsConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def team_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships#team_id DataDatadogTeamMemberships#team_id}
        '''
    ...
    def exact_match(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships#exact_match DataDatadogTeamMemberships#exact_match}
        '''
    ...
    def filter_keyword(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.36.1/docs/data-sources/team_memberships#filter_keyword DataDatadogTeamMemberships#filter_keyword}
        '''
