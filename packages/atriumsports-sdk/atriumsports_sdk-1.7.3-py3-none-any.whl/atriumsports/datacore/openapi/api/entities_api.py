...
class EntitiesApi:
    ...
    def entity_list(
        ...
        **kwargs
        ...
        >>> thread = api.entity_list(organization_id, sport, added, external, fields, hide_null, include, limit, name_full_latin_contains, name_full_local_contains, offset, sort_by, status, updated, async_req=True)
        >>> result = thread.get()
    ...
    def entity_list_by_entity_group(
        ...
        **kwargs
        ...
        >>> thread = api.entity_list_by_entity_group(entity_group_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, status, updated, async_req=True)
        >>> result = thread.get()
