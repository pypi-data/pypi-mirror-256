...
class SeasonPersonBaseStatisticsApi:
    ...
    def spbs_delete_all(
        ...
        **kwargs
    ) -> SeasonPersonBaseStatisticsResponse:  # noqa: E501
        ...
        >>> thread = api.spbs_delete_all(organization_id, season_id, sport, competitor_type, entity_id, external, fields, fixture_type, force_delete, hide_null, include, person_id, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the spbs_delete_all_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
        ...
        try:
            ...
            logger.error("Exception when calling SeasonPersonBaseStatisticsApi->spbs_delete_all: %s\n" % e)
            raise

    @validate_arguments
    def spbs_delete_all_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SeasonPersonBaseStatisticsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method spbs_delete_all" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        _response_types_map = {
            "200": "SeasonPersonBaseStatisticsResponse",
        }

        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/statistics/base/for/person/in/seasons/{seasonId}",
            "DELETE",
            _path_params,
            _query_params,
            _header_params,
    ...
    def spbs_insert_update(
        ...
        sport: Annotated[StrictStr, Field(..., description="Sport name")],
        season_person_base_statistics_post_body: SeasonPersonBaseStatisticsPostBody,
        external: Annotated[
            Optional[StrictStr],
            Field(
                description="A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information."
        ...
        **kwargs
        ...
        >>> thread = api.spbs_insert_update(organization_id, sport, season_person_base_statistics_post_body, external, fields, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        :param sport: Sport name (required)
        :type sport: str
        :param season_person_base_statistics_post_body: (required)
        :type season_person_base_statistics_post_body: SeasonPersonBaseStatisticsPostBody
        :param external: A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information.
        :type external: str
        :param fields: A comma separated list of fields to display.  The response will only display these fields. See [Partial Response](#section/Partial-Response) section for more information.
        :type fields: str
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the spbs_insert_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
            ...
            logger.error("Exception when calling SeasonPersonBaseStatisticsApi->spbs_insert_update: %s\n" % e)
            raise

    @validate_arguments
    def spbs_insert_update_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method spbs_insert_update" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/statistics/base/for/person/in/seasons",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def spbs_list(
        ...
        **kwargs
        ...
        >>> thread = api.spbs_list(organization_id, season_id, sport, added, competitor_type, entity_id, external, fields, fixture_type, hide_null, include, limit, offset, person_id, updated, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the spbs_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
            ...
            logger.error("Exception when calling SeasonPersonBaseStatisticsApi->spbs_list: %s\n" % e)
            raise

    @validate_arguments
    def spbs_list_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method spbs_list" % _key)
            _params[_key] = _val
        del _params["kwargs"]
