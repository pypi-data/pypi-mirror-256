...
class PersonsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonsResponse:
        """Create an instance of PersonsResponse from a JSON string"""
        ...
        _obj = PersonsResponse.parse_obj(
            {
                ...
                "data": (
                    [PersonsModel.from_dict(_item) for _item in obj.get("data")]
