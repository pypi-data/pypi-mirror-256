...
class SeasonEntitiesListResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonEntitiesListResponse:
        """Create an instance of SeasonEntitiesListResponse from a JSON string"""
        ...
        _obj = SeasonEntitiesListResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonEntitiesListModel.from_dict(_item) for _item in obj.get("data")]
