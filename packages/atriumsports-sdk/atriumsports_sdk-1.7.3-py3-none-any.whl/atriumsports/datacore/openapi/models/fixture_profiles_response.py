...
class FixtureProfilesResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureProfilesResponse:
        """Create an instance of FixtureProfilesResponse from a JSON string"""
        ...
        _obj = FixtureProfilesResponse.parse_obj(
            {
                ...
                "data": (
                    [FixtureProfilesModel.from_dict(_item) for _item in obj.get("data")]
