...
class SeasonEntityPlacingsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonEntityPlacingsResponse:
        """Create an instance of SeasonEntityPlacingsResponse from a JSON string"""
        ...
        _obj = SeasonEntityPlacingsResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonEntityPlacingsModel.from_dict(_item) for _item in obj.get("data")]
