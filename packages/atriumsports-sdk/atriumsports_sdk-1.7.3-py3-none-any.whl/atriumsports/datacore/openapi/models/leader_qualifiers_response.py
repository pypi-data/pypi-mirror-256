...
class LeaderQualifiersResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeaderQualifiersResponse:
        """Create an instance of LeaderQualifiersResponse from a JSON string"""
        ...
        _obj = LeaderQualifiersResponse.parse_obj(
            {
                ...
                "data": (
                    [LeaderQualifiersModel.from_dict(_item) for _item in obj.get("data")]
