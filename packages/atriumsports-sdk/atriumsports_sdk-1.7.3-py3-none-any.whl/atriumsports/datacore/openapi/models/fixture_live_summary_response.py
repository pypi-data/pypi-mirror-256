...
class FixtureLiveSummaryResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureLiveSummaryResponse:
        """Create an instance of FixtureLiveSummaryResponse from a JSON string"""
        ...
        _obj = FixtureLiveSummaryResponse.parse_obj(
            {
                ...
                "data": (
                    [FixtureLiveSummaryModel.from_dict(_item) for _item in obj.get("data")]
