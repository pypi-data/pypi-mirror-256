...
class FixtureEntityStatisticsPeriodsModel(BaseModel):
    """
    ...
    organization: Optional[FixtureEntityStatisticsPeriodsModelOrganization] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureEntityStatisticsPeriodsModel:
        """Create an instance of FixtureEntityStatisticsPeriodsModel from a JSON string"""
        ...
        _obj = FixtureEntityStatisticsPeriodsModel.parse_obj(
            {
                ...
                "organization": (
                    FixtureEntityStatisticsPeriodsModelOrganization.from_dict(obj.get("organization"))
