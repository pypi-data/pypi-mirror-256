...
class SiteExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(SiteExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SiteExternalIdsResponse:
        """Create an instance of SiteExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SiteExternalIdsResponse:
        """Create an instance of SiteExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SiteExternalIdsResponse.parse_obj(obj)

        _obj = SiteExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [SiteExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
