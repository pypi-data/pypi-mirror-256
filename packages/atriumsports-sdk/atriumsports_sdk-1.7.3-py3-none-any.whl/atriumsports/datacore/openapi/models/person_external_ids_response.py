...
class PersonExternalIdsResponse(BaseModel):
    ...
    data: Optional[conlist(PersonExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonExternalIdsResponse:
        """Create an instance of PersonExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonExternalIdsResponse:
        """Create an instance of PersonExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PersonExternalIdsResponse.parse_obj(obj)

        _obj = PersonExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [PersonExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
