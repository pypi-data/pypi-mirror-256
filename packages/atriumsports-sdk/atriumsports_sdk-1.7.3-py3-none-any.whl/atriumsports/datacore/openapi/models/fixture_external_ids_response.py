...
class FixtureExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(FixtureExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureExternalIdsResponse:
        """Create an instance of FixtureExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FixtureExternalIdsResponse:
        """Create an instance of FixtureExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixtureExternalIdsResponse.parse_obj(obj)

        _obj = FixtureExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [FixtureExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
