...
class CompetitionExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(CompetitionExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionExternalIdsResponse:
        """Create an instance of CompetitionExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompetitionExternalIdsResponse:
        """Create an instance of CompetitionExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompetitionExternalIdsResponse.parse_obj(obj)

        _obj = CompetitionExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [CompetitionExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
