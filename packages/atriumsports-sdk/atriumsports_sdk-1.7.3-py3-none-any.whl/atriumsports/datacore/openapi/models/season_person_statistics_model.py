...
class SeasonPersonStatisticsModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPersonStatisticsModel:
        """Create an instance of SeasonPersonStatisticsModel from a JSON string"""
        ...
        _obj = SeasonPersonStatisticsModel.parse_obj(
            {
                ...
                "organization": (
                    SeasonPersonStatisticsModelOrganization.from_dict(obj.get("organization"))
