...
class ConductModel(BaseModel):
    ...
    conduct_id: Optional[StrictStr] = Field(None, alias="conductId", description="The unique identifier of the conduct")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConductModel:
        ...
        _obj = ConductModel.parse_obj(
            {
                ...
                "organization": (
                    ConductModelOrganization.from_dict(obj.get("organization"))
                ...
                "penalty_results": (
                    [ConductPenaltyResult.from_dict(_item) for _item in obj.get("penaltyResults")]
