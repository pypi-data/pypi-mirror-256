...
class StandingAdjustmentsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StandingAdjustmentsResponse:
        """Create an instance of StandingAdjustmentsResponse from a JSON string"""
        ...
        _obj = StandingAdjustmentsResponse.parse_obj(
            {
                ...
                "data": (
                    [StandingAdjustmentsModel.from_dict(_item) for _item in obj.get("data")]
