...
class FixturePbpResponse(BaseModel):
    """
    FixturePbpResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturePbpResponse:
        """Create an instance of FixturePbpResponse from a JSON string"""
        ...
        _obj = FixturePbpResponse.parse_obj(
            {
                ...
                "data": (
                    [FixturePbpModel.from_dict(_item) for _item in obj.get("data")]
