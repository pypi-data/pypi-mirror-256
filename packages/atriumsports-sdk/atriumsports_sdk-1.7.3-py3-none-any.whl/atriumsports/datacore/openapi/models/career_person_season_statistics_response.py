...
class CareerPersonSeasonStatisticsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(CareerPersonSeasonStatisticsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CareerPersonSeasonStatisticsResponse:
        """Create an instance of CareerPersonSeasonStatisticsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CareerPersonSeasonStatisticsResponse:
        """Create an instance of CareerPersonSeasonStatisticsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CareerPersonSeasonStatisticsResponse.parse_obj(obj)

        _obj = CareerPersonSeasonStatisticsResponse.parse_obj(
            {
                ...
                "data": (
                    [CareerPersonSeasonStatisticsModel.from_dict(_item) for _item in obj.get("data")]
