...
class SeasonPersonStatisticsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPersonStatisticsResponse:
        """Create an instance of SeasonPersonStatisticsResponse from a JSON string"""
        ...
        _obj = SeasonPersonStatisticsResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonPersonStatisticsModel.from_dict(_item) for _item in obj.get("data")]
