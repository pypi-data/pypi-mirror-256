...
class VenueExternalIdsModel(BaseModel):
    ...
    venue_external_id: Optional[StrictStr] = Field(
        None, alias="venueExternalId", description="The unique identifier of the external ids"
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VenueExternalIdsModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VenueExternalIdsModel:
        """Create an instance of VenueExternalIdsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VenueExternalIdsModel.parse_obj(obj)

        _obj = VenueExternalIdsModel.parse_obj(
            {
                "venue_external_id": obj.get("venueExternalId"),
                "organization_id": obj.get("organizationId"),
                "organization": (
                    VenueExternalIdsModelOrganization.from_dict(obj.get("organization"))
