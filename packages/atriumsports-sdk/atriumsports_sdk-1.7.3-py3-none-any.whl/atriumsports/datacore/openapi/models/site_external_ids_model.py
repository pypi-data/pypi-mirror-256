...
class SiteExternalIdsModel(BaseModel):
    """
    SiteExternalIdsModel
    """

    site_external_id: Optional[StrictStr] = Field(
        None, alias="siteExternalId", description="The unique identifier of the external ids"
    )
    organization_id: Optional[StrictStr] = Field(
        None, alias="organizationId", description="The unique identifier of the organization"
    )
    organization: Optional[SiteExternalIdsModelOrganization] = None
    site_id: Optional[StrictStr] = Field(
        None, alias="siteId", description="The site that this site external ids belongs to"
    )
    site: Optional[SiteExternalIdsModelSite] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SiteExternalIdsModel:
        """Create an instance of SiteExternalIdsModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SiteExternalIdsModel:
        """Create an instance of SiteExternalIdsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SiteExternalIdsModel.parse_obj(obj)

        _obj = SiteExternalIdsModel.parse_obj(
            {
                "site_external_id": obj.get("siteExternalId"),
                "organization_id": obj.get("organizationId"),
                "organization": (
                    SiteExternalIdsModelOrganization.from_dict(obj.get("organization"))
                    if obj.get("organization") is not None
                    else None
                ),
                "site_id": obj.get("siteId"),
                "site": SiteExternalIdsModelSite.from_dict(obj.get("site")) if obj.get("site") is not None else None,
