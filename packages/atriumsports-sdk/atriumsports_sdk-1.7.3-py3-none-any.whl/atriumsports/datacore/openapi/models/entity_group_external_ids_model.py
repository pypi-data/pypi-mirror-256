...
class EntityGroupExternalIdsModel(BaseModel):
    """
    EntityGroupExternalIdsModel
    """

    entity_group_external_id: Optional[StrictStr] = Field(
        None, alias="entityGroupExternalId", description="The unique identifier of the external ids"
    )
    organization_id: Optional[StrictStr] = Field(
        None, alias="organizationId", description="The unique identifier of the organization"
    )
    organization: Optional[EntityGroupExternalIdsModelOrganization] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityGroupExternalIdsModel:
        """Create an instance of EntityGroupExternalIdsModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityGroupExternalIdsModel:
        """Create an instance of EntityGroupExternalIdsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityGroupExternalIdsModel.parse_obj(obj)

        _obj = EntityGroupExternalIdsModel.parse_obj(
            {
                "entity_group_external_id": obj.get("entityGroupExternalId"),
                "organization_id": obj.get("organizationId"),
                "organization": (
                    EntityGroupExternalIdsModelOrganization.from_dict(obj.get("organization"))
                    if obj.get("organization") is not None
                    else None
                ),
                "entity_group_id": obj.get("entityGroupId"),
                "entity_group": (
                    EntitiesModelEntityGroup.from_dict(obj.get("entityGroup"))
