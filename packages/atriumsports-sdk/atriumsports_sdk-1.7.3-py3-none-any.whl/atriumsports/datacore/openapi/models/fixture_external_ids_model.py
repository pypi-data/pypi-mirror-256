...
class FixtureExternalIdsModel(BaseModel):
    """
    FixtureExternalIdsModel
    """

    fixture_external_id: Optional[StrictStr] = Field(
        None, alias="fixtureExternalId", description="The unique identifier of the external ids"
    )
    organization_id: Optional[StrictStr] = Field(
        None, alias="organizationId", description="The unique identifier of the organization"
    )
    organization: Optional[FixtureExternalIdsModelOrganization] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureExternalIdsModel:
        """Create an instance of FixtureExternalIdsModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FixtureExternalIdsModel:
        """Create an instance of FixtureExternalIdsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixtureExternalIdsModel.parse_obj(obj)

        _obj = FixtureExternalIdsModel.parse_obj(
            {
                "fixture_external_id": obj.get("fixtureExternalId"),
                "organization_id": obj.get("organizationId"),
                "organization": (
                    FixtureExternalIdsModelOrganization.from_dict(obj.get("organization"))
                    if obj.get("organization") is not None
                    else None
                ),
                "fixture_id": obj.get("fixtureId"),
                "fixture": (
                    FixtureProgressionsModelFixture.from_dict(obj.get("fixture"))
