...
class GameLogPersonResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GameLogPersonResponse:
        """Create an instance of GameLogPersonResponse from a JSON string"""
        ...
        _obj = GameLogPersonResponse.parse_obj(
            {
                ...
                "data": (
                    [GameLogPersonModel.from_dict(_item) for _item in obj.get("data")]
