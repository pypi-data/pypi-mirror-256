...
class SeasonFixtureStagesPoolsListResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonFixtureStagesPoolsListResponse:
        """Create an instance of SeasonFixtureStagesPoolsListResponse from a JSON string"""
        ...
        _obj = SeasonFixtureStagesPoolsListResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonFixtureStagesPoolsListModel.from_dict(_item) for _item in obj.get("data")]
