...
class CompetitionEntityStatisticsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionEntityStatisticsResponse:
        """Create an instance of CompetitionEntityStatisticsResponse from a JSON string"""
        ...
        _obj = CompetitionEntityStatisticsResponse.parse_obj(
            {
                ...
                "data": (
                    [CompetitionEntityStatisticsModel.from_dict(_item) for _item in obj.get("data")]
