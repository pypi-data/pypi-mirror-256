...
class SeasonStagesResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonStagesResponse:
        """Create an instance of SeasonStagesResponse from a JSON string"""
        ...
        _obj = SeasonStagesResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonStagesModel.from_dict(_item) for _item in obj.get("data")]
