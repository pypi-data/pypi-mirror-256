...
class SeasonEntitiesModel(BaseModel):
    """
    SeasonEntitiesModel
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonEntitiesModel:
        """Create an instance of SeasonEntitiesModel from a JSON string"""
        ...
        _obj = SeasonEntitiesModel.parse_obj(
            {
                ...
                "organization": (
                    SeasonEntitiesListModelOrganization.from_dict(obj.get("organization"))
