...
class StandingPostBody(BaseModel):
    ...
    grouping_base: constr(strict=True, max_length=50) = Field(
        ..., alias="groupingBase", description="Base grouping of standings row >- `OVERALL` Overall >- `ROUND` Round "
    )
    grouping_conference_division: constr(strict=True, max_length=50) = Field(
        ...,
    ...
    grouping_stage_pool: constr(strict=True, max_length=50) = Field(
        ...,
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StandingPostBody:
