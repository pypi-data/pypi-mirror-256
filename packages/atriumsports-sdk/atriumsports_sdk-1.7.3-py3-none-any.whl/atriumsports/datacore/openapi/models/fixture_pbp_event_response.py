...
class FixturePbpEventResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturePbpEventResponse:
        """Create an instance of FixturePbpEventResponse from a JSON string"""
        ...
        _obj = FixturePbpEventResponse.parse_obj(
            {
                ...
                "data": (
                    [FixturePbpEventModel.from_dict(_item) for _item in obj.get("data")]
