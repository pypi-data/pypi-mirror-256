...
class LeaderSummaryResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeaderSummaryResponse:
        """Create an instance of LeaderSummaryResponse from a JSON string"""
        ...
        _obj = LeaderSummaryResponse.parse_obj(
            {
                ...
                "data": (
                    [LeaderSummaryModel.from_dict(_item) for _item in obj.get("data")]
