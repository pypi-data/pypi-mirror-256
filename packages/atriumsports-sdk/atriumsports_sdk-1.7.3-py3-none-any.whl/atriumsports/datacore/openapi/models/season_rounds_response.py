...
class SeasonRoundsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonRoundsResponse:
        """Create an instance of SeasonRoundsResponse from a JSON string"""
        ...
        _obj = SeasonRoundsResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonRoundsModel.from_dict(_item) for _item in obj.get("data")]
