...
class ConferenceExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(ConferenceExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConferenceExternalIdsResponse:
        """Create an instance of ConferenceExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConferenceExternalIdsResponse:
        """Create an instance of ConferenceExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConferenceExternalIdsResponse.parse_obj(obj)

        _obj = ConferenceExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [ConferenceExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
