...
class VideoFilesDownloadResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoFilesDownloadResponse:
        """Create an instance of VideoFilesDownloadResponse from a JSON string"""
        ...
        _obj = VideoFilesDownloadResponse.parse_obj(
            {
                ...
                "data": (
                    [VideoFilesDownloadModel.from_dict(_item) for _item in obj.get("data")]
