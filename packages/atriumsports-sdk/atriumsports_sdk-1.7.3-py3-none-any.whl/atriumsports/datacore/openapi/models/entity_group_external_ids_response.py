...
class EntityGroupExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(EntityGroupExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityGroupExternalIdsResponse:
        """Create an instance of EntityGroupExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityGroupExternalIdsResponse:
        """Create an instance of EntityGroupExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityGroupExternalIdsResponse.parse_obj(obj)

        _obj = EntityGroupExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [EntityGroupExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
