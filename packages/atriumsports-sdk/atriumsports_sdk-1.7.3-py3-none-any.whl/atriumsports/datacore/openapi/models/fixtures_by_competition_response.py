...
class FixturesByCompetitionResponse(BaseModel):
    """
    ...
    data: Optional[conlist(FixturesByCompetitionModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturesByCompetitionResponse:
        """Create an instance of FixturesByCompetitionResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FixturesByCompetitionResponse:
        """Create an instance of FixturesByCompetitionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixturesByCompetitionResponse.parse_obj(obj)

        _obj = FixturesByCompetitionResponse.parse_obj(
            {
                ...
                "data": (
                    [FixturesByCompetitionModel.from_dict(_item) for _item in obj.get("data")]
