...
class FixtureRosterResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureRosterResponse:
        """Create an instance of FixtureRosterResponse from a JSON string"""
        ...
        _obj = FixtureRosterResponse.parse_obj(
            {
                ...
                "data": (
                    [FixtureRosterModel.from_dict(_item) for _item in obj.get("data")]
