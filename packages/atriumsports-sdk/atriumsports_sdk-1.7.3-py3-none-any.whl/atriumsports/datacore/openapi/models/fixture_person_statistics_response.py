...
class FixturePersonStatisticsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturePersonStatisticsResponse:
        """Create an instance of FixturePersonStatisticsResponse from a JSON string"""
        ...
        _obj = FixturePersonStatisticsResponse.parse_obj(
            {
                ...
                "data": (
                    [FixturePersonStatisticsModel.from_dict(_item) for _item in obj.get("data")]
