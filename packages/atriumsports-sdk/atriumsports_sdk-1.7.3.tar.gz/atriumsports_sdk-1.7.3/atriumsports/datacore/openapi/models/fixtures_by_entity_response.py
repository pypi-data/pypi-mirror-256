...
class FixturesByEntityResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturesByEntityResponse:
        """Create an instance of FixturesByEntityResponse from a JSON string"""
        ...
        _obj = FixturesByEntityResponse.parse_obj(
            {
                ...
                "data": (
                    [FixturesByEntityModel.from_dict(_item) for _item in obj.get("data")]
