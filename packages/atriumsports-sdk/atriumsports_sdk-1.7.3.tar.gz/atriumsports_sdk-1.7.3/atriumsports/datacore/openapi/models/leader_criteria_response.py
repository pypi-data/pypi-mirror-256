...
class LeaderCriteriaResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeaderCriteriaResponse:
        """Create an instance of LeaderCriteriaResponse from a JSON string"""
        ...
        _obj = LeaderCriteriaResponse.parse_obj(
            {
                ...
                "data": (
                    [LeaderCriteriaModel.from_dict(_item) for _item in obj.get("data")]
