...
class FixturesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturesResponse:
        """Create an instance of FixturesResponse from a JSON string"""
        ...
        _obj = FixturesResponse.parse_obj(
            {
                ...
                "data": (
                    [FixturesModel.from_dict(_item) for _item in obj.get("data")]
