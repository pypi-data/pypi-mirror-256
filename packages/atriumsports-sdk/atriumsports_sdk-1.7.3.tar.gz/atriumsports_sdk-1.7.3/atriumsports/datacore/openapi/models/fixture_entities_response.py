...
class FixtureEntitiesResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureEntitiesResponse:
        """Create an instance of FixtureEntitiesResponse from a JSON string"""
        ...
        _obj = FixtureEntitiesResponse.parse_obj(
            {
                ...
                "data": (
                    [FixtureEntitiesModel.from_dict(_item) for _item in obj.get("data")]
