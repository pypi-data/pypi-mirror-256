...
class SeasonStandingsStagesPoolsListResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonStandingsStagesPoolsListResponse:
        """Create an instance of SeasonStandingsStagesPoolsListResponse from a JSON string"""
        ...
        _obj = SeasonStandingsStagesPoolsListResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonStandingsStagesPoolsListModel.from_dict(_item) for _item in obj.get("data")]
