...
class LeagueExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(LeagueExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeagueExternalIdsResponse:
        """Create an instance of LeagueExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeagueExternalIdsResponse:
        """Create an instance of LeagueExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LeagueExternalIdsResponse.parse_obj(obj)

        _obj = LeagueExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [LeagueExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
