...
class SeasonPostBody(BaseModel):
    ...
    competition_id: StrictStr = Field(
        ..., alias="competitionId", description="The unique identifier of the competition"
    )
    ...
    season_type: constr(strict=True, max_length=30) = Field(
        ...,
        alias="seasonType",
    ...
    standard: constr(strict=True, max_length=50) = Field(
        ...,
    ...
    representation: constr(strict=True, max_length=50) = Field(
        ...,
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPostBody:
        ...
        _obj = SeasonPostBody.parse_obj(
            {
                ...
                "roster_configuration": (
                    SEASONROSTERConfiguration.from_dict(obj.get("rosterConfiguration"))
