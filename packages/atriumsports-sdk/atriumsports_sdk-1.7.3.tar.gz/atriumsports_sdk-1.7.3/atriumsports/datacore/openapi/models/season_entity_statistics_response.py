...
class SeasonEntityStatisticsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonEntityStatisticsResponse:
        """Create an instance of SeasonEntityStatisticsResponse from a JSON string"""
        ...
        _obj = SeasonEntityStatisticsResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonEntityStatisticsModel.from_dict(_item) for _item in obj.get("data")]
