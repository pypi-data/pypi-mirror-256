...
class FixturePersonStatisticsPeriodsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturePersonStatisticsPeriodsResponse:
        """Create an instance of FixturePersonStatisticsPeriodsResponse from a JSON string"""
        ...
        _obj = FixturePersonStatisticsPeriodsResponse.parse_obj(
            {
                ...
                "data": (
                    [FixturePersonStatisticsPeriodsModel.from_dict(_item) for _item in obj.get("data")]
