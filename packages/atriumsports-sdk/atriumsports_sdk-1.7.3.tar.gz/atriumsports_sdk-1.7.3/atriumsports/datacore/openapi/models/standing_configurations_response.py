...
class StandingConfigurationsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StandingConfigurationsResponse:
        """Create an instance of StandingConfigurationsResponse from a JSON string"""
        ...
        _obj = StandingConfigurationsResponse.parse_obj(
            {
                ...
                "data": (
                    [StandingConfigurationsModel.from_dict(_item) for _item in obj.get("data")]
