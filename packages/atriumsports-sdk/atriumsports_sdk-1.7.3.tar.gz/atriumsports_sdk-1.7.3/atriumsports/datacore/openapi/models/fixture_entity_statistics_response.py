...
class FixtureEntityStatisticsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureEntityStatisticsResponse:
        """Create an instance of FixtureEntityStatisticsResponse from a JSON string"""
        ...
        _obj = FixtureEntityStatisticsResponse.parse_obj(
            {
                ...
                "data": (
                    [FixtureEntityStatisticsModel.from_dict(_item) for _item in obj.get("data")]
