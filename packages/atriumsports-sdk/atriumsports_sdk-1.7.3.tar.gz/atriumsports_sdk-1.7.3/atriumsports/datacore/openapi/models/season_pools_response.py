...
class SeasonPoolsResponse(BaseModel):
    """
    SeasonPoolsResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPoolsResponse:
        """Create an instance of SeasonPoolsResponse from a JSON string"""
        ...
        _obj = SeasonPoolsResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonPoolsModel.from_dict(_item) for _item in obj.get("data")]
