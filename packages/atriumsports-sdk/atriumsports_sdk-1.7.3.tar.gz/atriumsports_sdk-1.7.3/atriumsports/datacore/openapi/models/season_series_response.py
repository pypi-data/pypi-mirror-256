...
class SeasonSeriesResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonSeriesResponse:
        """Create an instance of SeasonSeriesResponse from a JSON string"""
        ...
        _obj = SeasonSeriesResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonSeriesModel.from_dict(_item) for _item in obj.get("data")]
