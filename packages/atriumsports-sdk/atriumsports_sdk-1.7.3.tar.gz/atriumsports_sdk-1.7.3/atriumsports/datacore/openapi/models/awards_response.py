...
class AwardsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AwardsResponse:
        """Create an instance of AwardsResponse from a JSON string"""
        ...
        _obj = AwardsResponse.parse_obj(
            {
                ...
                "data": (
                    [AwardsModel.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
                ),
            }
        )
        return _obj
