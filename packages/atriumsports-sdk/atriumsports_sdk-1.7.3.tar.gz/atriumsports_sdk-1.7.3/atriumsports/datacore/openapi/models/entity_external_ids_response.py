...
class EntityExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(EntityExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityExternalIdsResponse:
        """Create an instance of EntityExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityExternalIdsResponse:
        """Create an instance of EntityExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityExternalIdsResponse.parse_obj(obj)

        _obj = EntityExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [EntityExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
