...
class SeasonPersonsListModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPersonsListModel:
        """Create an instance of SeasonPersonsListModel from a JSON string"""
        ...
        _obj = SeasonPersonsListModel.parse_obj(
            {
                ...
                "organization": (
                    SeasonPersonsListModelOrganization.from_dict(obj.get("organization"))
