...
class GameLogEntityResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GameLogEntityResponse:
        """Create an instance of GameLogEntityResponse from a JSON string"""
        ...
        _obj = GameLogEntityResponse.parse_obj(
            {
                ...
                "data": (
                    [GameLogEntityModel.from_dict(_item) for _item in obj.get("data")]
