...
class CareerPersonSeasonStatisticsModel(BaseModel):
    """
    ...
    organization: Optional[CareerPersonSeasonStatisticsModelOrganization] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CareerPersonSeasonStatisticsModel:
        """Create an instance of CareerPersonSeasonStatisticsModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CareerPersonSeasonStatisticsModel:
        """Create an instance of CareerPersonSeasonStatisticsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CareerPersonSeasonStatisticsModel.parse_obj(obj)

        _obj = CareerPersonSeasonStatisticsModel.parse_obj(
            {
                "person_id": obj.get("personId"),
                "person": (
                    FixturePersonsModelPerson.from_dict(obj.get("person")) if obj.get("person") is not None else None
                ),
                "organization_id": obj.get("organizationId"),
                "organization": (
                    CareerPersonSeasonStatisticsModelOrganization.from_dict(obj.get("organization"))
                    if obj.get("organization") is not None
                    else None
                ),
                "season_id": obj.get("seasonId"),
                "season": (
                    FixtureProgressionsModelSeason.from_dict(obj.get("season"))
