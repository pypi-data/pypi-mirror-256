...
class CareerPersonStatisticsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CareerPersonStatisticsResponse:
        """Create an instance of CareerPersonStatisticsResponse from a JSON string"""
        ...
        _obj = CareerPersonStatisticsResponse.parse_obj(
            {
                ...
                "data": (
                    [CareerPersonStatisticsModel.from_dict(_item) for _item in obj.get("data")]
