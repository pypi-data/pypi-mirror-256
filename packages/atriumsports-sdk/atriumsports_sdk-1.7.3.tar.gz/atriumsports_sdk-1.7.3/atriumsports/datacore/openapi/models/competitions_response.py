...
class CompetitionsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionsResponse:
        """Create an instance of CompetitionsResponse from a JSON string"""
        ...
        _obj = CompetitionsResponse.parse_obj(
            {
                ...
                "data": (
                    [CompetitionsModel.from_dict(_item) for _item in obj.get("data")]
