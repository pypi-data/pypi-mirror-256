...
class DivisionExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(DivisionExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DivisionExternalIdsResponse:
        """Create an instance of DivisionExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DivisionExternalIdsResponse:
        """Create an instance of DivisionExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DivisionExternalIdsResponse.parse_obj(obj)

        _obj = DivisionExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [DivisionExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
