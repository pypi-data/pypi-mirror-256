...
class SeasonExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(SeasonExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonExternalIdsResponse:
        """Create an instance of SeasonExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeasonExternalIdsResponse:
        """Create an instance of SeasonExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SeasonExternalIdsResponse.parse_obj(obj)

        _obj = SeasonExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
