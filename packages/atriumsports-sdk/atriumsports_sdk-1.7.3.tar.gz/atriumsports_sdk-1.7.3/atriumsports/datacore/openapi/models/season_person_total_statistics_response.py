...
class SeasonPersonTotalStatisticsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPersonTotalStatisticsResponse:
        """Create an instance of SeasonPersonTotalStatisticsResponse from a JSON string"""
        ...
        _obj = SeasonPersonTotalStatisticsResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonPersonTotalStatisticsModel.from_dict(_item) for _item in obj.get("data")]
