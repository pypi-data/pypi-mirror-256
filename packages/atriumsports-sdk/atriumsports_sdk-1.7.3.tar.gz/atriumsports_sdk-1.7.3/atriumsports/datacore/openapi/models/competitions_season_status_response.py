...
class CompetitionsSeasonStatusResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionsSeasonStatusResponse:
        """Create an instance of CompetitionsSeasonStatusResponse from a JSON string"""
        ...
        _obj = CompetitionsSeasonStatusResponse.parse_obj(
            {
                ...
                "data": (
                    [CompetitionsSeasonStatusModel.from_dict(_item) for _item in obj.get("data")]
