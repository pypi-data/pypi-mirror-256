...
class FixtureProgressionsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureProgressionsResponse:
        """Create an instance of FixtureProgressionsResponse from a JSON string"""
        ...
        _obj = FixtureProgressionsResponse.parse_obj(
            {
                ...
                "data": (
                    [FixtureProgressionsModel.from_dict(_item) for _item in obj.get("data")]
