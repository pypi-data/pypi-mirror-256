...
class SeasonVenuesListResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonVenuesListResponse:
        """Create an instance of SeasonVenuesListResponse from a JSON string"""
        ...
        _obj = SeasonVenuesListResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonVenuesListModel.from_dict(_item) for _item in obj.get("data")]
