...
class VenueExternalIdsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(VenueExternalIdsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VenueExternalIdsResponse:
        """Create an instance of VenueExternalIdsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VenueExternalIdsResponse:
        """Create an instance of VenueExternalIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VenueExternalIdsResponse.parse_obj(obj)

        _obj = VenueExternalIdsResponse.parse_obj(
            {
                ...
                "data": (
                    [VenueExternalIdsModel.from_dict(_item) for _item in obj.get("data")]
