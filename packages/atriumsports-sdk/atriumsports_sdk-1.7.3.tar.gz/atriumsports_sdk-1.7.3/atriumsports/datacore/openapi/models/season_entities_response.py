...
class SeasonEntitiesResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonEntitiesResponse:
        """Create an instance of SeasonEntitiesResponse from a JSON string"""
        ...
        _obj = SeasonEntitiesResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonEntitiesModel.from_dict(_item) for _item in obj.get("data")]
