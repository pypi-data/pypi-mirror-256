...
class EntityGroupsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityGroupsResponse:
        """Create an instance of EntityGroupsResponse from a JSON string"""
        ...
        _obj = EntityGroupsResponse.parse_obj(
            {
                ...
                "data": (
                    [EntityGroupsModel.from_dict(_item) for _item in obj.get("data")]
