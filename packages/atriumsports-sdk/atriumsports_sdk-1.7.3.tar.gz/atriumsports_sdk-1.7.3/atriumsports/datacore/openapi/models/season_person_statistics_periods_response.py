...
class SeasonPersonStatisticsPeriodsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPersonStatisticsPeriodsResponse:
        """Create an instance of SeasonPersonStatisticsPeriodsResponse from a JSON string"""
        ...
        _obj = SeasonPersonStatisticsPeriodsResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonPersonStatisticsPeriodsModel.from_dict(_item) for _item in obj.get("data")]
