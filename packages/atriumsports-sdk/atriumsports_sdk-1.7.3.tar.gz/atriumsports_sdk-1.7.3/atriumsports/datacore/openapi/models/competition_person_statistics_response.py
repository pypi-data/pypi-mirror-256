...
class CompetitionPersonStatisticsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionPersonStatisticsResponse:
        """Create an instance of CompetitionPersonStatisticsResponse from a JSON string"""
        ...
        _obj = CompetitionPersonStatisticsResponse.parse_obj(
            {
                ...
                "data": (
                    [CompetitionPersonStatisticsModel.from_dict(_item) for _item in obj.get("data")]
