...
class LeagueExternalIdsModel(BaseModel):
    """
    ...
    organization: Optional[LeagueExternalIdsModelOrganization] = None
    league_id: Optional[StrictStr] = Field(None, alias="leagueId", description="The unique identifier of the league")
    league: Optional[LeagueExternalIdsModelLeague] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeagueExternalIdsModel:
        """Create an instance of LeagueExternalIdsModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeagueExternalIdsModel:
        """Create an instance of LeagueExternalIdsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LeagueExternalIdsModel.parse_obj(obj)

        _obj = LeagueExternalIdsModel.parse_obj(
            {
                "league_external_id": obj.get("leagueExternalId"),
                "organization_id": obj.get("organizationId"),
                "organization": (
                    LeagueExternalIdsModelOrganization.from_dict(obj.get("organization"))
                    if obj.get("organization") is not None
                    else None
                ),
                "league_id": obj.get("leagueId"),
                "league": (
                    LeagueExternalIdsModelLeague.from_dict(obj.get("league")) if obj.get("league") is not None else None
                ),
