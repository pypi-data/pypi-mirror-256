...
class StandingConfigurationsPutBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StandingConfigurationsPutBody:
        """Create an instance of StandingConfigurationsPutBody from a JSON string"""
        ...
        _obj = StandingConfigurationsPutBody.parse_obj(
            {
                ...
                "build_rules": (
                    StandingBuilding.from_dict(obj.get("buildRules")) if obj.get("buildRules") is not None else None
                ),
                "configuration": (
                    StandingConfiguration.from_dict(obj.get("configuration"))
