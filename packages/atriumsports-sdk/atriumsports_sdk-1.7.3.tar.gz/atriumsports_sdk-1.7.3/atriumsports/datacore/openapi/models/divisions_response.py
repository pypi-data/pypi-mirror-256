...
class DivisionsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DivisionsResponse:
        """Create an instance of DivisionsResponse from a JSON string"""
        ...
        _obj = DivisionsResponse.parse_obj(
            {
                ...
                "data": (
                    [DivisionsModel.from_dict(_item) for _item in obj.get("data")]
