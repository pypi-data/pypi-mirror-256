...
class ConductResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConductResponse:
        """Create an instance of ConductResponse from a JSON string"""
        ...
        _obj = ConductResponse.parse_obj(
            {
                ...
                "data": (
                    [ConductModel.from_dict(_item) for _item in obj.get("data")]
