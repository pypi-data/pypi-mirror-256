...
class SeasonPersonTotalStatisticsModel(BaseModel):
    """
    ...
    organization: Optional[SeasonPersonTotalStatisticsModelOrganization] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPersonTotalStatisticsModel:
        """Create an instance of SeasonPersonTotalStatisticsModel from a JSON string"""
        ...
        _obj = SeasonPersonTotalStatisticsModel.parse_obj(
            {
                ...
                "organization": (
                    SeasonPersonTotalStatisticsModelOrganization.from_dict(obj.get("organization"))
