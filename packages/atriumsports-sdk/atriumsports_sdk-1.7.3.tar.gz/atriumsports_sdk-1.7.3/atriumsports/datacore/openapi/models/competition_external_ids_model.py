...
class CompetitionExternalIdsModel(BaseModel):
    """
    CompetitionExternalIdsModel
    """

    competition_external_id: Optional[StrictStr] = Field(
        None, alias="competitionExternalId", description="The unique identifier of the external ids"
    )
    organization_id: Optional[StrictStr] = Field(
        None, alias="organizationId", description="The unique identifier of the organization"
    )
    organization: Optional[CompetitionExternalIdsModelOrganization] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionExternalIdsModel:
        """Create an instance of CompetitionExternalIdsModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompetitionExternalIdsModel:
        """Create an instance of CompetitionExternalIdsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompetitionExternalIdsModel.parse_obj(obj)

        _obj = CompetitionExternalIdsModel.parse_obj(
            {
                "competition_external_id": obj.get("competitionExternalId"),
                "organization_id": obj.get("organizationId"),
                "organization": (
                    CompetitionExternalIdsModelOrganization.from_dict(obj.get("organization"))
                    if obj.get("organization") is not None
                    else None
                ),
                "competition_id": obj.get("competitionId"),
                "competition": (
                    SeasonsModelCompetition.from_dict(obj.get("competition"))
