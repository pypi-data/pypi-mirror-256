...
class SeasonPersonsListResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPersonsListResponse:
        """Create an instance of SeasonPersonsListResponse from a JSON string"""
        ...
        _obj = SeasonPersonsListResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonPersonsListModel.from_dict(_item) for _item in obj.get("data")]
