...
class SeasonsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonsResponse:
        """Create an instance of SeasonsResponse from a JSON string"""
        ...
        _obj = SeasonsResponse.parse_obj(
            {
                ...
                "data": (
                    [SeasonsModel.from_dict(_item) for _item in obj.get("data")]
