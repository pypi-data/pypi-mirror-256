...
class FixtureEntityStatisticsPeriodsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureEntityStatisticsPeriodsResponse:
        """Create an instance of FixtureEntityStatisticsPeriodsResponse from a JSON string"""
        ...
        _obj = FixtureEntityStatisticsPeriodsResponse.parse_obj(
            {
                ...
                "data": (
                    [FixtureEntityStatisticsPeriodsModel.from_dict(_item) for _item in obj.get("data")]
