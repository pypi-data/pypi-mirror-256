...
class FixturePersonsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturePersonsResponse:
        """Create an instance of FixturePersonsResponse from a JSON string"""
        ...
        _obj = FixturePersonsResponse.parse_obj(
            {
                ...
                "data": (
                    [FixturePersonsModel.from_dict(_item) for _item in obj.get("data")]
