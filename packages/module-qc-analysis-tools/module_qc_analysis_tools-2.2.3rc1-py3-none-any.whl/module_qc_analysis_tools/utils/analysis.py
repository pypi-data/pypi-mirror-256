...
def print_result_summary(cell_text, test_type, outputdir, chipname, label=""):
    ...
    if test_type == "ANALOG_READBACK":
        cell_text1 = cell_text[:31, :]
        cellColours1 = cellColours[:31, :]
        ...
        cell_text2 = cell_text[31:65, :]
        cellColours2 = cellColours[31:65, :]
        nrows, _ncols = cell_text2.shape
        fig, ax = plt.subplots(figsize=(6.4, 1.5 + nrows * 0.5))
        table = ax.table(
            cellText=cell_text2,
            colLabels=colLabels,
