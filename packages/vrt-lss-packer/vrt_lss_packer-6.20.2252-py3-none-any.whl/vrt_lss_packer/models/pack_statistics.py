...
class PackStatistics(BaseModel):
    """
    General statistics for packing scheme.   # noqa: E501
    """
    ...
    __properties = ["products_count", "packages_count", "total_mass", "total_volume", "package_statistics"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PackStatistics:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PackStatistics:
        """Create an instance of PackStatistics from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PackStatistics.parse_obj(obj)

        _obj = PackStatistics.parse_obj({
            ...
            "package_statistics": [PackageStatistics.from_dict(_item) for _item in obj.get("package_statistics")] if obj.get("package_statistics") is not None else None
        })
        return _obj
