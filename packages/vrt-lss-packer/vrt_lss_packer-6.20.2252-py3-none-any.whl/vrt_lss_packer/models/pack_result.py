...
class PackResult(BaseModel):
    ...
    __properties = ["tracedata", "blueprint", "statistics", "warnings", "unpacked_items", "progress", "info"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PackResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PackResult:
        """Create an instance of PackResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PackResult.parse_obj(obj)

        _obj = PackResult.parse_obj({
            ...
            "statistics": PackStatistics.from_dict(obj.get("statistics")) if obj.get("statistics") is not None else None,
            "warnings": [EntityWarning.from_dict(_item) for _item in obj.get("warnings")] if obj.get("warnings") is not None else None,
            "unpacked_items": UnpackedItems.from_dict(obj.get("unpacked_items")) if obj.get("unpacked_items") is not None else None,
