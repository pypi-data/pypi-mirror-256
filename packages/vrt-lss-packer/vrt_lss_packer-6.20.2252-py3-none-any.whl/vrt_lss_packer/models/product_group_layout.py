...
class ProductGroupLayout(BaseModel):
    """
    The layout of the group of same (by key) product in the package. Product group - virtual package that combines the same (by key) product inside another package.   # noqa: E501
    """
