...
class UnpackedItems(BaseModel):
    ...
    __properties = ["product_keys", "package_keys"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnpackedItems:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnpackedItems:
        """Create an instance of UnpackedItems from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnpackedItems.parse_obj(obj)

        _obj = UnpackedItems.parse_obj({
