...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_glean_core_checksum_constructor_numeratormetric_new() != 57953:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_pingtype_new() != 52919:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class PingRequest:
    document_id: "str";path: "str";body: "typing.List[int]";headers: "dict";

    @typing.no_type_check
    def __init__(self, document_id: "str", path: "str", body: "typing.List[int]", headers: "dict"):
