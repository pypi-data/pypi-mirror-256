...
class AbstractController():
    ...
    def register_constants(self, fieldnames: str, values: typing.Any) -> None: ...
    def register_variable(self, fieldname: str, value: typing.Any) -> None: 
        """
    ...
    def sensor_measurements(self) -> SensorMeasurementTree:
        ...
        """
    pass
class AbstractFunctionalController(AbstractController):
...
class AbstractMotor():
    ...
    def joint_name(self) -> str:
        ...
        """
    @property
    def joint_position_index(self) -> int:
        """
        :type: int
        """
    @property
    def joint_type(self) -> JointModelType:
        ...
        """
    @property
    def joint_velocity_index(self) -> int:
        """
        :type: int
        """
    @property
...
class CouplingForce():
    ...
    def func(self) -> typing.Any:
        ...
        """
    @property
    def system_index_1(self) -> int:
        """
        :type: int
        """
    @property
    def system_index_2(self) -> int:
        """
        :type: int
        """
    @property
...
class EngineMultiRobot():
    def __init__(self) -> None: ...
    def add_system(self, system_name: str, robot: Robot, controller: typing.Any = None, callback_function: typing.Any = None) -> None: ...
    @staticmethod
    def compute_forward_kinematics(system: System, q: numpy.ndarray, v: numpy.ndarray, a: numpy.ndarray) -> None: ...
    def compute_systems_dynamics(self, t_end: float, q_list: typing.Any, v_list: typing.Any) -> list: ...
    def get_options(self) -> dict: ...
    @staticmethod
    def read_log(fullpath: str, format: typing.Any = None) -> dict: 
        ...
        """
    def register_coupling_force(self, system_name_1: str, system_name_2: str, frame_name_1: str, frame_name_2: str, force_function: typing.Any) -> None: ...
    def register_impulse_force(self, system_name: str, frame_name: str, t: float, dt: float, force: numpy.ndarray) -> None: ...
    def register_profile_force(self, system_name: str, frame_name: str, force_function: typing.Any, update_period: float = 0.0) -> None: ...
    @typing.overload
    def register_viscoelastic_coupling_force(self, system_name_1: str, system_name_2: str, frame_name_1: str, frame_name_2: str, stiffness: numpy.ndarray, damping: numpy.ndarray, alpha: float = 0.5) -> None: ...
    @typing.overload
    def register_viscoelastic_coupling_force(self, system_name: str, frame_name_1: str, frame_name_2: str, stiffness: numpy.ndarray, damping: numpy.ndarray, alpha: float = 0.5) -> None: ...
    @typing.overload
    def register_viscoelastic_directional_coupling_force(self, system_name_1: str, system_name_2: str, frame_name_1: str, frame_name_2: str, stiffness: float, damping: float, rest_length: float = 0.0) -> None: ...
    @typing.overload
    def register_viscoelastic_directional_coupling_force(self, system_name: str, frame_name_1: str, frame_name_2: str, stiffness: float, damping: float, rest_length: float = 0.0) -> None: ...
    def remove_all_forces(self) -> None: ...
    @typing.overload
    def remove_coupling_forces(self, system_name_1: str, system_name_2: str) -> None: ...
    @typing.overload
    def remove_coupling_forces(self, system_name: str) -> None: ...
    def remove_impulse_forces(self, system_name: str) -> None: ...
    def remove_profile_forces(self, system_name: str) -> None: ...
    ...
    def set_controller(self, system_name: str, controller: AbstractController) -> None: ...
    def set_options(self, arg2: dict) -> None: ...
    def simulate(self, t_end: float, q_init_list: dict, v_init_list: dict, a_init_list: typing.Any = None) -> None: ...
    def start(self, q_init_list: dict, v_init_list: dict, a_init_list: typing.Any = None) -> None: ...
    def step(self, dt_desired: float = -1) -> None: ...
    def stop(self) -> None: ...
    ...
    def stepper_state(self) -> StepperState:
        ...
        """
    @property
    def system_names(self) -> StdVec_StdString:
        """
        :type: StdVec_StdString
        """
    @property
    def system_states(self) -> list:
        """
        :type: list
        """
    @property
...
class Engine(EngineMultiRobot):
    def __init__(self) -> None: ...
    def add_system(self, arg2: str, arg3: Robot, arg4: AbstractController) -> None: ...
    def initialize(self, robot: Robot, controller: AbstractController = None, callback_function: typing.Any = None) -> None: ...
    def register_coupling_force(self, frame_name_1: str, frame_name_2: str, force_function: typing.Any) -> None: ...
    def register_impulse_force(self, frame_name: str, t: float, dt: float, force: numpy.ndarray) -> None: ...
    def register_profile_force(self, frame_name: str, force_function: typing.Any, update_period: float = 0.0) -> None: ...
    def register_viscoelastic_coupling_force(self, frame_name_1: str, frame_name_2: str, stiffness: numpy.ndarray, damping: numpy.ndarray, alpha: float = 0.5) -> None: ...
    def register_viscoelastic_directional_coupling_force(self, frame_name_1: str, frame_name_2: str, stiffness: float, damping: float, rest_length: float = 0.0) -> None: ...
    def remove_system(self, system_name: str) -> None: ...
    def set_controller(self, controller: AbstractController) -> None: ...
    def simulate(self, t_end: float, q_init: numpy.ndarray, v_init: numpy.ndarray, a_init: typing.Any = None, is_state_theoretical: bool = False) -> None: ...
    ...
    def controller(self) -> AbstractController:
        ...
        """
    @property
    def impulse_forces(self) -> ImpulseForceVector:
        """
        :type: ImpulseForceVector
        """
    @property
    def is_initialized(self) -> bool:
        """
        ...
        """
    @property
    def profile_forces(self) -> ProfileForceVector:
        """
        :type: ProfileForceVector
        """
    @property
    def robot(self) -> Robot:
        """
...
class FrameConstraint(AbstractConstraint):
    ...
    pass
class FunctionalController(AbstractFunctionalController, AbstractController):
...
class Model():
    ...
    def contact_frame_names(self) -> StdVec_StdString:
        ...
        """
    @property
    def flexible_joint_indices(self) -> StdVec_Index:
        """
        :type: StdVec_Index
        """
    @property
    def flexible_joint_names(self) -> StdVec_StdString:
        """
        :type: StdVec_StdString
        """
    @property
    ...
    def position_limit_upper(self) -> numpy.ndarray:
        ...
        """
    @property
    def rigid_joint_index(self) -> StdVec_Index:
        """
        :type: StdVec_Index
        """
    @property
    def rigid_joint_names(self) -> StdVec_StdString:
        """
        :type: StdVec_StdString
        """
    @property
    def rigid_joint_position_indices(self) -> typing.Any:
        """
        :type: typing.Any
        """
    @property
    def rigid_joint_velocity_indices(self) -> typing.Any:
        """
        :type: typing.Any
        """
    @property
...
class Robot(Model):
    ...
    def dump_options(self, json_filename: str) -> None: ...
    ...
    @typing.overload
    def initialize(self, pinocchio_model: Model, collision_model: GeometryModel, visual_model: GeometryModel) -> None: ...
    def load_options(self, json_filename: str) -> None: ...
    def set_model_options(self, model_options: dict) -> None: ...
    def set_motors_options(self, motors_options: dict) -> None: ...
    def set_options(self, robot_options: dict) -> None: ...
    def set_sensors_options(self, sensors_options: dict) -> None: ...
    def set_telemetry_options(self, telemetry_options: dict) -> None: ...
    @property
    ...
    def log_command_fieldnames(self) -> StdVec_StdString:
        ...
        """
    @property
    def log_motor_effort_fieldnames(self) -> StdVec_StdString:
        """
        :type: StdVec_StdString
        """
    @property
    def motor_names(self) -> StdVec_StdString:
        """
        :type: StdVec_StdString
        """
    @property
    def motor_position_indices(self) -> typing.Any:
        """
        :type: typing.Any
        """
    @property
    def motor_velocity_indices(self) -> typing.Any:
        """
        :type: typing.Any
        """
    @property
...
class System():
    @property
    def callbackFct(self) -> TimeStateBoolFunctor:
        """
        :type: TimeStateBoolFunctor
        """
    @property
    def controller(self) -> AbstractController:
        """
...
def build_models_from_urdf(urdf_path: str, has_freeflyer: bool, mesh_package_dirs: typing.Any = [], build_visual_model: bool = False, load_visual_meshes: bool = False) -> tuple:
    pass
def computeJMinvJt(pinocchio_model: Model, pinocchio_data: Data, J: numpy.ndarray, update_decomposition: bool = True) -> None:
    pass
def computeKineticEnergy(arg1: Model, pinocchio_model: Data, pinocchio_data: numpy.ndarray, q: numpy.ndarray, v: bool) -> float:
    ...
    """
def crba(pinocchio_model: Model, pinocchio_data: Data, q: numpy.ndarray, fast_math: bool = False) -> numpy.ndarray:
    """
...
def discretize_heightmap(heightmap: HeightmapFunction, x_min: float, x_max: float, x_unit: float, y_min: float, y_max: float, y_unit: float, must_simplify: bool = False) -> CollisionGeometry:
    pass
def get_frame_indices(pinocchio_model: Model, frames_names: StdVec_StdString) -> StdVec_Index:
    pass
...
__all__ = ['AbstractConstraint', 'AbstractController', 'AbstractFunctionalController', 'AbstractMotor', 'AbstractPerlinProcess', 'AbstractSensor', 'BadControlFlow', 'BaseConstraint', 'BaseController', 'ConstraintTree', 'ContactSensor', 'CouplingForce', 'CouplingForceVector', 'DistanceConstraint', 'EffortSensor', 'EncoderSensor', 'Engine', 'EngineMultiRobot', 'ForceSensor', 'FrameConstraint', 'FunctionalController', 'HeightmapFunction', 'ImpulseForce', 'ImpulseForceVector', 'ImuSensor', 'JointConstraint', 'JointModelType', 'LogicError', 'LookupError', 'Model', 'NotImplementedError', 'OSError', 'PCG32', 'PeriodicFourierProcess', 'PeriodicGaussianProcess', 'PeriodicPerlinProcess', 'ProfileForce', 'ProfileForceVector', 'RandomPerlinProcess', 'Robot', 'SensorMeasurementTree', 'SimpleMotor', 'SphereConstraint', 'StepperState', 'System', 'SystemState', 'SystemVector', 'TimeStateBoolFunctor', 'TimeStateForceFunctor', 'WheelConstraint', 'aba', 'array_copyto', 'build_geom_from_urdf', 'build_models_from_urdf', 'computeJMinvJt', 'computeKineticEnergy', 'crba', 'discretize_heightmap', 'get_frame_indices', 'get_joint_indices', 'get_joint_position_first_index', 'get_joint_type', 'heightmapType_t', 'interpolate_positions', 'is_position_valid', 'merge_heightmaps', 'normal', 'random_tile_ground', 'rnea', 'seed', 'sharedMemory', 'solveJMinvJtv', 'sum_heightmaps', 'uniform', 'get_cmake_module_path', 'get_include', 'get_libraries', '__version__', '__raw_version__']
__raw_version__ = '1.8.1'
__version__ = '1.8.1'
_are_all_dependencies_available = True
_boost_python_lib = 'libboost_python312.so'
