...
if (NOT CMAKE_CXX_COMPILER_ID STREQUAL "MSVC" OR
        CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.37.32826.1)
    message(WARNING
        "Jiminy was compiled using MSVC 19.37.32826.1.\n"
...
set(jiminy_DEFINITIONS PINOCCHIO_WITH_URDFDOM;PINOCCHIO_WITH_HPP_FCL;BOOST_MPL_CFG_NO_PREPROCESSED_HEADERS=ON;BOOST_MPL_LIMIT_VECTOR_SIZE=30)
set(jiminy_OPTIONS /arch:AVX2)
if("/arch:AVX2" MATCHES "AVX[0-9]+")
