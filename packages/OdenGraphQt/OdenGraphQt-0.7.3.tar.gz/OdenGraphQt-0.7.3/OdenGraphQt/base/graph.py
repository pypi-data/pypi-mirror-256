...
from OdenGraphQt.errors import (
    NodeCreationError,
    NodeDeletionError,
)
from OdenGraphQt.nodes.backdrop_node import BackdropNode
from OdenGraphQt.nodes.base_node import BaseNode
from OdenGraphQt.nodes.group_node import GroupNode
from OdenGraphQt.nodes.port_node import (
    PortInputNode,
    PortOutputNode,
)
from OdenGraphQt.widgets.node_graph import (
    NodeGraphWidget,
    SubGraphWidget,
)
from OdenGraphQt.widgets.viewer import NodeViewer
from OdenGraphQt.widgets.viewer_nav import (
...
class NodeGraph(QtCore.QObject):
    ...
    .. inheritance-diagram:: OdenGraphQt.NodeGraph
    ...
    :parameters: list[:class:`OdenGraphQt.NodeObject`]
    ...
    :parameters: :class:`OdenGraphQt.NodeObject`
    :emits: created node
    """
    ...
    :parameters: list[:class:`OdenGraphQt.NodeObject`],
                 list[:class:`OdenGraphQt.NodeObject`]
    ...
    :parameters: :class:`OdenGraphQt.Port`, :class:`OdenGraphQt.Port`
    ...
    :parameters: :class:`OdenGraphQt.BaseNode`, str, object
    ...
    :parameters: 
        :class:`OdenGraphQt.NodeGraphMenu` or :class:`OdenGraphQt.NodesMenu`, 
        :class:`OdenGraphQt.BaseNode`
    ...
    def _on_node_data_dropped(self, mimedata, pos):
        ...
        if mimedata.hasFormat(MIME_TYPE):
            ...
            if not_supported_urls:
                ...
                print(f"Can't import the following urls:\n{not_supported_urls_}")
    ...
    def model(self):
        ...
        Returns:
            OdenGraphQt.base.model.NodeGraphModel: node graph model.
        """
        return self._model
    ...
    def viewer(self):
        ...
        Warnings:
            ...
            by ``OdenGraphQt`` components to get the widget use
        ...
        Returns:
            OdenGraphQt.widgets.viewer.NodeViewer: viewer interface.
        """
        return self._viewer
    ...
    def scene(self):
        ...
        Returns:
            OdenGraphQt.widgets.scene.NodeScene: node scene.
        """
    ...
    def set_grid_mode(self, mode=None):
        ...
        (default: :attr:`OdenGraphQt.constants.ViewerEnum.GRID_DISPLAY_LINES`).

        See: :attr:`OdenGraphQt.constants.ViewerEnum`
    ...
    def add_properties_bin(self, prop_bin):
        ...
        Args:
            prop_bin (OdenGraphQt.PropertiesBinWidget): properties widget.
        """
    ...
    def context_menu(self):
        ...
        Returns:
            OdenGraphQt.NodeGraphMenu: context menu object.
        """
    ...
    def context_nodes_menu(self):
        ...
        Returns:
            OdenGraphQt.NodesMenu: context menu object.
        """
    ...
    def get_context_menu(self, menu):
        ...
        Returns:
            OdenGraphQt.NodeGraphMenu or OdenGraphQt.NodesMenu: context menu object.
        """
    ...
    def _deserialize_context_menu(self, menu, menu_data):
        ...
        Args:
            menu (OdenGraphQt.NodeGraphMenu or OdenGraphQt.NodesMenu):
                parent context menu.
                    ...
                    'items': [
                        {
                            ...
                            'function': 'run_test',
                            'node_type': 'OdenGraphQt.nodes.MyNodeClass'
                        },
    ...
    def pipe_style(self):
        ...
        Returns:
            int: pipe style value. :attr:`OdenGraphQt.constants.PipeLayoutEnum`
        """
    ...
    def set_pipe_style(self, style=PipeLayoutEnum.CURVED.value):
        ...
        See: :attr:`OdenGraphQt.constants.PipeLayoutEnum`
    ...
    def set_layout_direction(self, direction):
        ...
        **Layout Types:**
        ...
        - :attr:`OdenGraphQt.constants.LayoutDirectionEnum.HORIZONTAL`
        - :attr:`OdenGraphQt.constants.LayoutDirectionEnum.VERTICAL`
    ...
    def center_on(self, nodes=None):
        ...
        Args:
            nodes (list[OdenGraphQt.BaseNode]): a list of nodes.
        """
        nodes = nodes or []
    ...
    def register_nodes(self, nodes):
        ...
        Args:
            nodes (list[OdenGraphQt.NodeObject]): list of nodes.
        """
    ...
    def add_node(self, node, pos=None, selected=True, push_undo=True):
        ...
        Args:
            node (OdenGraphQt.BaseNode): node object.
    ...
    def delete_nodes(self, nodes, push_undo=True):
        ...
        Args:
            nodes (list[OdenGraphQt.BaseNode]): list of node instances.
            push_undo (bool): register the command to the undo stack. (default: True)
        """
        if not nodes:
            return
    ...
    def all_nodes(self):
        ...
        Returns:
            list[OdenGraphQt.BaseNode]: list of nodes.
        """
    ...
    def get_node_by_id(self, node_id=None):
        ...
        Returns:
            OdenGraphQt.NodeObject: node object.
        """
    ...
    def get_nodes_by_type(self, node_type):
        ...
        (see: :attr:`OdenGraphQt.NodeObject.type_`)

        Args:
            node_type (str): node type identifier.

        Returns:
            list[OdenGraphQt.NodeObject]: list of nodes.
        """
    ...
    def _deserialize(self, data, relative_pos=False, pos=None):
        ...
        Returns:
            list[OdenGraphQt.Nodes]: list of node instances.
        """
    ...
    def copy_nodes(self, nodes=None):
        ...
        Args:
            nodes (list[OdenGraphQt.BaseNode]):
    ...
    def paste_nodes(self):
        ...
        Returns:
            list[OdenGraphQt.BaseNode]: list of pasted node instances.
        """
        clipboard = QtWidgets.QApplication.clipboard()
    ...
    def duplicate_nodes(self, nodes):
        ...
        Args:
            nodes (list[OdenGraphQt.BaseNode]): list of nodes.
        Returns:
            list[OdenGraphQt.BaseNode]: list of duplicated node instances.
        """
        if not nodes:
            return
    ...
    def _update_node_rank(node, nodes_rank, down_stream=True):
        ...
        Args:
            node (OdenGraphQt.BaseNode): node to start from.
    ...
    def _compute_node_rank(nodes, down_stream=True):
        ...
        Args:
            nodes (list[OdenGraphQt.BaseNode]): nodes to start ranking from.
            down_stream (bool): true to compute down stream.

        Returns:
            dict: {OdenGraphQt.BaseNode: node_rank, ...}
        """
        nodes_rank = {}
        for node in nodes:
            nodes_rank[node] = 0
    ...
    def auto_layout_nodes(self, nodes=None, down_stream=True, start_nodes=None):
        ...
        Args:
            nodes (list[OdenGraphQt.BaseNode]): list of nodes to auto layout
                if nodes is None then all nodes is layed out.
            down_stream (bool): false to layout up stream.
            start_nodes (list[OdenGraphQt.BaseNode]):
    ...
    def expand_group_node(self, node):
        ...
        Args:
            node (OdenGraphQt.GroupNode): group node.
...
class SubGraph(NodeGraph):
    ...
    :class:`OdenGraphQt.GroupNode`.

    .. inheritance-diagram:: OdenGraphQt.SubGraph
        :top-classes: PySide6.QtCore.QObject
    ...
    def _clone_context_menu_from_parent(self):
        ...
        def clone_menu(menu, menu_to_clone):
            """
            Args:
                menu (OdenGraphQt.NodeGraphMenu):
                menu_to_clone (OdenGraphQt.NodeGraphMenu):
            """
            sub_items = []
    ...
    def initialized_graphs(self):
        ...
        Returns:
            list[OdenGraphQt.SubGraph]: list of sub graph objects.
        """
        if self._parent_graph.is_root:
    ...
    def parent_graph(self):
        ...
        Returns:
            OdenGraphQt.NodeGraph or OdenGraphQt.SubGraph: parent graph.
        """
    ...
    def node(self):
        ...
        Returns:
            OdenGraphQt.GroupNode: group node.
        """
        return self._node
    ...
    def get_input_port_nodes(self):
        ...
        Returns:
            list[OdenGraphQt.PortInputNode]: input nodes.
        """
    ...
    def get_output_port_nodes(self):
        ...
        Returns:
            list[OdenGraphQt.PortOutputNode]: output nodes.
        """
    ...
    def get_node_by_port(self, port):
        ...
        Args:
            port (OdenGraphQt.Port): parent node port object.
