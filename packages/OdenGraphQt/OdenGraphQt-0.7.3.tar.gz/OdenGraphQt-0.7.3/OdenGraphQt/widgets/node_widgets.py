...
from OdenGraphQt.custom_widgets import CustomCheckBox
from OdenGraphQt.constants import ViewerEnum, Z_VAL_NODE_WIDGET
from OdenGraphQt.errors import NodeWidgetError
...
class NodeBaseWidget(QtWidgets.QGraphicsProxyWidget):
    ...
    .. inheritance-diagram:: OdenGraphQt.NodeBaseWidget
        :parts: 1

    Args:
        parent (OdenGraphQt.BaseNode.view): parent node view.
    ...
    def node(self):
        ...
        Returns:
            OdenGraphQt.BaseNode: parent node.
        """
        return self._node
...
class NodeComboBox(NodeBaseWidget):
    ...
    .. inheritance-diagram:: OdenGraphQt.widgets.node_widgets.NodeComboBox
        :parts: 1

    .. note::
        `To embed a` ``QComboBox`` `in a node see func:`
        :meth:`OdenGraphQt.BaseNode.add_combo_menu`
    """
...
class NodeLineEdit(NodeBaseWidget):
    ...
    .. inheritance-diagram:: OdenGraphQt.widgets.node_widgets.NodeLineEdit
        :parts: 1
...
class NodeCheckBox(NodeBaseWidget):
    ...
    .. inheritance-diagram:: OdenGraphQt.widgets.node_widgets.NodeCheckBox
        :parts: 1

    .. note::
        `To embed a` ``QCheckBox`` `in a node see func:`
        :meth:`OdenGraphQt.BaseNode.add_checkbox`
    """
