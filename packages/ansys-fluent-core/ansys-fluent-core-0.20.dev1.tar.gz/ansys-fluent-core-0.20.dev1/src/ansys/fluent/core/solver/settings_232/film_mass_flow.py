...
class film_mass_flow(Command):
    ...
    """
    domain_val argument of film_mass_flow.
    """
    all_bndry_zones: all_bndry_zones_cls = all_bndry_zones_cls
    """
    all_bndry_zones argument of film_mass_flow.
    """
    zone_list: zone_list_cls = zone_list_cls
    """
    zone_list argument of film_mass_flow.
    """
    ...
    """
    overwrite argument of film_mass_flow.
    """
