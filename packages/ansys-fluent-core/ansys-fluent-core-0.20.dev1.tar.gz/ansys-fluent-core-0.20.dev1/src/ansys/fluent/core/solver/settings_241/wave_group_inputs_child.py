...
class wave_group_inputs_child(Group):
    ...
    """
    theory child of wave_group_inputs_child.
    """
    wave_ht: wave_ht_cls = wave_ht_cls
    """
    wave_ht child of wave_group_inputs_child.
    """
    wave_len: wave_len_cls = wave_len_cls
    """
    wave_len child of wave_group_inputs_child.
    """
    phase_diff: phase_diff_cls = phase_diff_cls
    """
    phase_diff child of wave_group_inputs_child.
    """
    heading_angle: heading_angle_cls = heading_angle_cls
    """
    heading_angle child of wave_group_inputs_child.
    """
