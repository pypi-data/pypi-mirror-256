...
class xy_plot_child(Group):
    ...
    """
    write_to_file command of xy_plot_child.
    """
    read_from_file: read_from_file_cls = read_from_file_cls
    """
    read_from_file command of xy_plot_child.
    """
    free_file_data: free_file_data_cls = free_file_data_cls
    """
    free_file_data command of xy_plot_child.
    """
