...
class write_histogram(Command):
    ...
    """
    domain argument of write_histogram.
    """
    cell_function: cell_function_cls = cell_function_cls
    """
    cell_function argument of write_histogram.
    """
    min_val: min_val_cls = min_val_cls
    """
    min_val argument of write_histogram.
    """
    max_val: max_val_cls = max_val_cls
    """
    max_val argument of write_histogram.
    """
    num_division: num_division_cls = num_division_cls
    """
    num_division argument of write_histogram.
    """
    set_all_zones: set_all_zones_cls = set_all_zones_cls
    """
    set_all_zones argument of write_histogram.
    """
    threads_list: threads_list_cls = threads_list_cls
    """
    threads_list argument of write_histogram.
    """
    file_name: file_name_cls = file_name_cls
    """
    file_name argument of write_histogram.
    """
    overwrite: overwrite_cls = overwrite_cls
    """
    overwrite argument of write_histogram.
    """
