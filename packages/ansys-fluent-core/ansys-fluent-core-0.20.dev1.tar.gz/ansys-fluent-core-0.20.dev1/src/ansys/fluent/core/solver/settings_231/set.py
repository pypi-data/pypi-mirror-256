...
class set(Group):
    ...
    anisotropic_boundary_zones: anisotropic_boundary_zones_cls = anisotropic_boundary_zones_cls
    """
    ...
    """
    anisotropic_split_ratio: anisotropic_split_ratio_cls = anisotropic_split_ratio_cls
    """
