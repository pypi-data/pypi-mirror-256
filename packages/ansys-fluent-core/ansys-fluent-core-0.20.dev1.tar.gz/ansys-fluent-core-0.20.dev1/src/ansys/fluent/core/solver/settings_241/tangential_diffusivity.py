...
class tangential_diffusivity(Group):
    ...
    """
    option child of tangential_diffusivity.
    """
    value: value_cls = value_cls
    """
    value child of tangential_diffusivity.
    """
    expression: expression_cls = expression_cls
    """
    expression child of tangential_diffusivity.
    """
    piecewise_linear: piecewise_linear_cls = piecewise_linear_cls
    """
    piecewise_linear child of tangential_diffusivity.
    """
    piecewise_polynomial: piecewise_polynomial_cls = piecewise_polynomial_cls
    """
    piecewise_polynomial child of tangential_diffusivity.
    """
    polynomial: polynomial_cls = polynomial_cls
    """
    polynomial child of tangential_diffusivity.
    """
    user_defined_function: user_defined_function_cls = user_defined_function_cls
    """
    user_defined_function child of tangential_diffusivity.
    """
