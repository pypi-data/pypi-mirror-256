...
class boundary_conditions(Group, _ChildNamedObjectAccessorMixin):
    ...
    """
    non_reflecting_bc: non_reflecting_bc_cls = non_reflecting_bc_cls
    """
    non_reflecting_bc child of boundary_conditions.
    """
    perforated_wall: perforated_wall_cls = perforated_wall_cls
    """
    perforated_wall child of boundary_conditions.
    """
    settings: settings_cls = settings_cls
    """
    settings child of boundary_conditions.
    """
    command_names = \
    ...
    """
    copy command of boundary_conditions.
    """
    set_zone_type: set_zone_type_cls = set_zone_type_cls
    """
    set_zone_type command of boundary_conditions.
    """
    ...
    """
    non_overlapping_zone_name command of boundary_conditions.
    """
    ...
    """
    knudsen_number_calculator: knudsen_number_calculator_cls = knudsen_number_calculator_cls
    """
    knudsen_number_calculator command of boundary_conditions.
    """
    set_zone_name: set_zone_name_cls = set_zone_name_cls
    """
    set_zone_name command of boundary_conditions.
    """
    add_suffix_or_prefix: add_suffix_or_prefix_cls = add_suffix_or_prefix_cls
    """
    add_suffix_or_prefix command of boundary_conditions.
    """
    rename_by_adjacency: rename_by_adjacency_cls = rename_by_adjacency_cls
    """
    rename_by_adjacency command of boundary_conditions.
    """
    rename_to_default: rename_to_default_cls = rename_to_default_cls
    """
    rename_to_default command of boundary_conditions.
    """
