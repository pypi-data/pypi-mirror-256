...
class phase_child(Group):
    ...
    """
    alpha child of phase_child.
    """
    dm: dm_cls = dm_cls
    """
    dm child of phase_child.
    """
    c2: c2_cls = c2_cls
    """
    c2 child of phase_child.
    """
    thermal_ctk: thermal_ctk_cls = thermal_ctk_cls
    """
    thermal_ctk child of phase_child.
    """
    ...
    """
    v_absp child of phase_child.
    """
    ir_absp: ir_absp_cls = ir_absp_cls
    """
    ir_absp child of phase_child.
    """
    ir_trans: ir_trans_cls = ir_trans_cls
    """
    ir_trans child of phase_child.
    """
    v_trans: v_trans_cls = v_trans_cls
    """
    v_trans child of phase_child.
    """
    ...
    """
    jump_adhesion child of phase_child.
    """
    adhesion_constrained: adhesion_constrained_cls = adhesion_constrained_cls
    """
    adhesion_constrained child of phase_child.
    """
