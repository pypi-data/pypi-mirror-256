...
class pressure_inlet_child(Group):
    ...
    """
    geom_disable child of pressure_inlet_child.
    """
    geom_dir_spec: geom_dir_spec_cls = geom_dir_spec_cls
    """
    geom_dir_spec child of pressure_inlet_child.
    """
    geom_dir_x: geom_dir_x_cls = geom_dir_x_cls
    """
    geom_dir_x child of pressure_inlet_child.
    """
    geom_dir_y: geom_dir_y_cls = geom_dir_y_cls
    """
    geom_dir_y child of pressure_inlet_child.
    """
    geom_dir_z: geom_dir_z_cls = geom_dir_z_cls
    """
    geom_dir_z child of pressure_inlet_child.
    """
    geom_levels: geom_levels_cls = geom_levels_cls
    """
    geom_levels child of pressure_inlet_child.
    """
    geom_bgthread: geom_bgthread_cls = geom_bgthread_cls
    """
    geom_bgthread child of pressure_inlet_child.
    """
    open_channel: open_channel_cls = open_channel_cls
    """
    open_channel child of pressure_inlet_child.
    """
    inlet_number: inlet_number_cls = inlet_number_cls
    """
    inlet_number child of pressure_inlet_child.
    """
    phase_spec: phase_spec_cls = phase_spec_cls
    """
    phase_spec child of pressure_inlet_child.
    """
    frame_of_reference: frame_of_reference_cls = frame_of_reference_cls
    """
    frame_of_reference child of pressure_inlet_child.
    """
    gauge_total_pressure: gauge_total_pressure_cls = gauge_total_pressure_cls
    """
    gauge_total_pressure child of pressure_inlet_child.
    """
    gauge_pressure: gauge_pressure_cls = gauge_pressure_cls
    """
    gauge_pressure child of pressure_inlet_child.
    """
    t0: t0_cls = t0_cls
    """
    t0 child of pressure_inlet_child.
    """
    direction_spec: direction_spec_cls = direction_spec_cls
    """
    direction_spec child of pressure_inlet_child.
    """
    flow_spec: flow_spec_cls = flow_spec_cls
    """
    flow_spec child of pressure_inlet_child.
    """
    ht_local: ht_local_cls = ht_local_cls
    """
    ht_local child of pressure_inlet_child.
    """
    ht_total: ht_total_cls = ht_total_cls
    """
    ht_total child of pressure_inlet_child.
    """
    vmag: vmag_cls = vmag_cls
    """
    vmag child of pressure_inlet_child.
    """
    ht_bottom: ht_bottom_cls = ht_bottom_cls
    """
    ht_bottom child of pressure_inlet_child.
    """
    den_spec: den_spec_cls = den_spec_cls
    """
    den_spec child of pressure_inlet_child.
    """
    coordinate_system: coordinate_system_cls = coordinate_system_cls
    """
    coordinate_system child of pressure_inlet_child.
    """
    flow_direction: flow_direction_cls = flow_direction_cls
    """
    flow_direction child of pressure_inlet_child.
    """
    direction_vector: direction_vector_cls = direction_vector_cls
    """
    direction_vector child of pressure_inlet_child.
    """
    axis_direction: axis_direction_cls = axis_direction_cls
    """
    axis_direction child of pressure_inlet_child.
    """
    axis_origin: axis_origin_cls = axis_origin_cls
    """
    axis_origin child of pressure_inlet_child.
    """
    les_spec_name: les_spec_name_cls = les_spec_name_cls
    """
    les_spec_name child of pressure_inlet_child.
    """
    rfg_number_of_modes: rfg_number_of_modes_cls = rfg_number_of_modes_cls
    """
    rfg_number_of_modes child of pressure_inlet_child.
    """
    vm_number_of_vortices: vm_number_of_vortices_cls = vm_number_of_vortices_cls
    """
    vm_number_of_vortices child of pressure_inlet_child.
    """
    vm_streamwise_fluct: vm_streamwise_fluct_cls = vm_streamwise_fluct_cls
    """
    vm_streamwise_fluct child of pressure_inlet_child.
    """
    vm_mass_conservation: vm_mass_conservation_cls = vm_mass_conservation_cls
    """
    vm_mass_conservation child of pressure_inlet_child.
    """
    stg_scale_limiter_type: stg_scale_limiter_type_cls = stg_scale_limiter_type_cls
    """
    stg_scale_limiter_type child of pressure_inlet_child.
    """
    stg_ti_limiter: stg_ti_limiter_cls = stg_ti_limiter_cls
    """
    stg_ti_limiter child of pressure_inlet_child.
    """
    stg_tvr_limiter: stg_tvr_limiter_cls = stg_tvr_limiter_cls
    """
    stg_tvr_limiter child of pressure_inlet_child.
    """
    stg_dw_limiter: stg_dw_limiter_cls = stg_dw_limiter_cls
    """
    stg_dw_limiter child of pressure_inlet_child.
    """
    volumetric_synthetic_turbulence_generator: volumetric_synthetic_turbulence_generator_cls = volumetric_synthetic_turbulence_generator_cls
    """
    volumetric_synthetic_turbulence_generator child of pressure_inlet_child.
    """
    volumetric_synthetic_turbulence_generator_option: volumetric_synthetic_turbulence_generator_option_cls = volumetric_synthetic_turbulence_generator_option_cls
    """
    volumetric_synthetic_turbulence_generator_option child of pressure_inlet_child.
    """
    volumetric_synthetic_turbulence_generator_option_thickness: volumetric_synthetic_turbulence_generator_option_thickness_cls = volumetric_synthetic_turbulence_generator_option_thickness_cls
    """
    volumetric_synthetic_turbulence_generator_option_thickness child of pressure_inlet_child.
    """
    prevent_reverse_flow: prevent_reverse_flow_cls = prevent_reverse_flow_cls
    """
    prevent_reverse_flow child of pressure_inlet_child.
    """
    ke_spec: ke_spec_cls = ke_spec_cls
    """
    ke_spec child of pressure_inlet_child.
    """
    nut: nut_cls = nut_cls
    """
    nut child of pressure_inlet_child.
    """
    kl: kl_cls = kl_cls
    """
    kl child of pressure_inlet_child.
    """
    intermit: intermit_cls = intermit_cls
    """
    intermit child of pressure_inlet_child.
    """
    k: k_cls = k_cls
    """
    k child of pressure_inlet_child.
    """
    e: e_cls = e_cls
    """
    e child of pressure_inlet_child.
    """
    o: o_cls = o_cls
    """
    o child of pressure_inlet_child.
    """
    v2: v2_cls = v2_cls
    """
    v2 child of pressure_inlet_child.
    """
    turb_intensity: turb_intensity_cls = turb_intensity_cls
    """
    turb_intensity child of pressure_inlet_child.
    """
    turb_length_scale: turb_length_scale_cls = turb_length_scale_cls
    """
    turb_length_scale child of pressure_inlet_child.
    """
    turb_hydraulic_diam: turb_hydraulic_diam_cls = turb_hydraulic_diam_cls
    """
    turb_hydraulic_diam child of pressure_inlet_child.
    """
    turb_viscosity_ratio: turb_viscosity_ratio_cls = turb_viscosity_ratio_cls
    """
    turb_viscosity_ratio child of pressure_inlet_child.
    """
    turb_viscosity_ratio_profile: turb_viscosity_ratio_profile_cls = turb_viscosity_ratio_profile_cls
    """
    turb_viscosity_ratio_profile child of pressure_inlet_child.
    """
    rst_spec: rst_spec_cls = rst_spec_cls
    """
    rst_spec child of pressure_inlet_child.
    """
    uu: uu_cls = uu_cls
    """
    uu child of pressure_inlet_child.
    """
    vv: vv_cls = vv_cls
    """
    vv child of pressure_inlet_child.
    """
    ww: ww_cls = ww_cls
    """
    ww child of pressure_inlet_child.
    """
    uv: uv_cls = uv_cls
    """
    uv child of pressure_inlet_child.
    """
    vw: vw_cls = vw_cls
    """
    vw child of pressure_inlet_child.
    """
    uw: uw_cls = uw_cls
    """
    uw child of pressure_inlet_child.
    """
    ksgs_spec: ksgs_spec_cls = ksgs_spec_cls
    """
    ksgs_spec child of pressure_inlet_child.
    """
    ksgs: ksgs_cls = ksgs_cls
    """
    ksgs child of pressure_inlet_child.
    """
    sgs_turb_intensity: sgs_turb_intensity_cls = sgs_turb_intensity_cls
    """
    sgs_turb_intensity child of pressure_inlet_child.
    """
    granular_temperature: granular_temperature_cls = granular_temperature_cls
    """
    granular_temperature child of pressure_inlet_child.
    """
    iac: iac_cls = iac_cls
    """
    iac child of pressure_inlet_child.
    """
    lsfun: lsfun_cls = lsfun_cls
    """
    lsfun child of pressure_inlet_child.
    """
    volume_fraction: volume_fraction_cls = volume_fraction_cls
    """
    volume_fraction child of pressure_inlet_child.
    """
    species_in_mole_fractions: species_in_mole_fractions_cls = species_in_mole_fractions_cls
    """
    species_in_mole_fractions child of pressure_inlet_child.
    """
    mf: mf_cls = mf_cls
    """
    mf child of pressure_inlet_child.
    """
    elec_potential_type: elec_potential_type_cls = elec_potential_type_cls
    """
    elec_potential_type child of pressure_inlet_child.
    """
    potential_value: potential_value_cls = potential_value_cls
    """
    potential_value child of pressure_inlet_child.
    """
    dual_potential_type: dual_potential_type_cls = dual_potential_type_cls
    """
    dual_potential_type child of pressure_inlet_child.
    """
    dual_potential_value: dual_potential_value_cls = dual_potential_value_cls
    """
    dual_potential_value child of pressure_inlet_child.
    """
    x_displacement_type: x_displacement_type_cls = x_displacement_type_cls
    """
    x_displacement_type child of pressure_inlet_child.
    """
    x_displacement_value: x_displacement_value_cls = x_displacement_value_cls
    """
    x_displacement_value child of pressure_inlet_child.
    """
    y_displacement_type: y_displacement_type_cls = y_displacement_type_cls
    """
    y_displacement_type child of pressure_inlet_child.
    """
    y_displacement_value: y_displacement_value_cls = y_displacement_value_cls
    """
    y_displacement_value child of pressure_inlet_child.
    """
    z_displacement_type: z_displacement_type_cls = z_displacement_type_cls
    """
    z_displacement_type child of pressure_inlet_child.
    """
    z_displacement_value: z_displacement_value_cls = z_displacement_value_cls
    """
    z_displacement_value child of pressure_inlet_child.
    """
    prob_mode_1: prob_mode_1_cls = prob_mode_1_cls
    """
    prob_mode_1 child of pressure_inlet_child.
    """
    prob_mode_2: prob_mode_2_cls = prob_mode_2_cls
    """
    prob_mode_2 child of pressure_inlet_child.
    """
    prob_mode_3: prob_mode_3_cls = prob_mode_3_cls
    """
    prob_mode_3 child of pressure_inlet_child.
    """
    equ_required: equ_required_cls = equ_required_cls
    """
    equ_required child of pressure_inlet_child.
    """
    uds_bc: uds_bc_cls = uds_bc_cls
    """
    uds_bc child of pressure_inlet_child.
    """
    uds: uds_cls = uds_cls
    """
    uds child of pressure_inlet_child.
    """
    pb_disc_bc: pb_disc_bc_cls = pb_disc_bc_cls
    """
    pb_disc_bc child of pressure_inlet_child.
    """
    pb_disc: pb_disc_cls = pb_disc_cls
    """
    pb_disc child of pressure_inlet_child.
    """
    pb_qmom_bc: pb_qmom_bc_cls = pb_qmom_bc_cls
    """
    pb_qmom_bc child of pressure_inlet_child.
    """
    pb_qmom: pb_qmom_cls = pb_qmom_cls
    """
    pb_qmom child of pressure_inlet_child.
    """
    pb_qbmm_bc: pb_qbmm_bc_cls = pb_qbmm_bc_cls
    """
    pb_qbmm_bc child of pressure_inlet_child.
    """
    pb_qbmm: pb_qbmm_cls = pb_qbmm_cls
    """
    pb_qbmm child of pressure_inlet_child.
    """
    pb_smm_bc: pb_smm_bc_cls = pb_smm_bc_cls
    """
    pb_smm_bc child of pressure_inlet_child.
    """
    pb_smm: pb_smm_cls = pb_smm_cls
    """
    pb_smm child of pressure_inlet_child.
    """
    pb_dqmom_bc: pb_dqmom_bc_cls = pb_dqmom_bc_cls
    """
    pb_dqmom_bc child of pressure_inlet_child.
    """
    pb_dqmom: pb_dqmom_cls = pb_dqmom_cls
    """
    pb_dqmom child of pressure_inlet_child.
    """
    radiation_bc: radiation_bc_cls = radiation_bc_cls
    """
    radiation_bc child of pressure_inlet_child.
    """
    radial_direction: radial_direction_cls = radial_direction_cls
    """
    radial_direction child of pressure_inlet_child.
    """
    coll_dtheta: coll_dtheta_cls = coll_dtheta_cls
    """
    coll_dtheta child of pressure_inlet_child.
    """
    coll_dphi: coll_dphi_cls = coll_dphi_cls
    """
    coll_dphi child of pressure_inlet_child.
    """
    band_q_irrad: band_q_irrad_cls = band_q_irrad_cls
    """
    band_q_irrad child of pressure_inlet_child.
    """
    band_q_irrad_diffuse: band_q_irrad_diffuse_cls = band_q_irrad_diffuse_cls
    """
    band_q_irrad_diffuse child of pressure_inlet_child.
    """
    parallel_collimated_beam: parallel_collimated_beam_cls = parallel_collimated_beam_cls
    """
    parallel_collimated_beam child of pressure_inlet_child.
    """
    solar_direction: solar_direction_cls = solar_direction_cls
    """
    solar_direction child of pressure_inlet_child.
    """
    solar_irradiation: solar_irradiation_cls = solar_irradiation_cls
    """
    solar_irradiation child of pressure_inlet_child.
    """
    t_b_b_spec: t_b_b_spec_cls = t_b_b_spec_cls
    """
    t_b_b_spec child of pressure_inlet_child.
    """
    t_b_b: t_b_b_cls = t_b_b_cls
    """
    t_b_b child of pressure_inlet_child.
    """
    in_emiss: in_emiss_cls = in_emiss_cls
    """
    in_emiss child of pressure_inlet_child.
    """
    fmean: fmean_cls = fmean_cls
    """
    fmean child of pressure_inlet_child.
    """
    fvar: fvar_cls = fvar_cls
    """
    fvar child of pressure_inlet_child.
    """
    fmean2: fmean2_cls = fmean2_cls
    """
    fmean2 child of pressure_inlet_child.
    """
    fvar2: fvar2_cls = fvar2_cls
    """
    fvar2 child of pressure_inlet_child.
    """
    premixc: premixc_cls = premixc_cls
    """
    premixc child of pressure_inlet_child.
    """
    premixc_var: premixc_var_cls = premixc_var_cls
    """
    premixc_var child of pressure_inlet_child.
    """
    ecfm_sigma: ecfm_sigma_cls = ecfm_sigma_cls
    """
    ecfm_sigma child of pressure_inlet_child.
    """
    inert: inert_cls = inert_cls
    """
    inert child of pressure_inlet_child.
    """
    pollut_no: pollut_no_cls = pollut_no_cls
    """
    pollut_no child of pressure_inlet_child.
    """
    pollut_hcn: pollut_hcn_cls = pollut_hcn_cls
    """
    pollut_hcn child of pressure_inlet_child.
    """
    pollut_nh3: pollut_nh3_cls = pollut_nh3_cls
    """
    pollut_nh3 child of pressure_inlet_child.
    """
    pollut_n2o: pollut_n2o_cls = pollut_n2o_cls
    """
    pollut_n2o child of pressure_inlet_child.
    """
    pollut_urea: pollut_urea_cls = pollut_urea_cls
    """
    pollut_urea child of pressure_inlet_child.
    """
    pollut_hnco: pollut_hnco_cls = pollut_hnco_cls
    """
    pollut_hnco child of pressure_inlet_child.
    """
    pollut_nco: pollut_nco_cls = pollut_nco_cls
    """
    pollut_nco child of pressure_inlet_child.
    """
    pollut_so2: pollut_so2_cls = pollut_so2_cls
    """
    pollut_so2 child of pressure_inlet_child.
    """
    pollut_h2s: pollut_h2s_cls = pollut_h2s_cls
    """
    pollut_h2s child of pressure_inlet_child.
    """
    pollut_so3: pollut_so3_cls = pollut_so3_cls
    """
    pollut_so3 child of pressure_inlet_child.
    """
    pollut_sh: pollut_sh_cls = pollut_sh_cls
    """
    pollut_sh child of pressure_inlet_child.
    """
    pollut_so: pollut_so_cls = pollut_so_cls
    """
    pollut_so child of pressure_inlet_child.
    """
    pollut_soot: pollut_soot_cls = pollut_soot_cls
    """
    pollut_soot child of pressure_inlet_child.
    """
    pollut_nuclei: pollut_nuclei_cls = pollut_nuclei_cls
    """
    pollut_nuclei child of pressure_inlet_child.
    """
    pollut_ctar: pollut_ctar_cls = pollut_ctar_cls
    """
    pollut_ctar child of pressure_inlet_child.
    """
    pollut_hg: pollut_hg_cls = pollut_hg_cls
    """
    pollut_hg child of pressure_inlet_child.
    """
    pollut_hgcl2: pollut_hgcl2_cls = pollut_hgcl2_cls
    """
    pollut_hgcl2 child of pressure_inlet_child.
    """
    pollut_hcl: pollut_hcl_cls = pollut_hcl_cls
    """
    pollut_hcl child of pressure_inlet_child.
    """
    pollut_hgo: pollut_hgo_cls = pollut_hgo_cls
    """
    pollut_hgo child of pressure_inlet_child.
    """
    pollut_cl: pollut_cl_cls = pollut_cl_cls
    """
    pollut_cl child of pressure_inlet_child.
    """
    pollut_cl2: pollut_cl2_cls = pollut_cl2_cls
    """
    pollut_cl2 child of pressure_inlet_child.
    """
    pollut_hgcl: pollut_hgcl_cls = pollut_hgcl_cls
    """
    pollut_hgcl child of pressure_inlet_child.
    """
    pollut_hocl: pollut_hocl_cls = pollut_hocl_cls
    """
    pollut_hocl child of pressure_inlet_child.
    """
    tss_scalar: tss_scalar_cls = tss_scalar_cls
    """
    tss_scalar child of pressure_inlet_child.
    """
    dpm_bc_type: dpm_bc_type_cls = dpm_bc_type_cls
    """
    dpm_bc_type child of pressure_inlet_child.
    """
    dpm_bc_collision_partner: dpm_bc_collision_partner_cls = dpm_bc_collision_partner_cls
    """
    dpm_bc_collision_partner child of pressure_inlet_child.
    """
    reinj_inj: reinj_inj_cls = reinj_inj_cls
    """
    reinj_inj child of pressure_inlet_child.
    """
    dpm_bc_udf: dpm_bc_udf_cls = dpm_bc_udf_cls
    """
    dpm_bc_udf child of pressure_inlet_child.
    """
    fensapice_flow_bc_subtype: fensapice_flow_bc_subtype_cls = fensapice_flow_bc_subtype_cls
    """
    fensapice_flow_bc_subtype child of pressure_inlet_child.
    """
    fensapice_drop_bccustom: fensapice_drop_bccustom_cls = fensapice_drop_bccustom_cls
    """
    fensapice_drop_bccustom child of pressure_inlet_child.
    """
    fensapice_drop_lwc: fensapice_drop_lwc_cls = fensapice_drop_lwc_cls
    """
    fensapice_drop_lwc child of pressure_inlet_child.
    """
    fensapice_drop_dtemp: fensapice_drop_dtemp_cls = fensapice_drop_dtemp_cls
    """
    fensapice_drop_dtemp child of pressure_inlet_child.
    """
    fensapice_drop_ddiam: fensapice_drop_ddiam_cls = fensapice_drop_ddiam_cls
    """
    fensapice_drop_ddiam child of pressure_inlet_child.
    """
    fensapice_drop_dv: fensapice_drop_dv_cls = fensapice_drop_dv_cls
    """
    fensapice_drop_dv child of pressure_inlet_child.
    """
    fensapice_drop_dx: fensapice_drop_dx_cls = fensapice_drop_dx_cls
    """
    fensapice_drop_dx child of pressure_inlet_child.
    """
    fensapice_drop_dy: fensapice_drop_dy_cls = fensapice_drop_dy_cls
    """
    fensapice_drop_dy child of pressure_inlet_child.
    """
    fensapice_drop_dz: fensapice_drop_dz_cls = fensapice_drop_dz_cls
    """
    fensapice_drop_dz child of pressure_inlet_child.
    """
    fensapice_dpm_surface_injection: fensapice_dpm_surface_injection_cls = fensapice_dpm_surface_injection_cls
    """
    fensapice_dpm_surface_injection child of pressure_inlet_child.
    """
    fensapice_dpm_inj_nstream: fensapice_dpm_inj_nstream_cls = fensapice_dpm_inj_nstream_cls
    """
    fensapice_dpm_inj_nstream child of pressure_inlet_child.
    """
    fensapice_drop_icc: fensapice_drop_icc_cls = fensapice_drop_icc_cls
    """
    fensapice_drop_icc child of pressure_inlet_child.
    """
    fensapice_drop_ctemp: fensapice_drop_ctemp_cls = fensapice_drop_ctemp_cls
    """
    fensapice_drop_ctemp child of pressure_inlet_child.
    """
    fensapice_drop_cmelt: fensapice_drop_cmelt_cls = fensapice_drop_cmelt_cls
    """
    fensapice_drop_cmelt child of pressure_inlet_child.
    """
    fensapice_drop_cdiam: fensapice_drop_cdiam_cls = fensapice_drop_cdiam_cls
    """
    fensapice_drop_cdiam child of pressure_inlet_child.
    """
    fensapice_drop_cv: fensapice_drop_cv_cls = fensapice_drop_cv_cls
    """
    fensapice_drop_cv child of pressure_inlet_child.
    """
    fensapice_drop_cx: fensapice_drop_cx_cls = fensapice_drop_cx_cls
    """
    fensapice_drop_cx child of pressure_inlet_child.
    """
    fensapice_drop_cy: fensapice_drop_cy_cls = fensapice_drop_cy_cls
    """
    fensapice_drop_cy child of pressure_inlet_child.
    """
    fensapice_drop_cz: fensapice_drop_cz_cls = fensapice_drop_cz_cls
    """
    fensapice_drop_cz child of pressure_inlet_child.
    """
    fensapice_drop_vrh: fensapice_drop_vrh_cls = fensapice_drop_vrh_cls
    """
    fensapice_drop_vrh child of pressure_inlet_child.
    """
    fensapice_drop_vrh_1: fensapice_drop_vrh_1_cls = fensapice_drop_vrh_1_cls
    """
    fensapice_drop_vrh_1 child of pressure_inlet_child.
    """
    fensapice_drop_vc: fensapice_drop_vc_cls = fensapice_drop_vc_cls
    """
    fensapice_drop_vc child of pressure_inlet_child.
    """
    mixing_plane_thread: mixing_plane_thread_cls = mixing_plane_thread_cls
    """
    mixing_plane_thread child of pressure_inlet_child.
    """
    wsf: wsf_cls = wsf_cls
    """
    wsf child of pressure_inlet_child.
    """
    wsb: wsb_cls = wsb_cls
    """
    wsb child of pressure_inlet_child.
    """
    wsn: wsn_cls = wsn_cls
    """
    wsn child of pressure_inlet_child.
    """
    solar_fluxes: solar_fluxes_cls = solar_fluxes_cls
    """
    solar_fluxes child of pressure_inlet_child.
    """
    solar_shining_factor: solar_shining_factor_cls = solar_shining_factor_cls
    """
    solar_shining_factor child of pressure_inlet_child.
    """
    radiating_s2s_surface: radiating_s2s_surface_cls = radiating_s2s_surface_cls
    """
    radiating_s2s_surface child of pressure_inlet_child.
    """
    ac_options: ac_options_cls = ac_options_cls
    """
    ac_options child of pressure_inlet_child.
    """
    impedance_0: impedance_0_cls = impedance_0_cls
    """
    impedance_0 child of pressure_inlet_child.
    """
    impedance_1: impedance_1_cls = impedance_1_cls
    """
    impedance_1 child of pressure_inlet_child.
    """
    impedance_2: impedance_2_cls = impedance_2_cls
    """
    impedance_2 child of pressure_inlet_child.
    """
    ac_wave: ac_wave_cls = ac_wave_cls
    """
    ac_wave child of pressure_inlet_child.
    """
    les_spec: les_spec_cls = les_spec_cls
    """
    les_spec child of pressure_inlet_child.
    """
