...
class phase_child(Group):
    ...
    """
    active_wetsteam_zone child of phase_child.
    """
    ...
    """
    fan_curve_filename child of phase_child.
    """
