...
class global_dt_pseudo_relax(NamedObject[band_diffuse_frac_child], _NonCreatableNamedObjectMixin[band_diffuse_frac_child]):
    """
    ...
    """
    rename command of global_dt_pseudo_relax.
    """
