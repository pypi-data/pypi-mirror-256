...
class reference_frame_axis_direction(ListObject[reference_frame_velocity_child]):
    """
    Set reference frame axis direction components.
    """
    ...
    """
    list_properties command of reference_frame_axis_direction.
    """
    resize: resize_cls = resize_cls
    """
    resize command of reference_frame_axis_direction.
    """
