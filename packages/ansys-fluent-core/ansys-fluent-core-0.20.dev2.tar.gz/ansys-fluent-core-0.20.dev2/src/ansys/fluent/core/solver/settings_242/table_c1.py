...
class table_c1(Group):
    ...
    """
    write_table command of table_c1.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of table_c1.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of table_c1.
    """
