...
from .pemfc import pemfc as pemfc_cls
class models(Group):
    """
    'models' child.
    """
    ...
    """
    echemistry: echemistry_cls = echemistry_cls
    """
    echemistry child of models.
    """
    battery: battery_cls = battery_cls
    """
    battery child of models.
    """
    system_coupling: system_coupling_cls = system_coupling_cls
    """
    system_coupling child of models.
    """
    sofc: sofc_cls = sofc_cls
    """
    sofc child of models.
    """
    pemfc: pemfc_cls = pemfc_cls
    """
    pemfc child of models.
    """
