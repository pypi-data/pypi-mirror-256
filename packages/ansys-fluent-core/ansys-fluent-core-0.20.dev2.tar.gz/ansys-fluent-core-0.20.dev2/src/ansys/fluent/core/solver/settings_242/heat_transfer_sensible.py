...
class heat_transfer_sensible(Command):
    ...
    """
    domain argument of heat_transfer_sensible.
    """
    all_boundary_zones: all_boundary_zones_cls = all_boundary_zones_cls
    """
    all_boundary_zones argument of heat_transfer_sensible.
    """
    zones: zones_cls = zones_cls
    """
    zones argument of heat_transfer_sensible.
    """
    physics: physics_cls = physics_cls
    """
    physics argument of heat_transfer_sensible.
    """
