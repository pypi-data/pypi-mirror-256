...
class settings(Group):
    ...
    """
    command_names = \
        ['detect_boundary_advection']

    detect_boundary_advection: detect_boundary_advection_cls = detect_boundary_advection_cls
    """
    detect_boundary_advection command of settings.
    """
