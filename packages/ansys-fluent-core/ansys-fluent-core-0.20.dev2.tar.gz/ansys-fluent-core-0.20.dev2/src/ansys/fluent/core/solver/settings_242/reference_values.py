...
class reference_values(Group):
    ...
    """
    ratio_of_specific_heats: ratio_of_specific_heats_cls = ratio_of_specific_heats_cls
    """
    ratio_of_specific_heats child of reference_values.
    """
    ...
    """
    list_values: list_values_cls = list_values_cls
    """
    list_values command of reference_values.
    """
