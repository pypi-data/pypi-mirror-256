...
class uniformity_index_mass_weighted(Command):
    ...
    """
    surface_names argument of uniformity_index_mass_weighted.
    """
    geometry_names: geometry_names_cls = geometry_names_cls
    """
    geometry_names argument of uniformity_index_mass_weighted.
    """
    cust_vec_func: cust_vec_func_cls = cust_vec_func_cls
    """
    cust_vec_func argument of uniformity_index_mass_weighted.
    """
    report_of: report_of_cls = report_of_cls
    """
    report_of argument of uniformity_index_mass_weighted.
    """
    current_domain: current_domain_cls = current_domain_cls
    """
    current_domain argument of uniformity_index_mass_weighted.
    """
    write_to_file: write_to_file_cls = write_to_file_cls
    """
    write_to_file argument of uniformity_index_mass_weighted.
    """
    file_name: file_name_cls = file_name_cls
    """
    file_name argument of uniformity_index_mass_weighted.
    """
    append_data: append_data_cls = append_data_cls
    """
    append_data argument of uniformity_index_mass_weighted.
    """
