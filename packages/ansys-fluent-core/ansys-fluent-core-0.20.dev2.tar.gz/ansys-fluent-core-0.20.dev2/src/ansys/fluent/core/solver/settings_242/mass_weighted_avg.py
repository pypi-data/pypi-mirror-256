...
class mass_weighted_avg(Command):
    ...
    """
    surface_names argument of mass_weighted_avg.
    """
    geometry_names: geometry_names_cls = geometry_names_cls
    """
    geometry_names argument of mass_weighted_avg.
    """
    cust_vec_func: cust_vec_func_cls = cust_vec_func_cls
    """
    cust_vec_func argument of mass_weighted_avg.
    """
    report_of: report_of_cls = report_of_cls
    """
    report_of argument of mass_weighted_avg.
    """
    current_domain: current_domain_cls = current_domain_cls
    """
    current_domain argument of mass_weighted_avg.
    """
    write_to_file: write_to_file_cls = write_to_file_cls
    """
    write_to_file argument of mass_weighted_avg.
    """
    file_name: file_name_cls = file_name_cls
    """
    file_name argument of mass_weighted_avg.
    """
    append_data: append_data_cls = append_data_cls
    """
    append_data argument of mass_weighted_avg.
    """
