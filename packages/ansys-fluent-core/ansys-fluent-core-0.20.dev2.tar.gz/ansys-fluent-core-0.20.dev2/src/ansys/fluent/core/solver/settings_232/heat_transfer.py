...
class heat_transfer(Command):
    ...
    """
    domain_val argument of heat_transfer.
    """
    all_bndry_zones: all_bndry_zones_cls = all_bndry_zones_cls
    """
    all_bndry_zones argument of heat_transfer.
    """
    zone_list: zone_list_cls = zone_list_cls
    """
    zone_list argument of heat_transfer.
    """
    write_to_file: write_to_file_cls = write_to_file_cls
    """
    write_to_file argument of heat_transfer.
    """
    file_name: file_name_cls = file_name_cls
    """
    file_name argument of heat_transfer.
    """
    append_data: append_data_cls = append_data_cls
    """
    append_data argument of heat_transfer.
    """
    overwrite: overwrite_cls = overwrite_cls
    """
    overwrite argument of heat_transfer.
    """
