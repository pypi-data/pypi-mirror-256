...
class cht_model_settings(Group):
    ...
    child_names = \
        ['same_for_active_enabled', 'energy_source_same_active',
         'tab_elec_current', 'energy_source_active']

    same_for_active_enabled: same_for_active_enabled_cls = same_for_active_enabled_cls
    """
    same_for_active_enabled child of cht_model_settings.
    """
    energy_source_same_active: energy_source_same_active_cls = energy_source_same_active_cls
    """
    energy_source_same_active child of cht_model_settings.
    """
    tab_elec_current: tab_elec_current_cls = tab_elec_current_cls
    """
    tab_elec_current child of cht_model_settings.
    """
    energy_source_active: energy_source_active_cls = energy_source_active_cls
    """
    energy_source_active child of cht_model_settings.
    """
