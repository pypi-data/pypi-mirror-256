...
class parametric_studies(NamedObject[parametric_studies_child], _CreatableNamedObjectMixin[parametric_studies_child]):
    ...
    """
    delete command of parametric_studies.
    """
    rename: rename_cls = rename_cls
    """
    rename command of parametric_studies.
    """
    list: list_cls = list_cls
    """
    list command of parametric_studies.
    """
    list_properties: list_properties_cls = list_properties_cls
    """
    list_properties command of parametric_studies.
    """
    make_a_copy: make_a_copy_cls = make_a_copy_cls
    """
    make_a_copy command of parametric_studies.
    """
