...
class system_coupling(Group):
    ...
    """
    activate_flow_boundary_coupling_model: activate_flow_boundary_coupling_model_cls = activate_flow_boundary_coupling_model_cls
    """
    activate_flow_boundary_coupling_model child of system_coupling.
    """
    command_names = \
