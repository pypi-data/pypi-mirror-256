...
class pb_qmom(NamedObject[fixes_child], _NonCreatableNamedObjectMixin[fixes_child]):
    """
    'pb_qmom' child.
    """
    ...
    """
    delete command of pb_qmom.
    """
    rename: rename_cls = rename_cls
    """
    rename command of pb_qmom.
    """
    ...
    """
    make_a_copy command of pb_qmom.
    """
