...
class cathode_sigma(Group):
    ...
    """
    method child of cathode_sigma.
    """
    value: value_cls = value_cls
    """
    value child of cathode_sigma.
    """
    piecewise_linear: piecewise_linear_cls = piecewise_linear_cls
    """
    piecewise_linear child of cathode_sigma.
    """
    polynomial: polynomial_cls = polynomial_cls
    """
    polynomial child of cathode_sigma.
    """
    user_defined: user_defined_cls = user_defined_cls
    """
    user_defined child of cathode_sigma.
    """
