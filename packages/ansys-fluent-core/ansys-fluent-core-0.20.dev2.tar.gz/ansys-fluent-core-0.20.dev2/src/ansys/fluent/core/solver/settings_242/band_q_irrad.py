...
class band_q_irrad(NamedObject[fixes_child], _NonCreatableNamedObjectMixin[fixes_child]):
    """
    Direct Irradiation.
    """
    ...
    """
    delete command of band_q_irrad.
    """
    rename: rename_cls = rename_cls
    """
    rename command of band_q_irrad.
    """
    ...
    """
    make_a_copy command of band_q_irrad.
    """
