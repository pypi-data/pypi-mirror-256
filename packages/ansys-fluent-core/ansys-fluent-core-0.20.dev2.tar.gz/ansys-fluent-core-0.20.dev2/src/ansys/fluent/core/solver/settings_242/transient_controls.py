...
class transient_controls(Group):
    ...
    """
    duration_specification_method: duration_specification_method_cls = duration_specification_method_cls
    """
    ...
    """
    max_iter_per_time_step: max_iter_per_time_step_cls = max_iter_per_time_step_cls
    """
    max_iter_per_time_step child of transient_controls.
    """
    total_time_step_count: total_time_step_count_cls = total_time_step_count_cls
    """
    ...
    """
    extrapolate_variables: extrapolate_variables_cls = extrapolate_variables_cls
    """
    extrapolate_variables child of transient_controls.
    """
    ...
    """
    cfl_based_time_stepping_advanced_options: cfl_based_time_stepping_advanced_options_cls = cfl_based_time_stepping_advanced_options_cls
    """
    cfl_based_time_stepping_advanced_options child of transient_controls.
    """
    ...
    """
    multiphase_specific_time_constraints: multiphase_specific_time_constraints_cls = multiphase_specific_time_constraints_cls
    """
    multiphase_specific_time_constraints child of transient_controls.
    """
    solid_time_step_size: solid_time_step_size_cls = solid_time_step_size_cls
    """
    solid_time_step_size child of transient_controls.
    """
    time_step_size_for_acoustic_export: time_step_size_for_acoustic_export_cls = time_step_size_for_acoustic_export_cls
    """
    time_step_size_for_acoustic_export child of transient_controls.
    """
    extrapolate_eqn_vars: extrapolate_eqn_vars_cls = extrapolate_eqn_vars_cls
    """
