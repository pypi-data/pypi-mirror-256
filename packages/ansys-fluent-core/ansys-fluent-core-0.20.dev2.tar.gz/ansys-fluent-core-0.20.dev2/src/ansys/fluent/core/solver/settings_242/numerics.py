...
class numerics(Group):
    ...
    child_names = \
        ['averaging', 'source_terms', 'tracking', 'parcel_count_control']
    ...
    """
    parcel_count_control: parcel_count_control_cls = parcel_count_control_cls
    """
    parcel_count_control child of numerics.
    """
