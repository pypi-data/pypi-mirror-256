...
class electrolyte_sigma(Group):
    ...
    """
    method child of electrolyte_sigma.
    """
    value: value_cls = value_cls
    """
    value child of electrolyte_sigma.
    """
    piecewise_linear: piecewise_linear_cls = piecewise_linear_cls
    """
    piecewise_linear child of electrolyte_sigma.
    """
    polynomial: polynomial_cls = polynomial_cls
    """
    polynomial child of electrolyte_sigma.
    """
    user_defined: user_defined_cls = user_defined_cls
    """
    user_defined child of electrolyte_sigma.
    """
