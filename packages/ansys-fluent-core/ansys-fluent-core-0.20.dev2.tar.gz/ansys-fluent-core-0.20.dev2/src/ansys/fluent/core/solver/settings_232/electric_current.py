...
class electric_current(Command):
    ...
    """
    domain_val argument of electric_current.
    """
    all_bndry_zones: all_bndry_zones_cls = all_bndry_zones_cls
    """
    all_bndry_zones argument of electric_current.
    """
    zone_list: zone_list_cls = zone_list_cls
    """
    zone_list argument of electric_current.
    """
    ...
    """
    overwrite argument of electric_current.
    """
