...
class degassing_child(Group):
    ...
    """
    adjacent_cell_zone query of degassing_child.
    """
    shadow_face_zone: shadow_face_zone_cls = shadow_face_zone_cls
    """
    shadow_face_zone query of degassing_child.
    """
