...
class local_dt_dualts_relax(NamedObject[band_diffuse_frac_child], _NonCreatableNamedObjectMixin[band_diffuse_frac_child]):
    """
    ...
    """
    delete command of local_dt_dualts_relax.
    """
    rename: rename_cls = rename_cls
    """
    rename command of local_dt_dualts_relax.
    """
    ...
    """
    make_a_copy command of local_dt_dualts_relax.
    """
