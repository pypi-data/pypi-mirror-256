...
class electrolyte_activity(Group):
    ...
    """
    method child of electrolyte_activity.
    """
    value: value_cls = value_cls
    """
    value child of electrolyte_activity.
    """
    piecewise_linear: piecewise_linear_cls = piecewise_linear_cls
    """
    piecewise_linear child of electrolyte_activity.
    """
    polynomial: polynomial_cls = polynomial_cls
    """
    polynomial child of electrolyte_activity.
    """
    user_defined: user_defined_cls = user_defined_cls
    """
    user_defined child of electrolyte_activity.
    """
