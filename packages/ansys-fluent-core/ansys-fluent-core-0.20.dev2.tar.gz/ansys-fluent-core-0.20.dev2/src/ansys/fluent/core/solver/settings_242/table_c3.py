...
class table_c3(Group):
    ...
    """
    write_table command of table_c3.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of table_c3.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of table_c3.
    """
