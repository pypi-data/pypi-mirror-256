...
class internal_resistance_table(Group):
    """
    'internal_resistance_table' child.
    """
    ...
    """
    write_table command of internal_resistance_table.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of internal_resistance_table.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of internal_resistance_table.
    """
