...
class standard_deviation(Command):
    ...
    """
    surface_names argument of standard_deviation.
    """
    geometry_names: geometry_names_cls = geometry_names_cls
    """
    geometry_names argument of standard_deviation.
    """
    cust_vec_func: cust_vec_func_cls = cust_vec_func_cls
    """
    cust_vec_func argument of standard_deviation.
    """
    report_of: report_of_cls = report_of_cls
    """
    report_of argument of standard_deviation.
    """
    current_domain: current_domain_cls = current_domain_cls
    """
    current_domain argument of standard_deviation.
    """
    write_to_file: write_to_file_cls = write_to_file_cls
    """
    write_to_file argument of standard_deviation.
    """
    file_name: file_name_cls = file_name_cls
    """
    file_name argument of standard_deviation.
    """
    append_data: append_data_cls = append_data_cls
    """
    append_data argument of standard_deviation.
    """
