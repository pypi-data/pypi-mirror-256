...
class output_parameters(NamedObject[band_diffuse_frac_child], _NonCreatableNamedObjectMixin[band_diffuse_frac_child]):
    """
    ...
    """
    delete command of output_parameters.
    """
    rename: rename_cls = rename_cls
    """
    rename command of output_parameters.
    """
    ...
    """
    make_a_copy command of output_parameters.
    """
