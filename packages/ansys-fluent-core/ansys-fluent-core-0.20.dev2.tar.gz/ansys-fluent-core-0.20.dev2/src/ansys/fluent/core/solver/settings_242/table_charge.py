...
class table_charge(Group):
    ...
    """
    write_table command of table_charge.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of table_charge.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of table_charge.
    """
