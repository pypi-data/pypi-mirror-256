...
class tortuosity_interface(ListObject[contact_resis_child]):
    ...
    """
    list_properties command of tortuosity_interface.
    """
    resize: resize_cls = resize_cls
    """
    resize command of tortuosity_interface.
    """
    add_zone: add_zone_cls = add_zone_cls
    """
    add_zone command of tortuosity_interface.
    """
    list_zone: list_zone_cls = list_zone_cls
    """
    list_zone command of tortuosity_interface.
    """
    delete_zone: delete_zone_cls = delete_zone_cls
    """
    delete_zone command of tortuosity_interface.
    """
