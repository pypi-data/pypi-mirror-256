...
class report_definitions(Group, _ChildNamedObjectAccessorMixin):
    ...
    """
    time child of report_definitions.
    """
    ...
    """
    single_valued_expression: single_valued_expression_cls = single_valued_expression_cls
    """
    single_valued_expression child of report_definitions.
    """
