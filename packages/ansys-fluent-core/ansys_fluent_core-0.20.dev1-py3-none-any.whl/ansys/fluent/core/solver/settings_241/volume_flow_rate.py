...
class volume_flow_rate(Command):
    ...
    """
    surface_names argument of volume_flow_rate.
    """
    geometry_names: geometry_names_cls = geometry_names_cls
    """
    geometry_names argument of volume_flow_rate.
    """
    cust_vec_func: cust_vec_func_cls = cust_vec_func_cls
    """
    cust_vec_func argument of volume_flow_rate.
    """
    report_of: report_of_cls = report_of_cls
    """
    report_of argument of volume_flow_rate.
    """
    current_domain: current_domain_cls = current_domain_cls
    """
    current_domain argument of volume_flow_rate.
    """
    write_to_file: write_to_file_cls = write_to_file_cls
    """
    write_to_file argument of volume_flow_rate.
    """
    file_name: file_name_cls = file_name_cls
    """
    file_name argument of volume_flow_rate.
    """
    append_data: append_data_cls = append_data_cls
    """
    append_data argument of volume_flow_rate.
    """
