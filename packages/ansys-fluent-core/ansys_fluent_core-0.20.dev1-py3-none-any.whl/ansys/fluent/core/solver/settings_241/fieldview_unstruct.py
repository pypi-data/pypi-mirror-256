...
class fieldview_unstruct(Command):
    ...
    """
    file_name argument of fieldview_unstruct.
    """
    surfaces: surfaces_cls = surfaces_cls
    """
    surfaces argument of fieldview_unstruct.
    """
    cellzones: cellzones_cls = cellzones_cls
    """
    cellzones argument of fieldview_unstruct.
    """
    cell_func_domain: cell_func_domain_cls = cell_func_domain_cls
    """
    cell_func_domain argument of fieldview_unstruct.
    """
