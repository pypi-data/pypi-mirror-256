...
class generic_impact_angle_function(Group):
    ...
    """
    option child of generic_impact_angle_function.
    """
    function_of: function_of_cls = function_of_cls
    """
    function_of child of generic_impact_angle_function.
    """
    value: value_cls = value_cls
    """
    value child of generic_impact_angle_function.
    """
    piecewise_polynomial: piecewise_polynomial_cls = piecewise_polynomial_cls
    """
    piecewise_polynomial child of generic_impact_angle_function.
    """
    piecewise_linear: piecewise_linear_cls = piecewise_linear_cls
    """
    piecewise_linear child of generic_impact_angle_function.
    """
    polynomial: polynomial_cls = polynomial_cls
    """
    polynomial child of generic_impact_angle_function.
    """
