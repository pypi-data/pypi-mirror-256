...
class anode(Group):
    ...
    anode_cc_zone: anode_cc_zone_cls = anode_cc_zone_cls
    """
    anode_cc_zone child of anode.
    """
    anode_fc_zone: anode_fc_zone_cls = anode_fc_zone_cls
    """
    anode_fc_zone child of anode.
    """
    anode_pl_zone: anode_pl_zone_cls = anode_pl_zone_cls
    """
    anode_pl_zone child of anode.
    """
    anode_pl_cp_function: anode_pl_cp_function_cls = anode_pl_cp_function_cls
    """
    anode_pl_cp_function child of anode.
    """
    anode_pl_angle: anode_pl_angle_cls = anode_pl_angle_cls
    """
    anode_pl_angle child of anode.
    """
    anode_pl_a: anode_pl_a_cls = anode_pl_a_cls
    """
    anode_pl_a child of anode.
    """
    anode_pl_b: anode_pl_b_cls = anode_pl_b_cls
    """
    anode_pl_b child of anode.
    """
    anode_pl_c: anode_pl_c_cls = anode_pl_c_cls
    """
    anode_pl_c child of anode.
    """
    anode_cl_zone: anode_cl_zone_cls = anode_cl_zone_cls
    """
    anode_cl_zone child of anode.
    """
    anode_cl_svratio: anode_cl_svratio_cls = anode_cl_svratio_cls
    """
    anode_cl_svratio child of anode.
    """
    anode_cl_thickness: anode_cl_thickness_cls = anode_cl_thickness_cls
    """
    anode_cl_thickness child of anode.
    """
    anode_cl_cp_function: anode_cl_cp_function_cls = anode_cl_cp_function_cls
    """
    anode_cl_cp_function child of anode.
    """
    anode_cl_angle: anode_cl_angle_cls = anode_cl_angle_cls
    """
    anode_cl_angle child of anode.
    """
    anode_cl_a: anode_cl_a_cls = anode_cl_a_cls
    """
    anode_cl_a child of anode.
    """
    anode_cl_b: anode_cl_b_cls = anode_cl_b_cls
    """
    anode_cl_b child of anode.
    """
    anode_cl_c: anode_cl_c_cls = anode_cl_c_cls
    """
    anode_cl_c child of anode.
    """
