...
class transfer_coefficient(Group):
    ...
    """
    option child of transfer_coefficient.
    """
    function_of: function_of_cls = function_of_cls
    """
    function_of child of transfer_coefficient.
    """
    value: value_cls = value_cls
    """
    value child of transfer_coefficient.
    """
    piecewise_polynomial: piecewise_polynomial_cls = piecewise_polynomial_cls
    """
    piecewise_polynomial child of transfer_coefficient.
    """
    piecewise_linear: piecewise_linear_cls = piecewise_linear_cls
    """
    piecewise_linear child of transfer_coefficient.
    """
    polynomial: polynomial_cls = polynomial_cls
    """
    polynomial child of transfer_coefficient.
    """
