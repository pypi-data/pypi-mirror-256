...
class inlet_temperature(Command):
    ...
    """
    heat_exchanger argument of inlet_temperature.
    """
    fluid_zone: fluid_zone_cls = fluid_zone_cls
    """
    fluid_zone argument of inlet_temperature.
    """
    boundary_zone: boundary_zone_cls = boundary_zone_cls
    """
    boundary_zone argument of inlet_temperature.
    """
    report_type: report_type_cls = report_type_cls
    """
    report_type argument of inlet_temperature.
    """
    write_to_file: write_to_file_cls = write_to_file_cls
    """
    write_to_file argument of inlet_temperature.
    """
    file_name: file_name_cls = file_name_cls
    """
    file_name argument of inlet_temperature.
    """
    append_file: append_file_cls = append_file_cls
    """
    append_file argument of inlet_temperature.
    """
    overwrite: overwrite_cls = overwrite_cls
    """
    overwrite argument of inlet_temperature.
    """
