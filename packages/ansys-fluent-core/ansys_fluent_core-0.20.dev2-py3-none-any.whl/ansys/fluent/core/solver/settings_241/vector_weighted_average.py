...
class vector_weighted_average(Command):
    ...
    """
    surface_names argument of vector_weighted_average.
    """
    geometry_names: geometry_names_cls = geometry_names_cls
    """
    geometry_names argument of vector_weighted_average.
    """
    cust_vec_func: cust_vec_func_cls = cust_vec_func_cls
    """
    cust_vec_func argument of vector_weighted_average.
    """
    report_of: report_of_cls = report_of_cls
    """
    report_of argument of vector_weighted_average.
    """
    current_domain: current_domain_cls = current_domain_cls
    """
    current_domain argument of vector_weighted_average.
    """
    write_to_file: write_to_file_cls = write_to_file_cls
    """
    write_to_file argument of vector_weighted_average.
    """
    file_name: file_name_cls = file_name_cls
    """
    file_name argument of vector_weighted_average.
    """
    append_data: append_data_cls = append_data_cls
    """
    append_data argument of vector_weighted_average.
    """
