...
class windows(Group):
    ...
    """
    open_window: open_window_cls = open_window_cls
    """
    open_window command of windows.
    """
    set_window: set_window_cls = set_window_cls
    """
    set_window command of windows.
    """
    set_window_by_name: set_window_by_name_cls = set_window_by_name_cls
    """
    set_window_by_name command of windows.
    """
    close_window: close_window_cls = close_window_cls
    """
    close_window command of windows.
    """
    close_window_by_name: close_window_by_name_cls = close_window_by_name_cls
    """
    close_window_by_name command of windows.
    """
