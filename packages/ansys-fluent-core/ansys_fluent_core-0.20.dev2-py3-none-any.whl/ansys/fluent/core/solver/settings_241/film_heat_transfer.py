...
class film_heat_transfer(Command):
    ...
    """
    domain argument of film_heat_transfer.
    """
    all_boundary_zones: all_boundary_zones_cls = all_boundary_zones_cls
    """
    all_boundary_zones argument of film_heat_transfer.
    """
    zones: zones_cls = zones_cls
    """
    zones argument of film_heat_transfer.
    """
    physics: physics_cls = physics_cls
    """
    physics argument of film_heat_transfer.
    """
