...
class discrete_phase(Group):
    ...
    """
    evap_mass_details_in_dpm_summ_rep: evap_mass_details_in_dpm_summ_rep_cls = evap_mass_details_in_dpm_summ_rep_cls
    """
    evap_mass_details_in_dpm_summ_rep child of discrete_phase.
    """
    command_names = \
