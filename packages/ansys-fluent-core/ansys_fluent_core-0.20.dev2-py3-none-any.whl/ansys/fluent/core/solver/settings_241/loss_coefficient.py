...
class loss_coefficient(Group):
    ...
    """
    option child of loss_coefficient.
    """
    function_of: function_of_cls = function_of_cls
    """
    function_of child of loss_coefficient.
    """
    value: value_cls = value_cls
    """
    value child of loss_coefficient.
    """
    piecewise_polynomial: piecewise_polynomial_cls = piecewise_polynomial_cls
    """
    piecewise_polynomial child of loss_coefficient.
    """
    piecewise_linear: piecewise_linear_cls = piecewise_linear_cls
    """
    piecewise_linear child of loss_coefficient.
    """
    polynomial: polynomial_cls = polynomial_cls
    """
    polynomial child of loss_coefficient.
    """
