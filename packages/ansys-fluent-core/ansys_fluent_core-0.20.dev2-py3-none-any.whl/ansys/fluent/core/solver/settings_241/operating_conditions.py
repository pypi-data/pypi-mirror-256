...
class operating_conditions(Group):
    ...
    """
    inlet_temperature_for_operating_density: inlet_temperature_for_operating_density_cls = inlet_temperature_for_operating_density_cls
    """
    inlet_temperature_for_operating_density child of operating_conditions.
    """
    command_names = \
