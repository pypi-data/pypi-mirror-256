...
class radiator_child(Group):
    ...
    """
    loss_coefficient child of radiator_child.
    """
    hc: hc_cls = hc_cls
    """
    ...
    """
    discrete_phase_bc_function child of radiator_child.
    """
