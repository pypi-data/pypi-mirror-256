...
class pb_dqmom(NamedObject[fixes_child], _NonCreatableNamedObjectMixin[fixes_child]):
    """
    'pb_dqmom' child.
    """
    ...
    """
    delete command of pb_dqmom.
    """
    rename: rename_cls = rename_cls
    """
    rename command of pb_dqmom.
    """
    ...
    """
    make_a_copy command of pb_dqmom.
    """
