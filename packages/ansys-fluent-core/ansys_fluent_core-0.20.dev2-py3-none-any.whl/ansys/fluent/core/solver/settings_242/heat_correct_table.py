...
class heat_correct_table(Group):
    ...
    """
    row_number child of heat_correct_table.
    """
    column_number: column_number_cls = column_number_cls
    """
    column_number child of heat_correct_table.
    """
    row_value: row_value_cls = row_value_cls
    """
    row_value child of heat_correct_table.
    """
    column_value: column_value_cls = column_value_cls
    """
    column_value child of heat_correct_table.
    """
    table_value: table_value_cls = table_value_cls
    """
    table_value child of heat_correct_table.
    """
    command_names = \
    ...
    """
    write_table command of heat_correct_table.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of heat_correct_table.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of heat_correct_table.
    """
