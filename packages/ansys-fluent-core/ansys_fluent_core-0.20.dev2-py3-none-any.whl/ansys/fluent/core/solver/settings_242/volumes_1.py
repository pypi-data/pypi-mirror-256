...
class volumes(NamedObject[volumes_child], _CreatableNamedObjectMixin[volumes_child]):
    ...
    """
    delete command of volumes.
    """
    rename: rename_cls = rename_cls
    """
    rename command of volumes.
    """
