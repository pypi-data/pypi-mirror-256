...
class zone_assignment(Group):
    ...
    child_names = \
        ['active_zone', 'passive_zone', 'passive_zone_tab', 'positive_tab',
         'negative_tab']
    ...
    """
    passive_zone_tab: passive_zone_tab_cls = passive_zone_tab_cls
    """
    passive_zone_tab child of zone_assignment.
    """
