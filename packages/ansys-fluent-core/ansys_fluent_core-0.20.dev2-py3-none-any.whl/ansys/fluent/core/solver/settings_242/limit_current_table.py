...
class limit_current_table(Group):
    ...
    """
    write_table command of limit_current_table.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of limit_current_table.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of limit_current_table.
    """
