...
class pack_builder(Group):
    ...
    """
    translation_rotation_matrix: translation_rotation_matrix_cls = translation_rotation_matrix_cls
    """
    translation_rotation_matrix child of pack_builder.
    """
    command_names = \
    ...
    """
    read_location_file command of pack_builder.
    """
    write_location_file: write_location_file_cls = write_location_file_cls
    """
    write_location_file command of pack_builder.
    """
