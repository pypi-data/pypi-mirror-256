...
class band_q_irrad_diffuse(NamedObject[fixes_child], _NonCreatableNamedObjectMixin[fixes_child]):
    """
    Diffuse Irradiation.
    """
    ...
    """
    delete command of band_q_irrad_diffuse.
    """
    rename: rename_cls = rename_cls
    """
    rename command of band_q_irrad_diffuse.
    """
    ...
    """
    make_a_copy command of band_q_irrad_diffuse.
    """
