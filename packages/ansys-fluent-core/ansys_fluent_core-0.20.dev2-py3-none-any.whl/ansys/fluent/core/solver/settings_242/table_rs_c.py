...
class table_rs_c(Group):
    ...
    """
    write_table command of table_rs_c.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of table_rs_c.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of table_rs_c.
    """
