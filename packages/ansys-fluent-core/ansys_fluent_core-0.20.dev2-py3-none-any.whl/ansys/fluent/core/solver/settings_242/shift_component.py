...
class shift_component(ListObject[cone_axis_vector_child]):
    """
    'shift_component' child.
    """
    ...
    """
    list_properties command of shift_component.
    """
    resize: resize_cls = resize_cls
    """
    resize command of shift_component.
    """
