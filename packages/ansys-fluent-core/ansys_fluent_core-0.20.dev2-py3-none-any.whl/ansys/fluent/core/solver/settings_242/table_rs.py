...
class table_rs(Group):
    ...
    """
    write_table command of table_rs.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of table_rs.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of table_rs.
    """
