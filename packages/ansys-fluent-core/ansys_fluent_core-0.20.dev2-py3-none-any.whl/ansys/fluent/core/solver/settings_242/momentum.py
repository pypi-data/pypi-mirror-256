...
class momentum(Group):
    ...
    child_names = \
        ['system_coupling', 'frame_of_reference', 'gauge_pressure',
         'p_profile_multiplier', 'direction_spec', 'coordinate_system',
         'flow_direction', 'p_backflow_spec_gen', 'p_backflow_spec',
         'axis_direction', 'axis_origin', 'prevent_reverse_flow', 'radial',
         'avg_press_spec', 'press_averaging_method', 'targeted_mf_boundary',
         'targeted_mf', 'targeted_mf_pmax', 'targeted_mf_pmin',
         'gen_nrbc_spec', 'ac_options', 'impedance_0', 'impedance_1',
         'impedance_2', 'ac_wave', 'pressure_jump', 'strength',
         'new_fan_definition']

    system_coupling: system_coupling_cls = system_coupling_cls
    """
    system_coupling child of momentum.
    """
    frame_of_reference: frame_of_reference_cls = frame_of_reference_cls
    """
    frame_of_reference child of momentum.
    """
    ...
    """
    p_profile_multiplier child of momentum.
    """
    direction_spec: direction_spec_cls = direction_spec_cls
    """
    direction_spec child of momentum.
    """
    ...
    """
    p_backflow_spec_gen child of momentum.
    """
    p_backflow_spec: p_backflow_spec_cls = p_backflow_spec_cls
    """
    p_backflow_spec child of momentum.
    """
    ...
    """
    pressure_jump: pressure_jump_cls = pressure_jump_cls
    """
    pressure_jump child of momentum.
    """
    strength: strength_cls = strength_cls
    """
    strength child of momentum.
    """
    new_fan_definition: new_fan_definition_cls = new_fan_definition_cls
    """
    new_fan_definition child of momentum.
    """
