...
class species_child(NamedObject[child_object_type_child], _NonCreatableNamedObjectMixin[child_object_type_child]):
    ...
    """
    delete command of species_child.
    """
    rename: rename_cls = rename_cls
    """
    rename command of species_child.
    """
    list: list_cls = list_cls
    """
    list command of species_child.
    """
    list_properties: list_properties_cls = list_properties_cls
    """
    list_properties command of species_child.
    """
    make_a_copy: make_a_copy_cls = make_a_copy_cls
    """
    make_a_copy command of species_child.
    """
