...
class cycle_life_table(Group):
    ...
    """
    row_number child of cycle_life_table.
    """
    column_number: column_number_cls = column_number_cls
    """
    column_number child of cycle_life_table.
    """
    row_value: row_value_cls = row_value_cls
    """
    row_value child of cycle_life_table.
    """
    column_value: column_value_cls = column_value_cls
    """
    column_value child of cycle_life_table.
    """
    table_value: table_value_cls = table_value_cls
    """
    table_value child of cycle_life_table.
    """
    command_names = \
    ...
    """
    write_table command of cycle_life_table.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of cycle_life_table.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of cycle_life_table.
    """
