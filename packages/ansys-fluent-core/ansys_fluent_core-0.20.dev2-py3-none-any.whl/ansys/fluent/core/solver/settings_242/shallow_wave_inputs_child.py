...
class shallow_wave_inputs_child(Group):
    ...
    """
    theory child of shallow_wave_inputs_child.
    """
    wave_ht: wave_ht_cls = wave_ht_cls
    """
    wave_ht child of shallow_wave_inputs_child.
    """
    wave_len: wave_len_cls = wave_len_cls
    """
    wave_len child of shallow_wave_inputs_child.
    """
    offset: offset_cls = offset_cls
    """
    offset child of shallow_wave_inputs_child.
    """
    heading_angle: heading_angle_cls = heading_angle_cls
    """
    heading_angle child of shallow_wave_inputs_child.
    """
