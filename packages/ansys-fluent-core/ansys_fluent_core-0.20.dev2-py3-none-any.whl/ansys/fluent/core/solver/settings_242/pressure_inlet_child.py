...
class pressure_inlet_child(Group):
    ...
    """
    momentum child of pressure_inlet_child.
    """
    turbulence: turbulence_cls = turbulence_cls
    """
    turbulence child of pressure_inlet_child.
    """
    thermal: thermal_cls = thermal_cls
    """
    thermal child of pressure_inlet_child.
    """
    radiation: radiation_cls = radiation_cls
    """
    radiation child of pressure_inlet_child.
    """
    species: species_cls = species_cls
    """
    species child of pressure_inlet_child.
    """
    dpm: dpm_cls = dpm_cls
    """
    dpm child of pressure_inlet_child.
    """
    multiphase: multiphase_cls = multiphase_cls
    """
    multiphase child of pressure_inlet_child.
    """
    potential: potential_cls = potential_cls
    """
    potential child of pressure_inlet_child.
    """
    structure: structure_cls = structure_cls
    """
    structure child of pressure_inlet_child.
    """
    uds: uds_cls = uds_cls
    """
    ...
    """
    icing child of pressure_inlet_child.
    """
    geometry: geometry_cls = geometry_cls
    """
    geometry child of pressure_inlet_child.
    """
    query_names = \
    ...
    """
    adjacent_cell_zone query of pressure_inlet_child.
    """
    shadow_face_zone: shadow_face_zone_cls = shadow_face_zone_cls
    """
    shadow_face_zone query of pressure_inlet_child.
    """
