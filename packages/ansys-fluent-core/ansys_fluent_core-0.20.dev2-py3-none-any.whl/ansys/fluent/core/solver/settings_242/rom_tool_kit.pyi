...
class rom_tool_kit:
    ...
    def add_rom_parameter(self, parameter_type: int, entity_list: List[str], group_value: Union[float, str], individual_or_group: bool, individual_value: bool, value_list: List[Union[float, str]]):
        """
