...
class injections(NamedObject[injections_child], _CreatableNamedObjectMixin[injections_child]):
    ...
    """
    delete command of injections.
    """
    rename: rename_cls = rename_cls
    """
    rename command of injections.
    """
    list: list_cls = list_cls
    """
    list command of injections.
    """
    list_properties: list_properties_cls = list_properties_cls
    """
    list_properties command of injections.
    """
    make_a_copy: make_a_copy_cls = make_a_copy_cls
    """
    make_a_copy command of injections.
    """
