...
class tss_scalar(NamedObject[fixes_child], _NonCreatableNamedObjectMixin[fixes_child]):
    """
    'tss_scalar' child.
    """
    ...
    """
    delete command of tss_scalar.
    """
    rename: rename_cls = rename_cls
    """
    rename command of tss_scalar.
    """
    ...
    """
    make_a_copy command of tss_scalar.
    """
