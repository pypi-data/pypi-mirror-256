...
from .tessellation import tessellation as tessellation_cls
...
class vector_opt(Group):
    ...
    """
    tessellation: tessellation_cls = tessellation_cls
    """
    tessellation child of vector_opt.
    """
