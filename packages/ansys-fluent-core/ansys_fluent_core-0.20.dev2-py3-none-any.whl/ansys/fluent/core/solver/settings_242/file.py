...
class file(Group):
    ...
    """
    batch_options: batch_options_cls = batch_options_cls
    """
    batch_options child of file.
    """
    command_names = \
    ...
    """
    read_surface_mesh: read_surface_mesh_cls = read_surface_mesh_cls
    """
    read_surface_mesh command of file.
    """
    ...
    """
    write_case: write_case_cls = write_case_cls
    """
    write_case command of file.
    """
    write_data: write_data_cls = write_data_cls
    """
    write_data command of file.
    """
    write_case_data: write_case_data_cls = write_case_data_cls
    """
    write_case_data command of file.
    """
