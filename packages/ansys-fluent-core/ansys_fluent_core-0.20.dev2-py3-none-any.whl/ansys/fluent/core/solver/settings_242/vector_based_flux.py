...
class vector_based_flux(Command):
    ...
    """
    surface_names argument of vector_based_flux.
    """
    geometry_names: geometry_names_cls = geometry_names_cls
    """
    geometry_names argument of vector_based_flux.
    """
    cust_vec_func: cust_vec_func_cls = cust_vec_func_cls
    """
    cust_vec_func argument of vector_based_flux.
    """
    report_of: report_of_cls = report_of_cls
    """
    report_of argument of vector_based_flux.
    """
    current_domain: current_domain_cls = current_domain_cls
    """
    current_domain argument of vector_based_flux.
    """
    write_to_file: write_to_file_cls = write_to_file_cls
    """
    write_to_file argument of vector_based_flux.
    """
    file_name: file_name_cls = file_name_cls
    """
    file_name argument of vector_based_flux.
    """
    append_data: append_data_cls = append_data_cls
    """
    append_data argument of vector_based_flux.
    """
