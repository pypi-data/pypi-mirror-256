...
class number_of_bands(Group):
    ...
    on_all_interfaces: on_all_interfaces_cls = on_all_interfaces_cls
    """
    on_all_interfaces command of number_of_bands.
    """
    on_specified_interface: on_specified_interface_cls = on_specified_interface_cls
    """
    on_specified_interface command of number_of_bands.
    """
