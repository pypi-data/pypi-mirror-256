...
class pb_qmom_bc(NamedObject[turb_visc_func_mf_child], _NonCreatableNamedObjectMixin[turb_visc_func_mf_child]):
    ...
    """
    delete command of pb_qmom_bc.
    """
    rename: rename_cls = rename_cls
    """
    rename command of pb_qmom_bc.
    """
    list: list_cls = list_cls
    """
    list command of pb_qmom_bc.
    """
    list_properties: list_properties_cls = list_properties_cls
    """
    list_properties command of pb_qmom_bc.
    """
    make_a_copy: make_a_copy_cls = make_a_copy_cls
    """
    make_a_copy command of pb_qmom_bc.
    """
