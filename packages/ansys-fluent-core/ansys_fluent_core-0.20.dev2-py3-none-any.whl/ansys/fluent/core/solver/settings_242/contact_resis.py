...
class contact_resis(ListObject[contact_resis_child]):
    ...
    """
    list_properties command of contact_resis.
    """
    resize: resize_cls = resize_cls
    """
    resize command of contact_resis.
    """
    add_zone: add_zone_cls = add_zone_cls
    """
    add_zone command of contact_resis.
    """
    list_zone: list_zone_cls = list_zone_cls
    """
    list_zone command of contact_resis.
    """
    delete_zone: delete_zone_cls = delete_zone_cls
    """
    delete_zone command of contact_resis.
    """
