...
class network_end_child(Group):
    ...
    """
    name child of network_end_child.
    """
    ...
    """
    network_end child of network_end_child.
    """
    query_names = \
    ...
    """
    adjacent_cell_zone query of network_end_child.
    """
    shadow_face_zone: shadow_face_zone_cls = shadow_face_zone_cls
    """
    shadow_face_zone query of network_end_child.
    """
