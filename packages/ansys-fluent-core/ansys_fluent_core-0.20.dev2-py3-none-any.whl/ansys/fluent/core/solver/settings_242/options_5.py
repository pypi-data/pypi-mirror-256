...
class options(Group):
    ...
    joule_heat: joule_heat_cls = joule_heat_cls
    """
    joule_heat child of options.
    """
    reaction_heat: reaction_heat_cls = reaction_heat_cls
    """
    reaction_heat child of options.
    """
    electrochemistry: electrochemistry_cls = electrochemistry_cls
    """
    electrochemistry child of options.
    """
    butlervolmer: butlervolmer_cls = butlervolmer_cls
    """
    butlervolmer child of options.
    """
    multidiff: multidiff_cls = multidiff_cls
    """
    multidiff child of options.
    """
    anisotropic: anisotropic_cls = anisotropic_cls
    """
    anisotropic child of options.
    """
    pconductivity: pconductivity_cls = pconductivity_cls
    """
    pconductivity child of options.
    """
    halfcell: halfcell_cls = halfcell_cls
    """
    halfcell child of options.
    """
    particlemodel: particlemodel_cls = particlemodel_cls
    """
    particlemodel child of options.
    """
    liquid_phase: liquid_phase_cls = liquid_phase_cls
    """
    liquid_phase child of options.
    """
    liquid_pressure: liquid_pressure_cls = liquid_pressure_cls
    """
    liquid_pressure child of options.
    """
    liquid_in_channel: liquid_in_channel_cls = liquid_in_channel_cls
    """
    liquid_in_channel child of options.
    """
    dynamic_head: dynamic_head_cls = dynamic_head_cls
    """
    dynamic_head child of options.
    """
    knudsen_diffusion: knudsen_diffusion_cls = knudsen_diffusion_cls
    """
    knudsen_diffusion child of options.
    """
    temp_jref: temp_jref_cls = temp_jref_cls
    """
    temp_jref child of options.
    """
    n2_crossover: n2_crossover_cls = n2_crossover_cls
    """
    n2_crossover child of options.
    """
    ice_phase: ice_phase_cls = ice_phase_cls
    """
    ice_phase child of options.
    """
    dissovled_urf: dissovled_urf_cls = dissovled_urf_cls
    """
    dissovled_urf child of options.
    """
    osmotic_urf: osmotic_urf_cls = osmotic_urf_cls
    """
    osmotic_urf child of options.
    """
    phasechange_urf: phasechange_urf_cls = phasechange_urf_cls
    """
    phasechange_urf child of options.
    """
    liquidremoval_urf: liquidremoval_urf_cls = liquidremoval_urf_cls
    """
    liquidremoval_urf child of options.
    """
    auto_amg: auto_amg_cls = auto_amg_cls
    """
    auto_amg child of options.
    """
    wdiff_model: wdiff_model_cls = wdiff_model_cls
    """
    wdiff_model child of options.
    """
    bc_type: bc_type_cls = bc_type_cls
    """
    bc_type child of options.
    """
    tot_voltage: tot_voltage_cls = tot_voltage_cls
    """
    tot_voltage child of options.
    """
    tot_current: tot_current_cls = tot_current_cls
    """
    tot_current child of options.
    """
