...
class table_voc(Group):
    ...
    """
    write_table command of table_voc.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of table_voc.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of table_voc.
    """
