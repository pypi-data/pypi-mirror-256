...
class table_discharge(Group):
    ...
    """
    row_number child of table_discharge.
    """
    column_number: column_number_cls = column_number_cls
    """
    column_number child of table_discharge.
    """
    row_value: row_value_cls = row_value_cls
    """
    row_value child of table_discharge.
    """
    column_value: column_value_cls = column_value_cls
    """
    column_value child of table_discharge.
    """
    table_value: table_value_cls = table_value_cls
    """
    table_value child of table_discharge.
    """
    command_names = \
    ...
    """
    write_table command of table_discharge.
    """
    read_table: read_table_cls = read_table_cls
    """
    read_table command of table_discharge.
    """
    print_table: print_table_cls = print_table_cls
    """
    print_table command of table_discharge.
    """
