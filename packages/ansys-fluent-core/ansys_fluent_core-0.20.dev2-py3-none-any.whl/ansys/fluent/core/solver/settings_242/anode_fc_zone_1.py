...
class anode_fc_zone(Group):
    ...
    """
    anode_fc_condensation: anode_fc_condensation_cls = anode_fc_condensation_cls
    """
    anode_fc_condensation child of anode_fc_zone.
    """
    anode_fc_evaporation: anode_fc_evaporation_cls = anode_fc_evaporation_cls
    """
    anode_fc_evaporation child of anode_fc_zone.
    """
