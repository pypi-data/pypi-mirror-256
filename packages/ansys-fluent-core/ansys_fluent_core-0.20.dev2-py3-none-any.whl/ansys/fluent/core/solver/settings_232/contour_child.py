...
class contour_child(Group):
    ...
    """
    deformation: deformation_cls = deformation_cls
    """
    deformation child of contour_child.
    """
    deformation_scale: deformation_scale_cls = deformation_scale_cls
    """
    deformation_scale child of contour_child.
    """
    command_names = \
    ...
    """
    update_min_max command of contour_child.
    """
