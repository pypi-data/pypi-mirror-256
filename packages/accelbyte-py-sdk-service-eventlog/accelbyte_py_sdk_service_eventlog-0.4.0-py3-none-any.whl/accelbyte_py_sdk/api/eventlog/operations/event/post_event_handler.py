...
class PostEventHandler(Operation):
    ...
    def with_body(self, value: ModelsEvent) -> PostEventHandler:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PostEventHandler:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsEvent.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelsEvent()
