...
class GetEventByNamespaceHandler(Operation):
    ...
    def with_namespace(self, value: str) -> GetEventByNamespaceHandler:
        self.namespace = value
        return self

    def with_offset(self, value: int) -> GetEventByNamespaceHandler:
        self.offset = value
        return self

    def with_end_date(self, value: str) -> GetEventByNamespaceHandler:
        self.end_date = value
        return self

    def with_page_size(self, value: int) -> GetEventByNamespaceHandler:
        self.page_size = value
        return self

    def with_start_date(self, value: str) -> GetEventByNamespaceHandler:
