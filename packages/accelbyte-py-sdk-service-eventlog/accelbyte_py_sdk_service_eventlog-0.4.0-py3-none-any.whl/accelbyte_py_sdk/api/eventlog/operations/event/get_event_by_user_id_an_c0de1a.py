...
class GetEventByUserIDAndEventTypeHandler(Operation):
    ...
    def with_event_type(self, value: float) -> GetEventByUserIDAndEventTypeHandler:
        self.event_type = value
        return self

    def with_namespace(self, value: str) -> GetEventByUserIDAndEventTypeHandler:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> GetEventByUserIDAndEventTypeHandler:
        self.user_id = value
        return self

    def with_offset(self, value: int) -> GetEventByUserIDAndEventTypeHandler:
        self.offset = value
        return self

    def with_end_date(self, value: str) -> GetEventByUserIDAndEventTypeHandler:
        self.end_date = value
        return self

    def with_page_size(self, value: int) -> GetEventByUserIDAndEventTypeHandler:
        self.page_size = value
        return self

    def with_start_date(self, value: str) -> GetEventByUserIDAndEventTypeHandler:
