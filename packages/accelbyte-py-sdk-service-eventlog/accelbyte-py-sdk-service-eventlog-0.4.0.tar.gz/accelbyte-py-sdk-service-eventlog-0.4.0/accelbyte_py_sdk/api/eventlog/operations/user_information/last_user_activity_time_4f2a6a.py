...
class LastUserActivityTimeHandler(Operation):
    ...
    def with_namespace(self, value: str) -> LastUserActivityTimeHandler:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> LastUserActivityTimeHandler:
        self.user_id = value
        return self
    ...
    def parse_response(
    ...
    ) -> Tuple[Union[None, ModelsUserLastActivity], Union[None, HttpResponse]]:
        ...
        if code == 200:
            return ModelsUserLastActivity.create_from_dict(content), None
        if code == 401:
