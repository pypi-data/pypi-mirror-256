...
class GetEventByEventTypeAndEventIDHandler(Operation):
    ...
    def with_event_id(self, value: float) -> GetEventByEventTypeAndEventIDHandler:
        self.event_id = value
        return self

    def with_event_type(self, value: float) -> GetEventByEventTypeAndEventIDHandler:
        self.event_type = value
        return self

    def with_namespace(self, value: str) -> GetEventByEventTypeAndEventIDHandler:
    ...
    def with_end_date(self, value: str) -> GetEventByEventTypeAndEventIDHandler:
        self.end_date = value
        return self
    ...
    def with_start_date(self, value: str) -> GetEventByEventTypeAndEventIDHandler:
