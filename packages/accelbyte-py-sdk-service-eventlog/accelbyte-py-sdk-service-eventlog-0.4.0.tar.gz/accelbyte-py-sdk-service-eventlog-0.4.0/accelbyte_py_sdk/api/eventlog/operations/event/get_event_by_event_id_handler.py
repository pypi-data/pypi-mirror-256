...
class GetEventByEventIDHandler(Operation):
    ...
    def with_event_id(self, value: float) -> GetEventByEventIDHandler:
        self.event_id = value
        return self

    def with_namespace(self, value: str) -> GetEventByEventIDHandler:
        self.namespace = value
        return self

    def with_offset(self, value: int) -> GetEventByEventIDHandler:
        self.offset = value
        return self

    def with_end_date(self, value: str) -> GetEventByEventIDHandler:
        self.end_date = value
        return self

    def with_page_size(self, value: int) -> GetEventByEventIDHandler:
        self.page_size = value
        return self

    def with_start_date(self, value: str) -> GetEventByEventIDHandler:
