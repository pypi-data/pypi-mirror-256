...
static void sqlite3_cleanup(void *unused) {

    // release resources
    Py_DECREF(pysqlite_Error);
    Py_DECREF(pysqlite_Warning);
    Py_DECREF(pysqlite_InterfaceError);
    Py_DECREF(pysqlite_DatabaseError);
    Py_DECREF(pysqlite_InternalError);
    Py_DECREF(pysqlite_OperationalError);
    Py_DECREF(pysqlite_ProgrammingError);
    Py_DECREF(pysqlite_IntegrityError);
    Py_DECREF(pysqlite_DataError);
    Py_DECREF(pysqlite_NotSupportedError);
    Py_DECREF(pysqlite_error_callback);
