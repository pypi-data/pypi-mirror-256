...
class MogulAthleteResult:
    ...
    def __str__(self) -> str:
        ...
        string += f"Ski Base: {self.ski_base}\n"
    ...
    def analyse_string(self, string: str, mode: str):
        ...
        self.ski_base, string = self.skip_until(string=string, char=".", pos=1)
        match pdf_type:
            case 1 | 3 | 4 | 4.1 | 4.2:
