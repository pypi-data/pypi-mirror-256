module dg_matrix_vector_kernel_10_mod
...
&gh_real, gh_read, any_space_1), arg_type(gh_operator, gh_real, gh_read, any_discontinuous_space_1, any_space_1)/)
  ...
  CONTAINS
  PROCEDURE, NOPASS :: dg_matrix_vector_kernel_10_code
END TYPE dg_matrix_vector_kernel_type
  private

  public :: dg_matrix_vector_kernel_10_code

  contains
  subroutine dg_matrix_vector_kernel_10_code(cell, nlayers_dummy, lhs, x, ncell_3d, matrix, ndf1, undf1, map1, ndf2, undf2, map2)
  ...
  end subroutine dg_matrix_vector_kernel_10_code

end module dg_matrix_vector_kernel_10_mod
