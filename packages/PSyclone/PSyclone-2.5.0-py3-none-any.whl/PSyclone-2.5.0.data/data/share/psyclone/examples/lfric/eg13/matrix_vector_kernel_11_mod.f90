module matrix_vector_kernel_11_mod
...
&any_space_2), arg_type(gh_operator, gh_real, gh_read, any_space_1, any_space_2)/)
  ...
  CONTAINS
  PROCEDURE, NOPASS :: matrix_vector_kernel_11_code
END TYPE matrix_vector_kernel_type
  private

  public :: matrix_vector_kernel_11_code

  contains
  subroutine matrix_vector_kernel_11_code(cell, nlayers_dummy, lhs, x, ncell_3d, matrix, ndf1, undf1, map1, ndf2, undf2, map2)
  ...
  end subroutine matrix_vector_kernel_11_code

end module matrix_vector_kernel_11_mod
