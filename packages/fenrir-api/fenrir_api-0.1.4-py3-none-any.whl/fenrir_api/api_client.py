...
from fenrir_api.api_response import ApiResponse, T as ApiResponseT
import fenrir_api.models
from fenrir_api import rest
from fenrir_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(fenrir_api.models, klass)
