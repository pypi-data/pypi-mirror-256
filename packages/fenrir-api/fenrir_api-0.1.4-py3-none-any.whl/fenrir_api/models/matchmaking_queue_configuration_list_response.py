...
class MatchmakingQueueConfigurationListResponse(BaseModel):
    """
    MatchmakingQueueConfigurationListResponse
    """ # noqa: E501
    configurations: Optional[List[MatchmakingQueueConfiguration]] = Field(default=None, description="A list of matchmaking queue configurations.")
    __properties: ClassVar[List[str]] = ["configurations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configurations": [MatchmakingQueueConfiguration.from_dict(_item) for _item in obj["configurations"]] if obj.get("configurations") is not None else None
        })
        return _obj
