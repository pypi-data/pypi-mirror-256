...
class ApplicationStats(BaseModel):
    ...
    cpu_avg: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The average CPU utilization of the application across all instances.")
    mem_avg: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The average memory utilization of the application across all instances, in megabytes.")
    num_deployments: Optional[StrictInt] = Field(default=None, description="The total number of deployments of the application.")
    num_instances: Optional[StrictInt] = Field(default=None, description="The total number of instances of the application across all deployments")
    __properties: ClassVar[List[str]] = ["ccu_total", "cpu_avg", "mem_avg", "num_deployments", "num_instances"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "num_deployments": obj.get("num_deployments"),
