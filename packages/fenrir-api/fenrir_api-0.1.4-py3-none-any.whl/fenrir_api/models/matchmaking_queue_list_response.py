...
class MatchmakingQueueListResponse(BaseModel):
    """
    MatchmakingQueueListResponse
    """ # noqa: E501
    queues: Optional[List[MatchmakingQueue]] = Field(default=None, description="A list of matchmaking queues.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queues": [MatchmakingQueue.from_dict(_item) for _item in obj["queues"]] if obj.get("queues") is not None else None
        })
        return _obj
