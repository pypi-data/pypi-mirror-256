...
class MatchmakingQueue(BaseModel):
    ...
    uuid: Optional[StrictStr] = Field(default=None, description="A unique id of the matchmaking queue.")
    __properties: ClassVar[List[str]] = ["application_uuid", "configuration", "created", "name", "updated", "uuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configuration": MatchmakingQueueConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
