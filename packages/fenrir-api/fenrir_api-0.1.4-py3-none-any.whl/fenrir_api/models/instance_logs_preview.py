...
class InstanceLogsPreview(BaseModel):
    """
    InstanceLogsPreview
    """ # noqa: E501
    log_lines: Optional[List[StrictStr]] = Field(default=None, description="Most recent log lines.")
    __properties: ClassVar[List[str]] = ["log_lines"]
