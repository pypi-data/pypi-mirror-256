...
class ApplicationConfigurationListResponse(BaseModel):
    """
    ApplicationConfigurationListResponse
    """ # noqa: E501
    configurations: Optional[List[ApplicationConfiguration]] = Field(default=None, description="A list of application configurations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configurations": [ApplicationConfiguration.from_dict(_item) for _item in obj["configurations"]] if obj.get("configurations") is not None else None
        })
        return _obj
