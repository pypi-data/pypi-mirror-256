...
class ApplicationInstance(BaseModel):
    ...
    ApplicationInstance
    """ # noqa: E501
    application_uuid: Optional[StrictStr] = Field(default=None, description="A uuid of the application.")
    container_id: Optional[StrictStr] = Field(default=None, description="A unique id of the container")
    created: Optional[datetime] = Field(default=None, description="Time when the instance was created.")
    deployment_uuid: Optional[StrictStr] = Field(default=None, description="A uuid of the deployment")
    desired_state: Optional[StrictStr] = Field(default=None, description="Desired state of the instance. Corresponds with docker container states.")
    hostname: Optional[StrictStr] = Field(default=None, description="A hostname of the node the instance is running on.")
    ports: Optional[List[ApplicationInstancePort]] = Field(default=None, description="A list of ports exposed on the instance. ")
    state: Optional[StrictStr] = Field(default=None, description="State of the running instance. Corresponds with docker container states.")
    updated: Optional[datetime] = Field(default=None, description="Time when the instance was last updated.")
    uuid: Optional[StrictStr] = Field(default=None, description="A unique id of the instance.")
    __properties: ClassVar[List[str]] = ["application_uuid", "container_id", "created", "deployment_uuid", "desired_state", "hostname", "ports", "state", "updated", "uuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ports": [ApplicationInstancePort.from_dict(_item) for _item in obj["ports"]] if obj.get("ports") is not None else None,
            "state": obj.get("state"),
