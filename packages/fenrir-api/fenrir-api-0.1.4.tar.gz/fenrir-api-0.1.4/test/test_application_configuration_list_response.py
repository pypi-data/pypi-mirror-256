...
class TestApplicationConfigurationListResponse(unittest.TestCase):
    """ApplicationConfigurationListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationConfigurationListResponse:
        """Test ApplicationConfigurationListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationConfigurationListResponse`
        """
        model = ApplicationConfigurationListResponse()
        if include_optional:
            return ApplicationConfigurationListResponse(
                configurations = [
                    fenrir_api.models.application_configuration.ApplicationConfiguration(
    ...
    def testApplicationConfigurationListResponse(self):
        """Test ApplicationConfigurationListResponse"""
