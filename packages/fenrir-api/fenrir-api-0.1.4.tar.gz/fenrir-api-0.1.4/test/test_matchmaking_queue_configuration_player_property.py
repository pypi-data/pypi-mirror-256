...
class TestMatchmakingQueueConfigurationPlayerProperty(unittest.TestCase):
    """MatchmakingQueueConfigurationPlayerProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchmakingQueueConfigurationPlayerProperty:
        """Test MatchmakingQueueConfigurationPlayerProperty
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchmakingQueueConfigurationPlayerProperty`
        """
        model = MatchmakingQueueConfigurationPlayerProperty()
        if include_optional:
            return MatchmakingQueueConfigurationPlayerProperty(
                default_value = '100',
                key = 'rank',
                required = True,
                type = 'int'
    ...
    def testMatchmakingQueueConfigurationPlayerProperty(self):
        """Test MatchmakingQueueConfigurationPlayerProperty"""
