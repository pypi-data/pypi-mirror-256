...
class TestMatchmakingQueueListResponse(unittest.TestCase):
    """MatchmakingQueueListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchmakingQueueListResponse:
        """Test MatchmakingQueueListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchmakingQueueListResponse`
        """
        model = MatchmakingQueueListResponse()
        if include_optional:
            return MatchmakingQueueListResponse(
                queues = [
                    fenrir_api.models.matchmaking_queue.MatchmakingQueue(
    ...
    def testMatchmakingQueueListResponse(self):
        """Test MatchmakingQueueListResponse"""
