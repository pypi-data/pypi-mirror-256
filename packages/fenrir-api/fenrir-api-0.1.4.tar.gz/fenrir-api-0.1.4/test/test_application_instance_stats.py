...
class TestApplicationInstanceStats(unittest.TestCase):
    """ApplicationInstanceStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationInstanceStats:
        """Test ApplicationInstanceStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationInstanceStats`
        """
        model = ApplicationInstanceStats()
        if include_optional:
            return ApplicationInstanceStats(
                ccu = 50,
                cpu = 55.5,
                mem = 25
            )
    ...
    def testApplicationInstanceStats(self):
        """Test ApplicationInstanceStats"""
