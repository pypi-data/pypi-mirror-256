...
class TestApplicationConfigurationResponse(unittest.TestCase):
    """ApplicationConfigurationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationConfigurationResponse:
        """Test ApplicationConfigurationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationConfigurationResponse`
        """
        model = ApplicationConfigurationResponse()
        if include_optional:
    ...
    def testApplicationConfigurationResponse(self):
        """Test ApplicationConfigurationResponse"""
