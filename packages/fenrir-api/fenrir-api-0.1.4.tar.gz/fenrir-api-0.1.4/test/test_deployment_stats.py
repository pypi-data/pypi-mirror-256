...
class TestDeploymentStats(unittest.TestCase):
    """DeploymentStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentStats:
        """Test DeploymentStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentStats`
        """
