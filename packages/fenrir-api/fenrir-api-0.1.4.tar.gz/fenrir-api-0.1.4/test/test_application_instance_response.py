...
class TestApplicationInstanceResponse(unittest.TestCase):
    """ApplicationInstanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationInstanceResponse:
        """Test ApplicationInstanceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationInstanceResponse`
        """
        model = ApplicationInstanceResponse()
        if include_optional:
            return ApplicationInstanceResponse(
                instance = fenrir_api.models.application_instance.ApplicationInstance(
    ...
    def testApplicationInstanceResponse(self):
        """Test ApplicationInstanceResponse"""
