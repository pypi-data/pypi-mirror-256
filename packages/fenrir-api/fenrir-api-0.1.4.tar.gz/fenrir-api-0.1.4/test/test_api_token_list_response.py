...
class TestApiTokenListResponse(unittest.TestCase):
    """ApiTokenListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTokenListResponse:
        """Test ApiTokenListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTokenListResponse`
        """
        model = ApiTokenListResponse()
        if include_optional:
            return ApiTokenListResponse(
                api_tokens = [
                    fenrir_api.models.api_token.ApiToken(
    ...
    def testApiTokenListResponse(self):
        """Test ApiTokenListResponse"""
