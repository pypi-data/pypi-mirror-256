...
class TestDeploymentListResponse(unittest.TestCase):
    """DeploymentListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentListResponse:
        """Test DeploymentListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentListResponse`
        """
        model = DeploymentListResponse()
        if include_optional:
            return DeploymentListResponse(
                deployments = [
                    fenrir_api.models.deployment.Deployment(
    ...
    def testDeploymentListResponse(self):
        """Test DeploymentListResponse"""
