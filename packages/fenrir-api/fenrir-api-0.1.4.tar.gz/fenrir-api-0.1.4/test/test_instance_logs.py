...
class TestInstanceLogs(unittest.TestCase):
    """InstanceLogs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceLogs:
        """Test InstanceLogs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceLogs`
        """
        model = InstanceLogs()
        if include_optional:
            return InstanceLogs(
                url = 'https://api.fenrircloud.com/1.0/logs/24b8bf3fe205468986f2bbad63d1929ea74a3f6db09a4a8eb2229a19ea207dc1/instance.log'
            )
        else:
            return InstanceLogs(
        )
