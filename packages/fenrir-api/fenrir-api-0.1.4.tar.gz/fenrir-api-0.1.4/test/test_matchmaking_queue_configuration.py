...
class TestMatchmakingQueueConfiguration(unittest.TestCase):
    """MatchmakingQueueConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchmakingQueueConfiguration:
        """Test MatchmakingQueueConfiguration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchmakingQueueConfiguration`
        """
        model = MatchmakingQueueConfiguration()
        if include_optional:
            return MatchmakingQueueConfiguration(
    ...
    def testMatchmakingQueueConfiguration(self):
        """Test MatchmakingQueueConfiguration"""
