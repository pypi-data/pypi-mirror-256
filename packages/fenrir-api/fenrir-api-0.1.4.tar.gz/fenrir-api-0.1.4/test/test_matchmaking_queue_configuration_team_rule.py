...
class TestMatchmakingQueueConfigurationTeamRule(unittest.TestCase):
    """MatchmakingQueueConfigurationTeamRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchmakingQueueConfigurationTeamRule:
        """Test MatchmakingQueueConfigurationTeamRule
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchmakingQueueConfigurationTeamRule`
        """
        model = MatchmakingQueueConfigurationTeamRule()
        if include_optional:
            return MatchmakingQueueConfigurationTeamRule(
                difference_value = 20,
                property_key = 'rank',
    ...
    def testMatchmakingQueueConfigurationTeamRule(self):
        """Test MatchmakingQueueConfigurationTeamRule"""
