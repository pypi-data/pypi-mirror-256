...
class TestApplicationInstancePort(unittest.TestCase):
    """ApplicationInstancePort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationInstancePort:
        """Test ApplicationInstancePort
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationInstancePort`
        """
        model = ApplicationInstancePort()
        if include_optional:
    ...
    def testApplicationInstancePort(self):
        """Test ApplicationInstancePort"""
