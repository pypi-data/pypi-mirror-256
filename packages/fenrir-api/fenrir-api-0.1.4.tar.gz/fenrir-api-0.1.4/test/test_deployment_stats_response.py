...
class TestDeploymentStatsResponse(unittest.TestCase):
    """DeploymentStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentStatsResponse:
        """Test DeploymentStatsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentStatsResponse`
        """
        model = DeploymentStatsResponse()
        if include_optional:
            return DeploymentStatsResponse(
                stats = fenrir_api.models.deployment_stats.DeploymentStats(
                    ccu_total = 100, 
                    cpu_avg = 55.5, 
                    instance_stats = {
                        'key' : fenrir_api.models.application_instance_stats.ApplicationInstanceStats(
                            ccu = 50, 
                            cpu = 55.5, 
                            mem = 25, )
                        }, 
    ...
    def testDeploymentStatsResponse(self):
        """Test DeploymentStatsResponse"""
