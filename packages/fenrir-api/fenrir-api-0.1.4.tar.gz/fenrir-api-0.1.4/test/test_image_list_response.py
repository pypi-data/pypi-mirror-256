...
class TestImageListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ImageListResponse:
        """Test ImageListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageListResponse`
        """
        model = ImageListResponse()
        if include_optional:
            return ImageListResponse(
                images = A list of application images.
            )
        else:
            return ImageListResponse(
        )
