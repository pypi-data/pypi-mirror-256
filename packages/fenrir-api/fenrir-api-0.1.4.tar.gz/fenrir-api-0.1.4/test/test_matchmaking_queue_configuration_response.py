...
class TestMatchmakingQueueConfigurationResponse(unittest.TestCase):
    """MatchmakingQueueConfigurationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchmakingQueueConfigurationResponse:
        """Test MatchmakingQueueConfigurationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchmakingQueueConfigurationResponse`
        """
        model = MatchmakingQueueConfigurationResponse()
        if include_optional:
            return MatchmakingQueueConfigurationResponse(
                configuration = fenrir_api.models.matchmaking_queue_configuration.MatchmakingQueueConfiguration(
    ...
    def testMatchmakingQueueConfigurationResponse(self):
        """Test MatchmakingQueueConfigurationResponse"""
