...
class TestMatchmakingQueue(unittest.TestCase):
    """MatchmakingQueue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchmakingQueue:
        """Test MatchmakingQueue
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchmakingQueue`
        """
        ...
        if include_optional:
            return MatchmakingQueue(
                ...
                uuid = '146f44647dd941a89dbe8d487b7aa1ca'
            )
        else:
            return MatchmakingQueue(
                configuration = fenrir_api.models.matchmaking_queue_configuration.MatchmakingQueueConfiguration(
