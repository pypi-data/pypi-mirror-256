...
class TestMatchmakingQueueResponse(unittest.TestCase):
    """MatchmakingQueueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchmakingQueueResponse:
        """Test MatchmakingQueueResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchmakingQueueResponse`
        """
        model = MatchmakingQueueResponse()
        if include_optional:
            return MatchmakingQueueResponse(
                queue = fenrir_api.models.matchmaking_queue.MatchmakingQueue(
    ...
    def testMatchmakingQueueResponse(self):
        """Test MatchmakingQueueResponse"""
