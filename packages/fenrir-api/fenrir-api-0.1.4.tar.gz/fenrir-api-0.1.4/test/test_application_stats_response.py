...
class TestApplicationStatsResponse(unittest.TestCase):
    """ApplicationStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationStatsResponse:
        """Test ApplicationStatsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationStatsResponse`
        """
        model = ApplicationStatsResponse()
        if include_optional:
            return ApplicationStatsResponse(
                stats = fenrir_api.models.application_stats.ApplicationStats(
                    ccu_total = 100, 
                    cpu_avg = 55.5, 
                    mem_avg = 25, 
                    num_deployments = 5, 
    ...
    def testApplicationStatsResponse(self):
        """Test ApplicationStatsResponse"""
