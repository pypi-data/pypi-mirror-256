...
class TestMatchmakingQueueConfigurationPlayerRule(unittest.TestCase):
    """MatchmakingQueueConfigurationPlayerRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchmakingQueueConfigurationPlayerRule:
        """Test MatchmakingQueueConfigurationPlayerRule
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchmakingQueueConfigurationPlayerRule`
        """
        model = MatchmakingQueueConfigurationPlayerRule()
        if include_optional:
            return MatchmakingQueueConfigurationPlayerRule(
                difference_value = 20,
                property_key = 'rank',
                type = 'value_equality'
            )
    ...
    def testMatchmakingQueueConfigurationPlayerRule(self):
        """Test MatchmakingQueueConfigurationPlayerRule"""
