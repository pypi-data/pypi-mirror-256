...
class TestPortConfiguration(unittest.TestCase):
    """PortConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortConfiguration:
        """Test PortConfiguration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortConfiguration`
        """
    ...
    def testPortConfiguration(self):
        """Test PortConfiguration"""
