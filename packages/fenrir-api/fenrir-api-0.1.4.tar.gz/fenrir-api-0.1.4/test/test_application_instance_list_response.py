...
class TestApplicationInstanceListResponse(unittest.TestCase):
    """ApplicationInstanceListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationInstanceListResponse:
        """Test ApplicationInstanceListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationInstanceListResponse`
        """
        model = ApplicationInstanceListResponse()
        if include_optional:
            return ApplicationInstanceListResponse(
                instances = [
                    fenrir_api.models.application_instance.ApplicationInstance(
    ...
    def testApplicationInstanceListResponse(self):
        """Test ApplicationInstanceListResponse"""
