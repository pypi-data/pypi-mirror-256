...
class TestMatchmakingQueueConfigurationTeam(unittest.TestCase):
    """MatchmakingQueueConfigurationTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchmakingQueueConfigurationTeam:
        """Test MatchmakingQueueConfigurationTeam
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchmakingQueueConfigurationTeam`
        """
        model = MatchmakingQueueConfigurationTeam()
        if include_optional:
            return MatchmakingQueueConfigurationTeam(
                max_players = 5,
                min_players = 5,
    ...
    def testMatchmakingQueueConfigurationTeam(self):
        """Test MatchmakingQueueConfigurationTeam"""
