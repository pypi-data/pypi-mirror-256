...
class TestApplicationListResponse(unittest.TestCase):
    """ApplicationListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationListResponse:
        """Test ApplicationListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationListResponse`
        """
        model = ApplicationListResponse()
        if include_optional:
            return ApplicationListResponse(
                applications = [
                    fenrir_api.models.application.Application(
                        configuration = null, 
    ...
    def testApplicationListResponse(self):
        """Test ApplicationListResponse"""
