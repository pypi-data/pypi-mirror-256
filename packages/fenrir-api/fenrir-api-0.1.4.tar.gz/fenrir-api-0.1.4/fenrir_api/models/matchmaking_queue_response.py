...
class MatchmakingQueueResponse(BaseModel):
    ...
    """ # noqa: E501
    queue: Optional[MatchmakingQueue] = Field(default=None, description="A matchmaking queue.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queue": MatchmakingQueue.from_dict(obj["queue"]) if obj.get("queue") is not None else None
        })
        return _obj
