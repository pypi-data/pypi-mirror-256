...
class ValidationError(BaseModel):
    ...
    ValidationError
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="A detailed description of an error.")
    field: Optional[StrictStr] = Field(default=None, description="A field which has validation errors.")
    __properties: ClassVar[List[str]] = ["error", "field"]
