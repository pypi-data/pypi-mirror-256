...
class Application(BaseModel):
    ...
    uuid: Optional[StrictStr] = Field(default=None, description="A unique id of the application.")
    __properties: ClassVar[List[str]] = ["configuration", "created", "name", "updated", "uuid"]

    @field_validator('name')
    def name_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^[0-9a-z\-]+$", value):
            raise ValueError(r"must validate the regular expression /^[0-9a-z\-]+$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": ApplicationConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
