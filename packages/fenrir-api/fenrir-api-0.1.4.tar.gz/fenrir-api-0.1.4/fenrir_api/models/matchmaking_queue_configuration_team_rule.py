...
class MatchmakingQueueConfigurationTeamRule(BaseModel):
    """
    MatchmakingQueueConfigurationTeamRule
    """ # noqa: E501
    difference_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A value difference. Must be specified if team rule checks difference between values.")
    ...
    type: StrictStr = Field(description="Team rule type.")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['max_difference_between_value_average', 'max_difference_between_value_sum']):
            raise ValueError("must be one of enum values ('max_difference_between_value_average', 'max_difference_between_value_sum')")
        return value
