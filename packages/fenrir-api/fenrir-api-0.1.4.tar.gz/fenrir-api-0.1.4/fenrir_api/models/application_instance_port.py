...
class ApplicationInstancePort(BaseModel):
    """
    ApplicationInstancePort
    """ # noqa: E501
    protocol: Optional[StrictStr] = Field(default=None, description="A protocol of the port. May be \"tcp\", \"udp\" or empty if both.")
    published_port: Optional[StrictInt] = Field(default=None, description="A published port of the container. This is the port exposed from the external network.")
    target_port: Optional[StrictInt] = Field(default=None, description="A target port on the container.")
    __properties: ClassVar[List[str]] = ["protocol", "published_port", "target_port"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "published_port": obj.get("published_port"),
