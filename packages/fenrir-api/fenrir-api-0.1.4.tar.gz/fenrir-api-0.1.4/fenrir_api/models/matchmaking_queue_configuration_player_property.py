...
class MatchmakingQueueConfigurationPlayerProperty(BaseModel):
    """
    MatchmakingQueueConfigurationPlayerProperty
    """ # noqa: E501
    default_value: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=128)]] = Field(default=None, description="A default value for a property. If \"required\" is set to false, this default value will be used for tickets that did not specify this property.")
    key: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="A unique key of the property.")
    required: Optional[StrictBool] = Field(default=None, description="A boolean value indicating if this property is required. If set to true, all matchmaking tickets must have this property.")
    type: StrictStr = Field(description="Player property type. Must be \"int\", \"string\", \"bool\" or \"float\".")
    __properties: ClassVar[List[str]] = ["default_value", "key", "required", "type"]
