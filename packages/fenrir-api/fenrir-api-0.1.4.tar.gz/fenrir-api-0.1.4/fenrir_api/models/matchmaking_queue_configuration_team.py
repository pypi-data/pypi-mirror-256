...
class MatchmakingQueueConfigurationTeam(BaseModel):
    """
    MatchmakingQueueConfigurationTeam
    """ # noqa: E501
    max_players: StrictInt = Field(description="A maximum number of players this team may have.")
    min_players: Optional[StrictInt] = Field(default=None, description="A minimum number of players this team must have.")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="A unique name of the team.")
    __properties: ClassVar[List[str]] = ["max_players", "min_players", "name"]
