...
class Image(BaseModel):
    ...
    Image
    """ # noqa: E501
    created: Optional[datetime] = Field(default=None, description="Time when the image was created.")
    id: Optional[StrictStr] = Field(default=None, description="A unique id of this image")
    last_tag_time: Optional[datetime] = Field(default=None, description="Time when image was last tagged")
    size: Optional[StrictInt] = Field(default=None, description="The size of the image, in megabytes.")
    tags: Optional[List[StrictStr]] = Field(default=None, description="A list of tags attached to this image")
    __properties: ClassVar[List[str]] = ["created", "id", "last_tag_time", "size", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "last_tag_time": obj.get("last_tag_time"),
            "size": obj.get("size"),
            "tags": obj.get("tags")
        })
        return _obj
