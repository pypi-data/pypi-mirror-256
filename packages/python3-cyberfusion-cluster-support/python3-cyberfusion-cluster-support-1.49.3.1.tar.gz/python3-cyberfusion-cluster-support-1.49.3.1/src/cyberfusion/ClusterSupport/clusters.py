...
class Cluster(APIObjectInterface):
    ...
    def _set_attributes_from_model(
        ...
        self.mariadb_backup_local_retention = obj[
    ...
    def create(
        ...
        *,
        ...
        url = f"/api/v1/{ENDPOINT_CLUSTERS}/{obj.object_id}"
    ...
    def get_ip_addresses(self) -> dict[str, Any]:
        """Get IP addresses."""
        url = f"/api/v1/{ENDPOINT_CLUSTERS}/{self.id}/ip-addresses"
    ...
    def create_ip_address(
        self, *, service_account_name: str, dns_name: str, address_family: str
    ) -> TaskCollection:
        """Create IP address."""
        url = f"/api/v1/{ENDPOINT_CLUSTERS}/{self.id}/ip-addresses"
        data = {
    ...
    def delete_ip_address(self, id_: int) -> TaskCollection:
        """Delete IP address."""
        url = f"/api/v1/{ENDPOINT_CLUSTERS}/{self.id}/ip-addresses/{id_}"
    ...
    def get_ip_address_products(self) -> dict:
        """Get IP address products."""
        url = f"/api/v1/{ENDPOINT_CLUSTERS}/ip-addresses/products"
