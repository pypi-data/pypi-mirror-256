...
class Routes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["simple_routes", b"simple_routes", "slot_id_route", b"slot_id_route", "slot_key_route", b"slot_key_route", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["simple_routes", b"simple_routes", "slot_id_route", b"slot_id_route", "slot_key_route", b"slot_key_route", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["simple_routes", "slot_key_route", "slot_id_route"] | None: ...
