...
def _hvm_wrap_excepthook(exception_hook):
...
sys.excepthook = _hvm_wrap_excepthook(sys.excepthook)


# Enhance default JSONEncoder for HVM support
class _Encoder(json.JSONEncoder):
    def encode(self, o) -> str:
        from .runtime import _ffi_api
        from hvm.runtime import List, Dict, Set, Tuple
    ...
    def default(self, obj):
        from hvm.runtime import List, Dict, Tuple
