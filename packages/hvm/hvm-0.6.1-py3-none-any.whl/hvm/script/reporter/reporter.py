...
from .script_error import HerculesError
...
def raise_syntax_error(custom_node: context.ASTNode,
    ...
    raise HerculesError(err_msg, new_reporter_span, err_type)
...
class Reporter:
    ...
    def error(cls,
        ...
        raise HerculesError(msg, span, err_type)
    ...
    def error_with_node(cls,
        ...
        new_reporter_span.func_name = custom_node.context.name
        new_reporter_span.source_code = source_code
        raise HerculesError(msg, new_reporter_span, err_type)
