...
unsupported_syntax_error_table = {
    ...
    "Delete": "\"del\" is not supported for hercules.",
    "AsyncFor": "AsyncFor is not supported for hercules",
    "With": "\"with\" statement is not supported for hercules.",
    "AsyncWith": "AsyncWith is not supported for hercules",
    "Import": "\"import\" is not supported within hercules.",
    "ImportFrom": "\"import from\" is not supported within hercules.",
    "Global": "\"global\" is not supported for hercules.",
    "Nonlocal": "Nonlocal is not supported for hercules."}
