...
class Set(Object):
    """hvm.Set: hvm.Set implemented refering to python built-in dict,
    ...
    def update(self, *args, **kwargs):
        ...
        Examples:
            >>> import hvm
            >>> a = hvm.Set({'a', 'b', 'c'})
            >>> a.update(hvm.Set({'b', 'd'}), {'e', 'f'}, ['a', 1], hvm.List([1, 2]))
            >>> a
            {'a', 'c', 'd', 2, 'b', 'f', 1, 'e'}
        """
    ...
    def difference(self, *args):
        ...
        Examples:
            >>> import hvm
            >>> s = hvm.Set({'a', 'b', 'c', 'd', 'e', 'f'})
            >>> s.difference(hvm.Set({'a', 'b'}), {'d', 1}, ['f'], hvm.List([2]))
            {'c', 'e'}
            >>> s
            {'a', 'd', 'c', 'b', 'f', 'e'}
        """
    ...
    def difference_update(self, *args):
        ...
        Examples:
            >>> s = hvm.Set({'a', 'b', 'c', 'd', 'e', 'f'})
            >>> s.difference_update(hvm.Set({'a', 'b'}), {'d', 1}, ['f'], hvm.List([2]))
            >>> s
            {'c', 'e'}
        """
    ...
    def union(self, *args, **kwargs):
        ...
        Examples:
            >>> import hvm
            >>> a = hvm.Set({'a', 'b', 'c'})
            >>> a.union(hvm.Set({'b', 'd'}), {'e', 'f'}, ['a', 1], hvm.List([1, 2]))
            {'a', 'c', 'd', 2, 'b', 'f', 1, 'e'}
            >>> a
            {'a', 'c', 'b'}
        """
