...
class Dict(Object):
    """hvm.Dict implemented refering to python built-in dict,
    ...
    def items(self):
        """Return a key-value iterable (hvm.Iterator).
        ...
        Examples:
            ...
            >>> it = d.items()
            >>> type(it)
            <class 'hvm.runtime._container._iterator.Iterator'>
            >>> for k, v in it:
            ...     print(k, v)
            ...
            a 1
    ...
    def pop(self, k, *args):
        ...
        Examples:
            ...
            File "/data00/shubaihan/repos/hvm4/python/hvm/runtime/_container/_dict.py", line 223, in pop
                return _ffi_api.DictPop(self, k, *args)
            TypeError: HVMError: dict.pop KeyError
            Stack trace:
            File "/data00/shubaihan/repos/hvm4/src/runtime/container/dict_ref.cc", line 305
            [bt] (0) /data00/shubaihan/repos/hvm4/lib/libhvm.so(+0x33c9ed) [0x7f70d4ad39ed]
            [bt] (1) /data00/shubaihan/repos/hvm4/lib/libhvm.so(hvm::runtime::Dict::pop(hvm::runtime::PyArgs)+0x92) [0x7f70d4ad5362]
            [bt] (2) /data00/shubaihan/repos/hvm4/lib/libhvm.so(+0x33f434) [0x7f70d4ad6434]
            [bt] (3) /data00/shubaihan/repos/hvm4/lib/libhvm.so(HVMFuncCall_PYTHON_C_API+0x45) [0x7f70d4ab8c45]
        """
        return _ffi_api.DictPop(self, k, *args)
