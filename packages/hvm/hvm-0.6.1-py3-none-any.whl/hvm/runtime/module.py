...
class Module(object):
    ...
    def __del__(self):
        ...
        check_call(_LIB.HerculesModFree(handle))
    ...
    def import_module(self, module):
        ...
        check_call(_LIB.HerculesModImport(handle, module_handle))
