...
#if defined(HVM_SCRIPT_TENSORFLOW_PYTHON_MODE) && TF_MAJOR_VERSION == 1
...
#ifdef HVM_SCRIPT_TENSORFLOW_PYTHON_MODE
...
HVM_REGISTER_NATIVE_OP(TFModel);
...
HVM_REGISTER_NATIVE_OBJECT(TensorProtoSerializer)
