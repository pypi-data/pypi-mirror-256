...
def _register_builtin_container_cons(name_hint, hvm_name_hint, ret_type):
    Builtin2Op.registrations[name_hint] = _ir_adt.Constructor(hvm_name_hint, ret_type=ret_type)
...
# python math
_register_python_builtin("min", "builtins_min")
_register_python_builtin("max", "builtins_max")
_register_python_builtin("math.exp", "math_exp")
_register_python_builtin("math.exp2", "hvm_math_exp2")
_register_python_builtin("math.exp10", "hvm_math_exp10")
_register_python_builtin("math.erf", "math_erf")
_register_python_builtin("math.tanh", "math_tanh")
_register_python_builtin("math.sigmoid", "hvm_math_sigmoid")
_register_python_builtin("math.log", "math_log")
_register_python_builtin("math.log2", "math_log2")
_register_python_builtin("math.log10", "math_log10")
_register_python_builtin("math.log1p", "math_log1p")
_register_python_builtin("math.tan", "math_tan")
_register_python_builtin("math.cos", "math_cos")
_register_python_builtin("math.cosh", "math_cosh")
_register_python_builtin("math.acos", "math_acos")
_register_python_builtin("math.acosh", "math_acosh")
_register_python_builtin("math.sin", "math_sin")
_register_python_builtin("math.sinh", "math_sinh")
_register_python_builtin("math.asin", "math_asin")
_register_python_builtin("math.asinh", "math_asinh")
_register_python_builtin("math.atan", "math_atan")
_register_python_builtin("math.atanh", "math_atanh")
_register_python_builtin("math.atan2", "math_atan2")
_register_python_builtin("math.sqrt", "math_sqrt")
_register_python_builtin("math.rsqrt", "hvm_math_rsqrt")
_register_python_builtin("math.floor", "math_floor")
_register_python_builtin("math.ceil", "math_ceil")
_register_python_builtin("math.trunc", "math_trunc")
_register_python_builtin("abs", "builtins_abs")
_register_python_builtin("round", "builtins_round")
_register_python_builtin("math.nearbyint", "hvm_math_nearbyint")
_register_python_builtin("math.nextafter", "math_nextafter")
_register_python_builtin("math.hypot", "math_hypot")
_register_python_builtin("math.copysign", "math_copysign")
_register_python_builtin("math.ldexp", "math_ldexp")
_register_python_builtin("math.isnan", "math_isnan")
_register_python_builtin("math.isfinite", "math_isfinite")
_register_python_builtin("math.isinf", "math_isinf")
_register_python_builtin("math.pow", "math_pow")
_register_python_builtin("math.fmod", "math_fmod")
...
# ndarray
_register_python_builtin("{}.runtime.ndarray.add".format("hvm"), "nd_module_add")
_register_python_builtin("{}.runtime.ndarray.sub".format("hvm"), "nd_module_sub")
_register_python_builtin("{}.runtime.ndarray.div".format("hvm"), "nd_module_div")
_register_python_builtin("{}.runtime.ndarray.mul".format("hvm"), "nd_module_mul")
_register_python_builtin("{}.runtime.ndarray.rand".format("hvm"), "nd_module_rand")
_register_python_builtin("{}.runtime.ndarray.concatenate".format("hvm"), "nd_module_concatenate")
_register_python_builtin("{}.runtime.ndarray.stack".format("hvm"), "nd_module_stack")

# TODO: support heapq
_register_python_builtin("{}.list_sort".format("hvm"), "list_module_sort")
_register_python_builtin(
    "{}.runtime._container._list.heapify".format("hvm"),
    "list_module_heapify")
_register_python_builtin(
    "{}.runtime._container._list.heap_replace".format("hvm"),
    "list_module_heap_replace")
_register_python_builtin(
    "{}.runtime._container._list.heap_pushpop".format("hvm"),
    "list_module_heap_pushpop")
_register_python_builtin(
    "{}.runtime._container._list.nth_element".format("hvm"),
    "list_module_nth_element")

# cuda_stream
_register_python_builtin(
    "{}.runtime.cuda_stream.default_stream".format("hvm"),
    "cuda_module_default_stream")
_register_python_builtin(
    "{}.runtime.cuda_stream.create_stream".format("hvm"),
    "cuda_module_create_stream")
_register_python_builtin(
    "{}.runtime.cuda_stream.stream_sync".format("hvm"),
...
# hvm.xx_func
_register_op(make_native_object, _ir_op.hvm_make_native_object)
_register_op("{}.native.make_native_op".format(_module_name_), _ir_op.hvm_make_native_op)
_register_op(make_native_function, _ir_op.hvm_make_native_function)
_register_op(call_native_function, _ir_op.hvm_call_native_function)
_register_op("{}.pmap".format(_module_name_), _ir_op.hvm_pmap)
_register_op("{}.pstarmap".format(_module_name_), _ir_op.hvm_pstarmap)
_register_op("{}.apply_async".format(_module_name_), _ir_op.hvm_apply_async)
...
def register_tuple_construct():
    ...
    def tuple_construct(args):
        ...
        # should be unpacked *args, e.g. hvm.Tuple(1, 2, 3) or (1, 2, 3).
    ...
    Builtin2Op.registrations["hvm.runtime.container.Tuple"] = tuple_star_construct
...
def _register_regex_construct():
    ...
    Builtin2Op.registrations["hvm.runtime.regex.Regex"] = regex_construct
...
def _register_nd_array_construct():
    ...
    Builtin2Op.registrations["hvm.runtime.ndarray.NDArray"] = nd_array_construct
