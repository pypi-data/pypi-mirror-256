...
class DatasetLocator:
    ...
    def __init__(self, namespace: str, dataset_name: str, tag: str | None = None, version: str | None = None):
    ...
    def resolve_remote(self, remote: Remote) -> RemoteDatasetVersion | RemoteDatasetVersionTag:
