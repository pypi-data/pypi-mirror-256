...
# %% auto 0
__all__ = ['moduleloader', 'modulespec', 'pathlike', 'sig', 'param', 'logger', 'ichain', 'iprod', 'ziplong', 'dictkeys',
           'dictvalues', 'dictitems', 'moduletype', 'wrappertype', 'builtinfunctype', 'trackbacktype', 'functiontype',
           'mapping', 'richtree', 'richtext', 'richcons', 'richprog', 'richtask', 'tqdmauto', 'typer']
...
@Prototype(plibpath, PathLike)
class pathlike: '''`pathlib.Path` or `os.PathLike`''';
...
class ziplong: '''`itertools.ziplongest`''';
