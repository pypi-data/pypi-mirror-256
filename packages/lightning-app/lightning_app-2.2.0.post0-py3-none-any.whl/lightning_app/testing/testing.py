...
from lightning_app.core import LightningApp, LightningFlow, constants
...
from lightning_app.utilities.network import LightningClient, _configure_session
...
def application_testing(lit_app_cls: Type[LightningTestApp] = LightningTestApp, command_line: List[str] = []) -> Any:
    ...
    with mock.patch("lightning_app.LightningApp", lit_app_cls):
        original = sys.argv
