...
from lightning_app.utilities.exceptions import CacheMissException, ExitAppException, LightningFlowException
...
class LightningApp:
    def __init__(
        ...
        :class:`~lightning_app.core.work.LightningWork`. This modular design enables you to reuse components created by
        other users.
    ...
    def _update_status(self) -> None:
        ...
        for work in breadth_first(self.root, types=(lightning_app.LightningWork,)):  # type: ignore[arg-type]
