...
- **Sitemap Support:** With just [one line of code](https://github.com/omkarcloud/botasaurus#how-to-get-all-links-in-a-sitemap), you can get all links for a website.
