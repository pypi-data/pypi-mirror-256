...
import seaplane.gen.carrier.models
from seaplane.gen.carrier import rest
from seaplane.gen.carrier.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(
        ...
        self.user_agent = "OpenAPI-Generator/0.0.15.beta1/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(seaplane.gen.carrier.models, klass)
