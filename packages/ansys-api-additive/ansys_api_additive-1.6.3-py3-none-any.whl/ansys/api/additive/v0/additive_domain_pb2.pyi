...
class InitialMicrostructureInput(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    NUMBER_OF_RANDOM_NUCLEI_FIELD_NUMBER: builtins.int
    X_LENGTH_FIELD_NUMBER: builtins.int
    Y_LENGTH_FIELD_NUMBER: builtins.int
    Z_LENGTH_FIELD_NUMBER: builtins.int
    number_of_random_nuclei: builtins.int = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["number_of_random_nuclei",b"number_of_random_nuclei","x_length",b"x_length","y_length",b"y_length","z_length",b"z_length"]) -> None: ...
global___InitialMicrostructureInput = InitialMicrostructureInput
...
class Microstructure3DInput(google.protobuf.message.Message):
    ...
    DEPOSIT_LAYER_THICKNESS_FIELD_NUMBER: builtins.int
    ...
    INITIAL_MICROSTRUCTURE_INPUT_FIELD_NUMBER: builtins.int
    MACHINE_FIELD_NUMBER: builtins.int
    MATERIAL_FIELD_NUMBER: builtins.int
    ...
    deposit_layer_thickness: builtins.float = ...
    ...
    @property
    def initial_microstructure_input(self) -> global___InitialMicrostructureInput: ...
    @property
    def machine(self) -> global___MachineSettings: ...
    @property
    def material(self) -> global___AdditiveMaterial: ...
    use_provided_initial_microstructure_data: builtins.float = ...
    def __init__(self,
        *,
        x_length : builtins.float = ...,
        y_length : builtins.float = ...,
        ...
        deposit_layer_thickness : typing.Optional[builtins.float] = ...,
        ...
        initial_microstructure_input : typing.Optional[global___InitialMicrostructureInput] = ...,
        machine : typing.Optional[global___MachineSettings] = ...,
        material : typing.Optional[global___AdditiveMaterial] = ...,
        use_provided_initial_microstructure_data : typing.Optional[builtins.float] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_deposit_layer_thickness",b"_deposit_layer_thickness","_first_deposit_layer",b"_first_deposit_layer","_initial_euler_angle_data",b"_initial_euler_angle_data","_initial_grain_data",b"_initial_grain_data","_initial_microstructure_input",b"_initial_microstructure_input","_machine",b"_machine","_material",b"_material","_max_bulk_nucleation_density",b"_max_bulk_nucleation_density","_num_deposit_layers",b"_num_deposit_layers","_run_initial_microstructure",b"_run_initial_microstructure","_use_provided_initial_microstructure_data",b"_use_provided_initial_microstructure_data","_use_transient_bulk_nucleation",b"_use_transient_bulk_nucleation","_x_origin",b"_x_origin","_x_thermal_domain_grid_spacing",b"_x_thermal_domain_grid_spacing","_y_origin",b"_y_origin","_y_thermal_domain_grid_spacing",b"_y_thermal_domain_grid_spacing","_z_origin",b"_z_origin","_z_thermal_domain_grid_spacing",b"_z_thermal_domain_grid_spacing","deposit_layer_thickness",b"deposit_layer_thickness","first_deposit_layer",b"first_deposit_layer","initial_euler_angle_data",b"initial_euler_angle_data","initial_grain_data",b"initial_grain_data","initial_microstructure_input",b"initial_microstructure_input","machine",b"machine","material",b"material","max_bulk_nucleation_density",b"max_bulk_nucleation_density","num_deposit_layers",b"num_deposit_layers","run_initial_microstructure",b"run_initial_microstructure","use_provided_initial_microstructure_data",b"use_provided_initial_microstructure_data","use_transient_bulk_nucleation",b"use_transient_bulk_nucleation","x_origin",b"x_origin","x_thermal_domain_grid_spacing",b"x_thermal_domain_grid_spacing","y_origin",b"y_origin","y_thermal_domain_grid_spacing",b"y_thermal_domain_grid_spacing","z_origin",b"z_origin","z_thermal_domain_grid_spacing",b"z_thermal_domain_grid_spacing"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_deposit_layer_thickness",b"_deposit_layer_thickness","_first_deposit_layer",b"_first_deposit_layer","_initial_euler_angle_data",b"_initial_euler_angle_data","_initial_grain_data",b"_initial_grain_data","_initial_microstructure_input",b"_initial_microstructure_input","_machine",b"_machine","_material",b"_material","_max_bulk_nucleation_density",b"_max_bulk_nucleation_density","_num_deposit_layers",b"_num_deposit_layers","_run_initial_microstructure",b"_run_initial_microstructure","_use_provided_initial_microstructure_data",b"_use_provided_initial_microstructure_data","_use_transient_bulk_nucleation",b"_use_transient_bulk_nucleation","_x_origin",b"_x_origin","_x_thermal_domain_grid_spacing",b"_x_thermal_domain_grid_spacing","_y_origin",b"_y_origin","_y_thermal_domain_grid_spacing",b"_y_thermal_domain_grid_spacing","_z_origin",b"_z_origin","_z_thermal_domain_grid_spacing",b"_z_thermal_domain_grid_spacing","deposit_layer_thickness",b"deposit_layer_thickness","first_deposit_layer",b"first_deposit_layer","initial_euler_angle_data",b"initial_euler_angle_data","initial_grain_data",b"initial_grain_data","initial_microstructure_input",b"initial_microstructure_input","machine",b"machine","material",b"material","max_bulk_nucleation_density",b"max_bulk_nucleation_density","num_deposit_layers",b"num_deposit_layers","run_initial_microstructure",b"run_initial_microstructure","use_provided_initial_microstructure_data",b"use_provided_initial_microstructure_data","use_transient_bulk_nucleation",b"use_transient_bulk_nucleation","x_length",b"x_length","x_origin",b"x_origin","x_thermal_domain_grid_spacing",b"x_thermal_domain_grid_spacing","y_length",b"y_length","y_origin",b"y_origin","y_thermal_domain_grid_spacing",b"y_thermal_domain_grid_spacing","z_length",b"z_length","z_origin",b"z_origin","z_thermal_domain_grid_spacing",b"z_thermal_domain_grid_spacing"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_deposit_layer_thickness",b"_deposit_layer_thickness"]) -> typing.Optional[typing_extensions.Literal["deposit_layer_thickness"]]: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_initial_microstructure_input",b"_initial_microstructure_input"]) -> typing.Optional[typing_extensions.Literal["initial_microstructure_input"]]: ...
    @typing.overload
