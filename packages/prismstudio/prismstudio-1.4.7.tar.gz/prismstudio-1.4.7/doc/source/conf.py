...
prism = importlib.import_module("prism") # used to resolve the import within the module, injecting it into the global namespace
prism.login("superuser", "L:3v[5a:mv8,z3Cf")
globals()["prism"] = prism
...
def skip_member(app, what, name, obj, skip, opts):
    ...
    if what == "method" and name == "dataitems":
        return False
    return True
