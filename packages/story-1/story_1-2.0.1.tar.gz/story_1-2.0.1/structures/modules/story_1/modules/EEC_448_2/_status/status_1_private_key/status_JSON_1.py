...
import story_1.modules.EEC_448_2.private_key.scan as private_scan
...
def check_1 ():
	...
	for seed in seeds:
		...
		#	scan
		#
		private_key_from_scan = private_scan.start (private_key_path, "JSON")	
			
		assert (
			private_key_from_scan ["private key"] ["DER hexadecimal string"] ==
