...
import story_1.instrument.thermos.start_dev as flask_start_dev
import story_1.instrument.moves as instrument_moves
...
def add ():
	...
	'''
		instrument thermos start --label instrument_1 --service-port 50000 --mongo-port 50001
	'''
	import os
	import click
	@group.command ("start")
	...
	def start (name, thermos_port, mongo_port):
		...
		import story_1.instrument.monetary as instrument_mongo
		mongo = Process (
