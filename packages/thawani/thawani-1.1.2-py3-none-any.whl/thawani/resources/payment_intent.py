...
class PaymentIntent(Resource):
    def __init__(self, client=None):
        super(PaymentIntent, self).__init__(client)
        self.base_url = URL.PAYMENT_INTENT
    ...
    def all(self, data={}, **kwargs):
        ...
        """
        return super(PaymentIntent, self).all(data, **kwargs)
    ...
    def fetch(self, payment_id, data={}, **kwargs):
        ...
        """
        return super(PaymentIntent, self).fetch(payment_id, data, **kwargs)

    def create(self,data={}, **kwargs): # nosemgrep : python.lang.correctness.common-mistakes.default-mutable-dict.default-mutable-dict
        """"
    ...
    def confirm(self, payment_intent_id, data={}, **kwargs): # nosemgrep : python.lang.correctness.common-mistakes.default-mutable-dict.default-mutable-dict
        """"
        Capture Payment for given Id
        ...
        Returns:
            Payment dict after getting captured
        """
        url = "{}/{}/confirm".format(self.base_url, payment_intent_id)
        return self.post_url(url, data, **kwargs)
