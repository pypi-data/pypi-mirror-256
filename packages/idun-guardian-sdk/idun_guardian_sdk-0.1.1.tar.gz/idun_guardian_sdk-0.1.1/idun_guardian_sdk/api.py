...
class GuardianAPI:
    ...
    def start_recording(
        ...
        """Start an EEG recording.

        Extended description of function.

        Args:
            callback: Description of arg1
            filtered_stream: Description of arg2
            raw_stream:
    ...
    def download_recording(
        self, recording_id, filename=None, eeg=True, imu=False, sleep_report=False
    ) -> bool:
        # TODO: add timeout
        if not filename:
    ...
    def _download_file(self, recording_id, filename, type="eeg"):
        x = requests.get(
            REST_API_LOGIN
    ...
    def subscribe_rt(self, predictions, callback):
        """_summary_

        Args:
            predictions: _description_
