...
class GuardianBLE:
    ...
    def start_recording(self, callback: Callable[[dict], None]):
        """Summary line.
        ...
        Hint:
            ...
            .. code-block::
                ...
                ble = GuardianBLE()
                api = GuardianAPI(ble.deviceID, my_api_key)
        ...
        # Subscribe to data notifications. maybe directly on connect?
    ...
    def start_impedance(self, callback):
    ...
    def start_battery(self, callback):
