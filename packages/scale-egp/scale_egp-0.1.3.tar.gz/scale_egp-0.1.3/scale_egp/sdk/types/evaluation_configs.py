...
class CategoricalChoice(BaseModel):
    ...
    asked to users when they are evaluating generated outputs in the SGP annotation UI.
...
class CategoricalQuestion(BaseModel):
    ...
    users when they are evaluating generated outputs in the SGP annotation UI.
