...
class ApiClient(object):
    ...
    def login(self):
        ...
        url = "https://apiv2-test.emil.de/authservice/v1/login"
        header_params = {}
        header_params.update(self.default_headers)
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ClaimsApi()
        api_instance.create_claim  # this is an instance of the class Endpoint
        api_instance.create_claim()  # this invokes api_instance.create_claim.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_claim.callable or self.callable in this class
