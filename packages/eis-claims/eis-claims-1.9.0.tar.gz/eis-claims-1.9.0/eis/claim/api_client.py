...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ClaimStatusesApi()
        api_instance.create_claim_status  # this is an instance of the class Endpoint
        api_instance.create_claim_status()  # this invokes api_instance.create_claim_status.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_claim_status.callable or self.callable in this class
