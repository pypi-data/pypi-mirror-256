...
class DynamicContentAdminMixin(admin.ModelAdmin):
    ...
    def get_list_display(self, request):
        ...
        return tuple(fields) + tuple(self.list_display)

    def get_list_filter(self, request):
        fields = super().get_list_filter(request)
        return tuple(fields) + tuple(self.list_filter)

    def get_readonly_fields(self, request, obj=None):
        fields = super().get_readonly_fields(request, obj)
        return tuple(fields) + tuple(self.readonly_fields)
