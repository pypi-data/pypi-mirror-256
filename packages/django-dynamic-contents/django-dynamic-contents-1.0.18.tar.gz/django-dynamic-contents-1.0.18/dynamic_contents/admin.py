...
class DynamicContentAdminMixin:
    ...
    list_filter = ('format',)
    append_readonly_fields = ('format', 'parts')

    def get_readonly_fields(self, request, obj=None):
        # Get the original readonly fields from the superclass
        original_readonly_fields = super().get_readonly_fields(request, obj)
        # Dynamically append additional readonly fields
        return original_readonly_fields + self.append_readonly_fields
