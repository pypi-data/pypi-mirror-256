...
def shell_command_file(filepath, **kwargs):
    filepath = os.path.abspath(filepath).replace('\\', os.path.altsep)
...
def shell_command_batch_core(commands,
                             context=None,
                             marker=None,
                             desc_begin=False,
