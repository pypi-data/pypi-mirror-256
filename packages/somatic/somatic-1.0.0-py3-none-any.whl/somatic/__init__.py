...
import somatic.basin as basin
from somatic._clique import clique

import somatic.climate as climate
import somatic.modules.add_glob_to_paths as add_glob_to_paths
...
def start (
	...
	def stop ():
		...
		if (verbose >= 1):
			print ('"somatic" has stopped.')
			print ()
	
	import atexit
	atexit.register (stop)
	
	print ('The somatic server has started')
