...
select_url = lambda url_dev, url_prod, mode: url_dev if mode == "DEV" else url_prod
...
BASE_URL = select_url(BASE_URL_DEV, BASE_URL_PROD, mode)
WEB_URL = select_url(WEB_URL_DEV, WEB_URL_PROD, mode)
