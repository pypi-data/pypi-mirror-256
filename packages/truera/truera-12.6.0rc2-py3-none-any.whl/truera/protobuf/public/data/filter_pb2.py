...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'truera.protobuf.public.data.filter_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _FILTEREXPRESSION._options = None
  _FILTEREXPRESSION._serialized_options = b'\222Aj\nh*\020FilterExpression2TFilter expression, is a tree of operators, where the leaves are FilterLeaf messages.'
  _FILTERLEAF._options = None
  _FILTERLEAF._serialized_options = b'\222A\\\nZ*\nFilterLeaf2LRepresents a simple single filter\n(e.g. `column_value[annual_inc] > 100000`)'
  _FILTEREXPRESSIONOPERATOR._serialized_start=1408
  _FILTEREXPRESSIONOPERATOR._serialized_end=1485
  _FILTEREXPRESSION._serialized_start=188
  _FILTEREXPRESSION._serialized_end=489
  _FILTERLEAF._serialized_start=492
  _FILTERLEAF._serialized_end=1406
  _FILTERLEAF_RANGEOPTIONS._serialized_start=833
  _FILTERLEAF_RANGEOPTIONS._serialized_end=889
  _FILTERLEAF_FILTERLEAFVALUETYPE._serialized_start=892
  _FILTERLEAF_FILTERLEAFVALUETYPE._serialized_end=1050
  _FILTERLEAF_FILTERLEAFCOMPARISONTYPE._serialized_start=1053
  _FILTERLEAF_FILTERLEAFCOMPARISONTYPE._serialized_end=1291
