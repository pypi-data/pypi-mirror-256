...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, pulp_href=None, versions_href=None, pulp_created=None, description=None, retain_repo_versions=None, pulp_labels=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
