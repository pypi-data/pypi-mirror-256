...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, name=None, content_guard=None, repository=None, base_path=None, pulp_labels=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
