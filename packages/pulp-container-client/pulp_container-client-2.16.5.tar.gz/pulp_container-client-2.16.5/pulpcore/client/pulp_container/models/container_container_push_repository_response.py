...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, versions_href=None, name=None, pulp_created=None, latest_version_href=None, description=None, pulp_href=None, manifest_signing_service=None, retain_repo_versions=None, local_vars_configuration=None):  # noqa: E501
