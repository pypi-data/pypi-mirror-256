...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, latest_version_href=None, versions_href=None, name=None, description=None, pulp_href=None, retain_repo_versions=None, manifest_signing_service=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
