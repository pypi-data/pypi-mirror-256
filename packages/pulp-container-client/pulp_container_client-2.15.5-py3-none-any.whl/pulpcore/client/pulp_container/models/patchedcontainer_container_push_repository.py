...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, pulp_labels=None, retain_repo_versions=None, manifest_signing_service=None, description=None, name=None, local_vars_configuration=None):  # noqa: E501
