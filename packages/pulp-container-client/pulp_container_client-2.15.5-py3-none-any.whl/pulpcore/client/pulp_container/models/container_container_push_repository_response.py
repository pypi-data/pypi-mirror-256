...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, pulp_labels=None, retain_repo_versions=None, latest_version_href=None, manifest_signing_service=None, description=None, versions_href=None, name=None, local_vars_configuration=None):  # noqa: E501
