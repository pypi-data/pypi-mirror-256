...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, name=None, base_path=None, content_guard=None, pulp_labels=None, repository=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
