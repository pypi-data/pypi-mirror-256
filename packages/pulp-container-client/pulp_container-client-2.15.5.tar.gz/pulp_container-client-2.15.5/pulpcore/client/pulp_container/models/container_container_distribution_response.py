...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, hidden=False, base_path=None, pulp_href=None, pulp_created=None, content_guard=None, pulp_labels=None, repository=None, name=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
