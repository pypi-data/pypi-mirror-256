...
def show_fig_subplot(images, titles=None, colors=None, ctitles=None, bounds=None, res=None, vmins=None, vcenters=None, vmaxs=None,
	...
	Plotting multiple raster files
		...
		vmins, vcenters, vmaxs: list of plot minimum, centers, and maximum (list of int or float)
...
def points_along_lines(geotiff, line, ID='SEGMENT_ID'):
    ...
    # line is a shapely geometry: shapely.geometry.MultiLineString(...)
    # xarr is a rioxarray array: rioxarray.open_rasterio(geoTIFF).squeeze()
