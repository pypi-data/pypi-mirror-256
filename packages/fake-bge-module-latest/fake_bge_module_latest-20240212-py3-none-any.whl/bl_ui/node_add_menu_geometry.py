...
class NODE_MT_category_GEO_UTILITIES_DEPRECATED(bpy_types.Menu,
...
class NODE_MT_geometry_node_GEO_VOLUME_OPERATIONS(bpy_types.Menu,
                                                  bpy_types._GenericUI):
    bl_idname = None
    ''' '''
...
class NODE_MT_geometry_node_GEO_VOLUME_PRIMITIVES(bpy_types.Menu,
                                                  bpy_types._GenericUI):
    bl_idname = None
    ''' '''
...
class NODE_MT_geometry_node_GEO_VOLUME_READ(bpy_types.Menu,
                                            bpy_types._GenericUI):
    bl_idname = None
    ''' '''
...
class NODE_MT_geometry_node_GEO_VOLUME_WRITE(bpy_types.Menu,
                                             bpy_types._GenericUI):
    bl_idname = None
    ''' '''
