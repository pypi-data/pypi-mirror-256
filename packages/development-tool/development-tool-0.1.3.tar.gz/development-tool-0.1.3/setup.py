...
VERSION = "0.1.3" # la version doit être supérieure à la précédente sinon la publication sera refusée
...
PACKAGE_DATA = {
	"orangecontrib.development_tool.widgets": ["icons/*", "img/*", "dataset_devellopper/*", "widget_designer/*", "kernel_function/*"], # contenu du dossier 'icons' situé dans 'orangecontrib/development_tool/widgets'
}
