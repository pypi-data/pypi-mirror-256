...
def get_create_function(*, git_installed: bool) -> tuple[callable, type[Exception]]:
    if git_installed:
        ...
        return cruft.create, cruft.exceptions.InvalidCookiecutterRepository

    cookiecutter = importlib.import_module("cookiecutter")

    def create(*args, **kwargs):
        return Path(cookiecutter.main.cookiecutter(*args, **kwargs))

    return create, cookiecutter.exceptions.CookiecutterException
