...
# Form implementation generated from reading ui file '/Users/runner/work/parsec-cloud/parsec-cloud/parsec/core/gui/forms/claim_device_provide_info_widget.ui'
#
...
class Ui_ClaimDeviceProvideInfoWidget(object):
    def setupUi(self, ClaimDeviceProvideInfoWidget):
        ...
        self.widget_auth = AuthenticationChoiceWidget(ClaimDeviceProvideInfoWidget)
        self.widget_auth.setObjectName("widget_auth")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget_auth)
