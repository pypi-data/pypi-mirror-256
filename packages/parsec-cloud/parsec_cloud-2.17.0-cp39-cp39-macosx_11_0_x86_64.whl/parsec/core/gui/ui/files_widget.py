...
# Form implementation generated from reading ui file '/Users/runner/work/parsec-cloud/parsec-cloud/parsec/core/gui/forms/files_widget.ui'
#
...
"}")
        ...
        self.spinner = SpinnerWidget(self.widget_files)
        self.spinner.setMinimumSize(QtCore.QSize(32, 32))
        self.spinner.setMaximumSize(QtCore.QSize(32, 32))
        ...
        self.label_elements = QtWidgets.QLabel(FilesWidget)
        ...
        self.horizontalLayout_3.addWidget(self.label_elements)
