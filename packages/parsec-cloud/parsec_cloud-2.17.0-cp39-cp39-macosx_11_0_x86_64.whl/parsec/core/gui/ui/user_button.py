...
# Form implementation generated from reading ui file '/Users/runner/work/parsec-cloud/parsec-cloud/parsec/core/gui/forms/user_button.ui'
#
...
class Ui_UserButton(object):
    def setupUi(self, UserButton):
        ...
        UserButton.resize(200, 200)
        UserButton.setMinimumSize(QtCore.QSize(200, 200))
        UserButton.setMaximumSize(QtCore.QSize(200, 200))
        font = QtGui.QFont()
...
"}")
        ...
        self.label_revoked = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_revoked.setFont(font)
        self.label_revoked.setText("")
        self.label_revoked.setAlignment(QtCore.Qt.AlignCenter)
        self.label_revoked.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        self.label_revoked.setObjectName("label_revoked")
        self.verticalLayout_2.addWidget(self.label_revoked)
