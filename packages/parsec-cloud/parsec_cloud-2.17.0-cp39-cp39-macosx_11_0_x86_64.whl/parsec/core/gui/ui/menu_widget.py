...
# Form implementation generated from reading ui file '/Users/runner/work/parsec-cloud/parsec-cloud/parsec/core/gui/forms/menu_widget.ui'
#
...
"}\n"
"\n"
"#button_devices, #button_files, #button_users, #button_enrollment {\n"
"    color: #999999;\n"
"    background-color: #222222;\n"
"    text-align: left;\n"
"    padding-left: 10px;\n"
...
"}\n"
"\n"
"#button_devices:checked, #button_files:checked, #button_users:checked, #button_enrollment:checked {\n"
"    background-color: #333333;\n"
"    border: 0;\n"
"    color: #FFFFFF;\n"
"}\n"
"\n"
"#button_devices:hover, #button_files:hover, #button_users:hover, #button_enrollment:hover {\n"
"    color: #EEEEEE;\n"
"}\n"
"\n"
...
"}")
        ...
        self.button_enrollment = MenuButton(self.widget_menu)
        self.button_enrollment.setMinimumSize(QtCore.QSize(0, 64))
        self.button_enrollment.setMaximumSize(QtCore.QSize(16777215, 64))
        self.button_enrollment.setBaseSize(QtCore.QSize(0, 64))
        self.button_enrollment.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/images/material/person_add.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_enrollment.setIcon(icon3)
        self.button_enrollment.setIconSize(QtCore.QSize(32, 32))
        self.button_enrollment.setCheckable(True)
        self.button_enrollment.setFlat(True)
        self.button_enrollment.setProperty("checked_color", QtGui.QColor(27, 141, 215))
        self.button_enrollment.setProperty("unchecked_color", QtGui.QColor(153, 153, 153))
        self.button_enrollment.setObjectName("button_enrollment")
        self.verticalLayout_3.addWidget(self.button_enrollment)
    ...
    def retranslateUi(self, MenuWidget):
        ...
        self.button_enrollment.setText(_translate("MenuWidget", "ACTION_MENU_ENROLLMENT"))
