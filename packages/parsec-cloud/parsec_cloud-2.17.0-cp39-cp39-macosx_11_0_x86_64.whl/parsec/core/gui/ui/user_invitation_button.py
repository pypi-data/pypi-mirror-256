...
# Form implementation generated from reading ui file '/Users/runner/work/parsec-cloud/parsec-cloud/parsec/core/gui/forms/user_invitation_button.ui'
#
...
class Ui_UserInvitationButton(object):
    def setupUi(self, UserInvitationButton):
        ...
        UserInvitationButton.resize(200, 200)
        UserInvitationButton.setMinimumSize(QtCore.QSize(200, 200))
        UserInvitationButton.setMaximumSize(QtCore.QSize(200, 200))
...
"}")
        ...
        font = QtGui.QFont()
        font.setPointSize(-1)
        self.button_greet.setFont(font)
        self.button_greet.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, UserInvitationButton):
        ...
        self.button_cancel.setText(_translate("UserInvitationButton", "ACTION_CANCEL_USER_INVITATION_TOOLTIP"))
