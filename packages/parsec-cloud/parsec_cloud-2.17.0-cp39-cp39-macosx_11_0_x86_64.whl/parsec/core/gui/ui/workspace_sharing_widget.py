...
# Form implementation generated from reading ui file '/Users/runner/work/parsec-cloud/parsec-cloud/parsec/core/gui/forms/workspace_sharing_widget.ui'
#
...
class Ui_WorkspaceSharingWidget(object):
    def setupUi(self, WorkspaceSharingWidget):
        ...
        WorkspaceSharingWidget.setStyleSheet("#WorkspaceSharingWidget #scrollArea{\n"
...
"}")
        ...
        self.label_owner_warning = QtWidgets.QLabel(WorkspaceSharingWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_owner_warning.sizePolicy().hasHeightForWidth())
        self.label_owner_warning.setSizePolicy(sizePolicy)
        self.label_owner_warning.setWordWrap(True)
        self.label_owner_warning.setObjectName("label_owner_warning")
        self.horizontalLayout.addWidget(self.label_owner_warning)
    ...
    def retranslateUi(self, WorkspaceSharingWidget):
        ...
        self.label_owner_warning.setText(_translate("WorkspaceSharingWidget", "TEXT_NOT_ENOUGH_OWNERS_WARNING"))
