...
from parsec.backend.postgresql.user_queries.create import query_create_device, query_create_user
...
from parsec.backend.postgresql.user_queries.revoke import query_freeze_user, query_revoke_user
