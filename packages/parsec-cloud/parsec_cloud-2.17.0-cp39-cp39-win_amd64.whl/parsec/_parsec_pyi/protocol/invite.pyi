...
class InviteNewReq:
    ...
    @classmethod
    def User(cls, send_email: bool, claimer_email: str) -> InviteNewReq: ...
    @classmethod
    def Device(cls, send_email: bool) -> InviteNewReq: ...
    @classmethod
    def ShamirRecovery(cls, send_email: bool, claimer_user_id: UserID) -> InviteNewReq: ...
    def dump(self) -> bytes: ...
    @property
    def type(self) -> InvitationType: ...
    @property
...
class InviteNewRepShamirRecoveryNotSetup(InviteNewRep): ...
...
class Invite1ClaimerWaitPeerReq:
    def __init__(self, greeter_user_id: UserID, claimer_public_key: PublicKey) -> None: ...
    def dump(self) -> bytes: ...
    @property
    def greeter_user_id(self) -> UserID | None: ...
    @property
    def claimer_public_key(self) -> PublicKey: ...
...
class Invite2aClaimerSendHashedNonceReq:
    def __init__(self, greeter_user_id: UserID, claimer_hashed_nonce: HashDigest) -> None: ...
    def dump(self) -> bytes: ...
    @property
    def greeter_user_id(self) -> UserID | None: ...
    @property
...
class Invite2bClaimerSendNonceReq:
    def __init__(self, greeter_user_id: UserID, claimer_nonce: bytes) -> None: ...
    def dump(self) -> bytes: ...
    @property
    def greeter_user_id(self) -> UserID | None: ...
    @property
...
class Invite3aClaimerSignifyTrustReq:
    def __init__(self, greeter_user_id: UserID) -> None: ...
    @property
    def greeter_user_id(self) -> UserID | None: ...
    def dump(self) -> bytes: ...
...
class Invite4ClaimerCommunicateReq:
    def __init__(self, greeter_user_id: UserID, payload: bytes) -> None: ...
    def dump(self) -> bytes: ...
    @property
    def greeter_user_id(self) -> UserID | None: ...
    @property
...
class ShamirRecoveryRecipient:
    def __init__(self, user_id: UserID, human_handle: HumanHandle | None, shares: int) -> None: ...
    @property
...
class InviteInfoRepOk(InviteInfoRep):
    def __init__(
        ...
        greeter_user_id: UserID | None = None,
        greeter_human_handle: HumanHandle | None = None,
        threshold: int | None = None,
        recipients: Iterable[ShamirRecoveryRecipient] | None = None,
    ) -> None: ...
    @property
    def type(self) -> InvitationType: ...
    @property
    ...
    @property
    def recipients(self) -> tuple[ShamirRecoveryRecipient, ...]: ...
