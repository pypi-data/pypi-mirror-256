...
__all__ = (
    ...
    "GetDomainsResultPaginatorTypeDef",
...
DomainEntryPaginatorTypeDef = TypedDict(
    "DomainEntryPaginatorTypeDef",
    {
        "id": NotRequired[str],
        "name": NotRequired[str],
...
DomainPaginatorTypeDef = TypedDict(
    "DomainPaginatorTypeDef",
    {
        "name": NotRequired[str],
        "arn": NotRequired[str],
        ...
        "resourceType": NotRequired[ResourceTypeType],
        "tags": NotRequired[List[TagTypeDef]],
        "domainEntries": NotRequired[List[DomainEntryPaginatorTypeDef]],
...
GetDomainsResultPaginatorTypeDef = TypedDict(
    "GetDomainsResultPaginatorTypeDef",
    {
        "domains": List[DomainPaginatorTypeDef],
        "nextPageToken": str,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
