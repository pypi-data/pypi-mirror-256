...
class Poetry(
    ...
    @jsii.member(jsii_name="installCiTask")
    def install_ci_task(self) -> _Task_9fa875b6:
        '''(experimental) A task that installs dependencies (honouring the lockfile).
    ...
    def install_task(self) -> _Task_9fa875b6:
        '''(experimental) A task that updates the lockfile and installs dependencies.
    ...
    def upgrade_task(self) -> _Task_9fa875b6:
        '''(experimental) A task that for upgrades dependencies.
