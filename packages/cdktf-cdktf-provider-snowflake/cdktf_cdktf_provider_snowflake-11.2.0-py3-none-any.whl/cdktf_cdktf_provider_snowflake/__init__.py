'''
# CDKTF prebuilt bindings for Snowflake-Labs/snowflake provider version 0.86.0

This repo builds and publishes the [Terraform snowflake provider](https://registry.terraform.io/providers/Snowflake-Labs/snowflake/0.86.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform snowflake provider](https://registry.terraform.io/providers/Snowflake-Labs/snowflake/0.86.0)
...
from . import failover_group_grant
...
from . import grant_privileges_to_role
