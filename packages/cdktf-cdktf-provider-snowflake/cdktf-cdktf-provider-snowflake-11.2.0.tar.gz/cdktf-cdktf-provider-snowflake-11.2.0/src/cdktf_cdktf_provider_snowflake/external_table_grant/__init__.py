...
class ExternalTableGrant(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.86.0/docs/resources/external_table_grant snowflake_external_table_grant} Resource.
        ...
        :param roles: Grants privilege to these roles. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.86.0/docs/resources/external_table_grant#roles ExternalTableGrant#roles}
        ...
        :param schema_name: The name of the schema containing the current or future external tables on which to grant privileges. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.86.0/docs/resources/external_table_grant#schema_name ExternalTableGrant#schema_name}
        :param shares: Grants privilege to these shares (only valid if on_future is false). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.86.0/docs/resources/external_table_grant#shares ExternalTableGrant#shares}
    ...
    def generate_config_for_import(
        ...
        '''Generates CDKTF code for importing a ExternalTableGrant resource upon running "cdktf plan ".

        :param scope: The scope in which to define this construct.
        :param import_to_id: The construct id used in the generated config for the ExternalTableGrant to import.
        :param import_from_id: The id of the existing ExternalTableGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.86.0/docs/resources/external_table_grant#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the ExternalTableGrant to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fed93d4793d5d55e63136da66a5035648fca92b8592a7b4b84e769a574341fc0)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
def _typecheckingstub__fed93d4793d5d55e63136da66a5035648fca92b8592a7b4b84e769a574341fc0(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
