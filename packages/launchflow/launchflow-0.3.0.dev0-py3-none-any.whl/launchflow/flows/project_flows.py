...
def get_project(project_name: Optional[str], prompt_for_creation: bool = False) -> str:
    if project_name is None:
        ...
        with Progress(
            ...
            projects = launchflow_client.projects.list(account_id)
...
def create_project(
    ...
    if project_name is None:
        ...
        rich.print(f"[pink1]>[/pink1] {project_name}")
    print()
    print("Select a cloud provider for your project:")
    ...
    with Progress(
        ...
        try:
            project = launchflow_client.projects.create(
