...
class CloudSQLPostgres(Resource[CloudSQLPostgresConnectionInfo]):
    ...
    def sqlalchemy(self, *, ip_type=IPTypes.PUBLIC):
        if self._pool is None:
            ...
            self._pool = create_engine("postgresql+pg8000://", creator=getconn)
    ...
    async def sqlalchemy_async(self, *, ip_type=IPTypes.PUBLIC):
        if self._pool is None:
