...
class ResourceResponse(BaseModel):
    ...
    def __str__(self) -> str:
        return f"Resource(name='{self.name}', resource_provider='{self.resource_provider}', resource_product='{self.resource_product}', resource_type='{self.resource_type}', status='{self.status}')"
