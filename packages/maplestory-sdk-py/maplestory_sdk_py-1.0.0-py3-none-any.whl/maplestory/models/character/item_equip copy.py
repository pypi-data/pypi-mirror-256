...
class EquipmentTitle(BaseModel):
    ...
    Attributes:
        ...
        icon: 칭호 아이콘
        description: 칭호 설명
        date_expire: 칭호 유효 기간
        date_option_expire: 칭호 옵션 유효 기간 (expired:만료, null:무제한) (KST)
            "2023-12-21T17:28+09:00"

    Examples:
        "title_name": "Eternal Flame",
        "title_icon": "https://open.api.nexon.com/static/maplestory/ItemIcon/KGICLAPC.png",
        "title_description": "꺼지지 않는 불꽃이 되어라.\n\n올스탯 +15, 공격력/마력+15\n보스 몬스터 공격 시 데미지+10%\n방어율 무시+10% \n최대 HP/최대 MP+750\n10% 추가 경험치\n아케인포스 + 50\n\n클릭으로 ON/OFF시킬 수 있다.\n옵션 지속 기간: 60일",
        "date_expire": null,
        "date_option_expire": "expired"
    """
...
class CharacterEquipment(BaseModel):
    ...
    Attributes:
        ...
        items: 장비 정보
        dragon_items: 에반 드래곤 장비 정보 (에반인 경우 응답)
        mechanic_items: 메카닉 장비 정보 (메카닉인 경우 응답)
        title: 칭호 정보
        preset_no: 적용 중인 어빌리티 프리셋 번호(number)
        preset1: 1번 프리셋 장비 정보
        preset2: 2번 프리셋 장비 정보
        preset3: 3번 프리셋 장비 정보
    """
