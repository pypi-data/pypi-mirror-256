...
from traitlets import Callable, CaselessStrEnum
...
class LTI13Authenticator(Authenticator):
    ...
    username_func = Callable(None, allow_none=True, config=True)
    ...
    def get_username(self, token: Dict[str, Any]) -> str:
        ...
        if self.username_func:
            return self.username_func(token, self.log)
