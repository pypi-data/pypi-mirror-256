...
class NWebJobFetch(Ticker):
    ...
    delete_jobs = True
    def __init__(self, interval = 91, nwebclient=None, group=None, supported_types=None, delete_jobs = True):
...
class MqttPub(Process):
    ...
    def start_client(self):
        from paho.mqtt import client as mqtt_client
        try:
            self.client = mqtt_client.Client(self.client_id, transport='tcp')
