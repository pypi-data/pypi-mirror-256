...
class RefService(object):
    ...
    def UpdateReferences(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/gitaly.RefService/UpdateReferences',
    ...
    def GetTagSignatures(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/gitaly.RefService/GetTagSignatures',
    ...
    def ListRefs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/gitaly.RefService/ListRefs',
    ...
    def FindRefsByOID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gitaly.RefService/FindRefsByOID',
