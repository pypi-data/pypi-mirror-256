...
class RepositoryService(object):
    ...
    def ObjectsSize(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/gitaly.RepositoryService/ObjectsSize',
    ...
    def ApplyGitattributes(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gitaly.RepositoryService/ApplyGitattributes',
            repository__pb2.ApplyGitattributesRequest.SerializeToString,
            repository__pb2.ApplyGitattributesResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def FetchBundle(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/gitaly.RepositoryService/FetchBundle',
    ...
    def BackupRepository(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gitaly.RepositoryService/BackupRepository',
    ...
    def RestoreRepository(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gitaly.RepositoryService/RestoreRepository',
    ...
    def GetFileAttributes(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gitaly.RepositoryService/GetFileAttributes',
