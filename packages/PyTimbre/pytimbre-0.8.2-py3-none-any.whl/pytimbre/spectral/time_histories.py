...
class TimeHistory:
    ...
    def plot(self, xlabel: str = None, ylabel: str = None, ax=None, vmin: float = 0, vmax: float = 125,
             colormap:str = 'jet'):
        """
...
class LogarithmicBandTimeHistory(TimeHistory):
    ...
    def __init__(
            self, a: Waveform, integration_time: float = 0.25, fob_band_width: int = 3, f0: float = 10,
            f1: float = 10000
            ):
        super().__init__(a, integration_time)
    ...
    def _calculate_spectrogram(self):
        ...
        for n in range(N):
            ...
            self._spectra[n] = SpectrumByDigitalFilters(
                subset, self.bandwidth, self.start_frequency,
                self.stop_frequency
                )
...
class Spectrogram(NarrowbandTimeHistory):
    ...
    def __init__(self, a: Waveform = None, integration_time: float = None, fft_size: int = 4096):
        """
        ...
        super().__init__(a, integration_time, fft_size)
