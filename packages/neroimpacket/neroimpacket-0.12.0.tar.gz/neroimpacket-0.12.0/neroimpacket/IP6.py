...
from neroimpacket.ImpactPacket import Header, array_frombytes
from neroimpacket.IP6_Address import IP6_Address
from neroimpacket.IP6_Extension_Headers import IP6_Extension_Header
