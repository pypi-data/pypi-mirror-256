...
from neroimpacket.examples.ntlmrelayx.servers import SMBRelayServer, HTTPRelayServer, WCFRelayServer, RAWRelayServer
from neroimpacket.examples.ntlmrelayx.utils.config import NTLMRelayxConfig, parse_listening_ports
from neroimpacket.examples.ntlmrelayx.utils.targetsutils import TargetsProcessor, TargetsFileWatcher
from neroimpacket.examples.ntlmrelayx.servers.socksserver import SOCKS
...
if __name__ == '__main__':
    ...
    from neroimpacket.examples.ntlmrelayx.clients import PROTOCOL_CLIENTS
    from neroimpacket.examples.ntlmrelayx.attacks import PROTOCOL_ATTACKS
