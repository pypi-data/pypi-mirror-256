...
from neroimpacket.examples import serviceinstall
from neroimpacket.examples.ntlmrelayx.servers.socksserver import activeConnections, SOCKS
from neroimpacket.examples.ntlmrelayx.clients.smbrelayclient import SMBRelayClient
from neroimpacket.nt_errors import ERROR_MESSAGES
from neroimpacket.nt_errors import STATUS_LOGON_FAILURE, STATUS_SUCCESS, STATUS_ACCESS_DENIED, STATUS_NOT_SUPPORTED, \
    STATUS_MORE_PROCESSING_REQUIRED
from neroimpacket.ntlm import NTLMAuthChallengeResponse, NTLMAuthNegotiate, NTLMAuthChallenge, AV_PAIRS, \
    NTLMSSP_AV_HOSTNAME, generateEncryptedSessionKey
from neroimpacket.smb import NewSMBPacket, SMBCommand, SMB, SMBSessionSetupAndX_Data, SMBSessionSetupAndX_Extended_Data, \
...
from neroimpacket.smb3 import SMB3
from neroimpacket.smbconnection import SMBConnection
from neroimpacket.smbserver import outputToJohnFormat, writeJohnOutputToFile, SMBSERVER
from neroimpacket.spnego import ASN1_AID, SPNEGO_NegTokenResp, SPNEGO_NegTokenInit
...
class doAttack(Thread):
    ...
    def run(self):
        ...
        if self.__exeFile is not None:
            ...
            from neroimpacket.examples.secretsdump import RemoteOperations, SAMHashes
            samHashes = None
            try:
