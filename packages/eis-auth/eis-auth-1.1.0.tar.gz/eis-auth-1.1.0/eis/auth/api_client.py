...
from eis.auth import rest
from eis.auth.configuration import Configuration
from eis.auth.exceptions import ApiTypeError, ApiValueError, ApiException, UnauthorizedException
from eis.auth.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AuthserviceApi()
        api_instance.create_org_and_user  # this is an instance of the class Endpoint
        api_instance.create_org_and_user()  # this invokes api_instance.create_org_and_user.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_org_and_user.callable or self.callable in this class
