    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule', models.CharField(blank=True, default=None, max_length=50, validators=[aw.model.job.validate_cronjob])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jobresult_fk_error', to='aw.joberror')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jobresulthost_fk_error', to='aw.joberror')),
                ('result', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='jobresulthost_fk_result', to='aw.jobexecutionresult')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jobexec_fk_result', to='aw.jobexecutionresult')),
                ('user', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jobexec_fk_user', to=settings.AUTH_USER_MODEL)),
                ('user_credentials', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jobexec_fk_usercreds', to='aw.job')),
            ],
            options={
                'abstract': False,
            },
