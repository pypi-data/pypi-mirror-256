    ...
    def list_indexes(self, limit=None, cursor=None) -> List["Index"]:
        ...
        return [
            Index(
                ...
                index_id=index["id"],
                created_at=index.pop("created_at"),
                updated_at=index.pop("updated_at"),
            )
    ...
    def create_index(self, template_name, fields, version: str = None):
        ...
        if not index_create:
            ...
            return Index(
                self,
                index_create["id"],
                created_at=index_create.pop("created_at"),
                updated_at=index_create.pop("updated_at"),
            )
...
class Index:
    ...
    def search(self, query, filter_query: str = None):
        params = {"query": query}
        if filter_query:
