...
def setup_pplog(**kwargs):
    ...
    if project_config.get("splunk_integration"):
        try:
            ...
            pplogging_conf["handlers"]["splunk"]["custom_log_properties"] = kwargs["custom_log_properties"]
        except KeyError as exp:
            raise KeyError(
                "setup_pplog() needs a DBUtils instance and custom_log_properties keyword argument to setup a splunk handler"
            ) from exp
