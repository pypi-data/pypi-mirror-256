...
mod tests {
    ...
    fn test_parse_truncated_len() {
        let buf: &[u8] = &[0, 0, 1];
        from_bytes_fail::<Bytes>(buf, chik_error::Error::EndOfBuffer);
    }
    ...
    fn test_parse_bytes32() {
        ...
        from_bytes_fail::<Bytes32>(&buf[0..30], chik_error::Error::EndOfBuffer);
    }
    ...
    fn test_parse_bytes48() {
        ...
        from_bytes_fail::<Bytes48>(&buf[0..47], chik_error::Error::EndOfBuffer);
    }
