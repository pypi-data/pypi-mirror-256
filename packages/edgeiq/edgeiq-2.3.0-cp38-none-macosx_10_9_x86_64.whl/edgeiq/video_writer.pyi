...
class VideoWriter:
    ...
    def __init__(self, output_path: str = 'output.avi', fps: int = 30, color: bool = True, codec: str = 'MJPG', chunk_duration_s: Optional[int] = None) -> None: ...
...
class _EventVideoWriterThread(threading.Thread):
    def __init__(self, output_path: str, fps: int, color: bool, codec: str, queue: queue.Queue, callback_function: Optional[Callable[..., None]] = None, callback_args: Tuple[Any, ...] = (), *args, **kwargs) -> None: ...
    def run(self) -> None: ...
...
class EventVideoWriter:
    ...
    def start_event(self, output_path: str, callback_function: Optional[Callable[..., None]] = None, callback_args=()): ...
