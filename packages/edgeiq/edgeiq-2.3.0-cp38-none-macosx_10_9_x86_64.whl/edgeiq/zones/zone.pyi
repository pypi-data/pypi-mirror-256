...
class Zone:
    def __init__(self, name: str, points: List[Tuple[int, int]], type: ZoneType, image_width: int, image_height: int, description: str = '') -> None: ...
    @classmethod
    ...
    def check_prediction_within_zone(self, prediction: ObjectDetectionPrediction) -> bool: ...
    def get_predictions_in_zone(self, results: ObjectDetectionResults) -> ObjectDetectionResults: ...
