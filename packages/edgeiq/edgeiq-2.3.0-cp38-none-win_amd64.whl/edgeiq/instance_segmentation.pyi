...
class InstanceSegmentation(BaseService[InstanceSegmentationProcessor]):
    def __init__(self, model_id: str, model_config: Optional[ModelConfig] = None) -> None: ...
    def segment_image(self, image: np.ndarray, confidence_level: float = 0.3) -> InstanceSegmentationResults: ...
    def markup_image(self, image: np.ndarray, predictions: List[InstanceSegmentationPrediction], show_labels: bool = True, show_confidences: bool = True, show_masks: bool = True, colors: Optional[List[Tuple[int, int, int]]] = None, line_thickness: int = 2, font_size: float = 0.5, font_thickness: int = 2) -> np.ndarray: ...
