...
class ObjectDetectionProcessor(Processor):
    def __init__(self, model_config: ModelConfig, pre_process: Optional[PreProcessT] = None, pre_process_batch: Optional[PreProcessBatchT] = None, post_process: Optional[PostProcessT] = None, post_process_batch: Optional[PostProcessBatchT] = None) -> None: ...
    def load(self) -> None: ...
