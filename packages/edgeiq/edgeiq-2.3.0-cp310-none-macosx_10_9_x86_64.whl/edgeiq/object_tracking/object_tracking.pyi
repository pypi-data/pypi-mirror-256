...
class TrackablePrediction(PredictionT):
    ...
    def __init__(self, prediction: PredictionT, deregister_frames: int, min_inertia: int, history_length: int, enter_cb: Optional['TrackerCbT'] = None, exit_cb: Optional['TrackerCbT'] = None) -> None: ...
