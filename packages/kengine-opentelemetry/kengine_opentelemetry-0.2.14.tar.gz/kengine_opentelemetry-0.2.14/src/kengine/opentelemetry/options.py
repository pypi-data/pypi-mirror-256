...
KENGINE_URL = "KENGINE_URL"
# Default values
DEFAULT_API_ENDPOINT = "https://otel.kengine.khulnasoft.com/v1"
...
MISSING_API_KEY_ERROR = "Missing API key. Specify either " + \
    "KENGINE_API_KEY environment variable or apikey in the options" + \
    "parameter."
MISSING_SERVICE_NAME_ERROR = "Missing service name. Specify either " + \
    ...
    "options parameter. If left unset, this will show up in KENGINE " + \
...
class KengineOptions:
    """
    Kengine Options used to configure the OpenTelemetry SDK.
