...
class DFEClient(BaseClient):
    """
    """
    def __init__(self, host_url: str, api_key: Optional[UUID] = None):
    ...
    def request_login(self, other_fields: dict = None):
        ...
        body = {
            ...
            "otp": "",
            "apiKey": "372625ea-6457-4bb0-8061-d9d257d14de9"
        }
        if other_fields:
    ...
    def create_litpet(self, username, hashed_uuid,
                      target_addr, magic_type,
                      food1_type, food2_type):
        body = {
            "username": username,
    ...
    def request_callback(self, other_fields: dict = None, xfers: list = []):
        ...
        body = {
            "tx": {
                ...
                "sig": ("693064023078e035f0f31834fd3342623497ddf80232ec\
        ...
        body["authToken"] = sha256(("00000000-1111-1111-1111-111111111111" + body["tx"]["sig"]).encode()).hexdigest()
        if other_fields:
            body.update(other_fields)
