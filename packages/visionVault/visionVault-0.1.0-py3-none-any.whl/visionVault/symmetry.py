...
def bilateral_syemmetry(picture_name: str, title: str, show_detail = False):
    """
    Main function
...
def test_case(filesPath):
    ...
    for file in files:
        bilateral_syemmetry(file, "With Mirror Line")


class Mirror_Symmetry_detection:
    def _init_(self, image_path: str):
...
bilateral_syemmetry('Screenshot_3.png','My image')