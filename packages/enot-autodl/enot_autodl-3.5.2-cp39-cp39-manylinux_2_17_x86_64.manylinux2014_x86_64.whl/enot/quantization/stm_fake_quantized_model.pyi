...
class STMFakeQuantizedModel(FakeQuantizedModel):
    ...
    """
    def __init__(self, model: nn.Module, leaf_modules: Optional[List[Union[Type[nn.Module], nn.Module]]] = None, use_weight_scale_factors: bool = False, use_bias_scale_factors: bool = False, inplace: bool = False, **kwargs) -> None:
        """
        Parameters
        ----------
        model : nn.Module
