...
class FakeQuantizedModel(nn.Module):
    ...
    """
    def __init__(self, model: nn.Module, transform_patterns: Sequence[Tuple[SubgraphTransformPattern, ...]], activations_quantization_type: QuantizationType, leaf_modules: Optional[List[Union[Type[nn.Module], nn.Module]]] = None, inplace: bool = False, **kwargs) -> None:
        """
        Parameters
        ----------
    ...
    def scale_factors(self) -> Iterator[nn.Parameter]:
        ...
        -------
        iterator over torch.nn.Parameter
            An iterator over scale factors.
