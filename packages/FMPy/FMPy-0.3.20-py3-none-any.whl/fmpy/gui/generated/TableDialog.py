...
# Form implementation generated from reading ui file '/home/vsts/work/1/s/fmpy/gui/forms/TableDialog.ui'
#
...
"}")
        ...
        self.buttonBox.accepted.connect(TableDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(TableDialog.reject) # type: ignore
        self.plotColumnsRadioButton.toggled['bool'].connect(self.firstColumnAsXAxisCheckBox.setEnabled) # type: ignore
        self.plotRowsRadioButton.toggled['bool'].connect(self.firstRowAsXAxisCheckBox.setEnabled) # type: ignore
