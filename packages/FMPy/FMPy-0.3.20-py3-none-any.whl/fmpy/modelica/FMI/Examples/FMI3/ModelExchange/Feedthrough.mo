...
model Feedthrough
  ...
  parameter String 'String_parameter' = "Set me!";
...
protected
  ...
  FMI.Internal.ExternalFMU instance = FMI.Internal.ExternalFMU(
    callbacks,
    Modelica.Utilities.Files.loadResource("modelica://FMI/Resources/FMUs/afead58"),
    2,
    "Feedthrough",
    getInstanceName(),
    0,
...
initial algorithm
  ...
  FMI3SetString(instance, {29}, 1, {'String_parameter'});
