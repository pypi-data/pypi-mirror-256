...
class QuantumCircuit:
    ...
    def get_state(self):
        return self.state.toarray().reshape(-1)
    ...
    def toffoli(self, control_1, control_2, target):
        self.custom_controlled_gate(sx(), target, control_2)
        self.apply_controlled_gate(CX, control_2, control_1)
        self.custom_controlled_gate(sxdg(), target, control_2)
        self.apply_controlled_gate(CX, control_2, control_1)
        self.custom_controlled_gate(sx(), target, control_1)
