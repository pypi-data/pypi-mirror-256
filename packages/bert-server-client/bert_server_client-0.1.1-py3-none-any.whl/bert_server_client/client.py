...
from bert_server_client.schema.embedding import Embedding, EmbeddingRequest
...
class BertClient:
    ...
    def send_request(self, request: EmbeddingRequest) -> Optional[Embedding]:
        """
        ...
        try:
            ...
            return Embedding.msgpack_unpack(response)
