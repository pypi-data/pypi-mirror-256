        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DataUnit']:
                        return DataUnit
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DataUnit'], typing.List['DataUnit']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DataUnit':
