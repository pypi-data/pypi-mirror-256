...
class KnoxUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["expiry", "token", "user", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["expiry", "token", "user", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        expiry: typing.Union[MetaOapg.properties.expiry, str, datetime, ],
        user: 'User',
