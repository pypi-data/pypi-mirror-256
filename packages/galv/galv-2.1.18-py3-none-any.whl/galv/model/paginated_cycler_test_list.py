        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CyclerTest']:
                        return CyclerTest
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['CyclerTest'], typing.List['CyclerTest']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CyclerTest':
