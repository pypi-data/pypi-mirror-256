...
class PaginatedEquipmentFamilyList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EquipmentFamily']:
                        return EquipmentFamily
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['EquipmentFamily'], typing.List['EquipmentFamily']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'EquipmentFamily':
