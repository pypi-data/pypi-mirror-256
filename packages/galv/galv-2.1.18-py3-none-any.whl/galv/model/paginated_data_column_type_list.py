...
class PaginatedDataColumnTypeList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DataColumnType']:
                        return DataColumnType
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DataColumnType'], typing.List['DataColumnType']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DataColumnType':
