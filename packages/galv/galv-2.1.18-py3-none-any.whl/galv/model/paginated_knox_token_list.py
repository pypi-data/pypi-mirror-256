        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['KnoxToken']:
                        return KnoxToken
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['KnoxToken'], typing.List['KnoxToken']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'KnoxToken':
