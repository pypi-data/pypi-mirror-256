        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DataColumn']:
                        return DataColumn
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DataColumn'], typing.List['DataColumn']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DataColumn':
