...
class IPCCArgs(AbstractArgs):
    ...
    def process_args(self):
        ...
        print(f"outdir, output  {outdir}, {output}")
    ...
    def create_output_files(self):
        ...
        output = self.join_filenames_expand_wildcards(outdir, output)
    ...
    def join_filenames_expand_wildcards(self, directory, filename, recursive=True):
        """
        ...
        fullfile = glob.glob(fullfile, recursive=recursive)
        if fullfile is list and len(fullfile) == 1:
            fullfile = fullfile[0]
        return fullfile
