...
class LogData(BaseModel):
    ...
    json_data: Dict[str, Any] = Field(
        description="A Base64 encoded string of the report's JSON data"
    )
    __properties: ClassVar[List[str]] = ["status", "json_data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LogData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LogData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"status": obj.get("status"), "json_data": obj.get("json_data")}
        )
        return _obj
