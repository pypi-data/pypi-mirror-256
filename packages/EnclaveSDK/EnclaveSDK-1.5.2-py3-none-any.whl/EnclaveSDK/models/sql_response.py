...
class SQLResponse(BaseModel):
    ...
    results: Optional[List[Dict[str, Any]]] = Field(
        default=None, description="Results of the SQL query in a JSON format"
    )
    message: Optional[StrictStr] = Field(
        default=None,
        description="Additional information about the query execution, e.g., if there were any errors",
    )
    __properties: ClassVar[List[str]] = ["results", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"results": obj.get("results"), "message": obj.get("message")}
        )
        return _obj
