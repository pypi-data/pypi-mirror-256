...
class ApiV1DataFilesGet200Response(BaseModel):
    """
    ...
    total_files: Optional[StrictInt] = Field(
        default=None, description="Total number of available files", alias="totalFiles"
    )
    __properties: ClassVar[List[str]] = ["files", "totalFiles"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1DataFilesGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1DataFilesGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "files": [File.from_dict(_item) for _item in obj["files"]]
