...
class ApiV1LogPost200Response(BaseModel):
    """
    ...
    message: Optional[StrictStr] = Field(
        default=None,
        description="A message confirming successful receipt of the log data.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1LogPost200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1LogPost200Response from a dict"""
        if obj is None:
            return None
