...
class LogApi:
    ...
    def api_v1_log_post(
        ...
        _param = self._api_v1_log_post_serialize(
            log_data=log_data,
    ...
    @validate_call
    def api_v1_log_post_with_http_info(
        self,
        log_data: LogData,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiV1LogPost200Response]:
        """Post log data
    ...
    @validate_call
    def api_v1_log_post_without_preload_content(
        self,
        log_data: LogData,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_log_post_serialize(
        self,
        log_data,
        _request_auth,
        _content_type,
