...
from .settings import AUTH_ENDPOINT_URL
    ...
    def authenticate(self, request: Request) -> Optional[Tuple[RemoteEmailUser, None]]:
        ...
        try:
            response = requests.get(
                AUTH_ENDPOINT_URL,  # type: ignore[misc]
                timeout=10,
...
class EndpointAuthenticationSchema(OpenApiAuthenticationExtension):
    """Схема endpoint auth."""

    target_class = EndpointAuthentication
