...
class Function:
    ...
    def __init__(self, function, cluster_kwargs, keepalive, environ, local: bool = False, name: Optional[str] = None):
    ...
    @property
    def cluster_status(self) -> Optional[dask.distributed.Status]:
    ...
    def _clear_terminal_cluster(self):
        ...
        if not self._local:
            ...
            if self.cluster_status in coiled.v2.cluster.TERMINATING_STATES:
            ...
            try:
                ...
                try:
                    ...
                    with dask.config.set({
                        ...
                        n_workers = self._cluster_kwargs["n_workers"]
                        if self._local:
                            ...
                            cluster.adapt(minimum=0, maximum=CPU_COUNT or 10)
                        else:
