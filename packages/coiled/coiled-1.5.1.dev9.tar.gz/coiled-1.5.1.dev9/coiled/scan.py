...
from coiled.software_utils import COILED_LOCAL_PACKAGE_PREFIX
...
async def scan_prefix(
    ...
    site_pkgs_paths: Optional[Set[Path]] = None,
    ...
    for extra_path in extra_paths:
        ...
        if any(recurse_importable_python_files(extra_path)):
            ...
            cleaned_name = re.sub(r"[^\w\d.]+", "_", extra_path.name, flags=re.UNICODE)
