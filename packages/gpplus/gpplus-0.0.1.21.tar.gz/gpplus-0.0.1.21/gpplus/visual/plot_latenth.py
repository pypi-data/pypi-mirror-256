            ...
            for j in range(len(levels)):
                for i in range(levels[j]):
                    ...
                    if  type=='mf':
                        ...
                        plt.xlabel(r'$z_1$',labelpad=0,rotation=0,usetex=True, fontsize=20)
                        plt.ylabel(r'$z_2$',labelpad=10,rotation=0,usetex=True, fontsize=20)
                        ...
                        axs[j].set_xlabel(r'$h_1$', labelpad=0,usetex=True, fontsize=20)
                        axs[j].set_ylabel(r'$h_2$', labelpad=5, usetex=True,fontsize=20)
                    else:
            ...
            for j in range(len(levels)):
                for i in range(levels[j]):
                    ...
                    if  type=='mf':
                        ...
                        plt.xlabel(r'$z_1$',labelpad=0,rotation=0,usetex=True, fontsize=fontsize)
                        plt.ylabel(r'$z_2$',labelpad=10,rotation=0,usetex=True, fontsize=fontsize)
                        ...
                        axs.set_xlabel(r'$h_1$', labelpad=0,usetex=True, fontsize=fontsize)
                        axs.set_ylabel(r'$h_2$', labelpad=5, usetex=True,fontsize=fontsize)
                    else:
                        raise ValueError("type should be either 'mf' or cat:")
                    # plt.tight_layout()
                    # axs[j].legend()
