...
def main():
    try:
        ...
        user_id_list = create_user_id_list(slack_client, args.users_to_notify, args.user_lookup_method)
        ...
        artifact.responses.write_json(os.getenv("SHIPYARD_BLUEPRINT_NAME", "send_message"), responses)
