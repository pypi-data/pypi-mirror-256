...
import magicapp_api.data_models.api_dtos as api_dtos
import magicapp_api.data_models.data_classes as data_classes
...
def get_all_guideline_dtos(guideline_id: int):
    ...
    return data_classes.AllGuidelineDTOs(
...
def _fetch_outcomes(pico_dtos: List[api_dtos.Pico]) -> data_classes.Outcomes:
    ts = []
...
def _get_outcome_ids(pico_dtos: List[api_dtos.Pico]) -> data_classes.OutcomeIDs:
    ...
    return data_classes.OutcomeIDs(
