...
def validate_list_datasets(req):
 ...
 # Validate parameters
    ...
    return email, token, client_id, oauth_secret, tenant_id, selected_datasets
...
def validate_list_dataset_files(req):
    ...
    return email, token, client_id, oauth_secret, tenant_id, dataset_id, pagination, max_item_count