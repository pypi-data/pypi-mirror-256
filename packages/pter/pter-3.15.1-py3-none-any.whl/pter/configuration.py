...
DEFAULT_CONFIG = {
        common.SETTING_GROUP_GENERAL: {
            ...
            common.SETTING_SEARCH_CASE_SENSITIVE: common.SearchCaseBehaviour.SENSITIVE,
            ...
            common.SETTING_AUTO_TEMPLATE_CASING: common.SearchCaseBehaviour.SENSITIVE,
            common.SETTING_SORT_ORDER: common.DEFAULT_SORT_ORDER,
        },
...
def get_config(args):
    ...
    includes = conf[common.SETTING_GROUP_GENERAL].get(common.SETTING_INCLUDES, "")
    includes = [pathlib.Path(fn.strip()).expanduser()
