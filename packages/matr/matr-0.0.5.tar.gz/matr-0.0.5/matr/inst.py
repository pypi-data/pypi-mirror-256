...
__all__ = ['pathlike', 'sig', 'param', 'ichain', 'iprod', 'ziplong', 'dict_keys', 'dict_values', 'dict_items', 'moduletype',
           ...
           'npnan', 'npNaN', 'npNAN', 'pdna', 'ptnan', 'number', 'npbool', 'repattern', 'strtemplate', 'npmatrix',
           'nparray', 'recarray', 'npempty', 'sparray', 'spmatrix', 'splinalg', 'speigs', 'sppdist', 'cscarray',
           'cscmatrix', 'cooarray', 'coomatrix', 'csrarray', 'csrmatrix', 'diaarray', 'diamatrix', 'dokarray',
           'dokmatrix', 'lilarray', 'lilmatrix', 'bsrarray', 'bsrmatrix', 'pdindex', 'pdseries', 'pdcatindex',
           'pddataframe', 'pddelegate', 'ptsize', 'pttype', 'ptdevice', 'ptmodule', 'ptdataset', 'ptdataloader',
