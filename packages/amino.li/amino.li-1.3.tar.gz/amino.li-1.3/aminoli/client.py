...
class Client(Callbacks, SocketHandler):
    def __init__(self, deviceId: str = None, userAgent: str = f"Apple iPhone{random.randint(1,99999)},1 iOS v16.5 Main/3.19.0", proxies: dict = None, certificatePath = None, socket_trace = False, socketDebugging = False, socket_enabled = True, autoDevice = False, sub: bool = False):
    ...
    def register(self, nickname: str, email: str, password: str, verificationCode: str, deviceId: str = None, timeout: int = None):
        ...
        **Returns**
        ...
        data = json.dumps({
            ...
            "longitude": 0,
            "address": None,
            "clientCallbackURL": "aminoappsapp://relogin",
            "validationContext": {
                "data": {
    ...
    def check_device(self, deviceId: str):
        ...
        **Returns**
        ...
        data = json.dumps({
            "deviceID": deviceId,
            "bundleID": "com.aminoapps.amino.master",
            "clientType": 100,
