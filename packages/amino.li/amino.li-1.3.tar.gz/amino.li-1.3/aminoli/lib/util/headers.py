...
class Tapjoy:
    def __init__(self, userId: str = None):
        self.data = {
            ...
            "app": {
                "bundle_id": "com.aminoapps.amino.master",
                "current_orientation": "portrait",
                "release_version": "3.4.33585",
                "user_agent": "Dalvik\/2.1.0 (Linux; U; Android 10; G8231 Build\/41.2.A.0.219; com.aminoapps.amino.master\/3.4.33567)"
            },
            "device_user": {
                "country": "US",
                "device": {
    ...
    def headers(self):
        return {
            ...
            "Content-Type": "application/x-www-form-urlencoded",
            "User-Agent": "Dalvik/2.1.0 (Linux; U; Android 10; Redmi Note 9 Pro Build/QQ3A.200805.001; com.aminoapps.amino.master/3.4.33585)"
        }
