...
class FileOperations:
    ...
    async def createUrlFile(
        self, body: RemoteUploadedFileDto, phrase_token: Optional[str] = None
    ) -> UploadedFileDto:
        """
        Upload file
    ...
    async def getFileJson(
        self, fileUid: str, phrase_token: Optional[str] = None
    ) -> UploadedFileDto:
        """
        Get file
