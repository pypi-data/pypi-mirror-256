...
class CustomFieldsOperations:
    ...
    async def getCustomField(
        self, fieldUid: str, phrase_token: Optional[str] = None
    ) -> CustomFieldDto:
        """
        Get custom field
    ...
    async def createCustomField(
        self, body: CreateCustomFieldDto, phrase_token: Optional[str] = None
    ) -> CustomFieldDto:
        """
        Create custom field
    ...
    async def getCustomFieldOptionList(
        self,
        fieldUid: str,
        sortField: str = None,
        name: str = None,
