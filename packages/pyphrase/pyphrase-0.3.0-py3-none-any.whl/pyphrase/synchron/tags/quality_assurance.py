...
class QualityAssuranceOperations:
    ...
    def getLqaProfileDefaultValues(
        self,
        phrase_token: Optional[str] = None,
    ) -> LqaProfileDetailDto:
        """
    ...
    def enabledQualityChecksForJob(
        self,
        jobUid: str,
        projectUid: str,
        phrase_token: Optional[str] = None,
    ...
    def enabledQualityChecksForJob_1(
        self,
        projectUid: str,
        phrase_token: Optional[str] = None,
    ) -> QualityAssuranceChecksDtoV2:
