...
def fn_execute_notebook(notebook, params={}, output_notebook=None, channel_id=None) -> str:
    ...
    # notebook_exists = os.path.exists(notebook)

    # if notebook_exists:
    #     slack.send_slack_message(channel_id, "Notebook Exists")
    # else:
    #     slack.send_slack_message(channel_id, "Notebook Doesnt Exist")

    # slack.send_slack_message(channel_id, f"cwd: {cwd}")

    # notebook = f"{cwd}/{notebook}"
    # output_notebook = f"/tmp/{output_notebook}"
