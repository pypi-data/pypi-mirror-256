...
def can_melon_use_cached(app: App) -> bool:
	...
	try:
		return sv.Version(min_melon) in sv.SimpleSpec(">=15.12.0")
	except ValueError:
	...
	try:
		...
		"""
		return sv.Version("15.12.0") not in sv.SimpleSpec(min_melon)
	except ValueError:
		click.secho(f"Invalid value found for melon version '{min_melon}'", fg="yellow")
		# Invalid expression
		return False
