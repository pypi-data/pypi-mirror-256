        ...
        for step in self.steps:
            ...
            if step['open']:
                bounds = BoundsList.BoundsList(
                    self.containerFrame, option_manager=self.option_manager, step_index=index, fg_color="transparent")
                ...
                funcs = FunctionsList.FunctionsList(
                    self.containerFrame, option_manager=self.option_manager, step_index=index, fg_color="red")
