...
def create_tab(self, tab, option_manager):
    ...
    self.steps_frame = sv.StepView(tab, label_text="Group Editor", option_manager=option_manager)
    ...
    self.static_param_frame = spv.StaticParameterView(tab, label_text="Static Parameters", option_manager=option_manager)
    ...
    self.calib_param_frame = cpv.CalibrationParametersView(tab, label_text="Calibration Parameters", option_manager=option_manager)
