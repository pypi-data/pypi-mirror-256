...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_label.grid(row=0, column=0, padx=header_padding_x, pady=header_padding_y)
        ...
        self.new_window = customtkinter.CTkButton(self.sidebar_frame, width=30, image=expand_image, command=self.new_window)
        self.new_window.grid(row=0, column=6, padx=header_padding_x, pady=header_padding_y)
        ...
        self.scaling_optionemenu = customtkinter.CTkOptionMenu(self.sidebar_frame, values=["50%", "75%", "100%", "150%", "200%"], width=60,
