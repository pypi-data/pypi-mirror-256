...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.footer_frame = customtkinter.CTkFrame(self, width=140, corner_radius=0)
        ...
        self.footer_progress_bar.grid(row=4, column=0, padx=(100, 100), pady=header_padding_y, sticky="ew")
