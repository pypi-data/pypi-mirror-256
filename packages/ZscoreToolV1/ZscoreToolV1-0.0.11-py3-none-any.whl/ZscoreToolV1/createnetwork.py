...
#samplename = 'CTR081_Fron'
#samplepath="/Users/emma/Library/CloudStorage/OneDrive-KarolinskaInstitutet/2. Postdoc KI/1. ALS-FTD project/FTD-GRN/snRNAseq/Integrated with large dataset/outputfiles/EGE1_output/samples/" + sample + ".h5ad"

def createnetwork(samplepath, samplename):

    #%% read in single-nuc data
    adata = sc.read_h5ad(samplepath)
    ...
    coords_df.to_csv('./Results/01. Zscores/' + samplename + '/Cluster_annotation.csv')
    ...
    res_zscore.to_csv('./Results/01. Zscores/' + samplename + '/res_zscore.csv')
