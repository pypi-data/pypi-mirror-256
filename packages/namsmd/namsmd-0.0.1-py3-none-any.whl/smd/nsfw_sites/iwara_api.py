#Code from: https://github.com/xiatg/iwara-python-api/blob/main/api_client.py
...
class ApiClient:
    ...
    def __init__(self, email, password, api_url, file_url):
        self.email = email
    ...
    def download_video(self, video_id, specify_name, preset_name) -> str:
...
client.login()
client.download_video(video_id, specify_name, preset_name)
'''