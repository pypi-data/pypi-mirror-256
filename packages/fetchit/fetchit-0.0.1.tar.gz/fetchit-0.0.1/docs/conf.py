...
# confuses Sphinx when parsing overloaded functions. When not building the documentation, the @set_module("fetchit")
...
html_title = "fetchit"
# html_favicon = "../logo/fetchit-favicon-color.png"
# html_logo = "../logo/fetchit-favicon-white.png"
...
html_theme_options = {
    ...
    "site_url": "https://fetchit.readthedocs.io/",  # todo: <---- no read the docs?
    "repo_url": "https://github.com/bernardodionisi/fetchit",
    "repo_name": "bernardodionisi/fetchit",
    "social": [
        {
            "icon": "fontawesome/brands/github",
            "link": "https://github.com/bernardodionisi/fetchit",
        },
        {
            "icon": "fontawesome/brands/python",
            "link": "https://pypi.org/project/fetchit/",
        },
    ],
    "edit_uri": "",
...
ipython_execlines = ["import fetchit"]
...
#     member for member in dir(fetchit.Array) if inspect.isdatadescriptor(getattr(type(fetchit.Array), member, None))
# ]
# for p in ArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     ArrayMeta_property = getattr(fetchit._domains._meta.ArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     delattr(fetchit._domains._meta.ArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(fetchit.Array, p, classproperty(ArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     setattr(fetchit._domains._meta.ArrayMeta, p, ArrayMeta_property)
# 
# 
# FieldArrayMeta_properties = [
#     member
#     for member in dir(fetchit.FieldArray)
#     if inspect.isdatadescriptor(getattr(type(fetchit.FieldArray), member, None))
# ]
# for p in FieldArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         ArrayMeta_property = getattr(fetchit._domains._meta.ArrayMeta, p)
#     FieldArrayMeta_property = getattr(fetchit._fields._meta.FieldArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         delattr(fetchit._domains._meta.ArrayMeta, p)
#     delattr(fetchit._fields._meta.FieldArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(fetchit.FieldArray, p, classproperty(FieldArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     if p in ArrayMeta_properties:
#         setattr(fetchit._domains._meta.ArrayMeta, p, ArrayMeta_property)
#     setattr(fetchit._fields._meta.FieldArrayMeta, p, FieldArrayMeta_property)
