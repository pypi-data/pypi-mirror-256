...
The latest released version of :obj:`fetchit` can be installed from `PyPI <https://pypi.org/project/fetchit/>`_ using `pip`.
...
.. code-block:: console
   ...
   $ python3 -m pip install git+https://github.com/bernardodionisi/fetchit.git

Or from a specific branch.

.. code-block:: console

   $ python3 -m pip install git+https://github.com/bernardodionisi/fetchit.git@branch
...
fashion from a local folder. This allows any changes in the current directory to be immediately seen upon the next `import fetchit`.

Clone the repo wherever you'd like.

.. code-block:: console

    $ git clone https://github.com/bernardodionisi/fetchit.git

Install the local folder using the `-e` or `--editable` flag.

.. code-block:: console

    $ python3 -m pip install -e fetchit/
...
.. code-block:: console
   ...
   $ python3 -m pip install fetchit[dev]
