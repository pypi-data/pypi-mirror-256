...
class SchemaTracker:
    ...
    def change_log(
        self,
        developmental_release=False,
        developmental_release_name="",
        force_release=False
    ):
        new_version = self.generate_new_version(
            developmental_release=developmental_release,
            developmental_release_name=developmental_release_name,
    ...
    def generate_new_version(
        ...
        if developmental_release:
            new_version = f"{previous_version}.dev{developmental_release_name}"
