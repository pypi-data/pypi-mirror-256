...
class CreateFileCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser: ArgumentParser) -> None:
        group = parser.add_mutually_exclusive_group(required=True)
        group.add_argument('--path', type=str_decode, help='Parent directory path')
        group.add_argument('--id', help='Parent directory ID')
...
class CreateSymlinkCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser: ArgumentParser) -> None:
        group = parser.add_mutually_exclusive_group(required=True)
        group.add_argument('--path', help='Parent directory path')
        group.add_argument('--id', help='Parent directory ID')
        parser.add_argument(
...
class RenameCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser: ArgumentParser) -> None:
        group = parser.add_mutually_exclusive_group(required=True)
        group.add_argument('--path', help='Destination parent directory path')
        group.add_argument('--id', help='Destination parent directory ID')
...
class DeleteCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser: ArgumentParser) -> None:
        group = parser.add_mutually_exclusive_group(required=True)
        group.add_argument('--path', help='File system object path', type=str_decode)
        group.add_argument('--id', help='File system object ID', type=str_decode)
...
class GetFileSamplesCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser: ArgumentParser) -> None:
        group = parser.add_mutually_exclusive_group(required=True)
        group.add_argument('--path', help='Query root path')
        group.add_argument('--id', help='Query root ID')
...
class AclExplainPosixModeCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser: ArgumentParser) -> None:
        group = parser.add_mutually_exclusive_group(required=True)
        group.add_argument('--path', help='File or directory path', type=str_decode)
        group.add_argument('--id', help='File or directory ID', type=str_decode)
...
class AclExplainSetModeCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser: ArgumentParser) -> None:
        group = parser.add_mutually_exclusive_group(required=True)
        group.add_argument('--path', type=str_decode, help='File or directory path')
        group.add_argument('--id', type=str_decode, help='File or directory ID')
