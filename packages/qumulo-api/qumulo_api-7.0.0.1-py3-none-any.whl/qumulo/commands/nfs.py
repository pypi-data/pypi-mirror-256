...
ADD_MODIFY_RESTRICTION_HELP = """
    ...
    host_restrictions is a comma separated list of IPs/ IP ranges/ hostnames/ wildcarded hostnames/
    and the strings KRB5@, KRB5I@, and KRB5P@ for the 3 kerberos security flavors: basic auth,
    Integrity, and Privacy.
    user_mapping can be "none"|"root"|"all".  map_to_user may be "{ "id_type": "LOCAL_USER",
    "id_value": "<integer_id>" }" or "{ "id_type": "NFS_UID", "id_value": "<integer_id>" }".
    map_to_group may be "{ "id_type": "NFS_GID", "id_value": "<integer_id>".  If user_mapping is not
    "none", then either specify map_to_user as a local user or specify both map_to_user and
