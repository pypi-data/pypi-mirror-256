...
class App(customtkinter.CTk):
    ...
    def _build_navi(self):
        ...
        self.console_button.grid(row=2, column=0, sticky="ew")
        ...
        self.reward_button.grid(row=4, column=0, sticky="ew")
    ...
    def _build_common(
        ...
        if add_feature_option:
            ...
            if (
                self.settings_data
                and "自定义" in self.settings_data
                and "feature" in self.settings_data["自定义"]
            ):
                feature_input.insert(0, self.settings_data["自定义"]["feature"])
            self.setting_modules["自定义"]["feature"] = feature_input
            base_row += 1
