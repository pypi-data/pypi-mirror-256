...
setup(
    name="mocker_db",
    packages=["mocker_db"],
    install_requires=['### mocker_db.py', 'dill==0.3.7', 'numpy', 'hnswlib==0.7.0', 'attrs>=22.2.0', 'sentence-transformers==2.2.2'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A mock handler for simulating a vector database.", version="0.0.2"
)
