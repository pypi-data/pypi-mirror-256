...
def printok(*args , **kwargs) : 
    ...
    print(colorama.Style.RESET_ALL + colorama.Style.BRIGHT + colorama.Fore.GREEN + f"{string_io.getvalue()}" +  colorama.Style.RESET_ALL   )
    string_io.close()

def printerror(*args , **kwargs) : 
    string_io = StringIO()  
    print(*args , **kwargs , file = string_io)
    print(colorama.Style.RESET_ALL + colorama.Style.BRIGHT + colorama.Fore.RED + f"{string_io.getvalue()}" +  colorama.Style.RESET_ALL   )
    string_io.close()