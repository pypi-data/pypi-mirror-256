        ...
        if isinstance(annotation, SFS.AttributesAnnotation):
            ret.append(
                AttributesAnnotation(
                    ...
                    sensor_attributes=from_attribute_paths_sfs(
                        annotation.sensor_attributes
                    ),
                )
            )
                ...
                CuboidAnnotation(
                    ...
                    sensor_activations=(
                        [
                            ...
                            for activation in annotation.sensor_activations
                        ]
                        if annotation.sensor_activations
                        else None
                    ),
                    sensor_projections=(
                        [
                            ...
                            for projection in annotation.sensor_projections
                        ]
                        if annotation.sensor_projections
                        else None
                    ),
                    parent_id=annotation.parent_id,
                )
        ...
        if isinstance(annotation, AttributesAnnotation):
            ret.append(
                SFS.AttributesAnnotation(
                    ...
                    sensor_attributes=to_attribute_paths_sfs(
                        annotation.sensor_attributes
                    ),
                )
            )
