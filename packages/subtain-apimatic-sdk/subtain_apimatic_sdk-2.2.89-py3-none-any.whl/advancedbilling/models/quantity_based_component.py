...
class QuantityBasedComponent(object):
    ...
    def from_dictionary(cls,
        ...
        pricing_scheme = APIHelper.deserialize_union_type(UnionTypeLookUp.get('QuantityBasedComponentPricingScheme'), dictionary.get('pricing_scheme'), False) if dictionary.get('pricing_scheme') is not None else None
