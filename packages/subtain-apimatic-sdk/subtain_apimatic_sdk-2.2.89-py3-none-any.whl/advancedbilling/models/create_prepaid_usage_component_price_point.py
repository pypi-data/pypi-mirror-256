...
class CreatePrepaidUsageComponentPricePoint(object):
    ...
    def from_dictionary(cls,
        ...
        expiration_interval_unit = APIHelper.deserialize_union_type(UnionTypeLookUp.get('CreatePrepaidUsageComponentPricePointExpirationIntervalUnit'), dictionary.get('expiration_interval_unit'), False) if dictionary.get('expiration_interval_unit') is not None else APIHelper.SKIP
