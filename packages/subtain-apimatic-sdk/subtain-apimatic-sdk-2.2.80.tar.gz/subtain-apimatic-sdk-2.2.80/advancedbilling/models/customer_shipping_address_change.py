...
class CustomerShippingAddressChange(object):

    """Implementation of the 'Customer Shipping Address Change' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CustomerShippingAddressChange class"""
