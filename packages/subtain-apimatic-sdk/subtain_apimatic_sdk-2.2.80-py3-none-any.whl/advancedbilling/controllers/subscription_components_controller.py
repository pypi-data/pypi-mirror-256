...
class SubscriptionComponentsController(BaseController):
    ...
    def allocate_component(self,
        ...
        **Notice**: Allocations can only be updated for Quantity, On/Off, and
        ...
        Full documentation on how to record Allocations in the Chargify UI can
        be located
        [here](https://maxio-chargify.zendesk.com/hc/en-us/articles/54045278499
        97). It is focused on how allocations operate within the Chargify
        UI.It goes into greater detail on how the user interface will react
        ...
        **Notice:** These proration and accural fields will be ignored for
        ...
        value](https://maxio-chargify.zendesk.com/hc/en-us/articles/54045278499
        97-Component-Allocations#component-allocations-0-0)
        3. Allocation API call top level (outside of the `allocations` array)
        4. [Site-level default
        value](https://maxio-chargify.zendesk.com/hc/en-us/articles/54045278499
        97#proration-schemes)
    ...
    def preview_allocations(self,
        ...
        **quantity-based** or **on/off** component allocation in the middle of
        the current billing period.  This is useful if you want users to be
        able to see the effect of a component operation before actually doing
        it.
        ...
        `allocation_preview` at the `line_items` and `allocations` level
        respectfully.
