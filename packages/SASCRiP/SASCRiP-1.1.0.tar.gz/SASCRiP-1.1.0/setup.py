...
package_data = {
'SASCRiP': ['cqc_srt.R', 'cut_t2g.sh', 'edit_fastq_function.sh', 'edit_seurat_matrix.sh', 'install_packages.R', 'MultipleSample_cqc_vis.R', 'normalise_seurat.R', 'AddHGNC_features.R']
},
