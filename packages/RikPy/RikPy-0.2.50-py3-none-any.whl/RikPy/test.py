...
from .commonshopify import Shopify_get_product_variants, Shopify_get_products_in_collection, Shopify_get_metaobject_gid, Shopify_update_metaobject, Shopify_get_collections
...
import requests
from .commonfunctions import download_file_local, send_email
...
if b_test_shopify:
    ...
    shop = '9d9853'
    access_token = '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'
    ...
    #collections = Shopify_get_collections(shop, access_token)
    #print(collections)

    collection_id = '450597257527'
    products = Shopify_get_products_in_collection(shop=shop, access_token=access_token, collection_id=collection_id)
    if products:
        # Get the ID of the first product
        first_product_id = products[0]['id']
        
        # Call Shopify_get_product_variants to get the variants for the first product
        variants = Shopify_get_product_variants(shop, access_token, first_product_id)
        ...
        if variants:
            ...
            print("Failed to retrieve variants for the first product")
    else:
