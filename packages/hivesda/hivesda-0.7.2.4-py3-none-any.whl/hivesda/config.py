...
def parse_args():
    ...
    parser.add_argument('--dataset', default='custom', type=str, metavar='D',
    ...
    parser.add_argument('--inp_size', default=300, type=int, metavar='C',
                        help='image resize dimensions (default: 256)')
    parser.add_argument('--batch_size', default=32, type=int, metavar='B',
                        help='train batch size (default: 32)')
    parser.add_argument('--num_workers', default=0, type=int, metavar='G',
    ...
    parser.add_argument('--in_fg_region', default=False, type=bool,
