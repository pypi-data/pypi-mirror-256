...
OVER A SET OF POSITIONS AT A FIXED COLLECTION OF BORESIGHT ANGLES
...
Versions:
    2022 10 14 : PR. Creation from cam_aat_050_ambient_circle_mult
...
from camtest.commanding.cam_aat_050_ambient_recentering_ghost import cam_aat_050_ambient_recentering_ghost
...
@building_block
def cam_aat_050_ambient_circle_mult_ghost(num_cycles=None, num_cycles_ghost=None, exposure_time=None, exposure_time_ghost=None, elevations=None, n_poss=None, n_rows=None, alternate_order=None, attenuation=None, attenuation_ghost=None):
    """
    SYNOPSIS
    ...
    num_cycles_ghost: nb of images to be acquired on the ghost (= on the complementary CCD)
    ...
    for elevation, n_pos in zip(elevations, n_poss):
        ...
        cam_aat_050_ambient_recentering_ghost(num_cycles=num_cycles, num_cycles_ghost=num_cycles_ghost,
                exposure_time=exposure_time, exposure_time_ghost=exposure_time_ghost, angles=angles,
                ccd_rows=ccdrows, ccd_cols=ccdcols, ccd_codes=ccdcodes, ccd_sides=ccdsides, n_rows=n_rows,
                attenuation=attenuation, attenuation_ghost=attenuation_ghost)
