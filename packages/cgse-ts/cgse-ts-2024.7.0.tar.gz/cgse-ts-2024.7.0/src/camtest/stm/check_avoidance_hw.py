...
setup.camera.fpa.avoidance.vertices_radius = 150.
setup.camera.fpa.avoidance.clearance_xy = 5.
...
#filexls = "/Users/pierre/plato/csl_refFrames_avoidance_test.xls"
...
# OBJ tilted wrt USR ==> should crash at -12.9 (--> -12.8 refused)
#  5.00 mm = definition of avoidance volum2
#  7.86 mm = vertical displacement of edges wrt center due to the tilt between hexusr and hexobj
# 12.90 mm = vertical distance "between the origins" when a point at the edge enters the avoidance volume
