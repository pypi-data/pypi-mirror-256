...
@building_block
def cam_aat_050_ambient_circle(num_cycles=None, exposure_time=None, elevation=None, n_pos=None, n_rows=None, reverse_order=None):
    """
    SYNOPSIS
    cam_aat_050_ambient_circle(num_cycles=None, exposure_time=None, elevation=None, n_pos=None, n_rows=None)
    ...
    NB: n_pos must be a multiple of 4 !!
    ...
    angles, [ccdrows, ccdcols, ccdcodes, ccdsides] = sort_on_azimuth(anglesorig,
                                                                     [ccdrowsorig, ccdcolsorig, ccdcodesorig,
                                                                      ccdsidesorig], reverse=reverse_order)
