...
# In this first step, lower the hexapod by 20mm. No other movements are done -----------------------
# This will bring us into a safe zone where the mirror L6 is outside of the mask.

vtrans = [0, 0, -20]
vrot = [0, 0, 0]

move_ok = execute(hexapod_puna_move_relative_user, translation=vtrans, rotation=vrot, wait=True)
...
#                                                                                                  #
# After this script has run, we can continue here...                                               #
#                                                                                                  #
####################################################################################################
...
# Check that the FPA is indeed at the Hartman plane ------------------------------------------------
...
# Test the positioning at the Hartmann plane -------------------------------------------------------
...
rich.print(setup)
setup = submit_setup(
    setup, "CSLReferenceFrameModel EM 005 20210921 - bringing FPA at Hartmann plane"
)
rich.print(setup)
