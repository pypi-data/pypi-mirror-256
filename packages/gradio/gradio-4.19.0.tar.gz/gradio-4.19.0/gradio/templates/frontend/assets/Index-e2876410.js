import { _ as __vitePreload } from './index-2e3ef8b2.js';
import { B as Block } from './Button-816a5c8f.js';
import { B as BlockLabel } from './BlockLabel-f1b72dca.js';
import { I as IconButton } from './IconButton-387c96f6.js';
import { a as Download } from './DownloadLink-2b75f7c5.js';
import { S as Static } from './Index-a927ce67.js';
import { F as File } from './File-e96cd7d6.js';
import { U as Undo } from './Undo-6c110254.js';
import { U as Upload } from './ModifyUpload.svelte_svelte_type_style_lang-f4299494.js';
import { M as ModifyUpload } from './ModifyUpload-7cf316e0.js';
import { E as Empty } from './Empty-2aeb2148.js';
import { U as UploadText } from './UploadText-dd61cd1f.js';
...
function create_if_block$2(ctx) {
	...
	return {
		c() {
			div1 = element$1("div");
			div0 = element$1("div");
			create_component$2(iconbutton0.$$.fragment);
			t0 = space$2();
			a = element$1("a");
			create_component$2(iconbutton1.$$.fragment);
			t1 = space$2();
			if_block.c();
			attr$1(a, "href", /*resolved_url*/ ctx[11]);
		...
		m(target, anchor) {
			...
			append$1(div1, div0);
			mount_component$2(iconbutton0, div0, null);
			append$1(div0, t0);
			append$1(div0, a);
			mount_component$2(iconbutton1, a, null);
			append$1(div1, t1);
		...
		p(ctx, dirty) {
			...
			if (dirty & /*i18n*/ 16) iconbutton1_changes.label = /*i18n*/ ctx[4]("common.download");
			iconbutton1.$set(iconbutton1_changes);

			if (!current || dirty & /*resolved_url*/ 2048) {
				attr$1(a, "href", /*resolved_url*/ ctx[11]);
			}
		...
		i(local) {
			if (current) return;
			transition_in$2(iconbutton0.$$.fragment, local);
			transition_in$2(iconbutton1.$$.fragment, local);
			transition_in$2(if_block);
			current = true;
		},
		o(local) {
			transition_out$2(iconbutton0.$$.fragment, local);
			transition_out$2(iconbutton1.$$.fragment, local);
		...
		d(detaching) {
			...
			destroy_component$2(iconbutton0);
			destroy_component$2(iconbutton1);
...
function create_else_block$2(ctx) {
	...
	function switch_instance_resolved_url_binding_1(value) {
		/*switch_instance_resolved_url_binding_1*/ ctx[16](value);
	}

	var switch_value = /*canvas3d*/ ctx[8];
	...
	function switch_props(ctx, dirty) {
		...
		if (/*resolved_url*/ ctx[11] !== void 0) {
			switch_instance_props.resolved_url = /*resolved_url*/ ctx[11];
		}
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*canvas3d*/ 256 && switch_value !== (switch_value = /*canvas3d*/ ctx[8])) {
				if (switch_instance) {
					group_outros$2();
				...
				if (!updating_resolved_url && dirty & /*resolved_url*/ 2048) {
					updating_resolved_url = true;
					switch_instance_changes.resolved_url = /*resolved_url*/ ctx[11];
...
function create_if_block_1$2(ctx) {
	...
	function switch_instance_resolved_url_binding(value) {
		/*switch_instance_resolved_url_binding*/ ctx[15](value);
	}

	var switch_value = /*canvas3dgs*/ ctx[10];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*canvas3dgs*/ 1024 && switch_value !== (switch_value = /*canvas3dgs*/ ctx[10])) {
				if (switch_instance) {
					group_outros$2();
					const old_component = switch_instance;
...
async function loadCanvas3D$1() {
	const module = await __vitePreload(() => import('./Canvas3D-f692ef92.js'),true?["./Canvas3D-f692ef92.js","./Index-a927ce67.js","./index-2e3ef8b2.js","./index-8d4a258a.css","./Index-882fff57.css","./file-url-3e95666f.js"]:void 0,import.meta.url);
	return module.default;
}

async function loadCanvas3DGS$1() {
	const module = await __vitePreload(() => import('./Canvas3DGS-158c44a5.js'),true?["./Canvas3DGS-158c44a5.js","./file-url-3e95666f.js","./Index-a927ce67.js","./index-2e3ef8b2.js","./index-8d4a258a.css","./Index-882fff57.css"]:void 0,import.meta.url);
	return module.default;
}
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*value, use_3dgs*/ 513) {
			{
				if (value) {
					...
					if (use_3dgs) {
						loadCanvas3DGS$1().then(module => {
							$$invalidate(10, canvas3dgs = module);
						});
					} else {
						loadCanvas3D$1().then(module => {
							$$invalidate(8, canvas3d = module);
						});
					}
				}
			}
		...
		if ($$self.$$.dirty & /*current_settings, camera_position, zoom_speed, pan_speed, canvas3d*/ 8672) {
			{
				if (!dequal(current_settings.camera_position, camera_position) || current_settings.zoom_speed !== zoom_speed || current_settings.pan_speed !== pan_speed) {
					canvas3d.reset_camera_position(camera_position, zoom_speed, pan_speed);
					$$invalidate(13, current_settings = { camera_position, zoom_speed, pan_speed });
				}
			}
		}
	};
...
function create_else_block$1(ctx) {
	...
	modifyupload.$on("clear", /*handle_clear*/ ctx[14]);
	modifyupload.$on("undo", /*handle_undo*/ ctx[15]);
...
function create_if_block$1(ctx) {
	...
	upload.$on("load", /*handle_upload*/ ctx[13]);
...
function create_else_block_1$1(ctx) {
	...
	let switch_instance_anchor;
	let current;
	var switch_value = /*canvas3d*/ ctx[11];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*canvas3d*/ 2048 && switch_value !== (switch_value = /*canvas3d*/ ctx[11])) {
				if (switch_instance) {
					group_outros$1();
					const old_component = switch_instance;
...
function create_if_block_1$1(ctx) {
	...
	let switch_instance_anchor;
	let current;
	var switch_value = /*canvas3dgs*/ ctx[12];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*canvas3dgs*/ 4096 && switch_value !== (switch_value = /*canvas3dgs*/ ctx[12])) {
				if (switch_instance) {
					group_outros$1();
					const old_component = switch_instance;
...
// (68:1) <Upload   on:load={handle_upload}   {root}   filetype={[".stl", ".obj", ".gltf", ".glb", "model/obj", ".splat", ".ply"]}   bind:dragging  >
				...
				if (value) {
					...
					if (use_3dgs) {
						loadCanvas3DGS().then(module => {
							$$invalidate(12, canvas3dgs = module);
						});
					} else {
						loadCanvas3D().then(module => {
							$$invalidate(11, canvas3d = module);
						});
					}
				}
			}
...
//# sourceMappingURL=Index-e2876410.js.map
