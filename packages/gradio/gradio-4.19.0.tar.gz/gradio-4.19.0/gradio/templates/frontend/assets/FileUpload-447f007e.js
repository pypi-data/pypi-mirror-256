...
import { D as DownloadLink } from './DownloadLink-2b75f7c5.js';
...
function create_if_block$2(ctx) {
	...
	return {
		c() {
			...
			button.textContent = "×";
			attr(button, "class", "label-clear-button svelte-1pacgzi");
			attr(button, "aria-label", "Remove this file");
			attr(td, "class", "svelte-1pacgzi");
		},
		m(target, anchor) {
...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			t5 = space$2();
			attr(span0, "class", "stem svelte-1pacgzi");
			attr(span1, "class", "ext svelte-1pacgzi");
			attr(td0, "class", "filename svelte-1pacgzi");
			attr(td0, "aria-label", td0_aria_label_value = /*file*/ ctx[10].orig_name);
			attr(td1, "class", "download svelte-1pacgzi");
			attr(tr, "class", "file svelte-1pacgzi");
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(tbody, "class", "svelte-1pacgzi");
			attr(table, "class", "file-preview svelte-1pacgzi");
...
function create_else_block(ctx) {
	...
	function upload_dragging_binding(value) {
		/*upload_dragging_binding*/ ctx[16](value);
	}
...
function create_if_block(ctx) {
	...
	filepreview.$on("change", /*change_handler*/ ctx[15]);
...
//# sourceMappingURL=FileUpload-447f007e.js.map
