...
const ENTRY_CSS = "./assets/index-8d4a258a.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-a927ce67.js').then(n => n.I),true?["./Index-a927ce67.js","./Index-882fff57.css"]:void 0,import.meta.url)).default;
  _res();
}
...
export { __vitePreload as _, prefix_css as a, get_fetchable_url_or_file as g, mount_css as m, prepare_files as p, upload as u };
//# sourceMappingURL=index-2e3ef8b2.js.map
