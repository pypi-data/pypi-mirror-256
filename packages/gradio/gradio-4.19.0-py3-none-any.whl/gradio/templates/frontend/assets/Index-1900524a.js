...
function create_key_block(ctx) {
	...
	function directoryexplorer_value_binding(value) {
		/*directoryexplorer_value_binding*/ ctx[19](value);
	}
	...
	directoryexplorer.$on("change", /*change_handler*/ ctx[20]);
...
// (29:0) <Block  {visible}  variant={value === null ? "dashed" : "solid"}  border_mode={"base"}  padding={false}  {elem_id}  {elem_classes}  {container}  {scale}  {min_width}  allow_overflow={false}  {height} >
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, rerender_key, file_count, interactive, server, value, gradio, show_label, label, loading_status*/ 2159025) {
...
//# sourceMappingURL=Index-1900524a.js.map
