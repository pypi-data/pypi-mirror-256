...
import { b as fly, B as Block } from './Button-816a5c8f.js';
import { B as BlockTitle } from './BlockTitle-76077052.js';
import { D as DropdownArrow } from './DropdownArrow-46fc40a2.js';
export { default as BaseExample } from './Example-84a3b179.js';
import './index-2e3ef8b2.js';
import './svelte/svelte.js';
import './Info-914ec0e6.js';
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function handle_key_down(e) {
		$$invalidate(12, [show_options, active_index] = handle_shared_keys(e, active_index, filtered_indices), show_options, (((((((((($$invalidate(14, active_index), $$invalidate(2, choices)), $$invalidate(23, old_choices)), $$invalidate(8, input_text)), $$invalidate(6, allow_custom_value)), $$invalidate(9, filtered_indices)), $$invalidate(25, old_input_text)), $$invalidate(10, selected_index)), $$invalidate(27, old_selected_index)), $$invalidate(26, initialized)), $$invalidate(24, choices_values)));
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*selected_index, old_selected_index, initialized, choices, choices_values*/ 218104836) {
			{
				if (selected_index !== old_selected_index && selected_index !== null && initialized) {
					$$invalidate(8, [input_text, value] = choices[selected_index], input_text, ((((($$invalidate(20, value), $$invalidate(10, selected_index)), $$invalidate(27, old_selected_index)), $$invalidate(26, initialized)), $$invalidate(2, choices)), $$invalidate(24, choices_values)));
					$$invalidate(27, old_selected_index = selected_index);
		...
		if ($$self.$$.dirty[0] & /*choices, old_choices, input_text, allow_custom_value, filtered_indices*/ 8389444) {
			{
		...
		if ($$self.$$.dirty[0] & /*input_text, old_input_text, choices, allow_custom_value, filtered_indices*/ 33555268) {
			{
...
//# sourceMappingURL=Index-7df8d524.js.map
