...
class ProductivityForecastElement(BaseModel):
    """
    Value for time window.  # noqa: E501
    """
    ...
    __properties = ["date_window", "productivity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductivityForecastElement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductivityForecastElement:
        """Create an instance of ProductivityForecastElement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductivityForecastElement.parse_obj(obj)

        _obj = ProductivityForecastElement.parse_obj({
