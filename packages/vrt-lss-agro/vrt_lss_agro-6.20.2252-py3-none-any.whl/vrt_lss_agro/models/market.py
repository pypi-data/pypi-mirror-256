...
class Market(BaseModel):
    """
    Market - allows you to buy and sell crops.   # noqa: E501
    """
    ...
    __properties = ["key", "contracts", "attributes"]
    ...
    def from_dict(cls, obj: dict) -> Market:
        ...
        _obj = Market.parse_obj({
            "key": obj.get("key"),
            "contracts": [Contract.from_dict(_item) for _item in obj.get("contracts")] if obj.get("contracts") is not None else None,
