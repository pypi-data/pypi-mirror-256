...
class CostForecastElement(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CostForecastElement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CostForecastElement:
        """Create an instance of CostForecastElement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CostForecastElement.parse_obj(obj)

        _obj = CostForecastElement.parse_obj({
