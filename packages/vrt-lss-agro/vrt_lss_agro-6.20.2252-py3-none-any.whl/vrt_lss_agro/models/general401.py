...
class General401(BaseModel):
    """
    401 Error details.  # noqa: E501
    """
    tracedata: Tracedata
    ...
    @classmethod
    def from_json(cls, json_str: str) -> General401:
        """Create an instance of General401 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> General401:
        """Create an instance of General401 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return General401.parse_obj(obj)

        _obj = General401.parse_obj({
