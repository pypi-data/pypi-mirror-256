...
class StockForecastElement(BaseModel):
    """
    Humidity forecast, ppm (‰).  # noqa: E501
    """
    ...
    __properties = ["date_window", "min_stock_days"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StockForecastElement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StockForecastElement:
        """Create an instance of StockForecastElement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StockForecastElement.parse_obj(obj)

        _obj = StockForecastElement.parse_obj({
