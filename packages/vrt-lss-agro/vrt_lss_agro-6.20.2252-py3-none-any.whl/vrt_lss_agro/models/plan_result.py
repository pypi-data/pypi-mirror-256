...
class PlanResult(BaseModel):
    """
    Planning result.  # noqa: E501
    """
    tracedata: Tracedata
    project: Annotated[List[Operation], Field(min_length=0, max_length=1000001)] = Field(description="Production plan. The sequence of work. ")
