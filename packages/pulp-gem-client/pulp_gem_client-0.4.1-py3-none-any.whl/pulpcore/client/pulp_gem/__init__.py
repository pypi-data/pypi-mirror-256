...
from pulpcore.client.pulp_gem.models.gem_gem_content import GemGemContent
...
from pulpcore.client.pulp_gem.models.gem_gem_remote_response_hidden_fields import GemGemRemoteResponseHiddenFields
