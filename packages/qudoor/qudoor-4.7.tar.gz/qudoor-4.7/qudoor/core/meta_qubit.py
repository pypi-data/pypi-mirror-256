...
class MetaQubit:
    ...
    def apply_gate_two_qbit(self, other, matrix):
        ...
        # Normaliser le qubit après l'application de la porte
        self.normalize()
    ...
    def mesure_qubit(self):
        warnings.warn("Warning this is a simulation with probability its not 100% 0 or 100% 1 lanch better than 1 your code to see what is th result")
        try:
