...
# TODO: Change types_defaults to a mapping, similar to the above registries
types_defaults: Optional["TypeDefaults"] = None
...
def register_backend_types_defaults(td: "TypeDefaults"):
    ...
    if (
        types_defaults
        and type(td).__name__ == "TypeDefaults"
        and type(types_defaults).__name__ != "TypeDefaults"
    ):
        # Ignore setting types_defaults back to the default if a more dialect-specific
