...
class AceEditorWidget(widgets.Textarea):
    ...
    def __init__(self, mode="ace/mode/django", theme="ace/theme/wagtail", use_frame_preview=True, frame_css=None, frame_js=None, attrs=None):
        attrs                       = attrs or {}
        self.mode                   = mode
        self.theme                  = theme
    ...
    def format_value(self, value: widgets.Any) -> str | None:
