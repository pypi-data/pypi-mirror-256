...
class Volume(object):
    ...
    def points(self):
        ...
        """
        return self.geom_resolver.resolve_vertices(self.cell_indices)
    ...
    def points_symbols(self):
        ...
        """
        return self.symbol_resolver.resolve_vertices(self.cell_indices)
    ...
    def boundary_points(self):
        ...
        """
        return self.geom_resolver.resolve_boundary_vertices(self.cell_indices)
    ...
    def boundary_points_symbols(self):
        ...
        Returns:
            ...
            in the form of the symbolic representation.
        """
        return self.symbol_resolver.resolve_boundary_vertices(self.cell_indices)
    ...
    def boundary(self, adjust_periodic_boundary=None):
        ...
        if adjust_periodic_boundary is None:
            return self.geom_resolver.resolve_boundary(self.cell_indices)
        else:
            return self.periodic_geom_resolver(adjust_periodic_boundary).resolve_boundary(self.cell_indices)
    ...
    def boundary_symbols(self):
        ...
        Returns:
            ...
            in the form of the symbolic representation.
        """
        return self.symbol_resolver.resolve_boundary(self.cell_indices)
    ...
    def cells(self, adjust_periodic_boundary=None):
        ...
        """
        if adjust_periodic_boundary is None:
            return self.geom_resolver.resolve_cells(self.cell_indices)
        else:
            return self.periodic_geom_resolver(adjust_periodic_boundary).resolve_cells(self.cell_indices)
    ...
    def simplices_symbols(self):
        ...
        Returns:
            ...
            in the form of the symbolic representation.
        """
        return self.symbol_resolver.resolve_cells(self.cell_indices)
    ...
    def restore_from_dict(cls, pd, data, validate=True):
        ...
        This class method should be called with a subclass of Volume, :class:`OptimalVolume`, :class:`StableVolume`, or :class:`StableSubvolume`, not Volume class.
        ...
        """
        if validate:
            cls.validate_restore_data(pd, data)
    ...
    def boundary_loop(self):
        ...
        """
        return self.geom_resolver.resolve_boundary_loop(self.cell_indices)
    ...
    def boundary_loop_symbols(self):
        ...
        Raises:
            ValueError: Raised if the dimension of the volume is not 2D,
              or if the loop is a self-loop or multi-edge loop.
        """
        return self.symbol_resolver.resolve_boundary_loop(self.cell_indices)
