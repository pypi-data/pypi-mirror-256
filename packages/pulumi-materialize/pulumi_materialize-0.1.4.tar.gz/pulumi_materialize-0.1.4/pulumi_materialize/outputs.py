...
class ConnectionConfluentSchemaRegistrySslCertificateAuthoritySecret(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str database_name: The identifier for the connection database. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        :param str schema_name: The identifier for the connection schema. Defaults to `public`.
        """
        pulumi.set(__self__, "name", name)
        if database_name is not None:
            pulumi.set(__self__, "database_name", database_name)
...
class SinkKafkaFormatAvroAvroDocColumn(dict):
    def __init__(__self__, *,
        ...
        """
        :param bool key: An optional list of columns to use for the Kafka key. If unspecified, the Kafka key is left unset.
        """
...
class SinkKafkaFormatAvroAvroDocColumnObject(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str database_name: The identifier for the sink database. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        :param str schema_name: The identifier for the sink schema. Defaults to `public`.
        """
        pulumi.set(__self__, "name", name)
        if database_name is not None:
            pulumi.set(__self__, "database_name", database_name)
...
class SourceKafkaFormatAvroSchemaRegistryConnection(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str database_name: The identifier for the source database. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        :param str schema_name: The identifier for the source schema. Defaults to `public`.
        """
        pulumi.set(__self__, "name", name)
        if database_name is not None:
            pulumi.set(__self__, "database_name", database_name)
...
class TableColumn(dict):
    def __init__(__self__, *,
        ...
        :param str comment: **Public Preview** Comment on an object in the database.
