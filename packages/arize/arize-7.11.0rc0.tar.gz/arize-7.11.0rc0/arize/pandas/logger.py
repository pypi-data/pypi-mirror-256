...
from .etl.errors import CastingError, InvalidSchemaFieldTypeError, InvalidTypedColumnsError
...
class Client:
    ...
    def log(
        ...
        if isinstance(schema, Schema) and schema.has_typed_columns():
            ...
            except (CastingError, InvalidSchemaFieldTypeError, InvalidTypedColumnsError) as e:
                logger.error(e)
                raise
