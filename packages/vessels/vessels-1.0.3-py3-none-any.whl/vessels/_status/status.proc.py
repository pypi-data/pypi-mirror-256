...
this_structure_name = "vessels"

this_folder = pathlib.Path (__file__).parent.resolve ()
places = str (normpath (join (this_folder, "../../../../places")))

this_structure = str (normpath (join (places, "structures", this_structure_name)))
...
scan = bracelet.start (
	...
	simultaneous = True,
	module_paths = [
		normpath (join (places, "structures")),
		normpath (join (places, "structures_pip"))
	],
