...
class RouteApi:
    ...
    def run_route_calculation(self, route_task : Annotated[RouteTask, Field(description="New request for route calculation.")], **kwargs) -> RouteResult:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the run_route_calculation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.run_route_calculation_with_http_info(route_task, **kwargs)  # noqa: E501

    @validate_arguments
    def run_route_calculation_with_http_info(self, route_task : Annotated[RouteTask, Field(description="New request for route calculation.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Route between points  # noqa: E501
        ...
        _body_params = None
        if _params['route_task'] is not None:
