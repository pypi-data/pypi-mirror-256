...
class TransactionsLinkProduct(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TransactionsLinkProduct from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TransactionsLinkProduct from a dict"""
        if obj is None:
            return None
