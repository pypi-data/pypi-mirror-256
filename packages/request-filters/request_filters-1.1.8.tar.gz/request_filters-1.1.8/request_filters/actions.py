...
def FILTER_ALLOWS_REQUEST(filter: "Filter", settings: "FilterSettings", request: HttpRequest, get_response):
    ...
    log(f"[Filter / {filter.action}] Allowing request {ipaddr} with {filter}", logging.INFO)
...
FILTER_LOGS_REQUEST = _FILTER_LOGS_REQUEST(logging.DEBUG, False)
FILTER_LOGS_REQUEST_ALLOW_NEXT = _FILTER_LOGS_REQUEST(logging.DEBUG, True)
