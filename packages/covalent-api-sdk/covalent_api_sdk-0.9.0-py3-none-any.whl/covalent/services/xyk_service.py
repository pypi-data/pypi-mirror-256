...
class PriceTimeseries:
    ...
    exchange: Optional[str]
    """ The pair address. """
    price_of_token0_in_token1: Optional[str]
    ...
    price_of_token1_in_token0: Optional[str]
    ...
    price_of_token0_in_quote_currency: Optional[str]
    price_of_token1_in_quote_currency: Optional[str]
...
class TokenV2Volume:
    ...
    def __init__(self, data):
        ...
        self.total_volume_24h = int(data["total_volume_24h"]) if "total_volume_24h" in data and data["total_volume_24h"] is not None else None
        self.logo_url = data["logo_url"] if "logo_url" in data and data["logo_url"] is not None else None
        self.contract_ticker_symbol = data["contract_ticker_symbol"] if "contract_ticker_symbol" in data and data["contract_ticker_symbol"] is not None else None
        self.contract_decimals = int(data["contract_decimals"]) if "contract_decimals" in data and data["contract_decimals"] is not None else None
...
class ExchangeTransaction:
    ...
    amount_0_in: Optional[int]
    amount_0_out: Optional[int]
    amount_1_in: Optional[int]
    amount_1_out: Optional[int]
    ...
    def __init__(self, data):
        ...
        self.amount_0 = int(data["amount_0"]) if "amount_0" in data and data["amount_0"] is not None else None
        self.amount_1 = int(data["amount_1"]) if "amount_1" in data and data["amount_1"] is not None else None
        self.amount_0_in = int(data["amount_0_in"]) if "amount_0_in" in data and data["amount_0_in"] is not None else None
        self.amount_0_out = int(data["amount_0_out"]) if "amount_0_out" in data and data["amount_0_out"] is not None else None
        self.amount_1_in = int(data["amount_1_in"]) if "amount_1_in" in data and data["amount_1_in"] is not None else None
        self.amount_1_out = int(data["amount_1_out"]) if "amount_1_out" in data and data["amount_1_out"] is not None else None
