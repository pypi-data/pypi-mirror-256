...
class PATH_FACADE:
    ...
    @staticmethod
    def SERVICE_PATH(service_name: str) -> str:
    ...
    class DITRIBUTIVE:
        ...
        MODULE_FOLDER_NAME: str = "all"
        
        @staticmethod
        def NAME(value: str) -> str:
            return j((ROOT_MODULE_NAME, value), "-")
        ...
        @staticmethod
        def MODULE(name: str, version: str | None) -> str:
            def wheel_name(name: str, version: str) -> str:
                ...
                dist_name: str = bdist_wheel_cmd.wheel_dist_name
                tag: str = "-".join(bdist_wheel_cmd.get_tag())
                return j((dist_name, "-", tag, ".whl"))

            return os.path.join(
                PATH_FACADE.DITRIBUTIVE.VALUE(),
                PATH_FACADE.DITRIBUTIVE.MODULE_FOLDER_NAME,
                name,
                wheel_name(
    ...
    class VIRTUAL_ENVIRONMENT:
        ...
        NAME: str = ".venv"
        FOLDER: str = j((NAME, PATH_SPLITTER, "Scripts", PATH_SPLITTER))

        @staticmethod
        def VALUE():
            return os.path.join(
                PATH_FACADE.VALUE, PATH_FACADE.VIRTUAL_ENVIRONMENT.FOLDER
            )
...
class PATH_WS_816_SCAN:
    NAME: str = "Scans"
    VALUE: str = j((PATH_DOUBLE_SPLITTER, os.path.join(Hosts.WS816.NAME, NAME)))
