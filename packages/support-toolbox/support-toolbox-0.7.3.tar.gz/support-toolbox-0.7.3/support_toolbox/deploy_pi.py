...
import os
import configparser
from support_toolbox.utils.api_url_manager import get_api_url_location
from support_toolbox.utils.api.user import get_agent_id, add_support
...
from support_toolbox.utils.api.org import authorize_access_to_org, deauthorize_access_to_org, validate_org_input
from support_toolbox.deploy_ctk import deploy_ctk, CTK_STACK
from support_toolbox.utils.api.entitlements import update_org_entitlements, get_entitlements, get_default_values, update_default_plan, ORG_DEFAULT_ENTITLEMENTS, USER_DEFAULT_ENTITLEMENTS
from support_toolbox.utils.api.site import create_site, SAML_PLACEHOLDER
from support_toolbox.utils.api.service_account import deploy_service_accounts
from support_toolbox.utils.metrics import deploy_metrics
from support_toolbox.utils.api.project import setup_implementation_project
...
def run():
    ...
    while True:
        ...
        if selection == 'y':
            ...
            print(f"\n{preview_url} will deploy with the following placeholder SAML values, be sure to update SAML once you have the SAML.xml file from the customer: ")
