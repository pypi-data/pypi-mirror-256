...
for i in range(6):
    ...
    if (save_png == 1): plt.savefig(dir_output + 'Orbital_Texture' + l_orb + '.png', dpi = 600, bbox_inches='tight', pad_inches = 0)
    if (save_pdf == 1): plt.savefig(dir_output + 'Orbital_Texture' + l_orb + '.pdf', dpi = 600, bbox_inches='tight', pad_inches = 0)
    if (save_eps == 1): plt.savefig(dir_output + 'Orbital_Texture' + l_orb + '.eps', dpi = 600, bbox_inches='tight', pad_inches = 0)
    if (save_svg == 1): plt.savefig(dir_output + 'Orbital_Texture' + l_orb + '.svg', dpi = 600, bbox_inches='tight', pad_inches = 0)
