...
for i in range (1,(6+1)):
    ...
    for b in range(n_band_f - n_band_i + 1):
        ...
        if (save_png == 1): plt.savefig(dir_output + 'Spin_Texture_Contour_' + rotulo + '.png', dpi = 600, bbox_inches='tight', pad_inches=0)
        if (save_pdf == 1): plt.savefig(dir_output + 'Spin_Texture_Contour_' + rotulo + '.pdf', dpi = 600, bbox_inches='tight', pad_inches=0)
        if (save_svg == 1): plt.savefig(dir_output + 'Spin_Texture_Contour_' + rotulo + '.svg', dpi = 600, bbox_inches='tight', pad_inches=0)
        if (save_eps == 1): plt.savefig(dir_output + 'Spin_Texture_Contour_' + rotulo + '.eps', dpi = 600, bbox_inches='tight', pad_inches=0)
