...
class Files(Resources):
    def upload(self, path: str, timeout: int = 60):
        ...
        begin_upload_request = BeginUploadRequest(file_name, file_size, force_overwrite=False)
        ...
        complete_upload_request = CompleteUploadRequest(file_id, upload_id, etags, force_overwrite=False)
