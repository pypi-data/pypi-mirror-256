...
setup(
  name = 'invoice-creator',   #* Your package will have this name
  ...
  description = 'This package can be used to convert Excel invoices to PDF invoices using parameters supplied by the user.',    # Short description of your library
  author = 'Daniel Updike',                   # Your name
  author_email = 'pydevops487@gmail.com',  # Your email
  url = 'https://github.com/naivar68/app22-python-package',              # Homepage of your library (e.g. github or your website)
