    ...
    def init_app(self, app, intercept_errors: Optional[bool] = True, add_current_user: bool = True, **kwargs):
        ...
        if intercept_errors:
            ...
            def handle_exception(error):
                ...
                if visited_urls:
                    error_text += f"<br><strong style='font-size:larger'>Last Visited URLs</strong>:<br>{' - '.join(visited_urls)}<br>"
            ...
            def wrapper(*func_args, **func_kwargs):
                ...
                try:
                    ...
                    if not send_success and send_to_db:
                        self.send_success_email(success_recipients, task_id=task_id, update_db_only=True, **kwargs)
                except Exception as e:
