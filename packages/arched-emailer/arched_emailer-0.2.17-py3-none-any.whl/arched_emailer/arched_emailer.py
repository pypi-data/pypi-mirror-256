...
class ArchedEmailer:
    ...
    def init_app(self, app, intercept_errors: Optional[bool] = True, **kwargs):
        """
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments for the `init_app` method.
        ...
        if intercept_errors:
            ...
            def handle_exception(error):
                ...
                if self.current_user:
                    email = getattr(self.current_user, "email", None)
                    name = getattr(self.current_user, "name", None)
