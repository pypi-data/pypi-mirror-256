...
class ArchedEmailer:
    ...
    def _get_set_user_details(self):
        ...
        try:
            ...
            if data[2] == 200 and data[1]:
                ...
                raise ValueError("Server did not respond with user details, either API_KEY is invalid or server is down.")
    ...
    def try_log_function(self, error_recipients: Union[str, list], send_success: Optional[bool] = False,
                         success_recipients: Optional[Union[str, list]] = None, update_db=True, allowed_minutes=60,
        ...
        Args:
            ...
            update_db (bool): A boolean value indicating whether to update the database with the email attempt. Default is True.
