...
from trosnoth.messages import (
    ...
    ConnectionLostMsg, EmoteRequestMsg,
...
class GameScene(PandaScene):
    ...
    def uiTick(self, task):
        ...
        self.tweenFraction = self.gameInterface.game.tweener.ui_tick(deltaT)
        return Task.cont
...
class StatusBarOverlay(Watcher):
    ...
    def updateReloadGauge(self):
        ...
        elif player.guns.reload_time > 0:
            ratio = 1 - player.guns.reload_time / (player.guns.reload_from + 0.)
...
class PlayerInputResponder(DirectObject):
    ...
    def update(self, task):
        ...
        if self.shooting and self.player.can_shoot():
            self.fireOneShot()
    ...
    def updateMouseAngle(self, target):
        ...
        self.sendRequest(AimPlayerAtMsg(theta, thrust))
