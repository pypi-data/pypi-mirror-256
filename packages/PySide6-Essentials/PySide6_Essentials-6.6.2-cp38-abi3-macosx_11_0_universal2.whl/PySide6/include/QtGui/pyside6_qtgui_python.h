...
enum : int {
    ...
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 464,
    ...
    SBK_QRHIMETALINITPARAMS_IDX                              = 295,
    SBK_QRHINATIVEHANDLES_IDX                                = 296,
    SBK_QRHINULLINITPARAMS_IDX                               = 297,
    SBK_QRHIREADBACKDESCRIPTION_IDX                          = 298,
    SBK_QRHIREADBACKRESULT_IDX                               = 299,
    SBK_QRHIRENDERBUFFER_TYPE_IDX                            = 302,
    SBK_QRHIRENDERBUFFER_FLAG_IDX                            = 301,
    SBK_QFLAGS_QRHIRENDERBUFFER_FLAG_IDX                     = 93,
    SBK_QRHIRENDERBUFFER_IDX                                 = 300,
    SBK_QRHIRENDERPASSDESCRIPTOR_IDX                         = 303,
    SBK_QRHIRENDERTARGET_IDX                                 = 304,
    SBK_QRHIRESOURCE_TYPE_IDX                                = 306,
    SBK_QRHIRESOURCE_IDX                                     = 305,
    SBK_QRHIRESOURCEUPDATEBATCH_IDX                          = 307,
    SBK_QRHISAMPLER_FILTER_IDX                               = 311,
    SBK_QRHISAMPLER_ADDRESSMODE_IDX                          = 309,
    SBK_QRHISAMPLER_COMPAREOP_IDX                            = 310,
    SBK_QRHISAMPLER_IDX                                      = 308,
    SBK_QRHISCISSOR_IDX                                      = 312,
    SBK_QRHISHADERRESOURCEBINDING_TYPE_IDX                   = 319,
    SBK_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX              = 317,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX       = 94,
    SBK_QRHISHADERRESOURCEBINDING_IDX                        = 313,
    SBK_QRHISHADERRESOURCEBINDING_DATA_IDX                   = 314,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEBUFFERDATA_IDX = 315,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEIMAGEDATA_IDX  = 316,
    SBK_QRHISHADERRESOURCEBINDING_TEXTUREANDSAMPLER_IDX      = 318,
    SBK_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX            = 321,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX     = 95,
    SBK_QRHISHADERRESOURCEBINDINGS_IDX                       = 320,
    SBK_QRHISHADERSTAGE_TYPE_IDX                             = 323,
    SBK_QRHISHADERSTAGE_IDX                                  = 322,
    SBK_QRHISTATS_IDX                                        = 324,
    SBK_QRHISWAPCHAIN_FLAG_IDX                               = 326,
    SBK_QFLAGS_QRHISWAPCHAIN_FLAG_IDX                        = 96,
    SBK_QRHISWAPCHAIN_FORMAT_IDX                             = 327,
    SBK_QRHISWAPCHAIN_STEREOTARGETBUFFER_IDX                 = 328,
    SBK_QRHISWAPCHAIN_IDX                                    = 325,
    SBK_QRHISWAPCHAINRENDERTARGET_IDX                        = 329,
    SBK_QRHITEXTURE_FLAG_IDX                                 = 331,
    SBK_QFLAGS_QRHITEXTURE_FLAG_IDX                          = 97,
    SBK_QRHITEXTURE_FORMAT_IDX                               = 332,
    SBK_QRHITEXTURE_IDX                                      = 330,
    SBK_QRHITEXTURECOPYDESCRIPTION_IDX                       = 333,
    SBK_QRHITEXTURERENDERTARGET_FLAG_IDX                     = 335,
    SBK_QFLAGS_QRHITEXTURERENDERTARGET_FLAG_IDX              = 98,
    SBK_QRHITEXTURERENDERTARGET_IDX                          = 334,
    SBK_QRHITEXTURERENDERTARGETDESCRIPTION_IDX               = 336,
    SBK_QRHITEXTURESUBRESOURCEUPLOADDESCRIPTION_IDX          = 337,
    SBK_QRHITEXTUREUPLOADDESCRIPTION_IDX                     = 338,
    SBK_QRHITEXTUREUPLOADENTRY_IDX                           = 339,
    SBK_QRHIVERTEXINPUTATTRIBUTE_FORMAT_IDX                  = 341,
    SBK_QRHIVERTEXINPUTATTRIBUTE_IDX                         = 340,
    SBK_QRHIVERTEXINPUTBINDING_CLASSIFICATION_IDX            = 343,
    SBK_QRHIVERTEXINPUTBINDING_IDX                           = 342,
    SBK_QRHIVERTEXINPUTLAYOUT_IDX                            = 344,
    SBK_QRHIVIEWPORT_IDX                                     = 345,
    SBK_QSCREEN_IDX                                          = 346,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 348,
    SBK_QSCROLLEVENT_IDX                                     = 347,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 349,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 351,
    SBK_QSESSIONMANAGER_IDX                                  = 350,
    SBK_QSHADER_STAGE_IDX                                    = 355,
    SBK_QSHADER_SOURCE_IDX                                   = 354,
    SBK_QSHADER_VARIANT_IDX                                  = 356,
    SBK_QSHADER_SERIALIZEDFORMATVERSION_IDX                  = 353,
    SBK_QSHADER_IDX                                          = 352,
    SBK_QSHADERCODE_IDX                                      = 357,
    SBK_QSHADERKEY_IDX                                       = 358,
    SBK_QSHADERVERSION_FLAG_IDX                              = 360,
    SBK_QFLAGS_QSHADERVERSION_FLAG_IDX                       = 99,
    SBK_QSHADERVERSION_IDX                                   = 359,
    SBK_QSHORTCUT_IDX                                        = 361,
    SBK_QSHORTCUTEVENT_IDX                                   = 362,
    SBK_QSHOWEVENT_IDX                                       = 363,
    SBK_QSINGLEPOINTEVENT_IDX                                = 364,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 366,
    SBK_QSTANDARDITEM_IDX                                    = 365,
    SBK_QSTANDARDITEMMODEL_IDX                               = 367,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 369,
    SBK_QSTATICTEXT_IDX                                      = 368,
    SBK_QSTATUSTIPEVENT_IDX                                  = 370,
    SBK_QSTYLEHINTS_IDX                                      = 371,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 373,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 374,
    SBK_QSURFACE_IDX                                         = 372,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 377,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 100,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 380,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 379,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 378,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 376,
    SBK_QSURFACEFORMAT_IDX                                   = 375,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 381,
    SBK_QTABLETEVENT_IDX                                     = 382,
    SBK_QTEXTBLOCK_IDX                                       = 383,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 384,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 465,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 386,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 385,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 387,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 388,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 392,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 391,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 390,
    SBK_QTEXTCHARFORMAT_IDX                                  = 389,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 394,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 395,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 396,
    SBK_QTEXTCURSOR_IDX                                      = 393,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 400,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 399,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 102,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 398,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 101,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 401,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 402,
    SBK_QTEXTDOCUMENT_IDX                                    = 397,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 403,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 404,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 406,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 409,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 407,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 408,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 103,
    SBK_QTEXTFORMAT_IDX                                      = 405,
    SBK_QTEXTFRAGMENT_IDX                                    = 410,
    SBK_QTEXTFRAME_IDX                                       = 411,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 412,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 415,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 414,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 413,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 416,
    SBK_QTEXTINLINEOBJECT_IDX                                = 417,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 419,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 104,
    SBK_QTEXTITEM_IDX                                        = 418,
    SBK_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX                = 423,
    SBK_QFLAGS_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX         = 105,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 421,
    SBK_QTEXTLAYOUT_IDX                                      = 420,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 422,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 425,
    SBK_QTEXTLENGTH_IDX                                      = 424,
    SBK_QTEXTLINE_EDGE_IDX                                   = 428,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 427,
    SBK_QTEXTLINE_IDX                                        = 426,
    SBK_QTEXTLIST_IDX                                        = 429,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 431,
    SBK_QTEXTLISTFORMAT_IDX                                  = 430,
    SBK_QTEXTOBJECT_IDX                                      = 432,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 433,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 437,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 438,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 435,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 106,
    SBK_QTEXTOPTION_IDX                                      = 434,
    SBK_QTEXTOPTION_TAB_IDX                                  = 436,
    SBK_QTEXTTABLE_IDX                                       = 439,
    SBK_QTEXTTABLECELL_IDX                                   = 440,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 441,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 442,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 443,
    SBK_QTOUCHEVENT_IDX                                      = 444,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 446,
    SBK_QTRANSFORM_IDX                                       = 445,
    SBK_QUNDOCOMMAND_IDX                                     = 447,
    SBK_QUNDOGROUP_IDX                                       = 448,
    SBK_QUNDOSTACK_IDX                                       = 449,
    SBK_QVALIDATOR_STATE_IDX                                 = 451,
    SBK_QVALIDATOR_IDX                                       = 450,
    SBK_QVECTOR2D_IDX                                        = 452,
    SBK_QVECTOR3D_IDX                                        = 453,
    SBK_QVECTOR4D_IDX                                        = 454,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 455,
    SBK_QWHEELEVENT_IDX                                      = 456,
    SBK_QWINDOW_VISIBILITY_IDX                               = 459,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 458,
    SBK_QWINDOW_IDX                                          = 457,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 460,
    SBK_QtGuiQT_IDX                                          = 461,
    SBK_QTGUIHELPER_QOVERRIDECURSORGUARD_IDX                 = 463,
    SBK_QtGui_IDX_COUNT                                      = 466
};
...
enum : int {
    ...
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 65, // QHash<int,QByteArray>
    SBK_QTGUI_QLIST_QVARIANT_IDX                             = 66, // QList<QVariant>
    SBK_QTGUI_QLIST_QSTRING_IDX                              = 67, // QList<QString>
    SBK_QTGUI_QMAP_QSTRING_QVARIANT_IDX                      = 68, // QMap<QString,QVariant>
    SBK_QtGui_CONVERTERS_IDX_COUNT                           = 69
};
