...
enum : int {
    ...
    SBK_QRUBBERBAND_SHAPE_IDX                                = 244,
    SBK_QRUBBERBAND_IDX                                      = 243,
    SBK_QSCROLLAREA_IDX                                      = 245,
    SBK_QSCROLLBAR_IDX                                       = 246,
    SBK_QSCROLLER_STATE_IDX                                  = 250,
    SBK_QSCROLLER_SCROLLERGESTURETYPE_IDX                    = 249,
    SBK_QSCROLLER_INPUT_IDX                                  = 248,
    SBK_QSCROLLER_IDX                                        = 247,
    SBK_QSCROLLERPROPERTIES_OVERSHOOTPOLICY_IDX              = 253,
    SBK_QSCROLLERPROPERTIES_FRAMERATES_IDX                   = 252,
    SBK_QSCROLLERPROPERTIES_SCROLLMETRIC_IDX                 = 254,
    SBK_QSCROLLERPROPERTIES_IDX                              = 251,
    SBK_QSIZEGRIP_IDX                                        = 255,
    SBK_QSIZEPOLICY_POLICYFLAG_IDX                           = 259,
    SBK_QSIZEPOLICY_POLICY_IDX                               = 258,
    SBK_QSIZEPOLICY_CONTROLTYPE_IDX                          = 257,
    SBK_QFLAGS_QSIZEPOLICY_CONTROLTYPE_IDX                   = 96,
    SBK_QSIZEPOLICY_IDX                                      = 256,
    SBK_QSLIDER_TICKPOSITION_IDX                             = 261,
    SBK_QSLIDER_IDX                                          = 260,
    SBK_QSPACERITEM_IDX                                      = 262,
    SBK_QSPINBOX_IDX                                         = 263,
    SBK_QSPLASHSCREEN_IDX                                    = 264,
    SBK_QSPLITTER_IDX                                        = 265,
    SBK_QSPLITTERHANDLE_IDX                                  = 266,
    SBK_QSTACKEDLAYOUT_STACKINGMODE_IDX                      = 268,
    SBK_QSTACKEDLAYOUT_IDX                                   = 267,
    SBK_QSTACKEDWIDGET_IDX                                   = 269,
    SBK_QSTATUSBAR_IDX                                       = 270,
    SBK_QSTYLE_STATEFLAG_IDX                                 = 279,
    SBK_QFLAGS_QSTYLE_STATEFLAG_IDX                          = 97,
    SBK_QSTYLE_PRIMITIVEELEMENT_IDX                          = 276,
    SBK_QSTYLE_CONTROLELEMENT_IDX                            = 274,
    SBK_QSTYLE_SUBELEMENT_IDX                                = 282,
    SBK_QSTYLE_COMPLEXCONTROL_IDX                            = 272,
    SBK_QSTYLE_SUBCONTROL_IDX                                = 281,
    SBK_QFLAGS_QSTYLE_SUBCONTROL_IDX                         = 98,
    SBK_QSTYLE_PIXELMETRIC_IDX                               = 275,
    SBK_QSTYLE_CONTENTSTYPE_IDX                              = 273,
    SBK_QSTYLE_REQUESTSOFTWAREINPUTPANEL_IDX                 = 277,
    SBK_QSTYLE_STYLEHINT_IDX                                 = 280,
    SBK_QSTYLE_STANDARDPIXMAP_IDX                            = 278,
    SBK_QSTYLE_IDX                                           = 271,
    SBK_QSTYLEFACTORY_IDX                                    = 283,
    SBK_QSTYLEHINTRETURN_HINTRETURNTYPE_IDX                  = 285,
    SBK_QSTYLEHINTRETURN_STYLEOPTIONTYPE_IDX                 = 286,
    SBK_QSTYLEHINTRETURN_STYLEOPTIONVERSION_IDX              = 287,
    SBK_QSTYLEHINTRETURN_IDX                                 = 284,
    SBK_QSTYLEHINTRETURNMASK_STYLEOPTIONTYPE_IDX             = 289,
    SBK_QSTYLEHINTRETURNMASK_STYLEOPTIONVERSION_IDX          = 290,
    SBK_QSTYLEHINTRETURNMASK_IDX                             = 288,
    SBK_QSTYLEHINTRETURNVARIANT_STYLEOPTIONTYPE_IDX          = 292,
    SBK_QSTYLEHINTRETURNVARIANT_STYLEOPTIONVERSION_IDX       = 293,
    SBK_QSTYLEHINTRETURNVARIANT_IDX                          = 291,
    SBK_QSTYLEOPTION_OPTIONTYPE_IDX                          = 295,
    SBK_QSTYLEOPTION_STYLEOPTIONTYPE_IDX                     = 296,
    SBK_QSTYLEOPTION_STYLEOPTIONVERSION_IDX                  = 297,
    SBK_QSTYLEOPTION_IDX                                     = 294,
    SBK_QSTYLEOPTIONBUTTON_STYLEOPTIONTYPE_IDX               = 300,
    SBK_QSTYLEOPTIONBUTTON_STYLEOPTIONVERSION_IDX            = 301,
    SBK_QSTYLEOPTIONBUTTON_BUTTONFEATURE_IDX                 = 299,
    SBK_QFLAGS_QSTYLEOPTIONBUTTON_BUTTONFEATURE_IDX          = 99,
    SBK_QSTYLEOPTIONBUTTON_IDX                               = 298,
    SBK_QSTYLEOPTIONCOMBOBOX_STYLEOPTIONTYPE_IDX             = 303,
    SBK_QSTYLEOPTIONCOMBOBOX_STYLEOPTIONVERSION_IDX          = 304,
    SBK_QSTYLEOPTIONCOMBOBOX_IDX                             = 302,
    SBK_QSTYLEOPTIONCOMPLEX_STYLEOPTIONTYPE_IDX              = 306,
    SBK_QSTYLEOPTIONCOMPLEX_STYLEOPTIONVERSION_IDX           = 307,
    SBK_QSTYLEOPTIONCOMPLEX_IDX                              = 305,
    SBK_QSTYLEOPTIONDOCKWIDGET_STYLEOPTIONTYPE_IDX           = 309,
    SBK_QSTYLEOPTIONDOCKWIDGET_STYLEOPTIONVERSION_IDX        = 310,
    SBK_QSTYLEOPTIONDOCKWIDGET_IDX                           = 308,
    SBK_QSTYLEOPTIONFOCUSRECT_STYLEOPTIONTYPE_IDX            = 312,
    SBK_QSTYLEOPTIONFOCUSRECT_STYLEOPTIONVERSION_IDX         = 313,
    SBK_QSTYLEOPTIONFOCUSRECT_IDX                            = 311,
    SBK_QSTYLEOPTIONFRAME_STYLEOPTIONTYPE_IDX                = 316,
    SBK_QSTYLEOPTIONFRAME_STYLEOPTIONVERSION_IDX             = 317,
    SBK_QSTYLEOPTIONFRAME_FRAMEFEATURE_IDX                   = 315,
    SBK_QFLAGS_QSTYLEOPTIONFRAME_FRAMEFEATURE_IDX            = 100,
    SBK_QSTYLEOPTIONFRAME_IDX                                = 314,
    SBK_QSTYLEOPTIONGRAPHICSITEM_STYLEOPTIONTYPE_IDX         = 319,
    SBK_QSTYLEOPTIONGRAPHICSITEM_STYLEOPTIONVERSION_IDX      = 320,
    SBK_QSTYLEOPTIONGRAPHICSITEM_IDX                         = 318,
    SBK_QSTYLEOPTIONGROUPBOX_STYLEOPTIONTYPE_IDX             = 322,
    SBK_QSTYLEOPTIONGROUPBOX_STYLEOPTIONVERSION_IDX          = 323,
    SBK_QSTYLEOPTIONGROUPBOX_IDX                             = 321,
    SBK_QSTYLEOPTIONHEADER_STYLEOPTIONTYPE_IDX               = 328,
    SBK_QSTYLEOPTIONHEADER_STYLEOPTIONVERSION_IDX            = 329,
    SBK_QSTYLEOPTIONHEADER_SECTIONPOSITION_IDX               = 325,
    SBK_QSTYLEOPTIONHEADER_SELECTEDPOSITION_IDX              = 326,
    SBK_QSTYLEOPTIONHEADER_SORTINDICATOR_IDX                 = 327,
    SBK_QSTYLEOPTIONHEADER_IDX                               = 324,
    SBK_QSTYLEOPTIONHEADERV2_STYLEOPTIONTYPE_IDX             = 331,
    SBK_QSTYLEOPTIONHEADERV2_STYLEOPTIONVERSION_IDX          = 332,
    SBK_QSTYLEOPTIONHEADERV2_IDX                             = 330,
    SBK_QSTYLEOPTIONMENUITEM_STYLEOPTIONTYPE_IDX             = 336,
    SBK_QSTYLEOPTIONMENUITEM_STYLEOPTIONVERSION_IDX          = 337,
    SBK_QSTYLEOPTIONMENUITEM_MENUITEMTYPE_IDX                = 335,
    SBK_QSTYLEOPTIONMENUITEM_CHECKTYPE_IDX                   = 334,
    SBK_QSTYLEOPTIONMENUITEM_IDX                             = 333,
    SBK_QSTYLEOPTIONPROGRESSBAR_STYLEOPTIONTYPE_IDX          = 339,
    SBK_QSTYLEOPTIONPROGRESSBAR_STYLEOPTIONVERSION_IDX       = 340,
    SBK_QSTYLEOPTIONPROGRESSBAR_IDX                          = 338,
    SBK_QSTYLEOPTIONRUBBERBAND_STYLEOPTIONTYPE_IDX           = 342,
    SBK_QSTYLEOPTIONRUBBERBAND_STYLEOPTIONVERSION_IDX        = 343,
    SBK_QSTYLEOPTIONRUBBERBAND_IDX                           = 341,
    SBK_QSTYLEOPTIONSIZEGRIP_STYLEOPTIONTYPE_IDX             = 345,
    SBK_QSTYLEOPTIONSIZEGRIP_STYLEOPTIONVERSION_IDX          = 346,
    SBK_QSTYLEOPTIONSIZEGRIP_IDX                             = 344,
    SBK_QSTYLEOPTIONSLIDER_STYLEOPTIONTYPE_IDX               = 348,
    SBK_QSTYLEOPTIONSLIDER_STYLEOPTIONVERSION_IDX            = 349,
    SBK_QSTYLEOPTIONSLIDER_IDX                               = 347,
    SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX              = 351,
    SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX           = 352,
    SBK_QSTYLEOPTIONSPINBOX_IDX                              = 350,
    SBK_QSTYLEOPTIONTAB_STYLEOPTIONTYPE_IDX                  = 356,
    SBK_QSTYLEOPTIONTAB_STYLEOPTIONVERSION_IDX               = 357,
    SBK_QSTYLEOPTIONTAB_TABPOSITION_IDX                      = 359,
    SBK_QSTYLEOPTIONTAB_SELECTEDPOSITION_IDX                 = 355,
    SBK_QSTYLEOPTIONTAB_CORNERWIDGET_IDX                     = 354,
    SBK_QFLAGS_QSTYLEOPTIONTAB_CORNERWIDGET_IDX              = 101,
    SBK_QSTYLEOPTIONTAB_TABFEATURE_IDX                       = 358,
    SBK_QFLAGS_QSTYLEOPTIONTAB_TABFEATURE_IDX                = 102,
    SBK_QSTYLEOPTIONTAB_IDX                                  = 353,
    SBK_QSTYLEOPTIONTABBARBASE_STYLEOPTIONTYPE_IDX           = 361,
    SBK_QSTYLEOPTIONTABBARBASE_STYLEOPTIONVERSION_IDX        = 362,
    SBK_QSTYLEOPTIONTABBARBASE_IDX                           = 360,
    SBK_QSTYLEOPTIONTABWIDGETFRAME_STYLEOPTIONTYPE_IDX       = 364,
    SBK_QSTYLEOPTIONTABWIDGETFRAME_STYLEOPTIONVERSION_IDX    = 365,
    SBK_QSTYLEOPTIONTABWIDGETFRAME_IDX                       = 363,
    SBK_QSTYLEOPTIONTITLEBAR_STYLEOPTIONTYPE_IDX             = 367,
    SBK_QSTYLEOPTIONTITLEBAR_STYLEOPTIONVERSION_IDX          = 368,
    SBK_QSTYLEOPTIONTITLEBAR_IDX                             = 366,
    SBK_QSTYLEOPTIONTOOLBAR_STYLEOPTIONTYPE_IDX              = 370,
    SBK_QSTYLEOPTIONTOOLBAR_STYLEOPTIONVERSION_IDX           = 371,
    SBK_QSTYLEOPTIONTOOLBAR_TOOLBARPOSITION_IDX              = 373,
    SBK_QSTYLEOPTIONTOOLBAR_TOOLBARFEATURE_IDX               = 372,
    SBK_QFLAGS_QSTYLEOPTIONTOOLBAR_TOOLBARFEATURE_IDX        = 103,
    SBK_QSTYLEOPTIONTOOLBAR_IDX                              = 369,
    SBK_QSTYLEOPTIONTOOLBOX_STYLEOPTIONTYPE_IDX              = 376,
    SBK_QSTYLEOPTIONTOOLBOX_STYLEOPTIONVERSION_IDX           = 377,
    SBK_QSTYLEOPTIONTOOLBOX_TABPOSITION_IDX                  = 378,
    SBK_QSTYLEOPTIONTOOLBOX_SELECTEDPOSITION_IDX             = 375,
    SBK_QSTYLEOPTIONTOOLBOX_IDX                              = 374,
    SBK_QSTYLEOPTIONTOOLBUTTON_STYLEOPTIONTYPE_IDX           = 380,
    SBK_QSTYLEOPTIONTOOLBUTTON_STYLEOPTIONVERSION_IDX        = 381,
    SBK_QSTYLEOPTIONTOOLBUTTON_TOOLBUTTONFEATURE_IDX         = 382,
    SBK_QFLAGS_QSTYLEOPTIONTOOLBUTTON_TOOLBUTTONFEATURE_IDX  = 104,
    SBK_QSTYLEOPTIONTOOLBUTTON_IDX                           = 379,
    SBK_QSTYLEOPTIONVIEWITEM_STYLEOPTIONTYPE_IDX             = 385,
    SBK_QSTYLEOPTIONVIEWITEM_STYLEOPTIONVERSION_IDX          = 386,
    SBK_QSTYLEOPTIONVIEWITEM_POSITION_IDX                    = 384,
    SBK_QSTYLEOPTIONVIEWITEM_VIEWITEMFEATURE_IDX             = 387,
    SBK_QFLAGS_QSTYLEOPTIONVIEWITEM_VIEWITEMFEATURE_IDX      = 105,
    SBK_QSTYLEOPTIONVIEWITEM_VIEWITEMPOSITION_IDX            = 388,
    SBK_QSTYLEOPTIONVIEWITEM_IDX                             = 383,
    SBK_QSTYLEPAINTER_IDX                                    = 389,
    SBK_QSTYLEDITEMDELEGATE_IDX                              = 390,
    SBK_QSWIPEGESTURE_SWIPEDIRECTION_IDX                     = 392,
    SBK_QSWIPEGESTURE_IDX                                    = 391,
    SBK_QSYSTEMTRAYICON_ACTIVATIONREASON_IDX                 = 394,
    SBK_QSYSTEMTRAYICON_MESSAGEICON_IDX                      = 395,
    SBK_QSYSTEMTRAYICON_IDX                                  = 393,
    SBK_QTABBAR_SHAPE_IDX                                    = 399,
    SBK_QTABBAR_BUTTONPOSITION_IDX                           = 397,
    SBK_QTABBAR_SELECTIONBEHAVIOR_IDX                        = 398,
    SBK_QTABBAR_IDX                                          = 396,
    SBK_QTABWIDGET_TABPOSITION_IDX                           = 401,
    SBK_QTABWIDGET_TABSHAPE_IDX                              = 402,
    SBK_QTABWIDGET_IDX                                       = 400,
    SBK_QTABLEVIEW_IDX                                       = 403,
    SBK_QTABLEWIDGET_IDX                                     = 404,
    SBK_QTABLEWIDGETITEM_ITEMTYPE_IDX                        = 406,
    SBK_QTABLEWIDGETITEM_IDX                                 = 405,
    SBK_QTABLEWIDGETSELECTIONRANGE_IDX                       = 407,
    SBK_QTAPANDHOLDGESTURE_IDX                               = 408,
    SBK_QTAPGESTURE_IDX                                      = 409,
    SBK_QTEXTBROWSER_IDX                                     = 410,
    SBK_QTEXTEDIT_LINEWRAPMODE_IDX                           = 414,
    SBK_QTEXTEDIT_AUTOFORMATTINGFLAG_IDX                     = 412,
    SBK_QFLAGS_QTEXTEDIT_AUTOFORMATTINGFLAG_IDX              = 106,
    SBK_QTEXTEDIT_IDX                                        = 411,
    SBK_QTEXTEDIT_EXTRASELECTION_IDX                         = 413,
    SBK_QTILERULES_IDX                                       = 415,
    SBK_QTIMEEDIT_IDX                                        = 416,
    SBK_QTOOLBAR_IDX                                         = 417,
    SBK_QTOOLBOX_IDX                                         = 418,
    SBK_QTOOLBUTTON_TOOLBUTTONPOPUPMODE_IDX                  = 420,
    SBK_QTOOLBUTTON_IDX                                      = 419,
    SBK_QTOOLTIP_IDX                                         = 421,
    SBK_QTREEVIEW_IDX                                        = 422,
    SBK_QTREEWIDGET_IDX                                      = 423,
    SBK_QTREEWIDGETITEM_ITEMTYPE_IDX                         = 426,
    SBK_QTREEWIDGETITEM_CHILDINDICATORPOLICY_IDX             = 425,
    SBK_QTREEWIDGETITEM_IDX                                  = 424,
    SBK_QTREEWIDGETITEMITERATOR_ITERATORFLAG_IDX             = 428,
    SBK_QFLAGS_QTREEWIDGETITEMITERATOR_ITERATORFLAG_IDX      = 107,
    SBK_QTREEWIDGETITEMITERATOR_IDX                          = 427,
    SBK_QUNDOVIEW_IDX                                        = 429,
    SBK_QVBOXLAYOUT_IDX                                      = 430,
    SBK_QWHATSTHIS_IDX                                       = 431,
    SBK_QWIDGET_RENDERFLAG_IDX                               = 433,
    SBK_QFLAGS_QWIDGET_RENDERFLAG_IDX                        = 108,
    SBK_QWIDGET_IDX                                          = 432,
    SBK_QWIDGETACTION_IDX                                    = 434,
    SBK_QWIDGETITEM_IDX                                      = 435,
    SBK_QWIZARD_WIZARDBUTTON_IDX                             = 437,
    SBK_QWIZARD_WIZARDPIXMAP_IDX                             = 439,
    SBK_QWIZARD_WIZARDSTYLE_IDX                              = 440,
    SBK_QWIZARD_WIZARDOPTION_IDX                             = 438,
    SBK_QFLAGS_QWIZARD_WIZARDOPTION_IDX                      = 109,
    SBK_QWIZARD_IDX                                          = 436,
    SBK_QWIZARDPAGE_IDX                                      = 441,
    SBK_QtWidgets_IDX_COUNT                                  = 442
};
...
template<> inline PyTypeObject *SbkType< ::QMessageBox::Option >() { return SbkPySide6_QtWidgetsTypes[SBK_QMESSAGEBOX_OPTION_IDX]; }
template<> inline PyTypeObject *SbkType< ::QFlags<QMessageBox::Option> >() { return SbkPySide6_QtWidgetsTypes[SBK_QFLAGS_QMESSAGEBOX_OPTION_IDX]; }
