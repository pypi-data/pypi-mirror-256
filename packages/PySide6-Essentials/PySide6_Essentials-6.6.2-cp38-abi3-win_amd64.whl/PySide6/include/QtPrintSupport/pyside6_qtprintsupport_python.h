...
enum : int {
    ...
    SBK_QTPRINTSUPPORT_QLIST_QACTIONPTR_IDX                  = 7, // QList<QAction*>
    SBK_QTPRINTSUPPORT_QLIST_QVARIANT_IDX                    = 8, // QList<QVariant>
    SBK_QTPRINTSUPPORT_QLIST_QSTRING_IDX                     = 9, // QList<QString>
    SBK_QTPRINTSUPPORT_QMAP_QSTRING_QVARIANT_IDX             = 10, // QMap<QString,QVariant>
    SBK_QtPrintSupport_CONVERTERS_IDX_COUNT                  = 11
};
