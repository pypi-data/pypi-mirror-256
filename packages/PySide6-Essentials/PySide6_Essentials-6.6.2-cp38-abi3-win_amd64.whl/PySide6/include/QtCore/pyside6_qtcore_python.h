...
enum : int {
    ...
    SBK_QFLAGS_QABSTRACTITEMMODEL_CHECKINDEXOPTION_IDX       = 100,
    ...
    SBK_QFLAGS_QBLUETOOTHPERMISSION_COMMUNICATIONMODE_IDX    = 101,
    SBK_QBLUETOOTHPERMISSION_IDX                             = 17,
    SBK_QBUFFER_IDX                                          = 19,
    SBK_QBYTEARRAY_BASE64OPTION_IDX                          = 22,
    SBK_QFLAGS_QBYTEARRAY_BASE64OPTION_IDX                   = 102,
    ...
    SBK_QFLAGS_QCBORVALUE_ENCODINGOPTION_IDX                 = 104,
    SBK_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX              = 48,
    SBK_QFLAGS_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX       = 103,
    ...
    SBK_QFLAGS_QCOMMANDLINEOPTION_FLAG_IDX                   = 105,
    SBK_QCOMMANDLINEOPTION_IDX                               = 54,
    SBK_QCOMMANDLINEPARSER_SINGLEDASHWORDOPTIONMODE_IDX      = 58,
    SBK_QCOMMANDLINEPARSER_OPTIONSAFTERPOSITIONALARGUMENTSMODE_IDX = 57,
    SBK_QCOMMANDLINEPARSER_IDX                               = 56,
    SBK_QCONCATENATETABLESPROXYMODEL_IDX                     = 59,
    SBK_QCONTACTSPERMISSION_ACCESSMODE_IDX                   = 61,
    SBK_QCONTACTSPERMISSION_IDX                              = 60,
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 450,
    SBK_QCOREAPPLICATION_IDX                                 = 62,
    SBK_QCRYPTOGRAPHICHASH_ALGORITHM_IDX                     = 64,
    SBK_QCRYPTOGRAPHICHASH_IDX                               = 63,
    SBK_QDATASTREAM_VERSION_IDX                              = 69,
    SBK_QDATASTREAM_BYTEORDER_IDX                            = 66,
    SBK_QDATASTREAM_STATUS_IDX                               = 68,
    SBK_QDATASTREAM_FLOATINGPOINTPRECISION_IDX               = 67,
    SBK_QDATASTREAM_IDX                                      = 65,
    SBK_QDATE_IDX                                            = 70,
    SBK_QDATETIME_YEARRANGE_IDX                              = 72,
    SBK_QDATETIME_IDX                                        = 71,
    SBK_QDEADLINETIMER_FOREVERCONSTANT_IDX                   = 74,
    SBK_QDEADLINETIMER_IDX                                   = 73,
    SBK_QDIR_FILTER_IDX                                      = 76,
    SBK_QFLAGS_QDIR_FILTER_IDX                               = 106,
    SBK_QDIR_SORTFLAG_IDX                                    = 77,
    SBK_QFLAGS_QDIR_SORTFLAG_IDX                             = 107,
    SBK_QDIR_IDX                                             = 75,
    SBK_QDIRITERATOR_ITERATORFLAG_IDX                        = 79,
    SBK_QFLAGS_QDIRITERATOR_ITERATORFLAG_IDX                 = 108,
    SBK_QDIRITERATOR_IDX                                     = 78,
    SBK_QDYNAMICPROPERTYCHANGEEVENT_IDX                      = 80,
    SBK_QEASINGCURVE_TYPE_IDX                                = 82,
    SBK_QEASINGCURVE_IDX                                     = 81,
    SBK_QELAPSEDTIMER_CLOCKTYPE_IDX                          = 84,
    SBK_QELAPSEDTIMER_IDX                                    = 83,
    SBK_QEVENT_TYPE_IDX                                      = 86,
    SBK_QEVENT_IDX                                           = 85,
    SBK_QEVENTLOOP_PROCESSEVENTSFLAG_IDX                     = 88,
    SBK_QFLAGS_QEVENTLOOP_PROCESSEVENTSFLAG_IDX              = 109,
    SBK_QEVENTLOOP_IDX                                       = 87,
    SBK_QFACTORYINTERFACE_IDX                                = 89,
    SBK_QFILE_IDX                                            = 90,
    SBK_QFILEDEVICE_FILEERROR_IDX                            = 92,
    SBK_QFILEDEVICE_FILETIME_IDX                             = 94,
    SBK_QFILEDEVICE_PERMISSION_IDX                           = 96,
    SBK_QFLAGS_QFILEDEVICE_PERMISSION_IDX                    = 112,
    SBK_QFILEDEVICE_FILEHANDLEFLAG_IDX                       = 93,
    SBK_QFLAGS_QFILEDEVICE_FILEHANDLEFLAG_IDX                = 110,
    SBK_QFILEDEVICE_MEMORYMAPFLAG_IDX                        = 95,
    SBK_QFLAGS_QFILEDEVICE_MEMORYMAPFLAG_IDX                 = 111,
    SBK_QFILEDEVICE_IDX                                      = 91,
    SBK_QFILEINFO_IDX                                        = 97,
    SBK_QFILESELECTOR_IDX                                    = 98,
    SBK_QFILESYSTEMWATCHER_IDX                               = 99,
    SBK_QFUTUREINTERFACEBASE_STATE_IDX                       = 156,
    SBK_QFUTUREINTERFACEBASE_CANCELMODE_IDX                  = 155,
    SBK_QFUTUREINTERFACEBASE_IDX                             = 154,
    SBK_QGENERICARGUMENT_IDX                                 = 157,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 158,
    SBK_QHASHSEED_IDX                                        = 159,
    SBK_QIODEVICE_IDX                                        = 160,
    SBK_QIODEVICEBASE_OPENMODEFLAG_IDX                       = 162,
    SBK_QFLAGS_QIODEVICEBASE_OPENMODEFLAG_IDX                = 113,
    SBK_QIODEVICEBASE_IDX                                    = 161,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 163,
    SBK_QITEMSELECTION_IDX                                   = 164,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 166,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 114,
    SBK_QITEMSELECTIONMODEL_IDX                              = 165,
    SBK_QITEMSELECTIONRANGE_IDX                              = 167,
    SBK_QJSONARRAY_IDX                                       = 168,
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 170,
    SBK_QJSONDOCUMENT_IDX                                    = 169,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 172,
    SBK_QJSONPARSEERROR_IDX                                  = 171,
    SBK_QJSONVALUE_TYPE_IDX                                  = 174,
    SBK_QJSONVALUE_IDX                                       = 173,
    SBK_QKEYCOMBINATION_IDX                                  = 175,
    SBK_QLIBRARY_LOADHINT_IDX                                = 177,
    SBK_QFLAGS_QLIBRARY_LOADHINT_IDX                         = 115,
    SBK_QLIBRARY_IDX                                         = 176,
    SBK_QLIBRARYINFO_LIBRARYPATH_IDX                         = 179,
    SBK_QLIBRARYINFO_IDX                                     = 178,
    SBK_QLINE_IDX                                            = 180,
    SBK_QLINEF_INTERSECTIONTYPE_IDX                          = 182,
    SBK_QLINEF_IDX                                           = 181,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 188,
    SBK_QLOCALE_SCRIPT_IDX                                   = 453,
    SBK_QLOCALE_COUNTRY_IDX                                  = 184,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 190,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 187,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 191,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 118,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 186,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 451,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 185,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 116,
    SBK_QLOCALE_LANGUAGECODETYPE_IDX                         = 189,
    SBK_QFLAGS_QLOCALE_LANGUAGECODETYPE_IDX                  = 117,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 452,
    SBK_QLOCALE_IDX                                          = 183,
    SBK_QLOCATIONPERMISSION_ACCURACY_IDX                     = 193,
    SBK_QLOCATIONPERMISSION_AVAILABILITY_IDX                 = 194,
    SBK_QLOCATIONPERMISSION_IDX                              = 192,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 196,
    SBK_QLOCKFILE_IDX                                        = 195,
    SBK_QLOGGINGCATEGORY_IDX                                 = 197,
    SBK_QMARGINS_IDX                                         = 198,
    SBK_QMARGINSF_IDX                                        = 199,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 200,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 201,
    SBK_QMETACLASSINFO_IDX                                   = 202,
    SBK_QMETAENUM_IDX                                        = 203,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 205,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 206,
    SBK_QMETAMETHOD_IDX                                      = 204,
    SBK_QMETAOBJECT_CALL_IDX                                 = 208,
    SBK_QMETAOBJECT_IDX                                      = 207,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 209,
    SBK_QMETAPROPERTY_IDX                                    = 210,
    SBK_QMETATYPE_TYPE_IDX                                   = 212,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 213,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 119,
    SBK_QMETATYPE_IDX                                        = 211,
    SBK_QMICROPHONEPERMISSION_IDX                            = 214,
    SBK_QMIMEDATA_IDX                                        = 215,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 217,
    SBK_QMIMEDATABASE_IDX                                    = 216,
    SBK_QMIMETYPE_IDX                                        = 218,
    SBK_QMODELINDEX_IDX                                      = 219,
    SBK_QMODELROLEDATA_IDX                                   = 220,
    SBK_QMUTEX_IDX                                           = 221,
    SBK_QNATIVEIPCKEY_TYPE_IDX                               = 223,
    SBK_QNATIVEIPCKEY_IDX                                    = 222,
    SBK_QOBJECT_IDX                                          = 224,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 226,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 225,
    SBK_QOPERATINGSYSTEMVERSIONBASE_OSTYPE_IDX               = 228,
    SBK_QOPERATINGSYSTEMVERSIONBASE_IDX                      = 227,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 229,
    SBK_QPAUSEANIMATION_IDX                                  = 230,
    SBK_QPERMISSION_IDX                                      = 231,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 232,
    SBK_QPLUGINLOADER_IDX                                    = 233,
    SBK_QPOINT_IDX                                           = 234,
    SBK_QPOINTF_IDX                                          = 235,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 241,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 242,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 239,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 240,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 238,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 237,
    SBK_QPROCESS_IDX                                         = 236,
    SBK_QPROCESSENVIRONMENT_INITIALIZATION_IDX               = 244,
    SBK_QPROCESSENVIRONMENT_IDX                              = 243,
    SBK_QPROPERTYANIMATION_IDX                               = 245,
    SBK_QRANDOMGENERATOR_IDX                                 = 246,
    SBK_QRANDOMGENERATOR64_IDX                               = 247,
    SBK_QREADLOCKER_IDX                                      = 248,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 250,
    SBK_QREADWRITELOCK_IDX                                   = 249,
    SBK_QRECT_IDX                                            = 251,
    SBK_QRECTF_IDX                                           = 252,
    SBK_QRECURSIVEMUTEX_IDX                                  = 253,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 257,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 121,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 256,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 255,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 120,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 258,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 122,
    SBK_QREGULAREXPRESSION_IDX                               = 254,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 259,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 260,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 262,
    SBK_QRESOURCE_IDX                                        = 261,
    SBK_QRUNNABLE_IDX                                        = 263,
    SBK_QSAVEFILE_IDX                                        = 264,
    SBK_QSEMAPHORE_IDX                                       = 265,
    SBK_QSEMAPHORERELEASER_IDX                               = 266,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 267,
    SBK_QSETTINGS_STATUS_IDX                                 = 271,
    SBK_QSETTINGS_FORMAT_IDX                                 = 269,
    SBK_QSETTINGS_SCOPE_IDX                                  = 270,
    SBK_QSETTINGS_IDX                                        = 268,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 273,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 274,
    SBK_QSHAREDMEMORY_IDX                                    = 272,
    SBK_QSIGNALBLOCKER_IDX                                   = 275,
    SBK_QSIGNALMAPPER_IDX                                    = 276,
    SBK_QSIZE_IDX                                            = 277,
    SBK_QSIZEF_IDX                                           = 278,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 279,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 281,
    SBK_QSOCKETNOTIFIER_IDX                                  = 280,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 282,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 285,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 284,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 123,
    SBK_QSTANDARDPATHS_IDX                                   = 283,
    SBK_QSTORAGEINFO_IDX                                     = 286,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 288,
    SBK_QSTRINGCONVERTER_IDX                                 = 287,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 290,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 124,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 289,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 291,
    SBK_QSTRINGDECODER_IDX                                   = 292,
    SBK_QSTRINGENCODER_IDX                                   = 293,
    SBK_QSTRINGLISTMODEL_IDX                                 = 294,
    SBK_QSYSINFO_SIZES_IDX                                   = 297,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 296,
    SBK_QSYSINFO_IDX                                         = 295,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 299,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 300,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 298,
    SBK_QTEMPORARYDIR_IDX                                    = 301,
    SBK_QTEMPORARYFILE_IDX                                   = 302,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 305,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 304,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 125,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 303,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 309,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 307,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 310,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 308,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 126,
    SBK_QTEXTSTREAM_IDX                                      = 306,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 311,
    SBK_QTHREAD_PRIORITY_IDX                                 = 313,
    SBK_QTHREAD_IDX                                          = 312,
    SBK_QTHREADPOOL_IDX                                      = 314,
    SBK_QTIME_IDX                                            = 315,
    SBK_QTIMELINE_STATE_IDX                                  = 318,
    SBK_QTIMELINE_DIRECTION_IDX                              = 317,
    SBK_QTIMELINE_IDX                                        = 316,
    SBK_QTIMEZONE_INITIALIZATION_IDX                         = 320,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 323,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 321,
    SBK_QTIMEZONE_IDX                                        = 319,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 322,
    SBK_QTIMER_IDX                                           = 324,
    SBK_QTIMEREVENT_IDX                                      = 325,
    SBK_QTRANSLATOR_IDX                                      = 326,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 327,
    SBK_QURL_PARSINGMODE_IDX                                 = 331,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 332,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 330,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 128,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 333,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 130,
    SBK_QURL_ACEPROCESSINGOPTION_IDX                         = 329,
    SBK_QFLAGS_QURL_ACEPROCESSINGOPTION_IDX                  = 127,
    SBK_QURL_IDX                                             = 328,
    SBK_QURLQUERY_IDX                                        = 334,
    SBK_QUUID_VARIANT_IDX                                    = 337,
    SBK_QUUID_VERSION_IDX                                    = 338,
    SBK_QUUID_STRINGFORMAT_IDX                               = 336,
    SBK_QUUID_IDX                                            = 335,
    SBK_QVARIANTANIMATION_IDX                                = 339,
    SBK_QVERSIONNUMBER_IDX                                   = 340,
    SBK_QWAITCONDITION_IDX                                   = 341,
    SBK_QWINEVENTNOTIFIER_IDX                                = 342,
    SBK_QWRITELOCKER_IDX                                     = 343,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 344,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 345,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 346,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 347,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 348,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 349,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 353,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 352,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 351,
    SBK_QXMLSTREAMREADER_IDX                                 = 350,
    SBK_QXMLSTREAMWRITER_IDX                                 = 354,
    SBK_QT_GLOBALCOLOR_IDX                                   = 390,
    SBK_QT_COLORSCHEME_IDX                                   = 369,
    SBK_QT_MOUSEBUTTON_IDX                                   = 406,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 144,
    SBK_QT_ORIENTATION_IDX                                   = 411,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 146,
    SBK_QT_FOCUSPOLICY_IDX                                   = 385,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 425,
    SBK_QT_SORTORDER_IDX                                     = 423,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 424,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 148,
    SBK_QT_TILERULE_IDX                                      = 430,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 356,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 131,
    SBK_QT_TEXTFLAG_IDX                                      = 427,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 426,
    SBK_QT_WHITESPACEMODE_IDX                                = 439,
    SBK_QT_HITTESTACCURACY_IDX                               = 392,
    SBK_QT_WINDOWTYPE_IDX                                    = 444,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 153,
    SBK_QT_WINDOWSTATE_IDX                                   = 443,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 152,
    SBK_QT_APPLICATIONSTATE_IDX                              = 359,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 132,
    SBK_QT_SCREENORIENTATION_IDX                             = 417,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 147,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 440,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 358,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 393,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 138,
    SBK_QT_BGMODE_IDX                                        = 363,
    SBK_QT_KEY_IDX                                           = 400,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 401,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 142,
    SBK_QT_MODIFIER_IDX                                      = 405,
    SBK_QT_ARROWTYPE_IDX                                     = 360,
    SBK_QT_PENSTYLE_IDX                                      = 414,
    SBK_QT_PENCAPSTYLE_IDX                                   = 412,
    SBK_QT_PENJOINSTYLE_IDX                                  = 413,
    SBK_QT_BRUSHSTYLE_IDX                                    = 364,
    SBK_QT_SIZEMODE_IDX                                      = 422,
    SBK_QT_UIEFFECT_IDX                                      = 438,
    SBK_QT_CURSORSHAPE_IDX                                   = 374,
    SBK_QT_TEXTFORMAT_IDX                                    = 428,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 361,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 377,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 133,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 378,
    SBK_QT_TOOLBARAREA_IDX                                   = 433,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 150,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 434,
    SBK_QT_DATEFORMAT_IDX                                    = 375,
    SBK_QT_TIMESPEC_IDX                                      = 431,
    SBK_QT_DAYOFWEEK_IDX                                     = 376,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 418,
    SBK_QT_CASESENSITIVITY_IDX                               = 365,
    SBK_QT_CORNER_IDX                                        = 373,
    SBK_QT_EDGE_IDX                                          = 380,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 135,
    SBK_QT_CONNECTIONTYPE_IDX                                = 370,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 420,
    SBK_QT_FILLRULE_IDX                                      = 383,
    SBK_QT_MASKMODE_IDX                                      = 403,
    SBK_QT_CLIPOPERATION_IDX                                 = 368,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 398,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 399,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 437,
    SBK_QT_AXIS_IDX                                          = 362,
    SBK_QT_FOCUSREASON_IDX                                   = 386,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 371,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 395,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 140,
    SBK_QT_INPUTMETHODHINT_IDX                               = 394,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 139,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 381,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 435,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 402,
    SBK_QT_ANCHORPOINT_IDX                                   = 357,
    SBK_QT_FINDCHILDOPTION_IDX                               = 384,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 136,
    SBK_QT_DROPACTION_IDX                                    = 379,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 134,
    SBK_QT_CHECKSTATE_IDX                                    = 366,
    SBK_QT_ITEMDATAROLE_IDX                                  = 396,
    SBK_QT_ITEMFLAG_IDX                                      = 397,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 141,
    SBK_QT_MATCHFLAG_IDX                                     = 404,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 143,
    SBK_QT_WINDOWMODALITY_IDX                                = 442,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 429,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 149,
    SBK_QT_EVENTPRIORITY_IDX                                 = 382,
    SBK_QT_SIZEHINT_IDX                                      = 421,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 441,
    SBK_QT_COORDINATESYSTEM_IDX                              = 372,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 436,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 151,
    SBK_QT_GESTURESTATE_IDX                                  = 388,
    SBK_QT_GESTURETYPE_IDX                                   = 389,
    SBK_QT_GESTUREFLAG_IDX                                   = 387,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 137,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 409,
    SBK_QT_NAVIGATIONMODE_IDX                                = 410,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 454,
    SBK_QT_TIMERTYPE_IDX                                     = 432,
    SBK_QT_SCROLLPHASE_IDX                                   = 419,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 408,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 407,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 145,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 367,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 391,
    SBK_QT_PERMISSIONSTATUS_IDX                              = 415,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 416,
    SBK_QtCoreQT_IDX                                         = 355,
    SBK_QTCOREHELPER_QGENERICARGUMENTHOLDER_IDX              = 446,
    SBK_QTCOREHELPER_QGENERICRETURNARGUMENTHOLDER_IDX        = 447,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 448,
    SBK_QCBORKNOWNTAGS_IDX                                   = 36,
    SBK_QCBORSIMPLETYPE_IDX                                  = 39,
    SBK_QCBORTAG_IDX                                         = 46,
    SBK_QTMSGTYPE_IDX                                        = 449,
    SBK_QtCore_IDX_COUNT                                     = 455
};
...
#if QT_CONFIG(permissions)
template<> inline PyTypeObject *SbkType< ::QBluetoothPermission::CommunicationMode >() { return SbkPySide6_QtCoreTypes[SBK_QBLUETOOTHPERMISSION_COMMUNICATIONMODE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QFlags<QBluetoothPermission::CommunicationMode> >() { return SbkPySide6_QtCoreTypes[SBK_QFLAGS_QBLUETOOTHPERMISSION_COMMUNICATIONMODE_IDX]; }
...
#endif
template<> inline PyTypeObject *SbkType< ::QNativeIpcKey::Type >() { return SbkPySide6_QtCoreTypes[SBK_QNATIVEIPCKEY_TYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QNativeIpcKey >() { return reinterpret_cast<PyTypeObject *>(SbkPySide6_QtCoreTypes[SBK_QNATIVEIPCKEY_IDX]); }
