...
enum PySide6_QtSql_QSqlResult_VirtualHookOperation_Surrogate {};
...
template<> inline PyTypeObject *SbkType< ::PySide6_QtSql_QSqlResult_BindingSyntax_Surrogate >() { return SbkPySide6_QtSqlTypes[SBK_QSQLRESULT_BINDINGSYNTAX_IDX]; }
template<> inline PyTypeObject *SbkType< ::PySide6_QtSql_QSqlResult_VirtualHookOperation_Surrogate >() { return SbkPySide6_QtSqlTypes[SBK_QSQLRESULT_VIRTUALHOOKOPERATION_IDX]; }
