...
enum : int {
    ...
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 467,
    ...
    SBK_QRHID3D11INITPARAMS_IDX                              = 277,
    SBK_QRHID3D11NATIVEHANDLES_IDX                           = 278,
    SBK_QRHID3D12INITPARAMS_IDX                              = 279,
    SBK_QRHID3D12NATIVEHANDLES_IDX                           = 280,
    SBK_QRHIDEPTHSTENCILCLEARVALUE_IDX                       = 281,
    SBK_QRHIDRIVERINFO_DEVICETYPE_IDX                        = 283,
    SBK_QRHIDRIVERINFO_IDX                                   = 282,
    SBK_QRHIGLES2INITPARAMS_IDX                              = 284,
    SBK_QRHIGLES2NATIVEHANDLES_IDX                           = 285,
    SBK_QRHIGRAPHICSPIPELINE_FLAG_IDX                        = 292,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_FLAG_IDX                 = 92,
    SBK_QRHIGRAPHICSPIPELINE_TOPOLOGY_IDX                    = 297,
    SBK_QRHIGRAPHICSPIPELINE_CULLMODE_IDX                    = 291,
    SBK_QRHIGRAPHICSPIPELINE_FRONTFACE_IDX                   = 293,
    SBK_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX          = 289,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX   = 91,
    SBK_QRHIGRAPHICSPIPELINE_BLENDFACTOR_IDX                 = 287,
    SBK_QRHIGRAPHICSPIPELINE_BLENDOP_IDX                     = 288,
    SBK_QRHIGRAPHICSPIPELINE_COMPAREOP_IDX                   = 290,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOP_IDX                   = 295,
    SBK_QRHIGRAPHICSPIPELINE_POLYGONMODE_IDX                 = 294,
    SBK_QRHIGRAPHICSPIPELINE_IDX                             = 286,
    SBK_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX                 = 296,
    SBK_QRHIINITPARAMS_IDX                                   = 298,
    SBK_QRHINATIVEHANDLES_IDX                                = 299,
    SBK_QRHINULLINITPARAMS_IDX                               = 300,
    SBK_QRHIREADBACKDESCRIPTION_IDX                          = 301,
    SBK_QRHIREADBACKRESULT_IDX                               = 302,
    SBK_QRHIRENDERBUFFER_TYPE_IDX                            = 305,
    SBK_QRHIRENDERBUFFER_FLAG_IDX                            = 304,
    SBK_QFLAGS_QRHIRENDERBUFFER_FLAG_IDX                     = 93,
    SBK_QRHIRENDERBUFFER_IDX                                 = 303,
    SBK_QRHIRENDERPASSDESCRIPTOR_IDX                         = 306,
    SBK_QRHIRENDERTARGET_IDX                                 = 307,
    SBK_QRHIRESOURCE_TYPE_IDX                                = 309,
    SBK_QRHIRESOURCE_IDX                                     = 308,
    SBK_QRHIRESOURCEUPDATEBATCH_IDX                          = 310,
    SBK_QRHISAMPLER_FILTER_IDX                               = 314,
    SBK_QRHISAMPLER_ADDRESSMODE_IDX                          = 312,
    SBK_QRHISAMPLER_COMPAREOP_IDX                            = 313,
    SBK_QRHISAMPLER_IDX                                      = 311,
    SBK_QRHISCISSOR_IDX                                      = 315,
    SBK_QRHISHADERRESOURCEBINDING_TYPE_IDX                   = 322,
    SBK_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX              = 320,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX       = 94,
    SBK_QRHISHADERRESOURCEBINDING_IDX                        = 316,
    SBK_QRHISHADERRESOURCEBINDING_DATA_IDX                   = 317,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEBUFFERDATA_IDX = 318,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEIMAGEDATA_IDX  = 319,
    SBK_QRHISHADERRESOURCEBINDING_TEXTUREANDSAMPLER_IDX      = 321,
    SBK_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX            = 324,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX     = 95,
    SBK_QRHISHADERRESOURCEBINDINGS_IDX                       = 323,
    SBK_QRHISHADERSTAGE_TYPE_IDX                             = 326,
    SBK_QRHISHADERSTAGE_IDX                                  = 325,
    SBK_QRHISTATS_IDX                                        = 327,
    SBK_QRHISWAPCHAIN_FLAG_IDX                               = 329,
    SBK_QFLAGS_QRHISWAPCHAIN_FLAG_IDX                        = 96,
    SBK_QRHISWAPCHAIN_FORMAT_IDX                             = 330,
    SBK_QRHISWAPCHAIN_STEREOTARGETBUFFER_IDX                 = 331,
    SBK_QRHISWAPCHAIN_IDX                                    = 328,
    SBK_QRHISWAPCHAINRENDERTARGET_IDX                        = 332,
    SBK_QRHITEXTURE_FLAG_IDX                                 = 334,
    SBK_QFLAGS_QRHITEXTURE_FLAG_IDX                          = 97,
    SBK_QRHITEXTURE_FORMAT_IDX                               = 335,
    SBK_QRHITEXTURE_IDX                                      = 333,
    SBK_QRHITEXTURECOPYDESCRIPTION_IDX                       = 336,
    SBK_QRHITEXTURERENDERTARGET_FLAG_IDX                     = 338,
    SBK_QFLAGS_QRHITEXTURERENDERTARGET_FLAG_IDX              = 98,
    SBK_QRHITEXTURERENDERTARGET_IDX                          = 337,
    SBK_QRHITEXTURERENDERTARGETDESCRIPTION_IDX               = 339,
    SBK_QRHITEXTURESUBRESOURCEUPLOADDESCRIPTION_IDX          = 340,
    SBK_QRHITEXTUREUPLOADDESCRIPTION_IDX                     = 341,
    SBK_QRHITEXTUREUPLOADENTRY_IDX                           = 342,
    SBK_QRHIVERTEXINPUTATTRIBUTE_FORMAT_IDX                  = 344,
    SBK_QRHIVERTEXINPUTATTRIBUTE_IDX                         = 343,
    SBK_QRHIVERTEXINPUTBINDING_CLASSIFICATION_IDX            = 346,
    SBK_QRHIVERTEXINPUTBINDING_IDX                           = 345,
    SBK_QRHIVERTEXINPUTLAYOUT_IDX                            = 347,
    SBK_QRHIVIEWPORT_IDX                                     = 348,
    SBK_QSCREEN_IDX                                          = 349,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 351,
    SBK_QSCROLLEVENT_IDX                                     = 350,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 352,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 354,
    SBK_QSESSIONMANAGER_IDX                                  = 353,
    SBK_QSHADER_STAGE_IDX                                    = 358,
    SBK_QSHADER_SOURCE_IDX                                   = 357,
    SBK_QSHADER_VARIANT_IDX                                  = 359,
    SBK_QSHADER_SERIALIZEDFORMATVERSION_IDX                  = 356,
    SBK_QSHADER_IDX                                          = 355,
    SBK_QSHADERCODE_IDX                                      = 360,
    SBK_QSHADERKEY_IDX                                       = 361,
    SBK_QSHADERVERSION_FLAG_IDX                              = 363,
    SBK_QFLAGS_QSHADERVERSION_FLAG_IDX                       = 99,
    SBK_QSHADERVERSION_IDX                                   = 362,
    SBK_QSHORTCUT_IDX                                        = 364,
    SBK_QSHORTCUTEVENT_IDX                                   = 365,
    SBK_QSHOWEVENT_IDX                                       = 366,
    SBK_QSINGLEPOINTEVENT_IDX                                = 367,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 369,
    SBK_QSTANDARDITEM_IDX                                    = 368,
    SBK_QSTANDARDITEMMODEL_IDX                               = 370,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 372,
    SBK_QSTATICTEXT_IDX                                      = 371,
    SBK_QSTATUSTIPEVENT_IDX                                  = 373,
    SBK_QSTYLEHINTS_IDX                                      = 374,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 376,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 377,
    SBK_QSURFACE_IDX                                         = 375,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 380,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 100,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 383,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 382,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 381,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 379,
    SBK_QSURFACEFORMAT_IDX                                   = 378,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 384,
    SBK_QTABLETEVENT_IDX                                     = 385,
    SBK_QTEXTBLOCK_IDX                                       = 386,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 387,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 468,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 389,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 388,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 390,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 391,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 395,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 394,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 393,
    SBK_QTEXTCHARFORMAT_IDX                                  = 392,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 397,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 398,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 399,
    SBK_QTEXTCURSOR_IDX                                      = 396,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 403,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 402,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 102,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 401,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 101,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 404,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 405,
    SBK_QTEXTDOCUMENT_IDX                                    = 400,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 406,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 407,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 409,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 412,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 410,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 411,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 103,
    SBK_QTEXTFORMAT_IDX                                      = 408,
    SBK_QTEXTFRAGMENT_IDX                                    = 413,
    SBK_QTEXTFRAME_IDX                                       = 414,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 415,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 418,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 417,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 416,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 419,
    SBK_QTEXTINLINEOBJECT_IDX                                = 420,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 422,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 104,
    SBK_QTEXTITEM_IDX                                        = 421,
    SBK_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX                = 426,
    SBK_QFLAGS_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX         = 105,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 424,
    SBK_QTEXTLAYOUT_IDX                                      = 423,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 425,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 428,
    SBK_QTEXTLENGTH_IDX                                      = 427,
    SBK_QTEXTLINE_EDGE_IDX                                   = 431,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 430,
    SBK_QTEXTLINE_IDX                                        = 429,
    SBK_QTEXTLIST_IDX                                        = 432,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 434,
    SBK_QTEXTLISTFORMAT_IDX                                  = 433,
    SBK_QTEXTOBJECT_IDX                                      = 435,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 436,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 440,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 441,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 438,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 106,
    SBK_QTEXTOPTION_IDX                                      = 437,
    SBK_QTEXTOPTION_TAB_IDX                                  = 439,
    SBK_QTEXTTABLE_IDX                                       = 442,
    SBK_QTEXTTABLECELL_IDX                                   = 443,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 444,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 445,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 446,
    SBK_QTOUCHEVENT_IDX                                      = 447,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 449,
    SBK_QTRANSFORM_IDX                                       = 448,
    SBK_QUNDOCOMMAND_IDX                                     = 450,
    SBK_QUNDOGROUP_IDX                                       = 451,
    SBK_QUNDOSTACK_IDX                                       = 452,
    SBK_QVALIDATOR_STATE_IDX                                 = 454,
    SBK_QVALIDATOR_IDX                                       = 453,
    SBK_QVECTOR2D_IDX                                        = 455,
    SBK_QVECTOR3D_IDX                                        = 456,
    SBK_QVECTOR4D_IDX                                        = 457,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 458,
    SBK_QWHEELEVENT_IDX                                      = 459,
    SBK_QWINDOW_VISIBILITY_IDX                               = 462,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 461,
    SBK_QWINDOW_IDX                                          = 460,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 463,
    SBK_QtGuiQT_IDX                                          = 464,
    SBK_QTGUIHELPER_QOVERRIDECURSORGUARD_IDX                 = 466,
    SBK_QtGui_IDX_COUNT                                      = 469
};
...
enum : int {
    ...
    SBK_QTGUI_STD_PAIR_INT_INT_IDX                           = 14, // std::pair<int,int>
    SBK_QTGUI_QLIST_QSTANDARDITEMPTR_IDX                     = 15, // QList<QStandardItem*>
    SBK_QTGUI_QLIST_QSHADERKEY_IDX                           = 16, // QList<QShaderKey>
    SBK_QTGUI_QMAP_INT_STD_PAIR_INT_INT_IDX                  = 17, // QMap<int,std::pair< int,int>>
    SBK_QTGUI_STD_ARRAY_FLOAT_4_IDX                          = 18, // std::array<float,4>
    SBK_QTGUI_QLIST_QRHIVERTEXINPUTATTRIBUTE_IDX             = 19, // QList<QRhiVertexInputAttribute>
    SBK_QTGUI_QLIST_QRHIVERTEXINPUTBINDING_IDX               = 20, // QList<QRhiVertexInputBinding>
    SBK_QTGUI_QLIST_QRHITEXTUREUPLOADENTRY_IDX               = 21, // QList<QRhiTextureUploadEntry>
    SBK_QTGUI_QLIST_QRHICOLORATTACHMENT_IDX                  = 22, // QList<QRhiColorAttachment>
    SBK_QTGUI_STD_ARRAY_INT_4_IDX                            = 23, // std::array<int,4>
    SBK_QTGUI_QLIST_QPOINTF_IDX                              = 24, // QList<QPointF>
    SBK_QTGUI_QLIST_QUINT32_IDX                              = 25, // QList<quint32>
    SBK_QTGUI_QLIST_QFONTDATABASE_WRITINGSYSTEM_IDX          = 26, // QList<QFontDatabase::WritingSystem>
    SBK_QTGUI_QLIST_QPOINT_IDX                               = 27, // QList<QPoint>
    SBK_QTGUI_QLIST_QPOLYGONF_IDX                            = 28, // QList<QPolygonF>
    SBK_QTGUI_QLIST_QPAGERANGES_RANGE_IDX                    = 29, // QList<QPageRanges::Range>
    SBK_QTGUI_QLIST_FLOAT_IDX                                = 30, // QList<float>
    SBK_QTGUI_QLIST_QSIZE_IDX                                = 31, // QList<QSize>
    SBK_QTGUI_STD_PAIR_QREAL_QCOLOR_IDX                      = 32, // std::pair<qreal,QColor>
    SBK_QTGUI_QLIST_STD_PAIR_QREAL_QCOLOR_IDX                = 33, // QList<std::pair< qreal,QColor>>
    SBK_QTGUI_QLIST_QSIZETYPE_IDX                            = 34, // QList<qsizetype>
    SBK_QTGUI_QLIST_UINT16_T_IDX                             = 35, // QList<uint16_t>
    SBK_QTGUI_QLIST_QACCESSIBLEINTERFACEPTR_IDX              = 36, // QList<QAccessibleInterface*>
    SBK_QTGUI_STD_PAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 37, // std::pair<QAccessibleInterface*,QFlags<QAccessible::RelationFlag>>
    SBK_QTGUI_QLIST_STD_PAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 38, // QList<std::pair< QAccessibleInterface*,QFlags<QAccessible::RelationFlag>>>
    SBK_QTGUI_QLIST_UNSIGNEDINT_IDX                          = 39, // QList<unsigned int>
    SBK_QTGUI_QLIST_QLINE_IDX                                = 40, // QList<QLine>
    SBK_QTGUI_QLIST_QLINEF_IDX                               = 41, // QList<QLineF>
    SBK_QTGUI_QLIST_QRECT_IDX                                = 42, // QList<QRect>
    SBK_QTGUI_QLIST_QRECTF_IDX                               = 43, // QList<QRectF>
    SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                         = 44, // QList<QKeySequence>
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 45, // QList<QObject*>
    SBK_QTGUI_QLIST_QBYTEARRAY_IDX                           = 46, // QList<QByteArray>
    SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                        = 47, // QList<QUndoStack*>
    SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                        = 48, // QList<QTextFrame*>
    SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                           = 49, // QList<QTextBlock>
    SBK_QTGUI_QLIST_QTEXTFORMAT_IDX                          = 50, // QList<QTextFormat>
    SBK_QTGUI_QLIST_QSCREENPTR_IDX                           = 51, // QList<QScreen*>
    SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                    = 52, // QList<QOpenGLContext*>
    SBK_QTGUI_QSET_QBYTEARRAY_IDX                            = 53, // QSet<QByteArray>
    SBK_QTGUI_QLIST_CONSTQINPUTDEVICEPTR_IDX                 = 54, // QList<const QInputDevice*>
    SBK_QTGUI_QLIST_QACTIONPTR_IDX                           = 55, // QList<QAction*>
    SBK_QTGUI_QLIST_QABSTRACTTEXTDOCUMENTLAYOUT_SELECTION_IDX = 56, // QList<QAbstractTextDocumentLayout::Selection>
    SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX          = 57, // QList<QInputMethodEvent::Attribute>
    SBK_QTGUI_QLIST_QEVENTPOINT_IDX                          = 58, // QList<QEventPoint>
    SBK_QTGUI_QLIST_QWINDOWPTR_IDX                           = 59, // QList<QWindow*>
    SBK_QTGUI_QLIST_QRHISHADERRESOURCEBINDING_IDX            = 60, // QList<QRhiShaderResourceBinding>
    SBK_QTGUI_QLIST_QRHISHADERSTAGE_IDX                      = 61, // QList<QRhiShaderStage>
    SBK_QTGUI_QLIST_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX     = 62, // QList<QRhiGraphicsPipeline::TargetBlend>
    SBK_QTGUI_STD_PAIR_INT_UNSIGNEDINT_IDX                   = 63, // std::pair<int,unsigned int>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX             = 64, // std::pair<QRhiBuffer*,quint32>
    SBK_QTGUI_QLIST_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX       = 65, // QList<std::pair< QRhiBuffer*,quint32>>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_UNSIGNEDINT_IDX         = 66, // std::pair<QRhiBuffer*,unsigned int>
    SBK_QTGUI_QLIST_QMODELINDEX_IDX                          = 67, // QList<QModelIndex>
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 68, // QHash<int,QByteArray>
    SBK_QTGUI_QLIST_QVARIANT_IDX                             = 69, // QList<QVariant>
    SBK_QTGUI_QLIST_QSTRING_IDX                              = 70, // QList<QString>
    SBK_QTGUI_QMAP_QSTRING_QVARIANT_IDX                      = 71, // QMap<QString,QVariant>
    SBK_QtGui_CONVERTERS_IDX_COUNT                           = 72
};
