...
from flask.globals import request_ctx, current_app
        ...
        with Transaction().set_context(language=language):
            ...
            if not inspect.isfunction(meth):
                ...
                try:
                    ...
                    # Catch internal exceptions with an Internal Server Error
                    current_app.logger.debug('Internal Server Error')
                    abort(500)
