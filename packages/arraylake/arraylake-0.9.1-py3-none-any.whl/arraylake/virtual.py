...
from arraylake.types import Path
...
def scan_grib2(url: str, **kwargs) -> ReferenceStoreT:
    """
    ...
    kwargs["storage_options"] = get_storage_options()
...
def scan_tiff(url: str, name: str, **kwargs) -> ReferenceStoreT:
    """
    ...
    storage_options = get_storage_options()
    refs_kerchunk = tiff_to_zarr(urlpath=url, remote_options=storage_options, **kwargs)
...
def reformat_kerchunk_refs(
    ...
    """
    from .chunkstore.base_chunkstore import encode_inline_data
