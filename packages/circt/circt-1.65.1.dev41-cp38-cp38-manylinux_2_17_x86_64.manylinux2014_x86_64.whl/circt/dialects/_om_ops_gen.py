...
def any_cast(input, *, loc=None, ip=None) -> _SubClassValueT:
...
def basepath_create(base_path, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def path_empty(*, loc=None, ip=None) -> _SubClassValueT:
...
def frozenbasepath_create(base_path, path, *, loc=None, ip=None) -> _SubClassValueT:
...
def frozenpath_empty(*, loc=None, ip=None) -> _SubClassValueT:
...
class FrozenPathCreateOp(_ods_ir.OpView):
  ...
  def __init__(self, targetKind, basePath, path, module, ref, field, *, loc=None, ip=None):
    ...
    issubclass(type(module), _ods_ir.Attribute) or
...
def frozenpath_create(target_kind, base_path, path, module, ref, field, *, loc=None, ip=None) -> _SubClassValueT:
...
def list_create(result, inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def map_create(result, inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def object_field(result, object, field_path, *, loc=None, ip=None) -> _SubClassValueT:
...
def object(result, class_name, actual_params, *, loc=None, ip=None) -> _SubClassValueT:
...
def path_create(target_kind, base_path, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def tuple_create(inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def tuple_get(input, index, *, loc=None, ip=None) -> _SubClassValueT:
