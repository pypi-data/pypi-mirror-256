...
SUBMODULES: List[Submodule] = [
    ...
    Submodule(
        module_name="mypy_boto3_backupstorage",
        import_name="backupstorage",
        boto3_name="backupstorage",
        class_name="BackupStorage",
        pypi_name="mypy-boto3-backupstorage",
        has_resource=False,
        has_waiter=False,
        has_paginator=False,
    ),
    ...
    Submodule(
        module_name="mypy_boto3_iotfleethub",
        import_name="iotfleethub",
        boto3_name="iotfleethub",
        class_name="IoTFleetHub",
        pypi_name="mypy-boto3-iotfleethub",
        has_resource=False,
        has_waiter=False,
        has_paginator=True,
    ),
    ...
    Submodule(
        module_name="mypy_boto3_lookoutmetrics",
        import_name="lookoutmetrics",
        boto3_name="lookoutmetrics",
        class_name="LookoutMetrics",
        pypi_name="mypy-boto3-lookoutmetrics",
        has_resource=False,
        has_waiter=False,
        has_paginator=False,
    ),
    Submodule(
        module_name="mypy_boto3_lookoutvision",
        import_name="lookoutvision",
        boto3_name="lookoutvision",
        class_name="LookoutforVision",
        pypi_name="mypy-boto3-lookoutvision",
        has_resource=False,
        has_waiter=False,
        has_paginator=True,
    ),
    ...
    Submodule(
        module_name="mypy_boto3_nimble",
        import_name="nimble",
        boto3_name="nimble",
        class_name="NimbleStudio",
        pypi_name="mypy-boto3-nimble",
        has_resource=False,
        has_waiter=True,
        has_paginator=True,
    ),
    ...
    Submodule(
        module_name="mypy_boto3_privatenetworks",
        import_name="privatenetworks",
        boto3_name="privatenetworks",
        class_name="Private5G",
        pypi_name="mypy-boto3-privatenetworks",
        has_resource=False,
        has_waiter=False,
        has_paginator=True,
    ),
