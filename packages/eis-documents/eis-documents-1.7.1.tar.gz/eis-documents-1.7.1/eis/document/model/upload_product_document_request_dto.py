...
class UploadProductDocumentRequestDto(ModelNormal):
    ...
    def _from_openapi_data(cls, content_type, description, filename, type, entity_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            product_slug (str): Slug of the product.. [optional]  # noqa: E501
            product_version_id (float): Id of the product version, and is optional. If not provided, the document will be attached        to the latest version of the product.. [optional]  # noqa: E501
        """
