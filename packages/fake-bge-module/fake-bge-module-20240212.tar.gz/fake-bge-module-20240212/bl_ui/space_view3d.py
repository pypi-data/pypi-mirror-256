...
class VIEW3D_MT_edit_greasepencil_animation(bpy_types.Menu,
                                            bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class VIEW3D_MT_edit_greasepencil_showhide(bpy_types.Menu,
                                           bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class VIEW3D_MT_grease_pencil_assign_material(bpy_types.Menu,
                                              bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class VIEW3D_MT_greasepencil_edit_context_menu(bpy_types.Menu,
                                               bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class VIEW3D_MT_greasepencil_material_active(bpy_types.Menu,
                                             bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class VIEW3D_PT_overlay_grease_pencil_options(bpy_types.Panel,
                                              bpy_types._GenericUI):
    bl_label = None
    ''' '''
