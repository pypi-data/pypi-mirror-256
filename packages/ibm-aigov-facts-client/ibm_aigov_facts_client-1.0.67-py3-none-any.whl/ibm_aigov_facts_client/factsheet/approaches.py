...
class ApproachUtilities:
    ...
    """
        Approach utilities. Running `client.assets.model_usecase().get_approaches` makes all methods in ApproachUtilities object available to use.
    
    """
   
    def __init__(self,assets_me_client:'asset_utils_me.ModelUsecaseUtilities', approach_id: str=None, approach_name: str=None, approach_desc: str=None, approach_icon: str=None,approach_icon_color: str=None, versions: list=None, model_asset_id: str=None, model_container_type: str=None, model_container_id: str=None) -> None:
    ...
    def get_versions(self)->list:
        ...
        """
            ...
            Example:
            >>> client.assets.model_usecase.get_approache.get_versions()
    ...
    def set_name(self,name:str=None):
        ...
        """
            ...
            Example:
            >>> client.assets.model_usecase.get_approache.set_name(name=<new approach name>)
        """
    ...
    def set_description(self,description:str=None):
        ...
        """
            ...
            Example:
            >>> client.assets.model_usecase.get_approache.set_description(description=<new approach description>)
        """
    ...
    def get_name(self)->str:
        ...
        """
            ...
            Example:
            >>>  >>> client.assets.model_usecase.get_approache.get_name()
    ...
    def get_id(self)->str:
        ...
        """
            ...
            Example:
            >>>  >>> client.assets.model_usecase.get_approache.get_id()
    ...
    def get_description(self)->str:
        ...
        """
            ...
            Example:
            >>>  >>> client.assets.model_usecase.get_approache.get_description()
    ...
    def get_model_useacse_id(self)->str:
        ...
        """
            ...
            Example:
            >>>  >>> client.assets.model_usecase.get_approache.get_model_useacse_id()
    ...
    def get_model_usecase_container_type(self)->str:
        ...
        """
            ...
            Example:
            >>>  >>> client.assets.model_usecase.get_approache.get_model_usecase_container_type()
    ...
    def get_model_usecase_container_id(self)->str:
        ...
        """
            ...
            Example:
            >>>  >>> client.assets.model_usecase.get_approache.get_model_usecase_container_id()
