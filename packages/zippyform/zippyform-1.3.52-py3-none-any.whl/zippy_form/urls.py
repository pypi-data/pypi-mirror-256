...
from zippy_form.views import form_list, create_form, update_form, delete_form, \
    ...
    update_form_submission_meta_data_value, get_form_recaptcha_details, update_form_recaptcha_details, form_analytics
...
urlpatterns = [
    ...
    path('builder/form/recaptcha/<uuid:form_id>/details', get_form_recaptcha_details),
    path('builder/form/recaptcha/<uuid:form_id>', update_form_recaptcha_details),
    ...
    path('builder/<uuid:form_id>/<year>/analytics', form_analytics),
