...
class PublicPartialUpdateUserV3(Operation):
    ...
    **Response body logic when user updating email address:**
    ...
    def with_body(self, value: ModelUserUpdateRequestV3) -> PublicPartialUpdateUserV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicPartialUpdateUserV3:
