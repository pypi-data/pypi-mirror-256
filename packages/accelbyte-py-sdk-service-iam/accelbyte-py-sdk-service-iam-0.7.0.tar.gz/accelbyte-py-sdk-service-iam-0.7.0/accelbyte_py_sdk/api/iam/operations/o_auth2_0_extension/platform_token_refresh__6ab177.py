...
class PlatformTokenRefreshV3Deprecate(Operation):
    ...
    def with_platform_token(self, value: str) -> PlatformTokenRefreshV3Deprecate:
        self.platform_token = value
        return self

    def with_platform_id(self, value: str) -> PlatformTokenRefreshV3Deprecate:
