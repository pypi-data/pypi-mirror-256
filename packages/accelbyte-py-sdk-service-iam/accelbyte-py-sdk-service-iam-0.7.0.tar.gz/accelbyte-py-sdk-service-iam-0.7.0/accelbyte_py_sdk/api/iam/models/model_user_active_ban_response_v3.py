...
class ModelUserActiveBanResponseV3(Model):
    """Model user active ban response V3 (model.UserActiveBanResponseV3)
    ...
    def with_ban(self, value: str) -> ModelUserActiveBanResponseV3:
        self.ban = value
        return self

    def with_ban_id(self, value: str) -> ModelUserActiveBanResponseV3:
        self.ban_id = value
        return self
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelUserActiveBanResponseV3]:
        return (
    ...
    ) -> List[ModelUserActiveBanResponseV3]:
        return (
    ...
    def create_from_any(
        ...
        ModelUserActiveBanResponseV3,
        List[ModelUserActiveBanResponseV3],
        Dict[Any, ModelUserActiveBanResponseV3],
    ]:
        if many:
