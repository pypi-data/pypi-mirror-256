...
from imxInsights.graph.graph import ImxGraph
from imxInsights.graph.models import (
    DirectionEnum,
    GraphMicroLink,
    ImxMicroLink,
    ImxMicroNode,
...
if __name__ == "__main__":
    file_path = r"C:\Users\marti\OneDrive - ProRail BV\toets\toets railgeometry\D-003037_000_100546_DO_WasWordt.XML"

    imx = Imx(file_path).project.initial_situation
    imx_graph = ImxGraphBuilder(imx).build_graph()

    imx_graph.draw_graph()
