...
class AppConnectedGithubVCSConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["branch", "component_config_id", "component_config_type", "created_at", "created_by_id", "directory", "id", "repo", "repo_name", "repo_owner", "updated_at", "vcs_connection", "vcs_connection_id"]
