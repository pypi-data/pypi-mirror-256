...
class ServiceUpdateInstallerRequestLinks(BaseModel):
    """
    ServiceUpdateInstallerRequestLinks
    """ # noqa: E501
    community: StrictStr
    demo: StrictStr
    ...
    homepage: StrictStr
    logo: StrictStr
    __properties: ClassVar[List[str]] = ["community", "demo", "documentation", "github", "homepage", "logo"]
