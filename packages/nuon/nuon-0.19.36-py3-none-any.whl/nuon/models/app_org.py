...
class AppOrg(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by_id", "custom_cert", "health_checks", "id", "latest_health_check", "name", "sandbox_mode", "status", "status_description", "updated_at", "users", "vcs_connections"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "users": [AppUserOrg.from_dict(_item) for _item in obj.get("users")] if obj.get("users") is not None else None,
