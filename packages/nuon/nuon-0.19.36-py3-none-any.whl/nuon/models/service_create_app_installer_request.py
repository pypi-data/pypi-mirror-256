...
class ServiceCreateAppInstallerRequest(BaseModel):
    """
    ServiceCreateAppInstallerRequest
    """ # noqa: E501
    app_id: StrictStr
    description: StrictStr
    links: Optional[ServiceCreateAppInstallerRequestLinks] = None
    name: StrictStr
    post_install_markdown: Optional[StrictStr] = None
    slug: StrictStr
    __properties: ClassVar[List[str]] = ["app_id", "description", "links", "name", "post_install_markdown", "slug"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "links": ServiceCreateAppInstallerRequestLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None,
            "name": obj.get("name"),
