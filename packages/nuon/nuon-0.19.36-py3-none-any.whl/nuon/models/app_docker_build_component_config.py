...
class AppDockerBuildComponentConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["build_args", "component_config_connection_id", "connected_github_vcs_config", "created_at", "created_by_id", "dockerfile", "env_vars", "id", "public_git_vcs_config", "target", "updated_at"]
