...
class AppInstall(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_id", "app_runner_config", "app_sandbox_config", "aws_account", "created_at", "created_by_id", "id", "install_components", "install_inputs", "install_sandbox_runs", "name", "status", "status_description", "updated_at"]
