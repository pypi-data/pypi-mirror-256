...
class StatsdEvent(BaseModel):
    ...
    alert_type: Optional[StatsdEventAlertType] = Field(default=None, description="AlertType can be statsd.Info, statsd.Error, statsd.Warning, or statsd.Success.
If absent, the default value applied by the dogstatsd server is Info.", alias="alertType")
