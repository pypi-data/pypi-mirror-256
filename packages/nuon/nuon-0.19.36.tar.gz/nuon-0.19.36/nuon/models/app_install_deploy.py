...
class AppInstallDeploy(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["build_id", "component_id", "component_name", "created_at", "created_by_id", "id", "install_component_id", "install_deploy_type", "install_id", "release_id", "status", "status_description", "updated_at"]
