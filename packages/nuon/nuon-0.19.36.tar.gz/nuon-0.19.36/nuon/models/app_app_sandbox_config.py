...
class AppAppSandboxConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_id", "artifacts", "connected_github_vcs_config", "created_at", "created_by_id", "id", "org_id", "public_git_vcs_config", "sandbox_release", "sandbox_release_id", "terraform_version", "updated_at", "variables"]
