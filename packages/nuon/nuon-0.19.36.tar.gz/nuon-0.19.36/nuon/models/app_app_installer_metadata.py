...
class AppAppInstallerMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_installer_id", "community_url", "created_at", "created_by_id", "demo_url", "description", "documentation_url", "github_url", "homepage_url", "id", "logo_url", "name", "post_install_markdown", "updated_at"]
