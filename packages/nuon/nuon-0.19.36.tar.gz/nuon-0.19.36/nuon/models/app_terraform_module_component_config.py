...
class AppTerraformModuleComponentConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["component_config_connection_id", "connected_github_vcs_config", "created_at", "created_by_id", "env_vars", "id", "public_git_vcs_config", "updated_at", "variables", "version"]
