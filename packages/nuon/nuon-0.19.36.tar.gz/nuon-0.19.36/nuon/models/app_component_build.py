...
class AppComponentBuild(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["component_config_connection_id", "component_id", "component_name", "created_at", "created_by_id", "git_ref", "id", "install_deploys", "releases", "status", "status_description", "updated_at", "vcs_connection_commit"]
