...
variable_wrong_formatting = (
    "variable {variable_name} not well formatted please refer to the documentation"
)
variable_input_value_error = "variable {variable_name} input error (see documentation)"
