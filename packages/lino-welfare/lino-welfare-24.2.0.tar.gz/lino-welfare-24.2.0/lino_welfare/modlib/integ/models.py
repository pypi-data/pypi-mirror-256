...
from lino_xl.lib.coachings.ui import CoachingEndings
...
art60 = dd.resolve_app('art60')
courses = dd.resolve_app('courses')
cv = dd.resolve_app('cv')
# properties = dd.resolve_app('properties')

if dd.is_installed('art60'):
    art60_contracts = art60.Contracts
    jobs_contract_set_by_company = 'art60_convention_set_by_company'
else:
    art60_contracts = jobs.Contracts
    jobs_contract_set_by_company = 'jobs_contract_set_by_company'
...
class CompareRequestsTable(dd.VirtualTable):
    ...
    def get_data_rows(self, ar):
        ...
        yield add(art60_contracts, observed_event=isip.ContractEvents.active)
...
class PeriodicNumbers(dd.VirtualTable):
    ...
    def get_data_rows(self, ar):
        ...
        for A in (isip.Contracts, art60_contracts):
...
class JobsContractEndingsByType(ContractEndingsByType):
    contracts_table = art60_contracts
    contract_type_model = jobs.ContractType

from lino_welfare.modlib.users.ui import Users
...
""")
        ...
        yield E.h1(str(art60_contracts.model._meta.verbose_name_plural))
