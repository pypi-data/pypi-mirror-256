...
for register/unregister it is mandatory.""")
    ...
    # understand why.
    action = ManageActions.field(blank=False, default='LIST')
    query_register = QueryRegisters.field(blank=False, default='ALL')
...
class RetrieveTIGroupsRequest(NewStyleRequest, SSIN):
    ...
    language = RequestLanguages.field(blank=True, default='fr')
