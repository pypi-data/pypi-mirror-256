...
from lino.core.roles import Anonymous, SiteUser, SiteAdmin, Supervisor, DataExporter
...
# add('430', _("Social agent (Office)"),         IntegrationAgentFlexible)
