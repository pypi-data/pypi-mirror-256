...
if (WIN32)
    set(METATENSOR_SHARED_LOCATION ${PACKAGE_PREFIX_DIR}/bin/libmetatensor.so)
    set(METATENSOR_IMPLIB_LOCATION ${PACKAGE_PREFIX_DIR}/lib/libmetatensor.so.lib)
else()
    set(METATENSOR_SHARED_LOCATION ${PACKAGE_PREFIX_DIR}/lib/libmetatensor.so)
endif()
