...
if (WIN32)
    set(METATENSOR_SHARED_LOCATION ${PACKAGE_PREFIX_DIR}/bin/metatensor.dll)
    set(METATENSOR_IMPLIB_LOCATION ${PACKAGE_PREFIX_DIR}/lib/metatensor.dll.lib)
else()
    set(METATENSOR_SHARED_LOCATION ${PACKAGE_PREFIX_DIR}/lib/metatensor.dll)
endif()

set(METATENSOR_STATIC_LOCATION ${PACKAGE_PREFIX_DIR}/lib/metatensor.lib)
set(METATENSOR_INCLUDE ${PACKAGE_PREFIX_DIR}/include/)
...
if (OFF OR NOT ON)
    ...
    set_target_properties(metatensor::static PROPERTIES
        ...
        INTERFACE_INCLUDE_DIRECTORIES ${METATENSOR_INCLUDE}
        INTERFACE_LINK_LIBRARIES "kernel32;advapi32;bcrypt;ntdll;userenv;ws2_32;$<$<CONFIG:Debug>:msvcrtd>"
        BUILD_VERSION "0.1.3"
    )
