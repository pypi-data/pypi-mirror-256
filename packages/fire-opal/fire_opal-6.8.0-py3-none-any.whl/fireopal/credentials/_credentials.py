...
def make_credentials_for_ibmq(
    ...
    Credentials
        ...
        argument of any Fire Opal function using IBM Quantum.
    ...
    if _check_for_remote_router():
        _EVENT_TRACKER.track_make_credentials_for_ibmq(user_email=_get_user_email())
...
def make_credentials_for_ibm_cloud(
    ...
    """
    if _check_for_remote_router():
        _EVENT_TRACKER.track_make_credentials_for_ibm_cloud(
