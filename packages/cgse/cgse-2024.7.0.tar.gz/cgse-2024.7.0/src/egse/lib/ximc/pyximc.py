...
libpath = os.path.join(cur_dir, "libximc.framework/libximc")
...
def ximc_shared_lib():
    if platform.system() == "Linux":
        ...
        return CDLL("libximc.so")
	# Here you passed directly the libpath, instead of having "libximc.framework/libximc"
...
class StateFlags:
	...
	STATE_CURRENT_MOTOR_BITS        = 0x00C0000
	STATE_CURRENT_MOTOR0            = 0x0000000
	STATE_CURRENT_MOTOR1            = 0x0040000
	STATE_CURRENT_MOTOR2            = 0x0080000
	STATE_CURRENT_MOTOR3            = 0x00C0000
