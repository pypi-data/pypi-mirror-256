...
class DeviceConnectionObserver:
    """
    An observer for the connection state of a device. Add the sub-class of this class to
...
class DeviceConnectionObservable:
    ...
    `add_observer()` method. Whenever the connection state of the device changes, the sub-class
