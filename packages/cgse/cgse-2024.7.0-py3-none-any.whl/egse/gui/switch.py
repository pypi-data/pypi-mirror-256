...
class Switch(QWidget):
    ...
    IMAGE_LOCATION = find_dir("/egse/icons") or ""

    def __init__(self, parent):
        super().__init__(parent)

        self.state = Indic.OFF
        self.image_location = Switch.IMAGE_LOCATION

        # logger.info(f"image_location = {self.image_location} of type({type(self.image_location)})")
    ...
    def drawCustomWidget(self, painter):
        ...
        renderer.load(str(self.image_location / self.states[self.state]))
