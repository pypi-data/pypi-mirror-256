...
class OAuthACG(HeaderAuth):
    ...
    def error_message(self):
        ...
        """
        return "OAuthACG: OAuthToken is undefined or expired."

    def __init__(self, o_auth_acg_credentials, config):
        auth_params = {}
        self._o_auth_client_id = o_auth_acg_credentials.o_auth_client_id \
            if o_auth_acg_credentials is not None else None
        self._o_auth_client_secret = o_auth_acg_credentials.o_auth_client_secret \
            if o_auth_acg_credentials is not None else None
        self._o_auth_redirect_uri = o_auth_acg_credentials.o_auth_redirect_uri \
            if o_auth_acg_credentials is not None else None
        if o_auth_acg_credentials is not None \
                and isinstance(o_auth_acg_credentials.o_auth_token, OAuthToken):
            self._o_auth_token = OAuthToken.from_dictionary(
                APIHelper.to_dictionary(o_auth_acg_credentials.o_auth_token))
        else:
            self._o_auth_token = o_auth_acg_credentials.o_auth_token \
                if o_auth_acg_credentials is not None else None
        if o_auth_acg_credentials is not None \
                and isinstance(o_auth_acg_credentials.o_auth_scopes, list):
            self._o_auth_scopes = o_auth_acg_credentials.o_auth_scopes
        else:
    ...
    def fetch_token(self, auth_code, additional_params=None):
        ...
        """
        token = self._o_auth_api.request_token_o_auth_acg(
    ...
    def refresh_token(self, additional_params=None):
        ...
        """
        token = self._o_auth_api.refresh_token_o_auth_acg(
            self.build_basic_auth_header(),
