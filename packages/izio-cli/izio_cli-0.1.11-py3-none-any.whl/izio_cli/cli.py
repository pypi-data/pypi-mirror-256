...
def main(
    ...
    message = """Usage: [b]izio_cli [SUBCOMMAND] [ARGUMENTS][/]
...
# [b]For detailed info please [blue][link=https://github.com/saulopef/izio_cli]refer to de docs![/]
"""
...
def new_project(
    ...
    if not type:
        type = inquirer.list_input(
            ...
            choices=["flutter", "netCore"] if os.name != "posix" else ["flutter"],
            default="flutter",
        )
    ...
    if path != "/Users/saulosenoski/Development/Izio/izio_cli":
        if type == "flutter":
            ...
            if os.name == "posix":
                raise ValueError("Type of project not supported in MacOS")
