...
project_name = 'graphite-datasets'
...
# python -m tensorflow_datasets.scripts.download_and_prepare --datasets=c4/en --data_dir=gs://data_ml_pipelines/tensorflow_datasets_2023_50_0_50 --beam_pipeline_options="machine_type=n1-standard-2,project=graphite-data,job_name=c4-050,staging_location=gs://data_ml_pipelines/binaries,temp_location=gs://data_ml_pipelines/temp,runner=DataflowRunner,requirements_file=/tmp/beam_requirements.txt,experiments=shuffle_mode=service,region=us-central1"