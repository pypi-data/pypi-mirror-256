...
class dataprocessing:
    ...
    def aggregate_daily_to_wc(self, df, date_column, group_columns, sum_columns, wc, aggregation='sum', include_totals=False):
        ...
        by summing or averaging them, and pivots the data to create separate columns for each combination 
        ...
        - aggregation: string, optional (default 'sum')
            Aggregation method, either 'sum' or 'average'.
    ...
    def merge_dataframes_on_column(self, dataframes, common_column='OBS', merge_how='inner'):
        """
