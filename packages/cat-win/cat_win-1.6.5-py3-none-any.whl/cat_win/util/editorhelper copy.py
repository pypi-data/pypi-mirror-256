...
_HIGHLIGHTS = [
    ('False',Highlights.BLUE),
    ('await',Highlights.CYAN),
    ('else',Highlights.CYAN),
    ('import',Highlights.MAGENTA),
    ('pass',Highlights.CYAN),
    ('None',Highlights.BLUE),
    ('break',Highlights.CYAN),
    ('except',Highlights.RED),
    ('in',Highlights.CYAN),
    ('raise',Highlights.RED),
    ('True',Highlights.BLUE),
    ('class',Highlights.MAGENTA),
    ('finally',Highlights.CYAN),
    ('is',Highlights.CYAN),
    ('return',Highlights.CYAN),
    ('and',Highlights.CYAN),
    ('continue',Highlights.CYAN),
    ('for',Highlights.CYAN),
    ('lambda',Highlights.MAGENTA),
    ('try',Highlights.RED),
    ('as',Highlights.MAGENTA),
    ('def',Highlights.MAGENTA),
    ('from',Highlights.MAGENTA),
    ('nonlocal',Highlights.CYAN),
    ('while',Highlights.CYAN),
    ('assert',Highlights.MAGENTA),
    ('del',Highlights.CYAN),
    ('global',Highlights.MAGENTA),
    ('not',Highlights.CYAN),
    ('with',Highlights.CYAN),
    ('async',Highlights.CYAN),
    ('elif',Highlights.CYAN),
    ('if',Highlights.CYAN),
    ('or',Highlights.CYAN),
    ('yield',Highlights.CYAN),
]

HIGHLIGHTS = [(token, len(token), color) for token, color in _HIGHLIGHTS]
