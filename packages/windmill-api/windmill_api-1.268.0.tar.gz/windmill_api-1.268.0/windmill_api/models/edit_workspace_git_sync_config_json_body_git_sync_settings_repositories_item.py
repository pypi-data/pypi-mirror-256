...
@_attrs_define
class EditWorkspaceGitSyncConfigJsonBodyGitSyncSettingsRepositoriesItem:
    """
    Attributes:
        script_path (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return edit_workspace_git_sync_config_json_body_git_sync_settings_repositories_item
