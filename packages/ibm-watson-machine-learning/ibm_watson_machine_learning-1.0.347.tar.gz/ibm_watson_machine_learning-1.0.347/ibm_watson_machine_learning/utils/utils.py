...
def _check_if_import_from_watsonx_ai(parent_obj_module: str, source_module: str, obj: str):
    try:
        if 'ibm_watsonx_ai' in parent_obj_module:
            import_module = importlib.__import__(source_module.replace('ibm_watson_machine_learning', 'ibm_watsonx_ai'),  
                                                 fromlist=[obj])
            return getattr(import_module, obj)
        else:
            import_module = importlib.__import__(source_module, 
                                                 fromlist=[obj])
            return getattr(import_module, obj)
