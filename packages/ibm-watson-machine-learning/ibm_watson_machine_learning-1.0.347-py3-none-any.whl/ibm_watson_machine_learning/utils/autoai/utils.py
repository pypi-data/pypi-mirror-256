...
def validate_additional_params_for_optimizer(params):
    expected_params = [
        ...
        'scorer_fairness_weight', 'use_flight', 'feature_selector_auto_delta', 'feature_selector_mode',
        'time_ordered_data', 'params_preset_name', 'feature_importances_normalization'
    ]
