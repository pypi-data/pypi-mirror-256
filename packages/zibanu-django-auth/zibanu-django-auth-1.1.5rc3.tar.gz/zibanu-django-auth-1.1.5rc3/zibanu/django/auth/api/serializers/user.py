...
class UserSerializer(UserListSerializer):
    ...
    def create(self, validated_data) -> User:
        ...
        if user_object is None:
            ...
            user_object = self.Meta.model.objects.create_user(username=username, email=email, password=password,
                                                              **validated_data)
            # Create profile
            # TODO: Make compatible with profile serializer to allow avatar and app_settings edition.
    ...
    def update(self, instance, validated_data) -> User:
        ...
        """
        # TODO: Make compatible with serializer option to allow imagefield and app_settings edition.
        profile_data = validated_data.pop("profile")
