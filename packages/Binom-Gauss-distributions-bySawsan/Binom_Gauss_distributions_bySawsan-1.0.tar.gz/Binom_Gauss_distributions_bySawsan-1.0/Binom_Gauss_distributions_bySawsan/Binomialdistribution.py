...
class Binomial(Distribution):  
    ...
    def plot_bar(self):
        ...
        Returns:
            None
        """
        plt.bar([0,1], [self.n-self.p*self.n, self.p*self.n])
        plt.xlabel("Value")
        plt.ylabel("Frequency")
        plt.title("Binomial results")
        plt.show()     
    ...
    def pdf(self, k):
        ...
        r1 = math.factorial(self.n)/(math.factorial(self.n - k)*math.factorial(k))
        r2 = self.p**k
        r3 = (1-self.p)**(self.n-k)
        return r1*r2*r3
    ...
    def __add__(self, other):
        ...
        Binomial_sum = Binomial(self.p, self.n+other.n)
    ...
    def __repr__(self):
        ...
        """
        return f'mean {self.mean:.2f}, standard deviation {self.stdev:.2f}, p {self.p:.1f}, n {self.n}'
