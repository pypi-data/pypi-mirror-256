...
from aioli.common import api, constants, util
from aioli.common.api import certs
from aioli.common.api.errors import UnauthenticatedException
...
def do_login(
    ...
    configuration = aiolirest.Configuration(host=host)
