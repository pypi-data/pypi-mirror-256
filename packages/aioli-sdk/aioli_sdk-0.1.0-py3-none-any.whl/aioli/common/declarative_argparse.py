...
def deprecation_warning(message: str, color: bool = True) -> str:
    msg: str = f"DEPRECATED: {message}"
    result: str = colored(msg, "yellow") if color else msg
    return result
...
# arg-type problem inherited from Determined -- ignore for now
