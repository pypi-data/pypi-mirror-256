...
main_cmd = Cmd(
    "r|egistry",
    None,
    "manage trained model registries",
    [
        # Inspection commands.
        Cmd(
            "list ls",
        ...
        Cmd(
            ...
            [
                ...
                Arg("--bucket", help="S3 Bucket name", required="true"),
                Arg("--access-key", help="S3 access key/username", required="true"),
                Arg("--secret-key", help="S3 secret key/password", required="true"),
                Arg("--endpoint-url", help="S3 endpoint URL", required="true"),
            ],
        ),
        Cmd(
            "update",
