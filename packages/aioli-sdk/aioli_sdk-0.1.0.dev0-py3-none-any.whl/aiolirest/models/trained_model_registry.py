...
class TrainedModelRegistry(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of the model registry. This is a read-only filed and is automatically assigned on creation.")
    ...
    __properties: ClassVar[List[str]] = ["accessKey", "bucket", "endpointUrl", "id", "name", "secretKey", "type"]
