...
class RolesApi:
    ...
    def roles_add_assignments_post(
        ...
        Authorize the specified user to perform actions associated with the specified role.
    ...
    def roles_remove_assignments_post(
        ...
        Remove the specified user from performing actions associated with the specified role.
