...
if __name__ == '__main__':
    ...
    ds = EmaDataSet.load(emf, data_path,
                         ...
                         # participant='Subject ID',  # == Column Header in each file
                         ...
                         # ... and / or any other keyword arguments to Pandas.read_xxx function.
                         )
    ...
    emd = EmaDisplaySet.show(emm,
                             ...
                             group_factors=['Age', 'Gender',
                                            ('Age', 'Gender')],
                             # ->  main effects in Dimensions 'Age', 'Gender', and combined effects of both
                             ...
                             # threshold_linewidth=1, # v. 1.1.0; default = 0.2 * rcParams.lines.linewidth
                             # threshold_color='w',   # v. 1.1.0; default = rcParams.axes.edgecolor
    ...
    emd.save(result_path,
             ...
             table_format='txt',    # or tex, csv, xlsx, odt; many formats that Pandas can handle
             float_format='%.2f')
