...
## What's Changed
* Fix output being printed incorrectly when amount of outdated packages is greater than the height of the terminal window by @yesseruser in https://github.com/Yesser-Studios/ypkgupgr/pull/49


**Full Changelog**: https://github.com/Yesser-Studios/ypkgupgr/compare/1.11.1...1.11.2
