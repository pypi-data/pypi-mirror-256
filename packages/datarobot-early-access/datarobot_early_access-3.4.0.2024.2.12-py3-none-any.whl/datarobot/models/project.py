...
OR individual keyword arguments. You cannot pass both."
    ...
    @deprecated(
        deprecated_since_version="v3.0",
        will_remove_version="v3.2",
        message="This method is deprecated, please use 'get_uri' instead.",
    )
    def get_leaderboard_ui_permalink(self) -> str:
        """
        Returns
        -------
        url : str
    ...
    @deprecated(
        deprecated_since_version="v3.0",
        will_remove_version="v3.2",
        message="This method is deprecated, please use 'open_in_browser' instead.",
    )
    def open_leaderboard_browser(self) -> None:
        """
