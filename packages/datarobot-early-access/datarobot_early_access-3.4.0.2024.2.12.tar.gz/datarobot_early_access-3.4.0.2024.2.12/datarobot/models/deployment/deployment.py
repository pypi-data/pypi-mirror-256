...
from datarobot.utils import deprecated, deprecation_warning, from_api, get_id_from_location
...
class Deployment(APIObject, MonitoringDataQueryBuilderMixin, BrowserMixin):
    ...
    def update_challenger_replay_settings(self, enabled: bool, schedule: Schedule) -> None:
