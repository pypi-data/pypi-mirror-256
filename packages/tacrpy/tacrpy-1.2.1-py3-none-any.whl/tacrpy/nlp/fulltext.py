...
class FulltextSimilarity:
    ...
    :param tfidf: model TFIDF a jeho hyperametry
    :type tfidf: TfidfVectorizer
    ...
    def create_tfidf(self) -> 'FulltextSimilarity':
    ...
    def create_similarity(self, include_comparison: bool = False) -> 'FulltextSimilarity':
    ...
    def get_similar_documents(self, threshold: float = 0.5, include_comparison: bool = False
        ...
        self.create_similarity(include_comparison)
    ...
    @staticmethod
    def add_info(similar_documents: pd.DataFrame
                 , comparison_info: pd.DataFrame, reference_info: pd.DataFrame = None) -> pd.DataFrame:
        ...
        merged_info = pd.merge(merged_info, reference_info, how='left', left_on='id2'
                               , right_on=reference_info_col, suffixes=('_1', '_2'))
        merged_info = merged_info.drop(columns=[reference_info_col])
