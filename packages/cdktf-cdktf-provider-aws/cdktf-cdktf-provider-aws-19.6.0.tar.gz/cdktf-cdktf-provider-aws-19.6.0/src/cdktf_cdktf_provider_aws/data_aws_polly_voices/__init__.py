...
Refer to the Terraform Registry for docs: [`data_aws_polly_voices`](https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/data-sources/polly_voices).
'''
import abc
import builtins
import datetime
...
class DataAwsPollyVoices(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/data-sources/polly_voices aws_polly_voices} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param engine: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/data-sources/polly_voices#engine DataAwsPollyVoices#engine}.
        :param include_additional_language_codes: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/data-sources/polly_voices#include_additional_language_codes DataAwsPollyVoices#include_additional_language_codes}.
        :param language_code: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/data-sources/polly_voices#language_code DataAwsPollyVoices#language_code}.
        :param voices: voices block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/data-sources/polly_voices#voices DataAwsPollyVoices#voices}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataAwsPollyVoices that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/data-sources/polly_voices#import import section} in the documentation of this resource for the id to use
