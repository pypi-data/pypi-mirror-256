...
from cdh_lava_demo.cdc_log_service.environment_tracing import TracerSingleton
...
if OS_NAME.lower() == "nt":  # Windows environment
    ...
    LOG_FILENAME = ENV_SHARE_PATH / "cdh_lava_demo_tracing.txt"
    ...
    try:
        ...
        LOG_FILENAME = os.path.join(ENV_SHARE_PATH, "cdh_lava_demo_logging.txt")
...
LOGGING_CONFIG = {
    ...
    "wonder_metadata_dev": {"level": "DEBUG", "handlers": ["logfile"]},
}
...
class LoggerSingleton:
    ...
    def __init__(
        ...
        log_format = LOGGING_CONFIG["formatters"]["default"]["format"]
