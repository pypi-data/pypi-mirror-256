...
class MLflowClient(ApiContainer):
    ...
    Args:
        client (cdh_lava_demoRestClient): The REST client used for making API requests.
...
`       """
        ...
        Args:
            client (cdh_lava_demoRestClient): The REST client used to communicate with the CDH Reference Python API.
        """
        self.client = client
