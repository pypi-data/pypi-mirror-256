from cdh_lava_demo.dbx_rest import ApiClient, ApiContainer

# from cdh_lava_demo.rest.permissions.crud import What, PermissionLevel
...
class Tokens(ApiContainer):
    ...
    def get_levels(self) -> dict:
        return self.client.execute_get_json(
            f"2.0/preview/permissions/authorization/tokens/permissionLevels"
        )
