...
from cdh_lava_demo.dbx_accelerator.dbgems import get_cloud, get_notebook_dir
...
class NotebookSolutionCompanion:
    ...
    def __init__(self):
        ...
        self.client = (
            cdh_lava_demoRestClient()
        )  # use cdh_lava_demo rest client for illustration. Feel free to update it to use other clients
