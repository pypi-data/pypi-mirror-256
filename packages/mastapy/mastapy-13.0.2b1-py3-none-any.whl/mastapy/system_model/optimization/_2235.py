...
class OptimizationStep(_0.APIBase):
    ...
    class _Cast_OptimizationStep:
        ...
        def conical_gear_optimization_step(
            ...
            return self._parent._cast(_2229.ConicalGearOptimizationStep)
        ...
        def cylindrical_gear_optimization_step(
            ...
            return self._parent._cast(_2232.CylindricalGearOptimizationStep)
    ...
    @property
    def optimisation_target(self: Self) -> "_2234.MicroGeometryOptimisationTarget":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.optimization._2234", "MicroGeometryOptimisationTarget"
        )(value)

    @optimisation_target.setter
    @enforce_parameter_types
    def optimisation_target(self: Self, value: "_2234.MicroGeometryOptimisationTarget"):
