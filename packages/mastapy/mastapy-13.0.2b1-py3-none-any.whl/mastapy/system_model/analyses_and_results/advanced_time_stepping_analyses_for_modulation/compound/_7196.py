...
class FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
    ...
    class _Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(
            self: "FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation",
            parent: "FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation.TYPE",
    ):
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_7066.FaceGearAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: Self,
    ) -> "FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation":
        return self._Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation(
            self
        )
