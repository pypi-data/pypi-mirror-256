...
class PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
    ...
    class _Cast_PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(
            self: "PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation",
            parent: "PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation.TYPE",
    ):
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_7095.PartToPartShearCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: Self,
    ) -> "PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation":
        return self._Cast_PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(
            self
        )
