...
Self = TypeVar(
    "Self", bound="SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation"
)
...
class SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
    ...
    class _Cast_SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(
            self: "SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation",
            parent: "SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation.TYPE",
    ):
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_7128.SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: Self,
    ) -> "SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation":
        return self._Cast_SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation(
            self
        )
