...
class AssemblyCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3513.AssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_3644.BearingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_3646.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3649.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_3656.BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_3655.BoltCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cv_ts(
        self: Self,
    ) -> "List[_3677.CVTCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3657.ClutchCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3662.ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3667.ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3679.CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3681.CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3685.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_3692.FEPartCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3691.FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def flexible_pin_assemblies(
        ...
        "List[_3693.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3700.HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3707.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3710.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_3711.MassDiscCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def measurement_components(
        ...
        "List[_3712.MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3714.OilSealCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3716.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3721.PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_3722.PointLoadCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_3723.PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3725.RingPinsCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def rolling_ring_assemblies(
        ...
        "List[_3727.RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3732.ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_3731.ShaftCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3737.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3738.SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3743.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        ...
        "List[_3746.StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3749.SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3753.TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_3757.UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3761.WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_3764.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
