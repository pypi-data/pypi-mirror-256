...
class CVTCompoundStabilityAnalysis(_3909.BeltDriveCompoundStabilityAnalysis):
    """CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_3808.CVTStabilityAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_3808.CVTStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.CVTStabilityAnalysis]
