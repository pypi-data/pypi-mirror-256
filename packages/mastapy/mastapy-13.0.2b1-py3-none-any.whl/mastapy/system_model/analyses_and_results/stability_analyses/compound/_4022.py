...
class WormGearCompoundStabilityAnalysis(_3957.GearCompoundStabilityAnalysis):
    """WormGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3895.WormGearStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.WormGearStabilityAnalysis]
