...
class AssemblyCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2992.AssemblySteadyStateSynchronousResponse]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_3126.BearingCompoundSteadyStateSynchronousResponse]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_3128.BeltDriveCompoundSteadyStateSynchronousResponse]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3131.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_3138.BoltedJointCompoundSteadyStateSynchronousResponse]":
    ...
    @property
    def bolts(self: Self) -> "List[_3137.BoltCompoundSteadyStateSynchronousResponse]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3159.CVTCompoundSteadyStateSynchronousResponse]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3139.ClutchCompoundSteadyStateSynchronousResponse]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3144.ConceptCouplingCompoundSteadyStateSynchronousResponse]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3149.ConceptGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3161.CycloidalAssemblyCompoundSteadyStateSynchronousResponse]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3163.CycloidalDiscCompoundSteadyStateSynchronousResponse]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3167.CylindricalGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_3174.FEPartCompoundSteadyStateSynchronousResponse]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3173.FaceGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_3175.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponse]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3182.HypoidGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3189.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3192.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_3193.MassDiscCompoundSteadyStateSynchronousResponse]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_3194.MeasurementComponentCompoundSteadyStateSynchronousResponse]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3196.OilSealCompoundSteadyStateSynchronousResponse]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3198.PartToPartShearCouplingCompoundSteadyStateSynchronousResponse]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3203.PlanetCarrierCompoundSteadyStateSynchronousResponse]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_3204.PointLoadCompoundSteadyStateSynchronousResponse]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_3205.PowerLoadCompoundSteadyStateSynchronousResponse]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3207.RingPinsCompoundSteadyStateSynchronousResponse]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_3209.RollingRingAssemblyCompoundSteadyStateSynchronousResponse]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3214.ShaftHubConnectionCompoundSteadyStateSynchronousResponse]":
    ...
    @property
    def shafts(self: Self) -> "List[_3213.ShaftCompoundSteadyStateSynchronousResponse]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3219.SpiralBevelGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3220.SpringDamperCompoundSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3225.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_3228.StraightBevelGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3231.SynchroniserCompoundSteadyStateSynchronousResponse]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3235.TorqueConverterCompoundSteadyStateSynchronousResponse]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_3239.UnbalancedMassCompoundSteadyStateSynchronousResponse]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3243.WormGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_3246.ZerolBevelGearSetCompoundSteadyStateSynchronousResponse]":
