...
class PartStaticLoadCaseGroup(_5677.DesignEntityStaticLoadCaseGroup):
    """PartStaticLoadCaseGroup
    ...
    class _Cast_PartStaticLoadCaseGroup:
        ...
        def abstract_assembly_static_load_case_group(
            ...
            return self._parent._cast(_5674.AbstractAssemblyStaticLoadCaseGroup)
        ...
        def component_static_load_case_group(
            ...
            return self._parent._cast(_5675.ComponentStaticLoadCaseGroup)
        ...
        def gear_set_static_load_case_group(
            ...
            return self._parent._cast(_5678.GearSetStaticLoadCaseGroup)
    ...
    @property
    def part_load_cases(self: Self) -> "List[_6931.PartLoadCase]":
