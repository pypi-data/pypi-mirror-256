...
TReal = TypeVar("TReal", bound="_2446.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_6840.ComponentLoadCase")


class ComponentStaticLoadCaseGroup(
    _5679.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
