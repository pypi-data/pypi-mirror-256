...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6808, _6820
    from mastapy.system_model.analyses_and_results import _2677, _2621
...
class TimeSeriesLoadCaseGroup(_5661.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: Self) -> "List[_6808.TimeSeriesLoadCase]":
