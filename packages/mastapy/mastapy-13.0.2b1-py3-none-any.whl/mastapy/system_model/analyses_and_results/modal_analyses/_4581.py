...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4718
...
class AssemblyModalAnalysis(_4574.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    class _Cast_AssemblyModalAnalysis:
        ...
        @property
        def part_analysis(self: "AssemblyModalAnalysis._Cast_AssemblyModalAnalysis"):
    ...
    @property
    def bearings(self: Self) -> "List[_4582.BearingModalAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4584.BeltDriveModalAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4593.BoltedJointModalAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_4594.BoltModalAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4616.CVTModalAnalysis]":
    ...
    def calculate_full_fe_results_by_mode(
        self: Self,
    ) -> "List[_4718.CalculateFullFEResultsForMode]":
    ...
    @property
    def clutches(self: Self) -> "List[_4597.ClutchModalAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_4602.ConceptCouplingModalAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_4605.ConceptGearSetModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4618.CycloidalAssemblyModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4620.CycloidalDiscModalAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4634.FEPartModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4633.FaceGearSetModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4635.FlexiblePinAssemblyModalAnalysis]":
    ...
    def full_fe_meshes_for_calculating_modes(
        self: Self,
    ) -> "List[_4634.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4643.HypoidGearSetModalAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4654.MassDiscModalAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4655.MeasurementComponentModalAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4662.OilSealModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4667.PartToPartShearCouplingModalAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4670.PlanetCarrierModalAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4671.PointLoadModalAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4672.PowerLoadModalAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4674.RingPinsModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4680.ShaftHubConnectionModalAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_4681.ShaftModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4687.SpiralBevelGearSetModalAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4690.SpringDamperModalAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4700.SynchroniserModalAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_4704.TorqueConverterModalAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_4707.UnbalancedMassModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4714.WormGearSetModalAnalysis]":
