...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4632, _4631
...
class FaceGearSetModalAnalysis(_4639.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self: Self) -> "List[_4632.FaceGearModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4631.FaceGearMeshModalAnalysis]":
