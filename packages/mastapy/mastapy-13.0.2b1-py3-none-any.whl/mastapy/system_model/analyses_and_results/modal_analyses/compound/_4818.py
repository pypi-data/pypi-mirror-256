...
class PulleyCompoundModalAnalysis(_4769.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4673.PulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4673.PulleyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PulleyModalAnalysis]
