...
class SynchroniserCompoundModalAnalysis(_4828.SpecialisedAssemblyCompoundModalAnalysis):
    """SynchroniserCompoundModalAnalysis
    ...
    @property
    def component_design(self: Self) -> "_2604.Synchroniser":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4700.SynchroniserModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4700.SynchroniserModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.SynchroniserModalAnalysis]
