...
class WormGearSetCompoundModalAnalysis(_4790.GearSetCompoundModalAnalysis):
    """WormGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4714.WormGearSetModalAnalysis]":
    ...
    def worm_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4853.WormGearCompoundModalAnalysis]":
    ...
    def worm_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4854.WormGearMeshCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4714.WormGearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearSetModalAnalysis]
