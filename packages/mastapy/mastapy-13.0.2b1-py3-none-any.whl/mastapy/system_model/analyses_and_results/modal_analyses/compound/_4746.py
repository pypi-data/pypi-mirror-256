...
class BevelGearCompoundModalAnalysis(_4734.AGMAGleasonConicalGearCompoundModalAnalysis):
    """BevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4591.BevelGearModalAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4591.BevelGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BevelGearModalAnalysis]
