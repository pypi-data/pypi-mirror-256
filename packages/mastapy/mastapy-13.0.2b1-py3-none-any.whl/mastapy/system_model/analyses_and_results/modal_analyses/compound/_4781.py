...
class DatumCompoundModalAnalysis(_4755.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4626.DatumModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4626.DatumModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.DatumModalAnalysis]
