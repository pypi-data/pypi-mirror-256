...
class MassDiscCompoundModalAnalysis(_4852.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4654.MassDiscModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4654.MassDiscModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.MassDiscModalAnalysis]
