...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis import _1798
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2654.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    def excitation_frequencies_at_reference_speed(
        self: Self,
    ) -> "List[_1798.DesignEntityExcitationDescription]":
