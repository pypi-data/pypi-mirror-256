...
class PerModeResultsReport(_1758.CustomReportChart):
    """PerModeResultsReport
    ...
    class _Cast_PerModeResultsReport:
        ...
        @property
        def custom_report_item(self: "PerModeResultsReport._Cast_PerModeResultsReport"):
    ...
    @property
    def display_option(self: Self) -> "_1822.TableAndChartOptions":
    ...
    def display_option(self: Self, value: "_1822.TableAndChartOptions"):
