...
class AssemblyModalAnalysisAtASpeed(_5119.AbstractAssemblyModalAnalysisAtASpeed):
    """AssemblyModalAnalysisAtASpeed
    ...
    @property
    def bearings(self: Self) -> "List[_5127.BearingModalAnalysisAtASpeed]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5129.BeltDriveModalAnalysisAtASpeed]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5138.BoltedJointModalAnalysisAtASpeed]":
    ...
    @property
    def bolts(self: Self) -> "List[_5139.BoltModalAnalysisAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5160.CVTModalAnalysisAtASpeed]":
    ...
    @property
    def clutches(self: Self) -> "List[_5142.ClutchModalAnalysisAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5150.ConceptGearSetModalAnalysisAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5162.CycloidalAssemblyModalAnalysisAtASpeed]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_5164.CycloidalDiscModalAnalysisAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5168.CylindricalGearSetModalAnalysisAtASpeed]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5175.FEPartModalAnalysisAtASpeed]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_5174.FaceGearSetModalAnalysisAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5176.FlexiblePinAssemblyModalAnalysisAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5183.HypoidGearSetModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5190.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5193.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtASpeed]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5194.MassDiscModalAnalysisAtASpeed]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5198.OilSealModalAnalysisAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5202.PartToPartShearCouplingModalAnalysisAtASpeed]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_5205.PlanetCarrierModalAnalysisAtASpeed]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5206.PointLoadModalAnalysisAtASpeed]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5207.PowerLoadModalAnalysisAtASpeed]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5209.RingPinsModalAnalysisAtASpeed]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5215.ShaftHubConnectionModalAnalysisAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_5216.ShaftModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5221.SpiralBevelGearSetModalAnalysisAtASpeed]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_5224.SpringDamperModalAnalysisAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5230.StraightBevelGearSetModalAnalysisAtASpeed]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_5234.SynchroniserModalAnalysisAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5241.UnbalancedMassModalAnalysisAtASpeed]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_5245.WormGearSetModalAnalysisAtASpeed]":
