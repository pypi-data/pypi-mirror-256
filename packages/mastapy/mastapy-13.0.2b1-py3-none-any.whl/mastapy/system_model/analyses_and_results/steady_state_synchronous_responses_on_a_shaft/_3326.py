...
class PartSteadyStateSynchronousResponseOnAShaft(_7550.PartStaticLoadAnalysisCase):
    """PartSteadyStateSynchronousResponseOnAShaft
    ...
    def create_viewable(self: Self) -> "_2260.SteadyStateSynchronousResponseViewable":
