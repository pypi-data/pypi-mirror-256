...
class WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft",
    )
    ...
    class _Cast_WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(
            self: "WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft._Cast_WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft",
            parent: "WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft.TYPE",
    ):
    ...
    def cast_to(
        self: Self,
    ) -> "WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft._Cast_WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft":
        return self._Cast_WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(
            self
        )
