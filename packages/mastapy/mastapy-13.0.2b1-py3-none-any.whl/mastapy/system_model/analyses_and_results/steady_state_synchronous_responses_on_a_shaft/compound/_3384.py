...
Self = TypeVar("Self", bound="AssemblyCompoundSteadyStateSynchronousResponseOnAShaft")
...
class AssemblyCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_AssemblyCompoundSteadyStateSynchronousResponseOnAShaft",
    )
    ...
    class _Cast_AssemblyCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(
            self: "AssemblyCompoundSteadyStateSynchronousResponseOnAShaft._Cast_AssemblyCompoundSteadyStateSynchronousResponseOnAShaft",
            parent: "AssemblyCompoundSteadyStateSynchronousResponseOnAShaft",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "AssemblyCompoundSteadyStateSynchronousResponseOnAShaft.TYPE",
    ):
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3254.AssemblySteadyStateSynchronousResponseOnAShaft]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_3385.BearingCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_3387.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3390.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_3397.BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_3396.BoltCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cv_ts(
        self: Self,
    ) -> "List[_3418.CVTCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3398.ClutchCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3403.ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3408.ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3420.CycloidalAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3422.CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3426.CylindricalGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_3433.FEPartCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3432.FaceGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def flexible_pin_assemblies(
        ...
        "List[_3434.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3441.HypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3448.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3451.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_3452.MassDiscCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def measurement_components(
        ...
        "List[_3453.MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3455.OilSealCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3457.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3462.PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_3463.PointLoadCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_3464.PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3466.RingPinsCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def rolling_ring_assemblies(
        ...
        "List[_3468.RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3473.ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_3472.ShaftCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3478.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3479.SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3484.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def straight_bevel_gear_sets(
        ...
        "List[_3487.StraightBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3490.SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3494.TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_3498.UnbalancedMassCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3502.WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_3505.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: Self,
    ) -> "AssemblyCompoundSteadyStateSynchronousResponseOnAShaft._Cast_AssemblyCompoundSteadyStateSynchronousResponseOnAShaft":
