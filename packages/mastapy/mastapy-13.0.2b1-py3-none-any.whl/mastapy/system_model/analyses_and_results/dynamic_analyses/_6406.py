...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6404, _6405
...
class WormGearSetDynamicAnalysis(_6341.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    def worm_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6404.WormGearDynamicAnalysis]":
    ...
    def worm_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6405.WormGearMeshDynamicAnalysis]":
