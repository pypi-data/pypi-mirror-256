...
class AssemblyCompoundDynamicAnalysis(_6410.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6286.AssemblyDynamicAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_6418.BearingCompoundDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6420.BeltDriveCompoundDynamicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6423.BevelDifferentialGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6430.BoltedJointCompoundDynamicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6429.BoltCompoundDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6451.CVTCompoundDynamicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6431.ClutchCompoundDynamicAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6436.ConceptCouplingCompoundDynamicAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6441.ConceptGearSetCompoundDynamicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6453.CycloidalAssemblyCompoundDynamicAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6455.CycloidalDiscCompoundDynamicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6459.CylindricalGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6466.FEPartCompoundDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6465.FaceGearSetCompoundDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6467.FlexiblePinAssemblyCompoundDynamicAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6474.HypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6481.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_6484.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_6485.MassDiscCompoundDynamicAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6486.MeasurementComponentCompoundDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6488.OilSealCompoundDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6490.PartToPartShearCouplingCompoundDynamicAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6495.PlanetCarrierCompoundDynamicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6496.PointLoadCompoundDynamicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6497.PowerLoadCompoundDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6499.RingPinsCompoundDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6501.RollingRingAssemblyCompoundDynamicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6506.ShaftHubConnectionCompoundDynamicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6505.ShaftCompoundDynamicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6511.SpiralBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6512.SpringDamperCompoundDynamicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6517.StraightBevelDiffGearSetCompoundDynamicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6520.StraightBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6523.SynchroniserCompoundDynamicAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6527.TorqueConverterCompoundDynamicAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6531.UnbalancedMassCompoundDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6535.WormGearSetCompoundDynamicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6538.ZerolBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6286.AssemblyDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.AssemblyDynamicAnalysis]
