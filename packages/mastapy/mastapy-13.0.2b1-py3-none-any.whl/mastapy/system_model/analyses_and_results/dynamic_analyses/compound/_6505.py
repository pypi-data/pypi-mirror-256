...
class ShaftCompoundDynamicAnalysis(_6411.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6376.ShaftDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6376.ShaftDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ShaftDynamicAnalysis]
