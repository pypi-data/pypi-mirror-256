...
class ShaftDynamicAnalysis(_6280.AbstractShaftDynamicAnalysis):
    ...
    class _Cast_ShaftDynamicAnalysis:
        ...
        @property
        def part_fe_analysis(self: "ShaftDynamicAnalysis._Cast_ShaftDynamicAnalysis"):
        ...
        @property
        def part_analysis_case(self: "ShaftDynamicAnalysis._Cast_ShaftDynamicAnalysis"):
            from mastapy.system_model.analyses_and_results.analysis_cases import _7547

            return self._parent._cast(_7547.PartAnalysisCase)

        @property
        def part_analysis(self: "ShaftDynamicAnalysis._Cast_ShaftDynamicAnalysis"):
