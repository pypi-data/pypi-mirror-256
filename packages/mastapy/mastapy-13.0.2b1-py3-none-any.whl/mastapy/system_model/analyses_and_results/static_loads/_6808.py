...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results import _2641, _2622
...
class TimeSeriesLoadCase(_6806.LoadCase):
    ...
    class _Cast_TimeSeriesLoadCase:
        ...
        @property
        def load_case(self: "TimeSeriesLoadCase._Cast_TimeSeriesLoadCase"):
            return self._parent._cast(_6806.LoadCase)

        @property
        def context(self: "TimeSeriesLoadCase._Cast_TimeSeriesLoadCase"):
