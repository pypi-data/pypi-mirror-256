...
from mastapy.bearings.bearing_results.rolling import _1968, _1969, _1974, _2071
from mastapy.materials.efficiency import _292
from mastapy.system_model.part_model import _2442
from mastapy.math_utility.hertzian_contact import _1575
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling.dysla import _2116
    from mastapy.bearings.bearing_results.rolling import _2072
    from mastapy.bearings.tolerances import _1916, _1922
...
class BearingLoadCase(_6853.ConnectorLoadCase):
    """BearingLoadCase
    ...
    class _Cast_BearingLoadCase:
        ...
        @property
        def connector_load_case(self: "BearingLoadCase._Cast_BearingLoadCase"):
        ...
        @property
        def component_load_case(self: "BearingLoadCase._Cast_BearingLoadCase"):
            from mastapy.system_model.analyses_and_results.static_loads import _6840

            return self._parent._cast(_6840.ComponentLoadCase)

        @property
        def part_load_case(self: "BearingLoadCase._Cast_BearingLoadCase"):
            from mastapy.system_model.analyses_and_results.static_loads import _6931

            return self._parent._cast(_6931.PartLoadCase)

        @property
        def part_analysis(self: "BearingLoadCase._Cast_BearingLoadCase"):
        ...
        @property
        def design_entity_analysis(self: "BearingLoadCase._Cast_BearingLoadCase"):
    ...
    @enforce_parameter_types
    def ball_bearing_analysis_method(
        self: Self, value: "_1968.BallBearingAnalysisMethod"
    ):
    ...
    def ball_bearing_contact_calculation(
        self: Self,
        value: "Union[_1969.BallBearingContactCalculation, Tuple[_1969.BallBearingContactCalculation, bool]]",
    ):
        wrapper_type = (
    ...
    def ball_bearing_friction_model_for_gyroscopic_moment(
        self: Self,
        value: "Union[_1974.FrictionModelForGyroscopicMoment, Tuple[_1974.FrictionModelForGyroscopicMoment, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def bearing_stiffness_model(self: Self) -> "_5388.BearingStiffnessModel":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5388",
            "BearingStiffnessModel",
        )(value)

    @bearing_stiffness_model.setter
    @enforce_parameter_types
    def bearing_stiffness_model(self: Self, value: "_5388.BearingStiffnessModel"):
    ...
    def force_at_zero_displacement_input_method(
        self: Self,
        value: "Union[_2442.BearingF0InputMethod, Tuple[_2442.BearingF0InputMethod, bool]]",
    ):
    ...
    @enforce_parameter_types
    def hertzian_contact_deflection_calculation_method(
        self: Self, value: "_1575.HertzianContactDeflectionCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def include_fitting_effects(self: Self) -> "_1591.LoadCaseOverrideOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility._1591", "LoadCaseOverrideOption"
        )(value)

    @include_fitting_effects.setter
    @enforce_parameter_types
    def include_fitting_effects(self: Self, value: "_1591.LoadCaseOverrideOption"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def include_ring_ovality(self: Self) -> "_1591.LoadCaseOverrideOption":
        """mastapy.utility.LoadCaseOverrideOption"""
    ...
    @enforce_parameter_types
    def include_ring_ovality(self: Self, value: "_1591.LoadCaseOverrideOption"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Utility.LoadCaseOverrideOption"
        )
    ...
    @property
    def include_thermal_expansion_effects(self: Self) -> "_1591.LoadCaseOverrideOption":
        """mastapy.utility.LoadCaseOverrideOption"""
    ...
    def include_thermal_expansion_effects(
        self: Self, value: "_1591.LoadCaseOverrideOption"
    ):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Utility.LoadCaseOverrideOption"
        )
    ...
    def roller_analysis_method(
        self: Self,
        value: "Union[_2071.RollerAnalysisMethod, Tuple[_2071.RollerAnalysisMethod, bool]]",
    ):
    ...
    @property
    def dynamic_analysis_options(self: Self) -> "_2116.DynamicBearingAnalysisOptions":
    ...
    @property
    def inner_ring_detail(self: Self) -> "_1916.RaceDetail":
    ...
    @property
    def left_ring_detail(self: Self) -> "_1916.RaceDetail":
        """mastapy.bearings.tolerances.RaceDetail
    ...
    @property
    def outer_ring_detail(self: Self) -> "_1916.RaceDetail":
        """mastapy.bearings.tolerances.RaceDetail
    ...
    @property
    def right_ring_detail(self: Self) -> "_1916.RaceDetail":
        """mastapy.bearings.tolerances.RaceDetail
