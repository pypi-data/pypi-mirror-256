...
class HarmonicLoadDataFluxImport(
    ...
    class _Cast_HarmonicLoadDataFluxImport:
        ...
        def harmonic_load_data_csv_import(
            ...
            return self._parent._cast(_6901.HarmonicLoadDataCSVImport)
    ...
    @property
    def inner_diameter_reference(self: Self) -> "_6913.InnerDiameterReference":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6913",
            "InnerDiameterReference",
        )(value)

    @inner_diameter_reference.setter
    @enforce_parameter_types
    def inner_diameter_reference(self: Self, value: "_6913.InnerDiameterReference"):
