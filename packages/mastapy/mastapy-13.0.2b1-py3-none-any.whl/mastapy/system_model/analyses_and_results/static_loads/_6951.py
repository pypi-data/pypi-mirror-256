...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6807, _6868
...
class RootAssemblyLoadCase(_6821.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    class _Cast_RootAssemblyLoadCase:
        ...
        @property
        def assembly_load_case(self: "RootAssemblyLoadCase._Cast_RootAssemblyLoadCase"):
        ...
        @property
        def part_load_case(self: "RootAssemblyLoadCase._Cast_RootAssemblyLoadCase"):
            from mastapy.system_model.analyses_and_results.static_loads import _6931

            return self._parent._cast(_6931.PartLoadCase)

        @property
        def part_analysis(self: "RootAssemblyLoadCase._Cast_RootAssemblyLoadCase"):
    ...
    @property
    def drive_cycle_pid_control_settings(self: Self) -> "_1578.PIDControlSettings":
    ...
    @property
    def supercharger_rotor_sets(self: Self) -> "List[_6868.CylindricalGearSetLoadCase]":
