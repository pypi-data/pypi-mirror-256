...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6918, _6919
...
class KlingelnbergCycloPalloidHypoidGearSetLoadCase(
    ...
    @property
    def gears(self: Self) -> "List[_6918.KlingelnbergCycloPalloidHypoidGearLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_load_case(
        self: Self,
    ) -> "List[_6918.KlingelnbergCycloPalloidHypoidGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.KlingelnbergCycloPalloidHypoidGearLoadCase]
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_load_case(
        self: Self,
    ) -> "List[_6919.KlingelnbergCycloPalloidHypoidGearMeshLoadCase]":
