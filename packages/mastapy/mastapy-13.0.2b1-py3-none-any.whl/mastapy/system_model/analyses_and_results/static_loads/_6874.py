...
from mastapy.electric_machines.harmonic_load_data import _1383, _1379
...
class ElectricMachineHarmonicLoadData(_1379.ElectricMachineHarmonicLoadDataBase):
    """ElectricMachineHarmonicLoadData
    ...
    @enforce_parameter_types
    def data_type_for_scaling(self: Self, value: "_1383.HarmonicLoadDataType"):
    ...
    @enforce_parameter_types
    def torque_ripple_input_type(self: Self, value: "_6979.TorqueRippleInputType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
