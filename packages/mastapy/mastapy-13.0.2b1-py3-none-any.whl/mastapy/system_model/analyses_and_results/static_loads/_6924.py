...
class MassDiscLoadCase(_6984.VirtualComponentLoadCase):
    """MassDiscLoadCase
    ...
    class _Cast_MassDiscLoadCase:
        ...
        @property
        def component_load_case(self: "MassDiscLoadCase._Cast_MassDiscLoadCase"):
            from mastapy.system_model.analyses_and_results.static_loads import _6840

            return self._parent._cast(_6840.ComponentLoadCase)

        @property
        def part_load_case(self: "MassDiscLoadCase._Cast_MassDiscLoadCase"):
            from mastapy.system_model.analyses_and_results.static_loads import _6931

            return self._parent._cast(_6931.PartLoadCase)

        @property
        def part_analysis(self: "MassDiscLoadCase._Cast_MassDiscLoadCase"):
        ...
        @property
        def design_entity_analysis(self: "MassDiscLoadCase._Cast_MassDiscLoadCase"):
