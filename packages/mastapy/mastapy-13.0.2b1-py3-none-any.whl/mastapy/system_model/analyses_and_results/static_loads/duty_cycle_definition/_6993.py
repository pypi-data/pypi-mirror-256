...
class DesignStateOptions(_1849.ColumnInputOptions):
    """DesignStateOptions
    ...
    class _Cast_DesignStateOptions:
        ...
        @property
        def column_input_options(self: "DesignStateOptions._Cast_DesignStateOptions"):
    ...
    @design_state.setter
    @enforce_parameter_types
    def design_state(self: Self, value: "_5665.DesignState"):
        wrapper_type = (
    ...
    def design_state_destinations(
        self: Self,
    ) -> "List[_2209.DutyCycleImporterDesignEntityMatch[_5665.DesignState]]":
