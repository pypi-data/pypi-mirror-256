...
if TYPE_CHECKING:
    from mastapy.utility.file_access_helpers import _1820
...
class MultiTimeSeriesDataInputFileOptions(_1850.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    class _Cast_MultiTimeSeriesDataInputFileOptions:
        ...
        def data_input_file_options(
            ...
            return self._parent._cast(_1850.DataInputFileOptions)
    ...
    @property
    def delimiter_options(self: Self) -> "_1820.TextFileDelimiterOptions":
