...
class TorqueInputOptions(_7001.PowerLoadInputOptions):
    """TorqueInputOptions
    ...
    class _Cast_TorqueInputOptions:
        ...
        @property
        def column_input_options(self: "TorqueInputOptions._Cast_TorqueInputOptions"):
    ...
    @property
    def conversion_to_load_case(self: Self) -> "_7007.TorqueValuesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition._7007",
            "TorqueValuesObtainedFrom",
        )(value)

    @conversion_to_load_case.setter
    @enforce_parameter_types
    def conversion_to_load_case(self: Self, value: "_7007.TorqueValuesObtainedFrom"):
