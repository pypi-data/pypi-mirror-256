...
from mastapy.system_model import _2216
from mastapy.gears import _337
from mastapy.nodal_analysis.nodal_entities import _130
from mastapy.bearings.bearing_results.rolling.iso_rating_results import _2111
...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _1969, _2071
    from mastapy.system_model import _2212, _2226
...
class LoadCase(_2652.Context):
    ...
    @enforce_parameter_types
    def ball_bearing_contact_calculation(
        self: Self, value: "_1969.BallBearingContactCalculation"
    ):
    ...
    @enforce_parameter_types
    def ball_bearing_friction_model_for_gyroscopic_moment(
        self: Self, value: "_1974.FrictionModelForGyroscopicMoment"
    ):
    ...
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2212", "HypoidWindUpRemovalMethod"
        )(value)

    @hypoid_gear_wind_up_removal_method_for_misalignments.setter
    @enforce_parameter_types
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        self: Self, value: "_2212.HypoidWindUpRemovalMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def mesh_stiffness_model(self: Self, value: "_2216.MeshStiffnessModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def roller_analysis_method(self: Self) -> "_2071.RollerAnalysisMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results.rolling._2071", "RollerAnalysisMethod"
        )(value)

    @roller_analysis_method.setter
    @enforce_parameter_types
    def roller_analysis_method(self: Self, value: "_2071.RollerAnalysisMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def stress_concentration_method_for_rating(
        self: Self, value: "_2111.StressConcentrationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def additional_acceleration(self: Self) -> "_6813.AdditionalAccelerationOptions":
    ...
    @property
    def input_power_load(self: Self) -> "_6942.PowerLoadLoadCase":
    ...
    @property
    def output_power_load(self: Self) -> "_6942.PowerLoadLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.PowerLoadLoadCase
    ...
    @property
    def parametric_study_tool_options(self: Self) -> "_4391.ParametricStudyToolOptions":
    ...
    @property
    def temperatures(self: Self) -> "_2226.TransmissionTemperatureSet":
    ...
    @enforce_parameter_types
    def inputs_for_cvt(self: Self, design_entity: "_2588.CVT") -> "_6858.CVTLoadCase":
