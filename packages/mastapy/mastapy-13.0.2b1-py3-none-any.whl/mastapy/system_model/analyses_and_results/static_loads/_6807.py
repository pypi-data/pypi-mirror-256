...
class StaticLoadCase(_6806.LoadCase):
    """StaticLoadCase
    ...
    class _Cast_StaticLoadCase:
        ...
        @property
        def load_case(self: "StaticLoadCase._Cast_StaticLoadCase"):
            return self._parent._cast(_6806.LoadCase)

        @property
        def context(self: "StaticLoadCase._Cast_StaticLoadCase"):
            from mastapy.system_model.analyses_and_results import _2652

            return self._parent._cast(_2652.Context)

        @property
        def parametric_study_static_load(self: "StaticLoadCase._Cast_StaticLoadCase"):
    ...
    @property
    def system_deflection(self: Self) -> "_2648.SystemDeflectionAnalysis":
    ...
    @property
    def power_flow(self: Self) -> "_2643.PowerFlowAnalysis":
    ...
    @property
    def harmonic_analysis(self: Self) -> "_2634.HarmonicAnalysis":
    ...
    @property
    def parametric_study_tool(self: Self) -> "_2642.ParametricStudyToolAnalysis":
    ...
    @property
    def modal_analysis(self: Self) -> "_2637.ModalAnalysis":
    ...
    @property
    def critical_speed_analysis(self: Self) -> "_2627.CriticalSpeedAnalysis":
    ...
    @property
    def stability_analysis(self: Self) -> "_2644.StabilityAnalysis":
    ...
    def unbalanced_mass_inclusion(
        self: Self,
        value: "Union[_2480.UnbalancedMassInclusionOption, Tuple[_2480.UnbalancedMassInclusionOption, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def clutch_engagements(self: Self) -> "List[_5663.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: Self,
    ) -> "List[_5664.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: Self) -> "_5665.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: Self, new_design_state_group: "_5665.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
