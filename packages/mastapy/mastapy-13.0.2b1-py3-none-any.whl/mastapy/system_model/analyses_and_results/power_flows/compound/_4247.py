...
class OilSealCompoundPowerFlow(_4205.ConnectorCompoundPowerFlow):
    """OilSealCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4115.OilSealPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4115.OilSealPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.OilSealPowerFlow]
