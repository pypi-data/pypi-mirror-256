...
class ConceptCouplingCompoundPowerFlow(_4206.CouplingCompoundPowerFlow):
    """ConceptCouplingCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4062.ConceptCouplingPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4062.ConceptCouplingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptCouplingPowerFlow]
