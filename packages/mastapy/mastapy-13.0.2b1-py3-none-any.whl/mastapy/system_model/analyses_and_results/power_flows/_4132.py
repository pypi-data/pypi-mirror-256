...
class RollingRingPowerFlow(_4072.CouplingHalfPowerFlow):
    ...
    class _Cast_RollingRingPowerFlow:
        ...
        @property
        def part_power_flow(self: "RollingRingPowerFlow._Cast_RollingRingPowerFlow"):
        ...
        @property
        def part_analysis_case(self: "RollingRingPowerFlow._Cast_RollingRingPowerFlow"):
            from mastapy.system_model.analyses_and_results.analysis_cases import _7547

            return self._parent._cast(_7547.PartAnalysisCase)

        @property
        def part_analysis(self: "RollingRingPowerFlow._Cast_RollingRingPowerFlow"):
