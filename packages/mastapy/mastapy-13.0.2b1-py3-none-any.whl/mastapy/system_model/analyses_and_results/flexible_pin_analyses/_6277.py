...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6271
...
class FlexiblePinAnalysisStopStartAnalysis(_6271.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self: Self) -> "_2806.ShaftSystemDeflection":
    ...
    @property
    def shaft_nominal_load_case(self: Self) -> "_2806.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
