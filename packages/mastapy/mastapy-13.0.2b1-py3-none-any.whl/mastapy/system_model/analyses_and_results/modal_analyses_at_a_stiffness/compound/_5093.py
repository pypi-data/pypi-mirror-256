...
Self = TypeVar("Self", bound="SpringDamperConnectionCompoundModalAnalysisAtAStiffness")
...
class SpringDamperConnectionCompoundModalAnalysisAtAStiffness(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_SpringDamperConnectionCompoundModalAnalysisAtAStiffness",
    )
    ...
    class _Cast_SpringDamperConnectionCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(
            self: "SpringDamperConnectionCompoundModalAnalysisAtAStiffness._Cast_SpringDamperConnectionCompoundModalAnalysisAtAStiffness",
            parent: "SpringDamperConnectionCompoundModalAnalysisAtAStiffness",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "SpringDamperConnectionCompoundModalAnalysisAtAStiffness.TYPE",
    ):
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4963.SpringDamperConnectionModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: Self,
    ) -> "SpringDamperConnectionCompoundModalAnalysisAtAStiffness._Cast_SpringDamperConnectionCompoundModalAnalysisAtAStiffness":
