...
class AssemblyCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4866.AssemblyModalAnalysisAtAStiffness]":
    ...
    @property
    def bearings(self: Self) -> "List[_4998.BearingCompoundModalAnalysisAtAStiffness]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_5000.BeltDriveCompoundModalAnalysisAtAStiffness]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5003.BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_5010.BoltedJointCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def bolts(self: Self) -> "List[_5009.BoltCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5031.CVTCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def clutches(self: Self) -> "List[_5011.ClutchCompoundModalAnalysisAtAStiffness]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5016.ConceptCouplingCompoundModalAnalysisAtAStiffness]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5021.ConceptGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5033.CycloidalAssemblyCompoundModalAnalysisAtAStiffness]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5035.CycloidalDiscCompoundModalAnalysisAtAStiffness]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5039.CylindricalGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5046.FEPartCompoundModalAnalysisAtAStiffness]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5045.FaceGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5047.FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5054.HypoidGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5061.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5064.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_5065.MassDiscCompoundModalAnalysisAtAStiffness]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5066.MeasurementComponentCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5068.OilSealCompoundModalAnalysisAtAStiffness]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5070.PartToPartShearCouplingCompoundModalAnalysisAtAStiffness]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5075.PlanetCarrierCompoundModalAnalysisAtAStiffness]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_5076.PointLoadCompoundModalAnalysisAtAStiffness]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_5077.PowerLoadCompoundModalAnalysisAtAStiffness]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_5079.RingPinsCompoundModalAnalysisAtAStiffness]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5081.RollingRingAssemblyCompoundModalAnalysisAtAStiffness]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5086.ShaftHubConnectionCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def shafts(self: Self) -> "List[_5085.ShaftCompoundModalAnalysisAtAStiffness]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5091.SpiralBevelGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5092.SpringDamperCompoundModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5097.StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5100.StraightBevelGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_5103.SynchroniserCompoundModalAnalysisAtAStiffness]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5107.TorqueConverterCompoundModalAnalysisAtAStiffness]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5111.UnbalancedMassCompoundModalAnalysisAtAStiffness]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5115.WormGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_5118.ZerolBevelGearSetCompoundModalAnalysisAtAStiffness]":
