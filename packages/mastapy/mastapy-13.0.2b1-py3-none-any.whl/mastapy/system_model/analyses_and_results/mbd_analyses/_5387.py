...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5527
...
class BearingMultibodyDynamicsAnalysis(_5417.ConnectorMultibodyDynamicsAnalysis):
    """BearingMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self: Self) -> "_5527.DynamicForceVector3DResult":
