...
class PulleyMultibodyDynamicsAnalysis(_5419.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self: Self) -> "List[_5528.DynamicTorqueResultAtTime]":
