...
class WormGearSetCompoundParametricStudyTool(_4505.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6987.WormGearSetLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4441.WormGearSetParametricStudyTool]":
    ...
    def worm_gears_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4568.WormGearCompoundParametricStudyTool]":
    ...
    def worm_meshes_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4569.WormGearMeshCompoundParametricStudyTool]":
