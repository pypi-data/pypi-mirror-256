...
class OilSealCompoundParametricStudyTool(_4481.ConnectorCompoundParametricStudyTool):
    """OilSealCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6929.OilSealLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4384.OilSealParametricStudyTool]":
