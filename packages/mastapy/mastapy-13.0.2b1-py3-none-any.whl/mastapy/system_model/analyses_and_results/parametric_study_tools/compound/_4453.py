...
class BearingCompoundParametricStudyTool(_4481.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self: Self) -> "_1950.LoadedBearingDutyCycle":
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6822.BearingLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4306.BearingParametricStudyTool]":
