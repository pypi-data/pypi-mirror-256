...
Self = TypeVar(
    "Self", bound="CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis"
)
...
class CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis",
    )
    ...
    class _Cast_CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis:
        ...
        def __init__(
            self: "CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis",
            parent: "CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis.TYPE",
    ):
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_6594.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis]":
    ...
    def cast_to(
        self: Self,
    ) -> "CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis":
        return self._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis(
            self
        )
