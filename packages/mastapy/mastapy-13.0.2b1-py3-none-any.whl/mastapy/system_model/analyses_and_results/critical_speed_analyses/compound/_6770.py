...
class RollingRingConnectionCompoundCriticalSpeedAnalysis(
    ...
    _CastSelf = TypeVar(
        "_CastSelf", bound="_Cast_RollingRingConnectionCompoundCriticalSpeedAnalysis"
    )
    ...
    class _Cast_RollingRingConnectionCompoundCriticalSpeedAnalysis:
        ...
        def __init__(
            self: "RollingRingConnectionCompoundCriticalSpeedAnalysis._Cast_RollingRingConnectionCompoundCriticalSpeedAnalysis",
            parent: "RollingRingConnectionCompoundCriticalSpeedAnalysis",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "RollingRingConnectionCompoundCriticalSpeedAnalysis.TYPE",
    ):
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_6640.RollingRingConnectionCriticalSpeedAnalysis]":
    ...
    def cast_to(
        self: Self,
    ) -> "RollingRingConnectionCompoundCriticalSpeedAnalysis._Cast_RollingRingConnectionCompoundCriticalSpeedAnalysis":
        return self._Cast_RollingRingConnectionCompoundCriticalSpeedAnalysis(self)
