...
class FaceGearSetCriticalSpeedAnalysis(_6608.GearSetCriticalSpeedAnalysis):
    """FaceGearSetCriticalSpeedAnalysis
    ...
    def face_gears_critical_speed_analysis(
        self: Self,
    ) -> "List[_6601.FaceGearCriticalSpeedAnalysis]":
    ...
    def face_meshes_critical_speed_analysis(
        self: Self,
    ) -> "List[_6602.FaceGearMeshCriticalSpeedAnalysis]":
