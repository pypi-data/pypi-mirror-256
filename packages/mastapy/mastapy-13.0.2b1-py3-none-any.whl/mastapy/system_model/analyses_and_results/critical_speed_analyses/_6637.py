...
class RingPinsCriticalSpeedAnalysis(_6625.MountableComponentCriticalSpeedAnalysis):
    """RingPinsCriticalSpeedAnalysis
    ...
    _CastSelf = TypeVar("_CastSelf", bound="_Cast_RingPinsCriticalSpeedAnalysis")

    class _Cast_RingPinsCriticalSpeedAnalysis:
        """Special nested class for casting RingPinsCriticalSpeedAnalysis to subclasses."""

        def __init__(
            self: "RingPinsCriticalSpeedAnalysis._Cast_RingPinsCriticalSpeedAnalysis",
            parent: "RingPinsCriticalSpeedAnalysis",
        ):
            self._parent = parent
    ...
    def __init__(self: Self, instance_to_wrap: "RingPinsCriticalSpeedAnalysis.TYPE"):
    ...
    def cast_to(
        self: Self,
    ) -> "RingPinsCriticalSpeedAnalysis._Cast_RingPinsCriticalSpeedAnalysis":
        return self._Cast_RingPinsCriticalSpeedAnalysis(self)
