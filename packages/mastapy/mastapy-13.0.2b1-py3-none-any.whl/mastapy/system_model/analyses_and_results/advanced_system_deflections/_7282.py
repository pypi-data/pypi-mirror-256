...
class AssemblyAdvancedSystemDeflection(_7272.AbstractAssemblyAdvancedSystemDeflection):
    """AssemblyAdvancedSystemDeflection
    ...
    @property
    def bearings(self: Self) -> "List[_7283.BearingAdvancedSystemDeflection]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_7285.BeltDriveAdvancedSystemDeflection]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_7295.BoltedJointAdvancedSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_7294.BoltAdvancedSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7316.CVTAdvancedSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_7296.ClutchAdvancedSystemDeflection]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7301.ConceptCouplingAdvancedSystemDeflection]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7306.ConceptGearSetAdvancedSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7319.CycloidalAssemblyAdvancedSystemDeflection]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_7320.CycloidalDiscAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7325.CylindricalGearSetAdvancedSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_7333.FEPartAdvancedSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_7332.FaceGearSetAdvancedSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7334.FlexiblePinAssemblyAdvancedSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_7341.HypoidGearSetAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7348.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_7351.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_7353.MassDiscAdvancedSystemDeflection]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7354.MeasurementComponentAdvancedSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_7356.OilSealAdvancedSystemDeflection]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7363.PlanetCarrierAdvancedSystemDeflection]":
    ...
    @property
    def point_loads(self: Self) -> "List[_7364.PointLoadAdvancedSystemDeflection]":
    ...
    @property
    def power_loads(self: Self) -> "List[_7365.PowerLoadAdvancedSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_7367.RingPinsAdvancedSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7374.ShaftHubConnectionAdvancedSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_7373.ShaftAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7379.SpiralBevelGearSetAdvancedSystemDeflection]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7380.SpringDamperAdvancedSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_7385.StraightBevelDiffGearSetAdvancedSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7388.StraightBevelGearSetAdvancedSystemDeflection]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_7391.SynchroniserAdvancedSystemDeflection]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7395.TorqueConverterAdvancedSystemDeflection]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7400.UnbalancedMassAdvancedSystemDeflection]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_7404.WormGearSetAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_7407.ZerolBevelGearSetAdvancedSystemDeflection]":
