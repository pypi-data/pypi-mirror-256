...
class FaceGearSetAdvancedSystemDeflection(_7337.GearSetAdvancedSystemDeflection):
    """FaceGearSetAdvancedSystemDeflection
    ...
    def face_gears_advanced_system_deflection(
        self: Self,
    ) -> "List[_7330.FaceGearAdvancedSystemDeflection]":
    ...
    def face_meshes_advanced_system_deflection(
        self: Self,
    ) -> "List[_7331.FaceGearMeshAdvancedSystemDeflection]":
