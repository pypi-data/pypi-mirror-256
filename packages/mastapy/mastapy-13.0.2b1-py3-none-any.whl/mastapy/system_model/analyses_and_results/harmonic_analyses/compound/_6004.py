...
class WormGearCompoundHarmonicAnalysis(_5939.GearCompoundHarmonicAnalysis):
    """WormGearCompoundHarmonicAnalysis
    ...
    _CastSelf = TypeVar("_CastSelf", bound="_Cast_WormGearCompoundHarmonicAnalysis")
    ...
    class _Cast_WormGearCompoundHarmonicAnalysis:
        ...
        def __init__(
            self: "WormGearCompoundHarmonicAnalysis._Cast_WormGearCompoundHarmonicAnalysis",
            parent: "WormGearCompoundHarmonicAnalysis",
        ):
            self._parent = parent
    ...
    def __init__(self: Self, instance_to_wrap: "WormGearCompoundHarmonicAnalysis.TYPE"):
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5840.WormGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.WormGearHarmonicAnalysis]
    ...
    def cast_to(
        self: Self,
    ) -> "WormGearCompoundHarmonicAnalysis._Cast_WormGearCompoundHarmonicAnalysis":
        return self._Cast_WormGearCompoundHarmonicAnalysis(self)
