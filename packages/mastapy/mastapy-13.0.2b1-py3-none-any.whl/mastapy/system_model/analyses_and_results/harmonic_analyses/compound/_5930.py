...
class CylindricalGearSetCompoundHarmonicAnalysis(_5941.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    def cylindrical_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5928.CylindricalGearCompoundHarmonicAnalysis]":
    ...
    def cylindrical_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5929.CylindricalGearMeshCompoundHarmonicAnalysis]":
