...
class StraightBevelDiffGearMeshHarmonicAnalysis(_5698.BevelGearMeshHarmonicAnalysis):
    """StraightBevelDiffGearMeshHarmonicAnalysis
    ...
    _CastSelf = TypeVar(
        "_CastSelf", bound="_Cast_StraightBevelDiffGearMeshHarmonicAnalysis"
    )
    ...
    class _Cast_StraightBevelDiffGearMeshHarmonicAnalysis:
        ...
        def __init__(
            self: "StraightBevelDiffGearMeshHarmonicAnalysis._Cast_StraightBevelDiffGearMeshHarmonicAnalysis",
            parent: "StraightBevelDiffGearMeshHarmonicAnalysis",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self, instance_to_wrap: "StraightBevelDiffGearMeshHarmonicAnalysis.TYPE"
    ):
    ...
    def cast_to(
        self: Self,
    ) -> "StraightBevelDiffGearMeshHarmonicAnalysis._Cast_StraightBevelDiffGearMeshHarmonicAnalysis":
        return self._Cast_StraightBevelDiffGearMeshHarmonicAnalysis(self)
