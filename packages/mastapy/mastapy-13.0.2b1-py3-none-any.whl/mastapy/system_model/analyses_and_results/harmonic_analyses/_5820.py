...
class StiffnessOptionsForHarmonicAnalysis(
    _7538.AbstractAnalysisOptions["_6807.StaticLoadCase"]
):
    """StiffnessOptionsForHarmonicAnalysis
    ...
    @property
    def curve_with_stiffness_steps(self: Self) -> "_1869.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def torque_input_type(self: Self, value: "_5771.HarmonicAnalysisTorqueInputType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def torque_speed_curve(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def torque_speed_curve(self: Self, value: "_1536.Vector2DListAccessor"):
