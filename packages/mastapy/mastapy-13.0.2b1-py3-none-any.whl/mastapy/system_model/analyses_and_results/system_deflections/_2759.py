...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.measured_vectors import _1566, _1562
    from mastapy.system_model.fe import _2412
...
class FEPartSystemDeflection(_2688.AbstractShaftOrHousingSystemDeflection):
    """FEPartSystemDeflection
    ...
    class _Cast_FEPartSystemDeflection:
        ...
        @property
        def part_analysis(self: "FEPartSystemDeflection._Cast_FEPartSystemDeflection"):
    ...
    @property
    def power_flow_results(self: Self) -> "_4093.FEPartPowerFlow":
    ...
    @property
    def export(self: Self) -> "_2412.SystemDeflectionFEExportOptions":
