...
class CylindricalGearMeshSystemDeflection(_2761.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def gear_a(self: Self) -> "_2747.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: Self) -> "_2747.CylindricalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4082.CylindricalGearMeshPowerFlow":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_2747.CylindricalGearSystemDeflection]":
    ...
    def cylindrical_meshed_gear_system_deflections(
        self: Self,
    ) -> "List[_2751.CylindricalMeshedGearSystemDeflection]":
    ...
    @property
    def mesh_deflections_left_flank(self: Self) -> "List[_2847.MeshDeflectionResults]":
    ...
    @property
    def mesh_deflections_right_flank(self: Self) -> "List[_2847.MeshDeflectionResults]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.MeshDeflectionResults]
    ...
    @property
    def gear_set(self: Self) -> "_2744.CylindricalGearSetSystemDeflection":
