...
class AssemblyCompoundSystemDeflection(_2853.AbstractAssemblyCompoundSystemDeflection):
    """AssemblyCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2694.AssemblySystemDeflection]":
    ...
    @property
    def bearings(self: Self) -> "List[_2861.BearingCompoundSystemDeflection]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_2863.BeltDriveCompoundSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_2866.BevelDifferentialGearSetCompoundSystemDeflection]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_2873.BoltedJointCompoundSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_2872.BoltCompoundSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_2894.CVTCompoundSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_2874.ClutchCompoundSystemDeflection]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_2879.ConceptCouplingCompoundSystemDeflection]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_2884.ConceptGearSetCompoundSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_2896.CycloidalAssemblyCompoundSystemDeflection]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_2898.CycloidalDiscCompoundSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_2902.CylindricalGearSetCompoundSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_2910.FEPartCompoundSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_2909.FaceGearSetCompoundSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_2911.FlexiblePinAssemblyCompoundSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_2918.HypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_2925.KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_2928.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_2929.MassDiscCompoundSystemDeflection]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_2930.MeasurementComponentCompoundSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_2932.OilSealCompoundSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_2934.PartToPartShearCouplingCompoundSystemDeflection]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_2939.PlanetCarrierCompoundSystemDeflection]":
    ...
    @property
    def point_loads(self: Self) -> "List[_2940.PointLoadCompoundSystemDeflection]":
    ...
    @property
    def power_loads(self: Self) -> "List[_2941.PowerLoadCompoundSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_2943.RingPinsCompoundSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: Self) -> "List[_2861.BearingCompoundSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.compound.BearingCompoundSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_2945.RollingRingAssemblyCompoundSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_2951.ShaftHubConnectionCompoundSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_2949.ShaftCompoundSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_2956.SpiralBevelGearSetCompoundSystemDeflection]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_2957.SpringDamperCompoundSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_2962.StraightBevelDiffGearSetCompoundSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_2965.StraightBevelGearSetCompoundSystemDeflection]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_2968.SynchroniserCompoundSystemDeflection]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_2972.TorqueConverterCompoundSystemDeflection]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_2976.UnbalancedMassCompoundSystemDeflection]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_2980.WormGearSetCompoundSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_2983.ZerolBevelGearSetCompoundSystemDeflection]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_2694.AssemblySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.AssemblySystemDeflection]
