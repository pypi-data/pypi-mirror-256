...
class ShaftSystemDeflection(_2689.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    class _Cast_ShaftSystemDeflection:
        ...
        @property
        def part_fe_analysis(self: "ShaftSystemDeflection._Cast_ShaftSystemDeflection"):
        ...
        @property
        def part_analysis(self: "ShaftSystemDeflection._Cast_ShaftSystemDeflection"):
    ...
    @property
    def power_flow_results(self: Self) -> "_4135.ShaftPowerFlow":
    ...
    @property
    def mounted_components_applying_torque(self: Self) -> "List[_1563.ForceResults]":
    ...
    def shaft_section_end_results_by_offset_with_worst_safety_factor(
        self: Self,
    ) -> "List[_2804.ShaftSectionEndResultsSystemDeflection]":
    ...
    @property
    def shaft_section_results(self: Self) -> "List[_2805.ShaftSectionSystemDeflection]":
