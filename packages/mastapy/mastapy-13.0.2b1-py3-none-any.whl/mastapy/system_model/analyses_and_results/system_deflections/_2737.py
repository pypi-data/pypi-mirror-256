...
class CycloidalAssemblySystemDeflection(_2808.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4077.CycloidalAssemblyPowerFlow":
    ...
    def ring_pins_to_disc_connections(
        self: Self,
    ) -> "List[_2797.RingPinsToDiscConnectionSystemDeflection]":
