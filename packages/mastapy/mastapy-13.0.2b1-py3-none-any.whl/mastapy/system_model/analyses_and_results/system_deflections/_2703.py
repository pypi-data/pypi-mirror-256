...
class BevelDifferentialGearMeshSystemDeflection(_2708.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4045.BevelDifferentialGearMeshPowerFlow":
