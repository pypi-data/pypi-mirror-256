...
class PulleySystemDeflection(_2732.CouplingHalfSystemDeflection):
    """PulleySystemDeflection
    ...
    class _Cast_PulleySystemDeflection:
        ...
        @property
        def part_analysis(self: "PulleySystemDeflection._Cast_PulleySystemDeflection"):
    ...
    @property
    def power_flow_results(self: Self) -> "_4127.PulleyPowerFlow":
