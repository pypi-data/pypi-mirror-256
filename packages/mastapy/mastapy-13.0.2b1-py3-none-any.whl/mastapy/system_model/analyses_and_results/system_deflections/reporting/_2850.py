...
class RigidlyConnectedComponentGroupSystemDeflection(_2654.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    class _Cast_RigidlyConnectedComponentGroupSystemDeflection:
        ...
        def design_entity_group_analysis(
            ...
            return self._parent._cast(_2654.DesignEntityGroupAnalysis)
    ...
    @property
    def mass_properties(self: Self) -> "_1519.MassProperties":
    ...
    @property
    def components(self: Self) -> "List[_2717.ComponentSystemDeflection]":
