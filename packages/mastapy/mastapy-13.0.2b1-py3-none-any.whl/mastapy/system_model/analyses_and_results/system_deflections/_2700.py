...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2441, _2443
    from mastapy.bearings.bearing_results import _1951, _1943
...
class BearingSystemDeflection(_2730.ConnectorSystemDeflection):
    """BearingSystemDeflection
    ...
    @property
    def spring_preload_chart(self: Self) -> "_1869.TwoDChartDefinition":
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1951.LoadedBearingResults":
    ...
    @property
    def power_flow_results(self: Self) -> "_4042.BearingPowerFlow":
    ...
    @property
    def preload_spring_stiffness(self: Self) -> "_1943.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_between_rings(self: Self) -> "_1943.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_matrix(self: Self) -> "_1943.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    def race_mounting_options_for_analysis(
        self: Self,
    ) -> "List[_2443.BearingRaceMountingOptions]":
    ...
    def stiffness_between_each_ring(
        self: Self,
    ) -> "List[_1943.BearingStiffnessMatrixReporter]":
