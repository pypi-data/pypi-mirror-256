...
if TYPE_CHECKING:
    from mastapy.utility.units_and_measurements import _1607
...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1607.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1607.MeasurementBase")
...
class ShaftComplexShape(_0.APIBase, Generic[TLinearMeasurement, TAngularMeasurement]):
    ...
    class _Cast_ShaftComplexShape:
        ...
        def shaft_forced_complex_shape(
            ...
            return self._parent._cast(_4030.ShaftForcedComplexShape)
        ...
        def shaft_modal_complex_shape(
            ...
            return self._parent._cast(_4031.ShaftModalComplexShape)

        @property
        def shaft_modal_complex_shape_at_speeds(
            self: "ShaftComplexShape._Cast_ShaftComplexShape",
        ):
            from mastapy.system_model.analyses_and_results.rotor_dynamics import _4032

            return self._parent._cast(_4032.ShaftModalComplexShapeAtSpeeds)

        @property
        def shaft_modal_complex_shape_at_stiffness(
            self: "ShaftComplexShape._Cast_ShaftComplexShape",
        ):
            from mastapy.system_model.analyses_and_results.rotor_dynamics import _4033

            return self._parent._cast(_4033.ShaftModalComplexShapeAtStiffness)
