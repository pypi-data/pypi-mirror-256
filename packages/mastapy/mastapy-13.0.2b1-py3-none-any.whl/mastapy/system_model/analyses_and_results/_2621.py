...
class CompoundAnalysis(_7555.MarshalByRefObjectPermanent):
    """CompoundAnalysis
    ...
    class _Cast_CompoundAnalysis:
        ...
        def compound_advanced_system_deflection_analysis(
            ...
            return self._parent._cast(_2660.CompoundAdvancedSystemDeflectionAnalysis)
        ...
        def compound_advanced_system_deflection_sub_analysis(
            ...
            return self._parent._cast(_2661.CompoundAdvancedSystemDeflectionSubAnalysis)
        ...
        def compound_critical_speed_analysis(
            ...
            return self._parent._cast(_2663.CompoundCriticalSpeedAnalysis)

        @property
        def compound_dynamic_analysis(self: "CompoundAnalysis._Cast_CompoundAnalysis"):
            from mastapy.system_model.analyses_and_results import _2664

            return self._parent._cast(_2664.CompoundDynamicAnalysis)
        ...
        def compound_dynamic_model_at_a_stiffness_analysis(
            ...
            return self._parent._cast(_2665.CompoundDynamicModelAtAStiffnessAnalysis)
        ...
        def compound_dynamic_model_for_harmonic_analysis(
            ...
            return self._parent._cast(_2666.CompoundDynamicModelForHarmonicAnalysis)
        ...
        def compound_dynamic_model_for_modal_analysis(
            ...
            return self._parent._cast(_2667.CompoundDynamicModelForModalAnalysis)
        ...
        def compound_dynamic_model_for_stability_analysis(
            ...
            return self._parent._cast(_2668.CompoundDynamicModelForStabilityAnalysis)
        ...
        @property
        def compound_harmonic_analysis(self: "CompoundAnalysis._Cast_CompoundAnalysis"):
            from mastapy.system_model.analyses_and_results import _2670

            return self._parent._cast(_2670.CompoundHarmonicAnalysis)
        ...
        def compound_harmonic_analysis_for_advanced_time_stepping_analysis_for_modulation(
            ...
            return self._parent._cast(
                _2671.CompoundHarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
            )
        ...
        @property
        def compound_modal_analysis(self: "CompoundAnalysis._Cast_CompoundAnalysis"):
            from mastapy.system_model.analyses_and_results import _2673

            return self._parent._cast(_2673.CompoundModalAnalysis)
        ...
        def compound_modal_analysis_at_a_speed(
            ...
            return self._parent._cast(_2674.CompoundModalAnalysisAtASpeed)
        ...
        def compound_modal_analysis_at_a_stiffness(
            ...
            return self._parent._cast(_2675.CompoundModalAnalysisAtAStiffness)
        ...
        def compound_modal_analysis_for_harmonic_analysis(
            ...
            return self._parent._cast(_2676.CompoundModalAnalysisForHarmonicAnalysis)
        ...
        def compound_multibody_dynamics_analysis(
            ...
            return self._parent._cast(_2677.CompoundMultibodyDynamicsAnalysis)
        ...
        def compound_power_flow_analysis(
            ...
            return self._parent._cast(_2678.CompoundPowerFlowAnalysis)
        ...
        def compound_stability_analysis(
            ...
            return self._parent._cast(_2679.CompoundStabilityAnalysis)
        ...
        def compound_system_deflection_analysis(
            ...
            return self._parent._cast(_2683.CompoundSystemDeflectionAnalysis)
        ...
        def compound_torsional_system_deflection_analysis(
            ...
            return self._parent._cast(_2684.CompoundTorsionalSystemDeflectionAnalysis)
    ...
    def perform_analysis_with_progress(self: Self, progress: "_7561.TaskProgress"):
        """Method does not return.
    ...
    ) -> "Iterable[_7545.DesignEntityCompoundAnalysis]":
