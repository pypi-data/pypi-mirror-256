...
class ClutchSocket(_2349.CouplingSocket):
    """ClutchSocket
    ...
    class _Cast_ClutchSocket:
        ...
        @property
        def coupling_socket(self: "ClutchSocket._Cast_ClutchSocket"):
            return self._parent._cast(_2349.CouplingSocket)

        @property
        def cylindrical_socket(self: "ClutchSocket._Cast_ClutchSocket"):
            from mastapy.system_model.connections_and_sockets import _2278

            return self._parent._cast(_2278.CylindricalSocket)

        @property
        def socket(self: "ClutchSocket._Cast_ClutchSocket"):
