...
class PulleySocket(_2278.CylindricalSocket):
    """PulleySocket
    ...
    class _Cast_PulleySocket:
        ...
        @property
        def cylindrical_socket(self: "PulleySocket._Cast_PulleySocket"):
            return self._parent._cast(_2278.CylindricalSocket)

        @property
        def socket(self: "PulleySocket._Cast_PulleySocket"):
            from mastapy.system_model.connections_and_sockets import _2298

            return self._parent._cast(_2298.Socket)

        @property
        def cvt_pulley_socket(self: "PulleySocket._Cast_PulleySocket"):
