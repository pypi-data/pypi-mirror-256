...
class PlanetarySocket(_2291.PlanetarySocketBase):
    """PlanetarySocket
    ...
    class _Cast_PlanetarySocket:
        ...
        @property
        def planetary_socket_base(self: "PlanetarySocket._Cast_PlanetarySocket"):
            return self._parent._cast(_2291.PlanetarySocketBase)

        @property
        def cylindrical_socket(self: "PlanetarySocket._Cast_PlanetarySocket"):
            from mastapy.system_model.connections_and_sockets import _2278

            return self._parent._cast(_2278.CylindricalSocket)

        @property
        def socket(self: "PlanetarySocket._Cast_PlanetarySocket"):
