...
class CVTPulleySocket(_2292.PulleySocket):
    """CVTPulleySocket
    ...
    class _Cast_CVTPulleySocket:
        ...
        @property
        def pulley_socket(self: "CVTPulleySocket._Cast_CVTPulleySocket"):
            return self._parent._cast(_2292.PulleySocket)

        @property
        def cylindrical_socket(self: "CVTPulleySocket._Cast_CVTPulleySocket"):
            from mastapy.system_model.connections_and_sockets import _2278

            return self._parent._cast(_2278.CylindricalSocket)

        @property
        def socket(self: "CVTPulleySocket._Cast_CVTPulleySocket"):
