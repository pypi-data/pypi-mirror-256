...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1262, _1268, _1287
...
class ElectricMachineGroup(_0.APIBase):
    ...
    @property
    def electric_machine_details(self: Self) -> "List[_1262.ElectricMachineDetail]":
    ...
    def electric_machine_load_case_groups(
        self: Self,
    ) -> "List[_1361.ElectricMachineLoadCaseGroup]":
    ...
    def add_electric_machine_detail(
        self: Self, type_: "_1268.ElectricMachineType", name: "str" = "Motor"
    ...
    def duplicate_electric_machine_detail(
        self: Self, detail: "_1262.ElectricMachineDetail"
    ...
    def remove_electric_machine_detail(
        self: Self, motor: "_1262.ElectricMachineDetail"
    ) -> "bool":
        """bool
    ...
    def try_remove_load_case_group(
        self: Self, load_case_group: "_1361.ElectricMachineLoadCaseGroup"
    ) -> "bool":
        """bool
