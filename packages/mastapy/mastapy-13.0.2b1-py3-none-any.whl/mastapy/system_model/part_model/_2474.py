...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2451, _2483
...
class PowerLoad(_2481.VirtualComponent):
    """PowerLoad
    ...
    class _Cast_PowerLoad:
        ...
        @property
        def virtual_component(self: "PowerLoad._Cast_PowerLoad"):
            return self._parent._cast(_2481.VirtualComponent)

        @property
        def mountable_component(self: "PowerLoad._Cast_PowerLoad"):
            from mastapy.system_model.part_model import _2466

            return self._parent._cast(_2466.MountableComponent)

        @property
        def component(self: "PowerLoad._Cast_PowerLoad"):
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "PowerLoad._Cast_PowerLoad"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "PowerLoad._Cast_PowerLoad"):
    ...
    @enforce_parameter_types
    def electric_machine_detail_selector(
        self: Self, value: "_1262.ElectricMachineDetail"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: Self, value: "_2451.ElectricMachineSearchRegionSpecificationMethod"
    ):
    ...
    @property
    def engine_fuel_consumption_grid(self: Self) -> "_1567.GriddedSurfaceAccessor":
    ...
    @enforce_parameter_types
    def engine_fuel_consumption_grid(self: Self, value: "_1567.GriddedSurfaceAccessor"):
        self.wrapped.EngineFuelConsumptionGrid = value.wrapped

    @property
    def engine_torque_grid(self: Self) -> "_1567.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def engine_torque_grid(self: Self, value: "_1567.GriddedSurfaceAccessor"):
    ...
    @enforce_parameter_types
    def power_load_type(self: Self, value: "_2221.PowerLoadType"):
    ...
    @property
    def electric_machine_detail(self: Self) -> "_1262.ElectricMachineDetail":
    ...
    @property
    def single_blade_details(self: Self) -> "_2483.WindTurbineSingleBladeDetails":
