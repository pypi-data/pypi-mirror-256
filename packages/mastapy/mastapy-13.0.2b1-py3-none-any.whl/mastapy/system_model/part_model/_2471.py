...
class PlanetCarrier(_2466.MountableComponent):
    """PlanetCarrier
    ...
    class _Cast_PlanetCarrier:
        ...
        @property
        def mountable_component(self: "PlanetCarrier._Cast_PlanetCarrier"):
            return self._parent._cast(_2466.MountableComponent)

        @property
        def component(self: "PlanetCarrier._Cast_PlanetCarrier"):
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "PlanetCarrier._Cast_PlanetCarrier"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "PlanetCarrier._Cast_PlanetCarrier"):
    ...
    @property
    def planetary_sockets(self: Self) -> "List[_2290.PlanetarySocket]":
