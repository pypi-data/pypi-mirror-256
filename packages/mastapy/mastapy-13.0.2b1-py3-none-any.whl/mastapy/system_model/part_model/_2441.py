...
from mastapy.bearings.bearing_results import _1944, _1963
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1875, _1888, _1871
    from mastapy.system_model.part_model import _2442, _2440, _2475, _2443, _2447
...
class Bearing(_2449.Connector):
    ...
    class _Cast_Bearing:
        ...
        @property
        def connector(self: "Bearing._Cast_Bearing"):
            return self._parent._cast(_2449.Connector)

        @property
        def mountable_component(self: "Bearing._Cast_Bearing"):
            from mastapy.system_model.part_model import _2466

            return self._parent._cast(_2466.MountableComponent)

        @property
        def component(self: "Bearing._Cast_Bearing"):
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "Bearing._Cast_Bearing"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "Bearing._Cast_Bearing"):
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(self: Self, value: "_1905.BearingToleranceClass"):
    ...
    @enforce_parameter_types
    def bearing_tolerance_definition(
        self: Self, value: "_1906.BearingToleranceDefinitionOptions"
    ):
    ...
    @property
    def damping_options(self: Self) -> "_1875.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1875", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(self: Self, value: "_1875.BearingDampingMatrixOption"):
        value = conversion.mp_to_pn_enum(
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2442", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: Self, value: "_2442.BearingF0InputMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: Self) -> "_1788.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: Self) -> "_1888.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1888", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: Self, value: "_1888.JournalBearingType"):
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: Self, value: "_1879.BearingModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def outer_fitting_chart(self: Self) -> "_1788.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    def permissible_axial_load_calculation_method(
        self: Self,
        value: "Union[_1944.CylindricalRollerMaxAxialLoadMethod, Tuple[_1944.CylindricalRollerMaxAxialLoadMethod, bool]]",
    ):
        wrapper_type = (
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: Self, value: "_1963.PreloadType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def detail(self: Self) -> "_2132.BearingDesign":
    ...
    @property
    def friction_coefficients(self: Self) -> "_2072.RollingBearingFrictionCoefficients":
    ...
    @property
    def inner_support_detail(self: Self) -> "_1922.SupportDetail":
    ...
    @property
    def left_support_detail(self: Self) -> "_1922.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def outer_support_detail(self: Self) -> "_1922.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def right_support_detail(self: Self) -> "_1922.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def ring_tolerance_inner(self: Self) -> "_1908.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: Self) -> "_1919.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: Self) -> "_1914.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: Self) -> "_1919.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: Self) -> "_2132.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: Self) -> "_1909.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: Self) -> "_1924.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: Self) -> "_1915.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: Self) -> "_1924.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def mounting(self: Self) -> "List[_2443.BearingRaceMountingOptions]":
    ...
    @property
    def tolerance_combinations(self: Self) -> "List[_1926.ToleranceCombination]":
    ...
    def set_detail_from_catalogue(
        self: Self, catalogue: "_1871.BearingCatalog", designation: "str"
    ):
    ...
    def try_attach_left_side_to(
        self: Self, shaft: "_2484.Shaft", offset: "float" = float("nan")
