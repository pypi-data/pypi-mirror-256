...
class ConnectorFromCAD(_2506.MountableComponentFromCAD):
    """ConnectorFromCAD
    ...
    @property
    def mounting(self: Self) -> "_2505.HousedOrMounted":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.import_from_cad._2505", "HousedOrMounted"
        )(value)

    @mounting.setter
    @enforce_parameter_types
    def mounting(self: Self, value: "_2505.HousedOrMounted"):
