...
class CylindricalGearFromCAD(_2506.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: Self, value: "_2528.CylindricalGearSet"):
        wrapper_type = (
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: Self, value: "_2527.CylindricalGear"):
        wrapper_type = (
