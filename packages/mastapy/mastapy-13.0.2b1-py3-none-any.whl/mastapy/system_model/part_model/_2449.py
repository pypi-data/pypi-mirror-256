...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2437, _2446, _2447
    from mastapy.system_model.connections_and_sockets import _2274, _2278
...
class Connector(_2466.MountableComponent):
    """Connector
    ...
    class _Cast_Connector:
        ...
        @property
        def mountable_component(self: "Connector._Cast_Connector"):
            return self._parent._cast(_2466.MountableComponent)

        @property
        def component(self: "Connector._Cast_Connector"):
            return self._parent._cast(_2446.Component)

        @property
        def part(self: "Connector._Cast_Connector"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "Connector._Cast_Connector"):
            from mastapy.system_model import _2205

            return self._parent._cast(_2205.DesignEntity)

        @property
        def bearing(self: "Connector._Cast_Connector"):
            from mastapy.system_model.part_model import _2441

            return self._parent._cast(_2441.Bearing)

        @property
        def oil_seal(self: "Connector._Cast_Connector"):
            from mastapy.system_model.part_model import _2468

            return self._parent._cast(_2468.OilSeal)

        @property
        def shaft_hub_connection(self: "Connector._Cast_Connector"):
    ...
    @property
    def outer_component(self: Self) -> "_2437.AbstractShaft":
    ...
    @property
    def outer_connection(self: Self) -> "_2274.Connection":
    ...
    @property
    def outer_socket(self: Self) -> "_2278.CylindricalSocket":
