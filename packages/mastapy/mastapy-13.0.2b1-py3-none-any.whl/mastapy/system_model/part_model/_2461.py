...
from mastapy.bearings.tolerances import _1904, _1906
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    class _Cast_InternalClearanceTolerance:
        ...
        def axial_internal_clearance_tolerance(
            ...
            return self._parent._cast(_2440.AxialInternalClearanceTolerance)
        ...
        def radial_internal_clearance_tolerance(
            ...
            return self._parent._cast(_2475.RadialInternalClearanceTolerance)
    ...
    def clearance_class(self: Self, value: "_1904.InternalClearanceClass"):
