...
class Bolt(_2446.Component):
    ...
    class _Cast_Bolt:
        ...
        @property
        def component(self: "Bolt._Cast_Bolt"):
            return self._parent._cast(_2446.Component)

        @property
        def part(self: "Bolt._Cast_Bolt"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "Bolt._Cast_Bolt"):
    ...
    @property
    def bolted_joint(self: Self) -> "_2445.BoltedJoint":
    ...
    @property
    def loaded_bolt(self: Self) -> "_1483.LoadedBolt":
