...
class Clutch(_2585.Coupling):
    ...
    @property
    def angular_speed_temperature_grid(self: Self) -> "_1567.GriddedSurfaceAccessor":
    ...
    @property
    def clutch_type(self: Self) -> "_2582.ClutchType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.couplings._2582", "ClutchType"
        )(value)

    @clutch_type.setter
    @enforce_parameter_types
    def clutch_type(self: Self, value: "_2582.ClutchType"):
    ...
    @property
    def flow_rate_vs_speed(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def flow_rate_vs_speed(self: Self, value: "_1536.Vector2DListAccessor"):
    ...
    @property
    def linear_speed_temperature_grid(self: Self) -> "_1567.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @property
    def spring_type(self: Self) -> "_5404.ClutchSpringType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5404",
            "ClutchSpringType",
        )(value)

    @spring_type.setter
    @enforce_parameter_types
    def spring_type(self: Self, value: "_5404.ClutchSpringType"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ClutchSpringType",
        )
    ...
    @property
    def clutch_connection(self: Self) -> "_2344.ClutchConnection":
