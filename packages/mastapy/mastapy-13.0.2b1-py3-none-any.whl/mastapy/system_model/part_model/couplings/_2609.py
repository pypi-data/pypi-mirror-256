...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2610, _2612
...
class TorqueConverter(_2585.Coupling):
    """TorqueConverter
    ...
    class _Cast_TorqueConverter:
        ...
        @property
        def coupling(self: "TorqueConverter._Cast_TorqueConverter"):
            return self._parent._cast(_2585.Coupling)

        @property
        def specialised_assembly(self: "TorqueConverter._Cast_TorqueConverter"):
            from mastapy.system_model.part_model import _2478

            return self._parent._cast(_2478.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "TorqueConverter._Cast_TorqueConverter"):
            from mastapy.system_model.part_model import _2436

            return self._parent._cast(_2436.AbstractAssembly)

        @property
        def part(self: "TorqueConverter._Cast_TorqueConverter"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "TorqueConverter._Cast_TorqueConverter"):
    ...
    @property
    def pump(self: Self) -> "_2610.TorqueConverterPump":
    ...
    @property
    def turbine(self: Self) -> "_2612.TorqueConverterTurbine":
