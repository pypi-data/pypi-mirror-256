...
class OilSeal(_2449.Connector):
    ...
    class _Cast_OilSeal:
        ...
        @property
        def connector(self: "OilSeal._Cast_OilSeal"):
            return self._parent._cast(_2449.Connector)

        @property
        def mountable_component(self: "OilSeal._Cast_OilSeal"):
            from mastapy.system_model.part_model import _2466

            return self._parent._cast(_2466.MountableComponent)

        @property
        def component(self: "OilSeal._Cast_OilSeal"):
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "OilSeal._Cast_OilSeal"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "OilSeal._Cast_OilSeal"):
    ...
    @property
    def drag_torque_vs_rotational_speed(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @property
    def oil_seal_orientation(self: Self) -> "_1962.Orientations":
    ...
    @enforce_parameter_types
    def oil_seal_orientation(self: Self, value: "_1962.Orientations"):
        value = conversion.mp_to_pn_enum(
