...
class CycloidalDisc(_2437.AbstractShaft):
    ...
    class _Cast_CycloidalDisc:
        ...
        @property
        def abstract_shaft(self: "CycloidalDisc._Cast_CycloidalDisc"):
            return self._parent._cast(_2437.AbstractShaft)

        @property
        def abstract_shaft_or_housing(self: "CycloidalDisc._Cast_CycloidalDisc"):
            from mastapy.system_model.part_model import _2438

            return self._parent._cast(_2438.AbstractShaftOrHousing)

        @property
        def component(self: "CycloidalDisc._Cast_CycloidalDisc"):
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "CycloidalDisc._Cast_CycloidalDisc"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "CycloidalDisc._Cast_CycloidalDisc"):
    ...
    @property
    def cycloidal_disc_design(self: Self) -> "_1455.CycloidalDiscDesign":
