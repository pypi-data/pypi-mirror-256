...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.cycloidal import _2572, _2571
...
class CycloidalAssembly(_2478.SpecialisedAssembly):
    """CycloidalAssembly
    ...
    class _Cast_CycloidalAssembly:
        ...
        @property
        def specialised_assembly(self: "CycloidalAssembly._Cast_CycloidalAssembly"):
            return self._parent._cast(_2478.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "CycloidalAssembly._Cast_CycloidalAssembly"):
            from mastapy.system_model.part_model import _2436

            return self._parent._cast(_2436.AbstractAssembly)

        @property
        def part(self: "CycloidalAssembly._Cast_CycloidalAssembly"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "CycloidalAssembly._Cast_CycloidalAssembly"):
    ...
    @property
    def cycloidal_assembly_design(self: Self) -> "_1454.CycloidalAssemblyDesign":
    ...
    @property
    def ring_pins(self: Self) -> "_2572.RingPins":
    ...
    @property
    def known_designs(self: Self) -> "List[_1454.CycloidalAssemblyDesign]":
    ...
    def add_disc(self: Self) -> "_2571.CycloidalDisc":
    ...
    def design_named(self: Self, name: "str") -> "_1454.CycloidalAssemblyDesign":
        """mastapy.cycloidal.CycloidalAssemblyDesign
    ...
    def set_active_cycloidal_assembly_design(
        self: Self, cycloidal_assembly_design: "_1454.CycloidalAssemblyDesign"
    ):
        """Method does not return.
    ...
    def try_remove_design(
        self: Self, design: "_1454.CycloidalAssemblyDesign"
    ) -> "bool":
        """bool
