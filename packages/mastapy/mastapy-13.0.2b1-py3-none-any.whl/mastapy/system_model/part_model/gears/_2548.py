...
class StraightBevelDiffGearSet(_2522.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self: Self) -> "List[_2547.StraightBevelDiffGear]":
    ...
    def straight_bevel_diff_meshes(
        self: Self,
    ) -> "List[_2327.StraightBevelDiffGearMesh]":
