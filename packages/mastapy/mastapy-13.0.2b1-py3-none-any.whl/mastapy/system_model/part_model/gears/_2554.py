...
class WormGearSet(_2534.GearSet):
    """WormGearSet
    ...
    class _Cast_WormGearSet:
        ...
        @property
        def gear_set(self: "WormGearSet._Cast_WormGearSet"):
            return self._parent._cast(_2534.GearSet)

        @property
        def specialised_assembly(self: "WormGearSet._Cast_WormGearSet"):
            from mastapy.system_model.part_model import _2478

            return self._parent._cast(_2478.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "WormGearSet._Cast_WormGearSet"):
            from mastapy.system_model.part_model import _2436

            return self._parent._cast(_2436.AbstractAssembly)

        @property
        def part(self: "WormGearSet._Cast_WormGearSet"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "WormGearSet._Cast_WormGearSet"):
    ...
    @property
    def worm_gears(self: Self) -> "List[_2553.WormGear]":
    ...
    @property
    def worm_meshes(self: Self) -> "List[_2331.WormGearMesh]":
