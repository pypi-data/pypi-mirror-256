...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.fe import _2378, _2369, _2370, _2401
...
class FESubstructureWithSelectionComponents(_2392.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    class _Cast_FESubstructureWithSelectionComponents:
        ...
        def fe_substructure_with_selection(
            ...
            return self._parent._cast(_2392.FESubstructureWithSelection)

        @property
        def base_fe_with_selection(
            self: "FESubstructureWithSelectionComponents._Cast_FESubstructureWithSelectionComponents",
        ):
            from mastapy.system_model.fe import _2362

            return self._parent._cast(_2362.BaseFEWithSelection)
    ...
    @property
    def manual_alignment(self: Self) -> "_1501.CoordinateSystemEditor":
    ...
    def beam_element_properties(
        self: Self,
    ) -> "List[_2378.ElementPropertiesWithSelection[_209.ElementPropertiesBeam]]":
    ...
    @property
    def component_links(self: Self) -> "List[_2422.FELinkWithSelection]":
    ...
    @property
    def contact_pairs(self: Self) -> "List[_2369.ContactPairWithSelection]":
    ...
    @property
    def coordinate_systems(self: Self) -> "List[_2370.CoordinateSystemWithSelection]":
    ...
    def interface_element_properties(
        self: Self,
    ) -> "List[_2378.ElementPropertiesWithSelection[_210.ElementPropertiesInterface]]":
    ...
    @property
    def links_for_electric_machine(self: Self) -> "List[_2422.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    @property
    def links_for_selected_component(self: Self) -> "List[_2422.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    def mass_element_properties(
        self: Self,
    ) -> "List[_2378.ElementPropertiesWithSelection[_211.ElementPropertiesMass]]":
    ...
    @property
    def materials(self: Self) -> "List[_2401.MaterialPropertiesWithSelection]":
    ...
    def other_element_properties(
        self: Self,
    ) -> "List[_2378.ElementPropertiesWithSelection[_208.ElementPropertiesBase]]":
    ...
    def rigid_element_properties(
        self: Self,
    ) -> "List[_2378.ElementPropertiesWithSelection[_212.ElementPropertiesRigid]]":
    ...
    def shell_element_properties(
        self: Self,
    ) -> "List[_2378.ElementPropertiesWithSelection[_213.ElementPropertiesShell]]":
    ...
    def solid_element_properties(
        self: Self,
    ) -> "List[_2378.ElementPropertiesWithSelection[_214.ElementPropertiesSolid]]":
    ...
    def spring_dashpot_element_properties(
        self: Self,
    ) -> "List[_2378.ElementPropertiesWithSelection[_215.ElementPropertiesSpringDashpot]]":
