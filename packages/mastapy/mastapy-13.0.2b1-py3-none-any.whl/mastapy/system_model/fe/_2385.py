...
from mastapy.system_model.part_model import _2446, _2450
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.units_and_measurements import _1612
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.fe import _2413, _2390
...
if TYPE_CHECKING:
    ...
    from mastapy.nodal_analysis import _70, _85, _60
    from mastapy.nodal_analysis.component_mode_synthesis import _233, _226
    from mastapy.materials import _237, _283
    from mastapy.system_model import _2222
    from mastapy.math_utility import _1500
    from mastapy.system_model.part_model import _2455
    from mastapy.nodal_analysis.geometry_modeller_link import _155, _157
...
class FESubstructure(_66.FEStiffness):
    ...
    class _Cast_FESubstructure:
        ...
        @property
        def fe_stiffness(self: "FESubstructure._Cast_FESubstructure"):
    ...
    @property
    def alignment_method(self: Self) -> "_2358.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2358", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: Self, value: "_2358.AlignmentMethod"):
    ...
    @property
    def bearing_node_alignment(self: Self) -> "_2364.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2364", "BearingNodeAlignmentOption"
        )(value)

    @bearing_node_alignment.setter
    @enforce_parameter_types
    def bearing_node_alignment(self: Self, value: "_2364.BearingNodeAlignmentOption"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def component_to_align_to(self: Self, value: "_2446.Component"):
        wrapper_type = (
    ...
    @datum.setter
    @enforce_parameter_types
    def datum(self: Self, value: "_2450.Datum"):
    ...
    @enforce_parameter_types
    def distance_display_unit(self: Self, value: "_1612.Unit"):
    ...
    @enforce_parameter_types
    def force_display_unit(self: Self, value: "_1612.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def reduction_mode_type(self: Self) -> "_233.ReductionModeType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.component_mode_synthesis._233", "ReductionModeType"
        )(value)

    @reduction_mode_type.setter
    @enforce_parameter_types
    def reduction_mode_type(self: Self, value: "_233.ReductionModeType"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def thermal_expansion_option(self: Self, value: "_2413.ThermalExpansionOption"):
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: Self, value: "_2390.FESubstructureType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def acoustic_radiation_efficiency(self: Self) -> "_237.AcousticRadiationEfficiency":
    ...
    def alignment_to_component(
        self: Self,
    ) -> "_2222.RelativeComponentAlignment[_2446.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2446.Component](temp)

    @property
    def cms_model(self: Self) -> "_226.CMSModel":
    ...
    @property
    def coordinate_system(self: Self) -> "_1500.CoordinateSystem3D":
    ...
    @property
    def export(self: Self) -> "_2386.FESubstructureExportOptions":
    ...
    @property
    def fe_meshing_options(self: Self) -> "_85.ShaftFEMeshingOptions":
    ...
    @property
    def fe_part(self: Self) -> "_2455.FEPart":
    ...
    @property
    def sound_pressure_enclosure(self: Self) -> "_283.SoundPressureEnclosure":
    ...
    @property
    def gear_meshing_options(self: Self) -> "List[_2397.GearMeshingOptions]":
    ...
    @property
    def geometries(self: Self) -> "List[_2383.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: Self,
    ) -> "List[_2398.IndependentMASTACreatedCondensationNode]":
    ...
    @property
    def links(self: Self) -> "List[_2420.FELink]":
    ...
    @property
    def nodes(self: Self) -> "List[_2387.FESubstructureNode]":
    ...
    @property
    def replaced_shafts(self: Self) -> "List[_2484.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: Self,
    ) -> "List[_2411.ReplacedShaftSelectionHelper]":
    ...
    def thermal_expansion_displacements(
        self: Self,
    ) -> "List[_1566.VectorWithLinearAndAngularComponents]":
    ...
    def import_fe_mesh(
        ...
        progress: Optional["_7561.TaskProgress"] = None,
    ):
        """Method does not return.
    ...
    def import_node_positions(
        self: Self, file_name: "str", distance_unit: "_1612.Unit"
    ):
        """Method does not return.
    ...
    def import_reduced_stiffness(
        self: Self,
        file_name: "str",
        distance_unit: "_1612.Unit",
        force_unit: "_1612.Unit",
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(self: Self, node: "_2387.FESubstructureNode") -> "List[_2420.FELink]":
        """List[mastapy.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: Self, file_name: "str", progress: "_7561.TaskProgress"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def load_stl_geometry(self: Self, length_unit: "_1612.Unit", file_name: "str"):
        """Method does not return.
