...
class Overridable_DQAxisConvention(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1260.DQAxisConvention":
        ...
        return _1260.DQAxisConvention

    @classmethod
    def implicit_type(cls) -> "_1260.DQAxisConvention.type_()":
        ...
        return _1260.DQAxisConvention.type_()

    @property
    def value(self: Self) -> "_1260.DQAxisConvention":
    ...
    @property
    def override_value(self: Self) -> "_1260.DQAxisConvention":
        """mastapy.electric_machines.DQAxisConvention
    ...
    @property
    def calculated_value(self: Self) -> "_1260.DQAxisConvention":
        """mastapy.electric_machines.DQAxisConvention
