...
class EnumWithSelectedValue_SplineRatingTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1418.SplineRatingTypes":
        ...
        return _1418.SplineRatingTypes

    @classmethod
    def implicit_type(cls) -> "_1418.SplineRatingTypes.type_()":
        ...
        return _1418.SplineRatingTypes.type_()

    @property
    def selected_value(self: Self) -> "_1418.SplineRatingTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1418.SplineRatingTypes]":
