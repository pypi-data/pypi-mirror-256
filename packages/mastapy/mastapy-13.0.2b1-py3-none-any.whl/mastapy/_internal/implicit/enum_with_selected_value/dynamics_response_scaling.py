...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1507.DynamicsResponseScaling":
        ...
        return _1507.DynamicsResponseScaling

    @classmethod
    def implicit_type(cls) -> "_1507.DynamicsResponseScaling.type_()":
        ...
        return _1507.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: Self) -> "_1507.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: Self) -> "List[_1507.DynamicsResponseScaling]":
