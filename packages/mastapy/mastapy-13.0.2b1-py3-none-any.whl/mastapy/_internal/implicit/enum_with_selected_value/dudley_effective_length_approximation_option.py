...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1395.DudleyEffectiveLengthApproximationOption":
        ...
        return _1395.DudleyEffectiveLengthApproximationOption

    @classmethod
    def implicit_type(cls) -> "_1395.DudleyEffectiveLengthApproximationOption.type_()":
        ...
        return _1395.DudleyEffectiveLengthApproximationOption.type_()

    @property
    def selected_value(self: Self) -> "_1395.DudleyEffectiveLengthApproximationOption":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1395.DudleyEffectiveLengthApproximationOption]":
