...
class ListWithSelectedItem_RotorSkewSlice(
    _1296.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1296.RotorSkewSlice.TYPE":
        ...
        return _1296.RotorSkewSlice.TYPE

    @property
    def selected_value(self: Self) -> "_1296.RotorSkewSlice":
    ...
    @property
    def available_values(self: Self) -> "List[_1296.RotorSkewSlice]":
