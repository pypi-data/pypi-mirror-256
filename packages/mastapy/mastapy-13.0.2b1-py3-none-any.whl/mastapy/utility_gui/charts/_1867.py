...
class ThreeDChartDefinition(_1861.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    class _Cast_ThreeDChartDefinition:
        ...
        @property
        def chart_definition(self: "ThreeDChartDefinition._Cast_ThreeDChartDefinition"):
    ...
    @property
    def z_axis(self: Self) -> "_1745.AxisSettings":
    ...
    @property
    def x_axis_range(self: Self) -> "_1490.Range":
    ...
    def x_axis_range(self: Self, value: "_1490.Range"):
        self.wrapped.XAxisRange = value.wrapped

    @property
    def y_axis_range(self: Self) -> "_1490.Range":
        """mastapy.math_utility.Range"""
    ...
    @y_axis_range.setter
    @enforce_parameter_types
    def y_axis_range(self: Self, value: "_1490.Range"):
        self.wrapped.YAxisRange = value.wrapped

    @property
    def z_axis_range(self: Self) -> "_1490.Range":
        """mastapy.math_utility.Range"""
    ...
    @z_axis_range.setter
    @enforce_parameter_types
    def z_axis_range(self: Self, value: "_1490.Range"):
        self.wrapped.ZAxisRange = value.wrapped

    def data_points_for_surfaces(self: Self) -> "List[_1863.PointsForSurface]":
