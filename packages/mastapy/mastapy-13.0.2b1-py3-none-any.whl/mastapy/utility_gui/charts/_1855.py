...
class ConstantLine(_0.APIBase):
    ...
    class _Cast_ConstantLine:
        ...
        @property
        def mode_constant_line(self: "ConstantLine._Cast_ConstantLine"):
            from mastapy.utility_gui.charts import _1860

            return self._parent._cast(_1860.ModeConstantLine)
    ...
    @property
    def axis(self: Self) -> "_1866.SMTAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility_gui.charts._1866", "SMTAxis"
        )(value)
