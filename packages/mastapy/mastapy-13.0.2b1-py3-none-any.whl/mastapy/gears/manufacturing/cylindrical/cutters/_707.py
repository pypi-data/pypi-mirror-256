...
class CylindricalGearFormGrindingWheel(_713.CylindricalGearRealCutterDesign):
    """CylindricalGearFormGrindingWheel
    ...
    @property
    def right_hand_cutting_edge_shape(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def right_hand_cutting_edge_shape(self: Self, value: "_1536.Vector2DListAccessor"):
