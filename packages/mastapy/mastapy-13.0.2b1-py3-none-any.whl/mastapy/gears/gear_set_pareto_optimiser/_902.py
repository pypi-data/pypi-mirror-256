...
class BarForPareto(
    _1552.ParetoOptimisationStrategyBars, Generic[TAnalysis, TCandidate]
):
    """BarForPareto
    ...
    class _Cast_BarForPareto:
        ...
        @property
        def pareto_optimisation_strategy_bars(self: "BarForPareto._Cast_BarForPareto"):
            return self._parent._cast(_1552.ParetoOptimisationStrategyBars)
