...
class CylindricalGearMeshMicroGeometryDutyCycle(_1222.GearMeshDesignAnalysis):
    """CylindricalGearMeshMicroGeometryDutyCycle
    ...
    def peak_to_peak_te(
        self: Self,
    ) -> "_1844.DutyCyclePropertySummaryVeryShortLength[_857.CylindricalGearMeshLoadDistributionAnalysis]":
