...
if TYPE_CHECKING:
    ...
    from mastapy.materials.efficiency import _299
...
class OilPumpDetail(_1588.IndependentReportablePropertiesBase["OilPumpDetail"]):
    """OilPumpDetail
    ...
    @property
    def electric_power_consumed_vs_speed(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @property
    def oil_flow_rate_vs_speed(self: Self) -> "_1536.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def oil_flow_rate_vs_speed(self: Self, value: "_1536.Vector2DListAccessor"):
        self.wrapped.OilFlowRateVsSpeed = value.wrapped

    @property
    def oil_pump_drive_type(self: Self) -> "_299.OilPumpDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials.efficiency._299", "OilPumpDriveType"
        )(value)

    @oil_pump_drive_type.setter
    @enforce_parameter_types
    def oil_pump_drive_type(self: Self, value: "_299.OilPumpDriveType"):
    ...
    @property
    def operating_oil_pressure_vs_speed(self: Self) -> "_1536.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
