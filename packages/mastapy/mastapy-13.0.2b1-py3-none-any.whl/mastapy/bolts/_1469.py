...
if TYPE_CHECKING:
    from mastapy.bolts import _1473, _1474, _1485, _1475, _1480, _1487
...
class BoltGeometry(_1831.NamedDatabaseItem):
    """BoltGeometry
    ...
    class _Cast_BoltGeometry:
        ...
        @property
        def named_database_item(self: "BoltGeometry._Cast_BoltGeometry"):
    ...
    @property
    def bolt_sections(self: Self) -> "List[_1473.BoltSection]":
    ...
    @enforce_parameter_types
    def bolt_sections(self: Self, value: "List[_1473.BoltSection]"):
        value = conversion.mp_to_pn_objects_in_list(value)
        self.wrapped.BoltSections = value

    @property
    def bolt_shank_type(self: Self) -> "_1474.BoltShankType":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1474", "BoltShankType")(
            value
        )

    @bolt_shank_type.setter
    @enforce_parameter_types
    def bolt_shank_type(self: Self, value: "_1474.BoltShankType"):
    ...
    @property
    def standard_size(self: Self) -> "_1485.StandardSizes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1485", "StandardSizes")(
            value
        )

    @standard_size.setter
    @enforce_parameter_types
    def standard_size(self: Self, value: "_1485.StandardSizes"):
    ...
    @property
    def type_of_bolted_joint(self: Self) -> "_1475.BoltTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1475", "BoltTypes")(value)

    @type_of_bolted_joint.setter
    @enforce_parameter_types
    def type_of_bolted_joint(self: Self, value: "_1475.BoltTypes"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Bolts.BoltTypes")
        self.wrapped.TypeOfBoltedJoint = value

    @property
    def type_of_head_cap(self: Self) -> "_1480.HeadCapTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1480", "HeadCapTypes")(
            value
        )

    @type_of_head_cap.setter
    @enforce_parameter_types
    def type_of_head_cap(self: Self, value: "_1480.HeadCapTypes"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Bolts.HeadCapTypes")
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self: Self) -> "_1487.ThreadTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1487", "ThreadTypes")(value)

    @type_of_thread.setter
    @enforce_parameter_types
    def type_of_thread(self: Self, value: "_1487.ThreadTypes"):
