...
if TYPE_CHECKING:
    from mastapy.bolts import _1486
...
class BoltMaterial(_1467.BoltedJointMaterial):
    """BoltMaterial
    ...
    class _Cast_BoltMaterial:
        ...
        @property
        def bolted_joint_material(self: "BoltMaterial._Cast_BoltMaterial"):
            return self._parent._cast(_1467.BoltedJointMaterial)

        @property
        def material(self: "BoltMaterial._Cast_BoltMaterial"):
            from mastapy.materials import _269

            return self._parent._cast(_269.Material)

        @property
        def named_database_item(self: "BoltMaterial._Cast_BoltMaterial"):
    ...
    @property
    def strength_grade(self: Self) -> "_1486.StrengthGrades":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1486", "StrengthGrades")(
            value
        )

    @strength_grade.setter
    @enforce_parameter_types
    def strength_grade(self: Self, value: "_1486.StrengthGrades"):
