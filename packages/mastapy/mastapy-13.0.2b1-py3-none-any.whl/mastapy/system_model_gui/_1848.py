...
if TYPE_CHECKING:
    from mastapy.system_model import _2202, _2205
    from mastapy.utility.operation_modes import _1792
    from mastapy.geometry.two_d import _311
    from mastapy.nodal_analysis.geometry_modeller_link import _155, _162, _163
    from mastapy.math_utility import _1512, _1494
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    def active_design(self: Self) -> "_2202.Design":
    ...
    @enforce_parameter_types
    def active_design(self: Self, value: "_2202.Design"):
    ...
    @property
    def open_designs(self: Self) -> "List[_2202.Design]":
    ...
    @property
    def operation_mode(self: Self) -> "_1792.OperationMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.operation_modes._1792", "OperationMode"
        )(value)

    @operation_mode.setter
    @enforce_parameter_types
    def operation_mode(self: Self, value: "_1792.OperationMode"):
    ...
    @property
    def selected_design_entity(self: Self) -> "_2205.DesignEntity":
    ...
    @enforce_parameter_types
    def selected_design_entity(self: Self, value: "_2205.DesignEntity"):
    ...
    def add_fe_substructure_from_data(
        self: Self,
        vertices_and_facets: "_1512.FacetedBody",
        geometry_modeller_design_information: "_155.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _156.GeometryModellerDimension]",
        body_moniker: "str",
    ):
    ...
    def add_line_from_geometry_modeller(
        self: Self, circles_on_axis: "_1494.CirclesOnAxis"
    ):
        """Method does not return.
    ...
    def circle_pairs_from_geometry_modeller(
        self: Self,
        preselection_circles: "_1494.CirclesOnAxis",
        selected_circles: "List[_1494.CirclesOnAxis]",
    ):
        """Method does not return.
    ...
    def create_new_circles_on_axis(self: Self) -> "_1494.CirclesOnAxis":
    ...
    def create_new_faceted_body(self: Self) -> "_1512.FacetedBody":
    ...
    @enforce_parameter_types
    def open_design_in_new_tab(self: Self, design: "_2202.Design"):
        """Method does not return.
