...
from mastapy.detailed_rigid_connectors.splines import _1395, _1418
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.detailed_rigid_connectors import _1388
...
class SplineJointDesign(_1388.DetailedRigidConnectorDesign):
    """SplineJointDesign
    ...
    class _Cast_SplineJointDesign:
        ...
        def detailed_rigid_connector_design(
            ...
            return self._parent._cast(_1388.DetailedRigidConnectorDesign)
        ...
        def custom_spline_joint_design(
            ...
            return self._parent._cast(_1391.CustomSplineJointDesign)
        ...
        def din5480_spline_joint_design(
            ...
            return self._parent._cast(_1394.DIN5480SplineJointDesign)
        ...
        def gbt3478_spline_joint_design(
            ...
            return self._parent._cast(_1398.GBT3478SplineJointDesign)
        ...
        def iso4156_spline_joint_design(
            ...
            return self._parent._cast(_1401.ISO4156SplineJointDesign)
        ...
        def jisb1603_spline_joint_design(
            ...
            return self._parent._cast(_1402.JISB1603SplineJointDesign)

        @property
        def sae_spline_joint_design(self: "SplineJointDesign._Cast_SplineJointDesign"):
            from mastapy.detailed_rigid_connectors.splines import _1409

            return self._parent._cast(_1409.SAESplineJointDesign)
        ...
        def standard_spline_joint_design(
            ...
            return self._parent._cast(_1421.StandardSplineJointDesign)
    ...
    @enforce_parameter_types
    def dudley_maximum_effective_length_option(
        self: Self, value: "_1395.DudleyEffectiveLengthApproximationOption"
    ):
    ...
    @property
    def fatigue_life_factor_type(self: Self) -> "_1407.SAEFatigueLifeFactorTypes":
    ...
    @enforce_parameter_types
    def fatigue_life_factor_type(self: Self, value: "_1407.SAEFatigueLifeFactorTypes"):
    ...
    @property
    def root_type(self: Self) -> "_1406.RootTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1406", "RootTypes"
        )(value)

    @root_type.setter
    @enforce_parameter_types
    def root_type(self: Self, value: "_1406.RootTypes"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def spline_fixture_type(self: Self) -> "_1414.SplineFixtureTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1414", "SplineFixtureTypes"
        )(value)

    @spline_fixture_type.setter
    @enforce_parameter_types
    def spline_fixture_type(self: Self, value: "_1414.SplineFixtureTypes"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def spline_rating_type(self: Self, value: "_1418.SplineRatingTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def torque_cycles(self: Self) -> "_1410.SAETorqueCycles":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1410", "SAETorqueCycles"
        )(value)

    @torque_cycles.setter
    @enforce_parameter_types
    def torque_cycles(self: Self, value: "_1410.SAETorqueCycles"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def external_half(self: Self) -> "_1415.SplineHalfDesign":
    ...
    @property
    def internal_half(self: Self) -> "_1415.SplineHalfDesign":
        """mastapy.detailed_rigid_connectors.splines.SplineHalfDesign
