...
class SAESplineHalfDesign(_1420.StandardSplineHalfDesign):
    """SAESplineHalfDesign
    ...
    class _Cast_SAESplineHalfDesign:
        ...
        @property
        def spline_half_design(self: "SAESplineHalfDesign._Cast_SAESplineHalfDesign"):
    ...
    @property
    def sae_accuracy_and_tolerance(self: Self) -> "_1423.SAESplineTolerances":
