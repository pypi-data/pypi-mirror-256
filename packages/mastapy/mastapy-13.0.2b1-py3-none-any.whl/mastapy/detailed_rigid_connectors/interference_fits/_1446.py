...
from mastapy.detailed_rigid_connectors.interference_fits import _1449
...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.interference_fits import _1444, _1445
...
class InterferenceFitDesign(_1388.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    class _Cast_InterferenceFitDesign:
        ...
        def keyed_joint_design(
            ...
            return self._parent._cast(_1438.KeyedJointDesign)
    ...
    @property
    def assembly_method(self: Self) -> "_1444.AssemblyMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1444",
            "AssemblyMethods",
        )(value)

    @assembly_method.setter
    @enforce_parameter_types
    def assembly_method(self: Self, value: "_1444.AssemblyMethods"):
    ...
    @property
    def calculation_method(self: Self) -> "_1445.CalculationMethods":
    ...
    @enforce_parameter_types
    def calculation_method(self: Self, value: "_1445.CalculationMethods"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.CalculationMethods",
        )
    ...
    @enforce_parameter_types
    def joint_interface_type(self: Self, value: "_1449.Table4JointInterfaceTypes"):
