...
if TYPE_CHECKING:
    ...
    from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1442
...
class KeywayRating(_1450.InterferenceFitRating):
    """KeywayRating
    ...
    class _Cast_KeywayRating:
        ...
        @property
        def interference_fit_rating(self: "KeywayRating._Cast_KeywayRating"):
            return self._parent._cast(_1450.InterferenceFitRating)

        @property
        def shaft_hub_connection_rating(self: "KeywayRating._Cast_KeywayRating"):
            from mastapy.detailed_rigid_connectors.rating import _1437

            return self._parent._cast(_1437.ShaftHubConnectionRating)
    ...
    @property
    def keyed_joint_design(self: Self) -> "_1438.KeyedJointDesign":
    ...
    @property
    def keyway_half_ratings(self: Self) -> "List[_1442.KeywayHalfRating]":
