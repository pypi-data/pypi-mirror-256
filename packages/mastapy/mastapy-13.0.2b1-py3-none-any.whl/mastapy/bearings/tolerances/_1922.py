...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1923, _1918
...
class SupportDetail(_1910.InterferenceDetail):
    """SupportDetail
    ...
    class _Cast_SupportDetail:
        ...
        @property
        def interference_detail(self: "SupportDetail._Cast_SupportDetail"):
            return self._parent._cast(_1910.InterferenceDetail)

        @property
        def bearing_connection_component(self: "SupportDetail._Cast_SupportDetail"):
    ...
    @property
    def material_source(self: Self) -> "_1923.SupportMaterialSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1923", "SupportMaterialSource"
        )(value)
    ...
    @property
    def radial_specification_method(self: Self) -> "_1918.RadialSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1918", "RadialSpecificationMethod"
        )(value)

    @radial_specification_method.setter
    @enforce_parameter_types
    def radial_specification_method(
        self: Self, value: "_1918.RadialSpecificationMethod"
    ):
