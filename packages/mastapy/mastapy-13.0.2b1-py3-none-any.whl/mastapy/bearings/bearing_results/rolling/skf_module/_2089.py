...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2088, _2090, _2091
...
class GreaseLifeAndRelubricationInterval(_2098.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease(self: Self) -> "_2088.Grease":
    ...
    @property
    def grease_quantity(self: Self) -> "_2090.GreaseQuantity":
    ...
    @property
    def initial_fill(self: Self) -> "_2091.InitialFill":
