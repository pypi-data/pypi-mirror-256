...
class BearingRatingLife(_2098.SKFCalculationResult):
    """BearingRatingLife
    ...
    class _Cast_BearingRatingLife:
        ...
        @property
        def skf_calculation_result(self: "BearingRatingLife._Cast_BearingRatingLife"):
    ...
    @property
    def life_model(self: Self) -> "_2092.LifeModel":
