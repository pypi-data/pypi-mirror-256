...
class LoadedBallBearingRow(_2036.LoadedRollingBearingRow):
    """LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2004.LoadedBallBearingResults":
    ...
    @property
    def race_results(self: Self) -> "List[_2003.LoadedBallBearingRaceResults]":
