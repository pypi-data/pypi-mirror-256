...
class RingFittingThermalResults(_0.APIBase):
    ...
    class _Cast_RingFittingThermalResults:
        ...
        def inner_ring_fitting_thermal_results(
            ...
            return self._parent._cast(_2112.InnerRingFittingThermalResults)

        @property
        def outer_ring_fitting_thermal_results(
            self: "RingFittingThermalResults._Cast_RingFittingThermalResults",
        ):
            from mastapy.bearings.bearing_results.rolling.fitting import _2114

            return self._parent._cast(_2114.OuterRingFittingThermalResults)
    ...
    @property
    def interference_values(self: Self) -> "List[_2113.InterferenceComponents]":
