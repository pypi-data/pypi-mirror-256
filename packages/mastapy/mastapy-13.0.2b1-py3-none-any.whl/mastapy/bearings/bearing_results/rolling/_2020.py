...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2019, _2018
...
class LoadedFourPointContactBallBearingRow(_2005.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2019.LoadedFourPointContactBallBearingResults":
    ...
    def race_results(
        self: Self,
    ) -> "List[_2018.LoadedFourPointContactBallBearingRaceResults]":
