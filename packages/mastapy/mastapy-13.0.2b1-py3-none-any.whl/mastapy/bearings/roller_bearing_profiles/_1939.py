...
if TYPE_CHECKING:
    from mastapy.bearings.roller_bearing_profiles import _1929, _1931, _1941
...
class RollerBearingUserSpecifiedProfile(_1938.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    class _Cast_RollerBearingUserSpecifiedProfile:
        ...
        def roller_bearing_profile(
            ...
            return self._parent._cast(_1938.RollerBearingProfile)
    ...
    @property
    def data_to_use(self: Self) -> "_1929.ProfileDataToUse":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1929", "ProfileDataToUse"
        )(value)

    @data_to_use.setter
    @enforce_parameter_types
    def data_to_use(self: Self, value: "_1929.ProfileDataToUse"):
    ...
    @property
    def profile_to_fit(self: Self) -> "_1931.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1931", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: Self, value: "_1931.ProfileToFit"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: Self) -> "List[_1941.UserSpecifiedProfilePoint]":
