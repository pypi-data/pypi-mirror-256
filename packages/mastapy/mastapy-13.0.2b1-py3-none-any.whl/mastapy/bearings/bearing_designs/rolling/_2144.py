...
class BarrelRollerBearing(_2164.RollerBearing):
    """BarrelRollerBearing
    ...
    class _Cast_BarrelRollerBearing:
        ...
        @property
        def roller_bearing(self: "BarrelRollerBearing._Cast_BarrelRollerBearing"):
            return self._parent._cast(_2164.RollerBearing)

        @property
        def rolling_bearing(self: "BarrelRollerBearing._Cast_BarrelRollerBearing"):
            from mastapy.bearings.bearing_designs.rolling import _2167

            return self._parent._cast(_2167.RollingBearing)

        @property
        def detailed_bearing(self: "BarrelRollerBearing._Cast_BarrelRollerBearing"):
            from mastapy.bearings.bearing_designs import _2133

            return self._parent._cast(_2133.DetailedBearing)

        @property
        def non_linear_bearing(self: "BarrelRollerBearing._Cast_BarrelRollerBearing"):
            from mastapy.bearings.bearing_designs import _2136

            return self._parent._cast(_2136.NonLinearBearing)

        @property
        def bearing_design(self: "BarrelRollerBearing._Cast_BarrelRollerBearing"):
