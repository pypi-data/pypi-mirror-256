...
if TYPE_CHECKING:
    from mastapy.bearings.roller_bearing_profiles import _1930, _1940
...
class RollerBearing(_2167.RollingBearing):
    """RollerBearing
    ...
    @enforce_parameter_types
    def roller_profile(self: Self, value: "_1893.RollerBearingProfileTypes"):
    ...
    @property
    def inner_race_profile_set(self: Self) -> "_1930.ProfileSet":
    ...
    @property
    def outer_race_profile_set(self: Self) -> "_1930.ProfileSet":
        """mastapy.bearings.roller_bearing_profiles.ProfileSet
    ...
    @property
    def roller_profile_set(self: Self) -> "_1930.ProfileSet":
        """mastapy.bearings.roller_bearing_profiles.ProfileSet
    ...
    def inner_race_and_roller_profiles(
        self: Self,
    ) -> "List[_1940.RollerRaceProfilePoint]":
