...
class BallBearing(_2167.RollingBearing):
    """BallBearing
    ...
    @property
    def shoulders(self: Self) -> "List[_2143.BallBearingShoulderDefinition]":
