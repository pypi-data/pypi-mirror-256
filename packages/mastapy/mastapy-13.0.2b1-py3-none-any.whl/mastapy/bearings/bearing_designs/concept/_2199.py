...
class ConceptAxialClearanceBearing(_2200.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self: Self) -> "_2198.BearingNodePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.concept._2198", "BearingNodePosition"
        )(value)

    @node_position.setter
    @enforce_parameter_types
    def node_position(self: Self, value: "_2198.BearingNodePosition"):
