...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.fluid_film import _2192, _2194
...
class PlainGreaseFilledJournalBearing(_2193.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self: Self) -> "_2192.PlainGreaseFilledJournalBearingHousingType":
    ...
    def housing_type(
        self: Self, value: "_2192.PlainGreaseFilledJournalBearingHousingType"
    ):
    ...
    @property
    def housing_detail(self: Self) -> "_2194.PlainJournalHousing":
