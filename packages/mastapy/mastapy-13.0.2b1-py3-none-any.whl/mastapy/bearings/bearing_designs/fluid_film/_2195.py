...
if TYPE_CHECKING:
    from mastapy.bearings import _1889
    from mastapy.bearings.bearing_designs.fluid_film import _2184, _2185, _2186
...
class PlainOilFedJournalBearing(_2193.PlainJournalBearing):
    """PlainOilFedJournalBearing
    ...
    @property
    def feed_type(self: Self) -> "_1889.JournalOilFeedType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1889", "JournalOilFeedType"
        )(value)

    @feed_type.setter
    @enforce_parameter_types
    def feed_type(self: Self, value: "_1889.JournalOilFeedType"):
    ...
    @property
    def axial_groove_oil_feed(self: Self) -> "_2184.AxialGrooveJournalBearing":
    ...
    @property
    def axial_hole_oil_feed(self: Self) -> "_2185.AxialHoleJournalBearing":
