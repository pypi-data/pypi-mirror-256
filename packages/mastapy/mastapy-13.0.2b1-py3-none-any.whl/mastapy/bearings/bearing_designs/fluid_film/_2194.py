...
class PlainJournalHousing(_0.APIBase):
    ...
    class _Cast_PlainJournalHousing:
        ...
        def cylindrical_housing_journal_bearing(
            ...
            return self._parent._cast(_2187.CylindricalHousingJournalBearing)
        ...
        def machinery_encased_journal_bearing(
            ...
            return self._parent._cast(_2188.MachineryEncasedJournalBearing)
        ...
        def pedestal_journal_bearing(
            ...
            return self._parent._cast(_2190.PedestalJournalBearing)
    ...
    @property
    def heat_emitting_area_method(self: Self) -> "_1945.DefaultOrUserInput":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results._1945", "DefaultOrUserInput"
        )(value)

    @heat_emitting_area_method.setter
    @enforce_parameter_types
    def heat_emitting_area_method(self: Self, value: "_1945.DefaultOrUserInput"):
