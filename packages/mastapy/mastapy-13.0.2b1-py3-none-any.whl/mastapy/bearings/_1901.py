...
class SKFSettings(_1596.PerMachineSettings):
    """SKFSettings
    ...
    class _Cast_SKFSettings:
        ...
        @property
        def per_machine_settings(self: "SKFSettings._Cast_SKFSettings"):
            return self._parent._cast(_1596.PerMachineSettings)

        @property
        def persistent_singleton(self: "SKFSettings._Cast_SKFSettings"):
    ...
    @property
    def skf_authentication(self: Self) -> "_2097.SKFAuthentication":
