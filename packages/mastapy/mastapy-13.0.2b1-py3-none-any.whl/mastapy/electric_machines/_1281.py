...
class MagnetDesign(_0.APIBase):
    ...
    class _Cast_MagnetDesign:
        ...
        @property
        def cad_magnets_for_layer(self: "MagnetDesign._Cast_MagnetDesign"):
            from mastapy.electric_machines import _1249

            return self._parent._cast(_1249.CADMagnetsForLayer)

        @property
        def magnet_for_layer(self: "MagnetDesign._Cast_MagnetDesign"):
            from mastapy.electric_machines import _1282

            return self._parent._cast(_1282.MagnetForLayer)
