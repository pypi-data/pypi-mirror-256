...
from mastapy.electric_machines.results import _1327
from mastapy.electric_machines import _1296, _1293
...
class ElectricMachineResultsViewable(_172.ElmerResultsViewable):
    """ElectricMachineResultsViewable
    ...
    class _Cast_ElectricMachineResultsViewable:
        ...
        def elmer_results_viewable(
            ...
            return self._parent._cast(_172.ElmerResultsViewable)
    ...
    @property
    def force_view_options(self: Self) -> "_1339.ElectricMachineForceViewOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.results._1339", "ElectricMachineForceViewOptions"
        )(value)

    @force_view_options.setter
    @enforce_parameter_types
    def force_view_options(self: Self, value: "_1339.ElectricMachineForceViewOptions"):
    ...
    @results.setter
    @enforce_parameter_types
    def results(self: Self, value: "_1327.ElectricMachineResults"):
        wrapper_type = (
    ...
    @property
    def parts_to_view(self: Self) -> "List[_1845.EnumWithBoolean[_1293.RegionID]]":
