...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1336, _1328, _1330, _1332
...
class ElectricMachineResults(_0.APIBase):
    ...
    class _Cast_ElectricMachineResults:
        ...
        def on_load_electric_machine_results(
            ...
            return self._parent._cast(_1345.OnLoadElectricMachineResults)

        @property
        def open_circuit_electric_machine_results(
            self: "ElectricMachineResults._Cast_ElectricMachineResults",
        ):
            from mastapy.electric_machines.results import _1346

            return self._parent._cast(_1346.OpenCircuitElectricMachineResults)
    ...
    @property
    def results_timesteps(self: Self) -> "List[_1336.ElectricMachineResultsTimeStep]":
    ...
    def results_for_conductor_turns(
        self: Self,
    ) -> "List[_1328.ElectricMachineResultsForConductorTurn]":
    ...
    def results_for_line_to_line(
        self: Self,
    ) -> "List[_1330.ElectricMachineResultsForLineToLine]":
    ...
    @property
    def results_for_phases(self: Self) -> "List[_1332.ElectricMachineResultsForPhase]":
