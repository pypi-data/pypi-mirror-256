...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1334, _1337, _1335, _1333
...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self: Self) -> "_1869.TwoDChartDefinition":
    ...
    @property
    def force_density_in_air_gap_mst_chart(self: Self) -> "_1869.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    def results_for_stator_teeth(
        self: Self,
    ) -> "List[_1334.ElectricMachineResultsForStatorToothAtTimeStep]":
    ...
    def results_at_locations(
        self: Self,
    ) -> "List[_1337.ElectricMachineResultsTimeStepAtLocation]":
    ...
    def results_for_line_to_line(
        self: Self,
    ) -> "List[_1335.ElectricMachineResultsLineToLineAtTimeStep]":
    ...
    def results_for_phases(
        self: Self,
    ) -> "List[_1333.ElectricMachineResultsForPhaseAtTimeStep]":
