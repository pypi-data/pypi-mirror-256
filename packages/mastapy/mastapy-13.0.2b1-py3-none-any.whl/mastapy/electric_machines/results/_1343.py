...
from mastapy.electric_machines.results import _1324
...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1867, _1869
...
class NonLinearDQModel(_1324.ElectricMachineDQModel):
    """NonLinearDQModel
    ...
    class _Cast_NonLinearDQModel:
        ...
        @property
        def electric_machine_dq_model(self: "NonLinearDQModel._Cast_NonLinearDQModel"):
            return self._parent._cast(_1324.ElectricMachineDQModel)
    ...
    @property
    def d_axis_armature_flux_linkage_map(self: Self) -> "_1867.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
    ...
    @property
    def q_axis_armature_flux_linkage_map(self: Self) -> "_1867.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
