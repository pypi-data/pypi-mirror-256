...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1277, _1258
...
class StatorRotorMaterial(_269.Material):
    ...
    class _Cast_StatorRotorMaterial:
        ...
        @property
        def material(self: "StatorRotorMaterial._Cast_StatorRotorMaterial"):
            return self._parent._cast(_269.Material)

        @property
        def named_database_item(self: "StatorRotorMaterial._Cast_StatorRotorMaterial"):
    ...
    def coefficient_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1277", "IronLossCoefficientSpecificationMethod"
        )(value)

    @coefficient_specification_method.setter
    @enforce_parameter_types
    def coefficient_specification_method(
        self: Self, value: "_1277.IronLossCoefficientSpecificationMethod"
    ):
    ...
    @property
    def loss_curves(self: Self) -> "_1869.TwoDChartDefinition":
    ...
    @property
    def core_loss_coefficients(self: Self) -> "_1258.CoreLossCoefficients":
