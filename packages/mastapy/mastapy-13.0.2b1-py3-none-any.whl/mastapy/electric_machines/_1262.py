...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1257, _1268, _1294, _1243
...
class ElectricMachineDetail(_0.APIBase):
    ...
    class _Cast_ElectricMachineDetail:
        ...
        def interior_permanent_magnet_machine(
            ...
            return self._parent._cast(_1276.InteriorPermanentMagnetMachine)
        ...
        def non_cad_electric_machine_detail(
            ...
            return self._parent._cast(_1287.NonCADElectricMachineDetail)
        ...
        def surface_permanent_magnet_machine(
            ...
            return self._parent._cast(_1304.SurfacePermanentMagnetMachine)
        ...
        def synchronous_reluctance_machine(
            ...
            return self._parent._cast(_1306.SynchronousReluctanceMachine)
        ...
        def wound_field_synchronous_machine(
            ...
            return self._parent._cast(_1321.WoundFieldSynchronousMachine)
    ...
    def core_loss_build_factor_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1257", "CoreLossBuildFactorSpecificationMethod"
        )(value)

    @core_loss_build_factor_specification_method.setter
    @enforce_parameter_types
    def core_loss_build_factor_specification_method(
        self: Self, value: "_1257.CoreLossBuildFactorSpecificationMethod"
    ):
    ...
    @property
    def electric_machine_type(self: Self) -> "_1268.ElectricMachineType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1268", "ElectricMachineType"
        )(value)
    ...
    @select_setup.setter
    @enforce_parameter_types
    def select_setup(self: Self, value: "_1267.ElectricMachineSetup"):
        wrapper_type = (
    ...
    @property
    def non_linear_dq_model(self: Self) -> "_1343.NonLinearDQModel":
    ...
    @property
    def rotor(self: Self) -> "_1294.Rotor":
    ...
    @property
    def selected_setup(self: Self) -> "_1267.ElectricMachineSetup":
    ...
    @property
    def results_locations(self: Self) -> "List[_1523.Named2DLocation]":
    ...
    @property
    def setups(self: Self) -> "List[_1267.ElectricMachineSetup]":
    ...
    def add_setup(self: Self) -> "_1267.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup"""
    ...
    @enforce_parameter_types
    def duplicate_setup(
        self: Self, setup: "_1267.ElectricMachineSetup"
    ...
    def generate_design_without_non_linear_dq_model(
        self: Self,
    ) -> "_1593.MethodOutcomeWithResult[ElectricMachineDetail]":
    ...
    @enforce_parameter_types
    def remove_setup(self: Self, setup: "_1267.ElectricMachineSetup"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def setup_named(self: Self, name: "str") -> "_1267.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup
    ...
    def try_generate_non_linear_dq_model_with_task_progress(
        self: Self, progress: "_7561.TaskProgress"
    ) -> "_1593.MethodOutcomeWithResult[ElectricMachineDetail]":
        """mastapy.utility.MethodOutcomeWithResult[mastapy.electric_machines.ElectricMachineDetail]
