...
class Windings(_0.APIBase):
    ...
    def double_layer_winding_slot_positions(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1259", "DoubleLayerWindingSlotPositions"
        )(value)

    @double_layer_winding_slot_positions.setter
    @enforce_parameter_types
    def double_layer_winding_slot_positions(
        self: Self, value: "_1259.DoubleLayerWindingSlotPositions"
    ):
    ...
    @property
    def end_winding_inductance_method(self: Self) -> "_1363.EndWindingInductanceMethod":
    ...
    def end_winding_inductance_method(
        self: Self, value: "_1363.EndWindingInductanceMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.EndWindingInductanceMethod",
    ...
    def fill_factor_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1269", "FillFactorSpecificationMethod"
        )(value)

    @fill_factor_specification_method.setter
    @enforce_parameter_types
    def fill_factor_specification_method(
        self: Self, value: "_1269.FillFactorSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def mmf(self: Self) -> "_1869.TwoDChartDefinition":
    ...
    @property
    def single_double_layer_windings(self: Self) -> "_1298.SingleOrDoubleLayerWindings":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1298", "SingleOrDoubleLayerWindings"
        )(value)

    @single_double_layer_windings.setter
    @enforce_parameter_types
    def single_double_layer_windings(
        self: Self, value: "_1298.SingleOrDoubleLayerWindings"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def winding_connection(self: Self) -> "_1314.WindingConnection":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1314", "WindingConnection"
        )(value)

    @winding_connection.setter
    @enforce_parameter_types
    def winding_connection(self: Self, value: "_1314.WindingConnection"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def winding_type(self: Self) -> "_1319.WindingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1319", "WindingType"
        )(value)

    @winding_type.setter
    @enforce_parameter_types
    def winding_type(self: Self, value: "_1319.WindingType"):
        value = conversion.mp_to_pn_enum(
    ...
    def wire_size_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1320", "WireSizeSpecificationMethod"
        )(value)

    @wire_size_specification_method.setter
    @enforce_parameter_types
    def wire_size_specification_method(
        self: Self, value: "_1320.WireSizeSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def mmf_fourier_series_electrical(self: Self) -> "_1514.FourierSeries":
    ...
    @property
    def mmf_fourier_series_mechanical(self: Self) -> "_1514.FourierSeries":
        """mastapy.math_utility.FourierSeries
    ...
    @property
    def windings_viewer(self: Self) -> "_1318.WindingsViewer":
    ...
    @property
    def coils(self: Self) -> "List[_1253.Coil]":
    ...
    @property
    def conductors(self: Self) -> "List[_1313.WindingConductor]":
    ...
    @property
    def phases(self: Self) -> "List[_1292.Phase]":
    ...
    @property
    def slot_section_details(self: Self) -> "List[_1299.SlotSectionDetail]":
