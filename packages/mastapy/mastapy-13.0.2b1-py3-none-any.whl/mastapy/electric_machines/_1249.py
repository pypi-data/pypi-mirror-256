...
class CADMagnetsForLayer(_1281.MagnetDesign):
    """CADMagnetsForLayer
    ...
    class _Cast_CADMagnetsForLayer:
        ...
        @property
        def magnet_design(self: "CADMagnetsForLayer._Cast_CADMagnetsForLayer"):
            return self._parent._cast(_1281.MagnetDesign)
    ...
    @property
    def cad_magnet_details(self: Self) -> "List[_1248.CADMagnetDetails]":
