...
class HairpinConductor(_1313.WindingConductor):
    """HairpinConductor
    ...
    class _Cast_HairpinConductor:
        ...
        @property
        def winding_conductor(self: "HairpinConductor._Cast_HairpinConductor"):
            return self._parent._cast(_1313.WindingConductor)
