...
if TYPE_CHECKING:
    from mastapy.electric_machines.results import _1323
...
class EfficiencyMapAnalysis(_1353.ElectricMachineAnalysis):
    """EfficiencyMapAnalysis
    ...
    @property
    def efficiency_map_results(self: Self) -> "_1323.EfficiencyResults":
    ...
    @property
    def load_case(self: Self) -> "_1352.EfficiencyMapLoadCase":
