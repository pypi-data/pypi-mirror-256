...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1378, _1353, _1361
...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    class _Cast_ElectricMachineLoadCaseBase:
        ...
        def basic_dynamic_force_load_case(
            ...
            return self._parent._cast(_1347.BasicDynamicForceLoadCase)
        ...
        def dynamic_force_load_case(
            ...
            return self._parent._cast(_1349.DynamicForceLoadCase)

        @property
        def efficiency_map_load_case(
            self: "ElectricMachineLoadCaseBase._Cast_ElectricMachineLoadCaseBase",
        ):
            from mastapy.electric_machines.load_cases_and_analyses import _1352

            return self._parent._cast(_1352.EfficiencyMapLoadCase)
        ...
        def electric_machine_load_case(
            ...
            return self._parent._cast(_1359.ElectricMachineLoadCase)
        ...
        def electric_machine_mechanical_load_case(
            ...
            return self._parent._cast(_1362.ElectricMachineMechanicalLoadCase)
        ...
        def speed_torque_curve_load_case(
            ...
            return self._parent._cast(_1376.SpeedTorqueCurveLoadCase)
        ...
        def speed_torque_load_case(
            ...
            return self._parent._cast(_1377.SpeedTorqueLoadCase)
    ...
    @property
    def temperatures(self: Self) -> "_1378.Temperatures":
    ...
    @property
    def analyses(self: Self) -> "List[_1353.ElectricMachineAnalysis]":
    ...
    @enforce_parameter_types
    def copy_to(
        self: Self, another_group: "_1361.ElectricMachineLoadCaseGroup"
    ) -> "ElectricMachineLoadCaseBase":
    ...
    @enforce_parameter_types
    def remove_analysis(
        self: Self, electric_machine_analysis: "_1353.ElectricMachineAnalysis"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_analysis_for(self: Self, setup: "_1267.ElectricMachineSetup"):
        """Method does not return.
