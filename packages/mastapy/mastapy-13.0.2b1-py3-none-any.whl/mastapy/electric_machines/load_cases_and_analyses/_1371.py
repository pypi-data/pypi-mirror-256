...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.load_cases_and_analyses import _1359, _1372
...
class SingleOperatingPointAnalysis(_1353.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1359.ElectricMachineLoadCase":
    ...
    def slot_section_details_for_analysis(
        self: Self,
    ) -> "List[_1372.SlotDetailForAnalysis]":
