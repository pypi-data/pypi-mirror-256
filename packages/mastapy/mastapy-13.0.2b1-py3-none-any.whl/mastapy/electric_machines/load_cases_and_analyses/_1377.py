...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1355, _1373, _1354
...
class SpeedTorqueLoadCase(_1359.ElectricMachineLoadCase):
    """SpeedTorqueLoadCase
    ...
    @property
    def load_specification(self: Self) -> "_1373.SpecifyTorqueOrCurrent":
