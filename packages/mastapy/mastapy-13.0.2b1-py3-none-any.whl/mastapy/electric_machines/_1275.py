...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1271, _1297, _1255, _1289, _1311, _1312
...
class InteriorPermanentMagnetAndSynchronousReluctanceRotor(_1291.PermanentMagnetRotor):
    """InteriorPermanentMagnetAndSynchronousReluctanceRotor
    ...
    class _Cast_InteriorPermanentMagnetAndSynchronousReluctanceRotor:
        ...
        def permanent_magnet_rotor(
            ...
            return self._parent._cast(_1291.PermanentMagnetRotor)
    ...
    @property
    def flux_barrier_style(self: Self) -> "_1271.FluxBarrierStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1271", "FluxBarrierStyle"
        )(value)

    @flux_barrier_style.setter
    @enforce_parameter_types
    def flux_barrier_style(self: Self, value: "_1271.FluxBarrierStyle"):
    ...
    @property
    def rotor_type(self: Self) -> "_1297.RotorType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1297", "RotorType"
        )(value)

    @rotor_type.setter
    @enforce_parameter_types
    def rotor_type(self: Self, value: "_1297.RotorType"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def cooling_duct_layers(self: Self) -> "List[_1255.CoolingDuctLayerSpecification]":
    ...
    @property
    def notch_specifications(self: Self) -> "List[_1289.NotchSpecification]":
    ...
    @property
    def u_shape_layers(self: Self) -> "List[_1311.UShapedLayerSpecification]":
    ...
    def v_shape_magnet_layers(
        self: Self,
    ) -> "List[_1312.VShapedMagnetLayerSpecification]":
