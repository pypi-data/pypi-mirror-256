...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1244, _1317
...
class AbstractStator(_0.APIBase):
    ...
    class _Cast_AbstractStator:
        ...
        @property
        def cad_stator(self: "AbstractStator._Cast_AbstractStator"):
            from mastapy.electric_machines import _1251

            return self._parent._cast(_1251.CADStator)

        @property
        def stator(self: "AbstractStator._Cast_AbstractStator"):
            from mastapy.electric_machines import _1300

            return self._parent._cast(_1300.Stator)
    ...
    @property
    def tooth_and_slot(self: Self) -> "_1244.AbstractToothAndSlot":
