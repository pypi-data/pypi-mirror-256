...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1278, _1279, _1282
...
class UShapedLayerSpecification(_1295.RotorInternalLayerSpecification):
    """UShapedLayerSpecification
    ...
    class _Cast_UShapedLayerSpecification:
        ...
        def rotor_internal_layer_specification(
            ...
            return self._parent._cast(_1295.RotorInternalLayerSpecification)
    ...
    @property
    def inner_magnet_clearance(self: Self) -> "_1278.MagnetClearance":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1278", "MagnetClearance"
        )(value)

    @inner_magnet_clearance.setter
    @enforce_parameter_types
    def inner_magnet_clearance(self: Self, value: "_1278.MagnetClearance"):
    ...
    @property
    def magnet_configuration(self: Self) -> "_1279.MagnetConfiguration":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1279", "MagnetConfiguration"
        )(value)

    @magnet_configuration.setter
    @enforce_parameter_types
    def magnet_configuration(self: Self, value: "_1279.MagnetConfiguration"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def outer_magnet_lower_clearance(self: Self) -> "_1278.MagnetClearance":
        """mastapy.electric_machines.MagnetClearance"""
    ...
    @enforce_parameter_types
    def outer_magnet_lower_clearance(self: Self, value: "_1278.MagnetClearance"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.ElectricMachines.MagnetClearance"
        )
    ...
    @property
    def outer_magnets(self: Self) -> "_1282.MagnetForLayer":
