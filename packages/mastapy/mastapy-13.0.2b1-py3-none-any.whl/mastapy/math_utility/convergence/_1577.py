...
class DataLogger(_0.APIBase):
    ...
    class _Cast_DataLogger:
        ...
        @property
        def convergence_logger(self: "DataLogger._Cast_DataLogger"):
            from mastapy.math_utility.convergence import _1576

            return self._parent._cast(_1576.ConvergenceLogger)

        @property
        def data_logger_with_charts(self: "DataLogger._Cast_DataLogger"):
            from mastapy.utility_gui import _1852

            return self._parent._cast(_1852.DataLoggerWithCharts)
