...
class ForceAndDisplacementResults(_1561.AbstractForceAndDisplacementResults):
    """ForceAndDisplacementResults
    ...
    class _Cast_ForceAndDisplacementResults:
        ...
        def abstract_force_and_displacement_results(
            ...
            return self._parent._cast(_1561.AbstractForceAndDisplacementResults)
    ...
    @property
    def displacement(self: Self) -> "_1566.VectorWithLinearAndAngularComponents":
