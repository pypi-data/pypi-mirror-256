...
class Vector6D(_1527.RealVector):
    """Vector6D
    ...
    class _Cast_Vector6D:
        ...
        @property
        def real_vector(self: "Vector6D._Cast_Vector6D"):
            return self._parent._cast(_1527.RealVector)

        @property
        def real_matrix(self: "Vector6D._Cast_Vector6D"):
            from mastapy.math_utility import _1526

            return self._parent._cast(_1526.RealMatrix)

        @property
        def generic_matrix(self: "Vector6D._Cast_Vector6D"):
            pass
