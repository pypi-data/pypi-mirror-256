...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1560, _1559
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    class _Cast_ParetoOptimisationVariableBase:
        ...
        def pareto_optimisation_input(
            ...
            return self._parent._cast(_1549.ParetoOptimisationInput)
        ...
        def pareto_optimisation_output(
            ...
            return self._parent._cast(_1550.ParetoOptimisationOutput)
        ...
        def pareto_optimisation_variable(
            ...
            return self._parent._cast(_1555.ParetoOptimisationVariable)
        ...
        def parametric_study_doe_result_variable(
            ...
            return self._parent._cast(_4386.ParametricStudyDOEResultVariable)
    ...
    @property
    def integer_range(self: Self) -> "_1590.IntegerRange":
    ...
    @enforce_parameter_types
    def integer_range(self: Self, value: "_1590.IntegerRange"):
    ...
    @property
    def range(self: Self) -> "_1490.Range":
    ...
    @range.setter
    @enforce_parameter_types
    def range(self: Self, value: "_1490.Range"):
        self.wrapped.Range = value.wrapped

    @property
    def specification_type(self: Self) -> "_1560.TargetingPropertyTo":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1560", "TargetingPropertyTo"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: Self, value: "_1560.TargetingPropertyTo"):
    ...
    @property
    def specify_input_range_as(self: Self) -> "_1559.SpecifyOptimisationInputAs":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1559", "SpecifyOptimisationInputAs"
        )(value)

    @specify_input_range_as.setter
    @enforce_parameter_types
    def specify_input_range_as(self: Self, value: "_1559.SpecifyOptimisationInputAs"):
        value = conversion.mp_to_pn_enum(
