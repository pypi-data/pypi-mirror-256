...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1463, _1462, _1455
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self: Self) -> "_1463.RingPinsDesign":
    ...
    @property
    def disc_phases(self: Self) -> "List[_1462.NamedDiscPhase]":
    ...
    @property
    def discs(self: Self) -> "List[_1455.CycloidalDiscDesign]":
