...
if TYPE_CHECKING:
    ...
    from mastapy.cycloidal import _1456, _1459
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: Self) -> "_1869.TwoDChartDefinition":
    ...
    @property
    def exporter(self: Self) -> "_1456.CycloidalDiscDesignExporter":
