...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis.gears import _1801, _1804
...
class GearOrderForTE(_1806.OrderWithRadius):
    """GearOrderForTE
    ...
    class _Cast_GearOrderForTE:
        ...
        @property
        def order_with_radius(self: "GearOrderForTE._Cast_GearOrderForTE"):
            return self._parent._cast(_1806.OrderWithRadius)

        @property
        def order_for_te(self: "GearOrderForTE._Cast_GearOrderForTE"):
            return self._parent._cast(_1804.OrderForTE)
    ...
    @property
    def position(self: Self) -> "_1801.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.modal_analysis.gears._1801", "GearPositions"
        )(value)

    @property
    def additional_orders_and_harmonics(self: Self) -> "List[_1804.OrderForTE]":
