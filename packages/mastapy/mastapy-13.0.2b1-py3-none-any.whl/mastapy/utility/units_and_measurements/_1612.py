...
class Unit(_0.APIBase):
    ...
    class _Cast_Unit:
        ...
        @property
        def degrees_minutes_seconds(self: "Unit._Cast_Unit"):
            from mastapy.utility.units_and_measurements import _1604

            return self._parent._cast(_1604.DegreesMinutesSeconds)

        @property
        def enum_unit(self: "Unit._Cast_Unit"):
            from mastapy.utility.units_and_measurements import _1605

            return self._parent._cast(_1605.EnumUnit)

        @property
        def inverse_unit(self: "Unit._Cast_Unit"):
            from mastapy.utility.units_and_measurements import _1606

            return self._parent._cast(_1606.InverseUnit)

        @property
        def safety_factor_unit(self: "Unit._Cast_Unit"):
            from mastapy.utility.units_and_measurements import _1610

            return self._parent._cast(_1610.SafetyFactorUnit)

        @property
        def time_unit(self: "Unit._Cast_Unit"):
            from mastapy.utility.units_and_measurements import _1611

            return self._parent._cast(_1611.TimeUnit)

        @property
        def unit_gradient(self: "Unit._Cast_Unit"):
            from mastapy.utility.units_and_measurements import _1613

            return self._parent._cast(_1613.UnitGradient)
