...
class LengthShort(_1607.MeasurementBase):
    """LengthShort
    ...
    class _Cast_LengthShort:
        ...
        @property
        def measurement_base(self: "LengthShort._Cast_LengthShort"):
            return self._parent._cast(_1607.MeasurementBase)
    ...
    @property
    def inches(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def metres(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def micrometres(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def millimetres(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def thousandths_of_an_inch(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
