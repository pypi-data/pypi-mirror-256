...
if TYPE_CHECKING:
    from mastapy.utility.report import _1785, _1786
    from mastapy.utility.reporting_property_framework import _1790
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    class _Cast_CustomReportPropertyItem:
        ...
        @property
        def blank_row(self: "CustomReportPropertyItem._Cast_CustomReportPropertyItem"):
            from mastapy.utility.report import _1746

            return self._parent._cast(_1746.BlankRow)
        ...
        def custom_report_chart_item(
            ...
            return self._parent._cast(_1759.CustomReportChartItem)

        @property
        def custom_row(self: "CustomReportPropertyItem._Cast_CustomReportPropertyItem"):
            from mastapy.utility.report import _1780

            return self._parent._cast(_1780.CustomRow)
        ...
        def user_text_row(
            ...
            return self._parent._cast(_1789.UserTextRow)
    ...
    @property
    def font_style(self: Self) -> "_1785.FontStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1785", "FontStyle"
        )(value)

    @font_style.setter
    @enforce_parameter_types
    def font_style(self: Self, value: "_1785.FontStyle"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Utility.Report.FontStyle")
        self.wrapped.FontStyle = value

    @property
    def font_weight(self: Self) -> "_1786.FontWeight":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1786", "FontWeight"
        )(value)

    @font_weight.setter
    @enforce_parameter_types
    def font_weight(self: Self, value: "_1786.FontWeight"):
    ...
    @property
    def horizontal_position(self: Self) -> "_1790.CellValuePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.reporting_property_framework._1790", "CellValuePosition"
        )(value)

    @horizontal_position.setter
    @enforce_parameter_types
    def horizontal_position(self: Self, value: "_1790.CellValuePosition"):
        value = conversion.mp_to_pn_enum(
