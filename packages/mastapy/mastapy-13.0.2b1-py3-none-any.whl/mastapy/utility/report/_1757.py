...
if TYPE_CHECKING:
    from mastapy.utility.cad_export import _1835
...
class CustomReportCadDrawing(_1773.CustomReportNameableItem):
    """CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self: Self) -> "_1835.StockDrawings":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.cad_export._1835", "StockDrawings"
        )(value)

    @stock_drawing.setter
    @enforce_parameter_types
    def stock_drawing(self: Self, value: "_1835.StockDrawings"):
