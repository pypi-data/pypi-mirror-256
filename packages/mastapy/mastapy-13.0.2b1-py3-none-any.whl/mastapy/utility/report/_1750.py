...
class ChartDefinition(_0.APIBase):
    ...
    class _Cast_ChartDefinition:
        ...
        @property
        def simple_chart_definition(self: "ChartDefinition._Cast_ChartDefinition"):
            from mastapy.utility.report import _1788

            return self._parent._cast(_1788.SimpleChartDefinition)

        @property
        def bubble_chart_definition(self: "ChartDefinition._Cast_ChartDefinition"):
            from mastapy.utility_gui.charts import _1854

            return self._parent._cast(_1854.BubbleChartDefinition)

        @property
        def legacy_chart_math_chart_definition(
            self: "ChartDefinition._Cast_ChartDefinition",
        ):
            from mastapy.utility_gui.charts import _1858

            return self._parent._cast(_1858.LegacyChartMathChartDefinition)
        ...
        def matrix_visualisation_definition(
            ...
            return self._parent._cast(_1859.MatrixVisualisationDefinition)

        @property
        def nd_chart_definition(self: "ChartDefinition._Cast_ChartDefinition"):
            from mastapy.utility_gui.charts import _1861

            return self._parent._cast(_1861.NDChartDefinition)
        ...
        def parallel_coordinates_chart_definition(
            ...
            return self._parent._cast(_1862.ParallelCoordinatesChartDefinition)

        @property
        def scatter_chart_definition(self: "ChartDefinition._Cast_ChartDefinition"):
            from mastapy.utility_gui.charts import _1864

            return self._parent._cast(_1864.ScatterChartDefinition)

        @property
        def three_d_chart_definition(self: "ChartDefinition._Cast_ChartDefinition"):
            from mastapy.utility_gui.charts import _1867

            return self._parent._cast(_1867.ThreeDChartDefinition)

        @property
        def three_d_vector_chart_definition(
            self: "ChartDefinition._Cast_ChartDefinition",
        ):
            from mastapy.utility_gui.charts import _1868

            return self._parent._cast(_1868.ThreeDVectorChartDefinition)

        @property
        def two_d_chart_definition(self: "ChartDefinition._Cast_ChartDefinition"):
            from mastapy.utility_gui.charts import _1869

            return self._parent._cast(_1869.TwoDChartDefinition)
