...
class DatabaseSettings(_1596.PerMachineSettings):
    """DatabaseSettings
    ...
    class _Cast_DatabaseSettings:
        ...
        @property
        def per_machine_settings(self: "DatabaseSettings._Cast_DatabaseSettings"):
            return self._parent._cast(_1596.PerMachineSettings)

        @property
        def persistent_singleton(self: "DatabaseSettings._Cast_DatabaseSettings"):
    ...
    @property
    def connection_settings(self: Self) -> "_1827.DatabaseConnectionSettings":
