...
class IndependentReportablePropertiesBase(_0.APIBase, Generic[T]):
    ...
    class _Cast_IndependentReportablePropertiesBase:
        ...
        def eccentricity(
            ...
            return self._parent._cast(_1261.Eccentricity)

        @property
        def temperatures(
            self: "IndependentReportablePropertiesBase._Cast_IndependentReportablePropertiesBase",
        ):
            from mastapy.electric_machines.load_cases_and_analyses import _1378

            return self._parent._cast(_1378.Temperatures)
