...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1412, _1403
...
class DIN5480SplineHalfDesign(_1420.StandardSplineHalfDesign):
    """DIN5480SplineHalfDesign
    ...
    @property
    def finishing_method(self: Self) -> "_1412.FinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1412", "FinishingMethods"
        )(value)

    @finishing_method.setter
    @enforce_parameter_types
    def finishing_method(self: Self, value: "_1412.FinishingMethods"):
    ...
    @property
    def manufacturing_type(self: Self) -> "_1403.ManufacturingTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1403", "ManufacturingTypes"
        )(value)

    @manufacturing_type.setter
    @enforce_parameter_types
    def manufacturing_type(self: Self, value: "_1403.ManufacturingTypes"):
        value = conversion.mp_to_pn_enum(
