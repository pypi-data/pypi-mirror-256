...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1399, _1416
...
class SplineHalfDesign(_1389.DetailedRigidConnectorHalfDesign):
    """SplineHalfDesign
    ...
    class _Cast_SplineHalfDesign:
        ...
        @property
        def custom_spline_half_design(self: "SplineHalfDesign._Cast_SplineHalfDesign"):
            from mastapy.detailed_rigid_connectors.splines import _1390

            return self._parent._cast(_1390.CustomSplineHalfDesign)

        @property
        def din5480_spline_half_design(self: "SplineHalfDesign._Cast_SplineHalfDesign"):
            from mastapy.detailed_rigid_connectors.splines import _1393

            return self._parent._cast(_1393.DIN5480SplineHalfDesign)

        @property
        def gbt3478_spline_half_design(self: "SplineHalfDesign._Cast_SplineHalfDesign"):
            from mastapy.detailed_rigid_connectors.splines import _1397

            return self._parent._cast(_1397.GBT3478SplineHalfDesign)

        @property
        def iso4156_spline_half_design(self: "SplineHalfDesign._Cast_SplineHalfDesign"):
            from mastapy.detailed_rigid_connectors.splines import _1400

            return self._parent._cast(_1400.ISO4156SplineHalfDesign)

        @property
        def sae_spline_half_design(self: "SplineHalfDesign._Cast_SplineHalfDesign"):
        ...
        def standard_spline_half_design(
            ...
            return self._parent._cast(_1420.StandardSplineHalfDesign)
    ...
    @property
    def heat_treatment(self: Self) -> "_1399.HeatTreatmentTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1399", "HeatTreatmentTypes"
        )(value)

    @heat_treatment.setter
    @enforce_parameter_types
    def heat_treatment(self: Self, value: "_1399.HeatTreatmentTypes"):
    ...
    @property
    def fit_and_tolerance(self: Self) -> "_1422.FitAndTolerance":
