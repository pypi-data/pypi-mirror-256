...
class SAESplineHalfRating(_1432.SplineHalfRating):
    """SAESplineHalfRating
    ...
    class _Cast_SAESplineHalfRating:
        ...
        @property
        def spline_half_rating(self: "SAESplineHalfRating._Cast_SAESplineHalfRating"):
            return self._parent._cast(_1432.SplineHalfRating)
