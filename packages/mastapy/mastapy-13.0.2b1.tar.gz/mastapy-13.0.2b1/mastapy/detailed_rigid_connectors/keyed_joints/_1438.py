...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.keyed_joints import _1439, _1441
...
class KeyedJointDesign(_1446.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    class _Cast_KeyedJointDesign:
        ...
        @property
        def interference_fit_design(self: "KeyedJointDesign._Cast_KeyedJointDesign"):
            return self._parent._cast(_1446.InterferenceFitDesign)
    ...
    @property
    def geometry_type(self: Self) -> "_1439.KeyTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1439", "KeyTypes"
        )(value)

    @geometry_type.setter
    @enforce_parameter_types
    def geometry_type(self: Self, value: "_1439.KeyTypes"):
    ...
    @property
    def number_of_keys(self: Self) -> "_1441.NumberOfKeys":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1441", "NumberOfKeys"
        )(value)

    @number_of_keys.setter
    @enforce_parameter_types
    def number_of_keys(self: Self, value: "_1441.NumberOfKeys"):
        value = conversion.mp_to_pn_enum(
