...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    class _Cast_ShaftHubConnectionRating:
        ...
        def agma6123_spline_joint_rating(
            ...
            return self._parent._cast(_1425.AGMA6123SplineJointRating)
        ...
        def din5466_spline_rating(
            ...
            return self._parent._cast(_1427.DIN5466SplineRating)
        ...
        def gbt17855_spline_joint_rating(
            ...
            return self._parent._cast(_1429.GBT17855SplineJointRating)
        ...
        def sae_spline_joint_rating(
            ...
            return self._parent._cast(_1431.SAESplineJointRating)
        ...
        def spline_joint_rating(
            ...
            return self._parent._cast(_1433.SplineJointRating)

        @property
        def keyway_rating(
            self: "ShaftHubConnectionRating._Cast_ShaftHubConnectionRating",
        ):
            from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1443

            return self._parent._cast(_1443.KeywayRating)

        @property
        def interference_fit_rating(
            self: "ShaftHubConnectionRating._Cast_ShaftHubConnectionRating",
        ):
            from mastapy.detailed_rigid_connectors.interference_fits.rating import _1450

            return self._parent._cast(_1450.InterferenceFitRating)
    ...
    @property
    def joint_design(self: Self) -> "_1388.DetailedRigidConnectorDesign":
