...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.interference_fits import _1448
...
class InterferenceFitHalfDesign(_1389.DetailedRigidConnectorHalfDesign):
    """InterferenceFitHalfDesign
    ...
    class _Cast_InterferenceFitHalfDesign:
        ...
        def keyway_joint_half_design(
            ...
            from mastapy.detailed_rigid_connectors.keyed_joints import _1440

            return self._parent._cast(_1440.KeywayJointHalfDesign)
    ...
    @property
    def stress_region(self: Self) -> "_1448.StressRegions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1448", "StressRegions"
        )(value)
    ...
    @property
    def tolerance(self: Self) -> "_1924.SupportTolerance":
