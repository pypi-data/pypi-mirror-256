...
if TYPE_CHECKING:
    from mastapy.bearings import _1898, _1871, _1887
...
class RollingBearingDatabase(
    _1833.SQLDatabase["_1896.RollingBearingKey", "_2167.RollingBearing"]
):
    """RollingBearingDatabase
    ...
    class _Cast_RollingBearingDatabase:
        ...
        @property
        def sql_database(self: "RollingBearingDatabase._Cast_RollingBearingDatabase"):
            return self._parent._cast(_1833.SQLDatabase)

        @property
        def database(self: "RollingBearingDatabase._Cast_RollingBearingDatabase"):
    ...
    def add_to_database(self: Self, bearing: "_2167.RollingBearing"):
    ...
    @enforce_parameter_types
    def create_bearing(
        self: Self, type_: "_1898.RollingBearingType", designation: "str" = "None"
    ...
    @enforce_parameter_types
    def remove_from_database(self: Self, bearing: "_2167.RollingBearing"):
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: Self, catalog: "_1871.BearingCatalog"
    ) -> "List[_2167.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: Self, designation: "str", catalog: "_1871.BearingCatalog"
    ) -> "_2167.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: Self,
        designation: "str",
        catalog: "_1871.BearingCatalog",
        type_: "_1898.RollingBearingType",
    ) -> "List[_2167.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        catalog: "_1871.BearingCatalog",
        type_: "_1898.RollingBearingType",
        bore_range: "_1490.Range",
        outer_diameter_range: "_1490.Range",
        width_range: "_1490.Range",
        dynamic_capacity_range: "_1490.Range",
        number_of_rows: "int",
        material_type: "_1887.HybridSteelAll",
    ) -> "List[_2167.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
