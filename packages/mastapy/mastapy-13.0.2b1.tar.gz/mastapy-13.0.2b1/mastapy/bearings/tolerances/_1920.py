...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1921, _1927, _1917
...
class RoundnessSpecification(
    _1588.IndependentReportablePropertiesBase["RoundnessSpecification"]
):
    """RoundnessSpecification
    ...
    class _Cast_RoundnessSpecification:
        ...
        def independent_reportable_properties_base(
            ...
            return self._parent._cast(_1588.IndependentReportablePropertiesBase)
    ...
    @property
    def specification_type(self: Self) -> "_1921.RoundnessSpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1921", "RoundnessSpecificationType"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: Self, value: "_1921.RoundnessSpecificationType"):
    ...
    @property
    def type_of_fit(self: Self) -> "_1927.TypeOfFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1927", "TypeOfFit"
        )(value)

    @type_of_fit.setter
    @enforce_parameter_types
    def type_of_fit(self: Self, value: "_1927.TypeOfFit"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def user_specified_deviation(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def user_specified_deviation(self: Self, value: "_1536.Vector2DListAccessor"):
        self.wrapped.UserSpecifiedDeviation = value.wrapped

    @property
    def roundness_distribution(self: Self) -> "List[_1917.RaceRoundnessAtAngle]":
