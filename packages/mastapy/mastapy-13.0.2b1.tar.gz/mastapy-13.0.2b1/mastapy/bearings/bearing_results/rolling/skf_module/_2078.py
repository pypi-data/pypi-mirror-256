...
class AdjustedSpeed(_2098.SKFCalculationResult):
    """AdjustedSpeed
    ...
    class _Cast_AdjustedSpeed:
        ...
        @property
        def skf_calculation_result(self: "AdjustedSpeed._Cast_AdjustedSpeed"):
    ...
    @property
    def adjustment_factors(self: Self) -> "_2079.AdjustmentFactors":
