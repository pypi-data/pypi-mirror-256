...
from mastapy.bearings.bearing_results.rolling.fitting import _2115
...
class OuterRingFittingThermalResults(_2115.RingFittingThermalResults):
    """OuterRingFittingThermalResults
    ...
    class _Cast_OuterRingFittingThermalResults:
        ...
        def ring_fitting_thermal_results(
            ...
            return self._parent._cast(_2115.RingFittingThermalResults)
