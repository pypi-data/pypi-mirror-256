...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.measured_data import _1569, _1570
...
class ISO14179Settings(_1831.NamedDatabaseItem):
    """ISO14179Settings
    ...
    class _Cast_ISO14179Settings:
        ...
        @property
        def named_database_item(self: "ISO14179Settings._Cast_ISO14179Settings"):
    ...
    def isotr141792001f1_specification_method(
        self: Self, value: "_2067.PowerRatingF1EstimationMethod"
    ):
