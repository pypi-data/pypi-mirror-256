...
class ANSIABMAResults(_2107.ISOResults):
    """ANSIABMAResults
    ...
    class _Cast_ANSIABMAResults:
        ...
        @property
        def iso_results(self: "ANSIABMAResults._Cast_ANSIABMAResults"):
            return self._parent._cast(_2107.ISOResults)

        @property
        def ansiabma112014_results(self: "ANSIABMAResults._Cast_ANSIABMAResults"):
            from mastapy.bearings.bearing_results.rolling.abma import _2117

            return self._parent._cast(_2117.ANSIABMA112014Results)

        @property
        def ansiabma92015_results(self: "ANSIABMAResults._Cast_ANSIABMAResults"):
