...
class Viscosities(_2098.SKFCalculationResult):
    """Viscosities
    ...
    class _Cast_Viscosities:
        ...
        @property
        def skf_calculation_result(self: "Viscosities._Cast_Viscosities"):
    ...
    @property
    def operating_viscosity(self: Self) -> "_2094.OperatingViscosity":
