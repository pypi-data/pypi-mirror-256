...
if TYPE_CHECKING:
    from mastapy.utility.property import _1840, _1843, _1841, _1842
...
class LoadedRollingBearingDutyCycle(_1958.LoadedNonLinearBearingDutyCycleResults):
    """LoadedRollingBearingDutyCycle
    ...
    def ansiabma_dynamic_equivalent_load_summary(
        self: Self,
    ) -> "_1840.DutyCyclePropertySummaryForce[_1877.BearingLoadCaseResultsLightweight]":
    ...
    def maximum_element_normal_stress_inner_summary(
        ...
        "_1843.DutyCyclePropertySummaryStress[_1877.BearingLoadCaseResultsLightweight]"
    ):
    ...
    def maximum_truncation_summary(
        self: Self,
    ) -> "_1841.DutyCyclePropertySummaryPercentage[_1877.BearingLoadCaseResultsLightweight]":
    ...
    def misalignment_summary(
        self: Self,
    ) -> "_1842.DutyCyclePropertySummarySmallAngle[_1877.BearingLoadCaseResultsLightweight]":
