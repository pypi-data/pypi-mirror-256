...
class PadFluidFilmBearing(_2133.DetailedBearing):
    """PadFluidFilmBearing
    ...
    class _Cast_PadFluidFilmBearing:
        ...
        @property
        def detailed_bearing(self: "PadFluidFilmBearing._Cast_PadFluidFilmBearing"):
            return self._parent._cast(_2133.DetailedBearing)

        @property
        def non_linear_bearing(self: "PadFluidFilmBearing._Cast_PadFluidFilmBearing"):
            from mastapy.bearings.bearing_designs import _2136

            return self._parent._cast(_2136.NonLinearBearing)

        @property
        def bearing_design(self: "PadFluidFilmBearing._Cast_PadFluidFilmBearing"):
    ...
    @enforce_parameter_types
    def rotational_direction(self: Self, value: "_1899.RotationalDirections"):
