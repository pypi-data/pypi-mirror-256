...
if TYPE_CHECKING:
    from mastapy.bearings import _1902
...
class TiltingPadThrustBearing(_2189.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self: Self) -> "_1902.TiltingPadTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1902", "TiltingPadTypes"
        )(value)

    @tilting_pad_type.setter
    @enforce_parameter_types
    def tilting_pad_type(self: Self, value: "_1902.TiltingPadTypes"):
