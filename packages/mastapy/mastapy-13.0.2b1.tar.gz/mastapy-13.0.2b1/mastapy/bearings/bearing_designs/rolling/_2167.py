...
from mastapy.bearings import _1894, _1872, _1873, _1897
from mastapy.bearings.bearing_designs.rolling import _2153, _2154, _2160, _2177
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1874, _1871
...
class RollingBearing(_2133.DetailedBearing):
    """RollingBearing
    ...
    class _Cast_RollingBearing:
        ...
        @property
        def detailed_bearing(self: "RollingBearing._Cast_RollingBearing"):
            return self._parent._cast(_2133.DetailedBearing)

        @property
        def non_linear_bearing(self: "RollingBearing._Cast_RollingBearing"):
            from mastapy.bearings.bearing_designs import _2136

            return self._parent._cast(_2136.NonLinearBearing)

        @property
        def bearing_design(self: "RollingBearing._Cast_RollingBearing"):
            from mastapy.bearings.bearing_designs import _2132

            return self._parent._cast(_2132.BearingDesign)

        @property
        def angular_contact_ball_bearing(self: "RollingBearing._Cast_RollingBearing"):
        ...
        @property
        def taper_roller_bearing(self: "RollingBearing._Cast_RollingBearing"):
        ...
        @property
        def thrust_ball_bearing(self: "RollingBearing._Cast_RollingBearing"):
            from mastapy.bearings.bearing_designs.rolling import _2175

            return self._parent._cast(_2175.ThrustBallBearing)

        @property
        def toroidal_roller_bearing(self: "RollingBearing._Cast_RollingBearing"):
    ...
    @arrangement.setter
    @enforce_parameter_types
    def arrangement(self: Self, value: "_1894.RollingBearingArrangement"):
    ...
    @enforce_parameter_types
    def basic_dynamic_load_rating_calculation(
        self: Self, value: "_1872.BasicDynamicLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def basic_static_load_rating_calculation(
        self: Self, value: "_1873.BasicStaticLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def cage_bridge_shape(self: Self) -> "_2149.CageBridgeShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2149", "CageBridgeShape"
        )(value)

    @cage_bridge_shape.setter
    @enforce_parameter_types
    def cage_bridge_shape(self: Self, value: "_2149.CageBridgeShape"):
    ...
    @property
    def cage_material(self: Self) -> "_1874.BearingCageMaterial":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1874", "BearingCageMaterial"
        )(value)

    @cage_material.setter
    @enforce_parameter_types
    def cage_material(self: Self, value: "_1874.BearingCageMaterial"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def catalogue(self: Self) -> "_1871.BearingCatalog":
        ...
        return constructor.new_from_mastapy("mastapy.bearings._1871", "BearingCatalog")(
            value
        )
    ...
    def diameter_series(
        self: Self,
        value: "Union[_2153.DiameterSeries, Tuple[_2153.DiameterSeries, bool]]",
    ):
    ...
    @enforce_parameter_types
    def fatigue_load_limit_calculation_method(
        self: Self, value: "_2154.FatigueLoadLimitCalculationMethodEnum"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def height_series(
        self: Self, value: "Union[_2160.HeightSeries, Tuple[_2160.HeightSeries, bool]]"
    ):
    ...
    @enforce_parameter_types
    def inner_race_type(self: Self, value: "_1897.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def outer_race_type(self: Self, value: "_1897.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
            enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType.implicit_type()
        )
    ...
    @property
    def sleeve_type(self: Self) -> "_2170.SleeveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2170", "SleeveType"
        )(value)
    ...
    @property
    def type_information(self: Self) -> "_2148.BearingTypeExtraInformation":
    ...
    @enforce_parameter_types
    def width_series(
        self: Self, value: "Union[_2177.WidthSeries, Tuple[_2177.WidthSeries, bool]]"
    ):
    ...
    @property
    def geometric_constants(self: Self) -> "_2157.GeometricConstants":
    ...
    @property
    def iso153122018(self: Self) -> "_1979.ISO153122018Results":
    ...
    @property
    def protection(self: Self) -> "_2145.BearingProtection":
