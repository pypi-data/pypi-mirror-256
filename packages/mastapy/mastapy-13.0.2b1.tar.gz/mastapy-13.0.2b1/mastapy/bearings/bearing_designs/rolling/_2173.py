...
class TaperRollerBearing(_2163.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self: Self) -> "_1878.BearingMeasurementType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1878", "BearingMeasurementType"
        )(value)

    @bearing_measurement_type.setter
    @enforce_parameter_types
    def bearing_measurement_type(self: Self, value: "_1878.BearingMeasurementType"):
