...
class SpringDamperSocket(_2349.CouplingSocket):
    """SpringDamperSocket
    ...
    class _Cast_SpringDamperSocket:
        ...
        @property
        def coupling_socket(self: "SpringDamperSocket._Cast_SpringDamperSocket"):
            return self._parent._cast(_2349.CouplingSocket)

        @property
        def cylindrical_socket(self: "SpringDamperSocket._Cast_SpringDamperSocket"):
            from mastapy.system_model.connections_and_sockets import _2278

            return self._parent._cast(_2278.CylindricalSocket)

        @property
        def socket(self: "SpringDamperSocket._Cast_SpringDamperSocket"):
