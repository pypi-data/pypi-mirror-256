...
class ComponentConnection(_2273.ComponentMeasurer):
    """ComponentConnection
    ...
    class _Cast_ComponentConnection:
        ...
        @property
        def component_measurer(self: "ComponentConnection._Cast_ComponentConnection"):
            return self._parent._cast(_2273.ComponentMeasurer)
    ...
    @property
    def connected_component(self: Self) -> "_2446.Component":
