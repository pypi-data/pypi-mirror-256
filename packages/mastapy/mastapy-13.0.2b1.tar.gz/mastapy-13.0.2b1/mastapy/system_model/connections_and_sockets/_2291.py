...
class PlanetarySocketBase(_2278.CylindricalSocket):
    """PlanetarySocketBase
    ...
    class _Cast_PlanetarySocketBase:
        ...
        @property
        def cylindrical_socket(self: "PlanetarySocketBase._Cast_PlanetarySocketBase"):
            return self._parent._cast(_2278.CylindricalSocket)

        @property
        def socket(self: "PlanetarySocketBase._Cast_PlanetarySocketBase"):
            from mastapy.system_model.connections_and_sockets import _2298

            return self._parent._cast(_2298.Socket)

        @property
        def planetary_socket(self: "PlanetarySocketBase._Cast_PlanetarySocketBase"):
