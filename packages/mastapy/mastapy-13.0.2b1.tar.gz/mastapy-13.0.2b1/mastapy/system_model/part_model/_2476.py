...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.projections import _2487
...
class RootAssembly(_2435.Assembly):
    """RootAssembly
    ...
    class _Cast_RootAssembly:
        ...
        @property
        def assembly(self: "RootAssembly._Cast_RootAssembly"):
            return self._parent._cast(_2435.Assembly)

        @property
        def abstract_assembly(self: "RootAssembly._Cast_RootAssembly"):
            from mastapy.system_model.part_model import _2436

            return self._parent._cast(_2436.AbstractAssembly)

        @property
        def part(self: "RootAssembly._Cast_RootAssembly"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "RootAssembly._Cast_RootAssembly"):
    ...
    @property
    def parallel_part_groups(self: Self) -> "List[_2492.ParallelPartGroup]":
    ...
    def parallel_part_groups_drawing_order(
        self: Self,
    ) -> "List[_2487.SpecifiedParallelPartGroupDrawingOrder]":
