...
class ConceptCoupling(_2585.Coupling):
    """ConceptCoupling
    ...
    class _Cast_ConceptCoupling:
        ...
        @property
        def coupling(self: "ConceptCoupling._Cast_ConceptCoupling"):
            return self._parent._cast(_2585.Coupling)

        @property
        def specialised_assembly(self: "ConceptCoupling._Cast_ConceptCoupling"):
            from mastapy.system_model.part_model import _2478

            return self._parent._cast(_2478.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "ConceptCoupling._Cast_ConceptCoupling"):
            from mastapy.system_model.part_model import _2436

            return self._parent._cast(_2436.AbstractAssembly)

        @property
        def part(self: "ConceptCoupling._Cast_ConceptCoupling"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "ConceptCoupling._Cast_ConceptCoupling"):
    ...
    @property
    def efficiency_vs_speed_ratio(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def efficiency_vs_speed_ratio(self: Self, value: "_1536.Vector2DListAccessor"):
