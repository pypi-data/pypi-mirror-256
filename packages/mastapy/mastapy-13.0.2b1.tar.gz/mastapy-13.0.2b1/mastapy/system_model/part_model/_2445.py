...
class BoltedJoint(_2478.SpecialisedAssembly):
    """BoltedJoint
    ...
    class _Cast_BoltedJoint:
        ...
        @property
        def specialised_assembly(self: "BoltedJoint._Cast_BoltedJoint"):
            return self._parent._cast(_2478.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "BoltedJoint._Cast_BoltedJoint"):
            from mastapy.system_model.part_model import _2436

            return self._parent._cast(_2436.AbstractAssembly)

        @property
        def part(self: "BoltedJoint._Cast_BoltedJoint"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "BoltedJoint._Cast_BoltedJoint"):
    ...
    @property
    def detailed_bolted_joint(self: Self) -> "_1479.DetailedBoltedJointDesign":
