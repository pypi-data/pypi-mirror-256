...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1463, _1464
...
class RingPins(_2466.MountableComponent):
    """RingPins
    ...
    class _Cast_RingPins:
        ...
        @property
        def mountable_component(self: "RingPins._Cast_RingPins"):
            return self._parent._cast(_2466.MountableComponent)

        @property
        def component(self: "RingPins._Cast_RingPins"):
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "RingPins._Cast_RingPins"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "RingPins._Cast_RingPins"):
    ...
    @property
    def ring_pins_design(self: Self) -> "_1463.RingPinsDesign":
    ...
    @property
    def ring_pins_material(self: Self) -> "_1464.RingPinsMaterial":
