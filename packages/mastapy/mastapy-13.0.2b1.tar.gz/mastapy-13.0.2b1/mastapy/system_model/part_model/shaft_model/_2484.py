...
from mastapy.system_model.part_model import _2457, _2437
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2458, _2466
...
class Shaft(_2437.AbstractShaft):
    """Shaft
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: Self, value: "_2457.GuideDxfModel"):
        wrapper_type = (
    ...
    @property
    def guide_image(self: Self) -> "_2458.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: Self) -> "_2385.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: Self, component: "_2466.MountableComponent", offset: "float"
    ):
        """Method does not return.
