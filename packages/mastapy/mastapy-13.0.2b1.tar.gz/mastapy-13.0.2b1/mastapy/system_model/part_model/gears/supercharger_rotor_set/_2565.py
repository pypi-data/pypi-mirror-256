...
class SuperchargerRotorSet(_1831.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    def supercharger_map_chart(self: Self) -> "_1867.ThreeDChartDefinition":
    ...
    @property
    def y_variable_for_imported_data(self: Self) -> "_2567.YVariableForImportedData":
    ...
    def y_variable_for_imported_data(
        self: Self, value: "_2567.YVariableForImportedData"
    ):
    ...
    @property
    def boost_pressure(self: Self) -> "_2557.BoostPressureInputOptions":
    ...
    @property
    def file(self: Self) -> "_2560.RotorSetDataInputFileOptions":
    ...
    @property
    def input_power(self: Self) -> "_2558.InputPowerInputOptions":
    ...
    @property
    def pressure_ratio(self: Self) -> "_2559.PressureRatioInputOptions":
    ...
    @property
    def rotor_speed(self: Self) -> "_2562.RotorSpeedInputOptions":
    ...
    @property
    def measured_points(self: Self) -> "List[_2561.RotorSetMeasuredPoint]":
