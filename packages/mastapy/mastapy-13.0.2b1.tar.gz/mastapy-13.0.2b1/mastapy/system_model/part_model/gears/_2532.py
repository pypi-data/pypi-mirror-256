...
class Gear(_2466.MountableComponent):
    """Gear
    ...
    @property
    def gear_set(self: Self) -> "_2534.GearSet":
    ...
    @property
    def shaft(self: Self) -> "_2484.Shaft":
