...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.gears import _2527, _2529
...
class PlanetaryGearSet(_2528.CylindricalGearSet):
    """PlanetaryGearSet
    ...
    class _Cast_PlanetaryGearSet:
        ...
        @property
        def cylindrical_gear_set(self: "PlanetaryGearSet._Cast_PlanetaryGearSet"):
            return self._parent._cast(_2528.CylindricalGearSet)

        @property
        def gear_set(self: "PlanetaryGearSet._Cast_PlanetaryGearSet"):
            from mastapy.system_model.part_model.gears import _2534

            return self._parent._cast(_2534.GearSet)

        @property
        def specialised_assembly(self: "PlanetaryGearSet._Cast_PlanetaryGearSet"):
            from mastapy.system_model.part_model import _2478

            return self._parent._cast(_2478.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "PlanetaryGearSet._Cast_PlanetaryGearSet"):
            from mastapy.system_model.part_model import _2436

            return self._parent._cast(_2436.AbstractAssembly)

        @property
        def part(self: "PlanetaryGearSet._Cast_PlanetaryGearSet"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "PlanetaryGearSet._Cast_PlanetaryGearSet"):
    ...
    @property
    def annuluses(self: Self) -> "List[_2527.CylindricalGear]":
    ...
    @property
    def planets(self: Self) -> "List[_2529.CylindricalPlanetGear]":
    ...
    @property
    def suns(self: Self) -> "List[_2527.CylindricalGear]":
        """List[mastapy.system_model.part_model.gears.CylindricalGear]
    ...
    def add_annulus(self: Self) -> "_2527.CylindricalGear":
    ...
    def add_planet(self: Self) -> "_2527.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
    ...
    def add_sun(self: Self) -> "_2527.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
