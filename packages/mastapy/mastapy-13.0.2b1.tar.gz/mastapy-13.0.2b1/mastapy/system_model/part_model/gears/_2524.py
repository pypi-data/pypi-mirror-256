...
class ConceptGearSet(_2534.GearSet):
    """ConceptGearSet
    ...
    class _Cast_ConceptGearSet:
        ...
        @property
        def gear_set(self: "ConceptGearSet._Cast_ConceptGearSet"):
            return self._parent._cast(_2534.GearSet)

        @property
        def specialised_assembly(self: "ConceptGearSet._Cast_ConceptGearSet"):
            from mastapy.system_model.part_model import _2478

            return self._parent._cast(_2478.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "ConceptGearSet._Cast_ConceptGearSet"):
            from mastapy.system_model.part_model import _2436

            return self._parent._cast(_2436.AbstractAssembly)

        @property
        def part(self: "ConceptGearSet._Cast_ConceptGearSet"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "ConceptGearSet._Cast_ConceptGearSet"):
    ...
    @property
    def concept_gears(self: Self) -> "List[_2523.ConceptGear]":
    ...
    @property
    def concept_meshes(self: Self) -> "List[_2307.ConceptGearMesh]":
