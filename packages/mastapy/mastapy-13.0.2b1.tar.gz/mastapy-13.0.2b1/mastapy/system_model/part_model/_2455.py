...
class FEPart(_2438.AbstractShaftOrHousing):
    """FEPart
    ...
    class _Cast_FEPart:
        ...
        @property
        def abstract_shaft_or_housing(self: "FEPart._Cast_FEPart"):
            return self._parent._cast(_2438.AbstractShaftOrHousing)

        @property
        def component(self: "FEPart._Cast_FEPart"):
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "FEPart._Cast_FEPart"):
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "FEPart._Cast_FEPart"):
    ...
    @enforce_parameter_types
    def default_fe_substructure(self: Self, value: "_2385.FESubstructure"):
        wrapper_type = (
    ...
    def create_fe_substructure(self: Self) -> "_2385.FESubstructure":
    ...
    def remove_fe_substructure(
        self: Self, fe_substructure: "_2385.FESubstructure"
    ) -> "bool":
        """bool
    ...
    @enforce_parameter_types
    def select_fe_substructure(self: Self, fe_substructure: "_2385.FESubstructure"):
