...
class PartGroup(_0.APIBase):
    ...
    class _Cast_PartGroup:
        ...
        @property
        def concentric_or_parallel_part_group(self: "PartGroup._Cast_PartGroup"):
        ...
        @property
        def concentric_part_group(self: "PartGroup._Cast_PartGroup"):
            from mastapy.system_model.part_model.part_groups import _2489

            return self._parent._cast(_2489.ConcentricPartGroup)

        @property
        def parallel_part_group(self: "PartGroup._Cast_PartGroup"):
            from mastapy.system_model.part_model.part_groups import _2492

            return self._parent._cast(_2492.ParallelPartGroup)

        @property
        def parallel_part_group_selection(self: "PartGroup._Cast_PartGroup"):
            from mastapy.system_model.part_model.part_groups import _2493

            return self._parent._cast(_2493.ParallelPartGroupSelection)
    ...
    @property
    def parts(self: Self) -> "List[_2470.Part]":
