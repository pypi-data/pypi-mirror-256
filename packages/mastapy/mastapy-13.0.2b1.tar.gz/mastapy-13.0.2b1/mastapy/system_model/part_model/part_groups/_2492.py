...
class ParallelPartGroup(_2488.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    class _Cast_ParallelPartGroup:
        ...
        @property
        def part_group(self: "ParallelPartGroup._Cast_ParallelPartGroup"):
    ...
    @property
    def concentric_part_groups(self: Self) -> "List[_2489.ConcentricPartGroup]":
