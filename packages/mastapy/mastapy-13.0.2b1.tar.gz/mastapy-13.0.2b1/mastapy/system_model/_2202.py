...
from mastapy.system_model.part_model import _2474, _2477
...
if TYPE_CHECKING:
    from mastapy.system_model_gui import _1848
    from mastapy.gears import _322, _328
    from mastapy.system_model import _2225, _2226, _2210, _2207, _2224, _2214
    ...
    from mastapy.utility import _1584, _1585
    from mastapy.gears.materials import _598
    from mastapy.shafts import _35
    from mastapy.system_model.optimization.system_optimiser import _2242, _2241
    from mastapy.system_model.part_model.configurations import _2617, _2614, _2616
    from mastapy.bearings.bearing_results.rolling import _1978
    from mastapy.system_model.database_access import _2266
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6807, _6806
    from mastapy.utility.model_validation import _1795
    from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2984
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: Self) -> "_1848.MASTAGUI":
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: Self, value: "_2514.ActiveGearSetDesignSelectionGroup"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def input_power_load(self: Self, value: "_2474.PowerLoad"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: Self, value: "_2474.PowerLoad"):
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: Self, value: "_2477.ShaftDiameterModificationDueToRollingBearingRing"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def thermal_expansion_for_grounded_nodes(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2225", "ThermalExpansionOptionForGroundedNodes"
        )(value)

    @thermal_expansion_for_grounded_nodes.setter
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: Self, value: "_2225.ThermalExpansionOptionForGroundedNodes"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def unbalanced_mass_inclusion(self: Self) -> "_2480.UnbalancedMassInclusionOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2480", "UnbalancedMassInclusionOption"
        )(value)

    @unbalanced_mass_inclusion.setter
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: Self, value: "_2480.UnbalancedMassInclusionOption"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def default_system_temperatures(self: Self) -> "_2226.TransmissionTemperatureSet":
    ...
    @property
    def detailed_spline_settings(self: Self) -> "_1392.DetailedSplineJointSettings":
    ...
    @property
    def electric_machine_group(self: Self) -> "_2210.ElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: Self) -> "_2363.BatchOperations":
    ...
    @property
    def file_save_details_all(self: Self) -> "_1584.FileHistory":
    ...
    @property
    def file_save_details_most_recent(self: Self) -> "_1585.FileHistoryItem":
    ...
    @property
    def settings(self: Self) -> "_2207.DesignSettings":
    ...
    @property
    def system(self: Self) -> "_2224.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: Self) -> "_2242.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: Self,
    ) -> "List[_2617.BearingDetailConfiguration]":
    ...
    def fe_substructure_configurations(
        self: Self,
    ) -> "List[_2614.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: Self,
    ) -> "List[_2514.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: Self,
    ) -> "List[_1978.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: Self,
    ) -> "List[_2616.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: Self) -> "_2266.Databases":
    ...
    @property
    def design_states(self: Self) -> "List[_5665.DesignState]":
    ...
    @property
    def duty_cycles(self: Self) -> "List[_5666.DutyCycle]":
    ...
    @property
    def gear_set_config(self: Self) -> "_2535.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: Self, value: "_2535.GearSetConfiguration"):
        self.wrapped.GearSetConfig = value.wrapped

    @property
    def masta_settings(self: Self) -> "_2214.MASTASettings":
    ...
    @property
    def root_assembly(self: Self) -> "_2476.RootAssembly":
    ...
    @property
    def static_loads(self: Self) -> "List[_6807.StaticLoadCase]":
    ...
    @property
    def system_optimiser(self: Self) -> "_2241.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: Self,
    ) -> "List[_5673.TimeSeriesLoadCaseGroup]":
    ...
    @enforce_parameter_types
    def add_duty_cycle(self: Self, name: "str" = "New Duty Cycle") -> "_5666.DutyCycle":
    ...
    def add_synchroniser_shift_empty(self: Self) -> "_2984.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: Self, name: "str") -> "_2984.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: Self, name: "str") -> "_5665.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: Self, name: "str") -> "_5666.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_bearing_from_database(
        self: Self, rolling_bearing: "_2167.RollingBearing"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_synchroniser_shift(self: Self, shift: "_2984.SynchroniserShift"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def save(self: Self, file_name: "str", save_results: "bool") -> "_1795.Status":
        """mastapy.utility.model_validation.Status
    ...
    def save_load_case_results(
        self: Self, file_name: "str", load_cases: "List[_6806.LoadCase]"
    ):
        """Method does not return.
    ...
    def all_parts_of_type_assembly(self: Self) -> "List[_2435.Assembly]":
    ...
    def load(
        file_path: "str",
        load_full_fe_option: "_1583.ExternalFullFEFileOption" = _1583.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS,
    ) -> "Design":
        """mastapy.system_model.Design
