...
class ComponentCompoundPowerFlow(_4248.PartCompoundPowerFlow):
    """ComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4059.ComponentPowerFlow]":
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4059.ComponentPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ComponentPowerFlow]
