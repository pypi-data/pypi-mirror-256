...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4064, _4063
...
class ConceptGearSetPowerFlow(_4097.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4064.ConceptGearPowerFlow]":
    ...
    @property
    def concept_gears_power_flow(self: Self) -> "List[_4064.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4063.ConceptGearMeshPowerFlow]":
    ...
    @property
    def concept_meshes_power_flow(self: Self) -> "List[_4063.ConceptGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearMeshPowerFlow]
