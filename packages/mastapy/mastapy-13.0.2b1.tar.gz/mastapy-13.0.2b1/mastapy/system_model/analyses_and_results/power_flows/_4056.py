...
class ClutchHalfPowerFlow(_4072.CouplingHalfPowerFlow):
    ...
    class _Cast_ClutchHalfPowerFlow:
        ...
        @property
        def component_power_flow(self: "ClutchHalfPowerFlow._Cast_ClutchHalfPowerFlow"):
            from mastapy.system_model.analyses_and_results.power_flows import _4059

            return self._parent._cast(_4059.ComponentPowerFlow)

        @property
        def part_power_flow(self: "ClutchHalfPowerFlow._Cast_ClutchHalfPowerFlow"):
        ...
        @property
        def part_analysis_case(self: "ClutchHalfPowerFlow._Cast_ClutchHalfPowerFlow"):
            from mastapy.system_model.analyses_and_results.analysis_cases import _7547

            return self._parent._cast(_7547.PartAnalysisCase)

        @property
        def part_analysis(self: "ClutchHalfPowerFlow._Cast_ClutchHalfPowerFlow"):
