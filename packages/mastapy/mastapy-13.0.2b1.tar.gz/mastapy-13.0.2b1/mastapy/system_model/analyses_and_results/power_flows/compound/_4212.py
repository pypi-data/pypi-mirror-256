...
class CycloidalAssemblyCompoundPowerFlow(_4267.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4077.CycloidalAssemblyPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4077.CycloidalAssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CycloidalAssemblyPowerFlow]
