...
class PlanetaryGearSetCompoundPowerFlow(_4218.CylindricalGearSetCompoundPowerFlow):
    """PlanetaryGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4121.PlanetaryGearSetPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4121.PlanetaryGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PlanetaryGearSetPowerFlow]
