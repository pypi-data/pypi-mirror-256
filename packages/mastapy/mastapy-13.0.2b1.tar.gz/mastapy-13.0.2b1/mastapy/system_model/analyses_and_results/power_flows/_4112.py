...
class MassDiscPowerFlow(_4162.VirtualComponentPowerFlow):
    """MassDiscPowerFlow
    ...
    class _Cast_MassDiscPowerFlow:
        ...
        @property
        def component_power_flow(self: "MassDiscPowerFlow._Cast_MassDiscPowerFlow"):
            from mastapy.system_model.analyses_and_results.power_flows import _4059

            return self._parent._cast(_4059.ComponentPowerFlow)

        @property
        def part_power_flow(self: "MassDiscPowerFlow._Cast_MassDiscPowerFlow"):
        ...
        @property
        def part_analysis_case(self: "MassDiscPowerFlow._Cast_MassDiscPowerFlow"):
            from mastapy.system_model.analyses_and_results.analysis_cases import _7547

            return self._parent._cast(_7547.PartAnalysisCase)

        @property
        def part_analysis(self: "MassDiscPowerFlow._Cast_MassDiscPowerFlow"):
        ...
        @property
        def design_entity_analysis(self: "MassDiscPowerFlow._Cast_MassDiscPowerFlow"):
