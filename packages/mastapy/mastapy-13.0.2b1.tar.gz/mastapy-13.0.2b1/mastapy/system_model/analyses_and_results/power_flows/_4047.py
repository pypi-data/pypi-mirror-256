...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4046, _4045
...
class BevelDifferentialGearSetPowerFlow(_4052.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4046.BevelDifferentialGearPowerFlow]":
    ...
    def meshes_power_flow(
        self: Self,
    ) -> "List[_4045.BevelDifferentialGearMeshPowerFlow]":
