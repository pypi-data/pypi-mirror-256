...
class PowerFlow(_7552.StaticLoadAnalysisCase):
    """PowerFlow
    ...
    class _Cast_PowerFlow:
        ...
        @property
        def static_load_analysis_case(self: "PowerFlow._Cast_PowerFlow"):
            return self._parent._cast(_7552.StaticLoadAnalysisCase)

        @property
        def analysis_case(self: "PowerFlow._Cast_PowerFlow"):
            from mastapy.system_model.analyses_and_results.analysis_cases import _7537

            return self._parent._cast(_7537.AnalysisCase)

        @property
        def context(self: "PowerFlow._Cast_PowerFlow"):
    ...
    @property
    def torsional_system_deflection(self: Self) -> "_2834.TorsionalSystemDeflection":
