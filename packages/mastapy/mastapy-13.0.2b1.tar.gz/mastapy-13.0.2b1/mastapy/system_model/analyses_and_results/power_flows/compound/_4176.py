...
class AssemblyCompoundPowerFlow(_4169.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4041.AssemblyPowerFlow]":
    ...
    @property
    def bearings(self: Self) -> "List[_4177.BearingCompoundPowerFlow]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4179.BeltDriveCompoundPowerFlow]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4182.BevelDifferentialGearSetCompoundPowerFlow]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4189.BoltedJointCompoundPowerFlow]":
    ...
    @property
    def bolts(self: Self) -> "List[_4188.BoltCompoundPowerFlow]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4210.CVTCompoundPowerFlow]":
    ...
    @property
    def clutches(self: Self) -> "List[_4190.ClutchCompoundPowerFlow]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_4195.ConceptCouplingCompoundPowerFlow]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_4200.ConceptGearSetCompoundPowerFlow]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4212.CycloidalAssemblyCompoundPowerFlow]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4214.CycloidalDiscCompoundPowerFlow]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4218.CylindricalGearSetCompoundPowerFlow]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4225.FEPartCompoundPowerFlow]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4224.FaceGearSetCompoundPowerFlow]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4226.FlexiblePinAssemblyCompoundPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4233.HypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4240.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4243.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4244.MassDiscCompoundPowerFlow]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4245.MeasurementComponentCompoundPowerFlow]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4247.OilSealCompoundPowerFlow]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4249.PartToPartShearCouplingCompoundPowerFlow]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4254.PlanetCarrierCompoundPowerFlow]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4255.PointLoadCompoundPowerFlow]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4256.PowerLoadCompoundPowerFlow]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4258.RingPinsCompoundPowerFlow]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4260.RollingRingAssemblyCompoundPowerFlow]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4265.ShaftHubConnectionCompoundPowerFlow]":
    ...
    @property
    def shafts(self: Self) -> "List[_4264.ShaftCompoundPowerFlow]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4270.SpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4271.SpringDamperCompoundPowerFlow]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4276.StraightBevelDiffGearSetCompoundPowerFlow]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4279.StraightBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4282.SynchroniserCompoundPowerFlow]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_4286.TorqueConverterCompoundPowerFlow]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_4290.UnbalancedMassCompoundPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4294.WormGearSetCompoundPowerFlow]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4297.ZerolBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4041.AssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.AssemblyPowerFlow]
