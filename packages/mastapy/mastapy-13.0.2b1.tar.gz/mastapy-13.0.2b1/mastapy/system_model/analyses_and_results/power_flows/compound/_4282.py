...
class SynchroniserCompoundPowerFlow(_4267.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4154.SynchroniserPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4154.SynchroniserPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserPowerFlow]
