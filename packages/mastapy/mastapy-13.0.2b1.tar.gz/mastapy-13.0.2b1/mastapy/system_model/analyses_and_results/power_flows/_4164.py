...
class WormGearPowerFlow(_4096.GearPowerFlow):
    ...
    class _Cast_WormGearPowerFlow:
        ...
        @property
        def gear_power_flow(self: "WormGearPowerFlow._Cast_WormGearPowerFlow"):
        ...
        @property
        def component_power_flow(self: "WormGearPowerFlow._Cast_WormGearPowerFlow"):
            from mastapy.system_model.analyses_and_results.power_flows import _4059

            return self._parent._cast(_4059.ComponentPowerFlow)

        @property
        def part_power_flow(self: "WormGearPowerFlow._Cast_WormGearPowerFlow"):
        ...
        @property
        def part_analysis_case(self: "WormGearPowerFlow._Cast_WormGearPowerFlow"):
            from mastapy.system_model.analyses_and_results.analysis_cases import _7547

            return self._parent._cast(_7547.PartAnalysisCase)

        @property
        def part_analysis(self: "WormGearPowerFlow._Cast_WormGearPowerFlow"):
        ...
        @property
        def design_entity_analysis(self: "WormGearPowerFlow._Cast_WormGearPowerFlow"):
