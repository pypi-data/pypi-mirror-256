...
class WormGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7404.WormGearSetAdvancedSystemDeflection]":
    ...
    def worm_gears_compound_advanced_system_deflection(
        self: Self,
    ) -> "List[_7531.WormGearCompoundAdvancedSystemDeflection]":
    ...
    def worm_meshes_compound_advanced_system_deflection(
        self: Self,
    ) -> "List[_7532.WormGearMeshCompoundAdvancedSystemDeflection]":
