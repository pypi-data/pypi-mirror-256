...
class BoltCompoundCriticalSpeedAnalysis(_6702.ComponentCompoundCriticalSpeedAnalysis):
    """BoltCompoundCriticalSpeedAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6564.BoltCriticalSpeedAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6564.BoltCriticalSpeedAnalysis]":
        """List[mastapy.system_model.analyses_and_results.critical_speed_analyses.BoltCriticalSpeedAnalysis]
