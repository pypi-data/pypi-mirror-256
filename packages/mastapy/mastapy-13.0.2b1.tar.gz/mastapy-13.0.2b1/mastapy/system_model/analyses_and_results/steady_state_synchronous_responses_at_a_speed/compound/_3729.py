...
Self = TypeVar(
    "Self", bound="RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed"
)
...
class RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed",
    )
    ...
    class _Cast_RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(
            self: "RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed",
            parent: "RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed.TYPE",
    ):
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_3598.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: Self,
    ) -> "RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed":
        return self._Cast_RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(
            self
        )
