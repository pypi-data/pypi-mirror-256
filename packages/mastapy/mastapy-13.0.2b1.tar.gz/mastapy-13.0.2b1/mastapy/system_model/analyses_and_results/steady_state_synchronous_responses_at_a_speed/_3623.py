...
class SynchroniserSteadyStateSynchronousResponseAtASpeed(
    ...
    _CastSelf = TypeVar(
        "_CastSelf", bound="_Cast_SynchroniserSteadyStateSynchronousResponseAtASpeed"
    )
    ...
    class _Cast_SynchroniserSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(
            self: "SynchroniserSteadyStateSynchronousResponseAtASpeed._Cast_SynchroniserSteadyStateSynchronousResponseAtASpeed",
            parent: "SynchroniserSteadyStateSynchronousResponseAtASpeed",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "SynchroniserSteadyStateSynchronousResponseAtASpeed.TYPE",
    ):
    ...
    def cast_to(
        self: Self,
    ) -> "SynchroniserSteadyStateSynchronousResponseAtASpeed._Cast_SynchroniserSteadyStateSynchronousResponseAtASpeed":
