...
class AssemblySteadyStateSynchronousResponseAtASpeed(
    ...
    def bearings(
        self: Self,
    ) -> "List[_3514.BearingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_3516.BeltDriveSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def bolts(self: Self) -> "List[_3526.BoltSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3548.CVTSteadyStateSynchronousResponseAtASpeed]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3529.ClutchSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3534.ConceptCouplingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3536.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3549.CycloidalAssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3552.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_3562.FEPartSteadyStateSynchronousResponseAtASpeed]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3560.FaceGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_3563.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3569.HypoidGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3579.KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_3582.MeasurementComponentSteadyStateSynchronousResponseAtASpeed]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3584.OilSealSteadyStateSynchronousResponseAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3588.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3591.PlanetCarrierSteadyStateSynchronousResponseAtASpeed]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_3592.PointLoadSteadyStateSynchronousResponseAtASpeed]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_3593.PowerLoadSteadyStateSynchronousResponseAtASpeed]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3595.RingPinsSteadyStateSynchronousResponseAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_3597.RollingRingAssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_3602.ShaftSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3606.SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3610.SpringDamperSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_3616.StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3623.SynchroniserSteadyStateSynchronousResponseAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3626.TorqueConverterSteadyStateSynchronousResponseAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_3628.UnbalancedMassSteadyStateSynchronousResponseAtASpeed]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3631.WormGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_3634.ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
