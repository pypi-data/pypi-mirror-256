...
class CVTPulleyCompoundSystemDeflection(_2942.PulleyCompoundSystemDeflection):
    """CVTPulleyCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2735.CVTPulleySystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2735.CVTPulleySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.CVTPulleySystemDeflection]
