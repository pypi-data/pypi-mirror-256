...
class CVTCompoundSystemDeflection(_2863.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_2736.CVTSystemDeflection]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_2736.CVTSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.CVTSystemDeflection]
