...
class FaceGearSetCompoundSystemDeflection(_2914.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    def face_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2907.FaceGearCompoundSystemDeflection]":
    ...
    def face_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2908.FaceGearMeshCompoundSystemDeflection]":
