...
class PlanetCarrierSystemDeflection(_2784.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4122.PlanetCarrierPowerFlow":
    ...
    @property
    def windup(self: Self) -> "List[_2848.PlanetCarrierWindup]":
