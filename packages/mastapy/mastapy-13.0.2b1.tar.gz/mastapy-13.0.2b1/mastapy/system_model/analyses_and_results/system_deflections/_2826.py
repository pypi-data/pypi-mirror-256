...
class SynchroniserSystemDeflection(_2808.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4154.SynchroniserPowerFlow":
    ...
    @property
    def cones(self: Self) -> "List[_2823.SynchroniserHalfSystemDeflection]":
