...
class DatumSystemDeflection(_2717.ComponentSystemDeflection):
    """DatumSystemDeflection
    ...
    class _Cast_DatumSystemDeflection:
        ...
        @property
        def part_fe_analysis(self: "DatumSystemDeflection._Cast_DatumSystemDeflection"):
        ...
        @property
        def part_analysis(self: "DatumSystemDeflection._Cast_DatumSystemDeflection"):
    ...
    @property
    def power_flow_results(self: Self) -> "_4086.DatumPowerFlow":
