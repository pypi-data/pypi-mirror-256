...
class SynchroniserHalfSystemDeflection(_2824.SynchroniserPartSystemDeflection):
    """SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self: Self) -> "_2713.ClutchConnectionSystemDeflection":
    ...
    @property
    def power_flow_results(self: Self) -> "_4152.SynchroniserHalfPowerFlow":
