...
class WormGearCompoundSystemDeflection(_2912.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self: Self) -> "_372.WormGearDutyCycleRating":
    ...
    @property
    def worm_duty_cycle_rating(self: Self) -> "_372.WormGearDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearDutyCycleRating
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2840.WormGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.WormGearSystemDeflection]
