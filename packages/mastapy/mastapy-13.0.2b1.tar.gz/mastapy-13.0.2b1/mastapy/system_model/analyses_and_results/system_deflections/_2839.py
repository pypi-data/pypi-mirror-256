...
class WormGearSetSystemDeflection(_2762.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4165.WormGearSetPowerFlow":
    ...
    def worm_meshes_system_deflection(
        self: Self,
    ) -> "List[_2838.WormGearMeshSystemDeflection]":
