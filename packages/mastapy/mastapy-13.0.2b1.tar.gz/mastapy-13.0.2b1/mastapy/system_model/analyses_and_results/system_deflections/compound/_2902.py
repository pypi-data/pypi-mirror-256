...
class CylindricalGearSetCompoundSystemDeflection(_2914.GearSetCompoundSystemDeflection):
    """CylindricalGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2746.CylindricalGearSetSystemDeflectionWithLTCAResults]":
    ...
    def cylindrical_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2900.CylindricalGearCompoundSystemDeflection]":
    ...
    def cylindrical_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2901.CylindricalGearMeshCompoundSystemDeflection]":
