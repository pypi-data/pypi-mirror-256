...
class ClutchHalfCompoundDynamicAnalysis(_6449.CouplingHalfCompoundDynamicAnalysis):
    """ClutchHalfCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6302.ClutchHalfDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6302.ClutchHalfDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ClutchHalfDynamicAnalysis]
