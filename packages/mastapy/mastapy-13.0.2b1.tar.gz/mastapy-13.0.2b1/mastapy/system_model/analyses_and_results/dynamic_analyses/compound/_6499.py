...
class RingPinsCompoundDynamicAnalysis(_6487.MountableComponentCompoundDynamicAnalysis):
    """RingPinsCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6370.RingPinsDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6370.RingPinsDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.RingPinsDynamicAnalysis]
