...
class PowerFlowAnalysis(_2622.SingleAnalysis):
    """PowerFlowAnalysis
    ...
    class _Cast_PowerFlowAnalysis:
        ...
        @property
        def single_analysis(self: "PowerFlowAnalysis._Cast_PowerFlowAnalysis"):
    ...
    @enforce_parameter_types
    def results_for_cvt(self: Self, design_entity: "_2588.CVT") -> "_4075.CVTPowerFlow":
