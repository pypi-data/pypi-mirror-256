...
from mastapy.system_model.part_model import _2441, _2455, _2473, _2474
...
from mastapy.system_model.part_model.gears import _2528, _2527, _2534, _2532
from mastapy.system_model.connections_and_sockets.gears import _2311, _2315
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6807, _6820
...
class AbstractStaticLoadCaseGroup(_5661.AbstractLoadCaseGroup):
    """AbstractStaticLoadCaseGroup
    ...
    class _Cast_AbstractStaticLoadCaseGroup:
        ...
        def duty_cycle(
            ...
            return self._parent._cast(_5666.DutyCycle)
    ...
    def bearings(
        ...
        "List[_5675.ComponentStaticLoadCaseGroup[_2441.Bearing, _6822.BearingLoadCase]]"
    ):
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5678.GearSetStaticLoadCaseGroup[_2528.CylindricalGearSet, _2527.CylindricalGear, _6864.CylindricalGearLoadCase, _2311.CylindricalGearMesh, _6866.CylindricalGearMeshLoadCase, _6868.CylindricalGearSetLoadCase]]":
    ...
    @property
    def design_states(self: Self) -> "List[_5660.AbstractDesignStateLoadCaseGroup]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_5675.ComponentStaticLoadCaseGroup[_2455.FEPart, _6890.FEPartLoadCase]]":
    ...
    def gear_sets(
        self: Self,
    ) -> "List[_5678.GearSetStaticLoadCaseGroup[_2534.GearSet, _2532.Gear, _6893.GearLoadCase, _2315.GearMesh, _6895.GearMeshLoadCase, _6898.GearSetLoadCase]]":
    ...
    @property
    def parts_with_excitations(self: Self) -> "List[_5679.PartStaticLoadCaseGroup]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_5675.ComponentStaticLoadCaseGroup[_2473.PointLoad, _6941.PointLoadLoadCase]]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_5675.ComponentStaticLoadCaseGroup[_2474.PowerLoad, _6942.PowerLoadLoadCase]]":
    ...
    @property
    def compound_power_flow(self: Self) -> "_2678.CompoundPowerFlowAnalysis":
    ...
    @property
    def compound_harmonic_analysis(self: Self) -> "_2670.CompoundHarmonicAnalysis":
    ...
    @property
    def compound_modal_analysis(self: Self) -> "_2673.CompoundModalAnalysis":
    ...
    @property
    def compound_stability_analysis(self: Self) -> "_2679.CompoundStabilityAnalysis":
