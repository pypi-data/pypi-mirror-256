...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6951, _6806
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    class _Cast_AbstractLoadCaseGroup:
        ...
        @property
        def design_state(self: "AbstractLoadCaseGroup._Cast_AbstractLoadCaseGroup"):
            from mastapy.system_model.analyses_and_results.load_case_groups import _5665

            return self._parent._cast(_5665.DesignState)

        @property
        def duty_cycle(self: "AbstractLoadCaseGroup._Cast_AbstractLoadCaseGroup"):
        ...
        def time_series_load_case_group(
            ...
            return self._parent._cast(_5673.TimeSeriesLoadCaseGroup)
    ...
    @property
    def model(self: Self) -> "_2202.Design":
    ...
    @property
    def load_case_root_assemblies(self: Self) -> "List[_6951.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: Self, number_of_load_cases: "int", token: "_7561.TaskProgress"
    ) -> "List[_6806.LoadCase]":
    ...
    @enforce_parameter_types
    def perform_pst_with_progress(self: Self, progress: "_7561.TaskProgress"):
        """Method does not return.
