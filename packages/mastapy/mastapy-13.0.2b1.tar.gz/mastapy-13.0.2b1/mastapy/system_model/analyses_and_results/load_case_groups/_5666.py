...
class DutyCycle(_5662.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    class _Cast_DutyCycle:
        ...
        @property
        def abstract_static_load_case_group(self: "DutyCycle._Cast_DutyCycle"):
            return self._parent._cast(_5662.AbstractStaticLoadCaseGroup)

        @property
        def abstract_load_case_group(self: "DutyCycle._Cast_DutyCycle"):
    ...
    def duty_cycle_design_states(
        self: Self,
    ) -> "List[_5669.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: Self) -> "_7004.TimeSeriesImporter":
    ...
    def add_static_load(self: Self, static_load: "_6807.StaticLoadCase"):
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: Self, sub_group: "_5669.SubGroupInSingleDesignState"
    ):
        """Method does not return.
