...
class AssemblyMultibodyDynamicsAnalysis(
    ...
    @property
    def bearings(self: Self) -> "List[_5387.BearingMultibodyDynamicsAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5390.BeltDriveMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5393.BevelDifferentialGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5399.BoltedJointMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5400.BoltMultibodyDynamicsAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5422.CVTMultibodyDynamicsAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5403.ClutchMultibodyDynamicsAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5409.ConceptCouplingMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5424.CycloidalAssemblyMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5426.CycloidalDiscMultibodyDynamicsAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5437.FEPartMultibodyDynamicsAnalysis]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5436.FaceGearSetMultibodyDynamicsAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5438.FlexiblePinAssemblyMultibodyDynamicsAnalysis]":
    ...
    @property
    def gear_sets(self: Self) -> "List[_5442.GearSetMultibodyDynamicsAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5446.HypoidGearSetMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5460.KlingelnbergCycloPalloidSpiralBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5461.MassDiscMultibodyDynamicsAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5465.MeasurementComponentMultibodyDynamicsAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5468.OilSealMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5472.PartToPartShearCouplingMultibodyDynamicsAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5476.PointLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5477.PowerLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5479.RingPinsMultibodyDynamicsAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5481.RollingRingAssemblyMultibodyDynamicsAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5488.ShaftMultibodyDynamicsAnalysis]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_5507.SynchroniserMultibodyDynamicsAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5512.TorqueConverterMultibodyDynamicsAnalysis]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5521.WormGearSetMultibodyDynamicsAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_5524.ZerolBevelGearSetMultibodyDynamicsAnalysis]":
