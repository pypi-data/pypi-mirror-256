...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5411, _5410
...
class ConceptGearSetMultibodyDynamicsAnalysis(_5442.GearSetMultibodyDynamicsAnalysis):
    """ConceptGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self: Self) -> "List[_5411.ConceptGearMultibodyDynamicsAnalysis]":
