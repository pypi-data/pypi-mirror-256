...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5388, _5440, _5486
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self: Self) -> "_5385.AnalysisTypes":
    ...
    def analysis_type(self: Self, value: "_5385.AnalysisTypes"):
    ...
    @enforce_parameter_types
    def include_shaft_and_housing_flexibilities(
        self: Self, value: "_5486.ShaftAndHousingFlexibilityOption"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: Self, value: "_5447.InertiaAdjustedLoadCasePeriodMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(self: Self, value: "_2474.PowerLoad"):
        wrapper_type = (
    ...
    def static_load_cases_to_create(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5448",
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: Self, value: "_5448.InertiaAdjustedLoadCaseResultsToCreate"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    @property
    def run_up_analysis_options(self: Self) -> "_5464.MBDRunUpAnalysisOptions":
