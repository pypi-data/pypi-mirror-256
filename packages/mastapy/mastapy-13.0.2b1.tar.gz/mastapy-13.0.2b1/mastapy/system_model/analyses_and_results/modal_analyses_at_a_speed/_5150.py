...
class ConceptGearSetModalAnalysisAtASpeed(_5179.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    def concept_gears_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5149.ConceptGearModalAnalysisAtASpeed]":
    ...
    def concept_meshes_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5148.ConceptGearMeshModalAnalysisAtASpeed]":
