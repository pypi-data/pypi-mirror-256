...
class BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness",
    )
    ...
    class _Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(
            self: "BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness._Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness",
            parent: "BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness.TYPE",
    ):
    ...
    def cast_to(
        self: Self,
    ) -> "BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness._Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness":
        return self._Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness(
            self
        )
