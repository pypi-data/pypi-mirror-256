...
class AssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7019.AssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_7151.BearingCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_7153.BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_7156.BevelDifferentialGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_7163.BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_7162.BoltCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cv_ts(
        self: Self,
    ) -> "List[_7184.CVTCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_7164.ClutchCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7169.ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7174.ConceptGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cycloidal_assemblies(
        ...
        "List[_7186.CycloidalAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_7188.CycloidalDiscCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7192.CylindricalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_7199.FEPartCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_7198.FaceGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7200.FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_7207.HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7214.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7217.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_7218.MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7219.MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_7221.OilSealCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_7223.PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7228.PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_7229.PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_7230.PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_7232.RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7234.RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7239.ShaftHubConnectionCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_7238.ShaftCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7244.SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7245.SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_7250.StraightBevelDiffGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7253.StraightBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7256.SynchroniserCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7260.TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7264.UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7268.WormGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_gear_sets(
        ...
        "List[_7271.ZerolBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]"
    ):
