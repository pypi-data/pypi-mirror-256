...
class AssemblyAdvancedTimeSteppingAnalysisForModulation(
    ...
    def bearings(
        self: Self,
    ) -> "List[_7021.BearingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_7023.BeltDriveAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_7033.BoltedJointAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_7032.BoltAdvancedTimeSteppingAnalysisForModulation]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7053.CVTAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7039.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7056.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7062.CylindricalGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_7069.FEPartAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_7068.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7070.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7085.KlingelnbergCycloPalloidHypoidGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7090.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_7092.OilSealAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_7094.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7099.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_7100.PointLoadAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7106.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7110.ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_7109.ShaftAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7116.SpringDamperAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7124.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7127.SynchroniserAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7131.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7135.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7139.WormGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_7142.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
