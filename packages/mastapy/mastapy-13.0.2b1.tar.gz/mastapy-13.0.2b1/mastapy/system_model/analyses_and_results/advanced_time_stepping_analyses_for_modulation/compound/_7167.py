...
Self = TypeVar(
    "Self", bound="CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation"
)
...
class CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    _CastSelf = TypeVar(
        "_CastSelf",
        bound="_Cast_CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
    ...
    class _Cast_CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(
            self: "CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation",
            parent: "CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation.TYPE",
    ):
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_7037.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: Self,
    ) -> "CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation":
        return self._Cast_CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(
            self
        )
