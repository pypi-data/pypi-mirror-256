...
class ClutchConnectionLoadCase(_6854.CouplingConnectionLoadCase):
    """ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def clutch_pressures(self: Self, value: "_1536.Vector2DListAccessor"):
