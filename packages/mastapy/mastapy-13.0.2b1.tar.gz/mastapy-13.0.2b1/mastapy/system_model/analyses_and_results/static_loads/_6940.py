...
if TYPE_CHECKING:
    from mastapy.math_utility import _1505, _1514
...
class PointLoadHarmonicLoadData(_1384.SpeedDependentHarmonicLoadData):
    """PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self: Self) -> "_1505.DegreeOfFreedom":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1505", "DegreeOfFreedom"
        )(value)

    @degree_of_freedom.setter
    @enforce_parameter_types
    def degree_of_freedom(self: Self, value: "_1505.DegreeOfFreedom"):
