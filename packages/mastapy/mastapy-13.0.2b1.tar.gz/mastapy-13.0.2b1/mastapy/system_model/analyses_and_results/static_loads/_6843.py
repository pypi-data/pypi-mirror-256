...
class ConceptCouplingLoadCase(_6856.CouplingLoadCase):
    """ConceptCouplingLoadCase
    ...
    @enforce_parameter_types
    def power_load_for_reference_speed(self: Self, value: "_2474.PowerLoad"):
        wrapper_type = (
    ...
    def speed_ratio_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2204", "ConceptCouplingSpeedRatioSpecificationMethod"
        )(value)

    @speed_ratio_specification_method.setter
    @enforce_parameter_types
    def speed_ratio_specification_method(
        self: Self, value: "_2204.ConceptCouplingSpeedRatioSpecificationMethod"
    ):
    ...
    @property
    def speed_ratio_vs_time(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @property
    def speed_ratio_pid_control(self: Self) -> "_1578.PIDControlSettings":
