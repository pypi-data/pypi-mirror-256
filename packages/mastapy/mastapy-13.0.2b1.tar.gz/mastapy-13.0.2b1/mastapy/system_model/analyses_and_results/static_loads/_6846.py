...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6844, _6845
...
class ConceptGearSetLoadCase(_6898.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6844.ConceptGearLoadCase]":
    ...
    @property
    def concept_gears_load_case(self: Self) -> "List[_6844.ConceptGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearLoadCase]
    ...
    @property
    def concept_meshes_load_case(self: Self) -> "List[_6845.ConceptGearMeshLoadCase]":
