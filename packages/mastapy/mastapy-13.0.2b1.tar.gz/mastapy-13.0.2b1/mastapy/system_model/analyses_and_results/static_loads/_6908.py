...
class HypoidGearLoadCase(_6816.AGMAGleasonConicalGearLoadCase):
    """HypoidGearLoadCase
    ...
    class _Cast_HypoidGearLoadCase:
        ...
        @property
        def conical_gear_load_case(self: "HypoidGearLoadCase._Cast_HypoidGearLoadCase"):
            from mastapy.system_model.analyses_and_results.static_loads import _6847

            return self._parent._cast(_6847.ConicalGearLoadCase)

        @property
        def gear_load_case(self: "HypoidGearLoadCase._Cast_HypoidGearLoadCase"):
        ...
        @property
        def component_load_case(self: "HypoidGearLoadCase._Cast_HypoidGearLoadCase"):
            from mastapy.system_model.analyses_and_results.static_loads import _6840

            return self._parent._cast(_6840.ComponentLoadCase)

        @property
        def part_load_case(self: "HypoidGearLoadCase._Cast_HypoidGearLoadCase"):
            from mastapy.system_model.analyses_and_results.static_loads import _6931

            return self._parent._cast(_6931.PartLoadCase)

        @property
        def part_analysis(self: "HypoidGearLoadCase._Cast_HypoidGearLoadCase"):
        ...
        @property
        def design_entity_analysis(self: "HypoidGearLoadCase._Cast_HypoidGearLoadCase"):
