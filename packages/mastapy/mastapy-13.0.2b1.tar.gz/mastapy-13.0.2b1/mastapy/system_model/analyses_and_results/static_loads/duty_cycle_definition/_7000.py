...
class PointLoadInputOptions(_1849.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    class _Cast_PointLoadInputOptions:
        ...
        def column_input_options(
            ...
            return self._parent._cast(_1849.ColumnInputOptions)
    ...
    def axis(self: Self, value: "_1493.Axis"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.MathUtility.Axis")
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self: Self) -> "_6991.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition._6991",
    ...
    def conversion_to_load_case(
        self: Self, value: "_6991.AdditionalForcesObtainedFrom"
    ):
    ...
    @point_load.setter
    @enforce_parameter_types
    def point_load(self: Self, value: "_2473.PointLoad"):
        wrapper_type = (
