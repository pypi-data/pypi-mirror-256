...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4721
...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4724
...
class SingleExcitationResultsModalAnalysis(_4721.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    class _Cast_SingleExcitationResultsModalAnalysis:
        ...
        def design_entity_modal_analysis_group_results(
            ...
            return self._parent._cast(_4721.DesignEntityModalAnalysisGroupResults)
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_4724.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):
