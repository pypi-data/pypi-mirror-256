...
class RootAssemblyCompoundModalAnalysis(_4737.AssemblyCompoundModalAnalysis):
    """RootAssemblyCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4679.RootAssemblyModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4679.RootAssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.RootAssemblyModalAnalysis]
