...
class FEPartCompoundModalAnalysis(_4732.AbstractShaftOrHousingCompoundModalAnalysis):
    """FEPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4634.FEPartModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4634.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
