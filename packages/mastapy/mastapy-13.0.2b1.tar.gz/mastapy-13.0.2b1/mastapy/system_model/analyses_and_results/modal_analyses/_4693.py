...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4692, _4691
...
class StraightBevelDiffGearSetModalAnalysis(_4592.BevelGearSetModalAnalysis):
    """StraightBevelDiffGearSetModalAnalysis
    ...
    def straight_bevel_diff_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4691.StraightBevelDiffGearMeshModalAnalysis]":
