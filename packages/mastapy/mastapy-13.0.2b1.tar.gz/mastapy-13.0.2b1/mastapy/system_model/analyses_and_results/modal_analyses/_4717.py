...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4716, _4715
...
class ZerolBevelGearSetModalAnalysis(_4592.BevelGearSetModalAnalysis):
    """ZerolBevelGearSetModalAnalysis
    ...
    def zerol_bevel_gears_modal_analysis(
        self: Self,
    ) -> "List[_4716.ZerolBevelGearModalAnalysis]":
    ...
    def zerol_bevel_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4715.ZerolBevelGearMeshModalAnalysis]":
