...
class SpiralBevelGearSetCompoundModalAnalysis(_4748.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4829.SpiralBevelGearCompoundModalAnalysis]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4830.SpiralBevelGearMeshCompoundModalAnalysis]":
