...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4649, _4648
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysis(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis(
        self: Self,
    ) -> "List[_4649.KlingelnbergCycloPalloidHypoidGearModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4648.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]":
