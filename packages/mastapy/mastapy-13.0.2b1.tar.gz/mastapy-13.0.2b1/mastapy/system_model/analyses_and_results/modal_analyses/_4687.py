...
class SpiralBevelGearSetModalAnalysis(_4592.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    def spiral_bevel_gears_modal_analysis(
        self: Self,
    ) -> "List[_4686.SpiralBevelGearModalAnalysis]":
    ...
    def spiral_bevel_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4685.SpiralBevelGearMeshModalAnalysis]":
