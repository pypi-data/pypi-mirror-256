...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5780, _5781
...
class KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis(
    ...
    def gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5780.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5781.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]":
