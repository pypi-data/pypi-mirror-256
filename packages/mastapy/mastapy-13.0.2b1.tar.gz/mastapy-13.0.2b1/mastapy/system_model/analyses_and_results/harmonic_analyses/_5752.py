...
class FEPartHarmonicAnalysis(
    ...
    _2656.IHaveFEPartHarmonicAnalysisResults,
):
    """FEPartHarmonicAnalysis
    ...
    class _Cast_FEPartHarmonicAnalysis:
        ...
        @property
        def part_analysis(self: "FEPartHarmonicAnalysis._Cast_FEPartHarmonicAnalysis"):
    ...
    @property
    def coupled_modal_analysis(self: Self) -> "_4634.FEPartModalAnalysis":
    ...
    @property
    def export(self: Self) -> "_5766.HarmonicAnalysisFEExportOptions":
    ...
    @property
    def results(self: Self) -> "_5859.FEPartHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: Self) -> "_2759.FEPartSystemDeflection":
