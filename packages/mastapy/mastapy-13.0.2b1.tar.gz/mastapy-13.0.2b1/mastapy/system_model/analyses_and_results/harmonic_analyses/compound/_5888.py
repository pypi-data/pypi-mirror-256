...
class AssemblyCompoundHarmonicAnalysis(_5881.AbstractAssemblyCompoundHarmonicAnalysis):
    """AssemblyCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5688.AssemblyHarmonicAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_5889.BearingCompoundHarmonicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5891.BeltDriveCompoundHarmonicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5894.BevelDifferentialGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5901.BoltedJointCompoundHarmonicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5900.BoltCompoundHarmonicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5922.CVTCompoundHarmonicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5902.ClutchCompoundHarmonicAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5907.ConceptCouplingCompoundHarmonicAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5912.ConceptGearSetCompoundHarmonicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5924.CycloidalAssemblyCompoundHarmonicAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5926.CycloidalDiscCompoundHarmonicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5930.CylindricalGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5937.FEPartCompoundHarmonicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_5936.FaceGearSetCompoundHarmonicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5938.FlexiblePinAssemblyCompoundHarmonicAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5945.HypoidGearSetCompoundHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5952.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_5955.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_5956.MassDiscCompoundHarmonicAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5957.MeasurementComponentCompoundHarmonicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5959.OilSealCompoundHarmonicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5961.PartToPartShearCouplingCompoundHarmonicAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5966.PlanetCarrierCompoundHarmonicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5967.PointLoadCompoundHarmonicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5968.PowerLoadCompoundHarmonicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5970.RingPinsCompoundHarmonicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5972.RollingRingAssemblyCompoundHarmonicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5977.ShaftHubConnectionCompoundHarmonicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5976.ShaftCompoundHarmonicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5982.SpiralBevelGearSetCompoundHarmonicAnalysis]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5983.SpringDamperCompoundHarmonicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5988.StraightBevelDiffGearSetCompoundHarmonicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5991.StraightBevelGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_5994.SynchroniserCompoundHarmonicAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5998.TorqueConverterCompoundHarmonicAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6002.UnbalancedMassCompoundHarmonicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6006.WormGearSetCompoundHarmonicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6009.ZerolBevelGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_5688.AssemblyHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.AssemblyHarmonicAnalysis]
