...
class AssemblyHarmonicAnalysis(_5680.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: Self) -> "_4581.AssemblyModalAnalysis":
    ...
    @property
    def system_deflection_results(self: Self) -> "_2694.AssemblySystemDeflection":
    ...
    @property
    def bearings(self: Self) -> "List[_5689.BearingHarmonicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5691.BeltDriveHarmonicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5694.BevelDifferentialGearSetHarmonicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5700.BoltedJointHarmonicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5701.BoltHarmonicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5723.CVTHarmonicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5704.ClutchHarmonicAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_5710.ConceptCouplingHarmonicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_5713.ConceptGearSetHarmonicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5725.CycloidalAssemblyHarmonicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_5727.CycloidalDiscHarmonicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5731.CylindricalGearSetHarmonicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5752.FEPartHarmonicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_5751.FaceGearSetHarmonicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5753.FlexiblePinAssemblyHarmonicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_5775.HypoidGearSetHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5782.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]":
    ...
    @property
    def loaded_gear_sets(self: Self) -> "List[_5760.GearSetHarmonicAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5786.MassDiscHarmonicAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5787.MeasurementComponentHarmonicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5789.OilSealHarmonicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5793.PartToPartShearCouplingHarmonicAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_5797.PlanetCarrierHarmonicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5798.PointLoadHarmonicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5799.PowerLoadHarmonicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5802.RingPinsHarmonicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5804.RollingRingAssemblyHarmonicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5809.ShaftHubConnectionHarmonicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5808.ShaftHarmonicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_5819.SpringDamperHarmonicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_5830.SynchroniserHarmonicAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_5834.TorqueConverterHarmonicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_5838.UnbalancedMassHarmonicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_5842.WormGearSetHarmonicAnalysis]":
