...
class ShaftHarmonicAnalysis(
    _5682.AbstractShaftHarmonicAnalysis, _2658.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: Self) -> "_4681.ShaftModalAnalysis":
    ...
    @property
    def export(self: Self) -> "_5770.HarmonicAnalysisShaftExportOptions":
