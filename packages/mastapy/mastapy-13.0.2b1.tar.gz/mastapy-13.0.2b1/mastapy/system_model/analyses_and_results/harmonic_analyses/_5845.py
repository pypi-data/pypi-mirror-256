...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5843, _5844
...
class ZerolBevelGearSetHarmonicAnalysis(_5699.BevelGearSetHarmonicAnalysis):
    """ZerolBevelGearSetHarmonicAnalysis
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5844.ZerolBevelGearMeshHarmonicAnalysis]":
