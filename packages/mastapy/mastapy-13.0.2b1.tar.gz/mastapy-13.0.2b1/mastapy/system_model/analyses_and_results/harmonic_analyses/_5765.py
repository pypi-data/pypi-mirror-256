...
TPart = TypeVar("TPart", bound="_2470.Part")
...
class HarmonicAnalysisExportOptions(_0.APIBase, Generic[TPartAnalysis, TPart]):
    ...
    class _Cast_HarmonicAnalysisExportOptions:
        ...
        def harmonic_analysis_fe_export_options(
            ...
            return self._parent._cast(_5766.HarmonicAnalysisFEExportOptions)
        ...
        def harmonic_analysis_root_assembly_export_options(
            ...
            return self._parent._cast(_5769.HarmonicAnalysisRootAssemblyExportOptions)
        ...
        def harmonic_analysis_shaft_export_options(
            ...
            return self._parent._cast(_5770.HarmonicAnalysisShaftExportOptions)
    ...
    def distance_units_for_export(self: Self, value: "_1612.Unit"):
    ...
    @export_type.setter
    @enforce_parameter_types
    def export_type(self: Self, value: "_5747.ExportOutputType"):
    ...
    @enforce_parameter_types
    def type_of_result_to_export(self: Self, value: "_4629.DynamicsResponseType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def analysis_options(self: Self) -> "_5768.HarmonicAnalysisOptions":
