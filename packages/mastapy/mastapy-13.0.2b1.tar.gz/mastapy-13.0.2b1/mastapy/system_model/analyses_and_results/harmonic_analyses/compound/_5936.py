...
class FaceGearSetCompoundHarmonicAnalysis(_5941.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5751.FaceGearSetHarmonicAnalysis]":
    ...
    def face_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5934.FaceGearCompoundHarmonicAnalysis]":
    ...
    def face_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5935.FaceGearMeshCompoundHarmonicAnalysis]":
