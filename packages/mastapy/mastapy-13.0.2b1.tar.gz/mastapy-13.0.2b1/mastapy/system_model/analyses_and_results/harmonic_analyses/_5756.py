...
class GearMeshExcitationDetail(_5681.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    def gear_mesh(self: Self) -> "_2761.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: Self) -> "_5706.ComplianceAndForceData":
