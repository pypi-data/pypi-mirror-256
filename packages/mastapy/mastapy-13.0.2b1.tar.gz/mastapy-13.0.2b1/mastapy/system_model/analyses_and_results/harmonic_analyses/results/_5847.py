...
class ExcitationSourceSelection(_5848.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self: Self) -> "List[_5850.HarmonicSelection]":
    ...
    def include_only_harmonic_with_order(
        self: Self, order: "_1530.RoundedOrder"
    ) -> "bool":
        """bool
