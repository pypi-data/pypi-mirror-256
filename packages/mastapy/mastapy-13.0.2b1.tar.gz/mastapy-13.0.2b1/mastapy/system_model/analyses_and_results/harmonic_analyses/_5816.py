...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5814, _5815
...
class SpiralBevelGearSetHarmonicAnalysis(_5699.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    def gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5814.SpiralBevelGearHarmonicAnalysis]":
