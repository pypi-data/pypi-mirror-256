...
class ResultsForOrderIncludingSurfaces(_5873.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    class _Cast_ResultsForOrderIncludingSurfaces:
        ...
        def results_for_order_including_nodes(
            ...
            return self._parent._cast(_5873.ResultsForOrderIncludingNodes)
        ...
        def results_for_order(
            ...
            return self._parent._cast(_5871.ResultsForOrder)
    ...
    def fe_surfaces(
        self: Self,
    ) -> "List[_5866.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]":
