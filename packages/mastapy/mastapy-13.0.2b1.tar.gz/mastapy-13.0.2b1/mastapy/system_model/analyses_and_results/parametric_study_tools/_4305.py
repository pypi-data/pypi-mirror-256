...
class AssemblyParametricStudyTool(_4298.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    def all_duty_cycle_results(
        self: Self,
    ) -> "List[_4352.DutyCycleResultsForAllComponents]":
    ...
    @property
    def bearings(self: Self) -> "List[_4306.BearingParametricStudyTool]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4308.BeltDriveParametricStudyTool]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4311.BevelDifferentialGearSetParametricStudyTool]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4317.BoltedJointParametricStudyTool]":
    ...
    @property
    def bolts(self: Self) -> "List[_4318.BoltParametricStudyTool]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4339.CVTParametricStudyTool]":
    ...
    @property
    def clutches(self: Self) -> "List[_4321.ClutchParametricStudyTool]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_4329.ConceptGearSetParametricStudyTool]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4341.CycloidalAssemblyParametricStudyTool]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4343.CycloidalDiscParametricStudyTool]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4347.CylindricalGearSetParametricStudyTool]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4361.FEPartParametricStudyTool]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4360.FaceGearSetParametricStudyTool]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4362.FlexiblePinAssemblyParametricStudyTool]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4369.HypoidGearSetParametricStudyTool]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4380.MassDiscParametricStudyTool]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4384.OilSealParametricStudyTool]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4401.PlanetCarrierParametricStudyTool]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4402.PointLoadParametricStudyTool]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4403.PowerLoadParametricStudyTool]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4405.RingPinsParametricStudyTool]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4407.RollingRingAssemblyParametricStudyTool]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4411.ShaftHubConnectionParametricStudyTool]":
    ...
    @property
    def shafts(self: Self) -> "List[_4412.ShaftParametricStudyTool]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4420.SpringDamperParametricStudyTool]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4426.StraightBevelGearSetParametricStudyTool]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4430.SynchroniserParametricStudyTool]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4434.TorqueConverterParametricStudyTool]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4441.WormGearSetParametricStudyTool]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4444.ZerolBevelGearSetParametricStudyTool]":
