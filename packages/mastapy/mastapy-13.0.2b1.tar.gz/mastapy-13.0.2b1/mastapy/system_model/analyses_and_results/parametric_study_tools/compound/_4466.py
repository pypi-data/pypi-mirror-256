...
class ClutchCompoundParametricStudyTool(_4482.CouplingCompoundParametricStudyTool):
    """ClutchCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6837.ClutchLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4321.ClutchParametricStudyTool]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4321.ClutchParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.ClutchParametricStudyTool]
