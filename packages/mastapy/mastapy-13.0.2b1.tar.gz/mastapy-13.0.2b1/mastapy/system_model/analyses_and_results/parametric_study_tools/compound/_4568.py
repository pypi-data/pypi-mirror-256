...
class WormGearCompoundParametricStudyTool(_4503.GearCompoundParametricStudyTool):
    """WormGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6985.WormGearLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4440.WormGearParametricStudyTool]":
