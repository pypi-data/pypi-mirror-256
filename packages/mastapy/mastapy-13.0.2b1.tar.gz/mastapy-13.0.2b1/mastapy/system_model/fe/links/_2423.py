...
class GearMeshFELink(_2425.MultiAngleConnectionFELink):
    """GearMeshFELink
    ...
    class _Cast_GearMeshFELink:
        ...
        @property
        def multi_angle_connection_fe_link(self: "GearMeshFELink._Cast_GearMeshFELink"):
            return self._parent._cast(_2425.MultiAngleConnectionFELink)

        @property
        def multi_node_fe_link(self: "GearMeshFELink._Cast_GearMeshFELink"):
            from mastapy.system_model.fe.links import _2427

            return self._parent._cast(_2427.MultiNodeFELink)

        @property
        def fe_link(self: "GearMeshFELink._Cast_GearMeshFELink"):
    ...
    def reference_fe_substructure_node_for_misalignments(
        self: Self, value: "_2387.FESubstructureNode"
    ):
        wrapper_type = (
