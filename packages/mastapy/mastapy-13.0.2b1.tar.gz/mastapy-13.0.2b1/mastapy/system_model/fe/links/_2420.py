...
from mastapy.system_model.fe import _2365, _2400, _2404, _2387
...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2399
...
class FELink(_0.APIBase):
    ...
    class _Cast_FELink:
        ...
        @property
        def electric_machine_stator_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2421

            return self._parent._cast(_2421.ElectricMachineStatorFELink)

        @property
        def gear_mesh_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2423

            return self._parent._cast(_2423.GearMeshFELink)

        @property
        def gear_with_duplicated_meshes_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2424

            return self._parent._cast(_2424.GearWithDuplicatedMeshesFELink)

        @property
        def multi_angle_connection_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2425

            return self._parent._cast(_2425.MultiAngleConnectionFELink)

        @property
        def multi_node_connector_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2426

            return self._parent._cast(_2426.MultiNodeConnectorFELink)

        @property
        def multi_node_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2427

            return self._parent._cast(_2427.MultiNodeFELink)

        @property
        def planetary_connector_multi_node_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2428

            return self._parent._cast(_2428.PlanetaryConnectorMultiNodeFELink)

        @property
        def planet_based_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2429

            return self._parent._cast(_2429.PlanetBasedFELink)

        @property
        def planet_carrier_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2430

            return self._parent._cast(_2430.PlanetCarrierFELink)

        @property
        def point_load_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2431

            return self._parent._cast(_2431.PointLoadFELink)

        @property
        def rolling_ring_connection_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2432

            return self._parent._cast(_2432.RollingRingConnectionFELink)

        @property
        def shaft_hub_connection_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2433

            return self._parent._cast(_2433.ShaftHubConnectionFELink)

        @property
        def single_node_fe_link(self: "FELink._Cast_FELink"):
            from mastapy.system_model.fe.links import _2434

            return self._parent._cast(_2434.SingleNodeFELink)
    ...
    @enforce_parameter_types
    def bearing_node_link_option(self: Self, value: "_2365.BearingNodeOption"):
    ...
    @enforce_parameter_types
    def link_node_source(self: Self, value: "_2400.LinkNodeSource"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def node_selection_depth(
        self: Self,
        value: "Union[_2404.NodeSelectionDepthOption, Tuple[_2404.NodeSelectionDepthOption, bool]]",
    ):
    ...
    @property
    def component(self: Self) -> "_2466.MountableComponent":
    ...
    @property
    def socket(self: Self) -> "_2298.Socket":
    ...
    @property
    def support_material(self: Self) -> "_269.Material":
    ...
    def nodes_grouped_by_angle(
        self: Self,
    ) -> "OrderedDict[float, List[_2387.FESubstructureNode]]":
    ...
    @enforce_parameter_types
    def add_or_replace_node(self: Self, node: "_2387.FESubstructureNode"):
