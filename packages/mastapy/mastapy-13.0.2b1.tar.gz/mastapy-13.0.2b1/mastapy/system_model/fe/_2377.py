...
from mastapy.system_model.fe import _2379
...
class ElementFaceGroupWithSelection(
    _2379.FEEntityGroupWithSelection["_224.CMSElementFaceGroup", "_1233.ElementFace"]
):
    """ElementFaceGroupWithSelection
    ...
    class _Cast_ElementFaceGroupWithSelection:
        ...
        def fe_entity_group_with_selection(
            ...
            return self._parent._cast(_2379.FEEntityGroupWithSelection)
