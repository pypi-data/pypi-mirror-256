...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.load_cases_and_analyses import _1348, _1357
...
class ElectricMachineDynamicLoadData(_0.APIBase):
    ...
    @property
    def electric_machine_data_sets(self: Self) -> "List[_2375.ElectricMachineDataSet]":
    ...
    def add_electric_machine_data_set_from_masta_dynamic_force_analysis(
        self: Self, analysis: "_1348.DynamicForceAnalysis", slice_index: "Optional[int]"
    ) -> "_2375.ElectricMachineDataSet":
        """mastapy.system_model.fe.ElectricMachineDataSet
    ...
    def add_electric_machine_data_set_from_masta_electric_machine_fe_analysis(
        self: Self,
        analysis: "_1357.ElectricMachineFEAnalysis",
        slice_index: "Optional[int]",
    ) -> "_2375.ElectricMachineDataSet":
        """mastapy.system_model.fe.ElectricMachineDataSet
