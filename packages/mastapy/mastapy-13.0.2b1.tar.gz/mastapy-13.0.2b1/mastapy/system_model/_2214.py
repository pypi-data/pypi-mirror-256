...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1881, _1882, _1895, _1901
    from mastapy.bolts import _1470, _1472, _1477
...
class MASTASettings(_0.APIBase):
    ...
    @property
    def iso14179_settings_database(self: Self) -> "_1977.ISO14179SettingsDatabase":
    ...
    @property
    def bearing_settings(self: Self) -> "_1881.BearingSettings":
    ...
    @property
    def bearing_settings_database(self: Self) -> "_1882.BearingSettingsDatabase":
    ...
    @property
    def rolling_bearing_database(self: Self) -> "_1895.RollingBearingDatabase":
    ...
    @property
    def skf_settings(self: Self) -> "_1901.SKFSettings":
    ...
    @property
    def bolt_geometry_database(self: Self) -> "_1470.BoltGeometryDatabase":
    ...
    @property
    def bolt_material_database(self: Self) -> "_1472.BoltMaterialDatabase":
    ...
    @property
    def ring_pins_material_database(self: Self) -> "_1465.RingPinsMaterialDatabase":
    ...
    @property
    def magnet_material_database(self: Self) -> "_1285.MagnetMaterialDatabase":
    ...
    @property
    def winding_material_database(self: Self) -> "_1316.WindingMaterialDatabase":
    ...
    @property
    def harmonic_analysis_draw_style(self: Self) -> "_5764.HarmonicAnalysisDrawStyle":
    ...
    @property
    def mbd_analysis_draw_style(self: Self) -> "_5462.MBDAnalysisDrawStyle":
    ...
    @property
    def modal_analysis_draw_style(self: Self) -> "_4658.ModalAnalysisDrawStyle":
    ...
    @property
    def power_flow_draw_style(self: Self) -> "_4125.PowerFlowDrawStyle":
    ...
    @property
    def stability_analysis_draw_style(self: Self) -> "_3873.StabilityAnalysisDrawStyle":
    ...
    @property
    def system_deflection_draw_style(self: Self) -> "_2828.SystemDeflectionDrawStyle":
    ...
    @property
    def model_view_options_draw_style(self: Self) -> "_2254.ModelViewOptionsDrawStyle":
    ...
    @property
    def planet_carrier_settings(self: Self) -> "_2472.PlanetCarrierSettings":
    ...
    @property
    def cad_export_settings(self: Self) -> "_1834.CADExportSettings":
    ...
    @property
    def database_settings(self: Self) -> "_1829.DatabaseSettings":
    ...
    @property
    def program_settings(self: Self) -> "_1598.ProgramSettings":
    ...
    @property
    def pushbullet_settings(self: Self) -> "_1599.PushbulletSettings":
    ...
    @property
    def scripting_setup(self: Self) -> "_1741.ScriptingSetup":
    ...
    @property
    def measurement_settings(self: Self) -> "_1608.MeasurementSettings":
