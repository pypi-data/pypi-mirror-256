...
from mastapy.utility.enums import _1824, _1825
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    class _Cast_PartAnalysisCaseWithContourViewable:
        ...
        def abstract_system_deflection_viewable(
            ...
            return self._parent._cast(_2245.AbstractSystemDeflectionViewable)
        ...
        def advanced_system_deflection_viewable(
            ...
            return self._parent._cast(_2246.AdvancedSystemDeflectionViewable)
        ...
        def harmonic_analysis_viewable(
            ...
            return self._parent._cast(_2251.HarmonicAnalysisViewable)
        ...
        def modal_analysis_viewable(
            ...
            return self._parent._cast(_2253.ModalAnalysisViewable)
        ...
        def system_deflection_viewable(
            ...
            return self._parent._cast(_2262.SystemDeflectionViewable)
    ...
    def contour(self: Self, value: "_1824.ThreeDViewContourOptionFirstSelection"):
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: Self, value: "_1825.ThreeDViewContourOptionSecondSelection"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def contour_draw_style(self: Self) -> "_2248.ContourDrawStyle":
