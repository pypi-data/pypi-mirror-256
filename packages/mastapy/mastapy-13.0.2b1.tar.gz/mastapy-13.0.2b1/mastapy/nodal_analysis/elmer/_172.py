...
class ElmerResultsViewable(_0.APIBase):
    ...
    class _Cast_ElmerResultsViewable:
        ...
        def electric_machine_mechanical_results_viewable(
            ...
            from mastapy.electric_machines.results import _1326

            return self._parent._cast(_1326.ElectricMachineMechanicalResultsViewable)
        ...
        def electric_machine_results_viewable(
            ...
            return self._parent._cast(_1338.ElectricMachineResultsViewable)
    ...
    @enforce_parameter_types
    def degree_of_freedom(self: Self, value: "_1528.ResultOptionsFor3DVector"):
    ...
    @result_type.setter
    @enforce_parameter_types
    def result_type(self: Self, value: "_173.ElmerResultType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def scaling_draw_style(self: Self) -> "_1853.ScalingDrawStyle":
