...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1453, _1460
...
class CycloidalDiscModificationsSpecification(_0.APIBase):
    ...
    def crowning_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.cycloidal._1453", "CrowningSpecificationMethod"
        )(value)

    @crowning_specification_method.setter
    @enforce_parameter_types
    def crowning_specification_method(
        self: Self, value: "_1453.CrowningSpecificationMethod"
    ):
    ...
    def direction_of_measured_modifications(
        ...
        return constructor.new_from_mastapy(
            "mastapy.cycloidal._1460", "DirectionOfMeasuredModifications"
        )(value)

    @direction_of_measured_modifications.setter
    @enforce_parameter_types
    def direction_of_measured_modifications(
        self: Self, value: "_1460.DirectionOfMeasuredModifications"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def measured_profile_modification(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def measured_profile_modification(self: Self, value: "_1536.Vector2DListAccessor"):
