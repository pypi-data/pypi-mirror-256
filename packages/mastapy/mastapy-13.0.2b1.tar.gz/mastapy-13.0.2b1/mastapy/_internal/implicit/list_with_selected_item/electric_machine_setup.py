...
class ListWithSelectedItem_ElectricMachineSetup(
    _1267.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self, instance_to_wrap: "ListWithSelectedItem_ElectricMachineSetup.TYPE"
    ):
        try:
    ...
    @classmethod
    def implicit_type(cls) -> "_1267.ElectricMachineSetup.TYPE":
        ...
        return _1267.ElectricMachineSetup.TYPE

    @property
    def selected_value(self: Self) -> "_1267.ElectricMachineSetup":
    ...
    @property
    def available_values(self: Self) -> "List[_1267.ElectricMachineSetup]":
