...
class ListWithSelectedItem_ElectricMachineDetail(
    _1262.ElectricMachineDetail, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self, instance_to_wrap: "ListWithSelectedItem_ElectricMachineDetail.TYPE"
    ):
        try:
    ...
    @classmethod
    def implicit_type(cls) -> "_1262.ElectricMachineDetail.TYPE":
        ...
        return _1262.ElectricMachineDetail.TYPE

    @property
    def selected_value(self: Self) -> "_1262.ElectricMachineDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_1262.ElectricMachineDetail]":
