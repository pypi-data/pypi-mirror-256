...
class ListWithSelectedItem_ElectricMachineResults(
    _1327.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self, instance_to_wrap: "ListWithSelectedItem_ElectricMachineResults.TYPE"
    ):
        try:
    ...
    @classmethod
    def implicit_type(cls) -> "_1327.ElectricMachineResults.TYPE":
        ...
        return _1327.ElectricMachineResults.TYPE

    @property
    def selected_value(self: Self) -> "_1327.ElectricMachineResults":
    ...
    @property
    def available_values(self: Self) -> "List[_1327.ElectricMachineResults]":
