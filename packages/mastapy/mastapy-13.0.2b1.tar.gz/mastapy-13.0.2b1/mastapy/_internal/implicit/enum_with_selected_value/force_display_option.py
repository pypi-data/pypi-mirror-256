...
class EnumWithSelectedValue_ForceDisplayOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1380.ForceDisplayOption":
        ...
        return _1380.ForceDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1380.ForceDisplayOption.type_()":
        ...
        return _1380.ForceDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1380.ForceDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1380.ForceDisplayOption]":
