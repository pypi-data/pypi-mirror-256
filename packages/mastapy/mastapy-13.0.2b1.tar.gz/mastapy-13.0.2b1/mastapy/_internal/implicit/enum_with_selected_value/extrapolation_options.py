...
class EnumWithSelectedValue_ExtrapolationOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1511.ExtrapolationOptions":
        ...
        return _1511.ExtrapolationOptions

    @classmethod
    def implicit_type(cls) -> "_1511.ExtrapolationOptions.type_()":
        ...
        return _1511.ExtrapolationOptions.type_()

    @property
    def selected_value(self: Self) -> "_1511.ExtrapolationOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1511.ExtrapolationOptions]":
