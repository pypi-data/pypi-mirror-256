...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1496.ComplexPartDisplayOption":
        ...
        return _1496.ComplexPartDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1496.ComplexPartDisplayOption.type_()":
        ...
        return _1496.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1496.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1496.ComplexPartDisplayOption]":
