...
class EnumWithSelectedValue_SplineFitClassType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1413.SplineFitClassType":
        ...
        return _1413.SplineFitClassType

    @classmethod
    def implicit_type(cls) -> "_1413.SplineFitClassType.type_()":
        ...
        return _1413.SplineFitClassType.type_()

    @property
    def selected_value(self: Self) -> "_1413.SplineFitClassType":
    ...
    @property
    def available_values(self: Self) -> "List[_1413.SplineFitClassType]":
