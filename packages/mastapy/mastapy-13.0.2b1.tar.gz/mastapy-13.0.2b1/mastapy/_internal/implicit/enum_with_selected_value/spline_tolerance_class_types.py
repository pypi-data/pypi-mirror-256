...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1419.SplineToleranceClassTypes":
        ...
        return _1419.SplineToleranceClassTypes

    @classmethod
    def implicit_type(cls) -> "_1419.SplineToleranceClassTypes.type_()":
        ...
        return _1419.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: Self) -> "_1419.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1419.SplineToleranceClassTypes]":
