...
class EnumWithSelectedValue_PressureAngleTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1405.PressureAngleTypes":
        ...
        return _1405.PressureAngleTypes

    @classmethod
    def implicit_type(cls) -> "_1405.PressureAngleTypes.type_()":
        ...
        return _1405.PressureAngleTypes.type_()

    @property
    def selected_value(self: Self) -> "_1405.PressureAngleTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1405.PressureAngleTypes]":
