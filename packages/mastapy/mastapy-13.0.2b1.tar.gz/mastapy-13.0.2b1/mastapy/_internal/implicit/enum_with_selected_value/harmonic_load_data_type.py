...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1383.HarmonicLoadDataType":
        ...
        return _1383.HarmonicLoadDataType

    @classmethod
    def implicit_type(cls) -> "_1383.HarmonicLoadDataType.type_()":
        ...
        return _1383.HarmonicLoadDataType.type_()

    @property
    def selected_value(self: Self) -> "_1383.HarmonicLoadDataType":
    ...
    @property
    def available_values(self: Self) -> "List[_1383.HarmonicLoadDataType]":
