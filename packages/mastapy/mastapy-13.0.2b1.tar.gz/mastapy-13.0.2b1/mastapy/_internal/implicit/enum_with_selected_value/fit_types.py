...
class EnumWithSelectedValue_FitTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1396.FitTypes":
        ...
        return _1396.FitTypes

    @classmethod
    def implicit_type(cls) -> "_1396.FitTypes.type_()":
        ...
        return _1396.FitTypes.type_()

    @property
    def selected_value(self: Self) -> "_1396.FitTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1396.FitTypes]":
