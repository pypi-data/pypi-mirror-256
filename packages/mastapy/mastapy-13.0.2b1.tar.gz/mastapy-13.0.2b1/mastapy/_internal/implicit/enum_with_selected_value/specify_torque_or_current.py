...
class EnumWithSelectedValue_SpecifyTorqueOrCurrent(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1373.SpecifyTorqueOrCurrent":
        ...
        return _1373.SpecifyTorqueOrCurrent

    @classmethod
    def implicit_type(cls) -> "_1373.SpecifyTorqueOrCurrent.type_()":
        ...
        return _1373.SpecifyTorqueOrCurrent.type_()

    @property
    def selected_value(self: Self) -> "_1373.SpecifyTorqueOrCurrent":
    ...
    @property
    def available_values(self: Self) -> "List[_1373.SpecifyTorqueOrCurrent]":
