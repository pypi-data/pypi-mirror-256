...
class DatabaseKey(_0.APIBase):
    ...
    class _Cast_DatabaseKey:
        ...
        @property
        def user_defined_property_key(self: "DatabaseKey._Cast_DatabaseKey"):
            from mastapy.utility.scripting import _1742

            return self._parent._cast(_1742.UserDefinedPropertyKey)

        @property
        def custom_report_key(self: "DatabaseKey._Cast_DatabaseKey"):
            from mastapy.utility.report import _1770

            return self._parent._cast(_1770.CustomReportKey)

        @property
        def named_key(self: "DatabaseKey._Cast_DatabaseKey"):
            from mastapy.utility.databases import _1832

            return self._parent._cast(_1832.NamedKey)

        @property
        def rolling_bearing_key(self: "DatabaseKey._Cast_DatabaseKey"):
            from mastapy.bearings import _1896

            return self._parent._cast(_1896.RollingBearingKey)
