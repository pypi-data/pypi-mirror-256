...
class CustomReportTab(_1769.CustomReportItemContainerCollectionItem):
    """CustomReportTab
    ...
    class _Cast_CustomReportTab:
        ...
        @property
        def custom_report_item_container(self: "CustomReportTab._Cast_CustomReportTab"):
            from mastapy.utility.report import _1766

            return self._parent._cast(_1766.CustomReportItemContainer)

        @property
        def custom_report_item(self: "CustomReportTab._Cast_CustomReportTab"):
