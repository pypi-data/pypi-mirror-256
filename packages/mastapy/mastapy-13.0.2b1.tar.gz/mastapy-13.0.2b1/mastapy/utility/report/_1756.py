...
from mastapy.utility.report import _1747, _1766
...
if TYPE_CHECKING:
    from mastapy.utility.report import _1749, _1783, _1748
...
class CustomReport(_1766.CustomReportItemContainer):
    """CustomReport
    ...
    class _Cast_CustomReport:
        ...
        @property
        def custom_report_item_container(self: "CustomReport._Cast_CustomReport"):
            return self._parent._cast(_1766.CustomReportItemContainer)

        @property
        def custom_report_item(self: "CustomReport._Cast_CustomReport"):
    ...
    @property
    def cad_table_border_style(self: Self) -> "_1749.CadTableBorderType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1749", "CadTableBorderType"
        )(value)

    @cad_table_border_style.setter
    @enforce_parameter_types
    def cad_table_border_style(self: Self, value: "_1749.CadTableBorderType"):
    ...
    @property
    def include_report_check(self: Self) -> "_1783.DefinitionBooleanCheckOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1783", "DefinitionBooleanCheckOptions"
        )(value)

    @include_report_check.setter
    @enforce_parameter_types
    def include_report_check(self: Self, value: "_1783.DefinitionBooleanCheckOptions"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def page_orientation_for_cad_export(self: Self, value: "_1747.CadPageOrientation"):
    ...
    @property
    def page_size_for_cad_export(self: Self) -> "_1748.CadPageSize":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1748", "CadPageSize"
        )(value)

    @page_size_for_cad_export.setter
    @enforce_parameter_types
    def page_size_for_cad_export(self: Self, value: "_1748.CadPageSize"):
        value = conversion.mp_to_pn_enum(
