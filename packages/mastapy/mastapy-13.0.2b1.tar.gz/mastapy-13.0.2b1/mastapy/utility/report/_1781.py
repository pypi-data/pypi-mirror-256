...
class CustomSubReport(_1762.CustomReportDefinitionItem):
    """CustomSubReport
    ...
    class _Cast_CustomSubReport:
        ...
        @property
        def custom_report_nameable_item(self: "CustomSubReport._Cast_CustomSubReport"):
            from mastapy.utility.report import _1773

            return self._parent._cast(_1773.CustomReportNameableItem)

        @property
        def custom_report_item(self: "CustomSubReport._Cast_CustomSubReport"):
