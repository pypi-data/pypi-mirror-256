...
class CustomRow(_1775.CustomReportPropertyItem):
    """CustomRow
    ...
    class _Cast_CustomRow:
        ...
        @property
        def custom_report_property_item(self: "CustomRow._Cast_CustomRow"):
            return self._parent._cast(_1775.CustomReportPropertyItem)

        @property
        def blank_row(self: "CustomRow._Cast_CustomRow"):
            from mastapy.utility.report import _1746

            return self._parent._cast(_1746.BlankRow)

        @property
        def user_text_row(self: "CustomRow._Cast_CustomRow"):
