...
class UserTextRow(_1780.CustomRow):
    """UserTextRow
    ...
    class _Cast_UserTextRow:
        ...
        @property
        def custom_row(self: "UserTextRow._Cast_UserTextRow"):
            return self._parent._cast(_1780.CustomRow)

        @property
        def custom_report_property_item(self: "UserTextRow._Cast_UserTextRow"):
            from mastapy.utility.report import _1775

            return self._parent._cast(_1775.CustomReportPropertyItem)
    ...
    @property
    def heading_size(self: Self) -> "_1787.HeadingSize":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1787", "HeadingSize"
        )(value)

    @heading_size.setter
    @enforce_parameter_types
    def heading_size(self: Self, value: "_1787.HeadingSize"):
