...
class CustomDrawing(_1754.CustomGraphic):
    """CustomDrawing
    ...
    class _Cast_CustomDrawing:
        ...
        @property
        def custom_graphic(self: "CustomDrawing._Cast_CustomDrawing"):
            return self._parent._cast(_1754.CustomGraphic)

        @property
        def custom_report_definition_item(self: "CustomDrawing._Cast_CustomDrawing"):
            from mastapy.utility.report import _1762

            return self._parent._cast(_1762.CustomReportDefinitionItem)

        @property
        def custom_report_nameable_item(self: "CustomDrawing._Cast_CustomDrawing"):
            from mastapy.utility.report import _1773

            return self._parent._cast(_1773.CustomReportNameableItem)

        @property
        def custom_report_item(self: "CustomDrawing._Cast_CustomDrawing"):
