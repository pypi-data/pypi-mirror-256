...
class Force(_1607.MeasurementBase):
    """Force
    ...
    class _Cast_Force:
        ...
        @property
        def measurement_base(self: "Force._Cast_Force"):
    ...
    @property
    def kilograms_force(self: Self) -> "_1612.Unit":
    ...
    @property
    def kilonewtons(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def millinewtons(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def newtons(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def ounces_force(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def pounds_force(self: Self) -> "_1612.Unit":
        """mastapy.utility.units_and_measurements.Unit
