...
class MeasurementSettings(_1596.PerMachineSettings):
    """MeasurementSettings
    ...
    class _Cast_MeasurementSettings:
        ...
        @property
        def per_machine_settings(self: "MeasurementSettings._Cast_MeasurementSettings"):
            return self._parent._cast(_1596.PerMachineSettings)

        @property
        def persistent_singleton(self: "MeasurementSettings._Cast_MeasurementSettings"):
    ...
    @enforce_parameter_types
    def selected_measurement(self: Self, value: "_1607.MeasurementBase"):
        wrapper_type = (
    ...
    @property
    def current_selected_measurement(self: Self) -> "_1607.MeasurementBase":
    ...
    @enforce_parameter_types
    def find_measurement_by_name(self: Self, name: "str") -> "_1607.MeasurementBase":
        """mastapy.utility.units_and_measurements.MeasurementBase
    ...
    @enforce_parameter_types
    def get_measurement(
        self: Self, measurement_type: "_7562.MeasurementType"
