...
TMeasurement = TypeVar("TMeasurement", bound="_1607.MeasurementBase")
T = TypeVar("T")
...
class DutyCyclePropertySummary(_0.APIBase, Generic[TMeasurement, T]):
    ...
    class _Cast_DutyCyclePropertySummary:
        ...
        def duty_cycle_property_summary_force(
            ...
            return self._parent._cast(_1840.DutyCyclePropertySummaryForce)
        ...
        def duty_cycle_property_summary_percentage(
            ...
            return self._parent._cast(_1841.DutyCyclePropertySummaryPercentage)
        ...
        def duty_cycle_property_summary_small_angle(
            ...
            return self._parent._cast(_1842.DutyCyclePropertySummarySmallAngle)
        ...
        def duty_cycle_property_summary_stress(
            ...
            return self._parent._cast(_1843.DutyCyclePropertySummaryStress)
        ...
        def duty_cycle_property_summary_very_short_length(
            ...
            return self._parent._cast(_1844.DutyCyclePropertySummaryVeryShortLength)
