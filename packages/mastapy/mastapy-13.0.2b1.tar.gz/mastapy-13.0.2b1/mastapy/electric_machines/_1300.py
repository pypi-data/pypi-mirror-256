...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1301, _1307
...
class Stator(_1243.AbstractStator):
    ...
    class _Cast_Stator:
        ...
        @property
        def abstract_stator(self: "Stator._Cast_Stator"):
    ...
    def stator_cut_out_specifications(
        self: Self,
    ) -> "List[_1301.StatorCutOutSpecification]":
    ...
    @property
    def tooth_and_slot(self: Self) -> "_1307.ToothAndSlot":
