...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1367, _1364
...
class OnLoadElectricMachineResults(_1327.ElectricMachineResults):
    """OnLoadElectricMachineResults
    ...
    class _Cast_OnLoadElectricMachineResults:
        ...
        def electric_machine_results(
            ...
            return self._parent._cast(_1327.ElectricMachineResults)
    ...
    @property
    def motoring_or_generating(self: Self) -> "_1367.MotoringOrGenerating":
    ...
    @property
    def power_factor_direction(self: Self) -> "_1364.LeadingOrLagging":
    ...
    @property
    def windings(self: Self) -> "_1317.Windings":
