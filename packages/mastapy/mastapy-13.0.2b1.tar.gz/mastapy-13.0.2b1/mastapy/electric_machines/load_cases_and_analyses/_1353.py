...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1262, _1267
...
class ElectricMachineAnalysis(_0.APIBase):
    ...
    class _Cast_ElectricMachineAnalysis:
        ...
        def dynamic_force_analysis(
            ...
            return self._parent._cast(_1348.DynamicForceAnalysis)
        ...
        def efficiency_map_analysis(
            ...
            return self._parent._cast(_1351.EfficiencyMapAnalysis)
        ...
        def electric_machine_fe_analysis(
            ...
            return self._parent._cast(_1357.ElectricMachineFEAnalysis)
        ...
        def electric_machine_fe_mechanical_analysis(
            ...
            return self._parent._cast(_1358.ElectricMachineFEMechanicalAnalysis)
        ...
        def single_operating_point_analysis(
            ...
            return self._parent._cast(_1371.SingleOperatingPointAnalysis)
        ...
        def speed_torque_curve_analysis(
            ...
            return self._parent._cast(_1375.SpeedTorqueCurveAnalysis)
    ...
    @property
    def load_case(self: Self) -> "_1360.ElectricMachineLoadCaseBase":
    ...
    @property
    def setup(self: Self) -> "_1267.ElectricMachineSetup":
    ...
    def perform_analysis_with_progress(self: Self, token: "_7561.TaskProgress"):
        """Method does not return.
