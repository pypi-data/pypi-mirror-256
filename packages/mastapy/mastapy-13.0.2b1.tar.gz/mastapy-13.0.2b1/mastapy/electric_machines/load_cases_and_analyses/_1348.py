...
from mastapy.electric_machines.results import _1340
...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1347, _1357
...
class DynamicForceAnalysis(
    _1353.ElectricMachineAnalysis, _1340.IHaveDynamicForceResults
):
    """DynamicForceAnalysis
    ...
    class _Cast_DynamicForceAnalysis:
        ...
        def electric_machine_analysis(
            ...
            return self._parent._cast(_1353.ElectricMachineAnalysis)
    ...
    @property
    def load_case(self: Self) -> "_1347.BasicDynamicForceLoadCase":
    ...
    @property
    def results(self: Self) -> "_1322.DynamicForceResults":
    ...
    def single_operating_point_analyses(
        self: Self,
    ) -> "List[_1357.ElectricMachineFEAnalysis]":
