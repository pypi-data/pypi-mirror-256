...
if TYPE_CHECKING:
    ...
    from mastapy.utility import _1592
...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def dynamic_forces_load_cases(self: Self) -> "List[_1349.DynamicForceLoadCase]":
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1347.BasicDynamicForceLoadCase]":
    ...
    @property
    def efficiency_map_load_cases(self: Self) -> "List[_1352.EfficiencyMapLoadCase]":
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        self: Self,
    ) -> "List[_1377.SpeedTorqueLoadCase]":
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1359.ElectricMachineLoadCase]":
    ...
    def speed_torque_curve_load_cases(
        self: Self,
    ) -> "List[_1376.SpeedTorqueCurveLoadCase]":
    ...
    @enforce_parameter_types
    def add_load_case(
        self: Self, load_case_type: "_1365.LoadCaseType"
    ...
    def add_load_case_named(
        self: Self, load_case_type: "_1365.LoadCaseType", name: "str"
    ) -> "_1360.ElectricMachineLoadCaseBase":
        """mastapy.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase
    ...
    def perform_compound_analysis(
        self: Self,
        setup: "_1267.ElectricMachineSetup",
        load_case_type: "_1365.LoadCaseType",
    ) -> "_1592.MethodOutcome":
    ...
    def perform_compound_analysis_with_progress(
        ...
        setup: "_1267.ElectricMachineSetup",
        load_case_type: "_1365.LoadCaseType",
        task_progress: "_7561.TaskProgress",
    ) -> "_1592.MethodOutcome":
        """mastapy.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: Self, load_case: "_1360.ElectricMachineLoadCaseBase"
    ) -> "bool":
        """bool
