...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1369, _1350, _1348
...
class BasicDynamicForceLoadCase(_1360.ElectricMachineLoadCaseBase):
    """BasicDynamicForceLoadCase
    ...
    @enforce_parameter_types
    def number_of_steps_per_operating_point_specification_method(
        self: Self, value: "_1369.NumberOfStepsPerOperatingPointSpecificationMethod"
    ):
    ...
    @property
    def operating_points(self: Self) -> "List[_1350.DynamicForcesOperatingPoint]":
    ...
    def remove_operating_point(
        self: Self, operating_point: "_1350.DynamicForcesOperatingPoint"
    ):
        """Method does not return.
