...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1356, _1351
...
class EfficiencyMapLoadCase(_1368.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """EfficiencyMapLoadCase
