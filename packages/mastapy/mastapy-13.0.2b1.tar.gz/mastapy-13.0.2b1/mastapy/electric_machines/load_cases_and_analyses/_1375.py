...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1342
...
class SpeedTorqueCurveAnalysis(_1353.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1376.SpeedTorqueCurveLoadCase":
    ...
    @property
    def results_points(self: Self) -> "List[_1342.MaximumTorqueResultsPoints]":
