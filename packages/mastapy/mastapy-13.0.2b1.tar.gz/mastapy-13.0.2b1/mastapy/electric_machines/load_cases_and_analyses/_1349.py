...
from mastapy.electric_machines.load_cases_and_analyses import _1373, _1347
...
class DynamicForceLoadCase(_1347.BasicDynamicForceLoadCase):
    """DynamicForceLoadCase
    ...
    class _Cast_DynamicForceLoadCase:
        ...
        def electric_machine_load_case_base(
            ...
            from mastapy.electric_machines.load_cases_and_analyses import _1360

            return self._parent._cast(_1360.ElectricMachineLoadCaseBase)
    ...
    @property
    def control_strategy(self: Self) -> "_1355.ElectricMachineControlStrategy":
    ...
    def control_strategy(self: Self, value: "_1355.ElectricMachineControlStrategy"):
    ...
    @enforce_parameter_types
    def load_specification(self: Self, value: "_1373.SpecifyTorqueOrCurrent"):
    ...
    @enforce_parameter_types
    def operating_points_specification_method(
        self: Self, value: "_1370.OperatingPointsSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.OperatingPointsSpecificationMethod",
    ...
    @property
    def speed_points_distribution(self: Self) -> "_1374.SpeedPointsDistribution":
    ...
    @enforce_parameter_types
    def speed_points_distribution(self: Self, value: "_1374.SpeedPointsDistribution"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.SpeedPointsDistribution",
        )
