...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines import _1250, _1251
...
class CADElectricMachineDetail(_1262.ElectricMachineDetail):
    """CADElectricMachineDetail
    ...
    @property
    def rotor(self: Self) -> "_1250.CADRotor":
    ...
    @property
    def stator(self: Self) -> "_1251.CADStator":
