...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1310, _1261
...
class ElectricMachineSetup(_0.APIBase):
    ...
    def two_d_fe_model_for_electro_magnetic_analysis(
        self: Self,
    ) -> "_1310.TwoDimensionalFEModelForAnalysis[_1265.ElectricMachineMeshingOptions]":
    ...
    @property
    def eccentricity(self: Self) -> "_1261.Eccentricity":
