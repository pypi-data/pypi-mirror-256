...
from mastapy.electric_machines.harmonic_load_data import _1383, _1380, _1384
...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1868, _1864
    from mastapy.electric_machines.harmonic_load_data import _1386, _1387
...
class ElectricMachineHarmonicLoadDataBase(_1384.SpeedDependentHarmonicLoadData):
    """ElectricMachineHarmonicLoadDataBase
    ...
    class _Cast_ElectricMachineHarmonicLoadDataBase:
        ...
        def speed_dependent_harmonic_load_data(
            ...
            return self._parent._cast(_1384.SpeedDependentHarmonicLoadData)
        ...
        def harmonic_load_data_base(
            ...
            return self._parent._cast(_1381.HarmonicLoadDataBase)

        @property
        def dynamic_force_results(
            self: "ElectricMachineHarmonicLoadDataBase._Cast_ElectricMachineHarmonicLoadDataBase",
        ):
            from mastapy.electric_machines.results import _1322

            return self._parent._cast(_1322.DynamicForceResults)
        ...
        def electric_machine_harmonic_load_data_from_excel(
            ...
            return self._parent._cast(_6875.ElectricMachineHarmonicLoadDataFromExcel)
        ...
        def electric_machine_harmonic_load_data_from_masta(
            ...
            return self._parent._cast(_6878.ElectricMachineHarmonicLoadDataFromMASTA)
    ...
    @enforce_parameter_types
    def data_type_for_force_moment_distribution_and_temporal_spatial_harmonics_charts(
        self: Self, value: "_1383.HarmonicLoadDataType"
    ):
    ...
    @enforce_parameter_types
    def display_option_for_slice_data(self: Self, value: "_1380.ForceDisplayOption"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def force_distribution_3d(self: Self) -> "_1868.ThreeDVectorChartDefinition":
    ...
    @slice.setter
    @enforce_parameter_types
    def slice(self: Self, value: "_1296.RotorSkewSlice"):
        wrapper_type = (
    ...
    @property
    def temporal_spatial_harmonics_chart(self: Self) -> "_1864.ScatterChartDefinition":
    ...
    @property
    def stator_axial_loads(self: Self) -> "_1386.StatorToothLoadInterpolator":
    ...
    @property
    def stator_radial_loads(self: Self) -> "_1386.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tangential_loads(self: Self) -> "_1386.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tooth_moments(self: Self) -> "_1387.StatorToothMomentInterpolator":
    ...
    def multiple_fourier_series_interpolator_for(
        self: Self,
        harmonic_load_data_type: "_1383.HarmonicLoadDataType",
        slice_index: "int",
