...
class StatorToothInterpolator(_0.APIBase):
    ...
    class _Cast_StatorToothInterpolator:
        ...
        def stator_tooth_load_interpolator(
            ...
            from mastapy.electric_machines.harmonic_load_data import _1386

            return self._parent._cast(_1386.StatorToothLoadInterpolator)
        ...
        def stator_tooth_moment_interpolator(
            ...
            return self._parent._cast(_1387.StatorToothMomentInterpolator)
