...
class Rotor(_0.APIBase):
    ...
    class _Cast_Rotor:
        ...
        @property
        def cad_rotor(self: "Rotor._Cast_Rotor"):
            from mastapy.electric_machines import _1250

            return self._parent._cast(_1250.CADRotor)
        ...
        @property
        def permanent_magnet_rotor(self: "Rotor._Cast_Rotor"):
            from mastapy.electric_machines import _1291

            return self._parent._cast(_1291.PermanentMagnetRotor)

        @property
        def surface_permanent_magnet_rotor(self: "Rotor._Cast_Rotor"):
    ...
    def d_axis_and_q_axis_convention(
        self: Self,
        value: "Union[_1260.DQAxisConvention, Tuple[_1260.DQAxisConvention, bool]]",
    ):
    ...
    @property
    def skew_slices(self: Self) -> "List[_1296.RotorSkewSlice]":
