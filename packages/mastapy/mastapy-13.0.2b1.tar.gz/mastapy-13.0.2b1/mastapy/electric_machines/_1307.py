...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1309, _1308
...
class ToothAndSlot(_1244.AbstractToothAndSlot):
    ...
    class _Cast_ToothAndSlot:
        ...
        @property
        def abstract_tooth_and_slot(self: "ToothAndSlot._Cast_ToothAndSlot"):
    ...
    @property
    def tooth_taper_specification(self: Self) -> "_1309.ToothTaperSpecification":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1309", "ToothTaperSpecification"
        )(value)

    @tooth_taper_specification.setter
    @enforce_parameter_types
    def tooth_taper_specification(self: Self, value: "_1309.ToothTaperSpecification"):
    ...
    @property
    def tooth_slot_style(self: Self) -> "_1308.ToothSlotStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1308", "ToothSlotStyle"
        )(value)

    @tooth_slot_style.setter
    @enforce_parameter_types
    def tooth_slot_style(self: Self, value: "_1308.ToothSlotStyle"):
        value = conversion.mp_to_pn_enum(
