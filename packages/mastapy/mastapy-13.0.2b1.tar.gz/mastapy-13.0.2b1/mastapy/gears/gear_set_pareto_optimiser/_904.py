...
if TYPE_CHECKING:
    from mastapy.utility.reporting_property_framework import _1791
    from mastapy.math_utility.optimisation import _1553
    from mastapy.gears.gear_set_pareto_optimiser import _906, _902, _914
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    class _Cast_ChartInfoBase:
        ...
        def pareto_optimiser_chart_information(
            ...
            return self._parent._cast(_932.ParetoOptimiserChartInformation)
    ...
    @property
    def chart_type(self: Self) -> "_1791.CustomChartType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.reporting_property_framework._1791", "CustomChartType"
        )(value)
    ...
    def select_chart_type(
        self: Self,
    ) -> "_1553.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation.ParetoOptimisationStrategyChartInformation._1553",
    ...
    def select_chart_type(
        self: Self,
        value: "_1553.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart",
    ):
    ...
    @property
    def optimiser(self: Self) -> "_906.DesignSpaceSearchBase[TAnalysis, TCandidate]":
    ...
    @property
    def bars(self: Self) -> "List[_902.BarForPareto[TAnalysis, TCandidate]]":
    ...
    def input_sliders(
        self: Self,
    ) -> "List[_914.InputSliderForPareto[TAnalysis, TCandidate]]":
