...
class LubricationDetail(_1831.NamedDatabaseItem):
    """LubricationDetail
    ...
    class _Cast_LubricationDetail:
        ...
        @property
        def named_database_item(self: "LubricationDetail._Cast_LubricationDetail"):
    ...
    @property
    def density_vs_temperature(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def density_vs_temperature(self: Self, value: "_1536.Vector2DListAccessor"):
