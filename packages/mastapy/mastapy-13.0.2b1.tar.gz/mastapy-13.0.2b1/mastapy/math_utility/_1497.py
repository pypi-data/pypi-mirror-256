...
class ComplexVector(_1495.ComplexMatrix):
    """ComplexVector
    ...
    class _Cast_ComplexVector:
        ...
        @property
        def complex_matrix(self: "ComplexVector._Cast_ComplexVector"):
            return self._parent._cast(_1495.ComplexMatrix)

        @property
        def generic_matrix(self: "ComplexVector._Cast_ComplexVector"):
            from mastapy.math_utility import _1515

            return self._parent._cast(_1515.GenericMatrix)

        @property
        def complex_vector_3d(self: "ComplexVector._Cast_ComplexVector"):
            from mastapy.math_utility import _1498

            return self._parent._cast(_1498.ComplexVector3D)

        @property
        def complex_vector_6d(self: "ComplexVector._Cast_ComplexVector"):
