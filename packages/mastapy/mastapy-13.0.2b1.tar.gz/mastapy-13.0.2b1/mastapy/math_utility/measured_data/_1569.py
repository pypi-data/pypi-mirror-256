...
class OnedimensionalFunctionLookupTable(
    _1568.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: Self) -> "_1536.Vector2DListAccessor":
    ...
    def lookup_table(self: Self, value: "_1536.Vector2DListAccessor"):
