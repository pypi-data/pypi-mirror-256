...
class TwodimensionalFunctionLookupTable(
    _1568.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: Self) -> "_1567.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: Self, value: "_1567.GriddedSurfaceAccessor"):
