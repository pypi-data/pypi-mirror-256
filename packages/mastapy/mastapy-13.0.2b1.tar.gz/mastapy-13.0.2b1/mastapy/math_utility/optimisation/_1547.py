...
class OptimizationVariable(_0.APIBase):
    ...
    class _Cast_OptimizationVariable:
        ...
        @property
        def optimization_input(self: "OptimizationVariable._Cast_OptimizationVariable"):
            from mastapy.math_utility.optimisation import _1546

            return self._parent._cast(_1546.OptimizationInput)
        ...
        def reporting_optimization_input(
            ...
            return self._parent._cast(_1558.ReportingOptimizationInput)
    ...
    @property
    def measurement(self: Self) -> "_1607.MeasurementBase":
    ...
    def measurement(self: Self, value: "_1607.MeasurementBase"):
