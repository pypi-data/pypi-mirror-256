...
class OptimizationInput(_1547.OptimizationVariable):
    """OptimizationInput
    ...
    class _Cast_OptimizationInput:
        ...
        @property
        def optimization_variable(self: "OptimizationInput._Cast_OptimizationInput"):
            return self._parent._cast(_1547.OptimizationVariable)
