...
if TYPE_CHECKING:
    from mastapy.math_utility.optimisation import _1553, _1549, _1550
...
class ParetoOptimisationStrategy(_1831.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    @property
    def charts(self: Self) -> "List[_1553.ParetoOptimisationStrategyChartInformation]":
    ...
    @property
    def inputs(self: Self) -> "List[_1549.ParetoOptimisationInput]":
    ...
    @property
    def outputs(self: Self) -> "List[_1550.ParetoOptimisationOutput]":
