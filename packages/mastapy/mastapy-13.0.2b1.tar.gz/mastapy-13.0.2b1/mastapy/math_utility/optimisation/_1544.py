...
class Optimisable(_1540.AbstractOptimisable):
    """Optimisable
    ...
    class _Cast_Optimisable:
        ...
        @property
        def abstract_optimisable(self: "Optimisable._Cast_Optimisable"):
            return self._parent._cast(_1540.AbstractOptimisable)
