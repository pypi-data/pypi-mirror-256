...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1855, _1865
...
class TwoDChartDefinition(_1861.NDChartDefinition):
    """TwoDChartDefinition
    ...
    class _Cast_TwoDChartDefinition:
        ...
        @property
        def nd_chart_definition(self: "TwoDChartDefinition._Cast_TwoDChartDefinition"):
            return self._parent._cast(_1861.NDChartDefinition)

        @property
        def chart_definition(self: "TwoDChartDefinition._Cast_TwoDChartDefinition"):
    ...
    @property
    def const_lines(self: Self) -> "List[_1855.ConstantLine]":
    ...
    @property
    def series_list(self: Self) -> "List[_1865.Series2D]":
