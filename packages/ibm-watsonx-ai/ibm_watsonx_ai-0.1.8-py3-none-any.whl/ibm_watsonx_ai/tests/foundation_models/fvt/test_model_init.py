...
class TestTextGeneration:
    ...
    def test_01a_create_flan_ul2_model(self, api_client, project_id):
    ...
    def test_01b_create_flan_ul2_model_numpy_object(self, api_client, project_id):
        model_id = ModelTypes.FLAN_UL2
        import numpy
    ...
    def test_01c_create_flan_ul2_model_with_typo(self, api_client, project_id):
        model_id = 'flan-ul2'
        ...
        assert flan_ul2_model.model_id == model_id, "Wrong initialization of invalid model"
            
    def test_02_create_gpt_neox_model(self, api_client, project_id):
    ...
    def test_03_create_mt0_model(self, api_client, project_id):
    ...
    def test_04_create_mpt_7b_model(self, api_client, project_id):
    ...
    def test_05_create_flan_t5_model(self, api_client, project_id):
    ...
    def test_06_create_starcoder_model(self, api_client, project_id):
    ...
    def test_07_create_llama2_70b_chat_model(self, api_client, project_id):
    ...
    def test_08_create_granite_13b_instruct_model(self, api_client, project_id):
        ...
        if is_cp4d():
            ...
            granite_instruct = ModelInference(
                model_id=model_id,
                api_client=api_client,
                project_id=project_id)
    ...
    def test_09_create_granite_13b_chat_model(self, api_client, project_id):
        model_id = ModelTypes.GRANITE_13B_CHAT
        granite_chat = ModelInference(
            model_id=model_id,
            api_client=api_client,
            project_id=project_id)
    ...
    def test_10_generate_text_with_raw_response(self, api_client, project_id):
    ...
    def test_11_generate_text_stream(self, api_client, project_id):
    ...
    def test_12_create_flan_t5_xl_model(self, api_client, project_id):
        model_id = ModelTypes.FLAN_T5_XL
        flan_t5_xl = ModelInference(
            model_id=model_id,
            api_client=api_client,
            project_id=project_id)
    ...
    def test_13_generate_text_stream_with_raw_response(self, api_client, project_id):
        raw_response = True
        text_params = {
            GenParams.DECODING_METHOD: DecodingMethods.GREEDY,
            GenParams.MIN_NEW_TOKENS: 0,
    ...
    def test_13b_generate_async(self, api_client, project_id):
        model_id = ModelTypes.FLAN_UL2
        text_params = {
            GenParams.DECODING_METHOD: DecodingMethods.GREEDY,
            GenParams.MIN_NEW_TOKENS: 0,
    ...
    def test_14_tokenize_without_return_tokens(self, model_id, api_client, project_id):
    ...
    @pytest.mark.parametrize('model_id', available_models)
    def test_15_tokenize_with_return_tokens(self, model_id, api_client, project_id):
    ...
    @pytest.mark.parametrize('model_id', available_models)
    def test_16_tokenize_input_token(self, model_id, api_client, project_id):
    ...
    def test_17_create_elyza_japanese_llama_2_7b_instruct_model(self, api_client, project_id):
