...
from ibm_watsonx_ai.helpers import DataConnection, S3Connection, S3Location, AssetLocation
...
class TestPrepareCOSClient(unittest.TestCase):
    def test_01_check_clients_types(self):
        ...
        self.assertIsInstance(data_clients[0][0], WMLDataConnection,
                              msg='First variable from data_clients[0] tuple should be always a DataConnection')
        self.assertIsInstance(data_clients[1][0], WMLDataConnection,
                              msg='First variable from data_clients[1] tuple should be always a DataConnection')
        self.assertIsInstance(result_client[0], WMLDataConnection,
