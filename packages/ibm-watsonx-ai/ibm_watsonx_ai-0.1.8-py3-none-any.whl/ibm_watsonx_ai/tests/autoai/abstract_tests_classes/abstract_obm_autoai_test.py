...
from ibm_watsonx_ai.preprocessing import DataJoinGraph
...
from ibm_watsonx_ai.preprocessing.data_join_pipeline import OBMPipelineGraphBuilder
...
class AbstractTestOBM(abc.ABC):
    ...
    def test_16__get_data_connections__return_a_list_with_data_connections_with_optimizer_params(self):
        ...
        from ibm_watson_machine_learning.helpers.connections import DatabaseLocation as WMLDataConnection
