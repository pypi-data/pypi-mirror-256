...
from ibm_watsonx_ai.utils.autoai.enums import PredictionType, RunStateTypes, BatchedRegressionAlgorithms, \
    ...
    def test_00a_space_cleanup(self):
        ...
        while not space_checked:
            try:
                ...
                warn(f"Cannot delete space due to {e}, using old space")
