...
from ibm_watsonx_ai.tests.utils import create_connection_to_cos, get_wml_credentials, get_cos_credentials, \
    get_space_id
...
class TestDataRead(unittest.TestCase):
    ...
    def test_03e_get_empty_sql_table(self):
        from ibm_watsonx_ai.wml_client_error import EmptyDataSource
        ...
        for db_data_conn in self.db_data_connections:
            ...
            self.assertIsInstance(db_data_conn, WMLDataConnection)
