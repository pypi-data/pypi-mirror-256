...
class TestAutoAIRemote(AbstractTestAutoAIRemote, unittest.TestCase):
    ...
    The test covers:
    - Snowflake connectied asset set-up
    - downloading training data from connected asset
    - downloading all generated pipelines to lale pipeline
    - deployment with lale pipeline
    - deployment deletion
    Connected asset used in test:
     - input: Database connected asset pointing to Snowflake.
     - output: null
    """
