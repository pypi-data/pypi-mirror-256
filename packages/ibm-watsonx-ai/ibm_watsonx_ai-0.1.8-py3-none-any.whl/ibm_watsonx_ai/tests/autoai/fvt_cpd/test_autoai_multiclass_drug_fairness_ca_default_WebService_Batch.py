...
from ibm_watsonx_ai.tests.autoai.abstract_tests_classes import AbstractTestAutoAIAsync, BaseTestStoreModel

from ibm_watsonx_ai.utils.autoai.enums import PredictionType, Metrics, ClassificationAlgorithms, SamplingTypes
...
class TestAutoAIRemote(AbstractTestAutoAIAsync, BaseTestStoreModel, unittest.TestCase):
    ...
    experiment_info = dict(
        ...
        sampling_type=SamplingTypes.FIRST_VALUES,
