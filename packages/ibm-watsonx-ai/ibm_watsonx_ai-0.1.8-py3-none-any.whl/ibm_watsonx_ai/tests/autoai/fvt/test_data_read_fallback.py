...
class TestAutoAIRemote(unittest.TestCase):
    ...
    def test_00d_prepare_connected_data_asset(self):
        ...
        self.assertEqual(len(self.assets_ids), 4)
    ...
    def test_02_data_reference_setup(self):
        ...
        self.assertEqual(len(self.data_connections), 4)
        self.assertEqual(len(self.results_connections), 4)
    ...
    def test_05_a_batch_size(self):
        ...
        batch_size = 120
        test_df = self.data_connections[0].read(use_flight=True, number_of_batch_rows=batch_size)
        print(test_df.head())
        print(test_df.shape)
