...
FM_GENERATION = u'{}/ml/v1-beta/generation/{}'
FM_GET_SPECS = u'{}/ml/v1-beta/foundation_model_specs?version=2022-08-01&limit={}'
FM_TOKENIZE = u'{}/ml/v1-beta/text/tokenization'

FM_DEPLOYMENT_GENERATION = u'{}/ml/v1-beta/deployments/{}/generation/{}'
...
class HrefDefinitions:
    ...
    def get_fm_specifications_href(self, limit):
        return FM_GET_SPECS.format(self._wml_credentials['url'], limit)

    def get_fm_generation_href(self, item):
        return FM_GENERATION.format(self._wml_credentials['url'], item)

    def get_fm_tokenize_href(self):
        return FM_TOKENIZE.format(self._wml_credentials['url'])

    def get_fm_deployment_generation_href(self, deployment_id, item):
        return FM_DEPLOYMENT_GENERATION.format(self._wml_credentials['url'], deployment_id, item)
