        ...
        **Example**
        ...
        if raw_response:
            ...
            if isinstance(prompt, list):
                return [ModelInference._return_guardrails_stats(single_response)['generated_text'] for single_response in metadata]
            else:
                return ModelInference._return_guardrails_stats(metadata)['generated_text']
