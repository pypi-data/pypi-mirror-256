...
class SimplePatternsCandidateGenerator(UnionCandidateGenerator):
    """short-cut for the sequence, optional, choice and loop candidate generators
    """

    def __init__(self):
        super().__init__([
            SequenceCandidateGenerator(),
            ChoiceCandidateGenerator(),
            OptionalCandidateGenerator(),
            LoopCandidateGenerator()
        ])
