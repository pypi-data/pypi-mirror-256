...
CreateCustomLogSourceRequestRequestTypeDef = TypedDict(
    ...
    {
        "sourceName": str,
        "configuration": NotRequired[CustomLogSourceConfigurationTypeDef],
...
DataLakeConfigurationTypeDef = TypedDict(
    "DataLakeConfigurationTypeDef",
    {
        ...
        "lifecycleConfiguration": NotRequired[DataLakeLifecycleConfigurationTypeDef],
        "replicationConfiguration": NotRequired[DataLakeReplicationConfigurationTypeDef],
    },
)
