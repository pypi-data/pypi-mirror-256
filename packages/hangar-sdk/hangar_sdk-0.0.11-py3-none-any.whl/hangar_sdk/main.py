...
@app.command()
def up(file: str, api_key: ApiKeyOption, url: UrlOption = DEFAULT_URL, mode: str = "create"):
...
version = importlib.metadata.version('hangar-sdk')

@app.command()
def version():
    typer.echo(f"hangar version: {version}")