...
class Smartfire(object):
    ...
    async def update(self) -> None:
        if hasattr(self, "_econet") is False:
            ...
            self.sensors["caution_fuel_level"] = Setting(
                self._econet, Params.CAUTION_FUEL_LEVEL
            )
            self.sensors["caution_load_the_thank"] = Setting(
                self._econet, Params.CAUTION_LOAD_THE_TANK
            )
