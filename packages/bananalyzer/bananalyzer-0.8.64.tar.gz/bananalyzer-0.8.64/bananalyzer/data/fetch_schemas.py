...
# High level goal for the agent. Will be provided as context to the model
GOVERNMENT_CONTRACT_GOAL = (
    "Fetch all government contract notices / solicitations on the current website"
)
...
class GovernmentContractSchema(BaseModel):
    __url: str = Field(
        description="Source URL the contract information was retrieved from"
    )
    ...
    buyer_number: Optional[str] = Field(
