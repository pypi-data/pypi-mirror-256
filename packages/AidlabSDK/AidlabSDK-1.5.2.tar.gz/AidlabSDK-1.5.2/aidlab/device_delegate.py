...
class DeviceDelegate:
    ...
    def did_receive_ecg(self, device: Device, timestamp: int, values: List[float]):
    ...
    def did_receive_activity(self, device: Device, timestamp: int, activity: str):
    ...
    def did_receive_pressure(self, device: Device, timestamp: int, values: List[int]):
    ...
    def did_receive_command(self, device: Device):
    ...
    def sync_state_did_change(self, device: Device, sync_state: str):
        ...
        :param aidlab: The device instance.
    ...
    def did_receive_past_ecg(self, device: Device, timestamp: int, values: List[float]):
        """
        Called when past ECG data is received from the device.

        :param aidlab: The device instance.
        :param timestamp: The timestamp of the ECG data.
        :param values: The list of ECG data values.
        """

    def did_receive_past_respiration(self, device: Device, timestamp: int, values: List[float]):
        """
        Called when past respiration data is received from the device.

        :param aidlab: The device instance.
        :param timestamp: The timestamp of the respiration data.
        :param values: The list of respiration data values.
        """
    ...
    def did_receive_past_rr(self, device: Device, timestamp: int, rr: int):
        ...
        :param rr: The RR interval value.
        """

    def did_receive_past_pressure(self, device: Device, timestamp: int, values: List[int]):
        """
        Called when past pressure data is received from the device.

        :param aidlab: The device instance.
        :param timestamp: The timestamp of the pressure data.
        :param values: The list of pressure values.
        """
    ...
    def did_receive_past_sound_volume(self, device: Device, timestamp: int, sound_volume: int):
        ...
        :param sound_volume: The sound volume level.
        """
    ...
    def did_receive_past_user_event(self, device: Device, timestamp: int):
        ...
        :param aidlab: The device instance.
        :param timestamp: The timestamp of the user event.
        """
