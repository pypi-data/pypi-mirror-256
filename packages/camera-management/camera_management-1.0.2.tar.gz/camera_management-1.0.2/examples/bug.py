...
camera_backend = CameraApplication(port=8091, description_path=pathlib.Path('/Users/simonmichel/PycharmProjects/camera-management/examples/data/type_configs/a2A5328-15ucBAS_0.json'))
