...
class VacuumStates_builder(PartitionManager):
    ...
    def handleDimers(self, container:object, values:list, container_index:int,  file_location:str=None):
        """
        Manages the creation of dimer configurations based on specified values.

        Parameters:
        - container (object): The initial container for creating dimers.
