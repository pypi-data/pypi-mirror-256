...
(see :py:func:`conforce_gen.expressions.eval_CS_mbf`).
...
def compute_F(
    ...
    .. seealso::
        Module :py:mod:`conforce_gen.element_definitions` for a list of supported element types
...
def compute_CS(
    ...
    .. seealso::
        ...
        - Supported methods are:
            ...
            - "mbf" :py:func:`conforce_gen.expressions.eval_CS_mbf`
            - "dbf" :py:func:`conforce_gen.expressions.eval_CS_dbf`
