...
from conforce_gen import element_definitions
from conforce_gen.expressions import Computation
from conforce_gen.symbolic_util import TermCollector, expand_matrices_in_symbols_to_expressions, apply_replacement_rules
...
def write_code_for_element_type(
    ...
    """
    Generate Code for an element type defined in :py:mod:`conforce_gen.element_definitions`.
