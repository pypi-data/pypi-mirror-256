...
class QuotasApi:
    ...
    def read_quota(self, **kwargs) -> QuotasResult:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_quota_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_quota_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def read_quota_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Obtaining the quotas  # noqa: E501
