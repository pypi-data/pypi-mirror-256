...
class General403(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> General403:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> General403:
        """Create an instance of General403 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return General403.parse_obj(obj)

        _obj = General403.parse_obj({
