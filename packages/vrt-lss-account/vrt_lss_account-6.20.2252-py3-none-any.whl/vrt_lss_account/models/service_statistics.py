...
class ServiceStatistics(BaseModel):
    """
    Usage statistics of all service methods.  # noqa: E501
    """
    service: ServiceName
    methods: Annotated[List[MethodStatistics], Field(min_length=1, max_length=100)] = Field(description="Usage statistics list of the specified service methods.")
