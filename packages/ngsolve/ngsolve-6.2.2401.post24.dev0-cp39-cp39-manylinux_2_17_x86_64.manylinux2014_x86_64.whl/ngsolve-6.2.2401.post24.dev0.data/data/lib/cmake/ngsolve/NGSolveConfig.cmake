set(PACKAGE_VERSION "6.2.2401-24-gfbf9f25b1")
...
set(NGSOLVE_PYTHON_INCLUDE_DIRS "/opt/_internal/cpython-3.9.18/include/python3.9")
...
set(NGSOLVE_ZLIB_INCLUDE_DIRS "/builds/ngsolve/netgen/_skbuild/linux-x86_64-3.9/cmake-build/dependencies/zlib/include")
set(NGSOLVE_ZLIB_LIBRARIES "/builds/ngsolve/netgen/_skbuild/linux-x86_64-3.9/cmake-build/dependencies/zlib/lib/libz.so")
...
set(NGSOLVE_COMPILE_FLAGS " -DHAVE_NETGEN_SOURCES -DHAVE_DLFCN_H -DHAVE_CXA_DEMANGLE -DUSE_TIMEOFDAY -DTCL -DLAPACK -DUSE_PARDISO -DNGS_PYTHON -DNETGEN_PYTHON -DNG_PYTHON -DPYBIND11_SIMPLE_GIL_MANAGEMENT" CACHE STRING "Preprocessor definitions of ngscxx")
...
set(NGSOLVE_INCLUDE_DIRS /opt/_internal/cpython-3.9.16/include;/opt/_internal/cpython-3.9.18/include/python3.9 CACHE STRING "Include dirs set in ngscxx")
