...
*LeadsApi* | [**create_lead_sync**](docs/LeadsApi.md#create_lead_sync) | **POST** /publicapi/v1/leads-sync | Create the lead
...
## Documentation For Models
 ...
 - [LeadSyncResponseClass](docs/LeadSyncResponseClass.md)
