...
try:
    ...
    os.chdir(os.path.join(module_dir, "PalEdit"))
    import PalInfo
    PalInfo.module_path = os.path.join(module_dir, "PalEdit")
    import PalEdit as PalEditModule
    from PalEdit import PalEditConfig, PalEdit
    PalEditModule.module_path = PalInfo.module_path 
