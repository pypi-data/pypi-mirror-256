...
from .interface import set_met, set_parameters
...
def setup(gui=False):
    ...
    params_set, met_set = set_met(params_set, gui=gui)
    return params_set, met_set


def solve(parameters, met_data, timer=False):
