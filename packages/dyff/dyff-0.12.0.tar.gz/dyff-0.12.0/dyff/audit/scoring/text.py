...
class MatchResult(str, enum.Enum):
    """The possible results of a text span matching comparison as defined by the
    MUC-5 evaluation standard.
...
def match_spans(
    ...
    """Compute matching results for ground-truth and predicted text spans using
    the extended set of matching criteria defined by the SemEval2013 and MUC-5
...
class TextSpanMatches(Rubric):
    """Computes matches between predicted and ground-truth text spans according
    to each criterion in ``MatchCriterion``.
    """
