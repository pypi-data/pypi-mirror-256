...
class LinearMatrixInequalityConstraint(Constraint):
    def __init__(self, F: List[numpy.ndarray[numpy.float64[m, n], flags.f_contiguous]], symmetry_tolerance: float = ...) -> None: ...
...
class MathematicalProgram:
    ...
    def AddLinearMatrixInequalityConstraint(self, F: List[numpy.ndarray[numpy.float64[m, n], flags.f_contiguous]], vars: numpy.ndarray[object[m, 1]]) -> BindingTLinearMatrixInequalityConstraintU: ...
