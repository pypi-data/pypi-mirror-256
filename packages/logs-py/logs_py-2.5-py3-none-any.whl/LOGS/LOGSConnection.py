...
class LOGSConnection:
    ...
    def checkServer(self):
        ...
        if isinstance(result, dict):
            ...
            if (
                ...
                raise LOGSException(
                    "This libraray is not compatible with the LOGS API version '%s'. (Expected %s %s)"
                    % (
    ...
    def putEndpoint(
        ...
        data: Union[dict, list] = {},
        responseType: ResponseTypes = ResponseTypes.JSON,
    ) -> Tuple[Optional[RESPONSE_TYPES], Optional[List[str]]]:
    ...
    def __convertResponse(
        ...
        if response.status_code >= 200 and response.status_code < 300:
            ...
            return (response, errors if errors else None)
