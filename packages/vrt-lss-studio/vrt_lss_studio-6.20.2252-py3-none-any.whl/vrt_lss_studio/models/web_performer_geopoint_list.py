...
class WebPerformerGeopointList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebPerformerGeopointList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebPerformerGeopointList:
        """Create an instance of WebPerformerGeopointList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebPerformerGeopointList.parse_obj(obj)

        _obj = WebPerformerGeopointList.parse_obj({
            "geopoints": [WebPerformerGeopoint.from_dict(_item) for _item in obj.get("geopoints")] if obj.get("geopoints") is not None else None,
