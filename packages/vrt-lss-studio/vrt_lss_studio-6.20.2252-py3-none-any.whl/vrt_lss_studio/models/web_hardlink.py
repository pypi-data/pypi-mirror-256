...
class WebHardlink(BaseModel):
    ...
    __properties = ["hardlink", "fields", "linked_essences"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebHardlink:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebHardlink:
        """Create an instance of WebHardlink from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebHardlink.parse_obj(obj)

        _obj = WebHardlink.parse_obj({
            "hardlink": Hardlink.from_dict(obj.get("hardlink")) if obj.get("hardlink") is not None else None,
            "fields": TableHardlinkFields.from_dict(obj.get("fields")) if obj.get("fields") is not None else None,
