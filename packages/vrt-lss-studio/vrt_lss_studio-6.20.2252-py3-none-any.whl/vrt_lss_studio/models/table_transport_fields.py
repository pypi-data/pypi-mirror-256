...
class TableTransportFields(BaseModel):
    """
    Transport\\shift fields for table.  # noqa: E501
    """
    ...
    __properties = ["essence_key", "essence_type", "enabled", "pristine", "working_time", "availability_time", "transport_type", "trip_key", "trip_name", "location_keys", "trips_count", "attributes"]
    ...
    def essence_type_validate_enum(cls, value):
        ...
        if value not in ('TRANSPORT', 'SHIFT'):
            raise ValueError("must be one of enum values ('TRANSPORT', 'SHIFT')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TableTransportFields:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TableTransportFields:
        """Create an instance of TableTransportFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TableTransportFields.parse_obj(obj)

        _obj = TableTransportFields.parse_obj({
