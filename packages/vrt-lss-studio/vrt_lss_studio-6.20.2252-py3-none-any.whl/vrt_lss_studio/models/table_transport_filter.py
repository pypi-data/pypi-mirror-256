...
class TableTransportFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TableTransportFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TableTransportFilter:
        """Create an instance of TableTransportFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TableTransportFilter.parse_obj(obj)

        _obj = TableTransportFilter.parse_obj({
            "type": obj.get("type"),
