...
class TableTripFilter(BaseModel):
    """
    Universal filter for table.  # noqa: E501
    """
    ...
    __properties = ["type", "column", "datetime_range", "int_range", "float_range", "bool_list", "string_list", "enum_list", "string_search", "duration_range"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TableTripFilter:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.duration_range is None and "duration_range" in self.__fields_set__:
            _dict['duration_range'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> TableTripFilter:
        """Create an instance of TableTripFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TableTripFilter.parse_obj(obj)

        _obj = TableTripFilter.parse_obj({
            "type": obj.get("type"),
            ...
            "duration_range": TableFilterDurationRange.from_dict(obj.get("duration_range")) if obj.get("duration_range") is not None else None
        })
        return _obj
