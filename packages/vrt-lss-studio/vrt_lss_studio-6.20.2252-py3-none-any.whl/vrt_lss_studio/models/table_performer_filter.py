...
class TablePerformerFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TablePerformerFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TablePerformerFilter:
        """Create an instance of TablePerformerFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TablePerformerFilter.parse_obj(obj)

        _obj = TablePerformerFilter.parse_obj({
            "type": obj.get("type"),
