...
class WebTransport(BaseModel):
    ...
    __properties = ["transport", "fields", "linked_essences"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebTransport:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebTransport:
        """Create an instance of WebTransport from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebTransport.parse_obj(obj)

        _obj = WebTransport.parse_obj({
            "transport": Transport.from_dict(obj.get("transport")) if obj.get("transport") is not None else None,
            "fields": TableTransportFields.from_dict(obj.get("fields")) if obj.get("fields") is not None else None,
