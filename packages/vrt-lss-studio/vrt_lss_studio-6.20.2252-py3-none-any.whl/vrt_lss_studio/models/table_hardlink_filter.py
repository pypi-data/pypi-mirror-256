...
class TableHardlinkFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TableHardlinkFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TableHardlinkFilter:
        """Create an instance of TableHardlinkFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TableHardlinkFilter.parse_obj(obj)

        _obj = TableHardlinkFilter.parse_obj({
            "type": obj.get("type"),
