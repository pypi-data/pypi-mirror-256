...
class TableLocationFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TableLocationFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TableLocationFilter:
        """Create an instance of TableLocationFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TableLocationFilter.parse_obj(obj)

        _obj = TableLocationFilter.parse_obj({
            "type": obj.get("type"),
