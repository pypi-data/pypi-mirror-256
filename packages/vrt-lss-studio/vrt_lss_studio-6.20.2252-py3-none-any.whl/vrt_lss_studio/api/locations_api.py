...
class LocationsApi:
    ...
    @validate_arguments
    def create_location(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(description="New essence creation request.")], **kwargs) -> WebLocation:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_location_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_location_with_http_info(experiment_key, web_location, **kwargs)  # noqa: E501

    @validate_arguments
    def create_location_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create location  # noqa: E501
        ...
        _body_params = None
        if _params['web_location'] is not None:
    ...
    @validate_arguments
    def delete_location(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_location_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_location_with_http_info(experiment_key, essence_key, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_location_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Remove location  # noqa: E501
    ...
    @validate_arguments
    def read_location(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> WebLocation:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_location_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_location_with_http_info(experiment_key, essence_key, **kwargs)  # noqa: E501

    @validate_arguments
    def read_location_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read location  # noqa: E501
    ...
    def read_locations(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, sort_field : Annotated[Optional[TableLocationColumnType], Field(description="Locations table column name. ")] = None, sort_direction : Annotated[Optional[StrictStr], Field(description="Sort direction.")] = None, table_location_filter_list : Annotated[Optional[TableLocationFilterList], Field(description="locations filter.")] = None, **kwargs) -> TableLocationList:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_locations_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
    ...
    def read_locations_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, sort_field : Annotated[Optional[TableLocationColumnType], Field(description="Locations table column name. ")] = None, sort_direction : Annotated[Optional[StrictStr], Field(description="Sort direction.")] = None, table_location_filter_list : Annotated[Optional[TableLocationFilterList], Field(description="locations filter.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['table_location_filter_list'] is not None:
    ...
    @validate_arguments
    def read_locations_geopoints(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, table_location_filter_list : Annotated[Optional[TableLocationFilterList], Field(description="Locations filter.")] = None, **kwargs) -> WebLocationGeopointList:  # noqa: E501
        ...
        >>> thread = api.read_locations_geopoints(experiment_key, offset, limit, table_location_filter_list, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_locations_geopoints_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_locations_geopoints_with_http_info(experiment_key, offset, limit, table_location_filter_list, **kwargs)  # noqa: E501

    @validate_arguments
    def read_locations_geopoints_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, table_location_filter_list : Annotated[Optional[TableLocationFilterList], Field(description="Locations filter.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Location geopoints  # noqa: E501
        ...
        >>> thread = api.read_locations_geopoints_with_http_info(experiment_key, offset, limit, table_location_filter_list, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def update_location(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(description="Essence update request.")], **kwargs) -> WebLocation:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_location_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_location_with_http_info(experiment_key, web_location, **kwargs)  # noqa: E501

    @validate_arguments
    def update_location_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update location  # noqa: E501
