...
class ObjectAccessProfile:
    ...
    object_type: str
    owned: list[str]
    explicit_definition_editor: list[str]
    explicit_definition_viewer: list[str]
    explicit_definition_product_user: list[str]
    implicit_definition_editor: list[str]
    implicit_definition_viewer: list[str]
    implicit_definition_product_user: list[str]
    ...
    def get_access_list(self, **kwargs) -> list[str]:
        ...
        if kwargs.get('explicit_definition_product_user', False):
            final_list.extend(self.explicit_definition_product_user)
        ...
        if kwargs.get('implicit_definition_product_user', False):
            final_list.extend(self.implicit_definition_product_user)
